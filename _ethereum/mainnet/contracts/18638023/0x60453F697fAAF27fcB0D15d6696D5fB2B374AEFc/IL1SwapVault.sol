...
interface IL1SwapVault {
    ...
    /// @notice Emitted when a whitelisted token is updated
    /// @param token The address of the token
    /// @param allowed True if the address is authorized, false otherwise
    event WhitelistTokenUpdated(address indexed token, bool indexed allowed);
    ...
    function updateWhitelistedToken(address target, bool allowed) external;
    ...
    function whitelistedToken(address) external view returns (bool);
