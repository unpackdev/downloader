 ...
 * Joint reward game
 * Total tokens: 1000
 * Reward mode: lucky draw + ranking reward
*/

/**
 * 10 random draws, 0.5 ETH for each person
*/

/**
 * First place holding JRGAME: reward 10ETH
 * Second place holding JRGAME: reward 7ETH
 * Third place holding JRGAME: reward 5ETH
 * Fourth place with JRGAME: reward 3ETH
 * Fifth place holding JRGAME: reward 1.5ETH
*/
