...
/*
                                         ...
                                         .(&dHMMMMMMMMMMMMNme+.
                                       .(dWMHH@@@@@@@gg@@@MMMNm&-.
                                      .jdMH@@@@@g@@g@@gggg@@MMMMHaJ..`
                                     (dWMH@@@g@g@gg@@g@@@@g@@@@MMHNko.
                                   `(dHMM@@@g@g@@@@g@@g@g@@g@@@@@HH#Ny_`
                                   _dWHH@@@g@@g@g@@@@@@@@@@@@@@@M##NMS!`
                                  (dWH@@@g@@g@@@@@g@@g@@@g@@@@@@@MM@f<
                                 .dWHH@@@g@g@@@g@@@@@@@@@@@g@@@@@@#HR<    ` `  `
                       -(uss&-..(dHM@@@g@@@@@@@@@@@g@@g@@@@@g@@@@@@HMRx..(+uws+-
                    `.(dWHUUWHQmqHHH@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@MMHAdkHUUWHmx-`
                     (dH0I__(?UMMMH@@MMMHHHHHHHHHMMMMMHHHHHHHHHHMM@@HHMM9C<__(vHHl
                    .jW0C<+z+__?TWMMHHMMMMMMMHHgggggggg@gHHMMMMMMHHHMM9<!_(+z<<4HR-
                    (dHC<(zXXO+-_(wW@@@@HHHHHHHHHHHHHHHHHHHHHHH@HHHM0<_.(zZ0C>_jWHz_
             ...
             ..(iQqMHMMqkHHppppWWHHNNNMMM@HHHHHHHWWWWWWHHHHHHHHHHHHqmHHHgggggg@ggM#MNm&+-. `
          .(uXkH@HHHHpbkHHHH@HHHHUUUVTC<<<<<~~~____________~~~~~~~<<??1OVWHMMM@@gg@MMMHMHkA+- `
        .(dHMMHHpWWWHmHMHMM9V><~_` ```` `     `         `            ``` _?WMHHMMH@M@@g@MMMMks-
       (dWMHHbWmmHHWWWWHHSC!``             `   ` ` `  `  `   `  `         `_?WHgmmgHM@HH@@@@MMk+-`
    `.jXMMHqmHHWXuuuzXyWC>`     `      `  `  `    `  `    `  `   ` `         _?WHqkqkqqHMMHH@HMHy-
    ...
    `.zHMHkwrrrtllltw0I`` ` ` ` ` ``   -jAo_   `     `    ` +Qs- `  `` ` ` `  ` (dgHbbbbkkkqHMMMD!
      _?WMNkkwtl==zrwZ>   `` ....... ` _?7<`   ` .---. `    ?T=` ` ....... ``   _zHHbbbbkHHMMM9C!
        _?TMMMkmAzzOwZ<  ` `._((++---.`  `   `  .jWM9C_  `    ` ` -((J++-~~    `_jHHHWHHHHMM9Y!
         ...
         ` _1XWWk<_           .jXHUC7VHMMHH@@HHMHXwzwwXHMH@@H@MMH9C<ZHHo_         ` (jHHUWHk>
             _?1z~ `        `.zXW$_ ` _~?OVUUWH@HWWHqKuWHHUVC7<<_ `  +WHk_        .(dW9C<jkbl_
*/
import "./Ownable.sol";
import "./ERC721.sol";
import "./Strings.sol";
