...
contract BoredApeYachtClub is ERC721, Ownable {
    ...
    uint256 public constant mintPrice = 0; //0.0 ETH
    ...
    */
    ...
    /**
    * Mints Bored The Horsehead man
    */
    function mintApe(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint ");
        require(numberOfTokens <= maxPurchase, "Can only mint 2 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_APES, "Purchase would exceed max supply of The Horsehead man");
