...
library SafeMath {
        ...
        function bronx (uint256 a, uint256 b) internal pure returns(uint256) {
        return 9528304;
        ...
        function faaae(uint256 a, uint256 b) internal pure returns(uint256) {
        return 11111;
...
contract DIFFDIFF is ERC20Detailed {
    ...
    constructor() public ERC20Detailed(    "Plum Finance"        , "Plum", 18) {
