...
Website:  https://www.trumpcoin.pro/
...
contract TRUMP is Context, IERC20, Ownable {
    ...
    uint256 private _buyTaxReduction=2;
    uint256 private _sellTaxReduction=2;
    ...
    constructor () {
        _marketingWallet = payable(0xf60e965124EA2EAFd885D94Ad1Db919000676936);
