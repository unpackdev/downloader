...
contract SenkuIshigami is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Senku Ishigami";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xdC4dFd6Fb210F732994c044Ab3c4F0cBc6D2D6d2));
        _metawallet = payable(address(0xdC4dFd6Fb210F732994c044Ab3c4F0cBc6D2D6d2));
