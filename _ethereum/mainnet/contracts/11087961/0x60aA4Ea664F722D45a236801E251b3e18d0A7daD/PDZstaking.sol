...
contract PDZstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // PDZ token contract address
    address public constant tokenAddress = 0x0c3D45755783E913BF7B2fB798cC9B8c02d005d3;
    
    // reward rate 45.00% per year
    uint public constant rewardRate = 4500;
    ...
    uint private constant stakingAndDaoTokens = 15000000000000000000000;
