...
/*
    ...
    Telegam: https://t.me/FlokiChainToken
...
contract FlokiChain is ERC20, Ownable {
    ...
    constructor() ERC20("FCHAIN", "Floki Chain") {
        ...
        uint256 _buyLiqFee = 0;   //inital tax is 1% 
        uint256 _buyProjectFee = 1;     //inital tax is 1% 


        uint256 _sellLiqFee = 0; //inital tax is 1% 
        uint256 _sellProjectFee = 1;   //inital tax is 15% for Bots 
