...
https://twitter.com/cz_binance/status/1586605105410973699?s=20&t=kB-Fxkf8hpyxdLHcoL1yuQ
...
contract MOSQUEMANNERS is Context,IERC20, Ownable{
 ...
 string private _name = "MOSQUEMANNERS";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xF8E33e7d6Fa7d0B0972BA2E6BdFFA722d006E61D);
 ...
 //Tokenomics related functions
  function MMDay() public onlyOwner{
      require(block.timestamp > MMDaycooldown, "You cant call MMCoinDay more than once a day");
 ...
 function MMCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      MMDaycooldown = block.timestamp + 86400;
 }
