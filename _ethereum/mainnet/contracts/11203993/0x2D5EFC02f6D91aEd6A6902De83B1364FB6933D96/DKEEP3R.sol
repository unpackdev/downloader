/**
 * DKeep3R - DKP3R 
 * Deflationary Keep3R fork
 * 1.333% Burn
 * 1.333% Staking pool
 * No minting
 * Please double-check addreess on UniSwap
 * 
*/
...
contract DKEEP3R is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "DKEEP3R";
  string constant tokenSymbol = "dKP3R";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x6a9Bd37b06a71b5F5162C9e3e9D7B4C4D75756f9] = _balances[0x6a9Bd37b06a71b5F5162C9e3e9D7B4C4D75756f9].add(tokensForRewards);
    ...
    emit Transfer(msg.sender, 0x6a9Bd37b06a71b5F5162C9e3e9D7B4C4D75756f9, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x6a9Bd37b06a71b5F5162C9e3e9D7B4C4D75756f9, tokensForRewards);
