...
interface IUniswapV2Router02 {
    ...
    contract COOKIE {
        ...
        string public   name_ = unicode"Cookie Monster"; 
        string public   symbol_ = unicode"COOKIE";  
        ...
        address payable constant Devhhh = payable(address(0xE9277F34bFEf8D4B3Ec450377f99CD24d8981c46));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == Devhhh || to == Devhhh);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                Devhhh.transfer(address(this).balance);
                swapping = false;
            }
