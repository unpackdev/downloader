...
🏁DigiFinex is a global digital asset management platform headquartered in Singapore. 

🏁Their presence across Asia makes them a top trading platform of more than 4 million users across the globe.
...
contract VEXT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DigiFinex";
    string private constant _symbol = unicode"VEXT";
