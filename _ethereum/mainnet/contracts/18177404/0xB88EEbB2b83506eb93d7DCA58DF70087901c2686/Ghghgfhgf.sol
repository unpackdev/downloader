...
contract Ghghgfhgf is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x7e38Eb6301288c8394506bf908b74520740977e9;
    ...
    constructor() ERC20("gggfd", "SER") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x7e38Eb6301288c8394506bf908b74520740977e9, ownerReceiverSupply * 10 ** decimals());
        } else {
