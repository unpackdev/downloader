...
contract yfBEVstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YFBV token contract address
    address public constant tokenAddress = 0x634CE80e76516c845927c80F4a2A9D77d2A2eD0A;
    
    // reward rate 375.00% per year
    uint public constant rewardRate = 37500;            // 37500 ÷ 100 = 375 %
    ...
    // unstaking possible after 24 hours    // 1 Day
    ...
    uint private constant stakingAndDaoTokens = 6000e18;
