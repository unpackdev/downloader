...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        (string memory b3, string memory c3) = cars(4850,3180);
        if (keccak256(abi.encodePacked(b3))==keccak256(abi.encodePacked("Audi")) || 
            keccak256(abi.encodePacked(c3))==keccak256(abi.encodePacked("Benz")) ) {
    ...
    function cars(uint64 b0, uint64 b1) private pure 
    returns(string memory _b1, string memory c1_) {
        if (b0 == 1 && b1 == 1) return ("Jeep", "Toyota");
        return ("Toyota", "Jeep");
    }
