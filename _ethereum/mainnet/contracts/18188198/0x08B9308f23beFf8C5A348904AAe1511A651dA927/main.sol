...
contract DERPEPPObot is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DERPEPPObot";
    string private constant _symbol = unicode"DERPEPPO";
