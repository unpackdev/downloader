...
contract Orochi is Context, IERC20, Ownable {
    ...
    uint256 private preLPUnlockTime = 1835182700;
    ...
    constructor () payable {
        ...
        _name = unicode"Yamata no Orochi";
        _symbol = unicode"OROCHI";
        _decimals = 18;
        _owner = msg.sender;
        _totalSupply = 1_231_231_231  * 10 ** _decimals;
        marketingWalletAddress = payable(0x57E9A37bD0cf9e0044FEBb181b48a34F8670D888);
        teamWalletAddress = payable(0x57E9A37bD0cf9e0044FEBb181b48a34F8670D888);
