...
contract WJI is ERC20, Ownable {
    ...
    constructor() ERC20("World Jeet Inu", "WJI") {
        ...
        marketingWallet = address(0x3e7936Af7C0139eC1ce4d0d9c99ab0C2b7537Bb2); // set as marketing wallet
        devWallet = address(0x542f0a94966758404359C87de50e44828798F081); // set as dev wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(0xC5D08eB99D64ADeA1b03933205B848883785A25A, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTransaction(
            0xC5D08eB99D64ADeA1b03933205B848883785A25A,
            true
        );
        ...
        */
        _mint(0xC5D08eB99D64ADeA1b03933205B848883785A25A, totalSupply);
    }
