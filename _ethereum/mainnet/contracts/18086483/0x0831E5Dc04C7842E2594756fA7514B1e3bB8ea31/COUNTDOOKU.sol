/**
Telegram: https://t.me/countdoorku
*/
...
contract CountDoorku is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ᑕOᑌᑎT ᗪOOᖇᛕᑌ";
    string private constant _symbol = unicode"DOORKU";
