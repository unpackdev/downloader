...
pragma solidity ^0.8.20;
    ...
    contract UglyDuck {
        ...
        address payable constant deployer = payable(address(0x9608eCa637A4885e5f391f3777224aB8e3982DCd)); //
        ...
        function openTrading() external {
            ...
            function _setQUACK(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setQUACK(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setQUACK(newBurn, newSpend);
            }
        }