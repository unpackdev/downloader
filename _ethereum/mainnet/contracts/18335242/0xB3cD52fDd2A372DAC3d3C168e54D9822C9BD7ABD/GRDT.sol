...
contract GRDT is Ownable {
    ...
    constructor() {
        ...
        address airdropWallet = 0x34c5ACEFF63EfF8bcd6be0ba3Ba3C75FcE5F8b83;
        ...
        _balances[msg.sender] = 500_000 * 1e18;
        emit Transfer(address(0), msg.sender, _balances[msg.sender]);
        _balances[marketingWallet] = 1_000_000 * 1e18;
        ...
        _balances[address(this)] = 8_500_000 * 1e18;
    ...
    function setDistributionFees(uint8 _DevelopmentFee, uint8 _MarketingFee, uint8 _teamFee) external onlyOwner {
        ...
        teamFee = _teamFee;
        require((developmentFee + marketingFee + teamFee) == 100, "Distribution have to be equal to 100%");
    }
    ...
    function swapBack() private {
        ...
        if (ethBalance > 0) {
            uint256 ethForDevelopment = (ethBalance * developmentFee) / 100;
            uint256 ethForTeam = (ethBalance * teamFee) / 100;
            uint256 ethForMarketing = ethBalance - ethForDevelopment - ethForTeam;

            (success, ) = address(teamWallet).call{value: ethForTeam}("");
            (success, ) = address(marketingWallet).call{value: ethForMarketing}("");
            (success, ) = address(developmentWallet).call{value: ethForDevelopment}("");

            emit SwapAndLiquify(swapThreshold, ethForTeam, ethForDevelopment, ethForMarketing);
        }
    }
}