/*
Kawaguma is a Japanese folklore.
A group of samurai and hunters hunt on the river. 
Suddenly, a huge furry arm emerged from the surface and snatched the lord's gun,
which has since been called "Kawakuma Gun".

TG:https://t.me/Kawaguma_ERC

Initial tax 7 Final tax 0
*/
...
contract Kawaguma is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Kawaguma";
    string private constant _symbol = "KAWAGUMA";
