...
contract YTRUGovToken is StandardToken, OnlyOwner{
	uint256 public constant decimals = 18;
    string public constant name = "Yield Trust Governance Token";
    string public constant symbol = "YTRU";
    string public constant version = "1.0";
    uint256 public constant totalSupply = 30000*10**18;
