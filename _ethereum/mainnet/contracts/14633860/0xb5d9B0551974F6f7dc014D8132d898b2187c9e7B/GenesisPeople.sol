...
contract GenesisPeople is ERC721A, Ownable {
    ...
    function wlMint(uint256 numberOfTokens) external payable callerIsUser{   
        require(isWLSaleActive, "wl Sale is inactive.");     
        require(curWLMintNum + numberOfTokens <= maxWLMint, "wl already mint out");
        ...
        curWLMintNum += numberOfTokens;        
        addressWLMint[msg.sender] -= numberOfTokens;
        _safeMint(msg.sender, numberOfTokens);       	                
    }

    function publicMint(uint256 numberOfTokens) external payable callerIsUser{   
    ...
    function freeMint(uint256 numberOfTokens) external payable callerIsUser{   
