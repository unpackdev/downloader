...
abstract contract ERC20Detailed is IERC20 {
 ...
 contract JAPE is ERC20Detailed {
  ...
  string   constant tokenName     = "JACK APES";
  string   constant tokenSymbol   = "JAPE";
  uint8    constant tokenDecimals = 0;
  uint256  public   burnPct       = 7;
  uint256  private  _totalSupply  = 500;
  uint256  private  _txCap        = 15;
