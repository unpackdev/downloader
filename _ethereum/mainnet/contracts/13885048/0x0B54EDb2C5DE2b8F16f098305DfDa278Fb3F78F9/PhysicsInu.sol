/*
https://twitter.com/elonmusk/status/1475313375597019140

Physics Inu

https://t.me/PhysicsInu
*/
...
contract PhysicsInu is Context, IERC20, Ownable {
    ...
    string private _name = "Physics Inu";
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1000000, "Swap Threshold ");
