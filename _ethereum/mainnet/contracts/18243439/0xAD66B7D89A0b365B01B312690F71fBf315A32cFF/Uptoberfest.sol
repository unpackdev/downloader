...
Twitter:  https://twitter.com/UPTOBERFESTeth
Telegram: https://t.me/Uptoberfest
...
contract Uptoberfest is Context, IERC20, Ownable {
    ...
    string private constant _name = "Uptoberfest";
    string private constant _symbol = "UPTOBERFEST";
    ...
    uint256 public swapTokenAtAmount = 3000000000000 * 10**_decimals;
    ...
    function BombsAway() external onlyOwner {
        tradingActive = true;
    }
