// Telegram: https://t.me/astropepex 
// Discord:  
// Twitter: https://twitter.com/CroissantEth 
// Website: https://www.astropepex.com/
...
contract Astropepex is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x086C9E34586bBc235B9d67342b02d1eA6bb0D38e;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 150;
    uint16 public feeOwnerInitialPercentageSell = 150;
    uint16 public feeOwnerPercentageBuy = 150;
    uint16 public feeOwnerPercentageSell = 150;
    ...
    constructor() ERC20("AstroPepeX", "APX") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (10000000000000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0x086C9E34586bBc235B9d67342b02d1eA6bb0D38e, ownerReceiverSupply * 10 ** decimals());
        } else {
