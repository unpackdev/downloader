/*
        ...
        Website: https://turbothebot.com
        Twitter/X: https://twitter.com/turbothebot
        Telegram: https://t.me/turbobotofficial
...
contract TURBO is Context, IERC20, Ownable {
    ...
    string private _name = "Turbo Bot";
    string private _symbol = "TURBO";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1_000_000_000 * 10**18;
    uint256 private minimumTokensBeforeSwap = 2_000_000 * 10**18;
    uint256 public maxBuyLimit  = 20_000_001 * 10**18;
    uint256 public maxSellLimit  = 20_000_001 * 10**18;
    ...
    address payable public marketingWalletAddress = payable(0xbc22Ee9Dec5520A487A062C94802eC67d1611688); // Marketing Address
    address payable public DevWalletAddress = payable(0x5B6ddD1A20ABA69a05B4268eECAC2999626a1F17); // Dev Address
    ...
    maxBuyLimit  = _totalSupply;
    maxSellLimit  = _totalSupply;
    }
    ...
    // Contract Created by www.turbothebot.com

    
                //when buy
                if (isMarketPair[sender] && !isExcludedFromFee[recipient]) {
                require(balanceOf(sender).add(amount) <= maxBuyLimit);
                    
                }
                
                //when sell
                else if (isMarketPair[recipient] && !isExcludedFromFee[sender]) {
                        require(amount <= maxSellLimit, "sell transfer amount exceeds the maxSellTransactionAmount.");
                }
