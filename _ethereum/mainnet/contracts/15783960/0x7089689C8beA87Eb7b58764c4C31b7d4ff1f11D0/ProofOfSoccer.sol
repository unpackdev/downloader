...
contract ProofOfSoccer is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Proof Of Soccer";
    ...
    address public marketingWallet = 0xE51774d0C800536A80C864656Ea360c3591c55A0;

    uint256 public maxTxAmount = 40000000 * 10**_decimals;
    uint256 public maxWalletAmount = 40000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 1800000 * 10**_decimals;
