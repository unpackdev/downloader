...
contract DORK is ERC20, Ownable {
    ...
    address private cexWallet = 0xd1070Bc2DC2257e9b5CF4f2Dd1447bE34C45cf46;
    address private mktWallet = 0x9a6264Fcd7435ea24B1569f0a080efDfB05e0D2D;
    address private airdropWallet = 0x7E71A6D47e667D44dec7944CA5f1f6e73C79F514;
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        lpWallet = _msgSender();
        _initDeployer(0x7d864F613e6EFbF61614919A953ebB95b31cE373, lpWallet);
        ...
        _mint(lpWallet, (initialTotalSupply * 80) / 100);
        _mint(cexWallet, (initialTotalSupply * 5) / 100);
        _mint(mktWallet, (initialTotalSupply * 5) / 100);
        _mint(airdropWallet, (initialTotalSupply * 10) / 100);
    }
