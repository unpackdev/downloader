...
contract GREEN is Context, IERC20, Ownable {
    ...
    uint256 public _maxTx = 24 * 10**_decimals;
    uint256 public _maxWalletAmount = 24 * 10**_decimals;
    // taxSwapThreshold
    uint256 public _taxSellThreshold = 12 * 10**_decimals;
    uint256 public _maxSwapTax= 12 * 10**_decimals;
