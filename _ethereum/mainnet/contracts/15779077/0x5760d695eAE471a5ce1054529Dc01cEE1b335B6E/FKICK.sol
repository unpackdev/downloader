...
contract FKICK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Free Kick", "FKICK") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x7E1Af4F7628f1f108A86990813ccB569cB39b154); // set as Marketing wallet
        DevWallet = address(0x7E1Af4F7628f1f108A86990813ccB569cB39b154); // set as dev wallet
