...
contract OVERRATED is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Overrated", "OVERRATED") {
        ...
        marketingWallet = address(0x2fae76C0e2e693760e6e59AeBe7Cb7cA09aC7aaF); // set as marketing wallet
        devWallet = address(0x2fae76C0e2e693760e6e59AeBe7Cb7cA09aC7aaF); // set as dev wallet
