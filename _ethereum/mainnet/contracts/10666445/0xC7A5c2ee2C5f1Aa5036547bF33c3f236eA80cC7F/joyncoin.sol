...
/*
    ...
    Immuted Deploy to mainnet for Client - JOYN Social Media
...
/*
    ...
    Immuted Deploy, 5 Bilion total finite supply.

*/
contract joyncoin is StandardToken {
  string public name = "Joyn Social Media";
  string public symbol = "JOYN";
  uint public decimals = 18;
  uint public INITIAL_SUPPLY = 5000000000 * (10 ** uint256(decimals));

  function joyncoin() public {
