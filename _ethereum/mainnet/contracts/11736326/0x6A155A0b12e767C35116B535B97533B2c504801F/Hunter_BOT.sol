 ...
 * `ERC20` functions.
 */
contract Hunter_BOT is ERC20, ERC20Detailed, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string private constant NAME = "Hunter BOT"; 
    string private constant SYMBOL = "HBOT"; 
    ...
    uint256 public constant INITIAL_SUPPLY = 88888888 *(10 ** uint256(DECIMALS));
