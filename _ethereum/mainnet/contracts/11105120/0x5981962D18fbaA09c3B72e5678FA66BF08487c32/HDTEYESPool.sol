...
contract HDTTokenWrapper {
    ...
    //EYES
    IERC20 public stakeToken = IERC20(0x2DCA19E944453e46d9130950Ca135461b3Bc0c30); 
 ...
 * HDT-EYES Pool
 */
contract HDTEYESPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-EYES-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-EYES-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-EYES-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-EYES-POOL: Pool is closed");
        _;
    }
