...
contract BCCGDistributor is Ownable {
    ...
    mapping(address => mapping(uint256 => mapping(address => bool))) internal _history;
        ...
        returns (bool)
    {
        ...
        require(
            _amount == 1 && _history[_currentCard.contractAddress][_currentCard.tokenId][msg.sender] == false,
        ...
        _history[_currentCard.contractAddress][_currentCard.tokenId][msg.sender] = true;
