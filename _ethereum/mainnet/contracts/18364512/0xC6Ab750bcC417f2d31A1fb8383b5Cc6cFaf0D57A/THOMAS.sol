...
Thomas the Dank Engine is the OG meme machine, turning buds into ash getting the whole train lit! 
So, if you're tired of the same old boring shitcoins come and ride the Dank Express to new highs you've never been

Website -  https://www.danksmoke.site/

Telegram - https://t.me/thomasthedankenginecoin

Twitter -  https://twitter.com/TTDE_Coin
...
contract THOMAS is Context, IERC20, Ownable {
	...
	//Tax will be changed to 1/2 10 minutes after launch to prevent snipers.
    string private constant _name = "The Dank Engine";
    ...
    constructor() {
        ...
        taxWallet = payable(0x845DBEe4BAA6ca49b6F026a16B39801C75eA651f);
