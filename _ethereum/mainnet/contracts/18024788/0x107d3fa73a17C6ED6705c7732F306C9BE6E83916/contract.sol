...
Buy, sell, swap...With OTC bot

  Socials: 
  https://t.me/otcbotportal
  https://twitter.com/OTCBotErc
  https://otcboterc.com/
...
contract OTCBOT is Context, Ownable,IERC20 {
    string private constant _contract_name = "OTCbot";
    string private constant _contract_symbol = "OTC";
    ...
    uint256 private _reducedWhenBuyTaxs=5;
    ...
    uint256 private _InitialeUsedTaxSelling=3;
    uint256 private _InitialeUsedInSwapTaxSelling=3;
    uint256 private _TaxUsedBuyingFinalized=3;
    uint256 private _TaxUsedSellingFinalized=3;
    uint256 private _TaxCharityUsedSelling=3;
    ...
    address public _addressUsedInFundationFees = address(0xedCdA1938500bE3B57BF56C1E8f5F54Ff84E5b95);
