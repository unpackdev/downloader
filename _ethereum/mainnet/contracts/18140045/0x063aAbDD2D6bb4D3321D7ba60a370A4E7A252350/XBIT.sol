...
contract XBIT is IERC20, Ownable {
  string private constant _name = "X Bit";
  string private constant _symbol = "XBIT";
  ...
  address internal constant marketing_receiver =
      0x1f049A20689E67C5Fd1e984b60f2708536113f43;
  ...
  function setFees(
      ...
      marketingAmount = _marketing;
      developmentAmount = _development;
      totalAmount = _marketing + _development;
      sellAmount = totalAmount + _extraSell;
      transferAmount = _trans;
      require(
          totalAmount <= denominator && sellAmount <= denominator,
          "totalAmount and sellAmount cannot be more than the denominator"
      );
  }
  ...
  function setTxLimits(
      ...
      _maxTxAmountP = _newMaxTx;
      _maxTransferP = _newMaxTransfer;
      _maxWalletP = _newMaxWallet;
