/*
            ...
            ::::::::::.:::^^^:!#B?!Y&?.:::::::::::::.:::::::::.:::::::^^:::::::J&Y!7?P#!:::::::::^:::::::::.::::
            :::::::::::::::::^G#?77?#P..::::::...:::::::^~!!!^...:::::^^^:::..~BB777?J#5..::::.:^::::::::::::..:
            :.:::::::::^:....~#P?777Y#5^..:::::::......JBGGPBB!::::::::::...^J#G?777JJ#G:.:::::::.::::::::^:::::
            ::^^::::::::::::.~#PJ?777JGBY~:.::::.:^7JYP#B??7J##GPPY?~:...:!YBGJ77777JJ#P.:::::.::::::.:::^^^::::
            :::::::::..:::::.^#B?J77777JPBPJ7~:^JGBBBGB#B????B#BGPGBBGPY5GGPJ777777?J5&7.:.::::^^^^^^:::.:::::::
            :::...::::::::::..Y&5J?77777!?Y5PGG##BG55P##GJJJYP##G55PB#&GYYJYY7777?JJ5&Y..:::^^^^^^^^^^:.::::::::
            ::::::^^^^^:.::::::5&PJJ??777JYYYJ5##BGPGB##P5P555##BBGGB##GYY555YJYYJYG#?..:::^^^^^^^^^^^:.::::::::
            ::::^^^^^^^::::::^::?BB5JYYYY5YYYYP##BBB####BGBBBG##########G5YYYYYY5GB5!::::::::^^^^:::::::::::::::
            :::::^^^:::.:::::::..^JGBP5YYY55PG####BBGGPPP5555555555PPGBB##BBGPPBGJ~::::::::..::::::..::^::::::::
            ::::.::::.:::::::::::..:7YGGGBB##BP5YJ????????JJJJJJJJJ?????J5PGB#&P::::::::::::::::::::::::::::::::
            :^::::::::::.:::::::::::..:Y#BGPY5YYY5PPPGGGBBBBBBBBBBBBGGGGGPP555#B:.:::::::^::::::::::::::::::::::
            ::::::::::^::::::::::::::.:G&5PGGBBBGP5PBY##?777!??J##?BYJJYPPBBGP5?:.:::::::::::.::::^^^:::::::::::
            ^::.:::::::::::::::::.::::.!Y555GJ^:.:^J#G&P.  ::.^!G#GBY!~~77Y?:::.::::::::::::::::::^^^:::::::::^^
            ^^^:::::::::::^^^::::::::::....:JY:...!?^7!:.~!GG!~^!JJ7J7~7J?P?::^:::::::::^^^^^^:.::::::::::::^:^^
            ::^^^^:.::::::^^:::::::::^::::::^5?:..7......:JPPY:..:^^!J7??55^^::::::::.::::::::^:::::::::::::::::
            ::^^^:::::.:::::::::::::::::::.:~!JJ~:^...............:^!!!7J7~~:...::::::::::::::::::::::^:::::::::
            :::^:::::::.:::::::::..::::::::::::^7???7!~^^^^^^^~~!77????!:...:::::::^::::::::::::::::::::.:::::::
            ...
            ::::::::::::::::::::::::::::::::::::::..:::...::::::.....:^^:::::::::::::::::::::::::::::::::::::::^
                            ...
                            Site        :   https://catoki.vip/


                            Twitter     :   https://twitter.com/catoki_erc



                            Telegram    :   https://t.me/catoki_erc
...
interface IUniswapV2Router01 {
    ...
    function FROMASSINU(uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        payable
...
contract CATOKI is Context, IERC20 { 
    ...
    address payable public LINEFUNDING = payable(0xEC45B1f04694cededf1833577F196BF7885a64d1); 
    address payable public BOYSLIKEFANTAWALLET = payable(0xbB638545BB474fc7A40e67625b20cB5494A57f6c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = unicode"CATOKI"; 
    ...
    constructor () {
        ...
        _isExcludedFromFee[LINEFUNDING] = true; 
        _isExcludedFromFee[Wallet_Burn] = true;

        _ExemptMaxWalletLimit[address(uniswapV2Pair)] = true;
        _ExemptMaxWalletLimit[LINEFUNDING] = true;
        ...
        _ExemptMaxTxLimit[LINEFUNDING] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(LINEFUNDING, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(BOYSLIKEFANTAWALLET, removeRandom);
