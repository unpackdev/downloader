...
contract Spoof is ERC20, Ownable {
    ...
    constructor() ERC20("Spoof Of Shiba", "SPOOF") {
		...
		charityWallet = address(0x105163C717537360a5779FD406Ee1C51Ddfc827F); // set as charity wallet
        marketingWallet = address(0x105163C717537360a5779FD406Ee1C51Ddfc827F); // set as marketing wallet
        devWallet = address(0x0b6948787A2025aA8719280A5658619d3827F54E); // set as dev wallet
