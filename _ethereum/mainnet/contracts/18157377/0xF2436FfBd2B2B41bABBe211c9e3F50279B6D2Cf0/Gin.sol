...
abstract contract SolMateERC20 {
    ...
    /*//////////////////////////////////////////////////////////////
                            METADATA STORAGE
    //////////////////////////////////////////////////////////////*/
    string public constant name = "TestingGin";
    string public constant symbol = "TestGin";
...
// File: contracts/TestNetStuff/Final_gin_testing.sol
    ...
    constructor()
{
    ...
    function _testInit() public {
        ...
        permitSigner(address(0xbEef104d06D68880080b9c63D482867E59aCD560));//beefy1
        permitSigner(address(0xBeeF2c7f2A3704723fE7F9283ca9A9427233c1b7));//beefy2
    }
