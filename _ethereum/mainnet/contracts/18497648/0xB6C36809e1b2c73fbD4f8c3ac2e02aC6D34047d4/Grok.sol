...
// https://t.me/GrokPortal
// https://twitter.com/xGrokAI
...
interface UniswapUniversalRouter {}
...
contract Grok is ERC20, Ownable {
    ...
    // states
    address constant FEE_RECEIVER = 0x4e8a7E4867348435ADDF373F0343A72478D8E47b;

    uint256 public constant MAX_SUPPLY = 1 * 1e9 ether;
    IUniswapV2Router02 public constant UNISWAP_V2_ROUTER =
        IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    uint256 private constant INITIAL_MAX_TRANSACTION_AMOUNT = 3 * 1e7 ether; // 3% from total supply maxTransactionAmountTxn
    uint256 private constant INITIAL_MAX_WALLET = 3 * 1e7 ether; // 3% from total supply maxWallet

    uint256 private constant INITIAL_BUY_FEE = 15;
    ...
    constructor() ERC20(unicode"GrōkAI", unicode"GROK") {
        // set states
