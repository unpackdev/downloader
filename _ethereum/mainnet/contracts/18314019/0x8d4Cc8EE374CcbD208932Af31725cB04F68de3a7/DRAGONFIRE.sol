...
//
//  ___    ____    ____   ____   ___   ____   _____  ____  ____     ___ 
// |   \  |    \  /    | /    | /   \ |    \ |     ||    ||    \   /  _]
// |    \ |  D  )|  o  ||   __||     ||  _  ||   __| |  | |  D  ) /  [_ 
// |  D  ||    / |     ||  |  ||  O  ||  |  ||  |_   |  | |    / |    _]
// |     ||    \ |  _  ||  |_ ||     ||  |  ||   _]  |  | |    \ |   [_ 
// |     ||  .  \|  |  ||     ||     ||  |  ||  |    |  | |  .  \|     |
// |_____||__|\_||__|__||___,_| \___/ |__|__||__|   |____||__|\_||_____|
...
contract DRAGONFIRE is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = (_totalSupply * 10) / 100; // 1% from total supply maxTransactionAmountTxn;
    uint256 public swapTokensAtAmount = (_totalSupply * 10) / 1000; // 0.1% swap tokens at this amount. (888_000_000 * 10) / 88000 = 0.1%(88000 tokens) of the total supply
    uint256 public maxWallet = (_totalSupply * 10) / 100; // 1% from total supply maxWallet
    ...
    constructor() ERC20("DRAGONFIRE", "DFS") {
