...
/*
   ...
   A project to celebrate all the balls created for the World Cup, especially Al Rihla.
   https://worldcupball.me/
   t.me/WorldCupBall
...
contract WorldCupBall is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xeBEcE5CF4871d2fBCaBBF50de991373dF9E80a3f); 
    address payable public devWallet = payable(0xEe10d349405B068201FeEe7BF50090e2A8192A1D);
    ...
    constructor() ERC20("World Cup Ball", "WCB") {
