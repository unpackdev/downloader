 ...
 */
contract FWETH is Ownable, ERC4626ETH, Messaging, ReentrancyGuard, Pausable {
    ...
    function deposit(
        address receiver
    ) public payable override onlyAllowedLiquidityProviders returns (uint256) {
     ...
     */
    function _sendToUser(address payable user, uint256 amount) internal {}
