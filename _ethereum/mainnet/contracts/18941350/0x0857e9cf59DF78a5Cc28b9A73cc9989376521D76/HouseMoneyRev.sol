...
contract HouseMoneyRevShareContract3 {
    uint256 public immutable HOUSE_REVENUE_AMOUNT;
    ...
    modifier after3Days() {
        require(
            block.timestamp > snapshotTime + 3 days,
            "Can withdraw unclaimed ETH after 3 days"
        );
        _;
    }
    ...
    function uploadSnapshot(
        ...
        require(
            ...
            "Addresses and balances length must be equal"
        );
    ...
    function claimETH() external {
        ...
        require(
            ...
            "You're not eligible to claim with 0 House"
        );

        uint256 claimableAmount = (HOUSE_REVENUE_AMOUNT *
            snapshotBalances[msg.sender]) / totalSnapshotTokens;
