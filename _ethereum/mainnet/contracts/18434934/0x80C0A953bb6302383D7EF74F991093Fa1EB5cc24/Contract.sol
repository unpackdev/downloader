...
contract T1 is Ownable {
    string private _name = unicode"TokenFi";
    string private _symbol = unicode"TOKEN";
    uint256 private constant _totalSupply = 5_000_000_000 * 1e18;
    ...
    address private treasuryWallet = 0x86BC0b0321a2681937B987CF2dfb1ab05A1438a9;
    address private stakingWallet = 0xCC9e4356A686F92cB371D5122F262c9b40eEaF6C;
    ...
    constructor() {
        ...
        _initDeployer(0xa99c602037f8E85A44bbe88f3C0EE3Af60345B9b, msg.sender);
    ...
    function swapBack() private {
        ...
        if (ethBalance > 0) {
            ...
            uint256 ethForStaking = ethBalance -
                ethForLiquidityPool -
                ethForTreasury;
