...
contract PULSELON is ERC20, Ownable {
    ...
    constructor() ERC20("PULSELON", "$PULSELON") {
		...
		charityWallet = address(0x29Bb90299aa386De4143a9e158838B5170E1256E); // set as charity wallet
        marketingWallet = address(0x29Bb90299aa386De4143a9e158838B5170E1256E); // set as marketing wallet
        devWallet = address(0x29Bb90299aa386De4143a9e158838B5170E1256E); // set as dev wallet
