...
Website: https://megachad.vip
Telegram: https://t.me/TheMegaChad
X: https://x.com/TheMegaChads
*/
...
contract MegaChad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private _name = "MegaChad";
    string private _symbol = unicode"MEGA🗿";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x4C027F17adA21AfA3D75C9f19A737E319089E0a0);
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(10).div(100);  //2%
    uint256 public _walletMax =   _totalSupply.mul(10).div(100);   //2%
