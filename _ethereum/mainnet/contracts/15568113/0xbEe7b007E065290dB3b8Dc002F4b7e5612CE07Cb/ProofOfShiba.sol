/**
   The Proof of Shiba, is an ERC-20 token that fuels the Shiba ecosystem.
    Comprising two separate tokens – SHIBA and PROOF – that users can stake, 
    swap or deposit into liquidity pools on the Uniswap decentralized exchange 
    to earn interest and rewards.

   Proof of Shiba is generally perceived as a meme currency similar to other
    dog-themed cryptocurrencies such as dogecoin and has a similarly viral 
    following of more than 1.2 million people on Twitter. PShiba’s price often
    makes news headlines, as it routinely notches tremendous gains and endures equally steep losses..

WEBSITE: https://www.proofofshiba.com/
TWITTER: https://twitter.com/ProofofShiba?t=3eMGcCNjfAKjlrP7Zrx5Jw&s=09
GITBOOK:  https://proofofshiba.gitbook.io/pos-erc/
TELEGRAM: https://t.me/ProofOfShibaERC   
*/
...
contract ProofOfShiba is IERC20, Ownable {
