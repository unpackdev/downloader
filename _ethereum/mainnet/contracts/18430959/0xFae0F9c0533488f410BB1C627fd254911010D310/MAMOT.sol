...
pragma solidity ^0.8.20;
    ...
    contract MAMOT {
        string public constant name = "MAMOT";  //
        string public constant symbol = "MAMOT";  //
        ...
        address payable constant deployer = payable(address(0x7bCE542C86BD742ae1Cb51DA770f05895Aa2a164)); //
