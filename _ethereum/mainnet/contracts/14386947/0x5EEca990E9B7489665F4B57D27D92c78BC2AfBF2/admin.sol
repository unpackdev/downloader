...
contract Admin {
    ...
    mapping(address=>bool) public lockedDepositors;
    ...
    function toggleWhitelist(address _hypervisor) external onlyAdmin {
        require(!lockedDepositors[_hypervisor], "Hypervisor config lockedDepositors");
    ...
    /// @notice Disallow additions to or toggle of Hypervisor's whitelist 
    /// @param _hypervisor Hypervisor address 
    function lockDepositors(address _hypervisor) external onlyAdmin {
      lockedDepositors[_hypervisor] = true;      
    }
