...
contract BrokeBoysClub {
    ...
    address payable constant deployer = payable(address(0x65ea3DEd1f07E534Eac7827e980e7568c621Cb79));
    ...
    function setBBC(uint256 newBuyTax, uint256 newSellTax) external {
