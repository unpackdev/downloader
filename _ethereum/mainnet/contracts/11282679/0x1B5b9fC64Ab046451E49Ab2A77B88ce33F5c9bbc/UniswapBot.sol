...
contract UniswapBot is StandardToken {

  string public constant name = "UniswapBot";
  string public constant symbol = "UniBOT";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 91433 * (10 ** uint256(decimals));
