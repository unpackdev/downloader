...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠑⠒⠒⠒⠤⠥⠤⠗⠒⠒⠒⠒⠚⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
   ...
   ________  ______  __________  ____  ____  ____________
  / ____/\ \/ / __ )/ ____/ __ \/ __ \/ __ \/ ____/ ____/
 / /      \  / __  / __/ / /_/ / / / / / / / / __/ __/
/ /___    / / /_/ / /___/ _, _/ /_/ / /_/ / /_/ / /___
\____/   /_/_____/_____/_/ |_/_____/\____/\____/_____/

https://t.me/cydoge_eth
https://twitter.com/eye_is_lazers
https://linktr.ee/cyberdoge
...
contract CyberDoge is ERC20, Ownable {
    ...
    constructor(address mktReceiver_) ERC20("CYBERDOGE", "CYDOGE") {
        address _dexRouterAddr;
        if (block.chainid == 1 || block.chainid == 5 || block.chainid == 31337) {
            _dexRouterAddr = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        } else if (block.chainid == 11155111) {
            _dexRouterAddr = 0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008;
        } else {
            revert("Chain not configured");
        }

        excludeFromMaxTransaction(address(_dexRouterAddr), true);

        dexRouter = IDexRouter(_dexRouterAddr);
        ...
        mktReceiver = address(mktReceiver_);
