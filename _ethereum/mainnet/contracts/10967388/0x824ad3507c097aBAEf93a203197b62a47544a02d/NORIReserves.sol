...
contract NORIReserves {

    // Token that serves as a reserve for NORI
        ...
        onlyGov
    {
        ...
        NORITokenInterface(noriAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        NORITokenInterface(noriAddress).approve(rebaser_, uint256(-1));
