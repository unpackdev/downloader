...
contract LakersEmpire is StandardToken {

  string public constant name = "Lakers Empire";
  string public constant symbol = "LAKs";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 81847 * (10 ** uint256(decimals));
