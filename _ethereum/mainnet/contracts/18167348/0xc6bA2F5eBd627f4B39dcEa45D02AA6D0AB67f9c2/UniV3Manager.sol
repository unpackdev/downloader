...
contract UniV3Manager is ERC20 , AccessControl {
        ...
        )
    {
        ...
        token0.safeApprove(address(NonfungiblePositionManager), params.amount0Desired);
        token1.safeApprove(address(NonfungiblePositionManager), params.amount1Desired);
    ...
    {
        token0.safeApprove(address(NonfungiblePositionManager), amount0Desired);
        token1.safeApprove(address(NonfungiblePositionManager), amount1Desired);
