...
Twitter:  www.twitter.com/FlowProtocolERC
Medium: https://medium.com/@flowprotoerc
*/
...
contract FlowProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Flow Protocol", "FLOW") {
        ...
        maxTransactionAmount = 2000000 * 1e18; // 2% 
        maxWallet = 2000000 * 1e18; // 2% 
        ...
        developmentWallet = address(0x76F200381583e301DE069fd14C67944Cd1b0A348); // set as development wallet
        marketingWallet = address(0xEDB790e43D3faEb3cB229AfF40f52F986968B2A8); // set as marketing wallet
        devWallet = address(0xA35dD2C3C3b355DaB75d565f76CaF6D14F0a5c3d); // set as dev wallet
