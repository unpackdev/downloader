...
$KNIGHT
Skill and confidence add up to an invincible army.
...
interface IUniswapV2Router02 {
    ...
    contract Knight  {
        ...
        string public   _name = "Knight"; 
        string public   _symbol = "KNIGHT";  
        uint8 public constant decimals = 8;
        uint256 public constant totalSupply = 100000000 * 10**decimals;

        uint256 buyHFTax = 10;
        uint256 sellHFTax = 10;
        ...
        address payable constant Mkktt = payable(0x959263656Ce8dcA7F83c453A60927F78933540A3);
