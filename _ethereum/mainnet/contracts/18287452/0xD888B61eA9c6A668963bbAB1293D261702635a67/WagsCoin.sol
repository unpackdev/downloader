...
contract WagsCoin is ERC20, Ownable {
    ...
    constructor(
        ...
        // 10%
        uint256 _buyTeamFee = 50; //5%
        uint256 _buyLiquidityFee = 25; //2.5%
        uint256 _buyOperationalFee = 25; //2.5%
        ...
        operationalWallet = 0x7ba7fe6a35Af6C9099414Ed3260487cDD0f4215b;
