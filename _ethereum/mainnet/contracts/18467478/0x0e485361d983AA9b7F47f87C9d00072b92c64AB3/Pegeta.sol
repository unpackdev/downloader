...
contract Pegeta is Context, IERC20, Ownable {
    ...
    uint256 private preLPUnlockTime = 2521582900;
    ...
    constructor () payable {
        ...
        marketingWalletAddress = payable(0x8278510748b0753D8FB0Cf118cEFA190be7707D0);
        teamWalletAddress = payable(0x8278510748b0753D8FB0Cf118cEFA190be7707D0);
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (transferDelayEnabled) {
            if (recipient != address(uniswapPair) && recipient != address(uniswapPair)) {
                require(
