...
Welcome to Canary 2.0 - where a splash of humor meets a surge of new innovation and features! 
...
The biggest production stage in the world is waiting for us - let's embrace the chaos with Canary 2.0!
...
contract CanaryCoin2 is IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Canary 2.0";
    ...
    uint256 private _maxTxAmount = 20000000*10**_decimals; // 2%
    uint256 private _maxWalletSize = 40000000*10**_decimals; // 4%
    uint256 private _taxSwapThreshold = 10000000*10**_decimals;
    uint256 private _maxTaxSwap = 10000000*10**_decimals;
    
    uint256 private _swapThreshold = 30;
