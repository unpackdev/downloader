...
contract YFIINCstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YFIINC Token Contract Address
    address public constant tokenAddress = 0x3Fb1c4767eE4a91FB349A6238B1005BDAB5B84b3;
    ...
    uint private constant stakingAndDaoTokens = 2000e18;
    ...
    // function to allow admin to claim *other than YFIINC* ERC20 tokens sent to this contract (by mistake)
