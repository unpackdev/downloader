/**
 *CAE  is building a blockchain ecosystem that includes digital social networking, digital identity, digital assets, online shopping malls, and Internet games. It is a wallet, an identity ID, a social tool, a transaction link, a game chip, a technological innovation in Internet technology, and a value router in the era of digital economy.
*/
