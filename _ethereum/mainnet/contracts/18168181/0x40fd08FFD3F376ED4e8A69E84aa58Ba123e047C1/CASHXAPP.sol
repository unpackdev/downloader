...
contract CASHXAPP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CASHXAPP";
    string private constant _symbol = unicode"CASHXAPP";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x2bA7Bbc0653Ec6d8E403aAdE6481c6ED52Bb15f1);
