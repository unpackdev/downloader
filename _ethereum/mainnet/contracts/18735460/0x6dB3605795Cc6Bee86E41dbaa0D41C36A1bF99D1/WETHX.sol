...
contract WETHX is XToken {
    uint256 public constant GENESIS_SUPPLY = 0.1 ether; // 0.1 will be minted at genesis for liq pool seeding

    address public operator;
    bool public openTrading = false;
    mapping(address => bool) public whitelistAddresses;

    constructor(string memory _name, string memory _symbol,address _owner) XToken(_name, _symbol) {
