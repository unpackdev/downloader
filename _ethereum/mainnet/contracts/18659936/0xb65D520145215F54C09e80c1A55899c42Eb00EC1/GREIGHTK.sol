...
contract GREIGHTK is ERC20, Ownable {
    ...
    constructor() ERC20("GR8K", "GR8K") {
        ...
        maxTransactionAmount = 9_600 * 1e18;
        maxWallet = 9_600 * 1e18;
        swapTokensAtAmount = 1_600 * 1e18;
    ...
    function Gr8klaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsAreGr8k() external onlyOwner {
