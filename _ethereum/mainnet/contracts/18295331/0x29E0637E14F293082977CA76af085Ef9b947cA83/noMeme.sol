...
https://t.me/NoMemeCommunity
https://x.com/nomemeerc
...
contract noMeme is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69420210000 * 10**_decimals;
    string private constant _name = unicode"NO MEME";
    string private constant _symbol = unicode"NO MEME";
    uint256 public _maxTxAmount =   1388404200 * 10**_decimals;
    uint256 public _maxWalletSize = 1388404200 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=1388404200 * 10**_decimals;
