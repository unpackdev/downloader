/**
* TAX will be used to mostly buy ARMY and NUCLEAR plus the ISHLANDS call or buy back
* and burn... but mostly PORT and SHIPS.... oh and AeroPlanes 🛫 - thank you.
*
* LAUNCH PLAN.
*
* 0) Add LP
...
* 3) 31-45 mins 25%
* 4) 46-60 mins 14%
* 5) 91-120 mins 7% - LP lock for 2 months
* 6) next 24 hours 4%
* 7) then tax = 3% - Renounce Contract.
* 8) Calls, marketing, BB&B, Army, Port, Aeroplanes etc. 🛫
*
* >> LP lock to be extended to 2 years at 100K MC <<
*
* >> The Fabulous Crypto Leaders will fully dox at 2 million MC <<
 ...
 * allowances. See {IERC20-approve}.
 */
contract NewUniverseOrder is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "New Universe Order";
    string private _symbol = "NATION";
    uint8 private _decimals = 18;
    uint256 private _supply = 50000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 70;
    uint256 public maxTxAmount = 1000 * 10**_decimals;
    uint256 public maxWalletAmount = 1000 * 10**_decimals;
    address public marketingWallet = 0x06d51CDdf57B8E23033d4ea0D8Eb6012bEe1c076;
