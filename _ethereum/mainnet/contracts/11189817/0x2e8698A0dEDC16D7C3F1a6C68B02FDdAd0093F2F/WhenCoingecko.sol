...
contract WhenCoingecko is StandardToken {

  string public constant name = "When Coingecko";
  string public constant symbol = "WCK";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 95613 * (10 ** uint256(decimals));
