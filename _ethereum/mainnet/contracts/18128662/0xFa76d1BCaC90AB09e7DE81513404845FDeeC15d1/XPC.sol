...
contract XPC is ERC20, Ownable {
    ...
    constructor(address revShareWallet_, address teamWallet_, address routerAddress_, address factoryAddress_, string memory name_, string memory symbol_) ERC20(name_, symbol_) {
        ...
        uniswapV2Pair = IUniswapV2Factory(factoryAddress_)
        ...
        revShareWallet = revShareWallet_; // set as revShare wallet
        teamWallet = teamWallet_; // set as team wallet
