...
contract PGfinal is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("PulseCorgi", "PLCG") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x01315Ac2Bfb091A67c17D5E299B9c2BcA62C0025); // CHANGE THIS TO YOURS
        devWallet = payable(0x5748ea2476486510566b28eaC5b7d4E2700C4323); // CHANGE THIS TO YOURS
