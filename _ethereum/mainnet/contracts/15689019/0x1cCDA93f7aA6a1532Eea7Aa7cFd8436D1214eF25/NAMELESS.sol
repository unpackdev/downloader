...
contract NAMELESS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Nameless";
    ...
    address payable private _developmentAddress = payable(0xA537C232702565903fab3F847CE7b68bad4aeB99); 
    address payable private _marketingAddress = payable(0xA537C232702565903fab3F847CE7b68bad4aeB99);
