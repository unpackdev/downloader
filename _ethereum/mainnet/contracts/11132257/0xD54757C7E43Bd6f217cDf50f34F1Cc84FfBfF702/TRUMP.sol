/*
Hey you! Welcome to GAMiNGPOiSON Collective. You may wonder what this is. We are a crypto contest project in which every day we run a new contest with different rules and rewards. 
That sounds exciting, right? Yeah, damn exciting. You wanna know the rules and rewards, well join our telegram group:
...
contract TRUMP is ERC20Detailed {
  ...
  string constant tokenName = "TRUMP";
