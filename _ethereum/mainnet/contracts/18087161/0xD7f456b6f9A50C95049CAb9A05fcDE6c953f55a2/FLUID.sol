...
/**
   Start small, think big. Don’t worry about too many things at once. Take a handful of simple things to begin with, 
    and then progress to more complex ones. Think about not just tomorrow, but the future. Put a ding in the universe.  — Steve Jobs
   https://t.me/FluidToken
   https://twitter.com/FluidFiToken
**/
...
// Creating modern and efficient trading tools for our digital world.
contract FluidDaoToken is Context,ERC20, Ownable {

    bool private swapping;

    ISFwd public teamWallet=ISFwd(0xCE54245ae51b916c75d5fB374C7F2B239C70487e);

    uint256 _totalSupply = 100_000_000 * 1e18; 
    uint256 _lp = (_totalSupply* 450)/1000; 

    uint256 public maxTransactionAmount = (_totalSupply * 10) / 1000;
    uint256 public swapTokensAtAmount = (_totalSupply * 5) / 100000;
    ...
    string private constant _name = unicode"FluidTradeToken";
    string private constant _symbol = unicode"FLUID";

    constructor() ERC20("FluidTradeToken", "FLUID") {
