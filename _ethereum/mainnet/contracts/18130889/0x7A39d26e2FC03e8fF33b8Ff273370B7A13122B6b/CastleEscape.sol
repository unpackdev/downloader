...
https://t.me/CastleEscape
https://castleescape.cfd
...
contract CastleEscape  {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Castle Escape";   
    string public constant symbol = "CTEP";   
    ...
    address payable constant deployer = payable(address(0x170aD039B92326409828FdA2DbC04B60dD054936));
    ...
    function setCTEP(uint256 newBuyTax, uint256 newSellTax) external {
