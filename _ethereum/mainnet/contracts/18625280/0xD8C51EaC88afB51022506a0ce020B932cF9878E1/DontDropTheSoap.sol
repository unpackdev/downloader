...
别让肥皂掉下来 - DON'T DROP THE SOAP CZ
...
contract DontDropTheSoap is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"别让肥皂掉下来";
    string private constant _symbol = unicode"别让肥皂掉下来";
