...
contract SteakToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    ISteakStaking public stakingContract;
    ...
    function setStakingContract(ISteakStaking stakingContract_) public onlyOwner {
