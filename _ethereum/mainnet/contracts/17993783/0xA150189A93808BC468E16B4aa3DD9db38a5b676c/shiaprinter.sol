...
contract ShiaDrucker is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0x26a5cE5620527599c143157954104e5bdFE5812f);
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 7, "Fee can't exceed 9%");
        totalFee = _fee;
    }
