...
contract PLASMA is Context, IERC20, Ownable {
    ...
    uint256 public _taxSwapThreshold= 1000000000 * 10**_decimals; // initial high threshold
    ...
    function updateSwapThreshold(uint256 _newValue) external onlyOwner() {
        _taxSwapThreshold= _newValue * 10**_decimals;
        _maxTaxSwap= _newValue * 10**_decimals;
    }
