...
// Telegram: https://t.me/uglyercportal 
// Discord:  
// Twitter: https://twitter.com/uglyERC 
// Website: https://ugly.mom/
...
contract Ugly is ERC20, Ownable {
    ...
    uint256 public constant TIME_LIMIT = 60 * 60;
    ...
    address private feeReceiverOwner = 0xdbD79DB1e67598A7B66a928e9532777d2CF1C9Ba;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 0;
    ...
    constructor() ERC20(unicode"UGLY", unicode"UGLY") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xdbD79DB1e67598A7B66a928e9532777d2CF1C9Ba, ownerReceiverSupply * 10 ** decimals());
        } else {
