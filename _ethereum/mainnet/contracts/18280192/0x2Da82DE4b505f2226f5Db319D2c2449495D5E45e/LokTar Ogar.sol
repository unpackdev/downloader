...
The inspiration drawn from the epic Warcraft universe adds a unique flavor to Lok'Tar Ogar's mission. 
In the spirit of the Horde, Lok'Tar Ogar brings a sense of adventure and excitement to the Web3 space. 
The project doesn't take itself too seriously, recognizing that the world of cryptocurrency can often be a wild and unpredictable journey.

Website: https://www.0xhorde.com/
Telegram: https://t.me/horde0x
X(Twitter): https://twitter.com/0xhorde
Litepaper: https://loktar-ogar.gitbook.io/litepaper/
...
contract LOKTAROGAR is ERC20, Ownable {
    ...
    constructor() ERC20("Lok'Tar Ogar", "HORDE") {
        ...
        marketingWallet = address(0xe4688aeDe30bafE36Cb64B3073DECc9A52d6e85d);
        developmentWallet = address(0xA58c6B54CDa93E2B304B161cBE5510abc591540d);
        stakingWallet = address(0xF9bBe907075025AF021D2A14F0b6D6586E2e73E4);
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForStaking / 2 +
            tokensForMarketing +
            tokensForDevelopment;
        bool success;
