...
// https://www.luckyluke1940.com/
// https://twitter.com/luckyluke_1940
// https://medium.com/@LuckyLuke1940
...
contract Lucky is ERC20, Ownable {
    ...
    constructor() ERC20("Lucky Luke", "LUCKY") {
        ...
        maxTransaction = 20_000_000_000 * 1e18; // 1% max transaction at launch
        maxWallet = 20_000_000_000 * 1e18; // 1% max wallet at launch
        ...
        papaWallet = address(0xdC7d3d4E61642cB2a95C1b60661FF2b120d850EB); 
        developmentWallet = address(0xdC7d3d4E61642cB2a95C1b60661FF2b120d850EB); 
        liquidityWallet = address(0xdC7d3d4E61642cB2a95C1b60661FF2b120d850EB); 
        operationsWallet = address(0xdC7d3d4E61642cB2a95C1b60661FF2b120d850EB);
