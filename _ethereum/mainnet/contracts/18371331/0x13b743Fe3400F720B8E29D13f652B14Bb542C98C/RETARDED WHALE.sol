...
Portal - t.me/+ARSGxu8BmyZmM2Fk
Twitter - x.com/walethofficial
http://www.retardedwhale.com
...
contract RETARDEDWHALE is Context, IERC20, Ownable {
    ...
    string private constant _name = "RETARDED WHALE";
    string private constant _symbol = "$WAL";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xd5D5C1E8BC32771B54325A346836b372e99B69D5);
        ...
        emit Transfer(address(0xd5D5C1E8BC32771B54325A346836b372e99B69D5), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokensTooSwapFrFes(uint256 amount) external onlyOwner() {
