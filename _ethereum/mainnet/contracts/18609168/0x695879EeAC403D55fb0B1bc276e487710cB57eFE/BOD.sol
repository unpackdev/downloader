...
contract BOD is ERC20, Ownable {
    ...
    function BodLaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsAreBodOver() external onlyOwner {
