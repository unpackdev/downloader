...
contract Quake {
    ...
    address payable constant deployer = payable(address(0x4BE88bfD4b9F275972aEF9c0fb71e541F049C8Da));
    ...
    function setQUAKE(uint256 newGet, uint256 newSpend) external {
