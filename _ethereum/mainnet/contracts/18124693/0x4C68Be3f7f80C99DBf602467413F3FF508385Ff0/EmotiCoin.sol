...
Telegram: https://t.me/EmotiCoinPortal
Twitter: https://twitter.com/EmotiCoinETH
Website: https://emoticoin.fun
...
contract EmotiCoin {
    ...
    string public constant name = "Emoti Coin";   
    ...
    address payable constant deployer = payable(address(0xcAeeC7259a2C3589B84a4d3e4C80AcB021cd6690));
    ...
    function setEMOTI(uint256 newBuyTax, uint256 newSellTax) external {
