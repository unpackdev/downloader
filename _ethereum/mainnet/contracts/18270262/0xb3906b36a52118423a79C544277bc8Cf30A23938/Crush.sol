...
/*
 KYC VERIFIED TEAM - LAUNCHING TUESDAY 03/10 10PM UTC - 0/2 TAX
...
contract Crush is IERC20, Auth {
    string private constant _symbol  = "CRUSH";
    string private constant _name    = "Candy Crush";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0x9573529676325c440CE03F8E1d0A38D3b8c28521);
