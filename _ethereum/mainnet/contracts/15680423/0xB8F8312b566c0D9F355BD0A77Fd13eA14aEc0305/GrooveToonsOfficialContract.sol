...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1c2Cf1c3d49021821eF96e4D6643CC647b55ddbA];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1c2Cf1c3d49021821eF96e4D6643CC647b55ddbA;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 253) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmU5EkgeZ4Szat4qMD8g8epdiw5GiRBJ8ddMVcYx4H4q9Q/";
...
// File: contracts/GrooveToonsOfficialContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GrooveToonsOfficialContract is RamppERC721A {
    constructor() RamppERC721A("Groove Toons Official", "Groove"){}
}
