...
contract CUCUMBERMAN is ERC20, Ownable {
    ...
    constructor() ERC20("Cucumberman", "CUCUMBERMAN") {
        ...
        marketingWallet = address(0x1b66d890833Bff15DAd5389648e3d3d57e0Dac14); // set as marketing wallet
        devWallet = address(0xe75811a2b47E53c0551b25B725D65470A1444a59); // set as dev wallet
