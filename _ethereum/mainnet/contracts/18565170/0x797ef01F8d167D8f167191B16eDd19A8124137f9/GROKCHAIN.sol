...
SOCIALS
🌐https://twitter.com/GrokChainERC
🟦 https://www.grokchain.world
💙https://t.me/GrokChainEthX
...
contract GROKCHAIN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$GrokChain";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x57368Dc495300C9D3673fC1FC6d8Eb1A4b04F23B);
        ...
        emit Transfer(address(0x57368Dc495300C9D3673fC1FC6d8Eb1A4b04F23B), _msgSender(), _tTotal);
    }
    ...
    function setMxTokensTooSwapFooorFes(uint256 amount) external onlyOwner() {
