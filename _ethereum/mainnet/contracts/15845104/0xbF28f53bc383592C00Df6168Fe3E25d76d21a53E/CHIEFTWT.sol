...
contract CHIEFTWT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"The bird is freed";
    string private _symbol = unicode"CHIEFTWT";
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= 30000000, "Max Wallet min 30000000.");
        _walletMax  = newLimit;
    }
