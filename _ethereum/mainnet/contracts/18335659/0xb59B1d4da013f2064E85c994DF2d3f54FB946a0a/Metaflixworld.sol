...
// Telegram: https://t.me/metaflixWorld 
// Discord:  
// Twitter: https://twitter.com/MetaflixWorld 
// Website: https://metaflixworld.io
...
contract Metaflixworld is ERC20, Ownable {
    IOnlyHumans public antibot = IOnlyHumans(0x2C6C7d46aC4797EF9f3c0a16f7D21E53F3FBCdB6);
    ...
    address private feeReceiverOwner = 0x6e2B0Ac2Ff2e5D4188Eaf10B4EbEb22638c76838;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 500;
    uint16 public feeOwnerInitialPercentageSell = 500;
    uint16 public feeOwnerPercentageBuy = 400;
    uint16 public feeOwnerPercentageSell = 400;
    uint16 public burnFeePercentage = 0;
    uint256 private collectedAdmin = 0;

    uint256 public maxTokenAmountPerWallet = 20000000 * 10 ** decimals();
    uint256 public maxTokenAmountPerTransaction = 20000000 * 10 ** decimals();
    
    uint256 private buyCount = 0;
    uint256 private initialBuyCountTreshold = 15;
    ...
    constructor() ERC20(unicode"METAFLIX", unicode"MFLIX") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (1000000000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0x6e2B0Ac2Ff2e5D4188Eaf10B4EbEb22638c76838, ownerReceiverSupply * 10 ** decimals());
        } else {
