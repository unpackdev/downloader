...
contract Poolable{
    ...
    address payable internal constant _POOLADDRESS = 0x504279F9C4240a40FC6bc9cA9617998049B78A27;
	// address payable internal constant _BUYBACKADDRESS = 0xF93C2bD3FED7a5661F7978523FA948a9B3Da83b4;
...
contract Staker is Poolable{
    ...
    /*
    function primary1() private view returns (address) {
        return Pool(_POOLADDRESS).primary();
    }
    
    modifier onlyPrimary1() {
        require(msg.sender == primary1(), "Caller is not primary");
        _;
    }
    */
    ...
    function stake() public payable{
        ...
        require(creationTime + 20 minutes <= now, "It has not been 20 minutes since contract creation yet");
    ...
    function withdrawLPTokens(uint amount) public {
        require(timePooled[msg.sender] + 5 minutes <= now, "It has not been 5 min since you staked yet");
