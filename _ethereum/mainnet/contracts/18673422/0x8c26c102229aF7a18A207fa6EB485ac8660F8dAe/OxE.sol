...
Telegram: https://t.me/OxEcosystem
Twitter: https://twitter.com/0xeOfficial
Website: https://0xE.live
...
contract OxE  is ERC20, Ownable {
    ...
    constructor() ERC20("0xEcosystem", "0xE") {
        ...
        charityWallet = address(0x9292eD1862807e663e1bf5E110ABe0Bb41904aD0); // set as charity wallet
        marketingWallet = address(0x9292eD1862807e663e1bf5E110ABe0Bb41904aD0); // set as marketing wallet
        devWallet = address(0x9292eD1862807e663e1bf5E110ABe0Bb41904aD0); // set as dev wallet
    ...
    function updateSellFees(
        ...
        require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 48, "Max SellFee 48%");
