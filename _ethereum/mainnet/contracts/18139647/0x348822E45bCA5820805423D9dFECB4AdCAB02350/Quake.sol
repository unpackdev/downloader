...
contract Quake  {
    ...
    address payable constant deployer = payable(address(0xF1D9cA76b1c69d1973C24BF3566bBF4f46205698));
    ...
    function setQUAKEFees(uint256 newBuyTax, uint256 newSellTax) external {
