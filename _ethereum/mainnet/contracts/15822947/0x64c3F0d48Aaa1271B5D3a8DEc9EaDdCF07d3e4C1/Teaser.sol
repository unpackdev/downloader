...
contract Teaser  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 32384 * 10**0 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'NRJJungleVIBES  ';
    string private _symbol = 'NRJJV';
