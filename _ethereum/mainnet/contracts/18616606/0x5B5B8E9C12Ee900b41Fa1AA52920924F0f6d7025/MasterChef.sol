// Sources flattened with WTF Dev Tools 3.0.0 (https://liquidity.wtf)
    ...
    UUPSUpgradeable
{
    ...
    function withdrawWtf() external onlyOwner {
        lwtf.transfer(msg.sender, lwtf.balanceOf(address(this)));
    }
