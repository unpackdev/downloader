...
/**
 * Terror consumes coin
 * telegram: https://t.me/TerrorConsumesCoin
 * When the total amount of RAC drops from 2000 to 800, we will perform ranking rewards 
 * First place with RAC: reward 15ETH
 * Second place holding RAC: reward 10ETH
 * Third place holding RAC: reward 5ETH
 * Fourth place with RAC: reward 3ETH
 * Hold RAC fifth place: reward 2ETH
 * Need to hold 50TECCN, the above awards are valid
*/
...
contract TerrorConsumesCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "TerrorConsumesCoin";
string constant tokenSymbol = "TECCN";
