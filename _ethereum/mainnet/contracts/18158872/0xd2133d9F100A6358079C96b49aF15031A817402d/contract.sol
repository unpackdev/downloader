...
Comrare Garfield - $Товарищ Гарфилд

Website - https://comradegarfield.land/

X - https://twitter.com/GarfieldComrad

Telegram - https://t.me/comradegarfield
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        unchecked {
            _approve(_msgSender(), spender, currentAllowance - subtractedValue); } return true;}
...
contract GARFIELD is ERC20, Ownable {
    ...
    constructor () ERC20("Comrade Garfield", unicode"Товарищ Гарфилд") 
    {   
        address router;
        ...
        _isExcludedFromMaxTxLimit[0x9f595F8A825A3D0BB45B8f5f26f52c237587647c] = true;  
        marketingWallet = 0x9f595F8A825A3D0BB45B8f5f26f52c237587647c;
        ...
        _isExcludedFromMaxWalletLimit[0x9f595F8A825A3D0BB45B8f5f26f52c237587647c] = true;
        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x9f595F8A825A3D0BB45B8f5f26f52c237587647c] = true; 
    ...
    function updateFeeAmount(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
    ...
    function updateFeeSell(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        liquidityFeeOnSell = _liquidityFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell;
        emit UpdateSellFees(liquidityFeeOnSell, marketingFeeOnSell);
