...
contract NEOINUtoken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NEO INU", "NEO") {
        ...
        devOpsWallet = address(0x288b71511F4a6F77093aeb90C8DbF56584a99B91); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x288b71511F4a6F77093aeb90C8DbF56584a99B91), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x288b71511F4a6F77093aeb90C8DbF56584a99B91), true);
