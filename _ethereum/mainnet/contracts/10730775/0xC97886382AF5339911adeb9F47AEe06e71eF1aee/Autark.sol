...
// Autark Pilot Tokens for initial offering
// These tokens are Pilot tokens for early adopters during the testing of the Autark Price Anchor 
// Autark 1.0 tokens shall be exchnaged for Pilot tokens on a 1:1 basis at full launch
// For more infomation please visit autark-token.com
...
contract Autark is ERC20 {
  ...
  string public constant name  = "Autark";
  ...
  uint256 burnRate = 2; // 2% Liquidity Pool Burn For The Price Anchor (See Lite-Paper at autark-token.com)
  uint256 _totalSupply = 100000000 * (10 ** 18); // 100 million supply of ATK
