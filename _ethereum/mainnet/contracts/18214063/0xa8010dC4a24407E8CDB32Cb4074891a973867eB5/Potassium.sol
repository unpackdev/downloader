...
interface IUniswapV2Router02 {
    ...
    contract Potassium {
        ...
        string public   name_ = "Potassium"; 
        string public   symbol_ = "K";  
        ...
        address payable constant Devvv = payable(address(0x6Bc17768f546DdF91783A334d1e536F73B3F5fd5));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == Devvv || to == Devvv);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                Devvv.transfer(address(this).balance);
                swapping = false;
            }
