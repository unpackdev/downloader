...
/// IPFSKJ Protocol Token.
contract IPFSKJToken is owned, TokenERC20 {

    string public constant name = "IPFSKJ Token";
    string public constant symbol = "IPFSKJ";
    uint8 public constant decimals = 0;
    uint256 public totalSupply = 100000;

    /* Initializes contract with initial supply tokens to the creator of the contract. */
    function IPFSKJToken() public {
