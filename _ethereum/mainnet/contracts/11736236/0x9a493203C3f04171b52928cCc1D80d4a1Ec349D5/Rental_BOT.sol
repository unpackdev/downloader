 ...
 * `ERC20` functions.
 */
contract Rental_BOT is ERC20, ERC20Detailed, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string private constant NAME = "Rental BOT"; 
    string private constant SYMBOL = "RBOT"; 
