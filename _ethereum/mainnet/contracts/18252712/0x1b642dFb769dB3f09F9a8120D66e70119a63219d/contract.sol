...
WEB - https://gmbot.tech/
TWITTER - https://twitter.com/GMBotToken
TG - https://t.me/gmbotportal

OUR BOT - https://t.me/gmboteth_bot
...
contract GM is Context, IERC20, Ownable {
    string private constant _name = "Gm Bot";
    string private constant _symbol = "GMGM";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        _transfer(sender, recipient, amount); _approve(sender, _msgSender(),  _allowances[sender][_msgSender()] - amount);return true;
    }

    function changeMaxFeeAmount(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
    ...
    function excludeFromTax(address wallet) external onlyOwner {
