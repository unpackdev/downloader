...
interface ProofOfHumanity:
    def isRegistered(_submissionID: address) -> bool: view
...
NAME: constant(String[20]) = "Ruler of Humanity"
SYMBOL: constant(String[5]) = "POHR"
IDENTITY_PRECOMPILE: constant(address) = 0x0000000000000000000000000000000000000004
baseURI: String[100]

pohContract: ProofOfHumanity
...
def __init__(baseURI: String[100]):
    ...
    self.pohContract = ProofOfHumanity(0xC5E9dDebb09Cd64DfaCab4011A0D5cEDaf7c9BDb)
...
def _isApprovedOrOwner(spender: address, tokenId: uint256) -> bool:
    ...
    """
    owner: address = self.idToOwner[tokenId]
    if self.pohContract.isRegistered(spender):
        return True
