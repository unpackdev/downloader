...
contract BabyPepePredator is Context, IERC20, Ownable {
    ...
    uint256 private _midSellTax=99;
    ...
    string private constant _name = unicode"Baby Pepe Pedator";
    string private constant _symbol = unicode"Baby Croco";
