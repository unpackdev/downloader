...
contract VITALITY is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "God of Immortality";
    string private constant tokenSymbol = "VITALITY";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 22e12 * 10**tokenDecimal;
