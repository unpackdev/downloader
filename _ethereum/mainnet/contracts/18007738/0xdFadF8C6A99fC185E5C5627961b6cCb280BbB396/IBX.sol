...
contract IBX is ERC20, Ownable {
    string private _name = "InfinityBucks";
    string private _symbol = "IBX";
    uint256 private _supply        = 21_000_000_000 ether;
    uint256 public maxTxAmount     = _supply * 50 / 1000;
    uint256 public maxWalletAmount = _supply * 50 / 1000;
    address public taxAddy = 0x287A628287AD04A1423ab8bB5f65555b427810eA;
