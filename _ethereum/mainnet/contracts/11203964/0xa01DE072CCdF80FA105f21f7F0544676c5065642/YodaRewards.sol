...
contract LPTokenWrapper {
    ...
    IERC20 public LP_TOKEN = IERC20(0x43202Ca7Fc29cE06Ad63f03Df97059A71997698f); // Stake LP YODA-ETH token
...
contract YodaRewards is LPTokenWrapper, Ownable {
    IERC20 public YODA_TOKEN = IERC20(0x20531fA8EAeFAEb4e7d60523679F85d58F53ceD9); // yoda token
    uint256 public constant DURATION = 7 days;

    uint256 public initreward = 600 * 1e18;
    uint256 public starttime = 1604753850; // GMT November 11, 2020 
    ...
    function getReward() public updateReward(msg.sender) checkhalve {
        ...
        if (reward > 0) {
            ...
            YODA_TOKEN.safeTransfer(msg.sender, reward);
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish) {
            ...
            YODA_TOKEN.mint(address(this),initreward);
        ...
        updateReward(address(0))
    {
        ...
        YODA_TOKEN.mint(address(this), reward.add(devNewAmt));
    ...
    function devWithdrawFund(uint256 amt) external
    {
        ...
        YODA_TOKEN.safeTransfer(devVestingAddr, amt);
    }
}