...
contract CoreRouter {
    ...
    address private constant _ACCOUNT_MODULE = 0x95AfaD3bc603F6AcAa8Fd98a11790fDcC14201C6;
    address private constant _ASSOCIATE_DEBT_MODULE = 0x896c3A88CF3C0330948d844951D5Ed7cF2d9A48D;
    ...
    address private constant _COLLATERAL_MODULE = 0xCDF91a2efA3308ec985afA57754Ba8b6709cC8ce;
    address private constant _COLLATERAL_CONFIGURATION_MODULE = 0xB93B39B9e8d2B47042a186DEccf07442e01816Ec;
    address private constant _CROSS_CHAIN_USDMODULE = 0xEE2Eb1DA7c13f65Bb6ffDA195ADC63bb177f8AbA;
    address private constant _ISSUE_USDMODULE = 0x3391297a26e769475eBFFE912EFf05C51095D082;
    address private constant _LIQUIDATION_MODULE = 0xf378Bd660c1c2B6790634f4B38BDbAbeBa075D8A;
    address private constant _MARKET_COLLATERAL_MODULE = 0x5a19Abe2c65056b9928e665233d6E517FCf4d62C;
    address private constant _MARKET_MANAGER_MODULE = 0xa8b6B4a1b114D1157bc21E49eA24D90165136870;
    address private constant _MULTICALL_MODULE = 0xD54ba8b0851b7456508d45264aad1FDdc7499e73;
    address private constant _POOL_CONFIGURATION_MODULE = 0x8C35743b4DC33cc2e8D5ddA8bCF428340424349F;
    address private constant _POOL_MODULE = 0x44406De9887af6ffc813D3Cda4aDa6fabd3946C9;
    address private constant _REWARDS_MANAGER_MODULE = 0xb7059Ed9950f2D9fDc0155fC0D79e63d4441e806;
    address private constant _UTILS_MODULE = 0x7ebCBBD835D17661b26b8AFAe75b5f94BfDC12cA;
    address private constant _VAULT_MODULE = 0xA154EcFFfb46380991751DE890956b245142e10C;
        ...
        assembly {
            ...
            function findImplementation(sig) -> result {
                if lt(sig,0x830e23b5) {
                    if lt(sig,0x3593bbd2) {
                        if lt(sig,0x183231d7) {
                            if lt(sig,0x11aa282d) {
                                ...
                                case 0x0a6c7553 { result := _MULTICALL_MODULE } // MulticallModule.setAllowlistedMulticallTarget()
                    ...
                    case 0x76167a89 { result := _MULTICALL_MODULE } // MulticallModule.getMessageSender()
                ...
                if lt(sig,0xdbdea94c) {
                    if lt(sig,0xcaab529b) {
                        ...
                        case 0xc0694da0 { result := _MULTICALL_MODULE } // MulticallModule.multicallThrough()
