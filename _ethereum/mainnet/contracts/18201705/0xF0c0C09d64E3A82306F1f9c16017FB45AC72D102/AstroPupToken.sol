...
contract AstroPupToken is Ownable, ERC20 {
    bool public limited;
    uint256 public maxHoldingAmount;
    uint256 public minHoldingAmount;
    address public uniswapV2Pair;
    uint256 public burnRate = 100; // 2% initially
    

    constructor(uint256 _totalSupply) ERC20("ASTROPUP", "#APUP") {
