...
𝕏: https://twitter.com/XUFOeth

𝕏UFO - The 𝕏 Factor of the 𝕏verse Safety
...
contract XUFO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"𝕏UFO👽";
    string private constant _symbol = unicode"𝕏UFO";
