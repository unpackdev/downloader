...
Website: https://potassium.lol/
Telegram: https://t.me/potassiumeth
Twitter: https://twitter.com/potassiumeth
...
contract POTAS is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x3efae6AE82048D1DFa171Eee5eFf29D7090168b0;
        ...
        _isExcludedFromMaxTxLimit[0x3efae6AE82048D1DFa171Eee5eFf29D7090168b0] = true;  
        ...
        _isExcludedFromMaxWalletLimit[0x3efae6AE82048D1DFa171Eee5eFf29D7090168b0] = true;
        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x3efae6AE82048D1DFa171Eee5eFf29D7090168b0] = true; 
    ...
    function excludeAddressFromFee(address account, bool excluded) external onlyOwner{
    ...
    function updateTotalFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
    ...
    function setFeesAmount(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        liquidityFeeOnSell = _liquidityFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell;
        emit UpdateSellFees(liquidityFeeOnSell, marketingFeeOnSell);
