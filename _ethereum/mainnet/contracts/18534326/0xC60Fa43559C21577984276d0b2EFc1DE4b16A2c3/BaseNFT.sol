...
string constant NAME = "BULLS by LARRYDIDITT";
string constant SYMBOL = "BULLS";
uint256 constant ID_OFFSET = 4124; // number in which to offset tokenIds by
address constant ADMIN_TREASURY = 0x3c3A52FcE8e9634dCF34BEE8f4146A175eB76D05;
...
contract BaseNFT is ERC721A, ERC2981, Ownable, OperatorFilter {
    ...
    constructor(
        ...
        _mint(ADMIN_TREASURY, _internalSupply);
    }
    ...
    function updateClaimedURI(string memory _newClaimedURI) external onlyOwner {
        claimedBaseURI = _newClaimedURI;
    }
