    ...
    Ownable
{
    ...
    uint256 public supply = 192;
    uint256 public mintPrice = 0.1 ether;
    string public baseTokenURI = "ipfs://bafybeibjqhosfdbp2mzrlkfl6ipfkrvbwhkskgxevpgiajllr3n7o6mnvq/";
    address payable public withdrawalAddress;

    constructor(address payable _withdrawalAddress) ERC721("Parametric Pottery", "PPTTRY") {
