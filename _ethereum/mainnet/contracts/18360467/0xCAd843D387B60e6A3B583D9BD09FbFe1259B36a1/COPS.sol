...
contract  COPS  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FOLLOWING ORDERS";
    string private constant _symbol = unicode"COPS";
