...
GTA VI Community Token

Telegram: https://t.me/gta6_token

Twitter: https://twitter.com/RockstarGames/status/1722237703553798312
...
contract GRAND_THEFT_AUTO_VI is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _balances[_msgSender()] = _tTotal * 20 / 1000;
        emit Transfer(address(0), _msgSender(), _tTotal * 20 / 1000);

        _balances[address(this)] = _tTotal * 980 / 1000;
