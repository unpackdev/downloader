...
contract Kiken is ERC20, Ownable {
    ...
    constructor() ERC20("A Dangerous Journey", "Kiken") {
        ...
        devWallet = address(0x44471e0F6593c51c89A19cf57AE26ebbdBAa78c8); // set as dev wallet
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 0) / 1000) / 1e18,
            "Cannot set maxWallet lower than 0%"
        );
