...
//
//     ____  _ __              __          __    __     
//    / __ \(_) /__  _________/ /___ _____/ /___/ /_  __
//   / /_/ / / / _ \/ ___/ __  / __ `/ __  / __  / / / /
//  / ____/ / /  __(__  ) /_/ / /_/ / /_/ / /_/ / /_/ / 
// /_/   /_/_/\___/____/\__,_/\__,_/\__,_/\__,_/\__, /  
//                                             /____/   
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x73435d81BfDdCF05DAD10cf6F9E1E9Eeb4e5E2A2];
  address public erc20Payable = 0x73435d81BfDdCF05DAD10cf6F9E1E9Eeb4e5E2A2;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiegzvotaikzr5fgpuyut3nlrbvq7u2kmwmwdekr57xbi7wwbmsmtq/";
...
// File: contracts/PilesdaddyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PilesdaddyContract is RamppERC721A {
    constructor() RamppERC721A("Pilesdaddy", "PDD"){}
}
