...
contract ShinjuInu is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Shinju Inu";
    string private _symbol = unicode"SHINJU";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xfAB5CC08B98565D021F1d1e5fC62d389E7d441ce);
    ...
    uint256 public _walletMax =   _totalSupply.mul(5).div(100);   //5%
