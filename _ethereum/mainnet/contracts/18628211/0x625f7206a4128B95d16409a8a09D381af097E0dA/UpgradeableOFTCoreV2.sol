...
import "./UpgradeableNonblockingLzApp.sol";
import "./ICommonOFT.sol";
import "./IOFTReceiverV2.sol";

abstract contract UpgradeableOFTCoreV2 is UpgradeableNonblockingLzApp {
    ...
    function __initOFTCoreV2(uint8 _sharedDecimals, address _lzEndpoint) internal {
        __initNonBlockingLzApp(_lzEndpoint);
