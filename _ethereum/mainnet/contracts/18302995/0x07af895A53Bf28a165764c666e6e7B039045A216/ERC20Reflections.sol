...
contract BuyHoldEarnBurn is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public reflectionFee = 200; // 200 => 2%
    ...
    function setTransactionFee(uint256 newTxFee) public onlyOwner {
        reflectionFee = newTxFee;
        emit SetFee(reflectionFee);
    }
    ...
    function _transfer(
        ...
        uint256 tTxFee = (tAmount * _reflectionFee) / 10000;
        ...
        unchecked {
            ...
            totalReflectionFees += tTxFee;
        }

        emit Transfer(from, to, tTransferAmount);

        _afterTokenTransfer(from, to, tTransferAmount);
    }
