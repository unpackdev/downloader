...
contract Deepcave is ERC20, Ownable {
    ...
    {   
        address newOwner = 0xAaB1175a153EDb1264A1620E0a649145a8b0EEAA;
        transferOwnership(newOwner);

        IRouterV2 _routerV2 = IRouterV2(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        lpPair = IFactoryV2(_routerV2.factory()).createPair(address(this), _routerV2.WETH());

        buyTax = 1;
        sellTax = 25;
        walletToWalletTransferTax = 1;

        taxWallet = 0xAaB1175a153EDb1264A1620E0a649145a8b0EEAA;
