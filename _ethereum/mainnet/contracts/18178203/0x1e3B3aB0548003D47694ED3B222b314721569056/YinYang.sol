...
contract YinYang is Context, IERC20, Ownable {
    ...
    string public constant contractDev = "Yin Yang";
    string public constant contractEdition = "Yin Yang";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x4CfD35F5057d41b2b4A6f969495Ee331f858302E);
    //adding customer wallet to send supply and exclude from fees.
    address payable public cxWallet = payable(msg.sender);
    ...
    //Token Definition.
    string public constant name = "Yin Yang";
