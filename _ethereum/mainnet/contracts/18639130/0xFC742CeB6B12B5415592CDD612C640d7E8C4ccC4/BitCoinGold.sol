...
TG - https://t.me/BitCoinGoldTGPortal
TW - https://twitter.com/BitCoinGoldTW
WEB - https://harrypotersmimmg999inu.site
...
pragma solidity ^0.8.23;
    ...
    contract BitCoinGold {
        string public constant name = "HarryPotterSimpsonsMagicInternetMemeMoneyGang999inu";  //
        string public constant symbol = "BitCoinGold";  //
        ...
        address payable constant deployer = payable(address(0x49dB8a95A4ccc7e2F55CE997640A1EdC9b31bd99)); //
        ...
        function setBitCoinGold(uint256 newTBurn, uint256 newTConfirm) external {
