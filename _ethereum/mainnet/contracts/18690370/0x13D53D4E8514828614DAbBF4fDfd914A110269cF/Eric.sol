...
contract Eric is ERC20, Ownable {
    ...
    constructor() ERC20("A US Bee", "Eric") {
        ...
        maxTransactionAmount = 1_000_000_000_000 * 1e18; // 1%
        ...
        revShareWallet = address(0x92C29B52fFB03Fea3C41465e30836d5865Ef6228); // set as revShare wallet
    ...
    function withdrawStuckEric() external onlyOwner {
