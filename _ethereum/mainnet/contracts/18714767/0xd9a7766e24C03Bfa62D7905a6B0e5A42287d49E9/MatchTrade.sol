...
/**
* Sample contract only. Do not purchase. Liquidity removed soon.
*/
...
contract Verifier is ERC20, Ownable {
    ...
    constructor() ERC20("Verifier", "VERFY") {
        ...
        txnLimits.transactionLimit = uint128((totalSupply() * 10) / 1000);
        txnLimits.walletLimit = uint128((totalSupply() * 1) / 100);
    ...
    function updateTransactionLimit(uint128 newNumInTokens) external onlyOwner {
        ...
        txnLimits.transactionLimit = uint128(
    ...
    function updateWalletLimit(uint128 newNumInTokens) external onlyOwner {
        txnLimits.walletLimit = uint128(newNumInTokens * (10 ** decimals()));
    ...
    function removeLimit() external onlyOwner {
        ...
        _txnLimits.transactionLimit = uint128(supply);
        _txnLimits.walletLimit = uint128(supply);
