...
Website :  https://twitter.com/KUMAfansETH
...
contract Kuma is ERC20, Ownable {
    ...
    uint256 private immutable maxSupply = 42_069_000_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"Kuma Fans";
    string private constant SYMBOL = unicode"KUMA";
