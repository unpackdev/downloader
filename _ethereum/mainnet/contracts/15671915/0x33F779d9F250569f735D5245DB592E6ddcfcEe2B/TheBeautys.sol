...
contract TheBeautys is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmduuHKaMT74BvreDzf8G51e4UajMmebLP1VaamSvnhDxV/";
    ...
    constructor(string memory initBaseURI) ERC721A("The Beautys", "TB") {
        baseURI = initBaseURI;
