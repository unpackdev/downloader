...
Twitter:  https://twitter.com/CryptoMonkeyERC
Telegram: https://t.me/CryptoMonkeyERC
Website:  http://www.cryptomonkey.club/

#BANANAS #CRYPTOMONKEY
**/
...
contract CRYPTOMONKEY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CRYPTO MONKEY";
    string private constant _symbol = unicode"BANANAS";
    uint8 private constant _decimals = 9;

    uint256 private constant _Totalvy = 4206900000 * 10 **_decimals;
    ...
    constructor () {
        _qfmoburq = payable(0xf8b925A5fE4aF08d459CcCd35135386161C8551D);
