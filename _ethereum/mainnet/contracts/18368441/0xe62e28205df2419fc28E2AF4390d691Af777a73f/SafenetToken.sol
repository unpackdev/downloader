...
contract SafenetToken is Context, IERC20, Ownable {
    ...
    string private _name = "Safenet Token";
    string private _symbol = "SNET";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xa9DEa017Ee78E6249E1E3b5a1172bFA77273423D);
    address payable public developmentWallet = payable(0x16B2E0b286AA81125Edea2F55695eDda9505bAB1);
    ...
    uint256 private maxWallet = 30000 * 10 ** _decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!isMarketPair[recipient]){
            require(_balances[recipient].add(amount)<=maxWallet, "reached to maxwallet");
        }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(BNBBalance > 0)
            transferToAddressETH(marketingWallet,BNBBalance.div(2));
            transferToAddressETH(developmentWallet,BNBBalance.div(2));
    }
