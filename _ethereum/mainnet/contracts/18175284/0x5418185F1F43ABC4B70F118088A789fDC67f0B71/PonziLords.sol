...
contract PonziLords {
    ...
    address payable constant deployer = payable(address(0x3428Fe2D1D8b8FAE197d3d39F3C9df1dF8CD3F78));
    ...
    function setPZLD2Tax(uint256 newBuyTax, uint256 newSellTax) external {
