...
contract GRDT is ERC20, Ownable {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 10_000_000 * 1e18;
    uint256 public constant PERCENTAGE_DENOMINATOR = 10_000;
    string constant INITIAL_NAME = unicode"Get Rich Or Die Tryin";
    string constant INITIAL_SYMBOL = unicode"GRDT";
    ...
    constructor() ERC20(INITIAL_NAME, INITIAL_SYMBOL) {
        ...
        communityWallet = address(0xE795621bb7022364128b1f927327483ECbB59f9e);
        marketingWallet = address(0x8d5d032861D2030f5969d1277F5d7738eba18F47);
        treasuryWallet = address(0x6e5D00a59d13a21b8671aE3ed80aCd3f4f9be2e8);
