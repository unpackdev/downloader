...
contract EtherShiba is ERC20, Ownable {
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x7D2C27935677e7820455f21FCdf8Ba3Ae770342f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x7D2C27935677e7820455f21FCdf8Ba3Ae770342f] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x7D2C27935677e7820455f21FCdf8Ba3Ae770342f,
                block.timestamp
            );
