...
contract SHOTA is Context, IERC20, Ownable {
    ...
    string private _name = "Shota Aizawa Inu";
    string private _symbol = "SHOTA";
    ...
    address public marketing = 0xaaF9eEAcA332199F1b27542A5A38e7775eB710F2;
    address public marketing2 = 0x90D25c7C664C9c91b0B89f56eE418212599Fe033;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {        
        ...
        uint256 Balance7 = Balance.mul(70).div(100);

        Balance = Balance.sub(Balance7);

        (bool succ, ) = address(marketing).call{value: Balance7}("");
        require(succ, "marketing ETH not sent");
        (bool succ2, ) = address(marketing2).call{value: Balance}("");
        require(succ2, "marketing2 ETH not sent");
