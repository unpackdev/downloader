/*
    ...
    WEBSITE: https://allis.one
    TELEGRAM: https://t.me/one_on_eth
    TWITTER: https://twitter.com/one_on_eth
...
contract one is ERC20, Ownable {
    uint256 public _maxTxAmount = (1 * 10**decimals()) / 100;
    uint256 public _maxWalletSize = (1 * 10**decimals()) / 100;
    uint256 public _swapTokensAtAmount = (1 * 10**decimals()) / 200;
    uint256 public _amountToSwap = (1 * 10**decimals()) / 200;
    ...
    address payable private constant _feeAddress =
        payable(0x55D5119462248e92629191a7E16C99Ef5F6002b8);
    ...
    function IT() external onlyOwner {
        _taxFeeOnBuy = 25;
        _taxFeeOnSell = 25;
    }

    function IS() external onlyOwner {
        _taxFeeOnBuy = 10;
        _taxFeeOnSell = 20;
    }

    function ALL() external onlyOwner {
        _taxFeeOnBuy = 0;
        _taxFeeOnSell = 20;
    }

    function ONE() external onlyOwner {
        _maxTxAmount = 1 * 10**decimals();
        _maxWalletSize = 1 * 10**decimals();
