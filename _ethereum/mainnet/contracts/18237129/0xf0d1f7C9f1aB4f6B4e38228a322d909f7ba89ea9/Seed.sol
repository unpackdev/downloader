...
abstract contract TradableErc20 is ERC20, DoubleSwapped, Ownable, Withdrawable {
    ...
    uint256 public sellFeePpm = 335; // fee in 1/1000
    ...
    constructor(string memory name_, string memory symbol_)
        ERC20(name_, symbol_)
        Withdrawable(0xD33B3d61C8DECbFf46a6F7a989a881C19d0fd332)
    {
...
contract Seed is TradableErc20 {
    constructor() TradableErc20("Seed Grow", "SEED") {}
