...
-Telegram: https://t.me/smurfdogeth
-Twitter: https://twitter.com/smurfdogeth
...
contract RealSmurfDog is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Real Smurf Dog", unicode"Смурф-собака") {
    ...
    /**
     * @dev Burns a specific amount of tokens from the given address. Only the owner can call this function.
