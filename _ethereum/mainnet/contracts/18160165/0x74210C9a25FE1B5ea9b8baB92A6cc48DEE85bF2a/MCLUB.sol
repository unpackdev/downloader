...
contract MCLUB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public feeWallet     = deadWallet;
    ...
    constructor() public ERC20("MetaverseClub", "MCLUB") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "MetaverseClub: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "MetaverseClub: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "MetaverseClub: The UniBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "MetaverseClub: Automated market maker pair is already set to that value");
