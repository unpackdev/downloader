...
contract Memecoin is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xc678B843827FB4A46b1EE61CAd24ea2949bEf45e;
    ...
    uint256 public maxTokenAmountPerTransaction = 2520000 * 10 ** decimals();
    ...
    constructor() ERC20(unicode"WEALTHCOIN", unicode"WEALTH") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (21000000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0xc678B843827FB4A46b1EE61CAd24ea2949bEf45e, ownerReceiverSupply * 10 ** decimals());
        } else {
