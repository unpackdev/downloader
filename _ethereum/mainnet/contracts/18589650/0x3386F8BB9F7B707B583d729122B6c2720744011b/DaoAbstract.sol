...
abstract contract DaoEvents {
    ...
    event UnlockBlacklistPirate(uint indexed pirateId, address indexed caller);
...
abstract contract DaoStructs {
    ...
    struct Judgement {
        ...
        bool isPiratePunished; // is pirate convicted
        bool isJudgementProcessed; // whether the judgement is processed or not
        bool isSuspected; // whether the pirate is suspected of proposal malpractice
        // mapping(address => bool) judgementVoters; // keep track of which pirate vote on this judgement
        mapping(address => Receipt) receipts; // keep track of which pirate vote on this judgement
