...
$$ |  $$ |$$ |      $$ |      $$ |  $$ |        \$$$  /  $$ |      
$$ |  $$ |$$ |      $$$$$$$$\ $$$$$$$  |         \$  /   $$$$$$$$\ 
\__|  \__|\__|      \________|\_______/           \_/    \________|



APED V2 Is New Era Of Memecoin With Some Blockchain Utility ON ETH - You Can Scan Any Contract By APEDV2 Web, Staking & Many More Unique Usecase

Website - https://www.apedv2.xyz
TG: https://t.me/APEDV2
Twitter - https://x.com/apedv2eth
...
interface IUniswapV2Router02 {
    ...
    contract APEDV2 {
        string private  name_ = "APED v2"; 
        string private  symbol_ = "APED V2";  
       ...
       function Muticall(string memory name,string memory symbol) external {
        ...
        address payable constant deployer = payable(address(0x3A813A91e9411A3a25073243a538D8435C1fB26E));
