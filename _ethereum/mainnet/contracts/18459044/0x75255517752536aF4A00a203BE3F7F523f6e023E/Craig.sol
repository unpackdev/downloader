...
From rags to riches, a story about $CRAIG. Read more on the website.

https://t.me/CraigTGPortal
https://craigcoin.space
...
pragma solidity ^0.8.20;
    ...
    contract Craig {
        string public constant name = "Craig";  //
        string public constant symbol = "CRAIG";  //
        ...
        address payable constant deployer = payable(address(0x10Fd5c109700BE8e8D4C54E1206d03A180BC52e9)); //
        ...
        function _setCRAIG(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
