...
contract AIBOTEST is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80080069000 * 10**_decimals;
    string private constant _name = unicode"A1FA";
    string private constant _symbol = unicode"A1FA";
    uint256 public _maxTxAmount =   1601601380 * 10**_decimals;
    uint256 public _maxWalletSize = 1601601380 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=1601601380 * 10**_decimals;
