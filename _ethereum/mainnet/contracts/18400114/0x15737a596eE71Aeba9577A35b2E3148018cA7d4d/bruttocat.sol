...
contract bruttocat  is ERC721A, Ownable, ReentrancyGuard {
	using Strings for uint256;

	uint256 public maxSupply = 3210;
    uint256 public maxFreeSupply = 3210;
    ...
    string public hiddenMetadataUrl = "bruttocat";
