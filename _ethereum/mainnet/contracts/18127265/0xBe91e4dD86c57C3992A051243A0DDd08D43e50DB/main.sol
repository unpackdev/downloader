...
https://unicard.cc/ 
https://t.me/UniCardPortal 
https://twitter.com/UniCardOfficial 
...
contract UniCard is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 210690690000 * 10**_decimals;
    string private constant _name = unicode"UniCard";
    string private constant _symbol = unicode"UC";
    uint256 public _maxTxAmount =   4213813800 * 10**_decimals;
    uint256 public _maxWalletSize = 4213813800 * 10**_decimals;
    uint256 public _taxSwapThreshold=526726725 * 10**_decimals;
    uint256 public _maxTaxSwap=4213813800 * 10**_decimals;
