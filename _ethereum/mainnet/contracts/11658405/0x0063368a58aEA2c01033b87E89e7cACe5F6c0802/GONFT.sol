...
contract GONFT is ERC1155Tradable {
	constructor() public ERC1155Tradable("GONFT", "GONFT") {
		_setBaseMetadataURI("http://18.183.227.7/api/");
	}

	function contractURI() public view returns (string memory) {
		return "https://18.183.227.7/api/contract/jgn";
	}
}