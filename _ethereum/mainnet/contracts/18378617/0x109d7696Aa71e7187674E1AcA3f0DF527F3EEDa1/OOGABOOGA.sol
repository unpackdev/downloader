...
Crash & Uka Uka kidnap wife to Ethereum! How repay me?
 Aku launches $OOGA token, 0/0 tax! OOGA!
...
contract OOGABOOGA is Context, IERC20, Ownable {
    ...
    string private _name = "OOGA BOOGA";
    string private _symbol = unicode"OOGA";
