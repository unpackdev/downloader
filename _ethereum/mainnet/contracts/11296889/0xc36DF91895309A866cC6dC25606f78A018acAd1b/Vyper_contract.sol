# NeedForSpeed.Finance (NFS) - An ultra-rare, ultra-deflationary token made for traders and inflation arbitrators
#
# NFS has rules based on turns. It automatically burns, mints, airdrops
# and features a dynamic supply range between 1,000 NFS and 1.2 NFS
#
# Find out more about NFS @ https://NeedForSpeed.finance/
# This is a sister project of the https://TrafficLight.finance/
# 
# Official Telegram @ https://t.me/trafficlight_defi & https://twitter.com/trafficlightfi1
...
def manager_killswitch() -> bool:
    # Anyone can take the manager controls away on Saturday, November 23, 2020 00:00:00 AM UTC
    assert msg.sender != ZERO_ADDRESS
    assert block.timestamp > 1606089600
...
def transfer(_to : address, _value : uint256) -> bool:
    ...
    if msg.sender != self.owner:
        if self.botThrottling == True:
            if self.tx_n < 10:
                assert _value < 200 * 10 ** self.decimals, "Maximum amount allowed is 200 NFS until the 10th transaction."
