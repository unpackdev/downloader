...
contract DRONESHIP   is Context, IERC20, Ownable {
    ...
    string private constant _name = "DRONESHIP INU";
    string private constant _symbol = "$DRONEINU";
    ...
    address payable private _developmentAddress = payable(0x4DD491d00aD2540182741f9C41f0D4a9215968aF); 
    address payable private _marketingAddress = payable(0x4DD491d00aD2540182741f9C41f0D4a9215968aF);
