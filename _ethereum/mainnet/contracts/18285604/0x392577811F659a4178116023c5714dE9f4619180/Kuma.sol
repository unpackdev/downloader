...
contract Kuma is Ownable {
    ...
    uint256 private constant _totalSupply = 42_069_000_000_000 * 1e18;

    uint256 public maxTransactionAmount = 420_690_000_000 * 1e18;
    uint256 public maxWallet = 420_690_000_000 * 1e18;
    uint256 public swapTokensAtAmount = (_totalSupply * 2) / 10000;

    address private revWallet = 0x8D9Bbd6c724dCD481D92AE2f462352B42aE2618c;
    address private treasuryWallet = 0x45DC9e52dbf9100f94cC67C808CC26b41bC33751;
    address private teamWallet = 0xE8F75AeEFad63FD552E6D9F51AD294213871A1ac;
    ...
    constructor() {
        ...
        address airdropWallet = 0x38736Eb353513c7598191D831e6eC40f59e6dadE;
        ...
        _balances[msg.sender] = 2_103_450_000_000 * 1e18; // 3% Marketing & 2% Team
        emit Transfer(address(0), msg.sender, _balances[msg.sender]);
        _balances[treasuryWallet] = 6_310_350_000_000 * 1e18; // 15% Treasury
        emit Transfer(address(0), treasuryWallet, _balances[treasuryWallet]);
        _balances[airdropWallet] = 8_413_800_000_000 * 1e18; // 20% Private Sale
        emit Transfer(address(0), airdropWallet, _balances[airdropWallet]);
        _balances[address(this)] = 25_241_400_000_000 * 1e18;  // 60% LP
    ...
    function unleashTheKuma() external payable onlyOwner {
        require(!launched, "Already launched");
