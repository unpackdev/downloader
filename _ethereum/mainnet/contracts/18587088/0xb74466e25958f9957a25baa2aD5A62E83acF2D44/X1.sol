...
The first bridge bringing projects on Ethereum to X1, a ZK-powered layer 2 network built by OKX
...
contract X1 is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xCcF724BE21cC7DeA1D3D843fAcE6845F7F5C8Cee);
    address payable public DeveloperWallet = payable(0xCcF724BE21cC7DeA1D3D843fAcE6845F7F5C8Cee);
