...
// Telegram：https://t.me/BABYGROKETHTOKEN
...
contract BabyGrok is Ownable, ERC20 {
    mapping(address => bool) public blacklists;
    mapping (address => bool) private excludedFromFee;
    address public marketing = 0x03C2E8b034EC4BF0A1C00b9D6869748b6c39Ceac;
    address public WETH;
    ...
    constructor() ERC20("BabyGrok", "BabyGrok")  Ownable(msg.sender)  {
