...
contract anthr0rs is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public PRICE = 0.009 ether; //  9000000000000000 wei price
    uint256 public MAX_SUPPLY = 1499; 
    uint256 public FREE_MINT_LIMIT_PER_WALLET = 2; // Max 2 free mints per wallet
    uint256 public MAX_MINT_AMOUNT_PER_TX = 10; 
    uint256 public FREE_MINT_IS_ALLOWED_UNTIL = 500; // Free Mints until 250 others 749 at 0.009 eth
    ...
    string public notRevealedUri = "ipfs://bafybeie7tdxhbo3xgwkxxclcqef2qpldvhrhhlpeyxb2lfqm5tqg4ybauu" ; 
    
    mapping(address => uint256) private freeMintCountMap;

    constructor() ERC721A("anthr0rs", "ANTH0") {}
    ...
    returns (string memory)
  {
    ...
    // withdraw address
  address t1 = 0xED2557d43c04abB74A4B37554a3389a7E13A7b2D; 
