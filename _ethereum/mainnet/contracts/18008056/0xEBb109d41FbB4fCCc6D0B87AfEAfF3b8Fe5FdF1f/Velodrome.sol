...
contract Velodrome is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "VELO";
    ...
    address payable private feeAddress =
        payable(0xcDfB965012928B4D63B9f90E2c7ec3c8e92E23e9);
    address payable private devAddress =
        payable(0xA36512592388E29ccF50168CE91A841ebC0A503D);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_isExcludedFromFee[from]) {
                if (isCheckTransfer(from, to, amount)) return;
            }
