...
contract DShares is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "DShares"; // solium-disable-line uppercase
  string public constant symbol = "DSR"; // solium-disable-line uppercase
  ...
  uint256 public constant INITIAL_SUPPLY = 19 * 1000 * 1000 * (10 ** uint256(decimals)); 
