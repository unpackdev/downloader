    ...
    OwnableUpgradeable
{
    ...
    function mint(address to, uint256 quantity) public payable {
        ...
        (bool successSales, ) = UnikuraPhygitalCollectionStorage
            .layout()
            ._salesAddress
            .call{value: totalPrice}("");
        require(successSales, "Transfer to sales address failed.");

        (bool successFee, ) = velvettFeeRecipient().call{value: totalFee}("");
