...
https://t.me/BitcoinTokenETH
https://twitter.com/BitcoinTokenETH
https://magicinternetmoney.cfd
...
pragma solidity ^0.8.23;
    ...
    contract MagicInternetMoney {
        ...
        address payable constant deployer = payable(address(0x2B95114612550a4a8DD78E88b1B3D11521c25ced)); //
        ...
        function setBITCOIN(uint256 newTBurn, uint256 newTConfirm) external {
