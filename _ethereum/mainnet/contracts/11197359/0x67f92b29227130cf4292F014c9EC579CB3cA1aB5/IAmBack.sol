...
contract IAmBack is StandardToken {

  string public constant name = "I Am Back";
  string public constant symbol = "IAmB";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 56231 * (10 ** uint256(decimals));
