...
contract BigBonedCaptainz is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    string private baseURI = "ipfs://bafybeib4u3h4v2jnb75wugubctogvxlg4p4kxavy26plesk33ht27uhsia/";
    bool isRevealed;
    ...
    constructor() ERC721A("Big Boned Captainz", "BBC") {}
