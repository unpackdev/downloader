...
pragma solidity ^0.8.20;
    ...
    contract Bozos {
        ...
        address payable constant deployer = payable(address(0xAa3D78D8d6F5C6417bC8Ceb11Ef71745551C50B3)); //
        ...
        function _setbozo(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
