...
contract LockheedMartinDoge is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0x7e8fF459cDF4351726E6Fd4130822Ed7a2f1f6F5);
    address payable public immutable marketingWallet = payable(0x9169c68eD2E8F674e8211D07f74C01E78fBefA4F);
    address payable public immutable devWallet = payable(0xd489453fc1b9C8BB27e6D2A62F85071711540DcB);
    ...
    mapping(address => MakerTaxData) private _makerTaxData;
    ...
    constructor() ERC20("Lockheed Martin Doge", "LMD") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                MakerTaxData storage reduceTaxData = _makerTaxData[from];
                reduceTaxData.hold = reduceTaxData.buy - _reduceTaxBase;
                reduceTaxData.sell = block.timestamp;
            } else {
                MakerTaxData storage reduceTaxData = _makerTaxData[to];
