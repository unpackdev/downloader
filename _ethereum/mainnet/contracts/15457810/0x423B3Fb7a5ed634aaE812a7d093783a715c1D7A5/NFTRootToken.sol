...
// File: @openzeppelin/contracts@4.4.1/interfaces/IERC2981.sol
...
abstract contract RoyaltyStandard is IERC2981, ERC165{
    ...
    constructor(string memory contractUri_){
        require(bytes(contractUri_).length != 0,"Invalid contractUri_");
    ...
    function _updateRoyaltyInfo(address receiver, uint96 feeNumerator) internal {
...
contract NFTToken is ERC721, ERC721Enumerable, AccessControl, RoyaltyStandard {
    ...
    function setBaseURI(string memory tokenBaseUri) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        emit BaseUriUpdated(tokenBaseUri);
    }
    ...
    function setRoyalty(address receiver, uint96 feeNumerator) external onlyRole(DEFAULT_ADMIN_ROLE) {
        _updateRoyaltyInfo(receiver, feeNumerator);
    }
...
contract NFTRootToken is NFTToken {
    ...
    constructor (string memory name, string memory symbol, string memory contractUri_, address mintableERC721Proxy) NFTToken(name,symbol,contractUri_) {
        ...
        require(mintableERC721Proxy!=address (0),"The mintableERC721Proxy should be a valid address");
    }
