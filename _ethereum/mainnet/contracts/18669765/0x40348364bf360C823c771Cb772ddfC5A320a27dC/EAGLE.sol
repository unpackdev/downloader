...
contract EAGLE is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _exemptForFees[owner()] = true;
        _exemptForFees[address(this)] = true;
        _exemptForFees[_teamAddr] = true;
        _exemptForEagle[_eagleAddr] = true;
