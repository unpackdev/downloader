...
/**
 *   @title Blockletes Golfers Collection
...
contract BlockletesGolfers is ERC721, Pausable, Ownable, ERC721Burnable, Mintable {
  ...
  constructor(
    address ownerInit,
    address imxInit
  ) ERC721("Blockletes Golfers", "BLOCKLETESGOLF") Mintable(ownerInit, imxInit) {}
