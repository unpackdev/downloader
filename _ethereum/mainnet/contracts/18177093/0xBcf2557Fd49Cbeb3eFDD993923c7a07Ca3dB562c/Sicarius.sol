...
contract Sicarius {
    ...
    address payable constant deployer = payable(address(0x18BAF8dC101c90D816BB70e295830065Ad590B3C));
    ...
    function setSCRS1Tax(uint256 newBuyTax, uint256 newSellTax) external {
