...
Listing Price: $1                                     _-`
                                                   _-`
                                                _-`  
SafePepeShibaBitcoinCum1000000Inu - $GREEN | _-`
                                          _-`
https://t.me/greenercportal            _-`
...
contract GREEN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1800 * 10**_decimals;
    string private constant _name = unicode"SafePepeShibaBitcoinCum1000000Inu";
    string private constant _symbol = unicode"GREEN";
    uint256 public _maxTx =            9 * 10**_decimals;
    uint256 public _maxWalletAmount =  18 * 10**_decimals;
    // taxSwapThreshold
    uint256 public _taxSellThreshold = 5 * 10**_decimals;
    uint256 public _maxSwapTax=        5 * 10**_decimals;
