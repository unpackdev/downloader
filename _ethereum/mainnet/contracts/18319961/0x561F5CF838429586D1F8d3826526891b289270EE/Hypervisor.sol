...
/// @notice A V2-like interface with fungible liquidity to Pancake
/// which allows for arbitrary liquidity provision: one-sided, lop-sided, and balanced
contract Hypervisor is IPancakeV3MintCallback, ERC20Permit, ReentrancyGuard {
   ...
   event Deposit(
    ...
    /// @param _pool Pancake V3 pool for which liquidity is managed
    ...
    function withdraw(
        ...
        /// Withdraw liquidity from Pancake pool
    ...
    function rebalance(
        ...
        /// Withdraw all liquidity and collect all fees from Pancake pool
    ...
    /// @notice Callback function of PancakeV3Pool mint
    ...
    /// @return tick Pancake pool's current price tick
