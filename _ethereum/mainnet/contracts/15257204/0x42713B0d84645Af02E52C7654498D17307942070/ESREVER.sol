...
- >                                              
- >  ETISBEW : https://esrever.click	
- >  RETTIWT : https://twitter.com/ESREVER_ETH
- >  MARGELET : https://t.me/esreverportal	
...
contract ESREVER is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "REVERSE";
    string private constant _symbol = "ESREVER";
    ...
    address payable private _developmentAddress = payable(0xEB42D9239DfEC96c55E1141ac507d98b37a8833F);
    address payable private _marketingAddress = payable(0xEB42D9239DfEC96c55E1141ac507d98b37a8833F);
    ...
    function setMaxTxnAmount(uint256 maxTxAmount, uint256 maxWalletSize) external onlyOwner {
        require(maxTxAmount >= 100000000000 * 10**9 );
