...
contract INFINITESNIPER is ERC20, Ownable {
    ...
    address payable public  marketingWallet = payable(0x7f5bfc69BA09F0a5375be1a03DcC9a1c999dBC3B);
    ...
    constructor(address _owner) ERC20("INFINITE SNIPER", "INFINITE SNIPER") {
