...
// Twitter: https://twitter.com/serene_erc
// Website: https://serene.bond
// Docs:  https://docs.serene.bond
// Dapp:  https://app.serene.bond
...
contract SereneBond is ERC20, Ownable {
    ...
    uint16 public feeInitialPercentageBuy = 1500;
    uint16 public feeInitialPercentageSell = 2500;
    uint16 public feePercentageBuy = 200;
    uint16 public feePercentageSell = 200;
    ...
    uint256 public swapTreshold = 0.2 ether;
    ...
    constructor() ERC20(unicode"SereneBond", unicode"SRN") {
        ...
        uint supplyTotal = 100000000 * 10 ** decimals();
        maxTokenAmountPerWallet = supplyTotal / 50;
        maxTokenAmountPerTransaction = supplyTotal / 50;
    ...
    function setTaxes(uint16 _buy, uint16 _sell) public {
        require(msg.sender == feeReceiver);
        feePercentageBuy = _buy;
        feePercentageSell = _sell;
        require(_buy <= 3000 && _sell <= 3000, "Max 30%");
    }
    ...
    function excludeFromFees(address account, bool status) public {
        require(msg.sender == feeReceiver);
