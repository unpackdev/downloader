...
abstract contract CNCERC721MultiSale is CNCIERC721MultiSale, CNCBasicSale {
    // ==================================================================
    // Modifier
    // ==================================================================
    mapping(address => CNCSalesRecord) internal _salesRecordByBuyer;
    ...
    function getBuyCount() public view returns (uint256) {
        CNCSalesRecord storage record = _salesRecordByBuyer[msg.sender];
