...
abstract contract CNCERC721MultiSaleByMerkle is
CNCIERC721MultiSaleByMerkle,
CNCERC721MultiSale
{
    ...
    modifier hasRight(
        ...
        require(
            CNCMerkleProof.verifyCalldata(merkleProof, _merkleRoot, node),
            "invalid proof."
        );
        _;
    }
    ...
    function _setCurrentSale(CNCSale calldata sale, bytes32 merkleRoot) internal {
