...
abstract contract CNCERC721RestrictApprove is CNCERC721PsiBurnable, CNCIERC721RestrictApprove {
    using CNCEnumerableSet for CNCEnumerableSet.CNCAddressSet;

    CNCIContractAllowListProxy public CAL;
    CNCEnumerableSet.CNCAddressSet localAllowedAddresses;
    ...
    function _setCAL(address _cal) internal virtual {
        CAL = CNCIContractAllowListProxy(_cal);
    }
    ...
    {
        return
            interfaceId == type(CNCIERC721RestrictApprove).interfaceId ||
