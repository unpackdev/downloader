...
import "./ERC721MultiSaleByMerkle.sol";
...
CNCAccessControl,
CNCOwnable,
CNCRevokableDefaultOperatorFilterer,
CNCERC721MultiSaleByMerkle,
CNCERC2981,
    CNCTokenUriSupplier,
    CNCERC721AntiScam
{
    using CNCStrings for uint256;
    // ==================================================================
    // Constants
    // ==================================================================
    ...
    // Constractor
    // ==================================================================
    constructor() CNCERC721Psi("CryptoNinja Children", "CNC") {
    ...
    function owner()
        ...
        view
        virtual
        override(CNCOwnable, CNCUpdatableOperatorFilterer)
        returns (address)
    {
        return CNCOwnable.owner();
    }
    ...
    function tokenURI(uint256 tokenId)
        ...
        view
        virtual
        override(CNCERC721Psi, CNCTokenUriSupplier)
        returns (string memory)
    {
        return CNCTokenUriSupplier.tokenURI(tokenId);
    }
    ...
    function setExternalSupplier(address _value)
        ...
        onlyRole(ADMIN)
    {
        externalSupplier = CNCITokenUriSupplier(_value);
    }
    ...
    function isLocked(uint256 tokenId)
        public
        view
        override(CNCIERC721Lockable, CNCERC721Lockable)
        returns (bool)
    {
        return
            CNCERC721Lockable.isLocked(tokenId) ||
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(CNCAccessControl, CNCERC721AntiScam, CNCERC2981)
        returns (bool)
    {
        return
            CNCERC721Psi.supportsInterface(interfaceId) ||
            CNCERC2981.supportsInterface(interfaceId) ||
            CNCERC721AntiScam.supportsInterface(interfaceId) ||
            CNCAccessControl.supportsInterface(interfaceId);
    }
    ...
    function setCurrentSale(CNCSale calldata sale, bytes32 merkleRoot)
        external
        onlyRole(ADMIN)
    {
