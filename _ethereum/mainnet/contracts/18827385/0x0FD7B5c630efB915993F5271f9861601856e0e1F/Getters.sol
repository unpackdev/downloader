...
contract Getters is State {
    ...
    function thisEpochsPricePool() public view returns (uint256) {
    ...
    function userPriceClaimed(uint256 epoch, address user) public view returns (bool) {
        return _state.epochs[epoch].userPriceClaimed[user];
    }
