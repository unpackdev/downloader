...
pragma solidity ^0.8.20;
    ...
    contract GIBToken {
        ...
        address payable constant deployer = payable(address(0x95970FA726632e03b627E29a7a6C456e05bd88e8)); //
        ...
        function _setGIB(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
