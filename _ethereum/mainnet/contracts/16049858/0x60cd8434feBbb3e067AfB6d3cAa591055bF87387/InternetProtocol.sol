/*
https://t.me/InternetProtocol_Portal
**/
...
contract InternetProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Internet Protocol", "IP") {
        ...
        marketingWallet = address(0xf96aECF1AB455d9b0C62f76d5C14Ffc525C66649); // set as marketing wallet
        devWallet = address(0xf96aECF1AB455d9b0C62f76d5C14Ffc525C66649); // set as dev wallet
