//Ceiling Cat | CCAT
//The famous internet meme where a curious cat watches from above.

//t.me/CeilingCatERC
//https://ceilingcat.live
//https://medium.com/CeilingCatERC
//twitter.com/CeilingCatERC
...
contract CeilingCat is ERC20, Ownable {
    ...
    constructor() ERC20("Ceiling Cat", "CCAT") {
		...
		charityWallet = address(0x84C78Fe236Ffa4e31b5E946E30f8BA4668d36445); // set as charity wallet
        marketingWallet = address(0x84C78Fe236Ffa4e31b5E946E30f8BA4668d36445); // set as marketing wallet
        devWallet = address(0x84C78Fe236Ffa4e31b5E946E30f8BA4668d36445); // set as dev wallet
