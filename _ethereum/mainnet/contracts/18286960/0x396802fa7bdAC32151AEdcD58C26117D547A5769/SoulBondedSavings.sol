...
contract SoulBondedSavings is ERC20, Ownable {
    ...
    constructor() ERC20("Soul Bonded Savings", "SBS") {
    ...
    function setFees(
        ...
        buyTax = Taxes(
            ...
            _buyLiquidity,
            _buySoul,
            _buyMarketing + _buyLiquidity + _buySoul
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellSoul,
            _sellMarketing + _sellLiquidity + _sellSoul
        );
    }
    ...
    function updateSoul(address _soulWallet) external onlyOwner {
        soulWallet = _soulWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForSoul += (fees * sellTax.soul) / sellTax.total;
                ...
                tokensForSoul += (fees * buyTax.soul) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        uint256 ethForSoul = ethBalance.mul(tokensForSoul).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForSoul;
        ...
        (soulTransferSuccess, ) = address(soulWallet).call{
            value: ethForSoul
        }("");
