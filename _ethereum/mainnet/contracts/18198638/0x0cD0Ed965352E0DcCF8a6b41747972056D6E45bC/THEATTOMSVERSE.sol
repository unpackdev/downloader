...
https://t.me/theatomverse
https://mint.theattoms.xyz/
BE READY FOR THE NEXT META.
...
contract THEATTOMSVERSE is Ownable, ERC20 {
    ...
    string constant _name = "ATTOMVERSE";
    string constant _symbol = "ATTOM";
    ...
    function enableTradingtheattoms(bool _open, uint256 _buyMultiplier, uint256 _sellMultiplier, uint256 _transferMultiplier) public onlyOwner {
        TradingOpen = _open;
