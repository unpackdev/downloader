...
telegram: https://t.me/ExeERC

docs: https://exes-docs.gitbook.io/info/
...
contract Exeerc20 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80069690000 * 10**_decimals;
    string private constant _name = unicode"EXE";
    string private constant _symbol = unicode"EXE";
    uint256 public _maxTxAmount =   1601393800 * 10**_decimals;
    uint256 public _maxWalletSize = 1601393800 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=1601393800 * 10**_decimals;
