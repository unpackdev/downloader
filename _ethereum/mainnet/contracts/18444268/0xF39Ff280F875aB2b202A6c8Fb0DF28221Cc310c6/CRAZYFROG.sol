...
Website: https://www.crazyfrogerc.xyz/
Telegram: https://t.me/CrazyFrogEthErc
X: https://x.com/CrazyFrogEthErc
...
contract CRAZYFROG is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"The Annoying Thing";
    ...
    uint256 private _buyDing = 30;
    uint256 private _sellDing = 30;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount.mul(_buyDing).div(100);
            ...
            if(to == uniswapV2Pair && from!= address(this) ){
                taxAmount = amount.mul(_sellDing).div(100);
            }
    ...
    function DINGDINGTRADE() external onlyOwner {
