...
Floktober is an annual celebration that runs 
throughout the month of October, uniting blockchain enthusiasts, 
developers, investors, and the wider crypto community in a collaborative 
exploration of ERC-20 tokens. During this period, the spotlight is firmly on these tokens, 
and their roles in shaping the future of decentralized finance (DeFi), non-fungible tokens (NFTs), and the broader blockchain ecosystem.

https://www.floktobercoin.com/

https://twitter.com/Floktobertoken

https://t.me/FloktoberErc
*/
...
contract FLOKTOBER is Ownable {
    ...
    string private _cigzyxas = "FLOKTOBER";
    string private _zvxtgilo = "FLOKTOBER";
