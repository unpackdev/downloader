...
/** 
        JOJO, like many other tokens, is built 
        on the Ethereum blockchain, leveraging the 
        ERC-20 standard. This standard, short for 
        Ethereum Request for Comment 20, has become 
        the foundation for countless digital assets due 
        to its versatility, compatibility, and ease of use.

    https://thejojotoken.com

    https://twitter.com/jojotokenerc

    https://t.me/JojoErcPorta
...
contract JOJO is Ownable {
    ...
    string private _cigzyxas = unicode"JOJO";
    string private _zvxtgilo = unicode"$JOJO";
