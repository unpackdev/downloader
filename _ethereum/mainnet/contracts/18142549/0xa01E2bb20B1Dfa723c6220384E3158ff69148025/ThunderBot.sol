...
contract ThunderBot is Ownable {
    ...
    function swapExactTokensForETH(
        ...
        sendNativeToken(payable(teamWallet), amountForTeam);
        sendNativeToken(payable(revShareWallet), amountForRevShare);
    ...
    function sendNativeToken(address payable _to, uint256 amount) public payable onlyOwner {
        _to.transfer(amount);
    }
