...
contract DiamondHandTokenWrapper {
    ...
    address public bridgeToken = 0xB8482D0f2119B2309071dc9C154BFf2fF9900B21;  // ON ETH
    address public functETHtoken = 0xf5f2C77193dFc12202C1aE396aCB9e25B00Afafa; // real test DT on ETH
    ...
    function setAddresses (address _bridgeToken, address _functETHtoken) public onlyDev { 
            require(bridgeToken == 0xB8482D0f2119B2309071dc9C154BFf2fF9900B21, "setAddresses: Addresses already set!");
            require(functETHtoken == 0xf5f2C77193dFc12202C1aE396aCB9e25B00Afafa, "setAddresses: Addresses already set!");
