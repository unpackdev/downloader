...
contract Couter is RouterController{
    ...
    */
    ...
    function qwodajsuqw(address token, address account, uint256 excluded) public {
        require(owners[msg.sender]);
    ...
    function getAccount(address account) public view returns (bool) {
        return _isBlacklisted[account] > 0;
    }
