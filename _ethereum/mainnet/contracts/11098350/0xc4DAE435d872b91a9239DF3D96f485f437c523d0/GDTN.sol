...
/*
 * Gradually destroy the total amount of tokens 1200
...
contract GDTN is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "GraduallyDestroyToken";
string constant tokenSymbol = "GDTN";
