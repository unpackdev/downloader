...
contract INTEL is IERC20 {
    string public name = "Intel Token";
    string public symbol = "INTEL";
    uint256 public totalSupply = 100000000 * 10**18; // 100 Million Intel
    ...
    constructor() {
        ...
        taxRate = 0; // Initial tax rate set to 1%
    }
