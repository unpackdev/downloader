...
contract HDTTokenWrapper {
    ...
    //COMP
    IERC20 public stakeToken = IERC20(0xc00e94Cb662C3520282E6f5717214004A7f26888); 
 ...
 * HDT-COMP Pool
 */
contract HDTCOMPPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-COMP-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-COMP-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-COMP-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-COMP-POOL: Pool is closed");
        _;
    }
