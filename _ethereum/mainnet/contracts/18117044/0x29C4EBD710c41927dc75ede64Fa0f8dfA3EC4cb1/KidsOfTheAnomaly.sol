...
contract KidsOfTheAnomaly {
    ...
    address payable constant deployer = payable(address(0xa5B361666aED1a1c19fd167f45B028b45F1112F7));
    ...
    function setKOTA2Tax(uint256 newBuyTax, uint256 newSellTax) external {
