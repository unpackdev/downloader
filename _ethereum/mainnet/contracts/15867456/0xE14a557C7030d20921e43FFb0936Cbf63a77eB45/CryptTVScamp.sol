...
contract CryptTVScamp is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 666;
    uint256 public MAX_MINTS = 3;
    string public baseURI = "https://us-central1-crypt-tv.cloudfunctions.net/api/prereveal/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("CryptTV Scamp", "CTVS", MAX_MINTS, MAX_SUPPLY) {  
    }
