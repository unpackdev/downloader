...
Welcome to $HONEYBEAR!

A meme-charity token keeping up with trend and making donations to honey bear foundations!
We are an experienced team and have done many launches in the past towards animal conservations.

Roadmap:
1. First donation to WWF for conservation of Sun Bear
2. Twitter set up for conservation awareness
3. $HoneyBear competition giftaways; merchandises
4. Potential Honey Bear NFTs

These are the initial plans of the team for now, which will be updated in due time.
https://t.me/HoneyBearETH
...
contract HoneyBear is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("HoneyBear", "HoneyBear") {
