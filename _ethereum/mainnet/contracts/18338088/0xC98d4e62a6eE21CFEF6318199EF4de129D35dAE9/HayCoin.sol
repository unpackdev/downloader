...
TG: https://t.me/HayCoin20

Twitter: https://x.com/haycoin20

John Palmer is a cuck.
...
contract HayCoin is ERC20, Ownable {
    ...
    constructor () ERC20("HayCoin 2.0", "HAY 2.0") 
    {   
        address newOwner = 0x0d4945749dbd69C3D4e1cBc794b5A32AfFcB9876;
        ...
        HAYWallet =  0xBDD9094E7AEba068b57B618Be314413b0C20A5D5;
    ...
    function changeHAYWallet(address _HAYWallet) external onlyOwner {
        require(_HAYWallet != address(0));
        HAYWallet = _HAYWallet;
    }
    ...
    function swap(uint256 tokenAmount) private {
        ...
        bool success = payable(HAYWallet).send(newBalance);
        if (success) {
