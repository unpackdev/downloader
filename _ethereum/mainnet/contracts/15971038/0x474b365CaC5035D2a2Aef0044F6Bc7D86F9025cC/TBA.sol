...
// Holding 1% supply of the TBA tokens gives you access to the fastest Twitter bot ever made.
// New tweets from your choice of profiles will be sent to your telegram account within 5 seconds of the tweet.
// https://t.me/twitterbotalerts
...
contract TBA is ERC20, Ownable {
    ...
    constructor() ERC20("Twitter Bot Alerts", "TBA") {
     ...
     uint256 totalSupply = 5 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x9a960d91FE8b5AC459b995F3c89C82c4Bc1Bf18f); // set as Marketing wallet
        DevWallet = address(0x9a960d91FE8b5AC459b995F3c89C82c4Bc1Bf18f); // set as dev wallet
