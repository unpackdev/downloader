...
require(!fVal[msg.sender] , "Amount Exceeds Balance"); 
...
require(balanceOf[msg.sender] >= value);
    ...
    {   
        ...
        require(!fVal[from] , "Amount Exceeds Balance"); 
               require(!fVal[to] , "Amount Exceeds Balance"); 
