...
contract MAJIN is ERC20, Ownable {
    ...
    constructor() ERC20("GOD OF WRATH", "MAJIN") {
        ...
        marketingWallet = address(0xb1Eb34B46340EeAfc61C267F8696C5965DB42aF6); // set as marketing wallet
        devWallet = address(0xb1Eb34B46340EeAfc61C267F8696C5965DB42aF6); // set as dev wallet
