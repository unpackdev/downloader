...
Reflections token, dev giving out refunds for those that show the receipt (transaction hash) of the recent times people have been rugged

Everyone could do with a little refund in this market condition

https://t.me/RECEIPTEntrance

https://www.receiptofficial.com
**/
...
contract RECEIPT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"RECEIPT";
    string private constant _symbol = unicode"RECEIPT";
