...
contract MyToken is ERC20, ReentrancyGuard {
    ...
    constructor(uint256 initialSupply, address _uniswapRouter) ERC20("opBNB Governance Token", "OGT") {
    ...
    function transfer(address recipient, uint256 amount) public override nonReentrant returns (bool) {
        ...
        // Add to LP automatically
        super.transfer(uniswapRouter, taxAmount);
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override nonReentrant returns (bool) {
        ...
        // Add to LP automatically
        super.transferFrom(sender, uniswapRouter, taxAmount);
