...
contract MPHM is Ownable, ERC721AO, DefaultOperatorFilterer, MarketplaceFactoryEnabled
{
    uint public _ArtBlocksProjectID = 69420;
    uint public _TOTAL_SUPPLY = 60;
    string public baseURI = "ipfs://QmWao6Jwir1hxMnrQvfN2cevKECYsRRfyrup5fsx66pvmj/";
    address public _LIVE_MINT = 0x1668f841ed817f5622a8480136B8c9CA1Fd09E6c;
    mapping(address => bool) public Admin;

    constructor() ERC721AO("Mint Pass Human Made | Ntent x Bright Moments | MPHM", "MPHM") { }
     ...
     */
    function __ChangeArtBlocksProjectID(uint NewArtistID) external onlyAdmin { _ArtBlocksProjectID = NewArtistID; }

    /**
     * @dev Instantiates New LiveMint Address
     */
    function ___NewLiveMintAddress(address NewAddress) external onlyAdmin { _LIVE_MINT = NewAddress; }
