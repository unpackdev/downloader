...
Real Smurf Cat 2.0 | $шайлушай2

Website: https://realsmurfcat.xyz/
Telegram: https://t.me/RealSmurfCat2
Twitter : https://twitter.com/RealSmurfCat2
...
contract RealSmurfCatTwoZero is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"шайлушай2";
    uint256 public _maxTx =   20000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 30000000000 * 10**_decimals;
    // taxSwapThreshold
    uint256 public _taxSellThreshold = 8000000000 * 10**_decimals;
    uint256 public _maxSwapTax=10000000000 * 10**_decimals;
