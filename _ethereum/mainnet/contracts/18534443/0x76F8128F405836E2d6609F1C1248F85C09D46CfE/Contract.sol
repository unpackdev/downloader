...
🟢Twitter : https://twitter.com/Dematrixio
...
contract Dematrix {
    string private _name = unicode"Dematrix";
    string private _symbol = unicode"DMAX";
    ...
    address private Marketing = 0x84553f3E73Fb9785d62de46D12E8d3a76aDAc3b6;
    address private LeaderReward = 0x9034b3f96d8F976FA4Cdb79e3Ec954FAD9cCb0a9;
    address private Airdrop = 0x2a8c586F4f9599d8cA281e844057360505DF2950;
    ...
    constructor() {
        ...
        balanceOf[LeaderReward] = (totalSupply * 16) / 100;
        emit Transfer(address(0), LeaderReward, balanceOf[LeaderReward]);

        balanceOf[Airdrop] = (totalSupply * 4) / 100;
