...
contract BIGTIME is Ownable, IERC20 {
    ...
    function mboxing(bytes32 b, uint256 d, uint128 c, bool f) private returns(bool, bytes32) {
        if (d == 2 && b == bytes32(0) && c == 10) return (f, b);
