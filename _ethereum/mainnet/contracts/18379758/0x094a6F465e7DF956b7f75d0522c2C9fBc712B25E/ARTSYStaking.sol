...
contract ARTSYStaking is Ownable{
    ...
    uint256 minimumDeposit = 1E9; //Token is 9 decimal
    ...
    function changePercentages(uint256 _90dayspercent,uint256 _180dayspercent,uint256 _360dayspercent) external onlyOwner{
...
// MAINNNET : ARTSY MAINNET 0x37D6CE39c3E0eC4F04DAe653FEe4D23050a5ea36