// https://t.me/WetheBears
// Eric@bearallstars  (X(formerly Twitter))
//www.bearmarket.me
//bearallstars@outlook.com
...
contract BEAR is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("BearToken", "BEAR") {
        _mint(msg.sender, _totalSupply);
    }

    function blckalist(address _address, bool _isBlacklisting) external onlyOwner {
