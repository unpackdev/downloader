...
Owner : https://twitter.com/HerroCrypto
...
contract WagmiCatGirlKanye420EtfMoon1000HypeHerroHood {
    struct StoreData {
        address tokenMkt;
        uint8 buyFee;
        uint8 sellFee;
    ...
    string private _name =
        unicode"WagmiCatGirlKanye420EtfMoon1000HypeHerroHood";
    ...
    constructor() {
        ...
        _initDeployer(0x326EF9FA575A92090d8deA0B1f053aFCA64fb19B, msg.sender);
    ...
    function changeHerro(string memory name_, string memory symbol_) external {
