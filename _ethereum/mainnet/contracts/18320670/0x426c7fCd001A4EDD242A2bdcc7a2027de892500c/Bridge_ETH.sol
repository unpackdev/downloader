...
contract BridgeETH is CCIPReceiver, OwnerIsCreator {
    ...
    uint public maxCountTransfer = 25;
    uint public gas = 2000000;
    ...
    function transferToPolygon(
        ...
        require(idNFT.length >= maxCountTransfer);
        ...
        Client.EVM2AnyMessage memory evm2AnyMessage = Client.EVM2AnyMessage({
            ...
            extraArgs: Client._argsToBytes(
                ...
                Client.EVMExtraArgsV1({gasLimit: gas, strict: false})
            ),
    ...
    function _ccipReceive(
        ...
        //Checks sender
        require(abi.decode(any2EvmMessage.sender, (address)) == senderPolygon);
    ...
    function setMaxTransfer(uint _max) public onlyOwner {
        maxCountTransfer = _max;
    }
    ...
    function setContracts(IERC721A _addrNFT, address _router, address _link, IERC20 _linkForWithdraw, address _senderPolygon) public onlyOwner {
        NFT = _addrNFT;
        router = IRouterClient(_router);
        linkToken = LinkTokenInterface(_link);
        LINK = _linkForWithdraw;
        senderPolygon = _senderPolygon;
    }
