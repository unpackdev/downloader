...
contract Shibdododo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"10000xShibdododo";
    string private constant _symbol = unicode"10000xShibdododo";
    uint256 public _maxTxAmount = 100000000 * 10**_decimals;
    uint256 public _maxWalletSize = 100000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 40000001 * 10**_decimals;
