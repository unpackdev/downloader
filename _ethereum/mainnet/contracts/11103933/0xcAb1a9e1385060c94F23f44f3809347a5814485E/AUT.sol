...
// ----------------------------------------------------------------------------
// 'Repel Core' token contract
//
// Telegram    : https://t.me/RepelCore
// Symbol      : REPEL
// Name        : Repel Core
// Total supply: 18000
// Decimals    : 18
...
contract AUT is BurnableToken {

    string public constant name = "Repel Core";
    string public constant symbol = "REPEL";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 18000 * (10 ** uint256(decimals));
