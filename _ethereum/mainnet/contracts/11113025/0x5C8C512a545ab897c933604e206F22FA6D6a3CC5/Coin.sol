...
/******************************************************************
 * 
 * This code has been heavily tested, and has anti-bot mechanisms in place.
 * 
 * If you play your cards right, this coin WILL moon! Just be patient.
 * 
 * 
 * LETS GO BURNING FIVES!
 * Good luck to G2 in the Semis!
 * 
 * 
 * 
 * *****************************************************************/
...
contract Coin is IERC20 {
    ...
    string private _name = "Burning Five Token";
    ...
    function findOnePercent(uint256 value) public pure returns (uint256)  {
        ...
        uint256 onePercent = roundValue.mul(100).div(2000);
        return onePercent;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (beginning) {
            if (sender != __owner && amount > (8 * 1e18)) {
                revert('anti-bot. Buy limit in place (8 Tokens)');
            }
        }
