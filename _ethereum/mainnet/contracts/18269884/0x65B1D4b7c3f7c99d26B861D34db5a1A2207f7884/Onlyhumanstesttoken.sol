...
contract Onlyhumanstesttoken is ERC20, Ownable {
    IOnlyHumans public antibot = IOnlyHumans(0xa8fcCF4D0e2f2c4451123fF2F9ddFc9be465Fa1d);
    uint256 public contractStartTime;
    uint256 public constant TIME_LIMIT = 60 * 120;
    ...
    address private feeReceiverOwner = 0xc36ebBf424963612970209f603CC0E74934D78f9;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 2500;
    uint16 public feeOwnerInitialPercentageSell = 2500;
    uint16 public feeOwnerPercentageBuy = 500;
    uint16 public feeOwnerPercentageSell = 500;
    uint16 public burnFeePercentage = 0;
    uint256 private collectedAdmin = 0;

    uint256 public maxTokenAmountPerWallet = 300000000 * 10 ** decimals();
    uint256 public maxTokenAmountPerTransaction = 300000000 * 10 ** decimals();
    
    uint256 private buyCount = 0;
    uint256 private initialBuyCountTreshold = 75;
    ...
    constructor() ERC20(unicode"OnlyHumans Test Token", unicode"OHTST") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xc36ebBf424963612970209f603CC0E74934D78f9, ownerReceiverSupply * 10 ** decimals());
        } else {
