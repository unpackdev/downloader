...
import "./SNXReward2FarmStrategy.sol";

contract MirrorMainnet_mAAPL_UST is SNXReward2FarmStrategy {

  address public mAAPL_UST = address(0x5233349957586A8207c52693A959483F9aeAA50C);
  ...
  SNXReward2FarmStrategy(_storage, mAAPL_UST, _vault, rewardPool, mir, uniswapRouterAddress, farm, _distributionPool, _distributionSwitcher)
  public {
