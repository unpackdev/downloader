...
contract GenericToken2 is ERC20, Ownable {
  ...
  uint256 public taxRate = 4; // 4% of buy and sell
  uint256 public revenueShare = 1; // 1%
  uint256 public liquidityShare = 2; // 2%
  uint256 public marketingShare = 1; // 1%
  ...
  constructor(address revWallet, address marWallet, address lpReceiverWallet) ERC20('GenericToken2', 'GEN2') {
  ...
  function swapBack() private {
    ...
    // uint256 totalTokensToSwap = liquidityShare + revenueShare + marketingShare;
    bool success;
