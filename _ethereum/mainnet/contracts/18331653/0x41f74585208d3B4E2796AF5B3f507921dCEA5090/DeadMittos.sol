...
contract DeadMittos is ERC721A, Ownable  {
    ...
    string  private uri = "ipfs://DeadMittos/";
    ...
    function freemint() public payable {
        require(totalSupply() + freeAmount <= maxSupply);
        require(totalSupply() + freeAmount <= maxFreeAmount);
        require(balanceOf(msg.sender) < freeAmount);
        require(msg.sender == tx.origin);
        _safeMint(msg.sender, freeAmount); 
    }

    constructor() ERC721A("DeadMittos", "DeadMittos") {
        maxFreeAmount = 4000;
        freeAmount = 10;
    }

    function setConfig(uint256 freeamount, uint256 maxf, uint256 maxt) onlyOwner public  {
