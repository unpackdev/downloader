...
Coinmarketcap Inu - $CINU 🪙📈

With CoinMarketCap being one of the biggest crypto platforms, its now time to fully put the spotlight on CMC

At 100k marketcap, a CMC listing will be fasttracked

Tokenomics for $CINU 🪙📈
2.000.000 Total supply
2% Max wallet and max buy
5% Tax

Twitter: https://twitter.com/CoinmcapInu
Website: Will be released once we hit 100k
Telegram: https://t.me/CoinmarketcapInu
...
contract CINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "CoinMarketCap Inu";
