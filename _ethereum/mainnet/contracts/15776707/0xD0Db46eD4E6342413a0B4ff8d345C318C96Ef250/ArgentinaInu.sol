// File: Argentina Inu.sol


// FIRST Token to represent the Brazilian National Team during the 2022 FIFA World Cup!


// https://t.me/ArgentinaInuCoin

// https://argentinainu.com/

// https://twitter.com/ArgentinaInuWC
...
contract ArgentinaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Argentina Inu", "ARG") {
        ...
        devOpsWallet = address(0x2fa22747404296a8892F1DD517dEbDB6F0EAB093); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x2fa22747404296a8892F1DD517dEbDB6F0EAB093), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x2fa22747404296a8892F1DD517dEbDB6F0EAB093), true);
