...
// Other Variables
    ...
    string private constant _name = unicode"Add back Metamask"; // Token Name (Editable)
    string private constant _symbol = unicode"Metamask"; // Token Symbol (Editable)
    ...
    uint256 private _initialSellTax = 20; // Initial Sell Tax Percentage (Editable)
