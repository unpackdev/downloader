...
/**          
    Twitter: twitter.com/meta_fun_vip
    Telegram: t.me/metafun_vip0
    Website: https://metafun.vip/
...
contract MetaFun is ERC20, Ownable {
    ...
    constructor() ERC20("META FUN", "$METAFUN") {
        ...
        maxTransactionAmount = 30_000_000 * 1e18; // 3% max txn
        ...
        mktgWallet = address(0xb887fEe7eC98FE80984634c8fd8A1a4F9C5aB202);
        liqWallet = address(0xb887fEe7eC98FE80984634c8fd8A1a4F9C5aB202);
        operationsWallet = address(0xb887fEe7eC98FE80984634c8fd8A1a4F9C5aB202);
