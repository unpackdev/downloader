...
Telegram: https://t.me/quasiintellect
Twitter: https://twitter.com/QuasIIntellect_
Website: https://quasiintellect.xyz
...
contract QuasIIntellect is ERC20, Ownable {
    ...
    constructor(address _mediaWallet) ERC20(unicode"QUASIINTELLECT", unicode"QIN") {
    ...
    function massManageBoughtEarly(address[] calldata wallets, bool flag) external onlyOwner {
        ...
        for(uint256 i = 0; i < _length; ){
            address _singleWallet = wallets[i];
            bot[_singleWallet] = flag;
            unchecked {
                ++i;
            }
        }
    ...
    function updateBuyFees(uint256 _buyOperationsFee, uint256 _buyLiquidityFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _sellOperationsFee, uint256 _sellLiquidityFee) external onlyOwner {
