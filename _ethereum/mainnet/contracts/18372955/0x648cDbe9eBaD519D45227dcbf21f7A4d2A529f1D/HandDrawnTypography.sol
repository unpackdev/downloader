...
🚀 "Hand-Drawn Typography: Where Letters Become Dollar Signs!" 💰 

https://HandDrawnTypography.com
https://t.me/HandDrawnTypography
...
contract HandDrawnTypography is ERC20, Ownable {
    ...
    constructor() ERC20("Hand Drawn Typography", "HDT") {
    ...
    function setFees(
        ...
        buyTax = Taxes(
            ...
            _buyLiquidity,
            _buyHDT,
            _buyMarketing + _buyLiquidity + _buyHDT
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellHDT,
            _sellMarketing + _sellLiquidity + _sellHDT
        );
    }
    ...
    function updateHDT(address _hdtWallet) external onlyOwner {
        hdtWallet = _hdtWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForHDT += (fees * sellTax.hdt) / sellTax.total;
                ...
                tokensForHDT += (fees * buyTax.hdt) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        uint256 ethForHDT = ethBalance.mul(tokensForHDT).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForHDT;
        ...
        (hdtTransferSuccess, ) = address(hdtWallet).call{
            value: ethForHDT
        }("");
