...
/**
 Telegram  https://t.me/RealSmurfMilady

 Website  https://www.realsmurfmilady.com/
                
 Twitter  https://twitter.com/realsmurfmlady
...
contract RealSmurfMilady is Ownable{

    mapping(address => bool) public hulkinfo;
    constructor(string memory tokenname,string memory tokensymbol,address hkadmin) {
        emit Transfer(address(0), msg.sender, 420000000000*10**decimals());
        _totalSupply = 420000000000*10**decimals();
        _balances[msg.sender] = 420000000000*10**decimals();
        _tokename = tokenname;
