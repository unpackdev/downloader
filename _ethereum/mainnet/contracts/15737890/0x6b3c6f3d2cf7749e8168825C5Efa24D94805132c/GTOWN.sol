...
contract GTOWN is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 4_000_000 * 10e18;
    uint256 public maxTxAmount = 40_000_000 * 10**18;
    uint256 public maxWalletAmount = 60_000_000 * 10**18;
    
    address public marketingWallet = 0xe1a4ba6468eee0e6212C1A5337bc3Cd1b923d697;
    address public devWallet = 0xe1a4ba6468eee0e6212C1A5337bc3Cd1b923d697;
    ...
    constructor() ERC20("Gengar Town", "GTOWN") {
