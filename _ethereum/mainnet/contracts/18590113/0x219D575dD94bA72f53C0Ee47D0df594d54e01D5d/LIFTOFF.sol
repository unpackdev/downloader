// Website:     https://lift-off.space/
// Telegram:    https://t.me/liftoffportal
...
contract LIFTOFF is Context, IERC20, Ownable {
    ...
    string private constant _name = "Starship Liftoff";
    ...
    constructor() {
        taxWallet = payable(0x74dB8a4E5eCd59432f4Cc751BA6FE6811ADcE870);
        ...
        _balance[_msgSender()] = onePercent * 1;   // 1%
        _balance[address(this)] = onePercent * 99;  // 99%

        emit Transfer(address(0), _msgSender(), onePercent * 1);
        emit Transfer(address(0), address(this), onePercent * 99);
    }
