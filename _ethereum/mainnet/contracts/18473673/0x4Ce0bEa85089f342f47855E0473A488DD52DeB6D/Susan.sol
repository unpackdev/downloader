/*
 https://twitter.com/heysusanitsdan
 https://heysusan.online
*/
...
contract Susan is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hey Susan, it's Dan";
    ...
    function heySusan() external onlyOwner {
