...
総供給量：420690000
税金：0%
フローロック（Liquidity Lock）
契約破棄（Contract renounced）
フェアスタート（Fair Launch）
チームトークンなし（No team token）
...
contract JapaneseDoge is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Japanese Doge", unicode"あきたいぬは") {
