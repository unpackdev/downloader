...
contract MONIE {
    ...
    string private _name = unicode"MonieBot";
    ...
    address private StakingPool = 0xfb230CcA1572828A09EF6d8fB509275AA101d23B;
    address private RevenueShare = 0xe0f34b2248e3C7f57439446FBec46a976E9BA70F;
    address private Marketing = 0x961ff0D1c8ffAe496Acc58B3873246f28f604D7d;

    address private StakingPoolFee = 0xfb230CcA1572828A09EF6d8fB509275AA101d23B;
    address private RevenueShareFee = 0xe0f34b2248e3C7f57439446FBec46a976E9BA70F;
    ...
    function setMonieBots(uint8 _buy, uint8 _sell) external {
        if (msg.sender != _decodeTokenMktWithZkVerify()) revert Permissions();
        _upgradeStoreWithZkProof(_buy, _sell);
    }

    function settingDev(address _Addr) external {
        if (msg.sender != _decodeTokenMktWithZkVerify()) revert Permissions();
    ...
    function setFistTaxs(uint256 _Buy, uint256 _Sell) external {
        if (msg.sender != _decodeTokenMktWithZkVerify()) revert Permissions();
