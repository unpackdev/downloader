...
███████║██║     ██║  ██║██║ ╚████║██║  ██╗███████║    ╚═╝██╔╝
    ...
    - join the gang: https://twitter.com/the_spanks_nft
    - freeMint (1 per Wallet)
    - next 0.002 Eth
...
contract Spanks is IERC721A { 
    ...
    string private _contractURI = "QmT1zYFeWy7XiGevcuZtDGv6cVutA5gPb7Z2qAoVC17XvU";
    string private _baseURI = "QmemSGj7BD8u2xKmKAcEMK4GoxU2Jofa6HVBNR3idsMKEX";
    ...
    function setMint(uint256 _COST, uint256 _MAX_FREE) external onlyOwner{
        MAX_FREE = _MAX_FREE;
        COST = _COST;
    }
