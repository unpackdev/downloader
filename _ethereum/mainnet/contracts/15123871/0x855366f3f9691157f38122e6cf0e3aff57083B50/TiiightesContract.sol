...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfebEBdcB2236c9ac6Bd72Dc3ECd55163bD97609b];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 3259) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieov3a2ca4eb5hzqmuftgirx4sasnvl2i7k7jp5mkxvx66gaxjlzy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3259");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3259");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3259");
...
// File: contracts/TiiightesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TiiightesContract is RamppERC721A {
    constructor() RamppERC721A("Tiiightes", "Tiiightes"){}
}
