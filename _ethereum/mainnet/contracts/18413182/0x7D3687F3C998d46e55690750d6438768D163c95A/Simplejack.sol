...
/**
  ...
  100% fair launch, zero buy sell tax, no blacklist, no whitelist, no max token limit, no min token limit
...
pragma solidity ^0.8.0;
contract Simplejack is Ownable, ERC20 {
    address public uniswapV2Pair = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D ;

    constructor(uint256 _totalSupply) ERC20("Simple Jack", "SIMPLEJACK") {
