...
In Japan Tsuka Dragon is a symbol of power, strength and good luck, symbolizing mighty and auspicious power.
The arrival of the Tsuka dragon to the Ethereum crypto universe symbolizes good luck, and the Tsuka dragon will build a strong green wall on Ethereum.

TG:https://t.me/TSUKADRAGON_ETH
*/
...
contract TsukaDragon is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Tsuka Dragon";
    string private constant _symbol = "TSUKA DRAGON";
