...
https://www.zergling.cloud/
https://twitter.com/Zergling_ERC
@Zergling_ERC

    Dedicated to the pursuit of genetic perfection, Zergling Inu 
    relentlessly hunt down and assimilate advanced species across the galaxy, 
    incorporating useful genetic code into their own. They are named "the Swarm" 
    per their ability to rapidly create strains, and the relentless assaults they 
...
contract ZINU is ERC20, Ownable {
    ...
    constructor() ERC20("ZERGLING INU", "ZINU") {
    ...
    ; uint256 totalSupply = 4.77 * 1e12 * 1e18;
