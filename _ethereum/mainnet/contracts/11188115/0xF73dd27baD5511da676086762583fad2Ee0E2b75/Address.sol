...
contract HDTokenWrapper {
    ...
    //UNI-V2(HDT-ETH)
    IERC20 public stakeToken = IERC20(0xEd6dFf14bAaa8f8757c34aAA684332c9aBd6fd75); 
...
/**
 * XD-UNI-V2(HDT-ETH) Pool
 */
contract XDUNIV2HDTETHPool is HDTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "XD-UNI-V2(HDT-ETH)-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "XD-UNI-V2(HDT-ETH)-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"XD-UNI-V2(HDT-ETH)-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "XD-UNI-V2(HDT-ETH)-POOL: Pool is closed");
        _;
    }
