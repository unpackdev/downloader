...
contract Token is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x869e26d54A6AB4Ada931fE5fFCC8f16839CBC0E1; 
    address public receiveSellFeeWallet = 0x869e26d54A6AB4Ada931fE5fFCC8f16839CBC0E1; 
    IWrap public wrap = IWrap(0x9eF0A42E1E217C61480735E177E46F0Eaa6eB30A);
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("The Crypto Procotol", "Crypto", 8, 10000 * 10 ** 8){
        address msgSender = _msgSender();
