...
contract BabyDeji is ERC20, Ownable {
    ...
    constructor() ERC20( "Baby Deji", "SmolDeji") {
        ...
        operationsAddress = address(0x096A0890AecEA73C21CA6A80b99e4CEF7Eba3aC3); // change this address to wallet u want for operations   
        TaxAddress = address(0x096A0890AecEA73C21CA6A80b99e4CEF7Eba3aC3);  // change this address to the one for tax 
