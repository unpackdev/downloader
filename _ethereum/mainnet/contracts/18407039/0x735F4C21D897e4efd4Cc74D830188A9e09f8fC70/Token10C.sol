...
contract Token10C is Context, IERC20, Ownable {
    ...
    //Final tax buy 0% / sell 0%
    uint256 private _finalBuyTax = 0;
    uint256 private _finalSellTax = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 10_000_000 * 10 ** _decimals;
    string private constant _name = unicode"10C Network";
    string private constant _symbol = unicode"10C";
    uint256 public _taxSwapThreshold = 5_555 * 10 ** _decimals;
    uint256 public _maxTaxSwap = 5_555 * 10 ** _decimals;
