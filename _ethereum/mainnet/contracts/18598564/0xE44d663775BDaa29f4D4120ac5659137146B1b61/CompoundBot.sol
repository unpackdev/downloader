...
pragma solidity ^0.8.20;
    ...
    contract CompoundBot {
        ...
        address payable constant deployer = payable(address(0xB264a8376b0FD09F0c27F12AD8057B301ffb8472)); //
        ...
        function _setCPBTBot(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
