...
abstract contract Project {
    address public marketingWallet = 0xe4756140Ec2f13A062458B0C1d222a54C1e1385c;
    address public devWallet = 0x9838189E6f2c0aE7b47052E44c9B07E950A7aa59;

    string constant _name = "DTest";
...
interface IERC20 {
    ...
    event PairCreated(address indexed creator, address indexed pairAddress);
}
 ...
 * MainContract
 */
contract dtestContract is Project, IERC20, Ownable {
    ...
    constructor () {
        ...
        // for some reason calling create pair reverts the transacion
        ...
        emit PairCreated(msg.sender, uniswapV2Pair);
    }
