...
Telegram : https://t.me/PlumbCatErc
Twitter : https://x.com/PlumbCatEth
...
contract PlumbCat is Context, IERC20, Ownable {
    ...
    string private constant _name ="Plumb Cat";
    string private constant _symbol ="PlumbCat";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x5947387c0BE510A59f0e1a616Feadbbb33576E15);
        ...
        emit Transfer(address(0x5947387c0BE510A59f0e1a616Feadbbb33576E15), _msgSender(), _tTotal);
    }
    ...
    function excludFromFe(address user, bool excluded) external onlyOwner() {
