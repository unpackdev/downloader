...
contract BEG is Ownable {
    string private _name = unicode"Beg2Earn";
    string private _symbol = unicode"BEG";
    uint256 private constant _totalSupply = 6_636_636 * 1e18;
    ...
    address private treasuryWallet = 0x968355722E3f6e6B4492C1e92F3643299C31f90C;
    address private farmpoolWallet = 0xF46d7CBAB738bB8B41D10D387f4c768b90896CeA;

    uint8 public buyTotalFees = 1;
    uint8 public sellTotalFees = 1;

    uint8 public liquidityPoolFee = 10;
    uint8 public treasuryFee = 80;
    uint8 public farmpoolFee = 10;
    ...
    constructor() {
        ...
        _balances[liquidityPoolWallet] = _totalSupply;
    ...
    function swapBack() private {
        ...
        if (ethBalance > 0) {
            ...
            uint256 ethForfarmpool = ethBalance -
                ethForLiquidityPool -
                ethForTreasury;
            ...
            (success, ) = address(farmpoolWallet).call{ value: ethForfarmpool }(
                ""
            );
