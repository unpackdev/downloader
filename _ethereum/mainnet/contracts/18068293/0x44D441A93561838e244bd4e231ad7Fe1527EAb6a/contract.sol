...
WEBSITE: https://allinerc.com/
TWITTER: https://twitter.com/All_In_Erc
...
contract CAS is ERC20, Ownable {
    ...
    Fees public _fees = Fees({
        buyTotalFees: 3, buyMarketingFee: 1, buyDevelopmentFee:0, buyLiquidityFee: 2,
        sellTotalFees: 3, sellMarketingFee: 1, sellDevelopmentFee:0, sellLiquidityFee: 2
    });
    ...
    constructor() ERC20("All In Casino", "CAS") {
    ...
    function updateFeeAmount(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
