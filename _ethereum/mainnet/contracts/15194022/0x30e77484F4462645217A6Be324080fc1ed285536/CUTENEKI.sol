...
contract CUTENEKI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CUTE Neki", "CUTE Neki") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 2% from total supply maxTransactionAmount
        ...
        marketingWallet = payable(0xFB88a699116bC8870d5A4825387F5378592EE233);
        devWallet = payable(0xFB88a699116bC8870d5A4825387F5378592EE233);
