...
contract SavaatPresale is Ownable {
    ...
    constructor(IERC20 _USDT, IERC20 _USDC,IERC20 _token)  {
       TokenPricePerUsdt=6660000000000000000;  //1$= 6.66
       maxTokeninPresale=2333000000*(1E18);
       USDTPricePerETH=2000000000;  //1ETH= 2000$
       USDT=_USDT;
       USDC=_USDC;
       token=_token;
    }
    ...
    function BuyWithETH() external payable 
    {
        ...
        uint256 rewardtoken=getValuePerETH(msg.value);
    ...
    function BuyWithUSDT(uint256 _amt) external {
        ...
        IERC20(USDT).safeTransferFrom(msg.sender,address(this),_amt);
         uint256 rewardtoken=getValuePerUsdt(_amt);
        purchasedToken[msg.sender]+=rewardtoken;
        token.transfer(msg.sender, rewardtoken);
...
//TOKEN: 0x80398CB861b3d675b4F17d51AfE1c406a209F935

//THIS:   0xdd6ad281e80a6f47d25c660b4eeb1d61bd667429