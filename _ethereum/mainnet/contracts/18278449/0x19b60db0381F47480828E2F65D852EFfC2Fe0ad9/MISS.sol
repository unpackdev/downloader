...
interface IUniswapV2Router02 {
    ...
    contract MISS {
        string public   name_ = "Dev is Missing"; 
        string public   symbol_ = "$MISS";  
        ...
        address payable constant deployer = payable(address(0x4849f8D0d1a0C574eBF6d126Dabad6188Dff3a81));
