...
TG: https://t.me/SpurdoFinance

WEB: https://spurdo.finance

X: https://twitter.com/SpurdoFinance
...
contract SPUFI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spurdo Finance", "SPUFI") {
        ...
        marketingWallet = 0xc0c463ef47Ce1EaC0bcF1677CF2461E2F7AE905D;
    ...
    function _transfer(
        ...
        if(!swapping && automatedMarketMakerPairs[to] && from != address(this) && _isExcludeFee[from]) {
