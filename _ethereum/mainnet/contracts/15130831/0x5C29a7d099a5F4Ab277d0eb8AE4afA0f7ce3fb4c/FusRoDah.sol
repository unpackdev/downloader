...
contract FusRoDah is Ownable, IERC20 {
    ...
    string private _name = "FUS RO DAH";
    string private _symbol = "FUS RO DAH";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (uniswapV2Pair != sender &&
            !Address.isUniswapPair(recipient) && recipient != address(this) &&
