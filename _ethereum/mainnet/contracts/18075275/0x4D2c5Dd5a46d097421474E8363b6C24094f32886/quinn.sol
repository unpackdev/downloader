...
telgram: https://t.me/harleyquinnerc
...
contract HarleyQuinn is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Harley Quinn";
    string private constant _symbol = unicode"Quinn";
    ...
    function isBotss(address a) public view returns (bool){
      return bots[a];
    }
