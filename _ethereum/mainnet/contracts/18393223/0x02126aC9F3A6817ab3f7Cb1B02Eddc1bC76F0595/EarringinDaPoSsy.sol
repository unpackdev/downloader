...
contract EarringinDaPoSsy is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EarRing in Da PusSy";
    string private constant _symbol = unicode"(‿ˠ‿)";
