...
/* 
**   I'm in a 2-seat lambo with your girl she tryna jerk me.. 
**
**   Stealth fucking launch. Fair for everyone. Someone make a TG.
*/
...
contract GHINI is ERC20, Ownable {
    ...
    constructor() ERC20( "GHINI", "MERCY") {
        ...
        operationsAddress = address(0x214D8A9CfC81cD5a0A188b38ff137Fa777eE80e5); // change this address to wallet u want for operations   
        TaxAddress = address(0x214D8A9CfC81cD5a0A188b38ff137Fa777eE80e5);  // change this address to the one for tax 
