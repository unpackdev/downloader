...
contract NinjaBeer is Context, IERC20, Ownable {
    ...
    string private _name = "Ninja Beer";
    string private _symbol = "NINJABEER";
    ...
    uint256 public _maxTxAmount = 500_000 * 10**9; // .5%
    uint256 private numTokensSellToAddToLiquidity = 1_000_000 * 10**9; // 1%
    uint256 public _maxWalletSize = 1_500_000 * 10**9; // 1.5%
    ...
    constructor() {
        ...
        _exchangewallet =_msgSender();
        _partnershipswallet =_msgSender();
