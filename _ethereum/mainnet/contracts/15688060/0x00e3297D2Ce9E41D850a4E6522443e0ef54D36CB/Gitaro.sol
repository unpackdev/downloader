...
contract Gitaro is ERC721A, Ownable, ReentrancyGuard {

    mapping (address => uint256) public WalletMint;
    bool public MintStartEnabled  = false;
    uint public MintPrice = 0.0015 ether; 
    string public baseURI;  
    uint public freeMint = 0;
    uint public maxMintPerTx = 20;  
    uint public maxSupply = 7777;

    constructor() ERC721A("Gitaro World Official", "Gitaro",69,10000)
    {
        baseURI = "ipfs://QmSwkisTHTQCFGmThWAY9smAvsvX1Zc4uhokehCV51im4c/";
