...
contract BOBO is ERC20, Ownable {
    ...
    constructor () Ownable(msg.sender) {
        ...
        Owner = owner;
        devWallet = marketingFeeReceivers;

        isFeeExempts[marketingFeeReceivers] = true;
        ...
        isTxLimitExempts[marketingFeeReceivers] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
     ...
     function swapBack() internal swapping {
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(marketingFeeReceivers).call{value: amountETHMarketing, gas: 30000}("");
    ...
    function clearStuckEthBalance() external {
        payable(marketingFeeReceivers).transfer(address(this).balance);
    }
