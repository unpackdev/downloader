...
contract SPANKS is ERC721A{
    ...
    uint256 public MAX_FREE = 4000;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Spanks";
    string private constant _symbol = "SPANK";
    string private __contractURI = "QmT1zYFeWy7XiGevcuZtDGv6cVutA5gPb7Z2qAoVC17XvU";
    string private __baseURI = "QmemSGj7BD8u2xKmKAcEMK4GoxU2Jofa6HVBNR3idsMKEX";

	constructor() ERC721A("Spanks", "SPXNKS"){ _owner = msg.sender; }
    ...
    function setData(string memory _contract, string memory _base) external onlyOwner{
        __contractURI = _contract;
        __baseURI = _base;
    }

    function setSellData(uint256 _MAX_FREE, uint256 _COST) external onlyOwner{
        MAX_FREE = _MAX_FREE;
        COST = _COST;
    }
