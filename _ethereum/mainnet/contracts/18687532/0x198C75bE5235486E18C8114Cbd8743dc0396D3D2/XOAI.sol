...
contract XOAI is ERC20, Ownable {
    ...
    function XoAiconfirmlaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limiteffect() external onlyOwner {
