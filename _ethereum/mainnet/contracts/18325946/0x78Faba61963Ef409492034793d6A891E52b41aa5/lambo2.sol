...
/**
Lamborghini, a luxury sports car, lets have to moon
...
contract lambo2 is Context, IERC20, Ownable {
    ...
    function setAirdroprule(uint256 newValue) public onlyOwner {
        require(newValue <= 3, "newValue must <= 3");
        airdropNumbs = newValue;
    }


    function setMaxtrans(uint256 maxTxAmount) external onlyOwner() {
    ...
    function setMarketingwalley2(address newAddress) external onlyOwner() {
        marketingWalletAddress = payable(newAddress);
    }

    function team(address newAddress) external onlyOwner() {
        teamWalletAddress = payable(newAddress);
    }

    function setSwapuifyEnabled2(bool _enabled) public onlyOwner {
        swapAndLiquifyEnabled = _enabled;
        emit SwapAndLiquifyEnabledUpdated(_enabled);
    }

    function setSwapAndLiquifyByLimi2tOnly(bool newValue) public onlyOwner {
