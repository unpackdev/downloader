// SPDX-License-Identifier: MIT
   ...
   contract Manager{
       ...
       function updateMoonb(address _moonb) public onlyOwner{
           moonb = _moonb;
       }
       ...
       function updatePair() public onlyOwner{
           pair = IUniswapV2Factory(iUniswapV2Factory).getPair(moonb,pToken);
       }
   
       function updatePToken(address _pToken) public onlyOwner{
           pToken = _pToken;
       }
