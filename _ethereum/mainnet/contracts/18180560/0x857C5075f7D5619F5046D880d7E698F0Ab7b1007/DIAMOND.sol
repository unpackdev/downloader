...
contract DIAMOND is ERC20, Ownable {
    ...
    function BoughtDIAMONDEarly(address wallet, bool flag) external onlyOwner {
        bot[wallet] = flag;
    }

    function massDIAMONDBoughtEarly(address[] calldata wallets, bool flag) external onlyOwner {
