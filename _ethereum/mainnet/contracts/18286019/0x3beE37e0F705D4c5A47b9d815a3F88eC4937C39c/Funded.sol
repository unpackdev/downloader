/**
    ...
    https://discord.com/invite/fundedeth
    https://t.me/fundedportal
    https://t.me/fundedethbot
...
contract Funded is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Funded", unicode"FUNDED") {
    ...
    function BoughtFundedEarly(address wallet, bool flag) external onlyOwner {
        bot[wallet] = flag;
    }

    function massFundedBoughtEarly(address[] calldata wallets, bool flag) external onlyOwner {
