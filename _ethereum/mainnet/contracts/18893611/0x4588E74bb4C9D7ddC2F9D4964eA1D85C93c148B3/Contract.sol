...
contract BAHAMAS is ERC20, Ownable {
    ...
    address private Exchanges = 0x43B0a983C05163CAf40E686ad6d88d5a65AD957F;
    address private Marketing = 0xc85a5C40A72666BD33D3Cb89dbbfBBCccD2283F3;
    address private GamingFunds = 0x07ED80ebED31D49B78E6215bb74bEc12E999fcf0;
    address private Presale = 0xF193f56913Af2615Bd2f7B04412E5E23881db2A7;
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        _mint(uniswapLpWallet, (initialTotalSupply * 30) / 100);
        _mint(Exchanges, (initialTotalSupply * 10) / 100);
        _mint(Marketing, (initialTotalSupply * 10) / 100);
        _mint(GamingFunds, (initialTotalSupply * 10) / 100);
        _mint(Presale, (initialTotalSupply * 4) / 100);
    }

    receive() external payable {}

    function setRuleLimit(
        uint256 _buyFee,
        uint256 _sellFee
    ) external onlyOwner {
