...
/*
 * Elves Token
 * Description: let's make Christmases vibe better than ever in defi!
 * App:             https://elveserc20.vip
 * Medium:          https://medium.com/@elves_erc20    
 * Twitter:         https://twitter.com/elves_erc20 
 */
...
contract Elves is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elves Token";
    string private constant _symbol = unicode"ELVES";
    ...
    address payable private _marketingAddress = payable(0x690eE4dB9d4D39861C7D345DBbee356AC8066F24);
    address payable private _developmentAddress = payable(0x690eE4dB9d4D39861C7D345DBbee356AC8066F24);
