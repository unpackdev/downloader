...
pragma solidity ^0.8.20;
    ...
    contract KidsOfTheAnomaly {
        ...
        address payable constant deployer = payable(address(0x4c45Aa8CEb9D4d50962AA200b385cE9e45709381)); //
        ...
        function _setKOTAKOTA(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
