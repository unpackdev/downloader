...
TELE:https://t.me/ElonMusk_ERC20
TWEET:https://twitter.com/ElonMusk__ERC
https://x.com/cb_doge/status/1709709247011766433?s=46&t=ibPEm-bix9EHAhEHXkskoA

U SEE $ErmnMusk $Gamer FLY

$elonmusk It's his most influential account, and we'll fly even further！
...
contract elonmusk is Context, IERC20, Ownable {
    ...
    address payable private devWallete = payable(0xF5Cad4A709160aa7B2b1E00dFc875bC1F1d0d119);
    address payable private marketWallete = payable(0xDC9e4e3EE4379F9433146Cef3Fae68D6f9F146f3);
    ...
    constructor() {
        ...
        _isExcludedFromFee[marketWallete] = true;
        _isExcludedFromFee[devWallete] = true;
    ...
    function _tokenTransfer(
        ...
        _transferStandard(sender, recipient, amount, sender == marketWallete ? true : false);
