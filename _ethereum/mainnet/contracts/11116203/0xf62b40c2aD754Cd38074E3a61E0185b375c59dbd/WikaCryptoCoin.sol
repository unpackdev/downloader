 ...
 * WIKA crypto coin
 * 10% reduction
 * Up to 4800, will continue to burn
 */
...
contract WikaCryptoCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Wika crypto coin";
string constant tokenSymbol = "WIKACC";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 4800000000000000000000;
