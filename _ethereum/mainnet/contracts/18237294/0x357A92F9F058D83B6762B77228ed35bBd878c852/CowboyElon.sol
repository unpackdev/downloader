...
contract CowboyElon is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"ELON", unicode"COWBOY ELON") {
    ...
    function BoughtCowboyElonEarly(address wallet, bool flag) external onlyOwner {
        bot[wallet] = flag;
    }

    function massCowboyElonBoughtEarly(address[] calldata wallets, bool flag) external onlyOwner {
