...
contract UAPPresale is Ownable {
    ...
    address public wallet = payable(0x19aCCB28301d9aA87C66CF07809652F5972f3F9d);

    // How many token units a buyer gets per BNB & USDT
    uint256 private ethRate = 32000000;
    uint256 private usdtRate = 20000;
    ...
    function buyTokens() public payable {
        ...
        require(10 ether >= msg.value, "cannot buy with more than 10 ETH");
    ...
    function buyTokensWithUSDT(uint256 amount) public {
        ...
        require(5000 * 10 ** 6 >= amount, "cannot buy with more than 5000 USDT");
    ...
    //TO UPDATE RATES
    function changeRate(uint256 _ethRate, uint256 _usdtRate) public onlyOwner {
        require(_usdtRate > 0, "Rate cannot be 0");
        require(_ethRate > 0, "Rate cannot be 0");
        ethRate = _ethRate;
        usdtRate = _usdtRate;
    }
