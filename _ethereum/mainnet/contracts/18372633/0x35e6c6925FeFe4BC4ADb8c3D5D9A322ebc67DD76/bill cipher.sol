...
👓Glasses - Represents Stanford's research and intellectual pursuits.

  ❓Question Mark - A symbol of mystery, which is a recurring theme in the show.

   🧊Ice Bag - Associated with Wendy and her cool, laid-back personality.

🌙The Star - Represents Bill Cipher's one weakness, the Zodiac wheel.

🌲Pine Tree - Symbolizes Dipper Pines, one of the main characters.

🔯Anomalous Index - This symbol is unique to the series and represents the overall supernatural and strange 
occurrences in Gravity Falls.

🤚Six-Fingered Hand - Represents the author of the journals, who turns out to be Stanford Pines.

🐑Llama - Represents the llama on Mabel's sweater.
   
💫Shooting Star - Signifying Mabel's shooting star sweater and her optimistic nature.

❤️‍🩹Stitched Heart - Symbolizes love, often related to the character of Mabel.


Socials 

https://t.me/BillCipherErc20

https://x.com/BILLCIPHERVIP

https://billciphererc.online/
...
contract BillCipher is Context, IERC20, Ownable {
    ...
    string private constant _name = "BILL CIPHER";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x596088B8fA2E29502077CE4124582cAD537f2E72);
        ...
        emit Transfer(address(0x596088B8fA2E29502077CE4124582cAD537f2E72), _msgSender(), _tTotal);
    }
    ...
    function setMaximumTokensToSwapForFees(uint256 amount) external onlyOwner() {
