...
contract Owned {
    ...
    constructor() public {
        owner = 0xeC52ABF4B4dBF2A858988f2fD574F322D56494EA;
    }
...
contract FreedomPumpToken is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "FPT";
        name = "FreedomPumpToken";
        decimals = 18;
        _totalSupply = 1000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
         RATE = 10;            // 10 FPT per ETH
        DENOMINATOR = 1;       // 1 ETH = 10 FPT
