...
contract ECADEGEN {
    ...
    string  public constant name        = "All calls from my chanel are unpaid, so I rarely post. My win rate in chanel is very high. Set notifications so you don't miss it.";
