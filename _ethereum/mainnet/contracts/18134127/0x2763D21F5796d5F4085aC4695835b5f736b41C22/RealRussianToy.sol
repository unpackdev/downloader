/*
Real Russian Toy [матрёшка]

https://t.me/RealRussianToy
https://twitter.com/RealRussianToy
...
contract RealRussianToy is ERC20, Ownable {
    ...
    string private constant name_ = unicode"Real Russian Toy";
    string private constant symbol_ = unicode"матрёшка";
    ...
    uint256 public maxTransactionAmount = 25000000 * 10 ** _decimals;
    uint256 public maxWallet = 25000000 * 10 ** _decimals;
