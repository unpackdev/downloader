...
contract Ruvbot is ERC20, Ownable {
    ...
    constructor() ERC20("RuvAntoBot", "RBA") {
        ...
        maxTransactionAmount = 27_000 * 1e18; // 0.9%
        maxWallet = 54_000 * 1e18; // 1.8% 
        ...
        revShareWallet = address(0x6552B54bEb9ab55b811a06c31cAD2E83b3d0b00b); // set as revShare wallet
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellRevShareFee + sellLiquidityFee + sellTeamFee;
        require(sellTotalFees <= 10, "Sell fees must be <= 40.");
    }
