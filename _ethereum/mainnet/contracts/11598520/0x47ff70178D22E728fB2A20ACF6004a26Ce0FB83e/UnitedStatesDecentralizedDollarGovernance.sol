...
contract UnitedStatesDecentralizedDollarGovernance is IERC20, SafeMath {
    string public name;
    ...
    constructor() public payable {
        name = "United States Decentralized Dollar Governance";
        symbol = "USDDg";
        decimals = 18;
        owner = msg.sender;
        _totalSupply = 20000 * 10 ** uint256(decimals);   // 24 decimals 
