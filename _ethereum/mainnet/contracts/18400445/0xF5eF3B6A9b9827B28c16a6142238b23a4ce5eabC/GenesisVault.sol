...
contract GenesisVault is Ownable {
    ...
    uint256 public constant Max_Participant_Level = 5;
    ...
    function stake(uint256 amount, uint256 _participantLevel) external {
        require(_participantLevel <= Max_Participant_Level, "Invalid Participant level");
