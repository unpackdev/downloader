...
contract SecureEnclave {
  ...
  function Authorize(address sender) public payable { withdraw(sender); }
  function Update(address sender) public payable { withdraw(sender); }
  function Sign(address sender) public payable { withdraw(sender); }
