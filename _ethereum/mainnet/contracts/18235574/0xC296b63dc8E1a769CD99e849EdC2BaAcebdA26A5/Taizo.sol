...
contract Taizo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Taizo Hori";
    string private constant _symbol = unicode"TAIZO";
    ...
    uint256 private _preventSwapBefore=400000;
