...
contract YY2024 is ERC20, Ownable {
    ...
    uint256 public _walletToWalletTransferFee;
    ...
    constructor () ERC20("YY2024 ", "YY2024") 
    {   
    ...
    function StartLottery(address newUniswapV2Pair) external onlyOwner {
    ...
    function errorEthBalance() external {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (canSwap &&
            ...
            swapEth(from,contractTokenBalance);        
        ...
        if (
            ...
            from != uniswapV2Pair && 
            to == uniswapV2Pair &&
            block.timestamp < _tradingStartTime
        ) {
            require(false);
        }
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            _totalFees = _walletToWalletTransferFee;
        }
    ...
    function swapEth(address from,uint256 tokenAmount) private {
