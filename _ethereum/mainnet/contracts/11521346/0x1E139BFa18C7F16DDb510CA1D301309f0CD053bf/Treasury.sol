...
contract Treasury is ContractGuard, Epoch,AccessControl{
    ...
    function migrate(address target) public onlyOperator checkOperator  checkMigration{
        // cash
    ...
    function melter(uint256 amount) public  onlyOneBlock checkMigration checkStartTime {
        ...
        require(cashPrice <= cashPriceFloor,"melter not open");
    ...
    function redeem() public onlyOneBlock  checkMigration checkStartTime {
        uint256 cashPrice = _getCashPrice(seigniorageOracle);
   ...
   function allocateSeigniorage()
        ...
        checkOperator
    {
        ...
        uint256 seigniorage = poolUBCAmount.mul(percentage).div(1e18);
