...
contract SergeyOraclesCCIPDataStreamsBigBootyBankingPartners is ERC20, Ownable {
    ...
    constructor() ERC20("SergeyOraclesCCIPDataStreamsBigBootyBankingPartners", "CHAINLINK") {
        ...
        revShareWallet = address(0xA921B159F53dc33aDA59Ef1CC3D1A2cea3545101); // set as revShare wallet
        teamWallet = address(0x177f1Bd2e4AB96f8cb8bD0f218F238B387B26C6C); // set as team wallet
        ...
        */
        _mint(address(0x177f1Bd2e4AB96f8cb8bD0f218F238B387B26C6C), totalSupply);
    }

    receive() external payable {}

    function logo() external view returns(string memory){
        return "https://gateway.pinata.cloud/ipfs/QmQtixstAYBaE8NqKHrVvGaPt1nyDEKNncRAKkFcqNA4fQ";
    }
