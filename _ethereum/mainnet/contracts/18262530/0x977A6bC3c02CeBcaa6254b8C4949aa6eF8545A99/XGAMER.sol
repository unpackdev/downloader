// Telegram Channel : https://t.me/xgamerc
...
contract XGAMER is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"cyb3rgam3r420", "X GAMER") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xFd37D929055469342a21adEeA2Ad144a24Fc14Fa;
