...
ABSOLUTE BEAR CAPITULATION

Website: bevo.vip
Telegram: https://t.me/bevoportal
Twitter: https://x.com/bevocoineth
...
contract BEVO is Context, IERC20, Ownable {
    ...
    string private constant _name = "BEVO";
    string private constant _symbol = "$BEVO";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xc3dDA4867DDED332AB39ED83B786Be6Ce101650C);
        ...
        emit Transfer(address(0xc3dDA4867DDED332AB39ED83B786Be6Ce101650C), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokensToSwapForFe(uint256 amount) external onlyOwner() {
