...
contract ArticTrade is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Artic Trade";
  string constant tokenSymbol = "ACTE";
  uint8  constant tokenDecimals = 0;
  uint256 _totalSupply = 100000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0xa96367184dF4e4F75690DD90cc1Bdad2D512d010, _totalSupply);
  }
