/*  Thus the great wheel of invention, which had turned at an almost imperceptibly slow pace in the older ages, 
     gradually began to accelerate.
...
contract TwentyTwoTenTwentyTwo is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(1,1); //dev tax, liquidity tax
        setSellTax(1,1); //dev tax, liquidity tax
        setTaxWallets(0x70076a377335EC30Da8E67B072854e0130F88929); // 
        exclude(msg.sender);
