...
The Nyan Cat meme is a classic and iconic internet meme that gained popularity around 2011. It features a pixel art cat with a Pop-Tart for a body, flying through space with a rainbow trail behind it. 

The meme is typically accompanied by a catchy, repetitive tune known as the "Nyan Cat Song". The meme is often used in videos or GIFs with the Nyan Cat flying across various landscapes or situations.

We bring both Nyan Cat and the famous smurf meme and present to you NYAN SMURF!😺

TG - https://t.me/NyanSmurfErc20

Website - NyanSmurfETH.live

Twitter - https://x.com/NyanSmurfErc20
*/
...
contract NyanSMURF is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"NYAN SMURF";
    string private constant _symbol = unicode"NYANSMURF";
    ...
    uint256 private removeBuyFeesAt = 16;
