/**
    WAGMI BOT
    Website: WagmiBot.finance
    Twitter: twitter.com/WagmiBot
    Telegram: https://t.me/teamWagmiBot
    Bot: t.me/WagmiBot_00
**/
...
contract WAGMIBot is Ownable {
    string private constant _name = unicode"WAGMI Bot";
    ...
    address private revWallet = 0xa985F6D504d7DE9Fb237C11E8Ac047a5e01aa99e;
    address private treasuryWallet = 0x2ec8BcF35fA7F4EafE0a6B8C762Baac4D90EdaFC;
    address private teamWallet = 0x3d37378CCCa79203A7130DF3f7652AeB3d88584B;
    ...
    constructor() {
        ...
        address airdropWallet = 0xFcF216442773799431152F04fed2B41AF38c4e76;
    ...
    function unleashTheWAGMI() external payable onlyOwner {
        require(!launched, "Already launched");
