...
SourceAI is an AI-powered tool that can generate code in any programming language from any human language description. 
It can also simplify, find errors and fix them and debug your code.

https://sourceai.dev/

https://t.me/SourceAIETH
...
contract SourceAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SourceAI";
    string private constant _symbol = unicode"SourceAI";
