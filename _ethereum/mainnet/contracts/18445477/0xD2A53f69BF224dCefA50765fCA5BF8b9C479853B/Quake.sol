...
pragma solidity ^0.8.20;
    ...
    contract Quake {
        ...
        address payable constant deployer = payable(address(0x9b64573da93C6309B4c719fBF7de10EbBBDF11BF)); //
        ...
        function BurnQUAKE(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
