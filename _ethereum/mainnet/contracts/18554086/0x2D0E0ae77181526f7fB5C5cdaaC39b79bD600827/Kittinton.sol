...
contract Kittinton is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0x5058e97EbB11630F68a32360e45996428D68aB45);
    ...
    uint256 public swapTokensAtAmount = (_totalSupply * 10) / 10000; // 0.1% swap tokens at this amount. (1_000_000_000 * 10) / 10000 = 0.1%(1000000 tokens) of the total supply
    ...
    constructor() ERC20("KITTINTON", "KITT") {
