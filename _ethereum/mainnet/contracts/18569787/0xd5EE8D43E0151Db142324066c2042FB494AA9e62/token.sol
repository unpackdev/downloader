...
Website: https://ztoken.pro
Telegram: https://t.me/ztoken
Twitter: https://twitter.com/ztoken

THE FUTURE BEGINS NOW 
The standard tokenization process can be painfully slow and extremely expensive for the average user. 
ZT Token solves this by giving users all they need to tokenize an asset in a simple all-in-one platform without writing a single line of code!
...
contract ZToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ZToken";
