...
contract zumi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"zumi izumi";
    string private constant _symbol = unicode"ZUMI";
    uint256 public _maxTxAmount =   40500000 * 10**_decimals;
    uint256 public _maxWalletSize = 40500000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 0 * 10**_decimals;
    uint256 public _maxTaxSwap= 40500000 * 10**_decimals;
