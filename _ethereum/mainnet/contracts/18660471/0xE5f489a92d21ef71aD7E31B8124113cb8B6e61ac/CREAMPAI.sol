// SPDX-License-Identifier: MIT
        ...
        //WEBSITE: https://creampaierc.wtf
        //TELEGRAM: https://t.me/creampaierc
        //TWITTER(X): https://twitter.com/CreampAI_Erc
...
contract CREAMPAI is PAI20, Ownable {
  ...
  using SafeMath for uint256;
    ...
    address public PAIdeployer;
    address constant taxwallet = 0x7C702A2A0715Cb8dfdC9c447bBf435583787a4bB; 
    ...
    maxTxAmount = 69000000000 * (10 ** uint256(_decimals));
    PAIdeployer = 0x1463c3Ad9dbeF4D086052D164a192D83419BD45d;
    _isExcludedFromTax[PAIdeployer] = true;
   ...
   function _transfer(
    ...
    function burnFee(uint256 newAmount) external onlyOwner {
