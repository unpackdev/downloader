...
/**
 *Reduce appreciation tokens, because of the reduction, they can continue to appreciate!
 *10% of the recovered coins are destroyed, please do not trade frequently!
 *It is estimated that the price will reach 1:1 ETH in a week
 *When the address increases to 1000, we will be listed on the exchange!
 */
...
contract ReduceAppreciationToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "ReduceAppreciationToken";
string constant tokenSymbol = "RAT";
