...
// public
  function public_mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        ...
        require(msg.value >= 2 * cost * _mintAmount, "insufficient funds");
      }
...
// gift
  function free_mint(uint256 _mintAmount) public payable {
    require(paused == false, "the contract is paused");
    uint256 supply = totalSupply();
    require(_mintAmount > 0, "need to mint at least 1 NFT");
  ...
  function FlipPause(bool _state) public onlyOwner {
    paused = _state;
  }
