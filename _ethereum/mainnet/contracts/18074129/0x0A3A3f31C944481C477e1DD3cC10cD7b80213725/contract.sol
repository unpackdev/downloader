...
Web 
https://snifferdog.tech/

X/Twitter
https://twitter.com/SnifferDogErc

TgPortal
https://t.me/snifferdogportal

SnifferDogBot
https://t.me/snifferdog_bot
...
contract SNIFF is ERC20, Ownable {
    ...
    Fees public _fees = Fees({
        buyTotalFees: 3, buyMarketingFee: 1, buyDevelopmentFee:1, buyLiquidityFee: 1,
        sellTotalFees: 3, sellMarketingFee: 1, sellDevelopmentFee:1, sellLiquidityFee: 1
    });
    ...
    constructor() ERC20("SnifferDog", "SNIFFBOT") {
        ...
        marketingWallet = address(0x4Be3f765e5f55f16f8ee16dbf7Eb56ebfe34e77A);
        developmentWallet = address(0x4Be3f765e5f55f16f8ee16dbf7Eb56ebfe34e77A);
    ...
    function changeMinSwapAmount(uint256 newAmount) external onlyOwner returns(bool){
        thresholdSwapAmount = newAmount;
        return true;
    }

    function setFeesTotal(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
    ...
    function setMaxTxnAmount(uint256 newMaxBuy, uint256 newMaxSell, uint256 newPercentage) public onlyOwner {
    ...
    function removeLimits() external onlyOwner {
        setMaxTxnAmount(1000,1000,1000);
    }
