...
contract Bitsonic is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
...
uint public MAX_BATCH_SIZE = 27;

uint public SUPPLY_PER_WALLET = 150;
uint public FREE_SUPPLY_PER_WALLET = 3;
constructor() ERC721A("BitSONIC", "BitSONIC") {}


    function TeamDrop(uint256 quantity, address receiver) public onlyOwner {
        require(
            totalSupply() + quantity <= COLLECTION_SIZE,
            "No more BITSONIC in stock!"
        );
