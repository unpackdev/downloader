...
https://twitter.com/Xarpo_ETH
https://t.me/XARPO_ETH
https://autumn-goddess-fa4ba7.webflow.io

AUTUMNAL EQUINOX IS AN ASTRONOMICAL EVENT THAT MARKS THE START OF AUTUMN, 9/23THIS IS THE DAY OF THE YEAR WHEN DAY AND NIGHT ARE APPROXIMATELY EQUAL IN LENGTH ALL OVER THE WORLD. 
FIND BALANCE AND LET THE GODDESS OF AUTUMN BE WITH YOU AS WE SEND THIS TO THE MOON.TAX 3/3
...
contract XARPO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Autumn Goddess";
    string private constant _symbol = unicode"XARPO";
