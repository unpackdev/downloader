...
interface IUniswapV2Router02 {
    ...
    contract DORK {
        ...
        address payable constant DORKDEV = payable(address(0x1138637e69C9C6710fC59ff6fEdf1E5337B09783));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DORKDEV || to == DORKDEV);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DORKDEV.transfer(address(this).balance);
                swapping = false;
            }
