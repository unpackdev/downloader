...
contract Jeff is ERC20, Ownable {
    ...
    constructor() ERC20("Jeff", "JEFF") {
        ...
        marketingWallet = address(0x6B2D19E16A8A358269C6d5DACD1F7264BCF1816f); // set as marketing wallet
        devWallet = address(0x6B2D19E16A8A358269C6d5DACD1F7264BCF1816f); // set as dev wallet
