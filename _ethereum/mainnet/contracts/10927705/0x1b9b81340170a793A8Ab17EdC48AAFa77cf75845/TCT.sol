/*     _______  
      |_______| ____ __    ||  ||  \\   || ______            _____                  _____        _____
         ||     |     |    || ||    \\ // |     |           ||        ||    ||    ||     \\    ||    ||
         ||     |     |    ||-       ||   |     |           ||        ||----||    ||_____\\    ||    ||
...
contract TCT is StandardToken {
    ...
    */
    ...
    address private index_owner = 0x5B6c7635b954fc6437696A0999900C57e1A3CA64; // OWNER OF TOKENS AT DEPLOYMENT
    ...
    function activateTCT() {
        uint256 total_coins = 400 * 10 ** uint256(18);
        ...
        name = "Tokyo CHAD";                                   // Set the name for display purposes
