...
/*
UltraSound | Decentralized Music App 

UltraSound is a revolutionary music dapp built on the Ethereum network,providing a trusted platform for music creators and lovers to connect and discover new pieces of musical delight. With UltraSound, you can easily upload and share your favorite songs, as well as listen to tracks contributed by other users.

Strap on your headphones and join the UltraSound community for a one-of-a-kind musical experience.
...
Website: ultrasounds.app
Dapp: ultrasounds.app
Twitter: twitter.com/UltraSoundERC
Telegram: t.me/UltraSoundApp
*/
...
contract UltraSound is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"UltraSound";
    string private constant _symbol = unicode"SOUND";
