...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfffBF891773D11a329588DfEaB6dF10f850a2d07];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 6, 12) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicns2h3ccbfappbbkcjzz3l2hhmzx5alwkpuvsprvde44sf6tctii/";
...
// File: contracts/UnusualTitansContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UnusualTitansContract is RamppERC721A {
    constructor() RamppERC721A("Unusual Titans", "UNTT"){}
}
