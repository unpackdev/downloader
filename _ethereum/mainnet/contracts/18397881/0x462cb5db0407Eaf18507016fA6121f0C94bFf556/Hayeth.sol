...
/*
 💻 https://t.me/Haythereum
 🌏 https://Haythereum.com
 ✖️ https://x.com/Haythereum
  LAUNCHING SUNDAY 7PM UTC
*/
...
contract Hayeth is IERC20, Auth {
    string private constant _symbol  = "HAYETH";
    string private constant _name    = "Haythereum";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 999999999 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0x5139ECf0aF9a204F8935b4ab007A4E54C1b040D6);
    ...
    uint256 private _swapMax = _totalSupply * 85 / 100000;
    uint256 private _swapTrigger = 20 * (10**15);
    uint256 private _swapLimits = _swapMin * 69 * 100;
