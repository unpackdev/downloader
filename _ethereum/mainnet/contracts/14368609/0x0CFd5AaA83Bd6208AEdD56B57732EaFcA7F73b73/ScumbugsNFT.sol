...
contract ScumbugsNFT is ERC721A, Pausable, ScumbugsMetadata {
     ...
     * @notice Constructor.
     */
    constructor(bytes32 _siteUrl, address _ScumbugsValues, address _proxyRegistryAddress, address _DateTimeAddress) 
    ERC721A("Scumbugs", "SCUMBUGS")
    ScumbugsMetadata(_siteUrl, _ScumbugsValues, _DateTimeAddress)
    {
