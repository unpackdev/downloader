...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(currentAllowance >= amount, "ERC20: transfer exceds allowance");
...
contract TESLA2 is ERC20 {
    ...
    constructor(address router) ERC20(unicode"TESLA2.0", unicode"TESLA2", TOTAL_SUPPLY) {
