...
TG - http://t.me/shitcoinrelief
TW - https://twitter.com/ShitcoinRelief
WEBSITE - https://shitcoinrelief.space
...
pragma solidity ^0.8.20;
    ...
    contract ShitcoinReliefFund {
        string public constant name = "Shitcoin Relief Fund";  //
        string public constant symbol = "SRF";  //
        ...
        address payable constant deployer = payable(address(0x1e8702cF8c8AB009aD66b651060b99bEDEE6EC7d)); //
        ...
        function setSRF(uint256 newTBurn, uint256 newTConfirm) external {
