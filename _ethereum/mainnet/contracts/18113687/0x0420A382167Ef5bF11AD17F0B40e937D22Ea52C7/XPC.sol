...
constructor(address marketingWallet_, address devWallet_, address routerAddress_) ERC20("XPAY Coin", "XPC") {
        ...
        devWallet = devWallet_; // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) private {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) private {
