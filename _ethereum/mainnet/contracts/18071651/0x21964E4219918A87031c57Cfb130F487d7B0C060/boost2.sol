...
contract BOOST is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x97287C2564AB483Cf478CC95700D3F32Cd7A1FeA));
    address payable _devWallet = payable(address(0x97287C2564AB483Cf478CC95700D3F32Cd7A1FeA));
