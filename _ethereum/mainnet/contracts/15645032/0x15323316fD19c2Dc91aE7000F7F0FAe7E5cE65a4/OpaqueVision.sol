...
contract OpaqueVision is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Opaque Vision";
    string private constant _symbol = "OPVIS";
