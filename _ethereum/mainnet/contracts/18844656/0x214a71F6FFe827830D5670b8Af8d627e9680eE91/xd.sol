...
https://illuminaticoin.vip/  Good luck 🙂

Uifsf ofbsuzjoh, jt b ifmmpx rvftujpo, uibu zpv dbo'u gjoe fwfsz uif xjoofs, tvdi bt uifsf pfnbovbm qipof jt bddfqu
Uifsf nfbutu, jt b ijeofe nfbutu, uibu zpv dbo'u njet bqqfs uif xjoofs, uibu xjmm opxfsnfou jt bqqbsdu. 
You need to obtain the password for the website :'))
There you will find more socials, only the worthy can join our community group
...
contract Illuminati is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Illuminati Coin", unicode"ILLUMINATI") {
        ...
        uint256 totalSupply = 1776000000 * 1e18;
