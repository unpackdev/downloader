...
contract HDTTokenWrapper {
    ...
    //MACH
    IERC20 public stakeToken = IERC20(0xB119Ce94D098C18fe380904c24e358bd887F00BE); 
 ...
 * HDT-MACH Pool
 */
contract HDTMACHPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-MACH-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-MACH-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-MACH-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-MACH-POOL: Pool is closed");
        _;
    }
