...
contract MORTELToken is IERC20, Ownable {
    ...
    constructor(
        ...
        _maxTxAmount = (_tTotal * 2) / 100; //Anti-whale
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        bool takeFee = false; 
        // take fee if transaction is buying or selling tx
        if (from == uniswapV2Pair) 
            takeFee = true;
        else if (to == uniswapV2Pair) 
            takeFee = true; 

        // final check, don't take fee if wallets are excluted 
