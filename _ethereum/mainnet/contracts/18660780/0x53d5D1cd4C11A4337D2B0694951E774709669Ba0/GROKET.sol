...
https://t.me/groketentry

https://www.Twitter.com/groketcoin
...
contract GROKET is ERC20, Ownable {
    ...
    constructor() ERC20("GROK ROCKET", "GROKET") {
    ...
    function openPairETH() external onlyOwner {
        tradingLive = true;
        swapEnabled = true;
