...
Telegram: https://t.me/allinbetsv2

X Twitter: https://twitter.com/allinbetsV2
*/
...
library Address{
 ...
 contract AllInBets is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 0 * 10**9;
    uint256 public maxSellLimit = 0 * 10**9;
    uint256 public maxWalletLimit = 0 * 10**9;
    ...
    string private constant _name = "AllInBets";
