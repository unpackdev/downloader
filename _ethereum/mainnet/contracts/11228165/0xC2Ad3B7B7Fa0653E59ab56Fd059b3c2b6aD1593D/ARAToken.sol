...
contract ARAToken is PausableToken {
    string  public  constant name = "Arithmetic aggregation one";
    string  public  constant symbol = "ARA-1";
    ...
    function ARAToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
