...
* DO NOT RAGE QUIT!
* 
* 2% tax fee per transaction, which is redistributed to token holders
* 5% liquidity provider fee, which is rewarded to liquitidy providers
* 2% liquidity provider fee, which get pooled in the ETH/RQUIT pair on uniswapV2Router
* 
* Use slippage of at least 10%
* 
* 
* Join our Telegram:
* 
* https://t.me/rageQUITprotocol
* 
* And check our Medium:
* 
* https://rquitprotocol.medium.com/welcome-to-ragequit-56d7da24629d
* 
*/
...
contract rageQUIT is Context, IERC20, Ownable {
    ...
    string private _name = "rageQUIT";
    string private _symbol = "RQUIT";
