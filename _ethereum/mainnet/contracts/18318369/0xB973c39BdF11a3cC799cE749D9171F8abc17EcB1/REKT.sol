...
contract REKT is ERC20, Ownable {
    ...
    constructor() ERC20("REKT", "REKT") {
        ...
        swapTokensAtAmount = totalSupply * 50 / 1000; // 5%
        ...
        marketingWallet = address(0x8d95ce1E367a795E842F987d689F22837ef25B96);
        devWallet = address(0x83385F1DFA5cd2c6d0a290D98555571845AC8bCb);
