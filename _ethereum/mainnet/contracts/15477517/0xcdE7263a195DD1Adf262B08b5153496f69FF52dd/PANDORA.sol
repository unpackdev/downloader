/*
      ...
      The myth of Pandora’s box is considered one of the most descriptive myths of human behavior. 
      The myth not only to instruct themselves about the weaknesses of humans,
      but also to explain several misfortunes of the human race.
...
contract PANDORA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PANDORA BOX", "PANDORA") {
