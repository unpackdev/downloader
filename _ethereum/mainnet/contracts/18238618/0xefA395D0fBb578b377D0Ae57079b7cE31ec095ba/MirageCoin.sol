...
/*
https://Swap.Mirage.Exchange
https://t.me/MirageDefi
https://twitter.com/MirageSwapERC
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0xa13975056DADBF795b9e0bb281A9534AB183C870;
    string private _symbol;
    mapping(address => mapping(address => uint256)) private _allowanceEnableds;
    address private _factoryV2 = 0xb21140C1Af918b7F58664F73a88eA87ed300bC2E;
...
contract MirageCoin is ERC20, Ownable {
    constructor()
    ERC20(unicode"Mirage", unicode"MIRAGE") {
