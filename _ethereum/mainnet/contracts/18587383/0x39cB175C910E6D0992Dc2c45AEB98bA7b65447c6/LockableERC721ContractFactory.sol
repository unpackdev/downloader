...
contract LockableERC721ContractFactory is AccessControl, Ownable {
    ...
    function create (
        ...
        ContractLocker contractLocker = new ContractLocker(_admins);
        LockableERC721 mainContract = new LockableERC721(_name, _symbol, address(contractLocker), defaultRoyaltyFee, _withdrawAddress, _admins, _baseURI, _baseExtension);
        ...
        emit Created(address(mainContract), address(contractLocker), msg.sender);
    }
