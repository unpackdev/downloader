...
contract BETDefi is StandardToken {
    string public constant name = "TheBETDefi";
    string public constant symbol = "BETF";
    uint256 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 7900 * (10**decimals);
