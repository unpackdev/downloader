...
In ancient Japan, it was also called "Akizu Country". Akizu is the ancient name for the dragonfly,
which is a symbol of courage, strength and happiness in Japan.

💪GO FORWARD AND NEVER BACK DOWN

👉TG:t.me/AkizuInu_ETH

Initial tax 7 Final tax rate 0
*/
...
contract AkizuInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Akizu Inu";
    string private constant _symbol = unicode"AKIZU";
