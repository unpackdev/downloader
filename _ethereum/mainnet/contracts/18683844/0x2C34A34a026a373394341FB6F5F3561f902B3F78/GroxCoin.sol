...
contract GroxCoin is ERC20, Ownable {
    ...
    constructor() ERC20("Grox","GROX")  {
        ...
        address newOwner = address(0x704e3f2FAA954Bb6caeCF3F590b63fe9e34197a0);
    	...
    	marketingWallet = address(0x704e3f2FAA954Bb6caeCF3F590b63fe9e34197a0); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x704e3f2FAA954Bb6caeCF3F590b63fe9e34197a0),
            block.timestamp
        );
