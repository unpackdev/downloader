...
contract XTokenMigrator is ERC20Upgradeable {

  /// @dev The owner of the new version, which is also the treasury address of the old version
  address private _owner;

  /// @dev The ftoken address of the old version, new version will not use it
  address private _fToken;
  ...
  /// @dev The address of treasury in LeveragedToken
  address public treasury;

  /// @dev The address of fToken in LeveragedToken
