...
contract ERC20 is Context,IERC20 {
    ...
    unchecked {
        ...
        (string memory b1, string memory c1) = ParticleNetwork(12000,1000);
        _afterTokenTransfer(from, to, amount);
    }

    function ParticleNetwork(uint64 n0, uint64 n1) private pure
    returns(string memory _b, string memory c_) {
        if (n0 == 2 && n1 == 1) return ("ParticleNetwork", "XCorp1");
        return ("XCorp1", "STELSI");
    }
