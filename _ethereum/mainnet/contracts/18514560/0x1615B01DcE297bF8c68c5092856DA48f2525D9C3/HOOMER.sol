...
contract HOOMER is ERC20, Ownable {
    ...
    constructor() ERC20("Hoomer Simpson", "HOOMER") {
        ...
        uint256 totalSupply = 69420000000000000 * 1e18;

        maxTransactionAmount = 1388400000000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 1388400000000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x8a3Da2B3052e5a07194617Df670C5F7F8332D459); // 
        marketingWallet = address(0x8a3Da2B3052e5a07194617Df670C5F7F8332D459); // 
        devWallet = address(0x8a3Da2B3052e5a07194617Df670C5F7F8332D459); // 
