...
/*
 ...
 Telegram : https://t.me/mysterylaunch2official

 Twitter  : https://twitter.com/CryptoMaster_M
...
contract PepeWojaxMiladySafereumShibaDogenWallStreetMemeKing is ERC20, Ownable {
    ...
    string constant INITIAL_NAME =
        unicode"PepeWojaxMiladySafereumShibaDogeWallStreetMemeKing";
    string constant INITIAL_SYMBOL = unicode"MKING";
    ...
    constructor() ERC20(INITIAL_NAME, INITIAL_SYMBOL) {
        ...
        maxTransactionAmount =
            (MAX_TOTAL_SUPPLY * 250) /
            PERCENTAGE_DENOMINATOR; // 2.5%
        maxWallet = (MAX_TOTAL_SUPPLY * 250) / PERCENTAGE_DENOMINATOR; // 2.5%
        swapTokensAtAmount = (MAX_TOTAL_SUPPLY * 100) / PERCENTAGE_DENOMINATOR; // 1%

        communityWallet = address(0x85e1cb78a833d5E54679D66e78Ec7D6C11F849A3);
        marketingWallet = address(0x4C9a3e3E1F458d5E9A98425175C80ca3765eFc1E);
        fundedAccountWallet = address(
            0xe2A7Db4d24aD9B8Ce3A00f820bd03A59Be79d64D
        );
    ...
    function setLimitsAndFees(
        ...
        _setLimitsAndFees(_communityFee, _marketingFee, _fundedAccountFee);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForFundedAccounts +=
                    (fees * sellFundedAccountsFee) /
                    sellTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForCommunity = (ethBalance * tokensForCommunity) /
            (totalTokensToSwap -
                (tokensForFundedAccounts - tokensForMarketing));

        uint256 ethForFundedAccounts = (ethBalance * tokensForCommunity) /
            (totalTokensToSwap - (tokensForCommunity - tokensForMarketing));

        uint256 ethForMarketing = ethBalance -
            ethForCommunity -
            ethForFundedAccounts;
