...
contract HUNT is ERC20, Ownable {
    ...
    uint256 public maxTxLimit = _tTotal.mul(150).div(10000);         // 0.75% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(250).div(10000);    // 1.50% of total supply
    ...
    constructor(address _dev) public ERC20("THE HUNT", "HUNT") {
