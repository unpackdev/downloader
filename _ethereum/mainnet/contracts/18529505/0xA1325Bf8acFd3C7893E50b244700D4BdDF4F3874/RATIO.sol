...
$RATIO is a social token that is powered by the creativity of our community.

If you reed this - we are live !
We are posting CA on Twitter NOW
*/
...
contract RATIO is Context, IERC20, Ownable {
    ...
    string private constant _name = "ethratio";
    ...
    uint256 private _taxFeeOnBuy = 53;  
    ...
    address payable private _developmentAddress = payable(0x07c7d12eE9B2bF06A0C2918e8E77a4B9072D528d); 
    address payable private _marketingAddress = payable(0x07c7d12eE9B2bF06A0C2918e8E77a4B9072D528d);
