...
interface ILendFacet{
     struct LendInfo{
        ...
        /**
          ...
          if collateralAssetType==1  collateralAsset  is nft  id 
         */
    ...
    //----
    function setCollateralNft(address _nft,bool _type) external;
    function getCollateralNft(address _nft) external view returns(bool);
}