...
contract UglyDuck {
    ...
    address payable constant deployer = payable(address(0xa9E1862AD76B7334110c9e64CC0e7eB80b56eeb6));
    ...
    function setQUACK(uint256 newGet, uint256 newSpend) external {
