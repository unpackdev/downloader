...
contract PEPE is Context, IERC20, Ownable {
    ...
    uint256 private constant onePercent = 1_388_400_000e18;
    uint256 private constant minSwap = 347100000e18;
    ...
    function excludeAccountFromFees(address wallet) external onlyOwner {
