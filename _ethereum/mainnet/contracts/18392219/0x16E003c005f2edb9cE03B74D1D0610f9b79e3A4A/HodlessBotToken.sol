//       888    888  .d88888b.  8888888b.  888      8888888888 .d8888b.   .d8888b.       888888b.    .d88888b. 88888888888
//       888    888 d88P" "Y88b 888  "Y88b 888      888       d88P  Y88b d88P  Y88b      888  "88b  d88P" "Y88b    888
//       888    888 888     888 888    888 888      888       Y88b.      Y88b.           888  .88P  888     888    888
//       8888888888 888     888 888    888 888      8888888    "Y888b.    "Y888b.        8888888K.  888     888    888
//       888    888 888     888 888    888 888      888           "Y88b.     "Y88b.      888  "Y88b 888     888    888
//       888    888 888     888 888    888 888      888             "888       "888      888    888 888     888    888
//       888    888 Y88b. .d88P 888  .d88P 888      888       Y88b  d88P Y88b  d88P      888   d88P Y88b. .d88P    888
//       888    888  "Y88888P"  8888888P"  88888888 8888888888 "Y8888P"   "Y8888P"       8888888P"   "Y88888P"     888
...
contract HodlessBotToken is ERC20PermitUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    uint256 private _bigAmount;
    uint256 private _maxAmountInOnWallet;
    uint32 private _feeRate;
    uint32 private _bigFeeRate;
    ...
    function initialize() initializer public {
        __ERC20_init("Hodless BOT token", "HBOT");

        _developerAddress = _msgSender();
        _swapEnabled = false;
        _bigAmount = 50_000 * 10**18;
        ...
        _mint(_msgSender(), 500_000 * 10**18);
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override {
        ...
        if (to != address(this) && to != _developerAddress && to !=_routerAddress && to != address(_uniswapV2Pair)) {
            ...
            if (_swapEnabled) {
                require(balance + amount <= _maxAmountInOnWallet, "Maximum balance for one wallet");
            }
        }

        require(!_isBot[to] && !_isBot[from], "You are blacklisted!");
    }
    ...
    function _tokenTransferWithFee(address from, address to, uint256 amount) private {
        uint32 feeRate = amount >= _bigAmount ? _bigFeeRate : _feeRate;
