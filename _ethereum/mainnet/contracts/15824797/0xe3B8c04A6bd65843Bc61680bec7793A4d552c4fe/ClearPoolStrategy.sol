...
contract ClearPoolStrategy {
    ...
    function init (IClearPoolBase pool) external onlyOwner {
    ...
    function calc1 (uint256 depositAmount) public view returns (uint256) {
        uint256 x = IClearPoolBase(poolAddress).getCurrentExchangeRate();
        uint256 y = depositAmount * 1e4;
        return x / y;
    }
