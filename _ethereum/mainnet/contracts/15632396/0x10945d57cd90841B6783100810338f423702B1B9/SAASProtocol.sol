...
contract SAASProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("SAASProtocol", "SAAS") {
        ...
        marketingWallet = address(0xCeAa2A2d47AbCB241F3A5052314387575BA8cA37); // set as marketing wallet
        devWallet = address(0xCeAa2A2d47AbCB241F3A5052314387575BA8cA37); // set as dev wallet
