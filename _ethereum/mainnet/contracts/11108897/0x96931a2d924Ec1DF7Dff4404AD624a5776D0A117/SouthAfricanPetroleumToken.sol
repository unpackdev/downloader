 ...
 *Initial total: 2625
 *Consumption in a single transaction: 20%
 */
...
contract SouthAfricanPetroleumToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "South African Petroleum Token";
string constant tokenSymbol = "SAPT";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 2625000000000000000000;
