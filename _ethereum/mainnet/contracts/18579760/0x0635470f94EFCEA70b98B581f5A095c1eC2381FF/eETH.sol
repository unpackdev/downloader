/**
  ...
  eETH minting in session🔥🚀
  
  Follow us:

  Twitter:  https://twitter.com/ether_fi
  Website:  https://www.ether.fi/
  Discord:  https://discord.com/invite/xfFtMA35rm
...
contract eETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ether.fi";
    string private constant _symbol = unicode"eETH";
    uint256 public _maxTx = 150000000 * 10**_decimals;
