...
contract PEACE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"IsraelHamasUkraineRussiaMLG360NoScope69Inu";
    ...
    uint256 public feeOnBuying = 2;
    uint256 public feeOnSelling = 2;
    uint256 public maxTxnLimit = (_tTotal * 3) / (100);
    uint256 public maxHoldLimit = (_tTotal * 3) / (100);
    ...
    address public marketingAddress = 0xf3e635178Fa807f1B21A1AD789388AB9b8bE4cc8;
    ...
    function setWebsite(string memory _web) external onlyOwner{
        website = _web;
    }
    ...
    function setTelegram(string memory _tg) external onlyOwner{
        telegram = _tg;
    }
