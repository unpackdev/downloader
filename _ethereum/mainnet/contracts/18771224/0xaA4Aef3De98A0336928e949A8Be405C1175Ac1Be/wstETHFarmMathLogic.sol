...
abstract contract wstETHFarmMathLogic is wstETHFarmDeclarations {
    ...
    function _checkDebtRatio(
        ...
        returns (bool res)
    {
        res = getTotalWeightedCollateralETH(_nftId)
        ...
        returns (bool)
    {
        ...
        uint256 withdrawValue = ORACLE_HUB.getTokensInETH(
            WST_ETH_ADDRESS,
            _amount
        )
            * collateralFactor
     ...
     * amount is above 3 ETH in value.
     */
    function _aboveMinDepositAmount(
        ...
        returns (bool)
    {
        uint256 equivETH = ORACLE_HUB.getTokensInETH(
            WETH_ADDRESS,
            _amount
        );
