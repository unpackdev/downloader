...
contract IllPokeYourNFT is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmYj7pWZjf5Fv2cAJBiguSzKYd81XBmn4PsnVdavgR6RWb/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.005 ether;
  uint256 public maxSupply = 5000;
  uint256 public maxMintAmountPerTx = 20;
  uint256 public freeUntil = 500;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = false;

  constructor() ERC721A("IllPokeYourNFT", "IPYN") {
  }
