/**
https://t.me/MouseXERC
https://mouse-x.com/
https://twitter.com/MouseXcoin

ABOUT MOUSEX
SPACEX fans are convinced an unexpected guest hitched a ride on SpaceX 
and NASA's launch of the Crew Dragon, with many claiming a mouse could be seen live on camera.

Millions of people tuned in to watch the SpaceX and NASA 
launch of SpaceX's Falcon 9. But a viral video clip shared 
online appears to show an unexpected stowaway on SpaceX's
 rocket, with many claiming a mouse was seen during the historic launch.
*/
...
contract MOUSEX is ERC20, Ownable {
    ...
    constructor() ERC20("Mouse X", "MOUSEX") {
		...
		charityWallet = address(0x32D88fcC23485C0CdD25552FAAc99D422aF38eED); // set as charity wallet
        marketingWallet = address(0xce8dE58dfA052a004a6a1a75f44f2140de348E9b); // set as marketing wallet
        devWallet = address(0x32D88fcC23485C0CdD25552FAAc99D422aF38eED); // set as dev wallet
