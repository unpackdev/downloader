...
contract baboon is ERC20, Ownable {
 using SafeMath for uint256;
 ...
 constructor() ERC20("Baboon Tools", "BABOON") {
 
 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0x2849B809d110cf507db3B8194E9f7121fB6E9972);
 marketingWallet = address(0x2849B809d110cf507db3B8194E9f7121fB6E9972);
...
//Limits
 ...
 function updateMaxBaboonAmount(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
 ...
 function updateMaxWalletBaboonAmount(uint256 newPercentage) external onlyOwner {
 ...
 function updateTerminalFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
