...
contract Flow is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 785;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Flow";
    string private constant _symbol = "Flow";
    string private _baseURI = "Qme9m4uvrtdVPwdhGweAkGQVztQ49Z72ZpoCTwgJWGcNrA";
