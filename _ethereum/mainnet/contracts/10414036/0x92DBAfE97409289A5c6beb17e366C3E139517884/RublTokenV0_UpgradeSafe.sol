 ...
 */
contract RublTokenV0_UpgradeSafe is Initializable, ContextUpgradeSafe, AccessControlUpgradeSafe, ERC20BurnableUpgradeSafe, ERC20PausableUpgradeSafe {
    ...
    function initialize(string memory name, string memory symbol) public {
        __RublTokenV0__init(name, symbol);
    }

    function __RublTokenV0__init(string memory name, string memory symbol) internal initializer {
        __Context_init_unchained();
        __AccessControl_init_unchained();
        __ERC20_init_unchained(name, symbol);
        __ERC20Burnable_init_unchained();
        __Pausable_init_unchained();
        __ERC20Pausable_init_unchained();
        __RublTokenV0__init_unchained();
    }

    function __RublTokenV0__init_unchained() internal initializer {
    ...
    function mint(address to, uint256 amount) public {
        require(hasRole(MINTER_ROLE, _msgSender()), "RublTokenV0: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "RublTokenV0: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "RublTokenV0: must have pauser role to unpause");
        _unpause();
    }
