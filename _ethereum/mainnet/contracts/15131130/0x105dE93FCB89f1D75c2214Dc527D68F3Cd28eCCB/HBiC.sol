...
Welcome to Hunter Bidens iCloud. 

Here you will discover the truth and corruption within Hunter Bidens life as well 
the Biden family in general. We will be helping as many victims as possible along 
the way. While the media is quick to silence the truth of this matter. 

We say…

FUCK THAT! LET THE TRUTH BE TOLD!
...
contract HBiC is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "Hunter Biden iCloud";
    string private constant _symbol = "HBiC";
    ...
    uint8 private _marTax = 3; // tax for marketing
    ...
    constructor() {
        ...
        charityAddress = payable(0xE8F43dF719f671Ad7cA155e05C41A9512F937882);
        marketingAddress = payable(0xE415bE8a0eeF3dB39034fdc9434b12a71208364f);
