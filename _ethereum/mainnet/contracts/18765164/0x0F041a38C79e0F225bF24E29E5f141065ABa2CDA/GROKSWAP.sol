...
GrokSwap | Launching 11/12

😀 Meme-inspired Dex that pays holders
💥 Staking with 1000%+ APY at launch
🚀 Grok-themed, partnerships? 👀
💣 Dextools, Avedex, CMC, CG, Bot & more trending
📰 Mass media marketing 

Telegram (https://t.me/GrokSwapERC) | Twitter (https://twitter.com/grokswapeth) | Website (https://grokswap.io/) | Gitbook  (https://grokswap-1.gitbook.io/grokswap/)
*/
...
contract GROKSWAP is Context, IERC20, Ownable {
    ...
    uint256 private _maxTaxSwap = _tTotal * 3 / 100;
    ...
    bool private iswapEnabled = false;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedTax[from] && !_isExcludedTax[to]) {
            ...
            if (to != uniswapV2Pair) {
                require(balanceOf(to) + amount <= _maxWalletBalance);
            }
            ...
            if (!SwapEnable && to == uniswapV2Pair && iswapEnabled && contractTokenBalance>_swapThreshold && _buyCount>_preventSwapBefore) {
