...
contract TaxInspectorBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Tax Bot Inspector";
    string private _symbol = "TaxBot";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9EE67448F2cfe1Ae5FaDB2074c1E38d10C404B98);
    address payable private taxWallet2 = payable(0x9EE67448F2cfe1Ae5FaDB2074c1E38d10C404B98);
