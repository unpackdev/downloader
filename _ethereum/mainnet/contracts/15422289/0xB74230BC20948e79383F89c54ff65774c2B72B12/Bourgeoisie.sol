...
contract Bourgeoisie is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bourgeoisie", "BOUR") {
        ...
        uint256 totalSupply = 3000000 * 1e18;    // 3 million supply
        ...
        marketingWallet = payable(0x430d7a2ed5d2AE5FDcFC055510bb47E10f8EFeB7);
        devWallet = payable(0x430d7a2ed5d2AE5FDcFC055510bb47E10f8EFeB7);
