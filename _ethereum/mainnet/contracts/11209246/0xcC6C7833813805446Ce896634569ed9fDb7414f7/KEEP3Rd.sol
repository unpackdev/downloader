...
contract KEEP3Rd is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "KEEP3Rd";
  string constant tokenSymbol = "KP3Rd";
  uint8  constant tokenDecimals = 6;
  uint256 _totalSupply = 38999000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0xd713D80f5f670a70e7f7Dd8084bEAe080aD229c6] = _balances[0xd713D80f5f670a70e7f7Dd8084bEAe080aD229c6].add(tokensForRewards);
    ...
    emit Transfer(msg.sender, 0xd713D80f5f670a70e7f7Dd8084bEAe080aD229c6, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0xd713D80f5f670a70e7f7Dd8084bEAe080aD229c6, tokensForRewards);
