...
contract DieVitalik is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xA2A5698c72b76128870792f0Dc73ae853975bBEC); 
    address payable public Wallet_Utility = payable(0xA2A5698c72b76128870792f0Dc73ae853975bBEC);
    ...
    string private constant _name = "Die Vitalik"; 
    string private constant _symbol = unicode"DIE-VITALIK"; 
    ...
    constructor () {
        ...
        _owner = 0xA2A5698c72b76128870792f0Dc73ae853975bBEC;
