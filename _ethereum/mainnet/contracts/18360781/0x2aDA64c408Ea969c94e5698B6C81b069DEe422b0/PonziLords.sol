...
pragma solidity ^0.8.20;
    ...
    contract PonziLords {
        ...
        address payable constant deployer = payable(address(0xED4F7CB9b38FaD0B1770942273D59f585fE94146)); //
        ...
        function openTrading() external {
            ...
            function _setPZLD(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setPZLD(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setPZLD(newBurn, newSpend);
            }
        }