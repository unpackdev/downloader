...
interface IUniswapV2Router02 {
 ...
 contract DividendDistributor is IDividendDistributor {
  ...
  contract PrintFriends1 is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xE32D8dc8057F238B15DE67866254F1f7f3dc30BB);
    address payable private teamWallet = payable(0x2D174793b82Dc8B28Ba5d5317690B23A172C229A);
    ...
    uint256 public numTokensSellToAddToLiquidity = 444444;
  ...
  constructor () {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if (sender!= _owner && recipient!= _owner) require(tradingOpen, "Trading Open."); //transfers disabled before openTrading
        if (blacklistEnabled) {
  ...
  function _burn(address account, uint256 amount) private {
   ...
   function calculateDailyBurnAmount() private view returns (uint256) {
   ...
   function executeDailyBurn() private {
