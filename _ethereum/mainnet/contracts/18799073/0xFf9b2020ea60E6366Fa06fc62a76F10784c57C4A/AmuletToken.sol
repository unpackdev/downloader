...
contract AmuletToken is ERC20PresetMinterPauserUpgradeable {
    ...
    function _beforeTokenTransfer(
        ...
        require(_validSender(_from), "AmuletToken: invalid sender");
        require(_validReceipt(_to), "AmuletToken: invalid receipt");
    ...
    function getPriorVotes(address _account, uint256 _blockNumber) public view returns (uint256) {
        require(_blockNumber < block.number, "AMULET::GPV:1");
