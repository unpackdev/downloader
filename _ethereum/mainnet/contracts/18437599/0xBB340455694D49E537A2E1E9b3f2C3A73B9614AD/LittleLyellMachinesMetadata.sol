...
contract LittleLyellMachinesMetadata is MetadataP5JS {
  constructor(address _libraryStorage, address _scriptStorage, address _nftAddress, string memory _name, string memory _description, string memory _tokenImageURI) MetadataP5JS(_libraryStorage, _scriptStorage, _nftAddress, _name, _description, _tokenImageURI) {}
