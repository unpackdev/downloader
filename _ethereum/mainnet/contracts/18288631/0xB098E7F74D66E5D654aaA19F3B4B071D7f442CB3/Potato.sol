/**
  ...
  TG : https://t.me/ThePotatoCoin

  Twitter : https://twitter.com/ThePotatoCoin

  Website : https://www.thepotato.space

  Contact : info@thepotato.space
...
contract Potato is Context, IERC20Metadata, Ownable {
    ...
    uint256 public constant hardCap =  1130000000000 * 10 ** 18; //113 billion
    uint256 public constant mintHardCap = 100000000000 * 10 ** 18; //100 billion
    uint256 public constant lockedSupply = hardCap - mintHardCap;
