...
contract BDPSSTAKING is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xc87D774620f74aD202d55F280C082b7Ce9781D4E);
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 20699615, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 20699615){
            return 0;
        }
    ...
    function updateExitPenalty(uint256 newPenaltyPerc) external onlyOwner {
        require(newPenaltyPerc <= 10, "May not set higher than 20%");
