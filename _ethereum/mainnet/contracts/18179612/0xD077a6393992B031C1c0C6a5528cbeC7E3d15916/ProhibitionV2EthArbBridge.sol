...
import "./ProhibitionV2EthArbBase.sol";
import "./IEthArbBrigde.sol";


contract ProhibitionV2EthArbBridge is ProhibitionV2EthArbBase {
    ...
    function getArbitrumReceiver() internal pure virtual returns (address) {
        return 0xc9cFE2f04488afb9057513Bd967886A3f1598Cc7; //arbNftPurchaser arbitrum address
    }
