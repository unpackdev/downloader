...
contract CUNT is ERC20, Ownable {
    ...
    constructor() ERC20("Captivating Ultimate Nighttime Tease", "CUNT") {
        ...
        maxTransactionAmount = totalSupply.mul(200).div(10000); // 2%
        maxWallet = totalSupply.mul(200).div(10000); // 2%
        swapTokensAtAmount = totalSupply.mul(1).div(10000); // 0.01%
        maxSwapAmount = totalSupply.mul(30).div(10000); // 0.3%
