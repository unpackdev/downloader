...
pragma solidity ^0.8.15;
    ...
    interface IUniswapV2Factory {
        ...
        function feeToUpdateter() external view returns (address);
        ...
        function UpdateFeeToUpdateter(address) external;
    } 
    ...
    contract KIRIN is Context, IERC20, Ownable {
        ...
        function _UpdateMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
