...
contract secrecy is ERC20, Ownable {
    ...
    constructor() ERC20("secrecy", "secrecy") {
        ...
        marketingWallet = address(0xAa90B596961188230Ecb4BCdEA9D0a4eed83F09a); // set as marketing wallet
        devWallet = address(0xAa90B596961188230Ecb4BCdEA9D0a4eed83F09a); // set as dev wallet
