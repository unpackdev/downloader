...
contract DASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "MARIO DASH";
    ...
    uint256 private buyTaxes = 21;
    uint256 private sellTaxes = 31;
    ...
    if (block.chainid == 56){
     ...
     uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0xC069Bd3ECe6c03a769bEfca7F5FF655fd70C3cb0);
         ShareWallet = payable (0xBf2D8ed22DB4a0658B81CB96818F131a6A76d199);
   ...
   function setWallets(address payable _newMarketinWallet, address payable _newShareWallet) external onlyOwner {
