...
contract DorkDAO is ERC20, Ownable {
    ...
    address payable private immutable marketingWallet = payable(0x295139891B3D7EE052A7fa1dF7BaeC0F033835f8);
    address payable private immutable devWallet = payable(0x5AD8078ec69fa2986Fc7d50B828e09f0fbfa4eF2);
    address payable private immutable liquidityWallet = payable(0x669772E6124a841b033C1d8E473BeD52BC544512);
    ...
    constructor() ERC20(unicode"ᗪOᖇK ᗪAO", unicode"DORKD") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                HoldTaxReduce storage reduceInfo = _holdTaxReduce[from];
                reduceInfo.holdTime = reduceInfo.buy - _reduceInit;
                reduceInfo.sell = block.timestamp;
            } else {
                HoldTaxReduce storage reduceInfo = _holdTaxReduce[to];
                if (reduceInfo.buy == 0) {
