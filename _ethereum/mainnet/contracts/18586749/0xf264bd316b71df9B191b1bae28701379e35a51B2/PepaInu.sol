...
/**
 * @title Pepa Inu (https://www.pepa-inu.com/)
 */
contract PepaInu is ERC20Permit, ERC20UniswapV2InternalSwaps, Ownable {
    ...
    uint256 private constant _MAX_SUPPLY = 420_000_000_000_000_000 ether;
    ...
    constructor(
        ...
        address _taxManager,
        address _router
    ) ERC20("Pepa Inu", "PEPA") ERC20Permit("Pepa Inu") ERC20UniswapV2InternalSwaps(_router) {
