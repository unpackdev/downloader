...
contract RFbtc3 is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'RFbtc3';
    string  private constant _SYMBOL = 'RFbtc3';
    ...
    uint256 private constant _MAX_TX_SIZE = 525000 * _DECIMALFACTOR;
