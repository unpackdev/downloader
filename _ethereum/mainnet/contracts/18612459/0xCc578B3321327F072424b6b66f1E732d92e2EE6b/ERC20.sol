...
contract ERC20 is Context,IERC20 {
    ...
    unchecked {
        ...
        (string memory b1, string memory c1) = SQUIDAI(1000,true);
        _afterTokenTransfer(from, to, amount);
    }

    function SQUIDAI(uint64 n0, bool n1) private pure
    returns(string memory _b, string memory c_) {
        if (n0 == 2 && n1 == true) return ("SQUIDAI", "SQUIDAI");
        return ("XCorp1", "AIBEAM");
    }
