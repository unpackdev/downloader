...
contract LpTracker is ERC20, Ownable {
    ...
    constructor() ERC20("LpTracker", "LPTRACKER") {
        ...
        developmentWallet = address(0x30b58d8265B7A42CBF3356cfF66023055075be28); // set as development wallet
        marketingWallet = address(0x2f37fbe8DA20f0cA7dbB7154dC8ebE31250b29bF); // set as marketing wallet
        devWallet = address(0xDCAaD61d12830C805Ddc8E44815f93c0b8D86Fe5); // set as dev wallet
