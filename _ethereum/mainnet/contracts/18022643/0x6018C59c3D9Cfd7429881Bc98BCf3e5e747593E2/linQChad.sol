...
contract linQChad is ERC20, Ownable {
    ...
    address public teamWallet = 0xE3F271B562295166C344DE186Ec9f4Bbced3384f;
    ...
    uint256 public bAutobuyFee = 2;
    uint256 public bLpFee = 0;
    uint256 public bTeamFee = 18;
    uint256 public buyTotalFees = bLpFee + bTeamFee + bAutobuyFee;

    uint256 public sAutobuyFee = 3;
    uint256 public sLpFee = 0;
    uint256 public sTeamFee = 32;
    ...
    function initContract() external onlyOwner {
        ...
        _excludeFromMaxTx(teamWallet, true);
    ...
    function withdrawStuckEth(address newAdd) external {
