...
contract SwipeNetwork is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "Swipe Network"; // solium-disable-line uppercase
  string public constant symbol = "SNK"; // solium-disable-line uppercase
