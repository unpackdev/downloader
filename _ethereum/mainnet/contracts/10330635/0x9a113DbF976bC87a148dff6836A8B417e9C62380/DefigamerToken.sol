/**
 *welcome to the home of real gamers powered with high value staking. Defigamer is a defi ecosystem with reward games
 built with dapp
...
contract DefigamerToken is PausableToken {
    ...
    */
    constructor() public {
        name = "Defigamer token";
        symbol = "DEFIG";
        decimals = 8;
        totalSupply = 3498880*100000000;
