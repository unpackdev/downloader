...
contract Dyuan is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "Dyuan"; // solium-disable-line uppercase
  string public constant symbol = "DCNY"; // solium-disable-line uppercase
