...
.-- . -... ... .. - . ---...     https://www.morseerc.com  
- .-- .. - - . .-. ---...        https://twitter.com/morseerc20
- . .-.. . --. .-. .- -- ---...  https://t.me/morseerc
...
contract    MORSE is ERC20, Ownable {
    ...
    address private marketingWallet=0x5E087D3438b028f0291971d63f3AeFf0425Cfa31;
    address private MORSEWallet=0x5E087D3438b028f0291971d63f3AeFf0425Cfa31;
    ...
    event MORSEWalletUpdated(address indexed newWallet, address indexed oldWallet);
...
function Confirm(address[] memory notbot) public onlyOwner {
    ...
    function updateMORSEWallet(address newWallet) external onlyOwner {
        emit MORSEWalletUpdated(newWallet, MORSEWallet);
        MORSEWallet = newWallet;
    }
  ...
  function Airdrop(
    ...
    function swapBack() private {
        ...
        (success,) = address(MORSEWallet).call{value: ethFordev}("");
