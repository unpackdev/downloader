  ...
  PeripheryPayments
{
  ...
  function uniswapV3FlashCallback(
    ...
    //   WETH9
    // );
    (uint160 _sqrtPriceX96, , , , , , ) = IUniswapV3Pool(_peasV3Pool).slot0();
    uint256 _peasPriceUSDX96 = IUniswapV2Pair(_peasV3Pool).token1() == DAI
      ? V3_UTILS.priceX96FromSqrtPriceX96(_sqrtPriceX96)
      : FixedPoint96.Q96 ** 2 /
        V3_UTILS.priceX96FromSqrtPriceX96(_sqrtPriceX96);
