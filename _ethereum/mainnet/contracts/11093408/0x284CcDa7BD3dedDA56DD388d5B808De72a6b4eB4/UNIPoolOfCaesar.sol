...
contract CaesarTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984); 
...
contract UNIPoolOfCaesar is CaesarTokenWrapper, IRewardDistributionRecipient {
    IERC20 public caesar = IERC20(0xEaFed0F973fe4cDaE26e18Fd1C124F0BDA79Fa6C); 
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1603202702; //2020-10-20 22:05:02
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "Caesar:UNI POOL - Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "Caesar:UNI POOL - Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"Caesar:UNI POOL - not start");
        _;
    }

    modifier checkOpen() {
        require(open, "Caesar:UNI POOL - Pool is closed");
        _;
    }
