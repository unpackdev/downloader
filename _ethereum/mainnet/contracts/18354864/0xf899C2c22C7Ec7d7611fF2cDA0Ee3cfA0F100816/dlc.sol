...
contract dlc is IERC20, Auth {
    string private constant _symbol  = "Degen Lab Credit";
    string private constant _name    = "DLC";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 100_000_000000 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0x074A7eAA34462164D18332DE0717A877D503b3e9);
