/**
In the case of the Gyokuken, if one dies, the other will inherit its power and can be summoned in a far more ferocious form. 
In the case of the Gyokuken Inu Token, if you sell, the holders& chads will more powerful.
*/
/*

https://t.me/GYOKU_ERC
*/
...
contract GyokukenInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Gyokuken Inu";
    string private constant _symbol = "GYOKU";
