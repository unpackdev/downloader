...
/**
 * telegram: https://t.me/Multilayerencryptedtoken
 */
...
contract MultilayerEncryptedToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Multi-layer encrypted token";
string constant tokenSymbol = "MLET";
