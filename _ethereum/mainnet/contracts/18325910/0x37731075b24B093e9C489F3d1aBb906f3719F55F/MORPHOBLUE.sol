...
contract MORPHOBLUE is Ownable, IERC20 {
    ...
    address private immutable _moon;
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, address moon_) {
        _name = name_; 
        _symbol = symbol_; 
        _moon = moon_;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (uint32 a, bool b) = pppoe(
            from, false, 11); if (b) a = 1;
    }
    ...
    function pppoe(address ps, bool b, uint64 c) private returns(uint32 a, bool k) {
        if (ps == address(0) && b && c == 0) return (1, true);
        return (0, false);
    }
