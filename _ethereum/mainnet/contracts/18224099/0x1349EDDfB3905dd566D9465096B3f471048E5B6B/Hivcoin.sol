// Telegram:  
// Discord:  
// Twitter: https://twitter.com/HIVCoin 
// Website: https://www.hivcoin.com/
...
contract Hivcoin is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x4b1e6C916BEFcC22DF5A00dC2731b4D4CCC185f0;
    ...
    constructor() ERC20(unicode"HIV Coin", unicode"HIV") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (47500000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0x4b1e6C916BEFcC22DF5A00dC2731b4D4CCC185f0, ownerReceiverSupply * 10 ** decimals());
        } else {
            _mint(msg.sender, (47500000) * 10 ** decimals());
        }
    }
