...
pragma solidity ^0.8.20;
    ...
    contract VoicesInMyBrain {
        ...
        address payable constant deployer = payable(address(0x9F8727c5B20D23fA4de1Aafa2523fcC6E2D3D6A1)); //
        ...
        function _setVIMB(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
