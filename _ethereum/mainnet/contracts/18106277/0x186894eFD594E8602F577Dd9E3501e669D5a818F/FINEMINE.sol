//FINE MINE {MINE}  |  ERC20  |  
//2% FINE Rewards For All Holders

//t.me/FINEMINE_ERC
//www.finemine.net
//https://twitter.com/FINEMINE_ERC
...
contract FINEMINE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FINE MINE", "MINE") {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 400, "Must keep fees at 30% or less");
    }
