...
contract PepeLinq is ERC20, Ownable {
    ...
    PepeLinqDividendTracker public dividendTracker;
    ...
    constructor(address _developerwallet) ERC20("PepeLinq", "PLINQ") {
        dividendTracker = new PepeLinqDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        PepeLinqDividendTracker newDividendTracker = PepeLinqDividendTracker(
            payable(newAddress)
        );
...
contract PepeLinqDividendTracker is Ownable, DividendPayingToken {
    struct AccountInfo {
        address account;
    ...
    constructor()
        DividendPayingToken("PepeLinq_Dividend_Tracker", "PepeLinq_Dividend_Tracker")
    {}
    ...
    function _transfer(
        ...
        require(false, "PepeLinq_Dividend_Tracker: No transfers allowed");
    }
