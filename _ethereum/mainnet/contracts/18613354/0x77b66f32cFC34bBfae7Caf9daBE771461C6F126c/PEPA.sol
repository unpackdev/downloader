...
contract PEPAINU is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"Your New Fren";
    string private constant _symbol =  unicode"PEPAINU";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 420 * 1e9 * 10**_decimals;
    uint256 public _BuyTax =           0;
    uint256 public _SellTax =          0;
    uint256 public _maxTxAmount =      42 * 1e8 * 10**_decimals;
    uint256 public _maxWalletSize =    42 * 1e8 * 10**_decimals;
