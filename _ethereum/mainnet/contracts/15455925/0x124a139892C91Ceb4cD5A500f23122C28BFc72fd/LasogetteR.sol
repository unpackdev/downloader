...
/**
 *
 * Bonjour, et bienvenue sur le contrat lasogette rNFT. Regarde autour de toi!
 *
 * Hello, and welcome to the lasogette rNFT contract. Have a look around!
 *
 */
...
contract LasogetteR  is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Lasogette rNFT", "LASOGR"){}
