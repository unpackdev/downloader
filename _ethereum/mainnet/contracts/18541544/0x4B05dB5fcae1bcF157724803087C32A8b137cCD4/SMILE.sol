...
If things are not going well, maybe you need a little $SMILE 
https://smiletokeneth.com/
...
contract SMILE is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xb6F21DB79d8664e4b06973634b6E9a4a2398bEFE); 
    address payable private _marketingAddress = payable(0xb6F21DB79d8664e4b06973634b6E9a4a2398bEFE);
    ...
    function openSMILE(bool _tradingOpen) public onlyOwner {
    ...
    function BeHappy() external onlyOwner{
