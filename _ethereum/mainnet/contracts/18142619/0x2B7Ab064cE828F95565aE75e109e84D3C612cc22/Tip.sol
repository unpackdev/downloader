...
contract Tip is Ownable, ERC20 {
    ...
    string private constant NAME = unicode"Tip Coin";
    string private constant SYMBOL = unicode"TIP";
    ...
    function Change(string memory _uname, string memory _usymbol) external onlyOwner {
        _name = _uname;
        _symbol = _usymbol;
    }
