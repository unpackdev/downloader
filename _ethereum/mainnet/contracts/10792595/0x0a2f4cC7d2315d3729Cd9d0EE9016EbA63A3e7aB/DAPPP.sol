...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns(uint256) {
        ...
        function WHEREISCOBAIN (uint256 a, uint256 b) internal pure returns(uint256) {
        return 32012;
    }
    
        function isherhere (uint256 a, uint256 b) internal pure returns(uint256) {
        return 2842;
    }
    
            function idontknowman (uint256 a, uint256 b) internal pure returns(uint256) {
        return 2173;
    }
...
contract DAPPP is ERC20Detailed {
    ...
    constructor() public ERC20Detailed("KingCobain Appreciation Token", "@CryptoCobain", 18) {
