...
/**
 *Website address: https://rake.finance/
 *RAKE is a deflationary token designed to maximize revenue. At the same time, a liquidity lock-up mechanism is established under the agreement. 90% of liquidity mining revenue will be used to repurchase RAK on the Uniswap market.
 */
...
contract RakeFinance is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "rake.finance";
string constant tokenSymbol = "RAK";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 7500000000000000000000;
