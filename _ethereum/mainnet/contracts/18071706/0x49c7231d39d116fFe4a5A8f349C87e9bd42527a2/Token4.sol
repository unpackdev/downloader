...
contract Token4 is Ownable, ERC20 {
    ...
    constructor(address _feeReceiver) ERC20("Token", "TOKEN") {
    ...
    function getMinSwapAmount() internal view returns (uint256) {
    ...
    function setMinSwap(uint256 _minSwapBps) external onlyOwner {
    ...
    function _transfer(
        ...
        uint256 tax = calculateTax(from, to, amount);
