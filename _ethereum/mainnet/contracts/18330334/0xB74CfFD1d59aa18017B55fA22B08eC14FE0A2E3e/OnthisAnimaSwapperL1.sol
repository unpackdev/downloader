...
contract OnthisAnimaSwapperL1 is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    event Paricipant(address paticipant);
    
    address public constant CROSS_CHAIN_PORTAL =
        0x4Dbd4fc535Ac27206064B68FfCf827b0A60BAB3f;
    address public constant L2_ANIMA_SWAPPER =
        0x18461750D7206F1482fb0fCa1AD9141a1F696e33;
    uint64 public constant GAS_LIMIT_FOR_CALL = 700_000;
    ...
    receive() external payable {
        bytes memory openLongData = abi.encodeWithSelector(
            bytes4(keccak256("magicAnimaSwapper(address)")),
            msg.sender
        );
