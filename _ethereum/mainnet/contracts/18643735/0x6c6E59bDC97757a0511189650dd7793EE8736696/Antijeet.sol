...
Welcome to Anti Jeet Token, the token where jeeters get rekt! 
Sell tax varies from 2-18 percent depending in the sales before 
the sell leading to that one. Example, every sell raises the sell 
tax 2% and every buy negates it the same. 33% of all taxes go back 
to holders via token reflections, 33% go towards buybacks via buyback 
wallet, and the remainder goes into a mw.
...
contract Antijeet is IERC20, Ownable {
    ...
    string private constant _symbol = "NOJEET";
