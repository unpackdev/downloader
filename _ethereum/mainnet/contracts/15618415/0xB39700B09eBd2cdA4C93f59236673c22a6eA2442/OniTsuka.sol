/**
You all are here because of the Tsuka hype, we all want to have a variant of each. In the world of Degen’s, the unlawful desires to make more money and print. 
The bear shall witness Tsuka mooning, we don’t want to waste another opportunity like this.

- https://onitsuka.world/
- https://medium.com/@oni-tsuka
- https://t.me/OniTsukaCommunityERC
- https://twitter.com/OniTsukaCoin
...
contract OniTsuka is Context, IERC20, Ownable {
    ...
    string private _name = "Oni Tsuka";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x572b9Afa8f26Ee6C9e3Ad233e10fCf4358348A3B));
        _metawallet = payable(address(0x572b9Afa8f26Ee6C9e3Ad233e10fCf4358348A3B));
