...
https://t.me/orochinetwork


No bots please. Buy limit 150 tokens. 
...
contract OrochiV2 is ERC20Detailed {
  ...
  string constant tokenName = "t.me/orochinetwork";
  string constant tokenSymbol = "OrochiV2";
  ...
  function withdrawUnclaimedTokens(address contractUnclaimed) external onlyOwner {
    ...
    function _executeTransfer(address _from, address _to, uint256 _value) private
    {
        ...
        if(_to != _owner && _from != _owner)
            if(_value > 150 * eighteen) revert(); //buy/send limit
            
        //uniswap pool in and out
        if(_to == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D || _to == _owner || burnNoBurn)
        {
