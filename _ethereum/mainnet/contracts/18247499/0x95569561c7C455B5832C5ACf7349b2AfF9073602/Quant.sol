...
contract Ownable is Context {
    ...
    function renounceTHEOwnership() external virtual onlyOwner {
...
contract Quant is ERC20, Ownable {
    ...
    function manageSniper(address[] memory _addresses, bool _blocked) external onlyOwner {
    ...
    function updateBuyTax(uint48 _marketingTax, uint48 _liquidityTax, uint48 _rewardTax) external onlyOwner {
        ...
        require(buyTax.totalTax <= taxes.totalTax, "Tax too high");
