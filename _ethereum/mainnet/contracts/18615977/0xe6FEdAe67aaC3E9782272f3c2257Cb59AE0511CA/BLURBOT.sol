...
contract BLURBOT is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"BLUR BOT";
    string private constant _symbol =  unicode"BLURBOT";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 100 * 1e6 * 10**_decimals;
    uint256 public _BuyTax =           0;
    uint256 public _SellTax =          0;
    uint256 public _maxTxAmount =      500 * 1e3 * 10**_decimals;
    uint256 public _maxWalletSize =    500 * 1e3 * 10**_decimals;
