...
\$$\  $$  |$$$$$$$$ |$$ |              $$ |  $$  __$$\ $$  _____|$$ |  $$ |$$  __$$\ \____$$\ $$  __$$\ $$  _____|$$  __$$\ 
 \$$\$$  / $$  __$$ |$$ |              $$ |  $$ |  $$ |\$$$$$$\  $$ |  $$ |$$ |  \__|$$$$$$$ |$$ |  $$ |$$ /      $$$$$$$$ |
  \$$$  /  $$ |  $$ |$$ |  $$\         $$ |  $$ |  $$ | \____$$\ $$ |  $$ |$$ |     $$  __$$ |$$ |  $$ |$$ |      $$   ____|
   \$  /   $$ |  $$ |\$$$$$$  |      $$$$$$\ $$ |  $$ |$$$$$$$  |\$$$$$$  |$$ |     \$$$$$$$ |$$ |  $$ |\$$$$$$$\ \$$$$$$$\ 
    \_/    \__|  \__| \______/       \______|\__|  \__|\_______/  \______/ \__|      \_______|\__|  \__| \_______| \_______|
*/
...
abstract contract Utils is Storage {
    ...
    function isCapitalClaimed(address account, uint256 index)
        external
        view
        returns (bool)
    {
    ...
    function userPlanDetails(address account, uint256 index)
        external
        view
    ...
    Utils
{
    ...
    function updateCashFlowFee(uint256 _newFee)
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(_newFee <= DIVISOR, "UCF: Invalid Fee");
        cashFlowFee = _newFee;
    }
    ...
    function _updateSigner(address account) internal onlyValidEoaAddr(account) {
        emit UpdateAddress(1, signer, account);
        signer = account;
    }
    ...
    {
        emit UpdateAddress(3, usd, _newUsd);
        usd = _newUsd;
    }

    function _updateCashFlow(address _newCashFlow)
        internal
        onlyValidAddr(_newCashFlow)
    {
        emit UpdateAddress(4, cashFlow, _newCashFlow);
        cashFlow = _newCashFlow;
    }
}

contract VACInsurance is AdminPanel {
    using SafeERC20 for IERC20;
    ...
    function claim(
        ...
        onlyValidExpiry(expiry)
    {
        require(IERC20(usd).balanceOf(address(this)) >= amount, "C: I F");
        address msgSender = _msgSender();
        User storage user = userData[msgSender];
        ...
        onlyValidExpiry(expiry)
    {
        ...
        require(IERC20(vac).balanceOf(address(this)) >= amount, "CC: I F");
