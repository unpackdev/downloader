...
contract INVT is ERC721A , Ownable  {
    ...
    function mint(uint256 quantity , uint256 deadline , uint8 v, bytes32 r, bytes32 s) external payable {
        ...
        bytes32 encodedMessageHash = keccak256(abi.encodePacked(this, msg.sender, deadline, quantity));
        require(signatureContract == ecrecover(getSignedHash(encodedMessageHash), v, r, s), "Signer should sign transaction");
