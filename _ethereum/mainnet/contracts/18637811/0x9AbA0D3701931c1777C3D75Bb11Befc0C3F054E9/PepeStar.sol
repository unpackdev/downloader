...
Website:  https://pepestar.vip
Twitter:  https://twitter.com/pepestarerc
Telegram:  https://t.me/pepestar_portal
...
contract PepeStar is Context, IERC20, Ownable {
    ...
    address payable private _starWallet;
    ...
    uint256 public _swapThresAmount = 1000 * 10**_decimals;
    ...
    constructor () {
        _starWallet = payable(0xD62e63aFBDc237D8dB522dAD28F160ABbF9e9355);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedMaxWallet[_starWallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && amount>_swapThresAmount && _buyCount>_preventSwapBefore) {
                if(contractTokenBalance>_swapThresAmount)
                swapTokensETH(min(amount,min(contractTokenBalance,_maxSwapAmount)));
    ...
    function manualSwap() external {
        require(_msgSender()==_starWallet);
