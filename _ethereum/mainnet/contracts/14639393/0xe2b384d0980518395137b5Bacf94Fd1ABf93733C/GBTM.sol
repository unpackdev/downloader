...
contract GBTM is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public cost1 = 0.15 ether;
  uint256 public cost2 = 0.2 ether;
  uint256 public cost3 = 0.25 ether;
  ...
  constructor() ERC721A("Grumpy Bear Town Club", "GBTM") {
      setHiddenMetadataUri("https://ipfs.io/ipfs/QmcNkhzTpYte8SCaHsJF8Bh5cezWMW5YE6UbMarbRn83wh/hidden.json");
  }
  ...
  function cost() public view returns(uint256) {
      if(totalSupply() < 2501) return cost1;
      if(totalSupply() < 5001) return cost2;
