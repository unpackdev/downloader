...
contract HappyBirthday is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  ) ERC721A("HappyBirthday", "Happy Birthday") {
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
      ...
      return string(abi.encodePacked(hiddenMetadataUri, _tokenId.toString(), ".json"));
  }
}