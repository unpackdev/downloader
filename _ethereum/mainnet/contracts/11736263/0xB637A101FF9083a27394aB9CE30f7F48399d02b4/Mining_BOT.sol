 ...
 * `ERC20` functions.
 */
contract Mining_BOT is ERC20, ERC20Detailed, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string private constant NAME = "Mining BOT"; 
    string private constant SYMBOL = "MBOT"; 
