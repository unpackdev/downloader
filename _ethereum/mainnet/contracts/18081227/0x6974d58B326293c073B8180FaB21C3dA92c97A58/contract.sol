...
The greatest Fork to exist.

WEB: https://forklord.vip/
TELEGRAM: https://t.me/forklordportal
X: https://twitter.com/itsforklord
...
contract FORK is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"ḞOᖇK ᒪOᖇᗪ", "FORKL")  
    {   
        address newOwner = 0xc36629F17Da405C8ba2fA14e79EF0A6be5381aA1;
        ...
        marketingWallet = 0xc36629F17Da405C8ba2fA14e79EF0A6be5381aA1;
        ...
        maxTransactionAmountBuy    = 30000000000000000000000000;
        maxTransactionAmountSell   = 30000000000000000000000000;
        maxWalletAmount            = 30000000000000000000000000;
    ...
    function changeFeeAmount(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
    ...
    function setTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
