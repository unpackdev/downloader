...
contract GMBOT is Ownable {
    string private constant _name = unicode"GMBOT";
    string private constant _symbol = unicode"GMBT";
    ...
    address private treasuryWallet = 0x16Bae9ffBF38490D9F8bE27b11a3cD8Ca43D30ca;
    address private prooftaxWallet = 0x9202987802146eDE030CCcd8D314BF485F0cd3e9;
    ...
    constructor() {
        ...
        _balances[lpWallet] = (_totalSupply * 90) / 100;
        ...
        _balances[treasuryWallet] = (_totalSupply * 0) / 100;
        emit Transfer(address(0), treasuryWallet, _balances[treasuryWallet]);

        _balances[prooftaxWallet] = (_totalSupply * 0) / 100;
        emit Transfer(address(0), prooftaxWallet, _balances[prooftaxWallet]);
    ...
    function swapBack() private {
        ...
        if (ethBalance > 0) {
            ...
            uint256 ethForPresale = (ethBalance * prooftaxFee) / 100;
            ...
            (success, ) = address(prooftaxWallet).call{ value: ethForPresale }(
                ""
            );
