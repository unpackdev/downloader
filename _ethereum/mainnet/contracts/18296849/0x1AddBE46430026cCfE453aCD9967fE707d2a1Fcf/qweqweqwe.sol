...
contract ElonEnemy is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Elon Musk Is The Enemy";
    string private _symbol = "ElonEnemy";  
    ...
    address payable private marketing_wallet = payable(0x1C68d6e047Aba9a08AA77Ef814f8BE6cA0d80EB2);
