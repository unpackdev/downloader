...
$PONGO is an anime themed ERC-20 token that will be launching SOON on the Ethereum blockchain ,

 aiming to build great community around this project. $PONGO will generate a permanent passive 
 
 income that will benefit all holders by creating a treasury wallet which will be use form different
 
  investment to generate profit from where the holders will benefit from.
