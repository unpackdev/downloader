...
contract ZUTToken is Ownable, ERC20 {
    ...
    constructor(string memory name, uint256 initialMaxSupply) ERC20(concat("Wrapped-", name), concat("w", name)) {
    ...
    function mintTo(address to, uint256 amount) external onlyOwner {
        ...
        require(_currentMinted + amount <= _maxSupply, "Exceeds maximum supply");
        _mint(to, amount);
