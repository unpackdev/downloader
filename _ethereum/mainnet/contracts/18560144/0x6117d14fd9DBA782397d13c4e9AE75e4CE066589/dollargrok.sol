...
/**
Missed Grok? Get a cheap entry with Dollar Grok. . The initial LP is $100, the inital and fianl taxes will be used to update dextools, trending and some levels of marketing.

Telegram: https://t.me/dollargrok
...
contract DollarGrok is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dollar Grok";
    string private constant _symbol = unicode"1Grok";
