...
contract Godzilla is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0x259582167A702caC3666f4D9d5A8F7e05513b7dB;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 11000 * 10**_decimals;
        marketingWalletAddress = payable(0x259582167A702caC3666f4D9d5A8F7e05513b7dB);
        teamWalletAddress = payable(0x259582167A702caC3666f4D9d5A8F7e05513b7dB);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = takeFee(sender,
             recipient, amount);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = 0;  uint256 deadAmount = 0;
