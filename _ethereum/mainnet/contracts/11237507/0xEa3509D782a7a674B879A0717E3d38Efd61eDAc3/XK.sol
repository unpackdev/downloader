...
contract XK{
/*********Token的属性说明************/
    string public name = 'XK';
    string public symbol = 'xingkong';
    uint8 public decimals = 18;  // 18 是建议的默认值
    uint256 public totalSupply=8000000000000000000000000; // 发行量
    ...
    // 这里是构造函数, 实例创建时候执行
    function XK(uint256 initialSupply, string tokenName, string tokenSymbol) public {
