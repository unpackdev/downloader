...
abstract contract ERC20Detailed is IERC20 {
 ...
 contract Emperor is ERC20Detailed {
  ...
  address private constant _router  = 0x3035C814FBA6a5088b46adF52ea2f90Bfd6CBc87;
  address private          _owner;
 
  string   constant tokenName     = "Emperor";
  string   constant tokenSymbol   = "Emperor";
  uint8    constant tokenDecimals = 18;
  uint256  public   burnPct       = 2;
  uint256  private  _totalSupply  = 12000000000000000000000;
  uint256  private  _txCap        = 480000000000000000000;
  ...
  function findBurnAmount(uint256 rate, uint256 value) public pure returns (uint256) {
      return value.ceil(20).mul(rate).div(20);
  }
