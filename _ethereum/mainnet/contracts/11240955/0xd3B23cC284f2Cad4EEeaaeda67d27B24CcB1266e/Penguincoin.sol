/**
 * Penguin coins total 9999
 * Penguin coin is the consensus token of Penguin mainnet
 * Penguin Coin not only has voting rights on the Penguin mainnet, but also has the right to distribute part of the income
*/
