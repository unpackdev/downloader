...
contract Yugen is Satoshigoat {

	uint256 public cycleStartTime = 1698192000;//October 25, 2023 (midnight)

	//red: [0,9], black: [10], gold: [11]
	string [12] private _hashes = ["QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-1.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-2.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-3.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-4.json",
                                   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-5.json",
                                   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-6.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-7.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-8.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-9.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/red2-10.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/black2.json",
								   "QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/gold2.json"];

	// ------------------------------
	// CORE FUNCTIONALITY FOR ERC-721
	// ------------------------------

	constructor() Satoshigoat("Yugen", "", "ipfs://") 
	{
		_contractURI = "ipfs://QmWtxuzrNa2j3SmUeWjXzkNWWibeUx3mPCpiCT26ufri2w/century2-contract.json";
		...
		for (i = 1; i <= 9; i++) {
			if (i == 1) {
			    ...
			    if (trueDeltaYears > 100 || (isHundredMultiple(trueDeltaYears) && !isBeforeCenturyTurn(today))) {
                    //today is either October 25th, 2023 + C*100, or between October 25th and December 31st
			...
			if (modDeltaYears <= 10*i) {
				...
				if (modDeltaYears == 10*i) {
					...
					else return _hashes[i];//red states 2 thru 10 (edge cases for decades) 4853960271
				}
