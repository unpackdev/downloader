...
Socials:
https://www.no-banana.xyz
https://t.me/NoBanana_ERC
https://twitter.com/No_Banana_erc
...
contract NoBanana is ERC20, Ownable { //.sol
    ...
    address public walletAddress = 0xba085Bff9F28b4Aa7eeC90920b6fd3b525F6F0C9; //MarketingWallet
    uint256 public buyFee  = 15; //BuyFee
    uint256 public sellFee = 15; //SellFee

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    
    address private DEAD = 0x000000000000000000000000000000000000dEaD;  //DeadAdd

    bool    private swapping;
    uint256 public swapTokensAtAmount;  //SwapTokens
    ...
    constructor () ERC20("NoBanana", "NoBanana") 
    {   
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //UniRouter
        ...
        swapTokensAtAmount = totalSupply() / 100;
         maxTransactionAmount = (totalSupply() * 1 / 100); // 1% maxTxAmount
    ...
    function setFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 15, "fee on buy cannot be more than 15%");
        require(_sellFee <= 15, "fee on sell cannot be more than 15%");
        buyFee  = _buyFee;
        sellFee = _sellFee;
