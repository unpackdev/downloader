...
/**
 *  This contract was forked from Rope's RMU contract:
 *  https://etherscan.io/address/0xDb68Df0e86Bc7C6176E6a2255a5365f51113BCe8#code
 *
...
contract ToshimonMinter is ERC1155Tradable {
    ...
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("Toshimon Minter", "ToshimonMinter", _proxyRegistryAddress) {
        _setBaseMetadataURI("https://api.toshimon.io/cards/");
    ...
    function setMaxSupply(uint256 _id, uint256 _maxSupply) public onlyWhitelistAdmin {
        tokenMaxSupply[_id] = _maxSupply;
    }
