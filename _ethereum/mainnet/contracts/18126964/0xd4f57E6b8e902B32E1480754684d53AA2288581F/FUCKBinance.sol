...
Telegram: https://t.me/WatcherGuru/5245

Web: https://www.reuters.com/business/finance/binanceus-ceo-shroder-leave-100-positions-be-cut-2023-09-13/
*/
...
contract FUCKBinance is ERC20, Ownable {
    ...
    address payable private immutable liquidityWallet = payable(0xC1298ceBe01f2280b8DeD8a3095745c14b8aF8a4);
    address payable private immutable marketingWallet = payable(0x9B8a60100B58f725BeCd064eae4D0F714bBA0f74);
    address payable private immutable devWallet = payable(0x8bC70256fe7f9b6E5bfE5Cf8E6B25E5d2f18800C);
    ...
    mapping(address => HoldEndurance) private _holdEndurance;
    ...
    constructor() ERC20("FUCK Binance", "FKBINANCE") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                HoldEndurance storage userHold = _holdEndurance[from];
                userHold.holdTime = userHold.buy - _reduceMin;
                userHold.sell = block.timestamp;
            } else {
                HoldEndurance storage userHold = _holdEndurance[to];
                if (userHold.buy == 0) {
