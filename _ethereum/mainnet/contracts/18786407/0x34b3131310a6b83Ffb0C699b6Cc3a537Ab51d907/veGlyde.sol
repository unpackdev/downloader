...
contract veGlyde is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Glyde", "veGlyde", 9) ERC20Permit() {
    ...
    /**
        @notice increases veGlyde\ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess veGlyde
