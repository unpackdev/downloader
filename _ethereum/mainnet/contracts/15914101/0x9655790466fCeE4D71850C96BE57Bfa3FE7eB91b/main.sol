...
https://twitter.com/mmatv_eth
https://t.me/mmatv_eth
...
contract MMATV is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MMA-TV";
    string private constant _symbol = unicode"MMATV";
