...
月へ (Tsukie) - To the moon

Official links will be announced in messages in contract tx
...
contract Tsukie is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TSUKIE";
