...
/**
    Deploy Ai: Token deployment at your fingertips.
    
    Telegram: https://t.me/DeployAi
    X: https://twitter.com/DeployAiErc
    Web: https://www.deployerc.ai/
...
contract DeployAi is ERC20, Ownable {
    ...
    constructor() ERC20("Deploy AI", "DEPLOY") {
        ...
        uint256 _sellTeamFee = 15; // launch high fees, then reduce to 5-5
