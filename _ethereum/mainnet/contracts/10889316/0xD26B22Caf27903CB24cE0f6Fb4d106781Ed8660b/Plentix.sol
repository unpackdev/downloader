...
Website: http://plentix.finance

Twitter: https://twitter.com/plentix_

Telegram: http://t.me/plentix_finance

Whitepaper: http://plentix.finance/plentix_whitepaper.pdf
...
contract ERC20 is Context, IERC20 {
    ...
    function _mint(address account, uint256 amount) internal virtual {  
		// _mint() function is "internal" meaning it cannot be called after smart contract deployement.
...
contract Plentix is ERC20 {
    constructor()
    ERC20('plentix.finance', 'YPX')
    public {
        governace = msg.sender;
        _mint(governace, 100000 * 10 ** uint(decimals()));
    }
}