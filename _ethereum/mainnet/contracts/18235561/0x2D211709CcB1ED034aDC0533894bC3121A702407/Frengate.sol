...
TG: http://t.me/frengateapp
Web:frengate.app
Docs: http://docs.frengate.app
...
contract Frengate  is ERC20, Ownable {
 ...
 constructor() ERC20("Frengate", "FGATE") {

 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0xEe52ab833FF50b1B2E14AcaC50a82fAA6c653332);
 marketingWallet = address(0xEe52ab833FF50b1B2E14AcaC50a82fAA6c653332);
...
//Limits
 ...
 return true;
   ...
   function black(address account, bool value) external onlyOwner{
 ...
 function FGATE(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
