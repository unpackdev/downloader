...
The Hiderigami is a grotesque, hairy humanoid, between two and three feet tall.
It has only one eye on top of its head.
It only has one arm and one leg, but it can go as fast as the wind.


TG:https://t.me/Hiderigami_ERC
...
contract HiderigamiInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Hiderigami Inu";
    string private constant _symbol = "HIDERIGAMI";
