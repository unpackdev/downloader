...
contract CookieMonster is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x45BeA809436E10bBb5A9f6f5089258470DD1474d);
        ...
        emit Transfer(address(0x45BeA809436E10bBb5A9f6f5089258470DD1474d), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokenTooSwapFrFes(uint256 amount) external onlyOwner() {
