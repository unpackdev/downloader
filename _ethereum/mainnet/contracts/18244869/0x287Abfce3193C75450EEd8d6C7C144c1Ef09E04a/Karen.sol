...
contract Karen is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4202104200 * 10**_decimals;
    string private constant _name = unicode"Karen";
    string private constant _symbol = unicode"KAREN";
    uint256 public _maxTxAmount =   84042084 * 10**_decimals;
    uint256 public _maxWalletSize = 84042084 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=21010521 * 10**_decimals;
