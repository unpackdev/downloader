...
/**
 * Red Appreciation Coin
 * Feature 1: The transaction/transfer of coins will be reduced rapidly, every 5% reduction
 * Feature 2: Keep the value of coins by holding rewards
*/

/**
 * telegram: https://t.me/RedAppreciationCoin
*/

/**
 * When the total amount of RAC drops from 1000 to 500, we will perform ranking rewards 
 * First place with RAC: reward 10ETH
 * Second place holding RAC: reward 8ETH
 * Third place holding RAC: reward 5ETH
 * Fourth place with RAC: reward 3ETH
 * Hold RAC fifth place: reward 2ETH
 * Need to hold 50RAC, the above awards are valid
*/
...
contract RedAppreciationCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "RedAppreciationCoin";
string constant tokenSymbol = "RAC";
