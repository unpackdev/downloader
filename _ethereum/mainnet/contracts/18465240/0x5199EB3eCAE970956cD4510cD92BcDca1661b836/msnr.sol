...
// °°°·.°·..·°¯°·._.·нєу ωєƖcσмє вк 2 мѕη ωαтѕ υя αɗɗу? σк g2g ттуƖ ·._.·°¯°·.·° .·°°° 
...
contract MSN is ERC20("MSN", "MSN"), Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 650_00 * 10 ** 18; // 0.65% threshhold
    uint256 public maxWalletLimit = 100_000 * 10 ** 18; // 2% max wallet

    uint256 private genesis_block;
    uint256 private deadline = 6; // 6 blocks of launch tax
    uint256 private launchtax = 30; // 30% launch tax
    ...
    Taxes public taxes = Taxes(5, 0, 0); // 2% buy tax
    Taxes public sellTaxes = Taxes(20, 0, 0); // 2% sell tax
    ...
    constructor() {
        ...
        _mint(msg.sender, 100_000_00 * 10 ** 18); // 10 mil supply
