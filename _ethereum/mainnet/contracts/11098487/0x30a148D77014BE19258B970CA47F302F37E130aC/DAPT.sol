...
/*
 * Destroying the total amount of appreciation tokens 1200 will only decrease but not increase!
...
contract DAPT is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "DestroyAppreciationToken";
string constant tokenSymbol = "DAPT";
