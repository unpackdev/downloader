...
TG: https://t.me/GANESHA_ETH
Twitter: x.com/ganesha_faith
Website: https://ganesha.faith
...
contract GANESHA is Context, IERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 444444444 * 10**_decimals;
    string private constant _name = unicode"GANESHA";
    string private constant _symbol = unicode"GANESHA";
    uint256 public _maxTxAmount =   6666667 * 10**_decimals;
    uint256 public _maxWalletSize = 8888889 * 10**_decimals;
