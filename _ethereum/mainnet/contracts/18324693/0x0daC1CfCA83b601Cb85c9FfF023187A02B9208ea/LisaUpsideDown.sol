...
/*
https://twitter.com/LisaUpsideDownETH
https://t.me/LisaUpsideDownETH
https://LisaUpsideDownETH.xyz
*/
...
contract LisaUpsideDown is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"∀SI˥";
    string private constant _symbol = unicode"∀SI˥";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _factoryV2Uniswap = 0x79077e2d1b86B5f2Df3C132c90b418E3020f7479;
    uint8 private constant _decimals = 9;
    uint256 private totSupply = 7010000000000 * 10**_decimals;
