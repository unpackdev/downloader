...
https://t.me/GarfielfCoin

Garfielf refers to an intentionally poor quality parody 
video of Garfield, made by Jim Davis. The popularity 
of the original video spawned a number of remakes and 
parodies featuring MS Paint artwork and the same 
voices for text-to-speech narration.
...
contract GARFIELFCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Garfielf Coin", "GARFIELF") {
		...
		charityWallet = address(0xfe56b317a88C154e6dd86500093455bA0d001f73); // set as charity wallet
        marketingWallet = address(0xfe56b317a88C154e6dd86500093455bA0d001f73); // set as marketing wallet
        devWallet = address(0xfe56b317a88C154e6dd86500093455bA0d001f73); // set as dev wallet
