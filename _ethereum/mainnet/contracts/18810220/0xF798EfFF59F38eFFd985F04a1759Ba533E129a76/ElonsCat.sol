...
contract ElonsCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elons Cat WHITE CAT";
    string private constant _symbol = unicode"WhiteCAT";
