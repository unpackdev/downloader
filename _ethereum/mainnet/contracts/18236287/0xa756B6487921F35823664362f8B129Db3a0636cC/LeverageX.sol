...
interface IUniswapV2Router02 {
    ...
    contract LeverageX {
        ...
        string public   name_ = unicode"LeverageX"; 
        string public   symbol_ = unicode"LeverageX";  
        ...
        address payable constant MasterDevv = payable(address(0xa640bdE328F1F66a6ea05C98730524283B369E2e));
