...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5dF32FfD4f78fbE874b74ea376C3855C53edD6D2];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 7373 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmS6yWvuy8yWhxyogshEH9h7QERVgdYWxaNfP446qG2VEj/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 7373");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 7373");
...
// File: contracts/NalaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NalaContract is RamppERC721A {
    constructor() RamppERC721A("Nala", "Nala"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/PlPc6ZFLGPN7rxdPGhHz/contract-metadata";
    }
}
