...
Crypto mixer via Telegram | Seamless, discreet & secure | Dive into the shadows with $XMIX 🪐

Telegram: http://t.me/EnterXMIX
Website: http://XMIXOfficial.com
Mixer: http://t.me/XMIX_MixerBot
...
contract XMIX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"XMIX";
    string private constant _symbol = unicode"XMIX";
    uint256 public _maxTxAmount =   8750 * 10**_decimals;
    uint256 public _maxWalletSize = 12500 * 10**_decimals;
    uint256 public _taxSwapThreshold=1250 * 10**_decimals;
