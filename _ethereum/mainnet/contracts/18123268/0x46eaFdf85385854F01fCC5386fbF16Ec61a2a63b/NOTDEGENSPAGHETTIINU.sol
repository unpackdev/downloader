...
contract NOTDEGENSPAGHETTIINU is ERC20, Ownable {
    ...
    constructor() ERC20("NOTDEGENSPAGHETTIINU", "FRENS") {
 ...
 sellFee=3;
     sellTotalFees=sellFee;
        ...
        swapTokensAtAmount = 100000000 * 1e18;

        feeWallet = address(0x2c319cbda996C8816Ce0A0F4BfB0CF306ef28A69);
    ...
    function whitelist(address _whitelist,bool isWL)
    public
    onlyOwner
    {
