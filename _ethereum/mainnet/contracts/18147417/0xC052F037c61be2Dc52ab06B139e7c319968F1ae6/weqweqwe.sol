...
/** 
🎵ROCKY is a meme token on Ethereum It’s based on the ROCKSTARS that we adore
You can buy them, sell them, trade them for some fun
ROCKY is the coin that makes you feel the sun🎵

//Website: https://www.rockytoken.info/

//Twitter: https://twitter.com/rockytokenerc

//Telegram: https://t.me/RockyTokenErc
...
contract ROCKY is Ownable {
    ...
    string private _cigzyxas = unicode"Rocky Token";
    string private _zvxtgilo = unicode"$ROCKY";
