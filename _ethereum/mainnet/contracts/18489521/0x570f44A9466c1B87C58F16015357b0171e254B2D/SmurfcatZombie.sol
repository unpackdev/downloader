...
contract SmurfcatZombie is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Smurfcat Zombie";
    string private constant _symbol = unicode"Шалозомби";
