...
contract RPEPE is Context, IERC20, Ownable {
    ...
    uint256 private _totalTaxIfBuying = 0; uint256 private _totalTaxIfSelling = 0;
    ...
    constructor (
        ...
        _minimumTokensBeforeSwap = 530000 * 10**_decimals;
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
        swapAndLiquifyEnabled = _enabled; emit SwapAndLiquifyEnabledUpdated(_enabled);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        // swap token -> eth
        swapTokensForEth(tAmount); uint256 amountReceived = address(this).balance;
