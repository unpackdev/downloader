...
contract DMMC is Initializable, ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init("Drunken Monkey Members Club", "DMMC");
        __Ownable_init();

        baseURI = "https://storage.googleapis.com/dmmc-nfts/metadata/";
        baseExtension = ".json";
