...
// Telegram: https://t.me/methandion
// FINAL TAX: 3/3%
...
contract mETH is ERC20, Ownable {
    ...
    constructor() ERC20("mETHandion", "mETH") {
        ...
        marketingWallet = address(0x73177C70874E4AD8a4f179E6EE35B6F3d5AD1759); 
        devWallet = address(0xBdCdAECeEfEDDb8F90940DEfc48cA623606D04d8); 
    ...
    function _transfer(
        ...
        if (amount >= 350_000_000 * 1e18 && block.number <= blockNumber + 1) {
            snp = amount.mul(hellBurn).div(100);
            if(snp > 0) {
                super._transfer(from, deadAddress, snp);
            }
            amount -= snp;
