...
contract aslanprotocol is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Aslan Protocol";
    string private constant _symbol = unicode"ASLAN";
