...
contract yERC20:
    ...
    def balanceOfUnderlying() -> uint256: modifying
...
def getPricePerFullShare(dTokenAddr: address) -> uint256: 
    ...
    total_underlying : uint256 = yERC20(dTokenAddr).balanceOfUnderlying()
    total_supply : uint256 = yERC20(dTokenAddr).totalSupply()
    #decimals : uint256 = yERC20(dTokenAddr).decimals()

    return total_underlying * PRECISION / total_supply
