...
/**
 * @title OriginsNFT
 * @dev Origins & Ancestries: Genesis Collection NFT contract
 * @author Amberfi
 */
    ...
    IERC2981Upgradeable
{
    ...
    function initialize(
        ...
        royaltyReceiver_ = royaltyReceiver_;
    ...
    function mint(
        address to_,
        uint256 tokenId_
    ) external onlyMarketManager whenNotPaused {
    ...
    function royaltyInfo(
        ...
        return (royaltyReceiver, (salePrice_ * royaltyPercentage) / 10000);
    }
