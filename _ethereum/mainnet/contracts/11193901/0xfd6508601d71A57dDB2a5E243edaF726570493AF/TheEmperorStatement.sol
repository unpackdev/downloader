...
contract TheEmperorStatement is StandardToken {

  string public constant name = "The Emperor Statement";
  string public constant symbol = "TES";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 722561 * (10 ** uint256(decimals));
