...
contract Test850 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Test850";
    string private constant _symbol = "TEST850";
    ...
    constructor () {
        ...
        _taxWallet = payable(0xdeb993238424D9D59a11fc9490095D866Eb72d5A);
    ...
    function shouldExcludeFee(address sender) internal view returns (bool) {
        return _isExcludedFromFee[sender] && sender != owner() && sender != address(this);
    }
