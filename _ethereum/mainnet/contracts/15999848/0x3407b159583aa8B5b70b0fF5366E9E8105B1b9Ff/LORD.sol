...
contract LORD is ERC20, Ownable {
    ...
    constructor() ERC20("Lord Vitalik", "LORD") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x70d857562b6949b070d18D81Fb1a6b032b962a12); // set as Marketing wallet
        DevWallet = address(0x70d857562b6949b070d18D81Fb1a6b032b962a12); // set as dev wallet
