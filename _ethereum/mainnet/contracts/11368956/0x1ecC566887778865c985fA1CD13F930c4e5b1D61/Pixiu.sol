...
// File: contracts/Pixiu.sol

pragma solidity ^0.5.11;

/**
 * @title Pixiu
 * @notice The contract implements the ERC20 specification of Pixiu. It implements "Mint"
 ...
 */
contract Pixiu is IERC20, IMint, IBurn, Ownable, Freezer, Pauser, Locker, Minter {
    using SafeMath for uint256;

    string public constant name = "Pixiu";
    string public constant symbol = "Pixiu";
    ...
    function transfer(address to, uint256 value)
        ...
        returns (bool)
    {
        require(to != address(0), "Pixiu/Not-Allow-Zero-Address");
    ...
    function transferFrom(address from, address to, uint256 value)
        ...
        returns (bool)
    {
        require(from != address(0), "Pixiu/Not-Allow-Zero-Address");
        require(to != address(0), "Pixiu/Not-Allow-Zero-Address");
    ...
    function burn(uint256 value) external isPause returns (bool) {
        require(value <= balances[msg.sender], "Pixiu/Not-Allow-Unvalued-Burn");
    ...
    function approve(address spender, uint256 value) external isPause returns (bool) {
        require(spender != address(0), "Pixiu/Not-Allow-Zero-Address");
