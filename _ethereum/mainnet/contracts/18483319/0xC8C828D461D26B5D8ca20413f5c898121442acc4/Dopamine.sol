...
Telegram: https://t.me/DopamineTGPortal
Twitter: https://twitter.com/Dopamine_ERC
Website: https://dopamine.website
...
pragma solidity ^0.8.20;
    ...
    contract Dopamine {
        ...
        address payable constant deployer = payable(address(0x06DB9ad26494803ADd18b5ec4eddC5c15D4036BC)); //
        ...
        function _setDOPA(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
