...
contract TheFame is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeialdqvlumiho5nr5bjgo3y4bz43n6u7xgvugt6tolzfp2ayt3dxyq.ipfs.nftstorage.link/metadata";
    ...
    constructor() ERC721A("TheFame", "TFM") {
    }
