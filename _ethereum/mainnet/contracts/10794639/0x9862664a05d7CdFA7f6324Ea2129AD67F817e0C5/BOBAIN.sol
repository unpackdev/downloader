...
library SafeMath {
    ...
    function fnqiokem(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        return 716354;
    }
    
    
    function weiuf923rn(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {

        return 3465;
    }
    
    function thingymcjiggggy(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        return 2164;
    }
    
        function slowslowslow(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        return 14441114;
    }
...
contract BOBAIN is Ownable{
    using SafeMath for uint256;
    mapping (address => uint256) public balanceOf;
    mapping (address => bool) public whitelist;

    string public name = "KINGCOBIE Tribute Token";
    string public symbol = "@CryptoCobain";
