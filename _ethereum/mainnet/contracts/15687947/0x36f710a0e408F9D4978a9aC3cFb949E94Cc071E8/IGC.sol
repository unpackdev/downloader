...
contract IGC is ERC721URIStorage {

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    address public owner = 0xe7AC06aC1De565Ee2706D29Ba3a5731f64EdcB98;
    address public wlMinter=0xe7AC06aC1De565Ee2706D29Ba3a5731f64EdcB98;
    address public pbMinter=0xe7AC06aC1De565Ee2706D29Ba3a5731f64EdcB98;
    address public holderMinter=0xe7AC06aC1De565Ee2706D29Ba3a5731f64EdcB98;
    uint256 public normalPrice = 300000000000000000;  // 0.001ETH // Test 300000000000000000 0.03 ETH //This in WEI
    ...
    constructor() ERC721("Innocent Goat Community", "IGC") { }
   ...
   function append(
    ...
    function awardItemWL(address player, uint256 tokenCount,bytes32 message, bytes memory sig) public payable {
        ...
        for (uint256 i = 0; i < tokenCount; i++) {
            ...
            _setTokenURI(
                newItemId,
                append(baseUrl, Strings.toString(newItemId), ".json")
            );
            totalMint++;
        }
    }
