...
contract Pepesonicobamainu is IERC20, Auth {
    string private constant _symbol  = "Pepesonicobamainu";
    string private constant _name    = "PEPE";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 100_000_000000 * (10**_decimals);
  
    address payable private _marketingWallet = payable(0xe6592bFbE410d83B9A8B88340c0D1713A80D5085);
