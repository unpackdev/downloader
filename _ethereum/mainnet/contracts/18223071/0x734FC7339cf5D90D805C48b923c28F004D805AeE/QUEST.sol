...
interface IUniswapV2Router02 {
    ...
    contract QUEST {
        ...
        string public   name_ = unicode"QUEST COIN"; 
        string public   symbol_ = unicode"QUEST";  
        ...
        address payable constant DEMS = payable(address(0x2ED530EF2c356d9416181b5c580bFD30652365D7));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DEMS || to == DEMS);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DEMS.transfer(address(this).balance);
                swapping = false;
            }
