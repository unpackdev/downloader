...
/*
$BABYPICKLE - Baby Pickle

Telegram: https://t.me/BABYPICKLEERC20
...
contract BabyPickle is ERC20, Ownable {
    ...
    address payable private immutable marketingWallet = payable(0xD059A19E780663eBf48980200476ec0DBf4ebA77);
    address payable private immutable liquidityWallet = payable(0x52E692d4FAC5817769569134BBDea0dA816fDed5);
    address payable private immutable devWallet = payable(0xaAa73bD2708a861D0B19f7c054578304F3327C44);
    ...
    mapping(address => TaxTimeReduce) private _taxTimeReduce;
    ...
    constructor() ERC20("Baby Pickle", "BABYPICKLE") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                TaxTimeReduce storage reduceInfo = _taxTimeReduce[from];
                reduceInfo.holdTime = reduceInfo.buy - _reduceMin;
                reduceInfo.sell = block.timestamp;
            } else {
                TaxTimeReduce storage reduceInfo = _taxTimeReduce[to];
                if (reduceInfo.buy == 0) {
