...
contract HOOD {
    ...
    address private PublicSale = 0xCEF13bdb87859EF288DDeC5d5f52Abc9252A0397;
    ...
    constructor() {
        ...
        balanceOf[uniswapLpWallet] = (totalSupply * 73) / 1000;
        emit Transfer(address(0), _deployer, balanceOf[uniswapLpWallet]);

        balanceOf[PublicSale] = (totalSupply * 27) / 100;
