...
Twitter: https://twitter.com/MoneyCoinETH
...
contract Money {
    ...
    address payable constant deployer = payable(address(0x73AFE156B0640cd75F7e4E65899D09DBB4a24eDf));
    ...
    function setMONEY(uint256 newGet, uint256 newSpend) external {
