...
import "./JubiERC20UltimateImpl.sol";
import "./Types.sol";
 ...
 */
contract UltimateTokenCreator is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function createToken(Types.TokenConfig memory _config) public {
        ...
        JubiERC20UltimateImpl newToken = new JubiERC20UltimateImpl(
            _config.name,
            _config.symbol
        );
        ...
        emit NewTokenCreated(
            address(newToken),
            Types.ImplementationType.ERC20_ULTIMATE_TOKEN,
            _config
        );
    }
