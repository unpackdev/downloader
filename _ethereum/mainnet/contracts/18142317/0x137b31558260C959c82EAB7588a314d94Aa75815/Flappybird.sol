// Telegram: t.me/flappybird2earn 
// Discord:  
// Twitter: https://twitter.com/flappybird2earn 
// Website: https://flap2earn.com/
...
contract Flappybird is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x0355C902E82c6Bd289e85a497Bb07bf5783dbF04;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 400;
    uint16 public feeOwnerInitialPercentageSell = 400;
    ...
    constructor() ERC20("Flappy Bird", "FLAPPY") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x0355C902E82c6Bd289e85a497Bb07bf5783dbF04, ownerReceiverSupply * 10 ** decimals());
        } else {
