// Project Telegram: https://t.me/Slartibartfasterc
...
contract Slartibartfast is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"Slartibartfast";
    uint256 public _txLimit = 1000000 * 10**_decimals;
    uint256 public _walletLimit = 20000 * 10**_decimals;
    uint256 public _swapbackThreshold= 500 * 10**_decimals;
    uint256 public __swapbackLimit= 500 * 10**_decimals;
