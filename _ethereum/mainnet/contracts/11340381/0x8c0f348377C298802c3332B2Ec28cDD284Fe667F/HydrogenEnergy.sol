...
contract HydrogenEnergy{
    ...
    string private _name= "HydrogenEnergyToken";
    string private _symbol= "HET";
    uint256 private _decimals = 18;
    bool internal _lockall = false;
    
    constructor () public {
	admin[address(0xF2788EF3EED4743B35544c4c1449b6b86452226b)] = true;
    balanceOf[address(0xF2788EF3EED4743B35544c4c1449b6b86452226b)] = _totalSupply;
        }
    ...
    function lockall(bool lockallt) public {
        require(admin[msg.sender]==true);
        _lockall = lockallt;
    }
