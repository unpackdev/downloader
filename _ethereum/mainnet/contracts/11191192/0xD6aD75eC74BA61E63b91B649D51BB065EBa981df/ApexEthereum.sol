...
contract ApexEthereum is StandardToken {

  string public constant name = "Apex Ethereum";
  string public constant symbol = "XEH";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 98563 * (10 ** uint256(decimals));
