...
contract OTF is ERC20Detailed, Context {
	...
	string constant tokenName = "Gordon One To Fifty";
	string constant tokenSymbol = "OTF";
	uint8  constant tokenDecimals = 18;
	uint256 private _totalSupply = 20500 * (10 ** 18);
