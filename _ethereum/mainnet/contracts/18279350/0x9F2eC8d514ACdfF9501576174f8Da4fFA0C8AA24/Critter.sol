...
// TELEGRAM https://t.me/+DfuX-AqHeckzOWRk
...
contract Critter is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x85d98C3F917C76a5Fc50027992474013f4465cf5); 
    address payable public Wallet_Dev = payable(0xCDFdE01815DCC24d3B3e0e4558c0312Fd37A4655);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "Critter"; 
    ...
    constructor () {
        _owner =0xCDFdE01815DCC24d3B3e0e4558c0312Fd37A4655;
