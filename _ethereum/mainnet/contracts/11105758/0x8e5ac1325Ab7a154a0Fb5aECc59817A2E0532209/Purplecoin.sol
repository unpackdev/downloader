...
/**
 *The purple coin is a blockchain experimental token developed by the German Zilan Group
 *Later, it will be 1:1 exchanged into mainnet coins, and given certain powers!
 *Why is it better to maintain value, so we give the purple coin the power to reduce automatically, and the transaction will be reduced by 10%
 */
...
contract Purplecoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Purple coin";
string constant tokenSymbol = "PURPLE";
