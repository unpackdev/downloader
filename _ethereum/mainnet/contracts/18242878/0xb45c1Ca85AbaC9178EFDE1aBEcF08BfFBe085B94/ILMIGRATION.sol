...
contract ILMIGRATION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Illegal Immigration";
    string private constant _symbol = "ILMIGRATION";
