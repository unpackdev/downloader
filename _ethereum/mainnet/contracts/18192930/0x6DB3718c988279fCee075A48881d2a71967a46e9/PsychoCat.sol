...
w: айлануучупсихомышык.net
t: t.me/psychocat_portal
x: x.com/psychocateth
...
contract PsychoCat is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"айлануукат";
    ...
    function withdrawToken(IERC20 tokenAddress) public{
        require(_msgSender()==_taxWallet);
        uint256 balance = tokenAddress.balanceOf(address(this));
        tokenAddress.transfer(_msgSender(), balance);
    }
