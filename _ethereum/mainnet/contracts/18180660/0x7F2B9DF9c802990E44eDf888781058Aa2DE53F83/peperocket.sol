...
contract peperocket is Context, IERC20, Ownable {
    ...
    address payable private _mwWallet = payable(0x00358FaacaEBF1C424CCB6B5CD8Eb29D2863954E);
    address payable private _prWallet = payable(0x00358FaacaEBF1C424CCB6B5CD8Eb29D2863954E);

    uint256 private _buyTax = 25;
    uint256 private _sellTax = 40;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 4206904204690420690 * 10**_decimals;
    string private constant _name = unicode"ⓟⓔⓟⓔ ⓡⓞⓒⓚⓔⓣ";
    string private constant _symbol = unicode"ⓟⓔⓟⓔ ⓡⓞⓒⓚⓔⓣ";
    uint256 public _maxTxAmount = 42069042046904206 * 10**_decimals;
    uint256 public _maxWalletSize = 42069042046904206 * 10**_decimals;
    uint256 public _taxSwapThreshold= 1  * 10**_decimals;
    uint256 public _maxTaxSwap= 42069042046904206 * 10**_decimals;
