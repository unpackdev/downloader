...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x89Ad2369De1c2F5A3d4E506CC4629c7436922250);
    address payable private _developmentAddress = payable(0x89Ad2369De1c2F5A3d4E506CC4629c7436922250);
