...
contract SnoopyInu is ERC20, Ownable {
    ...
    constructor() ERC20("Snoopy Inu", "SNOOPY") payable {
    	...
    	marketingWallet = address(0x502fc5C448a1325C1B059F39D3781787aF276925); // set as Marketing wallet
        devWallet = address(0x0966AF8719B5D618ad1A9736DCb4373c48ED5c51); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x502fc5C448a1325C1B059F39D3781787aF276925, true);
        excludeFromFees(0x0966AF8719B5D618ad1A9736DCb4373c48ED5c51, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x502fc5C448a1325C1B059F39D3781787aF276925, true);
        excludeFromMaxTransaction(0x0966AF8719B5D618ad1A9736DCb4373c48ED5c51, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x0966AF8719B5D618ad1A9736DCb4373c48ED5c51,
            block.timestamp
        );
    }
