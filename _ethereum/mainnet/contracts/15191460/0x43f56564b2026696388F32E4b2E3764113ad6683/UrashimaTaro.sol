...
contract UrashimaTaro is ERC20, Ownable {
    ...
    constructor() ERC20("Urashima Taro", "TARO") {
        ...
        devOpsWallet = address(0xBCa147781DD1546330a5e9eB3C437b8b57f3692d); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xBCa147781DD1546330a5e9eB3C437b8b57f3692d), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xBCa147781DD1546330a5e9eB3C437b8b57f3692d), true);
