...
[WEB] HTTPS://TATETOKEN.PRO
[TG]  HTTPS://T.ME/TATE_PORTAL
...
contract T4TETOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"T4TETOKEN";
    string private constant _symbol = unicode"T4TE";
