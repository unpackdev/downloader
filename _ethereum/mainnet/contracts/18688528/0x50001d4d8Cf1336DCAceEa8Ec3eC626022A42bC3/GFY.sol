...
contract GFY is ERC20, Ownable {
    ...
    constructor() ERC20("GO F*CK YOURSELF 2.0", "GYF2") payable {
    	...
    	marketingWallet = address(0x3792d077B71DBa77DAf3D992EA9c7A87b072a404); // set as Marketing wallet
        devWallet = address(0xdAe5b4D8Fcb2e32777d31d708e19df3052db7273); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x3792d077B71DBa77DAf3D992EA9c7A87b072a404, true);
        excludeFromFees(0xdAe5b4D8Fcb2e32777d31d708e19df3052db7273, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x3792d077B71DBa77DAf3D992EA9c7A87b072a404, true);
        excludeFromMaxTransaction(0xdAe5b4D8Fcb2e32777d31d708e19df3052db7273, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xdAe5b4D8Fcb2e32777d31d708e19df3052db7273, totalSupply*8/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xdAe5b4D8Fcb2e32777d31d708e19df3052db7273,
            block.timestamp
        );
    }
