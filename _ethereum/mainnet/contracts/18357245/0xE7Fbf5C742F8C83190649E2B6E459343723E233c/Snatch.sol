...
contract Snatch is ERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x1185f7638129De06B028B9F441e969Bd16E7D297);
    address payable private _marketingAddress = payable(0x68d3B46E0d5804a9f9886DC83c73dc2dEe465a37);
    ...
    constructor() ERC20("SNATCH", "SNATCH") {
	...
	function buyMarketingFee() public view returns(uint256) {
        ...
        uint256 _timeRound = (block.timestamp - launchedTime) / 5 minutes;
