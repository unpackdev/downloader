...
contract BillCipher is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xdEF0c4be97B38ccC8aF03434d03ebf5Ac71F2f81);
        ...
        emit Transfer(address(0xdEF0c4be97B38ccC8aF03434d03ebf5Ac71F2f81), _msgSender(), _tTotal);
    }
    ...
    function setMaximumTokensTooSwapForFes(uint256 amount) external onlyOwner() {
