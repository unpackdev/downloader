...
contract RF is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 1023;
    ...
    constructor(string memory initBaseURI) ERC721A("Renga Friends", "RF") {
        baseURI = initBaseURI;
