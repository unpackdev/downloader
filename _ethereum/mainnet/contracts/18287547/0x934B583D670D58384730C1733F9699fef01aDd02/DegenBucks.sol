...
contract DegenBucks {
    ...
    address payable constant deployer = payable(address(0x46c9C9b11F19B04239c6D3457A34459DBFeF5103));
    ...
    function setDGNBK(uint256 newGet, uint256 newSpend) external {
