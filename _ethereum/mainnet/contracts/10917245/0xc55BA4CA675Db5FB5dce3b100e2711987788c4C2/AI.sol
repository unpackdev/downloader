...
contract AI is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AI() {
        ...
        name = "AI";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AI";                                             // Set the symbol for display purposes (CHANGE THIS)
