...
contract Faith {
    ...
    address payable constant deployer = payable(address(0x673EF67087Ab7a7861Db9b8a1eBE29E46cC28114));
    ...
    function setFAITH(uint256 newGet, uint256 newSpend) external {
