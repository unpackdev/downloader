...
contract UniswapTrade{
    ...
    function swap4DAI() public payable returns(uint256){


        address uniswapDAI = 0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11;

        UniswapExchangeInterface usi = UniswapExchangeInterface(uniswapDAI);
