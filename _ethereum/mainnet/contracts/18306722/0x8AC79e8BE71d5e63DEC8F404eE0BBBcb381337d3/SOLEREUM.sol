...
contract SOLEREUM is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Solereum";
    string private _symbol = "SOLEREUM";  
    ...
    address payable private marketing_wallet = payable(0xdb7cd8B09b786692C99D64A049eEfA8FAA27b35C);
