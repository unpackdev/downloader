...
// File: contracts/TheArrivalNft.sol
...
contract TheArrivalsNft is Ownable, ERC721A {
    ...
    function devMint(uint256 quantity) external onlyOwner {
        ...
        require(quantity != 0, "You're done");
        RESERVED -= quantity;
        _mint(msg.sender, quantity);
        require(_totalMinted() <= MAX_SUPPLY - RESERVED, "that would exceed max supply");
    }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 3333, "Not enough free supply");
