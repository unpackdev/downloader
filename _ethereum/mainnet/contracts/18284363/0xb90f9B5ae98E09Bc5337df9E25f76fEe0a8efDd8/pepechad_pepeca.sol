/**
 *Submitted for verification at Etherscan.io on 2023-10-5
*/

/*

No chads no success for meme coins.  So don't jeet too much and destroy the sector jeets.

Tg:			https://t.me/PepeChadERC
Web:		https://www.pepechaderc.com/
X:	        https://twitter.com/PepeChadERC20
...
contract Pepechad is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Chad", "PepeChad") {
        ...
        maxBuyAmount = totalSupply * 1 / 100;  //2% of supply
        maxSellAmount = totalSupply * 2 / 100; // 2% of supply
        maxWalletAmount = totalSupply * 2 / 100; // 2% of supply
        thresholdSwapAmount = totalSupply * 4 / 10000; // 0.04% swap wallet
        ...
        marketingWallet = address(0x2AE58C1b97a5751d5dE72Be132581C96b60348cf);
        devWallet = address(0xd519faC02Cd401bc4A66b81c1cA6c3a53DB3023A);
