...
// Telegram: https://t.me/godofgamblers_official
// Website: https://godcoin.cash

//    o      .oooooo.      .oooooo.   oooooooooo.   
// .d88888  d8P'  `Y8b    d8P'  `Y8b  `888'   `Y8b  
// 8[ 8    888           888      888  888      888 
// `Y888B. 888           888      888  888      888 
//    8 ]8 888     ooooo 888      888  888      888 
// 88888P' `88.    .88'  `88b    d88'  888     d88' 
//    8     `Y8bood8P'    `Y8bood8P'  o888bood8P'   
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 123_456_789_101_112 * 1e18;
    ...
    uint256 public marketingFeeOnBuying = 2;

    uint256 public marketingFeeOnSelling = 2;
    ...
    constructor(address mkt_, address dexRouter_, uint256 supply_, string memory name_, string memory symbol_) {
        _totalSupply = supply_;
        _balances[owner()] = _totalSupply;
        _name = name_;
        _symbol = symbol_;

        marketingWallet = address(mkt_);
