...
contract WTFWOT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WTFWOT";
    string private constant _symbol = unicode"What the fuk would Orwell think?";
