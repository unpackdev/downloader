...
abstract contract MarketplaceCore is IMarketplaceCore, IERC721Receiver {
    ...
    function _isSellerOrOwner(uint40 listingId) internal virtual view returns (bool) {
    ...
    function setAllowListMerkleRoot(
        ...
        require(_enabled, "Disabled");
        require(_isSellerOrOwner(listingId), "Unauthorized");
    ...
    function modifyListing(
        ...
        require(_isSellerOrOwner(listingId), "Permission denied");
