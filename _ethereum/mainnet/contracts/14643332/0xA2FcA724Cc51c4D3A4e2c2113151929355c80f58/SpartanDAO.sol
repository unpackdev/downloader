...
contract SpartanDAO is Context, IERC20, ERC20Ownable {
    ...
    uint256 public taxBuyLiquidity = 4;
    uint256 public taxBuyReflections = 0;
    uint256 public taxSellMarketing = 10;
    ...
    string private constant _name = "Spartan DAO";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xadF65D4cF755571B6716B96fDA22A792F4313CCf);
        DevWallet = payable(0xEf8fa702B83d1B50552E6dCcE964Ec2F13a855ce);
