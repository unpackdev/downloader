/**
Let's bring Crypto back to where it all began and reboot the the Bullrun. Check the Marketing Wallet ;)
...
contract SHIBA2 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SHIBA INU 2.0";
    ...
    address payable private _developmentAddress = payable(0x1Af53597160D3F78D8261Ae008Ae5c4390FE952D); 
    address payable private _marketingAddress = payable(0xB339c0363c3df76A4E03c6fD51de9FCE50675C1B);
