...
contract ZZZETHMigrationPool is LPTokenWrapper, Ownable {
    using SafeERC20 for IERC20;

    IERC20 public rewardToken;
    IERC20 public multiplierToken;
    IERC20 public zzzethV2;
    ...
    function setNAPV2address(address _napv2address) external onlyOwner {
    ...
    - ZZZV2/ETH LP Token is created by adding liquidity on Uniswap
    - Transfer the LP tokens to the contract
    */

    function migrationFinish(address _zzzethV2, address _napv2)
        public
        onlyOwner
    {
        // Sets the ZZZV2/ETH address
        zzzethV2 = IERC20(_zzzethV2);
    ...
    function withdraw(uint256 amount) public override {
        ...
        zzzethV2.safeTransfer(msg.sender, amount);
