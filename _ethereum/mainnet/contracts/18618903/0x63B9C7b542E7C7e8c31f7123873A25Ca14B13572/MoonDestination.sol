...
contract MoonDestination {
    ...
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    constructor(){
        uint _supply = 38_440_000*10**_DECIMALS; // starting total supply
        _mint(msg.sender,_supply); // mint totalSupply, will never be used again
    }
    ...
    /*                         CONSTANTS                          */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    string public constant _NAME = "MoonDestination";
    string public constant _SYMBOL = "MODE";
    ...
    ///
    /// Emits a {Transfer} event.
    function _burn(uint256 amount) public {/* address from,  */
