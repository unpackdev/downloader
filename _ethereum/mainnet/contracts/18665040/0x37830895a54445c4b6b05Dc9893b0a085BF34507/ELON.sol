...
contract Elon is ERC20, Ownable {
    ...
    constructor() ERC20("Elon Musk", "ELON") {
        ...
        marketingWallet = address(0x2112FCf4472490208Ab38e6B40372db7Fa5c6791); // set as marketing wallet
        devWallet = address(0x2112FCf4472490208Ab38e6B40372db7Fa5c6791); // set as dev wallet
