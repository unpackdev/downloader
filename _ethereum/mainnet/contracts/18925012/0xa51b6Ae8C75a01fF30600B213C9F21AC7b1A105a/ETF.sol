...
contract ETF is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _symbol = "ETF";
        _decimals = 18;
        _owner = 0x6096fcDa77a94bE2fd1Cc2479Fa398dfDdd35Fe8;
        _totalSupply = 200000000  * 10 ** _decimals;
        marketingWalletAddress = payable(0x6096fcDa77a94bE2fd1Cc2479Fa398dfDdd35Fe8);
    ...
    function setNumToken(address newLimit) external onlyOwner() {
