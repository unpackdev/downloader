...
contract VLINK is ERC20, Ownable {
    ...
    constructor() payable ERC20("VITALINK", "VLINK") {
       ...
       buyOperationsFee = 3;
        ...
        operationsAddress1 = address(0x3371986e6A20bbd74aafb6ff2F27aaADDe64Fc95); //80%
        operationsAddress2 = address(0x3371986e6A20bbd74aafb6ff2F27aaADDe64Fc95); //20%
        lpReceiverAddress = address(0x3371986e6A20bbd74aafb6ff2F27aaADDe64Fc95);
