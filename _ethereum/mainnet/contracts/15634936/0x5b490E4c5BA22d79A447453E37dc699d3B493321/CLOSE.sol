...
// Seek to maximize empathy
// https://medium.com/@CLOSERC20
...
contract CLOSE is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Alt-F4";
    string private constant _symbol = "CLOSE";
