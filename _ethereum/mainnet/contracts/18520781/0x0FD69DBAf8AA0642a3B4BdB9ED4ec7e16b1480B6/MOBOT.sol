...
/*
Pooling all users' bribe funds into ONE single bribe to snipe.
Snipe at the lowest price with the least bribery fee. 💸
LAUNCH SOON 🔫 → $banana


Website  - https://www.monopolybot.guru/
Twitter  - hhttps://twitter.com/MonopolyBots
...
contract MOBOT is Context, IERC20, Ownable {
    ...
    string private _name = "MonopolyBot";
    string private _symbol = "MOBOT";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x019b66006e15627cCf40ef2b334B4B8357A57f86);
