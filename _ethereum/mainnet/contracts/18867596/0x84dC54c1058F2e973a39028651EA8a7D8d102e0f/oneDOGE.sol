...
contract oneDOGE is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0x5595829783076e408110B34B4baa2E5b6fc5A30c;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 1202 * 10**_decimals;
        marketingWalletAddress = payable(0x5595829783076e408110B34B4baa2E5b6fc5A30c);
    ...
    bool private tradingOpen;  bool private swapEnabled = false;
