...
// ██      ██ ███████ ██   ████ 
// https://msncoin.pro/
// https://twitter.com/MSNcoin_
// https://t.me/MSNportal
...
contract MSN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 199500000 * 10**_decimals;
    string private constant _name = unicode"MSN coin";
    ...
    function SendEmail() external onlyOwner() {
