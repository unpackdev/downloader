...
contract PSYCHO is Ownable, ERC20 {
    bool public limited;
    uint256 public maxHoldingAmount;
    address public taxCollector;
    address public uniswapV2Pair;
    uint256 public tradingStartTimeStamp;
    uint256 public constant startingTax = 15;
    uint256 public constant taxDuration = 5 minutes;
    mapping(address => bool) public blacklists;

    constructor(uint256 _totalSupply, address _taxCollector) ERC20("Patrick Bateman", "PSYCHO") {
