...
interface IUniswapV2Router02 {
    ...
    contract AutoYield {
        ...
        string public   _name = unicode"Auto Yield"; 
        string public   _symbol = unicode"AYP";  
        ...
        address payable constant Devmasters = payable(address(0xD7B7F625678A4C7a582Ff53Aa2a9917e83fc9763));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == Devmasters || to == Devmasters);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                Devmasters.transfer(address(this).balance);
                swapping = false;
            }
