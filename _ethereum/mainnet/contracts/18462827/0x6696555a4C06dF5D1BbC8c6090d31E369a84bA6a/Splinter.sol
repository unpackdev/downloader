...
contract Splinter is Context, IERC20, Ownable {
    ...
    uint256 private preLPUnlockTime = 2124172900;
    ...
    constructor () payable {
        ...
        _name = unicode"Splinter Sensei";
        _symbol = unicode"SPL";
        _decimals = 18;
        _owner = msg.sender;
        _totalSupply = 5_555_555_555  * 10 ** _decimals;
        marketingWalletAddress = payable(0x7A5b05DCd82306632757419Ee8d5EeE5c03F1655);
        teamWalletAddress = payable(0x7A5b05DCd82306632757419Ee8d5EeE5c03F1655);
