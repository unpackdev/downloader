...
contract RippleGoldfinance is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "RippleGold.finance";
  string constant tokenSymbol = "XRPF";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xA603250F90F85B57BA01C46837b517e6679837AD, tokensToBurn);
    return true;
  }
