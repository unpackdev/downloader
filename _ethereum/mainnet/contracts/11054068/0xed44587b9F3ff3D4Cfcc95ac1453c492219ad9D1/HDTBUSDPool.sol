...
contract HDTTokenWrapper {
    ...
    //BUSD
    IERC20 public stakeToken = IERC20(0x4Fabb145d64652a948d72533023f6E7A623C7C53); 
 ...
 * HDT-BUSD Pool
 */
contract HDTBUSDPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-BUSD-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-BUSD-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-BUSD-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-BUSD-POOL: Pool is closed");
        _;
    }
