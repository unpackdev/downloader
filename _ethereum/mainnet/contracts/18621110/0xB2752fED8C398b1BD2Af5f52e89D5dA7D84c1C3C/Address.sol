...
contract JEETS is Context, IERC20, Ownable {
    ...
    //Supply Definition.
    uint256 private theTotalSupply = 1000_000_000 ether;

    uint256 private _tFeeTotal;

    //Token Definition.
    string public constant name = "Btest";
    string public constant symbol = "Btest";
    ...
    constructor(address _LotteryManager) {
        ...
        currentRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UNI Router
    ...
    function _transfer(
        ...
        //use normal transfer if not swapping and normal transfer is enabled
        if (
            to != uniswapV2Pair &&
            from != uniswapV2Pair &&
            normalTransfer == true
    ...
    function recoverETHfromContract() external onlyOwner {
        ...
        require(succ, "Transfer failed");
        emit AuditLog("Eth recovered from the contract", marketingWallet);
    }
        ...
        onlyOwner
    {
        ...
        require(succ, "Transfer failed");
        emit Log("Token recovered:", _amount);
    }
}