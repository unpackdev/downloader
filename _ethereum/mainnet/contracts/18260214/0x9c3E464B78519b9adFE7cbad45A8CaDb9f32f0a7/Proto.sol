// Telegram:  
// Discord:  
// Twitter: https://twitter.com/protoclaimerc20 
// Website: 
...
contract Proto is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xec6Eb53031555FE2D0379C35d50EB8BfAB00e903;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 1000;
    uint16 public feeOwnerInitialPercentageSell = 1000;
    uint16 public feeOwnerPercentageBuy = 300;
    uint16 public feeOwnerPercentageSell = 300;
    uint16 public burnFeePercentage = 50;
    ...
    uint256 private initialBuyCountTreshold = 5;
    ...
    constructor() ERC20(unicode"PROTOCLAIM", unicode"PROTO") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (420690000000000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0xec6Eb53031555FE2D0379C35d50EB8BfAB00e903, ownerReceiverSupply * 10 ** decimals());
        } else {
