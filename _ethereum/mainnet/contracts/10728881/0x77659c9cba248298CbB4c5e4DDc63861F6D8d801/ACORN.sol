...
string public name = "The acorn";
string public symbol = 'ACORN';
...
name = "The acorn"; // Set the name for display purposes
symbol = "ACORN"; // Set the symbol for display purposes
}
...
contract ACORN is owned, TokenERC20 {
