...
contract ABBLegacy is MintpassValidator, ERC721A, ERC2981, Ownable {
    ...
    address internal complimentaryAddress =
        0xC16157e00b1bFf1522C6F01246B4Fb621dA048d0; // Wallet that has a reduced Fee for FIAT Payments
    ...
    function setComplimentaryFee(
        ...
        require(
            _complimentaryFeePercentage < 1001,
            "To Big"
        );
