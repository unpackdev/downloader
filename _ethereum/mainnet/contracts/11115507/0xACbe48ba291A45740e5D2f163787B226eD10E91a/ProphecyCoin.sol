...
/**
 *The total amount of predicted coins is 4300
 */
...
contract ProphecyCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Prophecy coin";
string constant tokenSymbol = "POC";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 4300000000000000000000;
