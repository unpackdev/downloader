...
contract CryptoBlackCrows is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
      ...
      _safeMint(0x0934e7A76783b701FfDFF11B9c62923837dF35F6, 1);
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool os, ) = payable(0x0934e7A76783b701FfDFF11B9c62923837dF35F6).call{
        value: (contractBalance * 33) / 100
    }("");
    (bool gs, ) = payable(0x0934e7A76783b701FfDFF11B9c62923837dF35F6).call{
        value: (contractBalance * 33) / 100
    }("");
