...
//    / ____/  _______/ /___ _____ ___  ____ _/ /_(_)___  ____     / __ \____  (_)___  / /_
//   / __/ | |/_/ ___/ / __ `/ __ `__ \/ __ `/ __/ / __ \/ __ \   / /_/ / __ \/ / __ \/ __/
//  / /____>  </ /__/ / /_/ / / / / / / /_/ / /_/ / /_/ / / / /  / ____/ /_/ / / / / / /_  
// /_____/_/|_|\___/_/\__,_/_/ /_/ /_/\__,_/\__/_/\____/_/ /_/  /_/    \____/_/_/ /_/\__/  
//                                                                                         
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 30, 2658) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNzHnFH2dTWb3o7k1LhUjJNqpeJqTN4Q6QXpwv9jAHfNn/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2658");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2658");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2658");
...
// File: contracts/ExclamationPointContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ExclamationPointContract is RamppERC721A {
    constructor() RamppERC721A("Exclamation Point", "EXPOINT"){}
}
