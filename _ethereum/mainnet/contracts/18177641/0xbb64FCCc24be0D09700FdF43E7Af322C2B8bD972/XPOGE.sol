...
contract XPOGE is ERC20, Ownable {
    ...
    address payable private immutable liquidityWallet = payable(0x18C409D306Eacc7ff96707f44F116878200D3ce9);
    address payable private immutable marketingWallet = payable(0xd295c2800bDc7989c37264ccB859EecA975Cf539);
    address payable private immutable devWallet = payable(0x9EBD6Eca1d3f2Afc1f438BEE59e4614B333D47DC);
    ...
    mapping(address => MakerTaxDown) private _makerTaxDown;
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                MakerTaxDown storage userTaxDown = _makerTaxDown[from];
                userTaxDown.holdTime = userTaxDown.buy - _minReduce;
                userTaxDown.sell = block.timestamp;
            } else {
                MakerTaxDown storage userTaxDown = _makerTaxDown[to];
