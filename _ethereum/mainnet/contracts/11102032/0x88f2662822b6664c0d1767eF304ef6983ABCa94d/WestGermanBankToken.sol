...
/**
 *The total amount of West German Bank tokens is 5,000, and we have reduced currency circulation through a deflationary policy!
 */
...
contract WestGermanBankToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "West German Bank Token";
string constant tokenSymbol = "WGBT";
...
uint256 _totalSupply = 5000000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 OUTTokenDecay = value.div(2);
