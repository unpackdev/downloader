...
contract DigiWitch  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeiadloo4v5bw2ahdd7y4fd5re4clrbr2rcuyepwuwc4kec4ifn537m/";

    uint256 public immutable mintPrice = 0.002 ether;
    uint32 public immutable maxSupply = 2100;
    uint32 public immutable maxPerTx = 5;

    address public freecollectionAddress;
    ...
    constructor()
    ERC721A ("DigiWitch", "DW") {
        setfreecollectionAddress(0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85);
    }
    ...
    function setfreecollectionAddress(address _newAddress) public onlyOwner {
        freecollectionAddress = _newAddress;
    }
    ...
    function PublicMint(uint256 amount) public payable callerIsUser{
        ...
        IERC721 token = IERC721(freecollectionAddress);
