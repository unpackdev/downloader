...
Twitter: https://twitter.com/OkamiERC_
...
contract OKAMI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"大神";
    ...
    address payable private _developmentAddress = payable(0xb651E51dAE111Ed2003eCE74e72952148a38fdA4);
    address payable private _marketingAddress = payable(0xb651E51dAE111Ed2003eCE74e72952148a38fdA4);
