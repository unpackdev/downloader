...
contract YUANNT is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 888 *18;
    ...
    constructor() BEP20("YUANNT", "YUANNT") {
        _tokengeneration(msg.sender, 888 *10 **decimals());
