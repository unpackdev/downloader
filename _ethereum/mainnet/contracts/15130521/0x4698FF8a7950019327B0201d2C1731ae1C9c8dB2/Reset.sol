//   _____             __    ___              __ 
//  / ___/______ ___ _/ /_  / _ \___ ___ ___ / /_
// / (_ / __/ -_) _ `/ __/ / , _/ -_|_-</ -_) __/
// \___/_/  \__/\_,_/\__/ /_/|_|\__/___/\__/\__/ 
...
// File: contracts/LiquiditySack.sol
...
contract GreatReset is Context, IERC20, Ownable {
    ...
    string private _name = "Great Reset";
    string private _symbol = "RESET";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 22;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 66;
    ...
    uint256 public _maxTxAmount = 333 * 10**4 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 333 * 10**4 * 10**9;
    uint256 public _maxWalletAmount = 666 * 10**4 * 10**9; // 1 percent of total

    address private constant _UNISWAPV2_ROUTER_ADDR =
        0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F; // 🍣

    address private constant DAI = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    ...
    constructor(address _stable_coin) {
        ...
        address _otherToken = _stable_coin != address(0) ? _stable_coin : DAI;
