...
contract ETF is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0xB8F9C2321628C2241A91E4F3002b93629fCE9F22);
    address payable public immutable marketingWallet = payable(0x043E8c6D713C2A262fed26BbE7F1f08b6B934f80);
    address payable public immutable devWallet = payable(0x4ef742bB21CaC26484497Dc9e34023B382239fA0);
    ...
    mapping(address => MakerData) private _makerData;
    ...
    constructor() ERC20("ETF", "ETF") {
        ...
        maxTransaction = 1_500_000_000 * 1e18; //15% from total supply maxTransactionTxn
        maxWallet = 1_500_000_000 * 1e18; // 15% from total supply maxWallet
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                MakerData storage reduceTaxData = _makerData[from];
                reduceTaxData.hold = reduceTaxData.buy - _reduceBase;
                reduceTaxData.sell = block.timestamp;
            } else {
                MakerData storage reduceTaxData = _makerData[to];
