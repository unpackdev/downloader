...
$GG - The first lesbian backed memecoin coming to you! Make sure to tune in to the live stream at youtube.com/GGCoinERC

COME WATCH US LIVE: https://www.youtube.com/@GNGCOINERC

https://girlongirl.xyz

https://t.me/ggcoinerc
https://twitter.com/GGCoinErc

*/

contract GG is ERC20("Girl on Girl Live Stream", "GG"), Ownable {
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amt must be greater than zero");
        require(
            !isearlybuyer[sender] && !isearlybuyer[recipient],
            "You cant transfer tokens"
        );
