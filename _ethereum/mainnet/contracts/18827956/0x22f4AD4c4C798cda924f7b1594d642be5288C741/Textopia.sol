...
contract Textopia is ERC20, Ownable {
    ...
    constructor () ERC20("Textopia", "TXT") 
    {   
        address newOwner = 0x20985Ae611A63E23908F2D3bF1Fe4563338806D7;
        ...
        taxWallet = 0xfb3cF1744E06434715F41d5645281CC91c618078;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        
        uint256 totalSupply = 100e6 * (10 ** decimals()); // 100 million
    ...
    function updateBuyTax(uint256 _buyTax) external onlyOwner {
        require(_buyTax <= 10, "Buy Tax cannot be more than 10%");
        buyTax = _buyTax;
        emit UpdateBuyTax(buyTax);
    }

    function updateSellTax(uint256 _sellTax) external onlyOwner {
        require(_sellTax <= 10, "Sell Tax cannot be more than 10%");
        sellTax = _sellTax;
