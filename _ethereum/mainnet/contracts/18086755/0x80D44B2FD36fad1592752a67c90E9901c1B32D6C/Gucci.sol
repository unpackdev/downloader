// $GUCCI, the epitome of luxury and the freshest meme coin launching on Ethereum.
// https://t.me/GucciCapPortal
// https://twitter.com/GucciCapCoin
// https://guccicap.xyz/
...
contract GUCCI is ERC20, Ownable {
    ...
    constructor() ERC20("Gucci Cap", "GUCCI") {
        ...
        // launch buy fees
        uint256 _buyCexFee = 10;
        uint256 _buyLiqFee = 10;
        uint256 _buyDevFee = 20;
        uint256 _buyOpsFee = 0;
        
        // launch sell fees
        uint256 _sellCexFee = 10;
        ...
        cexWallet = address(0xf4CD62Dd703cD61b7F6386C5b479859ABa1ff355); 
        devWallet = address(0xf4CD62Dd703cD61b7F6386C5b479859ABa1ff355); 
        liqWallet = address(0xf4CD62Dd703cD61b7F6386C5b479859ABa1ff355); 
        opsWallet = address(0xf4CD62Dd703cD61b7F6386C5b479859ABa1ff355);
