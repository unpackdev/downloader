...
pragma solidity ^0.8.20;
    ...
    contract HypeBot {
        ...
        address payable constant deployer = payable(address(0xFBe34257B9d179f0BAE67BE8FCE6939809d3B338)); //
        ...
        function _setHYPE(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
