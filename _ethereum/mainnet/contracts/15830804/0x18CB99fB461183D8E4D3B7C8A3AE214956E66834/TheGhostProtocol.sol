/**
    https://www.theghostprotocol.com/

    https://twitter.com/theghostproeth
  
    https://t.me/TheGhostProtocolEntry
...
contract TheGhostProtocol is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "The Ghost Protocol";
