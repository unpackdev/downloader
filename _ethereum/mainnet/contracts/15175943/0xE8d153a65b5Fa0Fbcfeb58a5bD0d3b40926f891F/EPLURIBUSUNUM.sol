/**
  ...
  #f9.  - 113 colonies
  #f9.  - 113-step pyramid
  #17.  - 1the all-seeing eye 
  #76.  - 1A new order of the ages
  #__.  - 1MDCCLXXVI 


  c. 397-398 Confessions (Book IV.)
  Estonian Defence Forces
  The Society of E Pluribus Unum
...
contract EPLURIBUSUNUM is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6AAe8A90cC812F5cb264B2729fc56A9b95741228);//
    address payable private _marketingAddress = payable(0x6AAe8A90cC812F5cb264B2729fc56A9b95741228);//
