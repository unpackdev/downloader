...
contract NFT is 
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlEnumerable, LazyMintERC721CInitializable, ImmutableMinterRoyaltiesBase) returns (bool) {
