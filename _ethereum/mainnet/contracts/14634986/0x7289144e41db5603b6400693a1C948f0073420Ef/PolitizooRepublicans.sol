...
contract PolitizooRepublicans is ERC721A {

    /// @notice 0.25 ether OR 250000000000000000 wei
    uint256 public constant MINT_COST = 0.25 ether;
    uint256 private constant MAX_NFTS_FOR_SALE = 4500;
    ...
    constructor(address payable _daoWallet) ERC721A("Politizoo Rupublicans", "POZO", MAX_MINT_PER_TRANSACTION) {
      daoWallet = _daoWallet;
      developerWallet = msg.sender;
      baseURI = "ipfs://Qme8aJnzJXYktMyRRYYSivYpD3jivyFw4gp2bX8ANaxy7X/";
    }
    ...
    function bulkAirdrops(address[] calldata _to, uint256[] calldata _amount) public onlyOwner{
