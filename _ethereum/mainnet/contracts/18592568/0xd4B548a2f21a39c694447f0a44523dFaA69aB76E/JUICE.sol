...
// this is a MOCK
contract JUICE is ERC20Upgradeable {
    function initialize(string memory name_, string memory symbol_) public initializer returns (bool) {
        __ERC20_init(name_, symbol_);

        _mint(msg.sender, 500_000_000 * 1e18); // mint 500M to deployoooor
        return true;
    }
}