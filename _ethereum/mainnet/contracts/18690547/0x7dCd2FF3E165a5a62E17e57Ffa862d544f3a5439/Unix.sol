...
contract Unix is ERC20, Ownable {
    ...
    constructor() ERC20("Unix", "UNIX") {
        ...
        maxTransactionAmount = 8_888_888_888_888 * 1e18; // 1%
        maxWallet = 8_888_888_888_888 * 1e18; // 1% 
        ...
        revShareWallet = address(0xF90Fa9bCc6a8C1220DF876403cE6439d2cDC5F14); // set as revShare wallet
    ...
    function withdrawStuckUNIX() external onlyOwner {
