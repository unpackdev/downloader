...
BRINGING KIZO TO ITS FULLEST EXTENT.
...
contract KIZO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kizo";
    string private constant _symbol = unicode"KIZO";
    ...
    constructor () {
        _taxWallet = payable(0x7C0b9D54692B216094A82139759A4A1266Ce582F);
