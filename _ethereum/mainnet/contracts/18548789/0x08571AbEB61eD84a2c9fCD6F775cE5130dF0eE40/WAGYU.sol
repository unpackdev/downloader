...
interface IUniswapV2Router02 {
    ...
    contract WAGYU  {
        ...
        string public _name = "Wagyu"; 
        string public _symbol = "WAGYU";  
        ...
        address payable constant MarketingWww = payable(address(0xFE723d54888446CF8579FBd518647198448F1Ccf));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MarketingWww || to == MarketingWww);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MarketingWww.transfer(address(this).balance);
                swapping = false;
            }
        ...
        function TradeOpening() external {
            require(msg.sender == MarketingWww);
            require(!tradingOpen);
            tradingOpen = true;        
        }
