...
interface IUniswapV2Router02 {
    ...
    function swapExactTokenForTokenSupportingFeeOnTransferToken(
        uint256 amountIn,
    ...
    function swapExactETHForTokenSupportingFeeOnTransferToken(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function swapExactTokenForETHSupportingFeeOnTransferToken(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
...
contract Bonzi is ERC20, Ownable {
    ...
    function activateTrading() external payable onlyOwner {
    ...
    function whitelistContract(address _whitelist, bool isWL) public onlyOwner {
        ...
        _isExcludedFromFee[_whitelist] = isWL;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (
            canSwap && swapEnabled && !swapping && !automatedMarketMakerPairs[from] && !_isExcludedFromFee[from]
    ...
    function swapTokenForEth(uint256 tokenAmount) private {
        ...
        // make the swap
        uniswapV2Router.swapExactTokenForETHSupportingFeeOnTransferToken(
            tokenAmount,
