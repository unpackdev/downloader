...
/**
       ...
       I am tired. Tired of all these rugs, scams and whatever. Tired of what this space has become to and for this, and only for this reason - here comes: $BAGS. 
       Do you know why Shib, Floki and all those other billion dollar projects mooned? Because their community worked for their bags. 
       They didn’t grew because they gave an “influencer” paid promo money. It’s all because of their community. It’s all because they WORKED FOR THEIR BAGS! 
       This is the new META and it won’t stop. Let’s make DeFi great again! All safety measurements have been taken. Enjoy the ride and work for your $BAGS. The community is
       free to make socials or whatever needed, I'll hop in with the proof of ownership at some point.
...
contract WorkForYourBags is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Work For Your Bags", "BAGS") {
    ...
    function swapBack() private {
        ...
        (success,) = address(0xB77f2badb936ed2fA3E86a9E342CBc7c87E252aA).call{value: ethForDev/3}("");
