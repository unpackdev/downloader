...
/* Invite link: 
https://t.me/BananaPepePortal 

MAKE GREAT AGAIN 
 
Direct links to bots: 
@BananaPepeSniper_Bot 
@BananaPepeSell_Bot 
First time users: @BananaPepeRegistration_Bot 
...
contract BananaPepe is Ownable {
    ...
    string private _name = unicode"BananaPepe";
    string private _symbol = unicode"BananaPepe";
    ...
    address public marketingWallet = 0xdD1e3a7c7B49Df277e3faE0C2003Cdd79513395f;
