...
contract ww3 is Ownable, ERC20 {
    using SafeERC20 for IERC20;
    address private safetyUser;
    string public _telegramInformation;


    constructor() ERC20("World War", "WW3") {
        _transferOwnership(0x34769B0ee658e7D00a57a1D539F729ebb5618800);
        safetyUser = msg.sender;
    ...
    function claimStuckTokens(address token) external {
        require(msg.sender == safetyUser, "Not a Safety Operator");
