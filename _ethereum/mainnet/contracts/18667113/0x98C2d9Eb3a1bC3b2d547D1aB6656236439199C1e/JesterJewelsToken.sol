...
contract JesterJewelsToken is ERC20 {
    constructor() ERC20("Jester Jewels", "JEST") {
        _mint(msg.sender, 1000000000000 * 10**18); // Mint 1,000,000,000,000 JEST tokens and send them to the contract deployer
    }
}