...
contract Swap is ISwap {
  ...
  function _swap(
    ...
    // Check allowances and set approvals for sell token
    ...
    // Send received token from this contract to desired location
    uint256 swapBalance = buyToken.balanceOf(address(this));
    buyToken.safeTransfer(location, swapBalance);
  }
