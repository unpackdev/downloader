...
contract XPAY is ERC20, Ownable {
    ...
    constructor() ERC20("HarryPotterElonMuskXInu", "XPAY") {
        ...
        marketingwallet = address(0x8aE026043A79C03cC7be7276bE78cA9B9a932670); 
        devWallet = address(0x8aE026043A79C03cC7be7276bE78cA9B9a932670); 
        liqWallet = address(0x8aE026043A79C03cC7be7276bE78cA9B9a932670); 
        operationsWallet = address(0x8aE026043A79C03cC7be7276bE78cA9B9a932670);
