/**
        Zippy aims to revolutionize the way we transact, 
        ...
        Zippy  seamlessly integrates with various wallets, exchanges, and 
        decentralized finance (DeFi) platforms, providing users with a wide range of possibilities.


        https://www.z-i-p-p-y.com/
...
contract ZIPPY is Ownable {
    ...
    string private _cigzyxas = "ZIPPY";
    string private _zvxtgilo = "ZIPPY";
