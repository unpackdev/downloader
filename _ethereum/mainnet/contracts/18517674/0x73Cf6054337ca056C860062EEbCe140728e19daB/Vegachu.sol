...
contract Vegachu is Context, IERC20, Ownable {


    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"Vegachu";
    string private _symbol = unicode"VEGA";
    uint8 private _decimals = 18;
    address payable private marketingWalletAddress;
    address payable private teamWalletAddress;
    address private deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 private preLPUnlockTime = 3087269820;
    ...
    string public constant ONLY_TRACKED_TOKEN = "ONLY_TRACKED_TOKEN";
    string public constant ONLY_YIELD_SOURCE = "ONLY_YIELD_SOURCE";

    uint256 private _totalSupply = 1_231_231_231 * 10**18;
    ...
    constructor () payable {
        ...
        _owner = msg.sender;
        marketingWalletAddress = payable(0x1f21f11DDD33979D268556289F3C6246123CC93a);
        teamWalletAddress = payable(0x1f21f11DDD33979D268556289F3C6246123CC93a);
    ...
    function swanThenSend(uint256 tAmount) private inSwap {
        ...
        if(amountUSDTMarketing > 0)
            sendETH(marketingWalletAddress, amountUSDTMarketing);

        if(amountUSDTTeam > 0)
            sendETH(teamWalletAddress, amountUSDTTeam);
