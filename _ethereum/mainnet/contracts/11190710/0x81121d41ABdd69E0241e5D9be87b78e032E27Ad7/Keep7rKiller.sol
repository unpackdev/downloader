...
contract Keep7rKiller is StandardToken {

  string public constant name = "Keep7r Killer";
  string public constant symbol = "KPRK";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 78231 * (10 ** uint256(decimals));
