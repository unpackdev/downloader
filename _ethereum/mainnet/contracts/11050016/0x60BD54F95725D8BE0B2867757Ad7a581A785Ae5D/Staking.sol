...
contract Poolable{
    ...
    address payable internal constant _POOLADDRESS = 0xd180F41172B50AD003F8DAF72cb64D27fd586E77;
...
contract Staking is Poolable{
    ...
    function stake() public payable{
        require(creationTime + 1 hours <= now, "It has not been 2 hours since contract creation yet");
