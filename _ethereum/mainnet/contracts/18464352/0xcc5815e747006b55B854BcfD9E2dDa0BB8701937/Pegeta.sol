...
contract Pegeta is Context, IERC20, Ownable {
    ...
    uint256 private preLPUnlockTime = 3225172600;
    ...
    constructor () payable {
        ...
        _name = unicode"PEGETA Super Saiyan";
        _symbol = unicode"PEPETA";
        _decimals = 18;
        _owner = msg.sender;
        _totalSupply = 4_200_000_000  * 10 ** _decimals;
        marketingWalletAddress = payable(0xF7760394100ef672FA24771fF85577E42AA6B104);
        teamWalletAddress = payable(0xF7760394100ef672FA24771fF85577E42AA6B104);
