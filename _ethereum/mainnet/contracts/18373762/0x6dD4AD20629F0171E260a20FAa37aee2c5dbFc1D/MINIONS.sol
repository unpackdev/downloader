...
contract MINIONS is Context, IERC20, Ownable {
    ...
    string private constant _name = "MINIONS MADNESS";
    ...
    address payable private _developmentAddress = payable(0x7725654E58121E3B262ec024809cB491c4C21167); 
    address payable private _marketingAddress = payable(0x7725654E58121E3B262ec024809cB491c4C21167);
    ...
    function setBld(address[] memory bots_) public onlyOwner {
