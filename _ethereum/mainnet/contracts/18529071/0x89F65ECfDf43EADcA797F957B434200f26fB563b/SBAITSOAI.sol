/*
HELLO ANON, MY NAME IS DOCTOR SBAITSO.
...
contract SBAITSOAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sbaitso AI";
    string private constant _symbol = unicode"SBAITSO";
