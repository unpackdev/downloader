...
contract $Hilux is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xfFCE440bB5461Cb4fA95F1Ca4988Eec9c0527703);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0x312137812c562AfA484C0CDAD3215627464eA7EC;
    ...
    string private _name = "1988 Toyota Hilux";
    string private _symbol = "$Hilux";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 448003 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 1120 * 10**_decimals;
