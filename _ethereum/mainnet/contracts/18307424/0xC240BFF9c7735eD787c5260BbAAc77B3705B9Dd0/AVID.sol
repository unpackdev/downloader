...
contract AVID is ERC20, Ownable {
    ...
    constructor() ERC20("Avid Innovations", "AVID") {
        ...
        marketingWallet = address(0xca2f850B0e571DBD127116d8AeeC4Deb3C7A283B);
        devWallet = address(0xca2f850B0e571DBD127116d8AeeC4Deb3C7A283B);
