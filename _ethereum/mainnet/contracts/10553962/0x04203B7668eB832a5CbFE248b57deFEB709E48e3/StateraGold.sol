/*
*
*  STA GOLD deflationary index token smart contract
*
**/
...
contract StateraGold is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Statera Gold";
  string constant tokenSymbol = "STAG";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 11000000000000000000000000;
