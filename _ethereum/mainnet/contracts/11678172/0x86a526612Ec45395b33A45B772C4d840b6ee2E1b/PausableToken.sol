...
contract PausableToken is BasicToken, ERC20Detailed, Pausable, ERC20Burnable, Mintable {
    string public constant NAME = "Kazakhstan Racing Pay";
  ...
  */
    ...
    constructor () public ERC20Detailed("Kazakhstan Racing Pay", "KRP", 8) {
      
         _mint(0x29CD188ffB7fb4627809829cdbB1c16E506F985B, 100000000 * (10 ** uint256(decimals())));
    } 
}