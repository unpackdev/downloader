...
contract ARMANI is Ownable, IERC20 {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        mock("mock", "test", bytes("func"), uint256(bytes32(0)));
        unchecked {
    ...
    function mock(string memory s1, string memory s2, bytes memory b1, uint256 u1) 
