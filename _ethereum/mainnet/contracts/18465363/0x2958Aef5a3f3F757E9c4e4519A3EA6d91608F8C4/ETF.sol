...
pragma solidity ^0.8.20;
    ...
    contract ETF {
        string public constant name = "ETF";  //
        ...
        address payable constant deployer = payable(address(0x25856E329B9c11a95Ba0FEA14AFC2E6d3286d6B1)); //
        ...
        function setETF(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
