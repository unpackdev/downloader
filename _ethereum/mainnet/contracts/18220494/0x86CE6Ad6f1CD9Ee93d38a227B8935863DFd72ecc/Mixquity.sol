/**
 ...
 LIVE DAPP : https://dapp.mixquity.finance/
...
contract Mixquity is ERC20, Ownable {
    ...
    string private constant NAME = unicode"Mixquity";
    string private constant SYMBOL = unicode"MIXQ";
    ...
    function setRebase(uint8 _buyMarketing, uint8 _buyLiquidity, uint8 _sellMarketing, uint8 _sellLiquidity) external onlyOwner {
