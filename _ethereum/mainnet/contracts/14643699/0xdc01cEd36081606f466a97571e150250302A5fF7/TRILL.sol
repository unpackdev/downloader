/**
TRILL - Don't Let Go of the Memories
TWITTER - https://twitter.com/DLGOMTrill
*/
...
contract TRILL is smart, protected, ERC20 {
    ...
    string public constant _name = 'Dont Let Go of the Memories';
    string public constant _symbol = 'TRILL';
    ...
    address public marketing = payable(0xbBABb7645D6Afd33C1b76AeF9C224dd8E209F26E);
    ...
    uint8 public buy_tax = 5;
    uint8 public sell_tax = 5;
    uint8 public transfer_tax = 5;
