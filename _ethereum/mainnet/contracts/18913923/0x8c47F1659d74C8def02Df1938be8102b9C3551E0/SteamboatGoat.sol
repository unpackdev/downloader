...
contract SteamboatGoat is IERC721A { 
    ...
    string private constant _name = "Steamboat Goat";
    string private constant _symbol = "STEAMGOAT";
    string private _baseURI = "QmNuu73g2ETHPRhkEZbg64vYe55pfbtaaCMJ2TM575WQaS";
    ...
    function setConfig(uint256 _MAX_FREE) external onlyOwner{
        MAX_FREE = _MAX_FREE;
    }

    function reveal(string memory _base) external onlyOwner{
        _baseURI = _base;
    }
