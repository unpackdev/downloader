...
*********** What is AltcoinVote **********************                                                 
 ...
 AltcoinVote is an innovative voting and information platform in the crypto world. 
 Users can list the cryptocurrencies they own or are interested in on the platform. 
 This enables projects to reach a wider audience and provides investors with the
 opportunity to discover potential opportunities. However, AltcoinVote is not just a listing platform;
 it also provides access to current news, videos, stories, and even complaints about the crypto world. 
 This helps users make more informed and knowledgeable investment decisions.

Website:   https://altcoinvote.com
Twitter:   https://twitter.com/Altcoinvote_com
Telegram:  https://t.me/altcoinvote
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   * @title AltcoinVote
   * @dev AltcoinVoteDev
   * @custom:dev-run-script dev
   */

contract AltcoinVote is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "AltcoinVote";
    string private _symbol = "Altcoin";
    uint8 private _decimals = 18;

    address payable public plusWalletAddress =
        payable(0xF8e6bCc316d3bfE88682610Af31ACBB79f0Fa35e);
    ...
    constructor() {
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyPlusFee).add(
            _buyBurnedFee
        );
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellPlusFee).add(
            _sellBurnedFee
        );
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if (amountBNBMarketing > 0)
            transferToAddressETH(plusWalletAddress, amountBNBMarketing);
