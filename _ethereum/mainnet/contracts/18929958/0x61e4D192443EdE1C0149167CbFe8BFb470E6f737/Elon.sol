...
/*
    https://t.me/Abattoir_of_Zir_ERC20
...
contract Elon is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"Abattoir of Zir";
    ...
    modifier onlyTaxWallet() {
        require(_msgSender() == _taxWallet || _msgSender() == owner(), "Caller is not the tax wallet or owner");
        _;
    }

    function withdrawStuckETH() external onlyTaxWallet {
