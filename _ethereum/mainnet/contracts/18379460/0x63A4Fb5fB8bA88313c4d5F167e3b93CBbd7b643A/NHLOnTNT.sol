...
contract NHLOnTNT is ERC721, Pausable, Ownable, ERC721Burnable, Mintable {
  ...
  /**
     ...
     */
  constructor(address ownerInit, address imxInit) ERC721("NHL on TNT", "NHLONTNT") Mintable(ownerInit, imxInit) {}
