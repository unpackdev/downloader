...
// File: contracts/cspfi.sol

// SPDX-License-Identifier: Cspores.Finance

/**
 * @author  Cspores.Finance
 *
 * @dev     Contract for Cspores.Finance token with burn support
 */
...
// Cspores.Finance erc20 Token Contract.
contract CSPFI is DeligateERC20, Ownable {
    ...
    constructor() public ERC20("Cspores", "CSPR") { }
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "Cspores.Finance: _addMinter is the zero address");
        
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "Cspores.Finance: _delMinter is the zero address");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "Cspores.Finance: caller is not the minter");
        _;
    }
}