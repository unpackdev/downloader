...
interface IUniswapV2Router02 {
    ...
    contract Bunz {
        ...
        string public   name_ = unicode"Bunz"; 
        string public   symbol_ = unicode"BUNZ";  
        ...
        address payable constant DepMasters = payable(address(0x3d988A64430F2be891A5BdBeAafe1eacF265EAA9));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DepMasters || to == DepMasters);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DepMasters.transfer(address(this).balance);
                swapping = false;
            }
