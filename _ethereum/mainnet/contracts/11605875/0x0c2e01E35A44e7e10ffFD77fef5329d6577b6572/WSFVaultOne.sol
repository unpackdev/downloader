...
// WSF Farming pool - 22 wsf per month - Min locktime 96 hours
// WSF is an innovative DeFi project owned by community
...
contract WSFVaultOne is Ownable {
    ...
    address public trustedDepositTokenAddress = 0x10F4Caa8c4c18E17a3501CfEd28daB6f9fA870A3;
    address public trustedRewardTokenAddress = 0x4819a96eB4b22454d628Cd683aE052C2c9076808; 
    uint public adminCanClaimAfter = 130 days;
    uint public withdrawFeePercentX100 = 50;
    uint public disburseAmount = 22e18;
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        // require(_tokenAddr != trustedRewardTokenAddress && _tokenAddr != trustedDepositTokenAddress, "Cannot send out reward tokens or deposited tokens!");
