...
SITE: https://akitavspog.com/
TG: https://t.me/akitavspog
X: https://twitter.com/AkitaVsPog
...
contract VS is ERC20, Ownable {
    ...
    Fees public _fees = Fees({
        buyTotalFees: 2, buyMarketingFee: 1, buyDevelopmentFee:0, buyLiquidityFee: 1,
        sellTotalFees: 2, sellMarketingFee: 1, sellDevelopmentFee:0, sellLiquidityFee: 1
    });
    ...
    constructor() ERC20("Akita Vs Pog", "APOG") {
        ...
        marketingWallet = address(0xBb901163021a04a3171B6bc364CBb5596aBd432d);
        developmentWallet = address(0xBb901163021a04a3171B6bc364CBb5596aBd432d);
    ...
    function updateFeeTotal(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
