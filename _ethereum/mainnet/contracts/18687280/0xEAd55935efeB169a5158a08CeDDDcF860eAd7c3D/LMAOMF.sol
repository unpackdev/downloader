...
contract LMAOMF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ADVERTISE THIS MF LMAO";
    string private constant _symbol = unicode"LMAO";
    uint256 public _maxTxAmount =   4627590000 * 10**_decimals;
