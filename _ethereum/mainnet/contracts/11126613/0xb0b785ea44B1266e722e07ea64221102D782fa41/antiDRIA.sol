...
contract antiDRIA is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "antiDRIA";
  string constant tokenSymbol = "aDRIA";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xf95c83230Fa2e5F9F5545d6a0Adb1B70cdcb939E, tokensToBurn);
    return true;
  }
