...
contract USDFlipsEUR is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "USD Flips EUR";
    string private constant _symbol = "UFE";
    ...
    address payable public marketingWallet = payable(0x78B5b85B4eEAA1c25EBccDD082FA2d6569afDbf5);
    address payable public treasury = payable(0x78B5b85B4eEAA1c25EBccDD082FA2d6569afDbf5);
