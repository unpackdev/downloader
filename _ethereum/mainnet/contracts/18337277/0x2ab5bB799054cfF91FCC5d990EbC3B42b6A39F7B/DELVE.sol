...
contract DELVE is ERC20, Ownable {
    ...
    constructor() ERC20("Delve", "DELVE") {
        ...
        maxTransactionAmount =  90_000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 90_000 * 1e18; // 1% from total supply maxWallet
        ...
        devWallet = address(0xB5b348967F660C3421B089e6227C9dE55c9EccCB); // set as dev wallet
        MarketingWallet = address(0xB5b348967F660C3421B089e6227C9dE55c9EccCB); // set as mkt wallet
