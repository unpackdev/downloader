...
contract OWS is ERC20, Ownable {
    ...
    constructor() ERC20("Occupy WallStreet", "OWS") {
        ...
        maxBuyAmount = totalSupply / 100; // 100% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 100; // 100% maxTransactionAmountTxn
        maxWalletAmount = totalSupply / 100; // 100% maxWallet
        ...
        marketingWallet = address(0xC33d355E052d4055542A41A46263223264fD7529);
        devWallet = address(0xC33d355E052d4055542A41A46263223264fD7529);
    ...
    function _transfer(
        ...
        require(sender != address(0x0), 'Cant send to 0x0');
        require(recipient != address(0x0), 'Cant send to 0x0');
        if (
            sender != owner() &&
            recipient != owner() &&
            !isSwapping
