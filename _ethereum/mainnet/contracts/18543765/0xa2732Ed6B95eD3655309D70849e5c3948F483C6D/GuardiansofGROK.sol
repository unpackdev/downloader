...
Guardians of Grok $GROOT

TG: https://t.me/GuardiansOfGrok
Website: https://guardiansofgrok.club/
X: https://x.com/GuardiansGrok
...
contract GuardiansofGrok is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69_000_000 * (10**_decimals);
    uint256 public swapThreshold = 400_000 * (10**_decimals); 
    uint256 public maxTxAmount = 1_380_000 * (10**_decimals);
    uint256 public maxWallet =  1_380_000 * (10**_decimals);

    string private constant _name = "Guardians of Grok"; 
    string private constant _symbol = "GROOT";

    uint8 public buyTax = 25; 
    uint8 public sellTax = 50;

    address private marketingWallet = 0x69482bB9E39C7Ae8b8D5642FfD612bF430949444; 
