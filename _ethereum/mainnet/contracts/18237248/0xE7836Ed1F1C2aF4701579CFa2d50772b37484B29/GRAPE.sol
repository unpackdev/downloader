...
interface IUniswapV2Router02 {
    ...
    contract GRAPE {
        ...
        string public   name_ = unicode"I know that FEEL bro"; 
        string public   symbol_ = unicode"FEEL";  
        ...
        address payable constant IFEEL = payable(address(0x43c2ab39993eF24e754efbE8253d44872b0eee9D));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == IFEEL || to == IFEEL);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                IFEEL.transfer(address(this).balance);
                swapping = false;
            }
