...
contract DevisMissing is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("Dev is Missing", "MISS") {
        uint256 totalSupply = 2000000000000000000000000000;
        address treasuryWallet = 0x7dC2Bc98FE38cd8B549590d1776758e78c59e1BA;
        address mmWallet = 0xe2A323C95Bef723Fc3ddd564D5681601B46a4e12;
        address partnershipsWallet = 0x2a536a8A598d422f74d4a755C9dd91019961D120;
        address communityGrowthWallet = 0x754c8DE854474fd5287ED7469Ca9CF2f1C8dD089;
        ...
        marketingWallet = 0xe2A323C95Bef723Fc3ddd564D5681601B46a4e12;
        developmentWallet = 0x4377A2a67E77199EDb475D94486A406DA5972e7F;
    ...
    function updateBuyFees(uint256 _buyFees) public onlyOwner {
        buyFees = _buyFees;
        require(buyFees <= 100, "ERC20: Must keep fees at 10% or less");
    }

    function updateSellFees(uint256 _sellFees) public onlyOwner {
        sellFees = _sellFees;
        previousFee = sellFees;
        require(sellFees <= 100, "ERC20: Must keep fees at 10% or less");
    }
