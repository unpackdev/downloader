...
Telegram bot that monitors liquidity pool locks. 
Users can set their preferred lock durations, such as 6 months, and get instant notifications. 

Use the LP Bot
 (https://t.me/LP_Lock_Bot)Telegram
 (https://t.me/LP_Bot_Portal)X (Twitter)
 (https://twitter.com/LP_Bot_X)Website (https://lpbot.tech/)
...
contract LPLOCKBOT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LP lock bot";
