...
Telegram : https://t.me/GROX_ERC20
Website  : https://www.grox-erc.com/
...
contract GroxCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Grox","GROX")  {
        
        address newOwner = address(0xC8C7D64cb62E08946CDDd4EA4bF0796492418DcB);
    	...
    	marketingWallet = address(0xC8C7D64cb62E08946CDDd4EA4bF0796492418DcB); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xC8C7D64cb62E08946CDDd4EA4bF0796492418DcB),
            block.timestamp
        );
