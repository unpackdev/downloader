...
contract CLIFFTAMA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CLIFFTAMA", "CLIFFTAMA") {
    ...
    function setAutoLPBurnSettings(uint256 _frequencyInSeconds, uint256 _percent, bool _Enabled) external onlyOwner {
        require(_frequencyInSeconds >= 60, "cannot set buyback more often than every 10 minutes");
