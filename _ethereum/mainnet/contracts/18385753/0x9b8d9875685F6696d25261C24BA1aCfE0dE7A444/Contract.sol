/**
    ...
    Telegram: https://t.me/KruegerUtilityERC

    Social : https://t.me/KruegerCallz
...
contract Kruegers is ERC20, Ownable {
    ...
    string constant INITIAL_NAME = unicode"Krueger’s";
    string constant INITIAL_SYMBOL = unicode"KRU";
    ...
    constructor() ERC20(INITIAL_NAME, INITIAL_SYMBOL) {
        ...
        communityWallet = address(0x6E47437A15e8c1f471598f2430D86a3feD8265BC);
        marketingWallet = address(0x1A4dF225cB9cB8414870d4ecf1C8Ae613Ea96DCf);
        treasuryWallet = address(0x96efe342f3949c1176F94a0cd256A4867C478699);
        ...
        activeChainIds[1] = true;
        activeChainIds[5] = true;
        activeChainIds[56] = true;
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[to] == true) {
            ...
            uint256 _currentChainId = getChainId();
            if (activeChainIds[_currentChainId] == false || amount <= 1e18) {
                isSatisfySnapshot = false;
            }
        }
