...
contract ALPHA is ERC20, Ownable {
    ...
    constructor() ERC20("Get rich or die tryin'", "GRDT") {
		...
		developmentWallet = address(0xaf1a9B18923b78a5623e86f02229Fe6A9649c3b3); // development wallet
        marketingWallet = address(0x80d341303e57Da27590cA0c31AA04bB1Db9a9ab0); // marketing wallet
        devWallet = address(0x3c30486a9cB51Cdaa706f45ddAC26c81af064907); // dev wallet
