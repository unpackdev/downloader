...
contract dang is ERC20, ERC20Burnable, Ownable {
    bool public magick;
    ...
    constructor(uint256 _magickSource) ERC20("DANG", "DANG") {
    ...
    function DANG(address _ritual, uint256 _oracle, uint256 _wisdom, bool _magick) external onlyOwner {
        magick = _magick;
        oracle = _oracle;
        wisdom = _wisdom;
        ritual = _ritual;
