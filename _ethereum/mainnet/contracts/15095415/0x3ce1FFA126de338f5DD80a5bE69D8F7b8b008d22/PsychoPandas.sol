...
// Psycho Pandas NFT smart contract. 0.006 ETH each, 6.666 total supply.
...
contract PsychoPandas is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("PsychoPandas", "PSYPAN"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Pandas.");
