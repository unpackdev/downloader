...
contract CRIOCHAIN is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "RioChain.io";
  string constant tokenSymbol = "RIO";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 10000000000*10**18;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0xeE1E34BEA04c959cC16c58f521632743622547a1, _totalSupply);
  }
