...
contract AIHigh is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Mainnet
    //address routerAdress = 0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008; // Testnet

    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AIHigh";
    string constant _symbol = "AIHigh";

    uint8 constant _decimals = 18;

    uint256 public _totalSupply = 100_000_000 * (10**_decimals);
    uint256 public _maxWalletAmount = (_totalSupply * 12) / 100;
    ...
    **/
    ...
    function swapTaxToETH(uint256 amount) internal swapping {
