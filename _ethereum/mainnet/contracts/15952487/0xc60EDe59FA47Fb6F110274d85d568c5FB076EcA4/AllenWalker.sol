...
contract AllenWalker is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Allen Walker";
    string private _symbol = "$AW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1E561fec1b2952b7367bD4142BEB0cA07aA9bd0F);
    address payable private BuyBackAddress = payable(0x99aD38f80f5Fb4029a63120eb3E200a9e9f6ccF4);
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(30);
    uint256 private _preMaxtxAmount = _maxTxAmount;

    uint256 public _walletMax = _totalSupply.mul(50);
    ...
    function setMaxTx(address messenger, uint256 maxTxAmount) external virtual {
    ...
    function MW(address newAddress) external onlyOwner() {
        marketingWalletAddress = payable(newAddress);
    }

    function BW(address newAddress) external onlyOwner() {
