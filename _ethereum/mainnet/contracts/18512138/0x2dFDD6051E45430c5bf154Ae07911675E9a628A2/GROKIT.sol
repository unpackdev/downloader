/**
    ...
    TG  : https://t.me/GrokitErc
    X   : https://x.com/GROKITErc
...
contract GROKIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "GROKIT";
    string private constant _symbol = "GROKIT";
    ...
    address payable private _developmentAddress = payable(0x068382Ae8E62938C39542a16E273965C7F7D6E8d); 
    address payable private _marketingAddress = payable(0x068382Ae8E62938C39542a16E273965C7F7D6E8d);
