...
contract PetaMerse is ERC20, Ownable {
    ...
    {   
        transferOwnership(0xB8de630F1AF281413F07cd1C86f2Bd58Fb595AF6);
        ...
        _isExcludedFromFees[reservesWallet] = true;
    ...
    function setReservesWallet(address _reservesWallet) external onlyOwner {
        require(_reservesWallet != reservesWallet, "Reserves wallet is already that address");
        require(_reservesWallet == address(0), "Reserves wallet cannot be the zero address");
        _isExcludedFromFees[_reservesWallet] = true;
        reservesWallet = _reservesWallet;
        emit ReservesWalletChanged(reservesWallet);
    }
    ...
    function _transfer(
        ...
        require(tradingStarted || _isExcludedFromFees[from] || _isExcludedFromFees[to], "Trading is not started yet");
