...
Website:  https://www.chickenbro.net/
Telegram: https://t.me/ChickenBroERC
Twitter:  https://twitter.com/ChickenBroErc20
...
contract CHICKENBRO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CHICKEN BRO";
    string private constant _symbol = unicode"CHICKEN";
    uint8 private constant _decimals = 9;

    uint256 private constant _TotalSupply = 10000000000000000000 * 10 **_decimals;
    ...
    constructor () {
        _marketingWallet = payable(0xa3B969405f7b865B8dD0d2C92BCEC02e2Bc81fDA);
