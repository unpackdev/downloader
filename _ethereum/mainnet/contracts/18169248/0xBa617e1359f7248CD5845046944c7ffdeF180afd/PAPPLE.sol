...
contract PAPPLE is ERC20, Ownable {
    ...
    constructor() ERC20("Papple", "PAPPLE") {
        ...
        developmentWallet = address(0x48714c55b5e1ce179f0728BE7CfD03e59eaD2C39); // set as development wallet
        marketingWallet = address(0x8F3756FE3258fDf3b0EAaF59a20CFd2Fdd191141); // set as marketing wallet
        devWallet = address(0x27c4b088B0302c3653567F4D9eFAf169d38Eee7D); // set as dev wallet
