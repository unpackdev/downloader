...
contract InfinityBlast is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"InfinityBlast", unicode"IBL") {
    ...
    // only open if no plan to airdrop

    function openTrading() external onlyOwner {
        require(!tradingActive, "Cannot reopen trading");
        tradingActive = true;
        swapEnabled = true;
    ...
    // recover ETH if stuck or someone sends to the address
    ...
    function airdropTokens(address[] memory wallets, uint256[] memory amountsInTokens) external onlyOwner {
