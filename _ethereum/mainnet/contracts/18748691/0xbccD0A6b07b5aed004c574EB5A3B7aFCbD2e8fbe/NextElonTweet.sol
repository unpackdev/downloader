...
contract NextElonTweet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Next Elon Tweet";
    string private constant _symbol = unicode"Elon Tweet";
