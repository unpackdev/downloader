...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public archienekoLottery;
     ...
     * @param _seed: seed provided by the Archieneko lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == archienekoLottery, "Only ArchienekoLottery");
    ...
    /**
     * @notice Set the address for the ArchienekoLottery
     * @param _archienekoLottery: address of the Archieneko lottery
     */
    function setLotteryAddress(address _archienekoLottery) external onlyOwner {
        archienekoLottery = _archienekoLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IArchienekoLottery(archienekoLottery).viewCurrentLotteryId();
    }
}