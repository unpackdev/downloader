/**
        https://www.shibataofficial.com/

        https://twitter.com/ShibataCoinETH

        https://t.me/ShibataCoin
*/
...
contract SHIBATA is ERC20 {
    ...
    constructor(address router) ERC20("Shibata Coin", "$SHIBATA", TOTAL_SUPPLY) {
