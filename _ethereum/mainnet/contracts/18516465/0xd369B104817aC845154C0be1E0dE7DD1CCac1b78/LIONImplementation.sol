...
// File: contracts/LIONImplementation.sol
...
/**
 * @title LIONImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing LIONImplementation
...
contract LIONImplementation {
    ...
    string public constant name = "Lion USD"; // solium-disable-line
    string public constant symbol = "LION"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all LION at the contract address.
     * This sends the LION tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimLION() external onlyOwner {
