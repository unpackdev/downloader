...
Telegram: https://t.me/PerpetualBotERC
...
contract PERPBOT is Context, IERC20, Ownable {
    ...
    uint256 private _buyTax = 99;
    uint256 private _sellTax = 40;
    uint256 private _startBlock = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 100000000 * 10 ** _decimals;
    string private constant _name = unicode"PERP BOT";
    string private constant _symbol = unicode"PERP BOT";
    ...
    function setTax(uint256 _buy, uint256 _sell) external onlyOwner {
        require (_buy <= 40, "Fee can't exceed 40%");
        require (_sell <= 40, "Fee can't exceed 40%");
        _buyTax = _buy;
        _sellTax = _sell;
    }
