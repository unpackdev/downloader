...
contract DORKIA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DORK LORD IS ASWSOME";
    string private constant _symbol = unicode"DORKIA";
