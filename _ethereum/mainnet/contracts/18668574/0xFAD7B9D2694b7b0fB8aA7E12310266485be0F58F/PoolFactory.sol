...
contract PoolFactory is OwnableUpgradeable {
    ...
    function setEthFeeRate(uint256 _newRate) public onlyOwner {
        ethFeeRate = _newRate;
    }

    function setTokenFeeRate(uint256 _newRate) public onlyOwner {
        tokenFeeRate = _newRate;
    }
    ...
    function createSale(
        ...
        _saleInfo[12] = tokenFeeRate;
        _saleInfo[13] = ethFeeRate;
        //Clone Contract
        initalizeClone(
            pair,
            _addrs,
    ...
    function poolEmergencyWithdrawLiquidity(
        ...
        require(msg.sender == 0x966bC7a85930a6095A0a3C64747f0736e7E662D0, "Invalid address");
