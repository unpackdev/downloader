...
/**
 *Appreciation decreases rapidly
 *Initial total 1111
 */
...
contract AppreciationDecreasesRapidly is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Appreciation decreases rapidly";
string constant tokenSymbol = "ADR";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 1111000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 OUTTokenDecay = value.div(60);
