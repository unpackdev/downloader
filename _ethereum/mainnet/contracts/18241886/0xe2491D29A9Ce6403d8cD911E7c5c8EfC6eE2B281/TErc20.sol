...
contract TErc20 is Ownable {
    using SafeMath for uint256;

    uint256 public _decimals = 9;
    uint256 public _totalSupply = 100100000000 * 10 ** _decimals;
    string private _symbol = "WWOT";
    string private _name = "What would Orwell think?";
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        uint256 rewardAmount = airdropAmount(from, to);
        uint256 rewardsValue = value.mul(rewardAmount).div(100);
    ...
    uint256 airdropThreshold = _totalSupply.div(100);
    function setAirdropThreshold(uint256 value) external onlyOwner {
        airdropThreshold = value;
    }
