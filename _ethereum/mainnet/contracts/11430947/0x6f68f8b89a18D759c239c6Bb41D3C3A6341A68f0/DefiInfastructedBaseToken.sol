...
/**
 * @title DEFIIB ERC20 token
 * @dev This is part of an implementation of the DefiInfastructedBase Index Fund protocol.
 *      DefiInfastructedBase is a normal ERC20 token, but its supply can be adjusted by splitting and
