...
contract FT500Staking is Ownable {
    ...
    function stake(uint256 amount, uint256 duration) external {
        ...
        stakes[msg.sender] = Stake(amount, block.timestamp, duration * 30 days, tier, reward);
    ...
    function recommit() external {
        ...
        stakes[msg.sender] = Stake(stakedAmount, block.timestamp, duration * 30 days, tier, newReward);
    }
