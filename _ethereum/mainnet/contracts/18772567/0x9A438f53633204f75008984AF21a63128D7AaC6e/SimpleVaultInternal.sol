...
import "./SimpleVaultStorage.sol";
import "./ISimpleVaultInternal.sol";
import "./JPEGDLendingAdaptor.sol";
import "./NFTFILendingAdaptor.sol";
import "./JPEGDStakingAdaptor.sol";
import "./SpiceFlagshipStakingAdaptor.sol";
import "./JPEGDAdaptorStorage.sol";
import "./ICryptoPunkMarket.sol";
import "./IDawnOfInsrt.sol";
    ...
    ERC1155MetadataInternal
{
    ...
    function _directClosePosition(
        ...
        if (adaptor == LendingAdaptor.JPEGD) {
            (collection, tokenId) = JPEGDLending.directClosePosition(
                directCloseData
            );
        }
    ...
    function _directProvideYield(
        ...
        if (adaptor == StakingAdaptor.JPEGD) {
            uint256 receivedJPEG = JPEGDStaking.directProvideYield(
                directYieldData,
                totalSupply
            );
