...
contract FEAROFTHEUNKNOWN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fear of the unkown";
    string private _symbol = "SCARED";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xDf2eD33f2ef685F8eeCaAc0E12CF806dcCe19949);
    address payable private taxWallet2 = payable(0xDf2eD33f2ef685F8eeCaAc0E12CF806dcCe19949);
    ...
    uint256 public _walletMax = 900 * 10**6 * 10**9;
