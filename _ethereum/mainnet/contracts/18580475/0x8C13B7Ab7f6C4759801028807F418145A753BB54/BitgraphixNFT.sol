...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mintBatchInConstructor(
        address to,
        ...
        uint256 endTokenId = startTokenId + tokens;
...
// File contracts/BitgraphixNFT.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity 0.8.19;
// Nfts are purchaseable with Native

contract BitgraphixNFT is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor(
        ...
        _mintBatchInConstructor(_msgSender(), 1, 108);
    }
