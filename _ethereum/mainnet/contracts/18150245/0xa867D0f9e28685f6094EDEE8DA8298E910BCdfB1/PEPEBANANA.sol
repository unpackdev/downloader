...
Don't slip on the peel and fall off the rocket to the moon! aka don't be a jeet and pull out, like a bitch, on a 2x
*/
...
contract PEPEBANANA is Context, IERC20, Ownable {
    string private _name = "Pepe Banana";
    string private _symbol = unicode"БАНАНОВЫЙ ПЕРЕЦ";
    ...
    constructor() {
        ...
        marketingWallet = address(0x245f4461bFbE802FCA56b2B37652B6f146EAA1bE);
