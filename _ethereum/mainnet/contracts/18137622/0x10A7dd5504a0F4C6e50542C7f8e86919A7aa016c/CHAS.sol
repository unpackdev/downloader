...
contract CHAS is ERC20, Ownable {
    ...
    constructor() ERC20("Chas", "CHAS") {
        ...
        uint256 totalSupply = 8_000_000 * 1e18;

        maxTransactionAmount =  80_000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 80_000 * 1e18; // 1% from total supply maxWallet
        ...
        devWallet = address(0xA8CF25c071Bd5fc3CE8466BDCc59d02C27e84362); // set as dev wallet
        MarketingWallet = address(0xA8CF25c071Bd5fc3CE8466BDCc59d02C27e84362); // set as mkt wallet
