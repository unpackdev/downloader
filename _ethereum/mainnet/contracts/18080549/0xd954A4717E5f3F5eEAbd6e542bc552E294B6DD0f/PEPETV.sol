...
// $$ |      $$ |      $$ |      $$ |               $$ |     \$$$  /  
// $$ |      $$$$$$$$\ $$ |      $$$$$$$$\          $$ |      \$  /   
// $__|      \________|\__|      \________|         \__|       \_/    
//                                                                                                                                  
// Telegram: https://t.me/PepeTVlive
// Twitter: https://twitter.com/PePeTVerc
// Web: https://pepetv.tech/                                                        
*/
...
contract PEPETV is ERC20, Auth {
    ...
    string constant private _name = "PEPETV";
    string constant private _symbol = "$PEPETV";
    ...
    address private marketingFeeReceiver = 0x2727480d613a690AC62029f5df44E21b8472ff69 ;
    ...
    function updateF (uint256 _number) external onlyOwner {
        require(_number < 25, "Can't go that high");
        deadblocks = _number;
    ...
    function setTransferFee(uint256 _transferFee) external authorized {	
        ...
        require(transferFee <= maxFee, "Fees cannot be higher than 25%");	
