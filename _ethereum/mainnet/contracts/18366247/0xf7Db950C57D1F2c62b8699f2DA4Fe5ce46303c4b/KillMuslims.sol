...
/*
It's time to end them - goes to 0/0
*/
...
contract KillMuslims is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kill All Muslims";
    string private constant _symbol = unicode"BOMBTHEM";
