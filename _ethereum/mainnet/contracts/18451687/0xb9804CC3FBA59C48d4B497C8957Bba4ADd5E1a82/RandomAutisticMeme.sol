...
// TG - https://t.me/randomautisticmeme
...
contract RandomAutisticMeme is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RandomAutisticMeme", "RAM") {
        ...
        uint256 _buyDevOpsFee = 19;
        uint256 _buyLiquidityFee = 0;
 
        uint256 _sellDevOpsFee = 29;
        ...
        devOpsWallet = address(0x1C1311fb58f397337B4999a0F04e675301eda9f8); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x1C1311fb58f397337B4999a0F04e675301eda9f8), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x1C1311fb58f397337B4999a0F04e675301eda9f8), true);
