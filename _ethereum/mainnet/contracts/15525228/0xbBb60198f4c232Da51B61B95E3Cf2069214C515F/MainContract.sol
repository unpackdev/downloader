...
contract MainContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kucoin v2.0";
    string private constant _symbol = "Kucoin2";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x8A74EAf7502b70EbeDf28e7475ddC1f53226b695); 
        ...
        maxTxAmount = 20000000000000000 * 10**9;
        maxWalletAmount = 20000000000000000 * 10**9;          
