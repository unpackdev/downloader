...
contract UglyApes is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmcCLwjEmnmFniXXRcSWGshNc4wX5P2bxRuGyGdiUzzeq5/";
