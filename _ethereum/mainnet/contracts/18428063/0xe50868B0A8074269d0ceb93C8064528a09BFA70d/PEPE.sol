/**
 *Submitted for verification at Etherscan.io on 2023-4-20
*/
...
contract PEPE is Ownable, ERC20 {
    ...
    constructor(uint256 _totalSupply) ERC20("PEPE69999", "PEPE69999") {
        _mint(msg.sender, _totalSupply);
    }


    // ----------------------------------------------------------------------------
    // 'pepe6999' Smart Contract
    //
    //
    // Symbol      : PEPE69999
    // Name        : PEPE69999
    // Total supply: 699,990,000,000 PEPE
    // Decimals    : 18
    //
    // Pepe Token is a simple ERC-20 token smart contract with a fixed supply.
    // It represents 699990000000 PEPE PEPE69999 with 18 decimal places, which can be
    // transferred, received, and managed by Ethereum wallets and DApps.
    //
    //
    // ----------------------------------------------------------------------------
