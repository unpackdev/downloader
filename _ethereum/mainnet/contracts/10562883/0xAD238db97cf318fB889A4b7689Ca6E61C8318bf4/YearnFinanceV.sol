 ...
 * 100% OF TOKEN SUPPLY LOCKED IN UNISWAP LIQUIDITY
 * 5% TOKEN BURN FROM LIQUIDITY POOL PER DAY
 * YEARN.FINANCE
*/
interface ERC20 {
...
contract YearnFinanceV is ERC20 {
  ...
  string public constant name  = "YearnFinanceV";
