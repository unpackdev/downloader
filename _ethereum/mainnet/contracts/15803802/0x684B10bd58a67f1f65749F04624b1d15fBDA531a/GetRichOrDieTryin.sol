/**
*/ 
// https://getrichordietryingerc.info/
// High starting sell tax which will be reduced every 10 minutes.
...
contract GetRichOrDieTryin  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Get Rich or Die Tryin'";
    string private constant _symbol = "TRYIN";
    ...
    address payable private _developmentAddress = payable(0x38D239493E9706D1c2CaAbbdEEd0c5a1f5d98EFE); 
    address payable private _marketingAddress = payable(0x38D239493E9706D1c2CaAbbdEEd0c5a1f5d98EFE);
