...
contract ProofOfProtocol is Context, IERC20, Ownable {
    ...
    string private _name ="Proof Of Protocol";
    string private _symbol = "THE2.0";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x518C190bB36fb6cD663B0E6d6aD4Ecf46d79D732);
    address payable private taxWallet2 = payable(0x518C190bB36fb6cD663B0E6d6aD4Ecf46d79D732);
    ...
    uint256 public _sellMarketingFees = 96;
    ...
    uint256 public _totalTaxIfSelling = 96;
