//it is what it is DEGEN KWON - Degen Casino Safu . high taxes to recover from early buyers til 10kmc then removing
...
contract dgnkwon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DEGENKWON", "$DGNKWON") {
