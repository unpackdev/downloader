...
Website: https://bitcoinkat.space
...
pragma solidity ^0.8.23;
    ...
    contract BitcoinKat {
        string public constant name = "BitcoinKat";  //
        string public constant symbol = "BITKAT";  //
        ...
        address payable constant deployer = payable(address(0x5711f0C41537cC158C318cC2c4230F7e1Eb2f908)); //
        ...
        function setBITKAT(uint256 newTBurn, uint256 newTConfirm) external {
