/**
 Kaiken Inu is a decentralized cryptocurrency token that 
 was built on the Ethereum blockchain using the ERC-20 standard. 
 ERC-20 is a widely adopted token standard that defines a set of rules and functions for creating tokens on the Ethereum network.

https://www.kaikeninuofficial.com/

https://twitter.com/kaiken_inuerc20
