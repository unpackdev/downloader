...
/**
IO Protocol - Artificial General Intelligence. It is an artificial intelligence agent capable of reaching the level of human intelligence. IO Protocol Inu is a cryptocurrency product derived from this key concept. Now, IO Protocol Coins have entered the Binance SmartChain (BSC).

The combination of IO Protocol Coin and IO Protocol A artificial intelligence technology is a joint effort by OpenSea to create a new type of protocol.
...
contract IO is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 10000000;
    string internal _name = "IO Protocol AI";
    string internal _symbol = "IO";
