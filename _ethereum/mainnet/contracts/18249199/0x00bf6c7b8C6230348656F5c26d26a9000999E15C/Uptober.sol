// Telegram:  
// Discord:  
// Twitter: https://twitter.com/uptober1erc 
// Website: 
...
contract Uptober is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xF9D1Beddb5C001fFc47ca03Efce5F29DBB82E9AA;
    ...
    uint256 public maxTokenAmountPerWallet = 8413800000000 * 10 ** decimals();
    uint256 public maxTokenAmountPerTransaction = 4206900000000 * 10 ** decimals();
    
    uint256 private buyCount = 0;
    uint256 private initialBuyCountTreshold = 10;
    ...
    constructor() ERC20(unicode"UPTOBER", unicode"UPTOBER") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xF9D1Beddb5C001fFc47ca03Efce5F29DBB82E9AA, ownerReceiverSupply * 10 ** decimals());
        } else {
