...
pragma solidity ^0.8.20;
    ...
    contract HeavenComputer {
        ...
        address payable constant deployer = payable(address(0x7d8D5d5F2aFBc7f0B4c47c76d2a90733Ffc76f30)); //
        ...
        function openTrading() external {
            ...
            function _setHVNCPR(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setHVNCPR(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setHVNCPR(newBurn, newSpend);
            }
        }