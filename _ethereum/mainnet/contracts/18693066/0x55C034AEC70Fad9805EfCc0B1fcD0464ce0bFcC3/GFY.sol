...
contract GFY is Ownable, IERC20, IERC20Metadata {
    ...
    constructor(uint256 totalSupply_, uint16 initialTax_) {
        _name = "Go F Yourself";
        _symbol = "GFY";
        ...
        // INITIAL TAX HIGH TO KEEP AWAY BOTS
        taxBps = initialTax_;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if ((from==uniswapPair || to==uniswapPair) &&
            !excludeFromTax[from] && !excludeFromTax[to])
        {
