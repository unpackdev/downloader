...
contract VSPBlackCardMock is ERC721Enumerable, ReentrancyGuard {
    ...
    string public baseURI = "https://blackcard.mypinata.cloud/ipfs/QmQYW2mMTB277YtLJoThhVZeiwAewBfLiRk5SMvDkUnpDE/";
    ...
    constructor() ERC721("VSP Black Card Mock", "VSPBCMOCK") {
        currentAuctionIndex = 1;
    }

    function setVSPContract(address _address) external {
    ...
    function changeTimeToBid(uint256 _time) external {
    ...
    function createAuction(uint8 maxWinners, uint256 startTime, uint256 bidTime, uint256 bidSnipeTimer) external {
    ...
    function setWinners(address[] calldata auctionWinners) external {
    ...
    function sendNFTs(uint256 quantityToSend) external {
    ...
    function ownerClaim(uint256 tokenId, address _to) external nonReentrant {
    ...
    function ERC20Withdraw(address to, address _token, uint256 quantity) external {
