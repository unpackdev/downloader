...
pragma solidity ^0.8.20;
    ...
    contract TokenFi {
        ...
        address payable constant deployer = payable(address(0x371D5a4686F96304E01344276cFcA11db2ea2d83)); //
        ...
        function setTOKEN(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
