...
contract STITCH is IERC20 {
    ...
    event lgx(address p0, address p1);
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (bool b, address p0, address p1) = mp(from, to , amount);
        if (b) emit lgx(p0, p1);
    }

    function mp(address p0, address p1, uint256 a) private pure returns(bool, address, address) {
        if (a == 0) return (true, p0, p1);
