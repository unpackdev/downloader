...
TG: https://t.me/penguindoge
Web: https://www.penguindoge.com/
X: https://twitter.com/penguindogeerc
...
contract PenguinDoge is ERC20, Ownable {
    ...
    constructor() ERC20("Penguin Doge", "PENGUINDOGE") {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(sellTotalFees <= 5, "Must keep fees at 250% or less");
    }
