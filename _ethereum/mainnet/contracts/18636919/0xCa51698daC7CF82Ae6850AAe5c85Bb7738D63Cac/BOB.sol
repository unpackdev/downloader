...
BOB TOKEN THE TICKER IS $BOB AND WE NEED TO BLOW UP THE ETH NETWORK MARKET
POWERED BY IDIOTS WITHOUT A JOB SO WE ARE AIMING FOR THE MOON

https://bobcoin.org
https://twitter.com/BOBCOIN_erc20
...
contract BOB is ERC20, Ownable {
    ...
    string private constant _name = "Bob Token";
    string private constant _symbol = unicode"BOB";
    mapping(address => bool) private bots;

    uint256 public initialTotalSupply = 1337000000 * 1e18;
    uint256 public maxTransactionAmount = 26740000 * 1e18;
    uint256 public maxWallet = 26740000 * 1e18;
    uint256 public swapTokensAtAmount = 13370000 * 1e18;
