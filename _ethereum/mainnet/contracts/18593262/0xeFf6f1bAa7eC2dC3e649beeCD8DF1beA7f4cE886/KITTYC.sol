...
contract KITTYC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hello Kitty Classic";
    string private constant _symbol = unicode"KITTYC";
