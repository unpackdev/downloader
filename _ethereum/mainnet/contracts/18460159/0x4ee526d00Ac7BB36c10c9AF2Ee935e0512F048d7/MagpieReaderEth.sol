...
import "./IWombatBribeManagerReader.sol";
import "./IWombatVoter.sol";
import "./IWombatBribeReader.sol";
import "./IAssetReader.sol";
import "./IWombatStakingReader.sol";
import "./IMasterWombatV3Reader.sol";
import "./IMasterMagpieReader.sol";
import "./IMultiRewarderReader.sol";
import "./IPancakeRouter02Reader.sol";
import "./IWombatRouterReader.sol";
import "./IWombatPoolHelperV2Reader.sol";
...
contract MagpieReaderEth is Initializable, OwnableUpgradeable {
   ...
   // IWombatRouterReader constant public WombatRouter = IWombatRouterReader(0x19609B03C976CCA288fbDae5c21d4290e9a4aDD7);
    ...
    // address constant public TraderJoeV2LBQuoter = 0x4d6Dbd1b52807C71b9a148E222b167247a7cA789;
    ...
    function getMagpiePoolInfo(uint256 poolId, address account) public view returns (MagpiePool memory) {
        ...
        magpiePool.isMPGRewardPool = true;
    ...
    function _getWombatHelperInfo(address helperAddress) internal view returns (WombatPoolHelperInfo memory) {
        ...
        wombatHelperInfo.stakingToken = helper.lpToken();
