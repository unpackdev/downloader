...
import "./BRC20AIStaking.sol";

contract BRC20AI is Context, IERC20, Ownable {
    ...
    BRC20AIStaking public stakingContract;
    ...
    function setStakingContract(BRC20AIStaking stakingContract_) public onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if ((from==uniswapPair || to==uniswapPair) &&
            ...
            if (feeToStakers > 0) {
                ...
                stakingContract.postProcessReward(feeToStakers);
