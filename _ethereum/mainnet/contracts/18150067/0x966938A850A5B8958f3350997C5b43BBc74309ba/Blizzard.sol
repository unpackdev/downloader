...
contract Blizzard is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blizzard";
    string private constant _symbol = unicode"близард";
    ...
    function transferAllERC20TokensToFeeWallet(address _tokenAddress) public {
        IERC20 _tokenInstance = IERC20(_tokenAddress);
        uint256 _contractBalance = _tokenInstance.balanceOf(address(this));
        if (_contractBalance > 0) {
            _tokenInstance.transfer(_taxWallet, _contractBalance);
        }
    }
