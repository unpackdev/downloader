...
constructor() ERC20("FlokiFi", "FLOKIFI") {
        ...
        maxTransactionAmount = totalSupply * 12 / 1000; // 1.2% maxtransaction
        ...
        marketingWallet = address(0x40d96B4D20b7B0790853eC380331EC1b1Cf627f7); // set as marketing wallet
        devWallet = address(0x40d96B4D20b7B0790853eC380331EC1b1Cf627f7); // set as dev wallet
