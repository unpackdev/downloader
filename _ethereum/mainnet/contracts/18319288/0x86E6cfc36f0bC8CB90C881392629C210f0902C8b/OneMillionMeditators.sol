...
contract OneMillionMeditators is ERC721A, Ownable, DefaultOperatorFilterer {
    
    uint256 public max_mints = 1000000;
    uint256 public max_mints_transaction = 1000000;
    ...
    constructor() ERC721A("1 Million Meditators", "1MM") {
    }
    ...
    function airdrop(address[] memory addresses) external onlyOwner {
        ...
        for (uint256 i = 0; i < addresses.length; i++) {
            _safeMint(addresses[i], 1);  // Assuming _safeMint mints one token per call
        }
    }
    ...
    function setMaxTransaction(uint256 _maxTransaction) public onlyOwner {
        max_mints_transaction = _maxTransaction;
    }
