/**
https://outlaw.top
https://t.me/OutlawCoin
https://twitter.com/OutlawCoinEth
...
contract JesseJames is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"Jesse James";
    string private constant _symbol = unicode"OUTLAW";
    uint8 private constant _decimals = 9;

    uint256 private constant _Totalvy = 10000000000000000 * 10 **_decimals;
    ...
    constructor () {
        _qfmoburq = payable(0x153faDC670a5e04517AE12341b052cC7c7355a65);
