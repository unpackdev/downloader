...
/// @param feeRatePerAsset fee rate is the percentage of the amount lent taken for each asset. Default is 0
struct Protocol {
    uint256 nbOfLoans;
...
/// @notice Fees collected by the protocol
/// @param feeRatePerAsset fee rate is the percentage of the amount lent taken for each asset. Default is 0
struct Fee {
    mapping(IERC20 => Ray) feeRatePerAsset;
}
