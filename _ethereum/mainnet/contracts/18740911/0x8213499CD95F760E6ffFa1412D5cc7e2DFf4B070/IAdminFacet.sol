...
interface IAdminFacet {
    ...
    /// @notice the fee rate of the currency has been updated
    /// @param currency the erc20 on which a new fee rate is taking effect
    /// @param newFeeRate the new fee rate
    event NewFeeRatePerAsset(IERC20 indexed currency, Ray indexed newFeeRate);
    ...
    function setFeeRateForAsset(IERC20 asset, Ray feeRate) external;
}
