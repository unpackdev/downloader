...
contract DynamiteAttack is Ownable {
    ...
    function AttackPir(address killed) public {
        ...
        require(dyn.balanceOf(msg.sender)>minAmount, "DynamiteAttack: Not enough balance");
        require(killer != killed, "DynamiteAttack: Can't attack yourself");

        uint256 killedBalance = pir.balanceOf(killed);
        uint256 amount = killPerAttack.mul(10**18);
        ...
        dyn.burnFrom(msg.sender,minAmount.mul(10**18));
