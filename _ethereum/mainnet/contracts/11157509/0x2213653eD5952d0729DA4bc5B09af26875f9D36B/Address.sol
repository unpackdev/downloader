...
contract MasterSeal is Ownable, Timelock {
    ...
    uint256 public constant REWARD_START_BLOCK = 11157650;
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            if(pending > 0) {
                safeANTISEALTransfer(msg.sender, pending);
            }
        }
    ...
    function safeANTISEALTransfer (address _to, uint256 _amount) internal {
