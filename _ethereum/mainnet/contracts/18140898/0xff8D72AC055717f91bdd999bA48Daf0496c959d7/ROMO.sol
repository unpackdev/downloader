/*
Within every hero's tale, there exists a critical moment of choice. Return to the ordinary life or embark on the journey. $ROMO #AIROMANCE

- Telegram: https://t.me/AIRomanceETH
- Twitter: https://twitter.com/AIRomanceETH
- App: https://airomance.xyz
...
contract ROMO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AI Romance";
    ...
    constructor () {
        _taxWallet = payable(0x5476483799D56aedc05B932b83C21d894fd3A3Fe);
