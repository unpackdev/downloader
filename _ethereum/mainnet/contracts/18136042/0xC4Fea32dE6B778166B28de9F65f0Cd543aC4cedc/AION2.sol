...
contract AION is ERC20, Ownable {
    ...
    constructor() ERC20("Fake token", "FAKE") {
        ...
        revShareWallet = address(0xE912274F77952D2B44c054C92312664d08A824BE); // set as revShare wallet
        buyBackWallet = address(0xD599b4840Da7ABB19A7BAe8F70FBA422eabf783C); // set as buyBack wallet
