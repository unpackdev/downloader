...
contract PEPEPIRATEGOLD is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x5457CA660A28216819DA2E1bCE488376B5053626));

    string private _name = "PEPEPIRATEGOLD";
    string private _symbol = "PEPEPIRATE";
