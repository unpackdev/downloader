...
https://t.me/AllStarsCHAMPS

https://twitter.com/AllStarsToken
...
contract CHAMPS  is ERC20, Ownable {
    ...
    constructor() ERC20("All Stars Token", "CHAMPS") {
        ...
        uint256 _buyEcosystemFee = 7;
        uint256 _buyLiquidityFee = 2;
        uint256 _buyCharityFee = 1;

        uint256 _sellEcosystemFee = 15;
        ...
        buyTotalFees = buyEcosystemFee + buyLiquidityFee + buyCharityFee;

        sellEcosystemFee = _sellEcosystemFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellCharityFee = _sellCharityFee;
        sellTotalFees = sellEcosystemFee + sellLiquidityFee + sellCharityFee;    

        ecosystemWallet = address(0x07429986a06a7C54B79a11815A9276277B416ae9); // set as marketing wallet
        charityWallet = address(0x63E32B69224ab92b00141a9862e7355a4AB4ccf1); // set as dev wallet
    ...
    function updateMWallet(address newEcosystemWallet)
        external
        onlyOwner
    {
    ...
    function swapBack() private {
        ...
        uint256 ethForEcosystem = ethBalance.mul(tokensForEcosystem).div(
            totalTokensToSwap
        );
        uint256 ethForCharity = ethBalance.mul(tokensForCharity).div(totalTokensToSwap);

        uint256 ethForLiquidity = ethBalance - ethForEcosystem - ethForCharity;
