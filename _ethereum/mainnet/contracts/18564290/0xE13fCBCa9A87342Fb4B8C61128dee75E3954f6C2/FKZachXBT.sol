...
contract FKZachXBT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fuck ZachXBT";
    string private constant _symbol = unicode"FKZachXBT";
