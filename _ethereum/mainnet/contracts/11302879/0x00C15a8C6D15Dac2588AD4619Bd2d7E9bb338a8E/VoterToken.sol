 ...
 */
contract VoterToken is Pausable, StandardToken {

  using SafeMath for uint256;

  address public treasurer = 0x0;

  uint256 public purchasableTokens = 100000000 * 10**18;

  string public name = "voterledger.io";
  string public symbol = "VOTER";
   ...
   */
  function VoterToken(address _owner) {
