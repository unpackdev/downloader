...
TWITTER: https://twitter.com/NibblerETH
WEBSITE: https://nibbler.website
...
contract Nibbler {
    ...
    string public constant name = "Nibbler";   
    string public constant symbol = "NIBBLER";   
    ...
    address payable constant deployer = payable(address(0x8F625fcA5Eb2e878107B38A324E93c244eac08d4));
    ...
    function setNIBBLER(uint256 newGet, uint256 newSpend) external {
