...
contract ArabicStrawberryElephant is ERC20, Ownable {
    ...
    constructor() ERC20("Arabic Strawberry Elephant", unicode"صباح فراوله") {
        ...
        maxTransaction = 38_888_888_888 * 1e18; // 5% max transaction at launch
        maxWallet = 38_888_888_888 * 1e18; // 5% max wallet at launch
        ...
        marketingWallet = address(0x594187a3Fa47dFf81c9b701E07e029B46De0Ff00); 
        developmentWallet = address(0x594187a3Fa47dFf81c9b701E07e029B46De0Ff00); 
        liquidityWallet = address(0x594187a3Fa47dFf81c9b701E07e029B46De0Ff00); 
        operationsWallet = address(0x594187a3Fa47dFf81c9b701E07e029B46De0Ff00);
    ...
    function updateRouter(address newRouter) external onlyOwner {
        emit routerUpdated(newRouter, uniV2router);
