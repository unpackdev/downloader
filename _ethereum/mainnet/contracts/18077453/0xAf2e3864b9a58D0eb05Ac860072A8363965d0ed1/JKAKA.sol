...
Tipcoin is a platform that aims to revolutionize social interaction (in this case, on Twitter), allowing users to reward their friends and favorite content creators without leaving Twitter.

Fair Launch: 13:00 UTC September 6, 2023

Join us: 
X : https://twitter.com/tipcoineth
Website: thetipcoin.io
Telegram: https://t.me/tipcoin_Official
*/
...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x15D66eaF56C9D9Bb5f4C347b1e76EF7366Ff85bc;
    uint8 public marketingTax = 5;
    ...
    {
        require(tax <=35,"Cannot set the fee more than 5%");
        marketingTax = tax;
    }
...
contract TipCoin is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("TipCoin", "TIP", 18) {
    _owner = msg.sender;
