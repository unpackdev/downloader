...
contract TokenTRC20 {
    ...
    constructor(
        ...
        totalSupply = 1000 * 10 ** uint256(18);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                // Give the creator all initial tokens for distribution 
        name = "XFI.digital";                                   // Set the name for display purposes
        symbol = "XFI";                               // Set the symbol for display purposes
        _governance=_gov;
    }
