...
🔗 WEBSITE ~ https://dogpark.com
🔗 TWITTER ~ https://x.com/dogparkgo
🔗 TELEGRAM ~ https://t.me/dogpark_eth
...
contract Dog_Park is ERC20, Ownable {
    ...
    address public _market = 0x6FF08dBDAaed8E1816D2D2b30339Cd2730FA327C;

    event SwapAndMarketEnabledUpdated(bool enabled);

    constructor() ERC20("Dog Park", "Dog Park") {
    ...
    function openTrade() public onlyOwner {
        if (!tradeEnabled) tradeEnabled = true;
