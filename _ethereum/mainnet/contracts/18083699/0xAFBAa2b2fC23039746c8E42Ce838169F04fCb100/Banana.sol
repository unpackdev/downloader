...
*/
// This is where we bundle together to create the biggers bribe to be in the first block!
//  

// 
//                          https://t.me/BananaGunMarksmenPortal 
...
contract Banana is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Banana Bribe";
