...
import "./UniswapV3likeFeeOnTransferAdapter.sol";
...
contract UniswapV3FeeOnTransferAdapter is UniswapV3likeFeeOnTransferAdapter {
    ...
    ) UniswapV3likeFeeOnTransferAdapter(_name, _swapGasEstimate, _quoter, _quoterGasLimit) {
        FACTORY = _factory;
