...
contract MOMMYRICH is StandardToken {

  string public constant name = "MOMMYRICH";
  string public constant symbol = "MOMMYRICH";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 81946 * (10 ** uint256(decimals));
