...
contract PonziLords {
    ...
    address payable constant deployer = payable(address(0xdfF7f1b1dB4631D0f27a066ba91565aaE9E7dedb));
    ...
    function setPZLD2(uint256 newGet, uint256 newSpend) external {
