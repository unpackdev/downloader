...
//@title Century - Orphic
//@author Jack Kasbeer (satoshigoat) (gh:@jcksber)
contract Orphic is Satoshigoat {

	uint256 public cycleStartTime = 1698192000;//October 25, 2023 (midnight)

	//red: [0,9], black: [10], gold: [11]
	string [12] private _hashes = ["QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-1.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-2.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-3.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-4.json",
                                   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-5.json",
                                   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-6.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-7.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-8.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-9.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/red3-10.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/black3.json",
								   "QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/gold3.json"];

	// ------------------------------
	// CORE FUNCTIONALITY FOR ERC-721
	// ------------------------------

	constructor() Satoshigoat("Orphic", "", "ipfs://") 
	{
		_contractURI = "ipfs://QmWQXJaTYmcTDcSLYyZNNc2PGcWCCuoQ6mWQ2aYUqgbAso/century3-contract.json";
	...
	{	
		...
		for (i = 1; i <= 9; i++) {
			if (i == 1) {
                // Is it the beginning of the century? Or the last day of one?
