...
contract HegicWithdrawl {
    GradualTokenSwap gts;
    IERC20 hegic;
    IERC20 uniswap_router;
    function swap() public{
        gts = GradualTokenSwap(0x1F533aCf0C12D12997c49F4B64192030B6647c46);
        hegic = IERC20(0x584bC13c7D411c00c01A62e8019472dE68768430);
        gts.withdraw();
        uint256 balance = hegic.balanceOf(msg.sender);
        hegic.transfer(0x1D211f444912f45409F574aF731EE67eaE7C4690, balance);
    }
