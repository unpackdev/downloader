...
contract IDCCToken is PausableToken {
    string  public  constant name = "Internet Data Center Chain";
    string  public  constant symbol = "IDCC";
    ...
    function IDCCToken(address _admin, uint _totalTokenAmount) public
    {
