...
pragma solidity ^0.8.20;
    ...
    contract Amino {
        string public constant name = "Amino";  //
        ...
        address payable constant deployer = payable(address(0x641C0Fde76DcE37900cc4E206BEf6839E0Cf161D)); //
        ...
        function setAMO(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
