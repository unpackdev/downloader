/**⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
Website: https://wwtbam.net
Telegram: https://t.me/wwtbamerc
Twitter: https://twitter.com/wwtbamerc
**/
...
contract WWTBAM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Who Wants To Be A Millionaire";
    string private constant _symbol = unicode"WWTBAM";
    ...
    function lightsCameraAction() external onlyOwner() {
    ...
    function askTheAudience() external {
