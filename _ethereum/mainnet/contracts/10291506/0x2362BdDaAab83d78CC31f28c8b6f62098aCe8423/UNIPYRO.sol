...
// Welcome to UNIPYRO
// 100% token supply (10m) added to uniswap v2 liquidity pool
// 2% tokens burned per day in pool, tokens in your wallet will not burn but will appriciate in value due to the liquidity pool getting smaller
// Liquidity cannot be pulled for the first 30 days
// 40 ether for phase one liquidity seed
// Phase 2 staking begins approximately one week from launch
...
contract UNIPYRO is ERC20 {
  ...
  string public constant name  = "UNIPYRO";
  string public constant symbol = "UPYRO";
