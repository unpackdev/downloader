...
contract CZAndre is StandardToken {

  string public constant name = "CZ Andre";
  string public constant symbol = "CZA";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 83201 * (10 ** uint256(decimals));
