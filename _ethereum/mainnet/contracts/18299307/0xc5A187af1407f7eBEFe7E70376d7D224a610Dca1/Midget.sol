...
contract Midget is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x6faab99EbFA1237FD4d237F5D8CB90f5B5BD250b;
    ...
    constructor() ERC20(unicode"MIDGET", unicode"MID") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x6faab99EbFA1237FD4d237F5D8CB90f5B5BD250b, ownerReceiverSupply * 10 ** decimals());
        } else {
