...
contract Tote is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tote";
    string private constant _symbol = "TOTE";
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x29e47712d8fcF845BFae3d3cdCEcAc34E4746086);
