...
contract RayaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "RayaInu";
    string private constant _symbol = "RayaInu";
    ...
    address payable private _developmentAddress = payable(0xBdD7Dcc09c6100fcD42738a166835362F291eA26);
    address payable private _marketingAddress = payable(0xBdD7Dcc09c6100fcD42738a166835362F291eA26);
    ...
    uint256 public _swapTokensAtAmount = 5000000000 * 10**9; //0.5
