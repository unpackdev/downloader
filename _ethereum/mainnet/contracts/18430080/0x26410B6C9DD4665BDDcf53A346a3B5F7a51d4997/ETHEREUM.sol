...
We Are Tired Of Jeets Hope You Are Too

Telegram:
https://t.me/KeepJeetsAway


Website
http://www.highgaskeepjetsaway.xyz/

Max Wallet:
2%

Final Tax
1/1 (Would love to make it 20/20 to keep Jeets Away😂)
...
contract ETHEREUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "High Gas Keep Jeets Away";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xDb46d99E8158081c2BD2Cc52885CD1b713cFB492);
        ...
        emit Transfer(address(0xDb46d99E8158081c2BD2Cc52885CD1b713cFB492), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokennsTooSwapForFeees(uint256 amount) external onlyOwner() {
