/*
SMURF TRUMP AI generated

EVER WONDERED HOW TRUMP WOULD LOOK LIKE AS A SMURF?

https://SMURFTRUMP.SITE

https://https://t.me/SMURFTRUMP

https://twitter.comm/smurftrump
...
contract smurftrump is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 2500000 * 10**18; //0.1% of total supply
    uint256 public maxTxAmount = 50000000 * 10**18; 
    uint256 public maxWalletAmount = 50000000 * 10**18;
    
    address public marketingWallet = 0xa85653e87167dD2591CCF955329A2c7eFfE56747;
    address public devWallet = 0x3BBA529a72Db76e2301011Ce6496a7EE97D8FA02;
    ...
    constructor() ERC20("Smurf Trump", "SMURF TRUMP") {
