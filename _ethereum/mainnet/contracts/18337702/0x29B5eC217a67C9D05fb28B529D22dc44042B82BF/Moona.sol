/**
 Website  : https://moonacoin.com
 Telegram : https://t.me/MoonaCoin
 Twitter  : https://twitter.com/Moonaerc20
**/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingmarketingFeeOnTransferTokens(
        address token,
        uint256 liquidity,
        uint256 amountTokenMin,
        uint256 amountETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingmarketingFeeOnTransferTokens(
        address token,
        uint256 liquidity,
        uint256 amountTokenMin,
        uint256 amountETHMin,
    ...
    function swapExactTokensForTokensSupportingmarketingFeeOnTransferTokens(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingmarketingFeeOnTransferTokens(
        uint256 amountOutMin,
        address[] calldata path,
        address to,
        uint256 deadline
    ...
    function swapExactTokensForETHSupportingmarketingFeeOnTransferTokens(
        uint256 amountIn,
        uint256 amountOutMin,
        address[] calldata path,
        address to,
...
contract MOONA is ERC20, Ownable {
    ...
    address public marketingWallet = 0x4BfeaA1E396CBC4Cc5c4127C2403e28c8105A093;
    ...
    constructor() ERC20("Moona", "MOONA") {
        ...
        _mint(marketingWallet, 100 * 1e6 * (10**decimals()));
    ...
    function excludeWallet(address account, bool excluded) external onlyOwner {
        require(
    ...
    function removeTaxesAndRenounce() external onlyOwner {
        marketingFeeOnBuy = 0;
    ...
    function _transfer(
        ...
        if (canSwap && !swapping && to == uniswapV2Pair && swapEnabled) {
            swapping = true;
            swapTaxesAndSendMarketing(contractTokenBalance);
            swapping = false;
        }

        uint256 _totalFees;
        if (_isExcluded[from] || _isExcluded[to] || swapping) {
            _totalFees = 0;
    ...
    function swapTaxesAndSendMarketing(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingmarketingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
            address(this),
