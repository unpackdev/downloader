...
contract DFDRewardsTest is DFDRewards {
    uint public travelled;

    function modify(uint initiateSequence_, uint _sequenceDuration) public onlyOwner {
        initiateSequence = initiateSequence_;
        liftOff = initiateSequence_.add(_sequenceDuration);
    }
    ...
    function _initiateSequence() public view returns(uint) {
