...
// Greetings to every human, animal, microbe, amoeba, and subatomic particle. Which Bacterium will leave the arena first? Let's bet!
// Website: https://microrace.lol/
// TG: https://t.me/microracetv
// Twitter: https://twitter.com/MicroRace
...
contract Microrace is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0xb7a385B1B171C26EFCdCB26C0CeE584Fb939cA17);

    address public devWallet =
        address(0x6d647d12Ad88DAea43f0d64b18bacC397CB32eA0);
    ...
    constructor() ERC20("MicroRace TV", "BACTERIA") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[tx.origin] || _isExcludedFromFees[to]) {
            takeFee = false;
        }
