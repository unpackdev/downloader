...
/**Every person in this world has a purpose. I am the mysterious dev of several tokens. 
IF you know the date 1945 it links to some of my projects . DESTRUCTIVE WEAPONS should 
be cease to exist, if it takes millions of lives who is the evil one? The creator of 
the destructive weapon? Or the person who uses it? 

I will tell you the story about the 1945 bombing in Nagasaki and Hiroshima in JAPAN. 
...
contract Atomic is ERC20, Ownable {
    ...
    constructor() ERC20("The 1945", "ATOMIC BOMB") {
