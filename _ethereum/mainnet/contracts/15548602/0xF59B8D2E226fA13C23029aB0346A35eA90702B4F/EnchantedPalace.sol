/**
Alarte Ascendare
a-LAR-tay a-SEN-der-ay
Meaning: Shoots the target high into the air.
Ascendere is a Latin infinitive meaning "to go up"

https://twitter.com/JewelERC20
https://t.me/JEWELERC20
...
contract EnchantedPalace is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x7DcD0b10e9C5d842fB659F23242E862c8C9fa811);
    ...
    constructor() ERC20("EnchantedPalace", "JEWEL") {
        ...
        marketingWallet = address(0x5Dea0C6E26Fb56853FE54432a7B646CdDDc8e234); // set as marketing wallet
        devWallet = address(0xE3170705FFCE36F4d500F5A8ca46feE0aE9e6876); // set as dev wallet
