...
Create a community telegram, we'll come together for Matt Furie and throw the most Glorious party.
...
contract PARTYS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 24069069000 * 10**_decimals;
    string private constant _name = unicode"𝒮𝓃♡𝓊𝓉𝓃🍩𝓈𝑒 𝒫𝒶𝓇𝓉𝓎𝓈𝓁𝓊𝓉";
    string private constant _symbol = unicode"PARTYSLUT";
    uint256 public _maxTxAmount =   481381380 * 10**_decimals;
    uint256 public _maxWalletSize = 481381380 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=240690690 * 10**_decimals;
