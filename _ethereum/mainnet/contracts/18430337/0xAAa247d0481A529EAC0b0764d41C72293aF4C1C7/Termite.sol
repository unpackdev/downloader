...
contract Termite is ERC20, Ownable {
    ...
    constructor() ERC20("Termite: AI-powered anto spam bot", "Termite") {
        ...
        maxTransactionAmount = 50_000 * 1e18; // 1.0%
        maxWallet = 100_000 * 1e18; // 2.0% 
        ...
        revShareWallet = address(0x3779a552832E9966986ddF6f5210907883b2b709); //
        teamWallet = owner(); 
