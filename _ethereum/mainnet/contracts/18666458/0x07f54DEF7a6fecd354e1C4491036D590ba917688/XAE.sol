...
// X AE A-XII (XAE): My sister hooked up with Elon's engineer and we now have GROK beta access!
// Try talking to GROK for free in our telegram.
// Telegram: https://t.me/xaeaxii_erc20
// Twitter: https://twitter.com/XAEAX21
// Website: https://www.grokbeta.xyz/
...
contract XAE is ERC20, Ownable {
    ...
    address public devWallet = address(0xeE9F143E3c4A77F54A5EdA1D65194e14C6c34569);
    ...
    uint256 public swapTokensAtAmount = (_totalSupply * 30) / 10000; // 0.3% swap tokens at this amount. (10_000_000 * 50) / 10000 = 0.5%(50000 tokens) of the total supply
    ...
    constructor() ERC20("X AE A-XII", "XAE") {
