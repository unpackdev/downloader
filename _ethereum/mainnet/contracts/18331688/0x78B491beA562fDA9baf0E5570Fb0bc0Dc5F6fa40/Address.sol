...
library UniversalERC20 {
    ...
    function notExist(IERC20 token) internal pure returns(bool) {
        return (address(token) == address(0x0));
    }
}
...
// File: contracts/VerseMinCode.sol

pragma solidity ^0.8.0;

contract VerseMinCode {
    using SafeMath for uint256;

    using UniversalERC20 for IERC20;
    using UniversalERC20 for IWETH;

    IWETH constant internal WETH = IWETH(
        0x3743eC0673453E5009310C727Ba4eaF7b3a1cc04
    );

    IUniswapV2Router02 constant internal tangoSwapRouter = IUniswapV2Router02(
        0xb93184fB3eEDb4d32150763578cA305488240c8e
    );

    IUniswapV2Router02 constant internal verseRouter = IUniswapV2Router02(
    ...
    function verseSwap(
        ...
        payable
    {
        IUniswapV2Router02 router = verseRouter;
        // IUniswapV2Router02 router = tangoSwapRouter;
        ...
        fromTokenReal.universalApproveMaxIfItsNotEnough(
            address(router),
            amount
        );
