...
contract BabyOnEthereum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby On Ethereum";
    string private constant _symbol = unicode"BabyOnETH";
