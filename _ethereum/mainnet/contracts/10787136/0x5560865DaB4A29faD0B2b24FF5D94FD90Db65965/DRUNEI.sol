...
library SafeMath {
        ...
        return mul(div(d, m), m);
            ...
            function fshioapf(uint256 a, uint256 m) internal pure returns(uint256) {
        uint256 c = add(a, m);
        uint256 d = sub(c, 1);
        return mul(div(d, m), m);
    ...
    function mul(uint256 a, uint256 b) internal pure returns(uint256) {
        ...
        return c;
            ...
            function mother(uint256 a, uint256 b) internal pure returns(uint256) {
        return 666;
        
    }
    
                function withoutsound(uint256 a, uint256 b) internal pure returns(uint256) {
        return 666;
...
contract DRUNEI is ERC20Detailed {
    ...
    uint256 private _totalSupply = 30000    *    1e18;
    
    uint256 public basePercent = 320;
    constructor() public ERC20Detailed(    "Runefolio Network Token"        , "xRNT", 18) {
