 ...
 */
contract WSTETHAggregator is OwnableUpgradeable, UUPSUpgradeable {
    ...
    IWSTETH public immutable token;
        ...
        returns (uint80 roundId, int256 answer, uint256 startedAt, uint256 updatedAt, uint80 answeredInRound)
    {
        ...
        (roundId, price,, updatedAt) = getSpot();
    ...
    function latestRoundDetails() external view returns (uint80 roundId, int256 answer, uint256 rate, uint256 updatedAt) {
        ...
        (roundId, price, rate, updatedAt) = getSpot();
    ...
    function getSpot() public view returns (uint80 roundId, uint256 price, uint256 rate, uint256 updatedAt) {
        int256 answer;
