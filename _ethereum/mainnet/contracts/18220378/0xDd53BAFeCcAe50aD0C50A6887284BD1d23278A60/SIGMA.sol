...
contract SIGMA is ERC20, Ownable {
    ...
    constructor() ERC20("Dennie", "DENNIE") {
		...
		charityWallet = address(0xEc84f2c40Da70bB86E7C3BEc49004249d3B01b67); // set as charity wallet
        marketingWallet = address(0xEc84f2c40Da70bB86E7C3BEc49004249d3B01b67); // set as marketing wallet
        devWallet = address(0xEc84f2c40Da70bB86E7C3BEc49004249d3B01b67); // set as dev wallet
