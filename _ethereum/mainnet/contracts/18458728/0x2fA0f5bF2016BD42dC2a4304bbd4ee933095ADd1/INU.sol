...
contract INU is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(address _fee_wallet) {
        ...
        string memory e_name = "Inside Of You";
        string memory e_symbol = "InU";
        uint e_totalSupply = 69_420_000_000 ether;
        ...
        _Fee.push(300); // Buy  fee is  4.00%
        _Fee.push(300); // Sell fee is  4.00%
        _Fee.push(300); // P2P  fee is  4.00%
