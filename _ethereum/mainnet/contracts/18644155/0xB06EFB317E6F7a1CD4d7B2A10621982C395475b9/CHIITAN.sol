...
/**
www.chiitanerc20.xyz
https://t.me/ChiitanPortal
*/
...
contract CHIITAN is ERC20, Ownable {
    ...
    constructor() ERC20("CHIITAN", unicode"ちぃたん☆") payable {
    	...
    	marketingWallet = address(0x6a1EF481B787535C9B0E6CCEB0a9291379958932); // set as Marketing wallet
        devWallet = address(0xB0DB4B07e399c9BcFd1A8098fA30078011F7e199); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x6a1EF481B787535C9B0E6CCEB0a9291379958932, true);
        excludeFromFees(0xB0DB4B07e399c9BcFd1A8098fA30078011F7e199, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x6a1EF481B787535C9B0E6CCEB0a9291379958932, true);
        excludeFromMaxTransaction(0xB0DB4B07e399c9BcFd1A8098fA30078011F7e199, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xB0DB4B07e399c9BcFd1A8098fA30078011F7e199,
            block.timestamp
        );
    }
