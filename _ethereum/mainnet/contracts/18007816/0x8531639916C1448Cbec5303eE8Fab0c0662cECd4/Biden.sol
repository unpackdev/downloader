...
website: https://biden.social

twiter: https://twitter.com/BidenPoterBIDEN

telegram: https://t.me/HarryBotterBIDENInuPrinter

*/

/*
Don't miss on the opportunity,to buy the official 
HarryPotterBidenInu gonna moon faster than ever
Let's go fucking the nuke market...
*/
...
contract Biden is Context, Ownable,IERC20 {
    string private constant _contract_name = "HarryBotterBIDENinu Printers";
    string private constant _contract_symbol = "Biden";
    ...
    uint256 public _limitationsForAddressSingleTxsMax = 3_000_000* 10**_contract_decimals;
    uint256 public _LimitationsTaxUsedInSlotsForSwapping= 3_000_000 * 10**_contract_decimals;   
    uint256 public _limitationsForSingleMaxTxAmounts =   3_000_000 * 10**_contract_decimals;
    ...
    address public _addressUsedInFundationFees = address(0xF2eC19849453F6e992BFade430348014B3539122);
