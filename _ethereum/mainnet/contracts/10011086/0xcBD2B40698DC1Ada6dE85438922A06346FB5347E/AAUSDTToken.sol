...
contract AAUSDTToken is PausableToken {
    string  public  constant name = "Asia Alliance USDT";
    string  public  constant symbol = "AAUSDT";
    ...
    function AAUSDTToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
