 ...
 * Pausable
 */
contract  PeerSafeLoans is WhitelistedPausableToken {
  string public constant name = "PeerSafeLoan";
  string public constant symbol = "PSL";
  uint8 public constant decimals = 18;

  // 1 billion initial supply of RTE tokens
  // Taking into account 18 decimals
  uint256 public constant INITIAL_SUPPLY = (15000) * (10 ** 18);

  /**
   * @dev  PeerSafeLoans Constructor
