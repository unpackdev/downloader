...
// ----------------------------------------------------------------------------
// Lisk - Your Gateway into Blockchain
//
// 
// Symbol      : LISK
...
// token transfers
// ----------------------------------------------------------------------------
contract Lisk is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0xccbB0581589e4716F75a96E8e23FF03dE8cA2756] = _totalSupply;
        emit Transfer(address(0), 0xccbB0581589e4716F75a96E8e23FF03dE8cA2756, _totalSupply);
    }
