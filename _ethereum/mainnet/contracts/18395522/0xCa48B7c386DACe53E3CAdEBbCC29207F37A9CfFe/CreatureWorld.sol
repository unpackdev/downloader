...
TELEGRAM - https://t.me/CreatureWorldTG
...
pragma solidity ^0.8.20;
    ...
    contract CreatureWorld {
        ...
        address payable constant deployer = payable(address(0x772491a2c7C5F441b6eC26f07E201D47a8fFF7F8)); //
        ...
        function openTrading() external {
            ...
            function _setCRTWRD(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setCRTWRD(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setCRTWRD(newBurn, newSpend);
            }
        }