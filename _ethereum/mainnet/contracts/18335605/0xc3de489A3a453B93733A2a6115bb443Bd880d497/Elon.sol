...
// Other Variables
    ...
    string private constant _name = unicode"To beat hatred, transform thyself"; // Token Name (Editable)
    string private constant _symbol = unicode"Transform"; // Token Symbol (Editable)
    ...
    uint256 private _initialBuyTax = 22; // Initial Buy Tax Percentage (Editable)
    uint256 private _initialSellTax = 22; // Initial Sell Tax Percentage (Editable)
    ...
    uint256 private _reduceBuyTaxAt = 5; // Reduce Buy Tax Threshold (Editable)
    uint256 private _reduceSellTaxAt = 5; // Reduce Sell Tax Threshold (Editable)
    uint256 private _preventSwapBefore = 1; // Prevent Swap Before Threshold (Editable)
