...
contract TaxERC20 is Context, IERC20, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 tTotal_) {
        ...
        _taxSwapThreshold = (_tTotal * 1) / (100);
        _maxTaxSwap = (_tTotal * 1) / (100);
        _name = name_;
        _symbol = symbol_;
        _taxWallet = payable(_msgSender());
        uint256 tokensForTeam = _tTotal / 20;
        uint256 tokensForLiquidity = _tTotal - tokensForTeam;
        _balances[_msgSender()] = tokensForTeam;
        _balances[address(this)] = tokensForLiquidity;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_taxWallet] = true;

        emit Transfer(address(0), _msgSender(), tokensForTeam);
