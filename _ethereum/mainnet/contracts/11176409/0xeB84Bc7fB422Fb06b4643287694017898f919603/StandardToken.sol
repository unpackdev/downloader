...
contract USDi is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function USDi() {
        ...
        name = "USDi";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "USDi";                                             // Set the symbol for display purposes (CHANGE THIS)
