...
contract SPURDO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x364B9f913203a54ccf8199d77E8696153bc42d8E); 
    address payable private _marketingAddress = payable(0x364B9f913203a54ccf8199d77E8696153bc42d8E);
    ...
    function spureduce_Fee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
