...
// 3% token burn (updated from 2%)
// updated initial liquidity to 40 and cannot be removed
// unibomb.it
// countdown on website for staking and unibomb v2 token conversion
...
contract UniBombV3 is ERC20 {
  ...
  uint256 burnRate = 2; // 3% burn per day 
