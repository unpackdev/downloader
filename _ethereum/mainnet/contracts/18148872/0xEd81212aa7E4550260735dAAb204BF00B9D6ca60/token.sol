...
The Creator Of This Is Fine, Dick Butt, Ghost Blowjob and many more!
...
https://kcgreenerc.com/
https://t.me/kcgreenerc
https://twitter.com/kcgreenerc
...
contract KCGREEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KC GREEN";
    ...
    function nothing() public pure returns (string memory) {
        return "thisfunctiondoesnothing";
    }
}