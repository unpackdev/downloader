/** 
  ...
  Website - https://butter.finance/
  Telegram - https://t.me/ButterFinanceOfficial
  Twitter - https://twitter.com/ButterBoost
...
contract ButterFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Butter Finance";
    string private _symbol = "BUTTER";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xF3638525e0698A4Dee36753D2fBc70B14902E579);
    address payable public DeveloperWallet = payable(0xF3638525e0698A4Dee36753D2fBc70B14902E579);
