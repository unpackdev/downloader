...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'BitTurbo';//change here
    string public constant _mySymbol = 'BITTURBO';//change here
    uint public constant _myinitialSupply = 1000000000000000000;//leave it
