...
contract GROOVY is Context, IERC20, Ownable {
    ...
    uint256 private constant _TotalSupply = 69000000000000000 * 10 **_decimals;
    ...
    constructor () {
        _marketingWallet = payable(0x796b85D8DeF32F64c40399B39E8395A05C48b10C);
