...
In the end, This is $Alpha is a symbol of the magical and unpredictable nature of crypto. It reminded people that even in the world of memes, where absurdity and humor reigned supreme, there could be moments of bullish green candles and incredible gains. Ape this, “This is $Alpha”!

Telegram: https://t.me/ThisAlphaErc20
Twitter: https://twitter.com/AlphaCoinErc20
Website: https://www.alphaerc.xyz/
...
contract ThisAlphaErc20 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 250000001 * 10**_decimals;
    string private constant _name = unicode"This is Alpha";
    ...
    uint256 public _taxSwapThreshold=1125000 * 10**_decimals;
