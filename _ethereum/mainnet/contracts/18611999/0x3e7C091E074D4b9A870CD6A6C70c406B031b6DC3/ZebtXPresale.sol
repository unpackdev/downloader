...
contract ZebtXPresale is Ownable {
    ...
    address public wallet = payable(0xb8C56137877012F85604aFa018E57c688054d3Ef);

    // How many token units a buyer gets per BNB & USDT
    uint256 private ethRate = 97500;
    ...
    function buyTokensWithUSDT(uint256 amount) public {
        require(hasPresaleStarted,"Presale not started");
        require(!hasPresaleEnded, "Presale has ended");
        require(amount >= 25 * 10 ** 6, "cant buy less with than 25 USDT");
