...
contract ReverseCalcium is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ɯnᴉɔʅɐɔ"; 
    string private constant _symbol = unicode"ʅɐɔ"; 
