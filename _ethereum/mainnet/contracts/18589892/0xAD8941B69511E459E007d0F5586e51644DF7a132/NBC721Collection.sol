  ...
  OperatorFilterer 
{
  ...
  function updateRoyalty(bool _enabled, address _receiver, uint96 _feeNumerator) public onlyOwner {
    operatorFilteringEnabled = _enabled;
    _setDefaultRoyalty(_receiver, _feeNumerator);
  }

  function updateOperatorFilteringEnabled(bool _enabled) public onlyOwner {
    operatorFilteringEnabled = _enabled;
  }
