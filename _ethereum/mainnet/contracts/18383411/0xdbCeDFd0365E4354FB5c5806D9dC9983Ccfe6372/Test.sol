...
contract Test is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"This Is A Test Token Do Not Ape";
    string private constant _symbol = unicode"TEST TOKEN";
    uint256 public _maxTxAmount =  _tTotal / 2000000;
    uint256 public _maxWalletSize =   _tTotal / 2000000;
    uint256 public _taxSwapThreshold=  _tTotal / 2000000;
    uint256 public _maxTaxSwap=   _tTotal / 2000000;
    ...
    constructor () {
        ...
        _teamWallet = payable(0x0096E14Dd3650336d65A75aB6204c798A5c25226);
