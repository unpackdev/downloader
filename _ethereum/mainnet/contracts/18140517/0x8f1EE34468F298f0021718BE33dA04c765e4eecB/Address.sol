...
contract NWORD is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE16706c31191f09225C914ee54f36d00De8B5ca8); 
    address payable public Wallet_Dev = payable(0x0ad2E7F42E6E95bDF388b4e51C31d84158Ff9B8c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =900000 * 10**5* 10**5 * 10**_decimals;
    string private constant _name = "NWORD COIN"; 
    string private constant _symbol = unicode"NIGA"; 
    ...
    constructor () {
        _owner =0x0ad2E7F42E6E95bDF388b4e51C31d84158Ff9B8c;
