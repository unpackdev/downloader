...
Website: https://pp-eth.com
Twitter: https://x.com/pp_erc20
Telegram: https://t.me/polypropyleneportal
...
contract PP is ERC20, Ownable {
    ...
    constructor() ERC20("Polypropylene", "PP") {
    ...
    function setFees(
        ...
        buyTax = Taxes(
            ...
            _buyLiquidity,
            _buyPp,
            _buyMarketing + _buyLiquidity + _buyPp
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellPp,
            _sellMarketing + _sellLiquidity + _sellPp
        );
    }
    ...
    function updatePp(address _ppWallet) external onlyOwner {
        ppWallet = _ppWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForPp += (fees * sellTax.pp) / sellTax.total;
                ...
                tokensForPp += (fees * buyTax.pp) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        uint256 ethForPp = ethBalance.mul(tokensForPp).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForPp;
        ...
        (ppTransferSuccess, ) = address(ppWallet).call{
            value: ethForPp
        }("");
