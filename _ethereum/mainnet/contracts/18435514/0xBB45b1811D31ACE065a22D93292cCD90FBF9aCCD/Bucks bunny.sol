...
https://banksbunny.com/
https://twitter.com/BanksBunnyBot
https://t.me/banksbunnyentry
...
contract BanksBunny is ERC20, Ownable {
    ...
    constructor() ERC20("Banks Bunny", "BANKS") {
        ...
        marketingWallet = address(0xC5d2B804D528DBf34Bc9094867FF3443a077d6Dd); 
        developmentWallet = address(0xC5d2B804D528DBf34Bc9094867FF3443a077d6Dd); 
    ...
    function BucksOn() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
