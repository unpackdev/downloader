...
contract Authenticator is Context, IERC20, Ownable {
    ...
    string private constant _name = "Authenticator";
    string private constant _symbol = "AUTH";
