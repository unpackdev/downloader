...
contract MetaRebelzV4 is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable {
    uint256 public cost;   
   ...
   /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function mint(uint256 _mintAmount, address to) external payable {
        require(mintable);
        require(!preSale);
        require(_mintAmount > 0);
        require(_mintAmount <= maxMintAmount);
        ...
        if (msg.sender != owner() || msg.sender != 0x92CEC813B1486f632C3B0963C621930Ee9503A26) {            
            require(msg.value >= cost * _mintAmount);
        }
