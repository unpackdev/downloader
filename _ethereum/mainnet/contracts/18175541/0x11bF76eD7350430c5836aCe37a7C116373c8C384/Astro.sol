...
contract ScarabICOV2 is Initializable {
    ...
    function checkMaxInvestment(
        address _user
    ) public view returns (uint256 _maxInv) {
        ...
        if (round == 1 || round == 0) {
            ...
            maxInv = Tier2maxInvestment;
            if (_balance < Tier2maxInvestment) {
                maxInv = _balance;
            }
        }
        return maxInv;
    ...
    function checkWhitelistTierWise(
        address _user,
        uint256 _tier
