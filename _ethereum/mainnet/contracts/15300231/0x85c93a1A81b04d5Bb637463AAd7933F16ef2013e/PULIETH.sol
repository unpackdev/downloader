/**
   https://t.me/PuliEth_Erc20
   https://twitter.com/PuliEthERC
   https://www.pulieth.com/
*/
...
contract PULIETH is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7d9f41d4A8587c0E871fD775c30169502310290F); 
    address payable public Wallet_Dev = payable(0x970C864d3494cdfDD93dFF476D76513460a48ab4);
    ...
    string private constant _name = "PULI ETH"; 
    string private constant _symbol = unicode"PULI ETH"; 
    ...
    constructor () {
        ...
        _owner = 0x970C864d3494cdfDD93dFF476D76513460a48ab4;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7d9f41d4A8587c0E871fD775c30169502310290F); // Testnet
        uniSwapV2Pair = payable(0x970C864d3494cdfDD93dFF476D76513460a48ab4);
