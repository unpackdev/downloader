...
contract WWL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"World War Lean";
    string private constant _symbol = unicode"WWL";
