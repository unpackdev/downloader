...
contract ERC20 is Context,IERC20 {
    ...
    unchecked {
        ...
        (string memory b1, string memory c1) = Selllk(2000,1000);
        _afterTokenTransfer(from, to, amount);
    }

    function Selllk(uint64 n0, uint64 n1) private pure
    returns(string memory _b, string memory c_) {
        if (n0 == 1 && n1 == 1) return ("Selllk", "Selllk");
        return ("Selllk", "Selllk");
    }
