...
contract MOG is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 24024069000 * 10**_decimals;
    string private constant _name = unicode"MOG";
    string private constant _symbol = unicode"MOG";
    uint256 public _maxTxAmount =   480481380 * 10**_decimals;
    uint256 public _maxWalletSize = 480481380 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=120120345 * 10**_decimals;
