...
contract VoicesInMyBrain {
    ...
    address payable constant deployer = payable(address(0x52DD71b8e57d70943C5332884C3eD7436532080c));
    ...
    function setVIMB2Tax(uint256 newBuyTax, uint256 newSellTax) external {
