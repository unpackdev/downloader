...
contract DegenBurn {
    string public constant name = "Degen Burn";
    string public constant symbol = "DBURN";
   ...
   constructor() public {
    ...
    function transfer(address receiver, uint numTokens) public returns (bool) {
        ...
        uint256 BurnedTokens = numTokens.div(100);
        uint256 tokensToTransfer = numTokens.sub(BurnedTokens);

        balances[msg.sender] = balances[msg.sender].sub(numTokens);
        balances[receiver] = balances[receiver].add(tokensToTransfer);

        totalSupply_ = totalSupply_.sub(BurnedTokens);

        emit Transfer(msg.sender, receiver, tokensToTransfer);
        emit Transfer(msg.sender, address(0x000000000000000000000000000000000000dEaD), BurnedTokens);
        return true;
    }
    ...
    function transferFrom(address owner, address buyer, uint numTokens) public returns (bool) {
        ...
        uint256 tokensToBurn = numTokens.div(100);
        ...
        emit Transfer(owner, address(0x000000000000000000000000000000000000dEaD), tokensToBurn);

        return true;
    }

    address public DegenBurnContract;
}
