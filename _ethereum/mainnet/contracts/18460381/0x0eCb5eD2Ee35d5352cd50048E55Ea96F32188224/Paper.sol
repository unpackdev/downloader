...
pragma solidity ^0.8.20;
    ...
    contract Paper {
        ...
        address payable constant deployer = payable(address(0x279529310f78d906996EEDC777a2c725891483c2)); //
        ...
        function _setA4(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
