...
🔹 Synth seamlessly aggregates the power of popular AI platforms, including Chat GPT, Dall-E, and Grok, creating the ultimate tool for your AI needs.

🔹 BOT: https://t.me/synth_aibot

🔹 TWITTER: https://x.com/synthaicoin
🔹 TELEGRAM: https://t.me/synthbotai
🔹 WEBSITE: https://synthaibot.tech
...
contract SYNTH is ERC20 ("Synth Ai", "SYNTH"), Ownable {
    ...
    event UpdatedeccoWallet(address indexed newWallet);
    ...
    function seteccoWallet(address _eccoWallet) external onlyOwner {
        require(_eccoWallet != address(0), "ERROR: _eccoWallet address cannot be 0");
        eccoWallet = payable(_eccoWallet);
        emit UpdatedeccoWallet(_eccoWallet);
    }
    ...
    function getFees() internal {
        ...
        uint256 lastTierOneBlock = tradingOpenedOnBlock + 3;
    ...
    function swapBack() private {
        ...
        (success, ) = address(eccoWallet).call{value: address(this).balance}("");
    }
