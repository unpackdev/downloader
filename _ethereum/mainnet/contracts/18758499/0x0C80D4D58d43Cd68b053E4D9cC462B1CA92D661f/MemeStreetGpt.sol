...
Telegram
https://t.me/MemeStreetGpt

Website
https://www.memestreetgpt.xyz/
...
contract MemeStreetGpt is Context, IERC20, Ownable {
    ...
    string private constant _name = "Memes Street Gpt";
    string private constant _symbol = "MemeGPT";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x940E58C54E0e6a9826D4266d734613920C86acec);
        ...
        emit Transfer(address(0x940E58C54E0e6a9826D4266d734613920C86acec), _msgSender(), _tTotal);
    }
    ...
    function setMxTokenssTooSwapsFrFees(uint256 amount) external onlyOwner() {
