...
contract PEPE  is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe on SHIBASWAP", "PEPEs") {
        ...
        maxWallet = totalSupply * 10 / 1000; // 100% 
        ...
        marketingWallet = address(0x2d948b90b2f630Eac6e962eC8FDa8540CB8B4c0a);
        devWallet = address(0x2d948b90b2f630Eac6e962eC8FDa8540CB8B4c0a);
