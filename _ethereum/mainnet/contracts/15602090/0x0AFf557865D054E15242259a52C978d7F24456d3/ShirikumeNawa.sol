...
Shirikume nawa is put at the entrance door to keep misfortune and unclean spirits away.
...
contract ShirikumeNawa is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shirikume Nawa", "Shimenawa") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x1fD09943d6D7D7D274167784C6Bb153FcA12DeBc); // marketing wallet
        devWallet = address(0x1fD09943d6D7D7D274167784C6Bb153FcA12DeBc); // dev wallet
