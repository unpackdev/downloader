/**
            NOᴚƎԀƎԀ, an ERC-20 standard token, 
            is designed to cater to the diverse 
            needs of the DeFi community, empowering 
            developers and users alike. Leveraging the 
            Ethereum network's well-established infrastructure, 
            INOᴚƎԀƎԀ promises to enhance security, efficiency, 
            and utility while embracing the core principles of decentralization.

https://peperoni20.com

https://twitter.com/peperonierc

https://t.me/PeperoniErcPortal
...
contract INOREPEP is Ownable {
    ...
    string private _cigzyxas = unicode"INOᴚƎԀƎԀ ";
    string private _zvxtgilo = unicode"INOᴚƎԀƎԀ$ ";
