...
contract XRPTRUST is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"XRP Trust";
    string private constant _symbol = unicode"XRPT";
