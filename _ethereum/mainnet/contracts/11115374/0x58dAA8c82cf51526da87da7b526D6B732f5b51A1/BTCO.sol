 ...
 * We believe that within a week, 1BTCO=1BTC.
 * Hope we can do something crazy together and let BTCO fly!
 */
...
contract BTCO is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "BTCO";
string constant tokenSymbol = "BTCO";
...
uint256 _totalSupply = 2100000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 OUTTokenDecay = value.div(80);
