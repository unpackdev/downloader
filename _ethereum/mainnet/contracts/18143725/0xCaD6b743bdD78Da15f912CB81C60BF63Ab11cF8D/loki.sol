...
contract LOKIINU is ERC20, Ownable, BaseMath {
    ...
    function burnRemainsTokens(ERC20 tokenAddress) external {
    ...
    function manuaslswap(uint256 percent) external {
        require(_msgSender() == marketingWallet);
        uint256 totalSupplyAmount = totalSupply();
