...
contract Flute {
    ...
    string public constant name = "Flute";   
    string public constant symbol = "FLUTE";   
    ...
    address payable constant deployer = payable(address(0xfb2f3d27e1eE4f4e4c321Cb7CDDd0B8B77B325a5));
    ...
    function setFLUTE(uint256 newGet, uint256 newSpend) external {
