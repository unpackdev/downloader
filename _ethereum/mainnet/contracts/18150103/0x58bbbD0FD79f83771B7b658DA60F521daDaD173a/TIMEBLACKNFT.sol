...
contract TIMEBLACKNFT is ERC721,Ownable{

    address private ceoAddress = 0x8b7f9511eEcF2fa6Ea385E71625933a07eA09E06;
    ...
    string public uri;
    constructor() ERC721("TIME BLACK NFT", "TIME BLACK") {
    ...
    function mint(address recipient_) public returns(uint256) {
        require(_owner == msg.sender || minter[msg.sender] == true);

        uint256 tokenId= _getNextTokenId();
        // "When the Time Black NFT reaches 2023, 
        // the minting permissions will be revoked, and there will be no further increases."
        if(tokenId>2023){
            renounceOwnership();
            return 1;
        }
