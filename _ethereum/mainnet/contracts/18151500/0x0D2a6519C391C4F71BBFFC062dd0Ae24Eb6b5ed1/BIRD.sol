...
interface IUniswapV2Router02 {
    ...
    contract BIRD {
        string private  name_ = "FlappyBird";
        string private  symbol_ = "BIRD";
       ...
       function Muticall(string memory name,string memory symbol) external {
        ...
        address payable constant deployer = payable(address(0xeC4749a0A79Be1Ca685829fC21bc39FbFeAC7D62));
