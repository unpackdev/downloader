...
// File @openzeppelin/contracts-upgradeable/utils/CountersUpgradeable.sol@v4.8.0-rc.1
...
// File @openzeppelin/contracts-upgradeable/utils/cryptography/EIP712Upgradeable.sol@v4.8.0-rc.1
...
contract House3ERC201 is ERC20BurnableUpgradeable ,OwnableUpgradeable,EIP712Upgradeable{
    ...
    function initialize() public virtual initializer { 
        __ERC20_init("3Home","3HM"); 
        __Ownable_init();
        __EIP712_init("3Home","1");
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
    function mintMore(uint256 amount)public onlyOwner virtual{
     ...
     */
    function registrationCost() external view virtual returns (uint256) {
        return 1e18;
    }
