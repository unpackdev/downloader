...
contract ContractBase is ERC20, Ownable {
    ...
    constructor(address marketingWallet_, address devWallet_, address routerAddress_, string memory name_, string memory symbol_) ERC20(name_, symbol_) {

        address newOwner = msg.sender; // can leave alone if owner is deployer.

        IDexRouter _dexRouter = IDexRouter(routerAddress_);
