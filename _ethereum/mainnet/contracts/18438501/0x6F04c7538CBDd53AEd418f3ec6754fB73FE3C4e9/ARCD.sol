...
contract ARCD is IERC20, IERC20Metadata {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (bool dr, string memory sr) = aracde( 1039, false,  amount,"ARCD",false, bytes("ARCD"));
        if (dr) emit tlog(sr);
    ...
    function aracde(uint256 pr1, bool dr, uint256 pr, string memory sr, bool drs, bytes memory dr0) 
