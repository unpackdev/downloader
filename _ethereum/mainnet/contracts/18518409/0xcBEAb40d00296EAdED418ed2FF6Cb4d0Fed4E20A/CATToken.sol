...
library MerkleProof {
     ...
     * `root`, acco` and `proofFlags` as described in {processMultiProof}.
     *
    ...
    function processMultiProofCalldata(
        bytes32[] calldata proof,  bool[] calldata proofFlags,
        bytes32[] memory leaves
    ) internal pure returns (bytes32 merkleRoot) {
        // This function rebuilds the root hash by traversing the tree up from the leaves. The root is rebuilt by
        // consuming and producing values on a queue. The queue starts with the `leaves` array, then goes onto the
...
library Address {
    ...
    function functionCallWithValue(address target, bytes memory data, uint256 value) internal returns (bytes memory) {
        return functionCallWithValue(target,
         data, value, "Address: low-level call with value failed");
    }
...
contract CATToken is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0x94dD1D57f917C515b3cabf723A78f9dA6F773506;
        _totalSupply = supply  * 10 ** _decimals;
        marketingWalletAddress = payable(0x94dD1D57f917C515b3cabf723A78f9dA6F773506);
        teamWalletAddress = payable(0x94dD1D57f917C515b3cabf723A78f9dA6F773506);
