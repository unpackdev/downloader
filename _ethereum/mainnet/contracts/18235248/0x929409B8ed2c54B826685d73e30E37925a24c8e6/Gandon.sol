...
contract Gandon is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dumbledore";
    string private constant _symbol = unicode"GANDON";
    uint256 public _maxTxAmount =   7500 * 10**_decimals;
    uint256 public _maxWalletSize = 11250 * 10**_decimals;
