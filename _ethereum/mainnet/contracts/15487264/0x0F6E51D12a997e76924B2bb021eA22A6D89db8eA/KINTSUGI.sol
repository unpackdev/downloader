...
/*
https://medium.com/@KINTSUGIeth/kintsugi-4add545bea6e
*/
...
contract KINTSUGI is IERC20, Ownable {
    ...
    uint256 private swapThreshold = ( _totalSupply * 500 ) / 1000000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal development_receiver = 0xD3cBB1bB760D90aF8A98646fF77E34205e794Dd4;
    address internal marketing_receiver = 0xD3cBB1bB760D90aF8A98646fF77E34205e794Dd4;
    address internal liquidity_receiver = 0xD3cBB1bB760D90aF8A98646fF77E34205e794Dd4;
