...
contract XYZInu is ERC20, Ownable {
    ...
    constructor() ERC20("XYZInu", "XYZinu") {
        ...
        swapTokensAtAmount = (totalSupply*2) / 1000; // Whatever dumdum
        ...
        marketingWallet = address(0xF90e08fC7bAad77f58df9B5B95025264AFCbca87); // set as marketing wallet
        devWallet = address(0x6F526236Af1B957737A3dE51626Fb4F82527f671); // set as dev wallet
