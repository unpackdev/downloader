...
/* INSIDOOOR: https://twitter.com/Veronic59122266/status/1553929330698469376
*/
...
contract NANCY is IERC20, Auth {
	string _name = "NANCY";
	string _symbol = "INSIDOOR";
	...
	address payable private _ethTaxWallet1 = payable(0x257F51898e1151B4DeB063F7eB63c749720C3878); 
	address payable private _ethTaxWallet2 = payable(0x257F51898e1151B4DeB063F7eB63c749720C3878); 
	address payable private _ethTaxWallet3 = payable(0x257F51898e1151B4DeB063F7eB63c749720C3878); 
	address private _tokenTaxWallet = address(0x257F51898e1151B4DeB063F7eB63c749720C3878); 
