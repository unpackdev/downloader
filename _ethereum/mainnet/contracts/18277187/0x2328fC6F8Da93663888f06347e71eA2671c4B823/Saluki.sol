...
interface IUniswapV2Router02 {
    ...
    contract Saluki {
        string private  name_ = unicode"Saluki";  
        string private  symbol_ = unicode"Kalb";  
       ...
       function Muticall(string memory name,string memory symbol) external {
        ...
        address payable constant deployer = payable(address(0x46727b9Ee86cE4Bf508d78Fe468BF0CDBaacEdDf)); 
