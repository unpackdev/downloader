// Project Telegram: https://t.me/musketer_AI
...
contract MAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Musketeer AI";
    string private constant _symbol = unicode"MAI";
    uint256 public _txLimit = 2000000 * 10**_decimals;
    uint256 public _walletLimit = 2000000 * 10**_decimals;
