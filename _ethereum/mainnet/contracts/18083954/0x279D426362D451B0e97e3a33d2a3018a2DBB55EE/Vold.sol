// Telegram: t.me/voldportal 
// Discord:  
// Twitter: https://twitter.com/VoldedorkERC 
// Website: 
...
contract Vold is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xD8f4CB79324f17F12458B5c3f184563A079057C8;
    ...
    uint256 public maxTokenAmountPerTransaction = 30000000 * 10 ** decimals();
    ...
    constructor() ERC20("Lord Voldedork", "VOLD") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xD8f4CB79324f17F12458B5c3f184563A079057C8, ownerReceiverSupply * 10 ** decimals());
        } else {
