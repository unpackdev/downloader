...
/*  
    $rugg will leave you with nothing
    telegram: t.me/ruggcoin
...
contract Rugg is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"Rugg Coin";
    string private _symbol = unicode"RUGG";
