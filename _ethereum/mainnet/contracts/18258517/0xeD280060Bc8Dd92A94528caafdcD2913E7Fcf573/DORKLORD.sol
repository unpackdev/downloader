// Telegram Channel : https://t.me/ercdorklord

// Twitter : https://twitter.com/dorklorderc
...
contract DORKLORD is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"DORKLORD", "DORKLORD") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x04Ac7F25b29FaD95c12A0D6eb3ae92c54D411a7C;
