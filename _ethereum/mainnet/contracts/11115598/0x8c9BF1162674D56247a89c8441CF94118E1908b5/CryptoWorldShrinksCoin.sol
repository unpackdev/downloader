...
contract CryptoWorldShrinksCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Crypto world shrinks coin";
string constant tokenSymbol = "CWSC";
