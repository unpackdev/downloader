...
https://x.com/alex_hugh3s/status/1699338990531325980?s=46&t=Yt1bwL9_vfXxzxIBMvI14A

FIN THE FINTASTIC Matt_Furie art


TG: https://t.me/FINTASTICERC
TW: https://x.com/fintasticerc
*/
...
contract FIN is Context, IERC20, Ownable {
    string private _name = "FIN THE FINTASTIC FLIPPER";
    ...
    constructor() {
        ...
        marketingWallet = address(0x505a3e617235cdc7E465Ec3e2048bC027f6aCdAF);
    ...
    function removeStuckEths(address _receiver) public onlyOwner {
