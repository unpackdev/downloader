/** ANOTHER DAY
     ...
     This right here is the website https://anotherpepecoin.com/ the nxt is telegram 

     check this ... tg https://t.me/anotherpepecoin wait i also
     think we made twitter  i mean x

     here https://x.com/anotherpepevip follow follow 
...
contract AnotherPepe is Context, IERC20, Ownable {
    ...
    string private _name = "Another PEPE";
    string private _symbol = "APEPE";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x1A819Be8aA3f1Ed359269f70A4775Fe587099549);
    address payable public DeveloperWallet = payable(0x1A819Be8aA3f1Ed359269f70A4775Fe587099549);
