...
/**
 * https://t.me/CrazyBurningCoin
 * CrazyBurningCoin
 * Transaction consumption: 5%
 * Lock in liquidity: 6 hours
 * Reward: ETH + ETHHK
 * For specific rewards, please go to the community to find out!
 */
...
contract CrazyBurningCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "CrazyBurningCoin";
string constant tokenSymbol = "CBCN";
