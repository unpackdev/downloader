...
WEB - https://aggregatorbot.com/
TG - https://t.me/aggregatorbotportal
TWITTER - https://twitter.com/Aggregator_Bot

OUR BOT - https://t.me/AggregatorBot_bot
...
contract AGG is Context, IERC20, Ownable {
    ...
    string private constant _name = "AggregatorBot";
    string private constant _symbol = "AGGBOT";
    ...
    function excludedFromFees(address wallet) external onlyOwner {
