...
abstract contract UniswapV3likeFeeOnTransferAdapter is AvabotFeeOnTransferAdapter {
    ...
    function _swap(
        ...
        QParams memory params = getQParams(IERC20(_tokenIn).balanceOf(address(this)), _tokenIn, _tokenOut);
    ...
    function _underlyingSwap(
        ...
        return IERC20(params.tokenOut).balanceOf(address(this)) - balanceBefore;
    }
