...
contract Ownable is Context {
  ...
  }abstract contract StakeBLVRD2Token {
...
/**
 * @dev Implementation of the  BLVRD2Token
 * BLVRD2 is a price-reactive cryptocurrency.
...
contract Token is Ownable, IERC20 {
  ...
  string public constant _name = "BLVRD2Token";
  string public constant _symbol = "BLVRD2";
  uint8 public constant _decimals = 18;

  StakeBLVRD2Token public _stakingContract;
  ...
  constructor () public {
    ...
    _treasuryWallet = 0x304fc201d04379AB73BAa54e5Fda1296772eF299;
    _teamWallet = 0xA4466051bfd7bf3a1e96ef60b21F915343f39302;
  ...
  function updateStakingContract(StakeBLVRD2Token stakingContract) external onlyOwner {
