...
contract VhilsBurn is Ownable2Step, ERC721Holder, ERC1155Holder {
  ...
  constructor() {
    ...
    editions[1] = Edition(true, 20, 0, 1696032000, 1696636800, 0.3 ether);
    editions[2] = Edition(true, 20, 0, 1696032000, 1696636800, 1 ether);
  }
  ...
  function _burnToken(address _account) internal {
    ...
    // 1 = alpha, 2 = beta
    IERC1155(vhilsUtility).safeTransferFrom(address(this), _account, 1, utilityAmount, "");
