...
contract MEVFree is Context, IERC20Upgradeable {
    ...
    uint256 private _startingSupply = 420000000;
    ...
    uint256 private _decimalsMul = 6;
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            _routerAddress = 0x86dcd3293C53Cf8EFd7303B57beb2a3F671dDE98;
        } else {
            revert();
        }
        ...
        _marketWallet = payable(_owner);
        _devWallet = payable(_owner);
    }

    receive() external payable {}

    function LaunchToken() external onlyOwner {
        require(!contractInitialized, "Already initialized");

        _tTotal = _startingSupply * (10**_decimalsMul);
        ...
        maxTxAmountUI = (_startingSupply * 10) / 1000;
        _maxWalletSize = (_tTotal * 10) / 1000;
        maxWalletSizeUI = (_startingSupply * 10) / 1000;
...
//===============================================================================================================
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        _maxTxAmount = check;
        maxTxAmountUI = (_startingSupply * percent) / divisor;
    }
    ...
    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        maxWalletSizeUI = (_startingSupply * percent) / divisor;
    }
