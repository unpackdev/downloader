...
https://grok-killer.vip
https://twitter.com/chainsawgrook
https://t.me/chainsawgrok
...
contract GrokKiller is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x55E955e272Ae2142e1D0973d43E5c3267e51248f);
    uint256 private _finalBuyTax=25;
    uint256 private _finalSellTax=36;
    ...
    function chainsaw(uint256 grokkiller) external onlyOwner {
        enabled = grokkiller;
    }
