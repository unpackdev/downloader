...
TELEGRAM: https://t.me/PomCatPomChiSister
3% TAX WILL BE ADDED TO POMCHI LIQUIDITY, Believe in the memes.
...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = 0xA2e3411ac72A582c4A8e6B6A2F74e6D1ef64B88A;
...
contract POMCAT is Context, IERC20, Ownable {
    ...
    string private _name = "POMCAT";
    string private _symbol = "POMCAT";
    ...
    address payable private dev_wallet =
        payable(0xA2e3411ac72A582c4A8e6B6A2F74e6D1ef64B88A);
    ...
    address private _authorized = 0xA2e3411ac72A582c4A8e6B6A2F74e6D1ef64B88A;
