...
contract Elcanrebat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Elcanrebat", "El") {
     ...
     uint256 totalSupply = 2 * 10 ** 9 * 10 ** decimals();
 
        maxTransactionAmount = 20 * 10 ** 6 * 10 ** decimals(); // 1% maxTransactionAmountTxn
        maxWallet = 40 * 10 ** 6 * 10 ** decimals(); // 2% maxWallet
    ...
    function destroythebots (address account, bool isBlacklisted) public onlyOwner {
