...
pragma solidity ^0.8.20;
    ...
    contract Groooook {
        string public constant name = "Groooook.io";  //
        string public constant symbol = "Groooook";  //
        ...
        address payable constant deployer = payable(address(0x5eb763cB0010253e1C1C2499946Bb22f31C905D9)); //
        ...
        function _setRedeemBurn(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
