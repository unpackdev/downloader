...
// File: GenerativeProtocolNEW.sol
...
/// @custom:security-contact info@generativeprotocol.xyz
contract GenerativeProtocol is ERC20, Ownable {
    constructor(address initialOwner)
        ERC20("Generative Protocol", "GEN")
