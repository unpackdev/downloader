...
// https://www.thefutureismodular.com/
// https://twitter.com/TIAERC20
// https://t.me/TIAERC20
...
contract tia is ERC20, Ownable(msg.sender) {
    ...
    constructor(IUniswapV2Router02 _uniswapRouter, address[] memory _musas) 
                ERC20("TiaTheFutureIsModular", "TIA") {
        ...
        maxTransactionAmount = totalSupply * 75 / 10000; 
        maxWallet = totalSupply * 75 / 10000; 
