...
https://onlyupcoin.vip/
https://t.me/OnlyUpGreen 
...
contract UP is ERC20, Ownable {
    ...
    constructor() ERC20("ONLY UP", "UP") {
        ...
        maxWallet = 9913800000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xc7c4451d48357A4DFf6176852bA545b4a4e0Fdef); // 
        marketingWallet = address(0xc7c4451d48357A4DFf6176852bA545b4a4e0Fdef); // 
        devWallet = address(0xc7c4451d48357A4DFf6176852bA545b4a4e0Fdef); // 
