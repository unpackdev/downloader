...
▀▀███▀▀▀     ███▌ ▀▀███▀▀▀     ▀███████████ ▀▀███▀▀▀     ▀███████████ ███   ███ 
  ...
  ███        █▀     ███          ███    █▀    ███          ███    █▀   ▀█   █▀  
    ...
    ---------------
    Website: fifafan.club
    Twitter: twitter.com/FIFAFan_club
    Medium: medium.com/@FIFAFan_club
    Telegram: t.me/fifafanclub
...
contract FifaFanClub is ERC20, Ownable {
    ...
    constructor() payable ERC20("Fifa Fan Club", "FIFAFAN") {
        ...
        swapTokensMaxAmount = (totalSupply * 5) / 1000; // 0.5%
        ...
        operationsAddress1 = address(0xE8FEa59AFb634E57e5D474Db183ebcffd715Fc41);
        lpReceiverAddress = address(0x0D41F1F83F79D13c9616b4BCFd82E4f76558EE8F);
    ...
    function setSellingEnabled(bool confirmSellingEnabled) external onlyOwner {
        ...
        sellingEnabled = true;
        removeLimits();
        swapTokensMaxAmount = totalSupply();
