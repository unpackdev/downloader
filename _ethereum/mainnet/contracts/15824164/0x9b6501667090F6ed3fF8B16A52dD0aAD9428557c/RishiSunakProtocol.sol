...
// Let's welcome the new British PM
...
contract RishiSunakProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rishi Sunak Protocol";
    string private constant _symbol = "RSP";
