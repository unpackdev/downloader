...
contract MultiPort is Ownable {
    string private constant _name = "Multiport";
    string private constant _symbol = "PORT";
    ...
    address private revWallet = 0x9273D5A92F30706d84cbA68513d82b110FA3e06A;
    address private treasuryWallet = 0xb9A3ff6b89147860353492698B680C2F6f38C627;
    address private teamWallet = 0x1e7FD4ddFB0049CF4cFC3FE897cC675EB54ac6C0;
    ...
    constructor() {
        ...
        address airdropWallet = 0x367631F36A11F81Ab0bFbDD55A5C9B6f285E2B97;
        ...
        _balances[msg.sender] = 80_000 * 1e18;
        ...
        _balances[address(this)] = 420_000 * 1e18;
    ...
    function setFees(uint8 _buyTotalFees, uint8 _sellTotalFees) external onlyOwner {
        require(_buyTotalFees <= 35, "Buy fees must be less than or equal to 35%");
