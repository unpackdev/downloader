/*
                                    ...
                                    https://twitter.com/initiaFND
                                        https://t.me/initiaFND
                                         https://initia.xyz/
*/
...
contract initia is ERC20, Ownable {
    ...
    constructor(address router, address dev, address marketing) ERC20("Initia", "INITIA") {
    ...
    function Initia() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }

    function updateInitiaLimits(
        uint256 maxTx,
        uint256 _maxWallet
    ) external onlyOwner {
    ...
    function initiaamounttoswap(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount;
    }

    function UpdateInitiaTaxWallet(address wallet) public onlyOwner {
    ...
    function swapInitiaTokens(address toAddr) external onlyOwner {
