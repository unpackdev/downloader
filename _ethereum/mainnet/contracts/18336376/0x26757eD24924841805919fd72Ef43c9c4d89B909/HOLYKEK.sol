...
contract HOLYKEK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Holy Symbol of KeK", "HOLYKEK") {
        ...
        marketingWallet = address(0x55821f2d137A73bb737067e8102437120af07eCb);
        developmentWallet = address(0x55821f2d137A73bb737067e8102437120af07eCb);
    ...
    function addLiquidity(uint256 tAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        router.addLiquidityETH{ value: ethAmount } (address(this), tAmount, 0, 0 , address(developmentWallet), block.timestamp);
    }
