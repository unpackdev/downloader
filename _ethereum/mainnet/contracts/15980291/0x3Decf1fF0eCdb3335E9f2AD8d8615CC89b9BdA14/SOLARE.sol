...
contract SOLARE is Context, IERC20, Ownable {
    ...
    string private _name = "Solare";
    string private _symbol = "SOLARE";
    ...
    address payable public marketingWallet = payable(0xE8765cac3dd888161919DA681a98eCa92aa317a1);
