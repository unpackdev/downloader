...
contract P33rEscrowV1 is Ownable, ReentrancyGuard {
    ...
    // ERC20 fee balance
    mapping(ERC20 => uint256) public _feeBalance;
    ...
    event WithdrawnFee(address indexed recipient, ERC20 token, uint256 amount);
    ...
    function refund(bytes32 referenceId) external onlyOwner nonReentrant {
        ...
        SafeERC20.safeTransfer(token, depositor, refundedAmount);
