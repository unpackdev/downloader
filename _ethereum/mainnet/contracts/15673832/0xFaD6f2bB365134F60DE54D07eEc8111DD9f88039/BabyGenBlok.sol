...
contract BabyGenBlok is IERC20, Ownable {
    ...
    string constant _name = "The Baby Genesis Block";
    string constant _symbol = "BabyGenBlok";
    ...
    uint256 totalFee = 20;      // liquidityFee + developmentFee + reflectionFee + marketingFee
    ...
    uint256 swapThreshold = _totalSupply.mul(631749274).div(100000000000); // ~0.6%
    ...
    constructor () {
        ...
        _maxWalletSize = (_totalSupply * 5) / 1000; // 0.5% of Total supply
    ...
    function adjustFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator / 5); // fee cannot be > 20%
    }
