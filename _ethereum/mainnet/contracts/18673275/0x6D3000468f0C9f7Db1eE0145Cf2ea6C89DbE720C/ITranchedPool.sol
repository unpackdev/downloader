...
interface ITranchedPool is ILoan {
  ...
  /// @param _reservePercent percent (whole number) of interest that goes to the reserves. Valid range is [0,100], with
  ///   the exception of -1, which is a sentinel value that will use the default global value in GoldfinchConfig.
