...
contract UselessUtility is ERC20, Ownable {
    ...
    constructor() ERC20("Useless Utility", "UU") {
        ...
        maxTransactionAmount = 1_000 * 1e18; // 1%
        maxWallet = 1_000 * 1e18; // 1% 
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% 

        buyRevShareFee = _buyMarketingFee;
        ...
        revShareWallet = address(0xDC824291F53367e9877e3AFfFeEe0ff23d8C932e); // set as marketing wallet
    ...
    function withdrawStuckUU() external onlyOwner {
