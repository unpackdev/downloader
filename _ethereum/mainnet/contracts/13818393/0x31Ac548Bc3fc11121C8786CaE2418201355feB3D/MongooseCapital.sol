/* 
Congress is showing their hand by trying to regulate away the new found freedom DeFi has brought to millions—before 
the entrenched institutions lose their control. 

We cannot let them get away with it.
Congressman and Mongoose coin inspired a decentralised passive income protocol that is here to prove the government
how wrong they are and that DeFi is here to stay and nothing can ever stop it ! !

Buy MONGOOSECAP, hold it and relax while professional investors farm and trade treasury funds across multiple chains

All profits generated will be distributed daily  to MONGOOSECAP Holders!

Join Us
https://t.me/MongooseCapital
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a MONGOOSECAP shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract MongooseCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Mongoose Capital";
    string private constant _symbol = "MONGOOSECAP";
    ...
    address payable public marketingWallet = payable(0x575538a245DB49C080616097136df60DcA523818);
    address payable public treasury = payable(0x39EBdacAB0c72A5Edd1DcADACC441d3C1364E8aD);
