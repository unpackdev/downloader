...
*/
/** 
  * @title SHiELDxAGExSPECIAL by Art Tokyo Global
  * @author 0xjikangu
*/

contract SHiELDxAGExSPECIAL is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {

  using Strings for uint256;

  string public uriPrefix = "ipfs://QmVo3EP8qRRvBbhfxaDNv3Yx6vfqnNPiMCNcqfHbDF911K/";
