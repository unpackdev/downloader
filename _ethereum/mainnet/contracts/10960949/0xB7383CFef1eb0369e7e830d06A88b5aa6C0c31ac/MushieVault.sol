...
contract MushieVault is ERC20, ERC20Detailed, Ownable {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    string private constant NAME = "Mushie Fungi";
    string private constant SYMBOL = "Fungi";
    uint8 private constant DECIMALS = 18;
    address private constant ADDRESS_TOKEN = 0x53a68E70E7daB2105df15ecF0f142967902203fb;    // MUSH
    address private constant ADDRESS_VAULT = 0xaFeADBDd8655D3b5db556DADAa080C0B01E4f08C;    // TrippyPool
