...
interface IMstWrapper {
    ...
    /**
     * @notice Cannot migrate zero shares
     */
    error NoSharesToMigrate();
    ...
    /**
     * @notice Emitted when shares are migrated to native deposit token
     *
     * @param account Account
     * @param tokens Tokens migrated
     */
    event Migrated(address indexed account, uint256 tokens);
     ...
     * @return Deposit share price as a fixed point 18 decimal
     */
