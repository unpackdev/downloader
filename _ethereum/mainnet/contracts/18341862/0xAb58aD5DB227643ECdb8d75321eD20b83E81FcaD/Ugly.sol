...
// Telegram: https://t.me/uglyportal 
// Discord:  
// Twitter: https://twitter.com/SBFiloveyou 
...
contract Ugly is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xE9474904793118C0B62fadcb1824415CE325Ca4c;
    ...
    constructor() ERC20(unicode"Ugly", unicode"UGLY") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xE9474904793118C0B62fadcb1824415CE325Ca4c, ownerReceiverSupply * 10 ** decimals());
        } else {
