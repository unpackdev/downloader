...
contract poobs is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmZU6h1b9Srf1CALZjJ7eDQN9MVjEAjPoEKMdYDUwuLjKH/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("poobs", "poobsnft", MAX_MINTS, MAX_SUPPLY) {  
    }
