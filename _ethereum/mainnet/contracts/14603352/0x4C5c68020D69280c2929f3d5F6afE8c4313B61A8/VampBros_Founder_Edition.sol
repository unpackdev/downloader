...
// File: contracts/VampBros_Founder_Edition.sol



pragma solidity >=0.7.0 <0.9.0;

contract VampBros_Founder_Edition is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("VampBros Founder Edition", "VB") {
    setHiddenMetadataUri("ipfs://QmPvwbJrbErothoy2zXooSTN7neqC7ZZR5mgscEzAB1zRN/hidden.json");
  }
