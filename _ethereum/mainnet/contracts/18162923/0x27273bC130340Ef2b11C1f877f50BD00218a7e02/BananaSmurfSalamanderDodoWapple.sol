/**                                                                                                                                                                                                                                                                                                                                                                                        
Get $wNANA or COPE later

TG: https://t.me/BananaSmurfSalamanderDodoWapple


Twitter:  https://twitter.com/BSSDWcrypto
...
contract BananaSmurfSalamanderDodoWapple is ERC20, Ownable {
    ...
    constructor() ERC20("BananaSmurfSalamanderDodoWapple", "wNANA") {
        ...
        marketingwallet = address(0x978EFFd17F8F91F7CE8Fd24f56768031F140E7EB); 
        devWallet = address(0x06F35c41763D71eF5031602917A9EcC7bEAF8c77); 
        lpWallet = address(0x0f9840C99D13eC1EF026757909A6A2CDcE48095f); 
        burnWallet = address(0xE24aF4FcfCb9AA7D65d965fA79addAf4c237DBCB);
        teamWallet = address(0x3400B37E80330848FD36B71ca7235B25b332EbF4);
        ...
        excludeFromFees(address(lpWallet), true);
        ...
        excludeFromMaxTransaction(address(lpWallet), true);
        ...
        excludeFromMaxWallet(address(lpWallet), true);
