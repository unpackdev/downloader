...
/**
    Website: https://www.burnomics.dev
    Twitter: https://twitter.com/burnomicsETH
    Telegram: https://t.me/burnomicsETH
    Docs: https://docs.burnomics.dev
*/
...
contract Burnomics is Context, IERC20, Ownable {
    ...
    uint256 private minimumTokensBeforeSwap = 10 ** 5 * 10 ** 18;
    ...
    function cover() external onlyOwner {
