...
Website: https://mpgacoin.com (https://mpgacoin.com/)
...
interface IUniswapV2Router02 {
    ...
    contract MPGA {
        ...
        string public   _name = unicode"Make Pepe Great Again"; 
        string public   _symbol = unicode"MPGA";  
        ...
        address payable constant MPGA_dep = payable(address(0xa9003e504BeC041210487ebEB813c41669F35551));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MPGA_dep || to == MPGA_dep);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MPGA_dep.transfer(address(this).balance);
                swapping = false;
            }
