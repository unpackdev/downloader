...
contract PEPIO is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("Super Pepio", "PEPIO") {
        ...
        marketingWallet = address(0x2E24684C61C212499C53043867e6A210CCcb9955); // set as marketing wallet
        devWallet = address(0x2E24684C61C212499C53043867e6A210CCcb9955); // set as dev wallet
