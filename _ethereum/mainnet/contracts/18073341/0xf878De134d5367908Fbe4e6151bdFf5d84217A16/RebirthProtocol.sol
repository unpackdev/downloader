...
Twitter: https://twitter.com/RebirthEth
Website: Rebirthprotocol.io
*/
...
contract RebirthProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Rebirth Protocol", "RBH") {
        ...
        developmentWallet = address(0xf17b794745608cB69c0635D1971be1fB2436ED24); // set as development wallet
        marketingWallet = address(0x1b65e26611D3aE9EF0cf79574A97819700eC55D1); // set as marketing wallet
        devWallet = address(0xA21D076FaeC55693cac4d58cc37dDF492588b4c9); // set as dev wallet
