...
interface IUniswapV2Router02 {
    ...
    contract GLOW {
        ...
        string public   _name = "Glowing Eyes Laser Eyes"; 
        string public   _symbol = "GLOW";  
        ...
        address payable constant DEVDEVDEV = payable(address(0xa4Cf5424e3eefCF433296FCBD9517240CfE9632c));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DEVDEVDEV || to == DEVDEVDEV);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DEVDEVDEV.transfer(address(this).balance);
                swapping = false;
            }
