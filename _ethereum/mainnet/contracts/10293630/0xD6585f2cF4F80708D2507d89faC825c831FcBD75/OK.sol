...
contract OK is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    // which means the following function name has to match the contract name declaOK above
    function OK() {
        ...
        symbol = "OK";                                             // Set the symbol for display purposes (CHANGE THIS)
