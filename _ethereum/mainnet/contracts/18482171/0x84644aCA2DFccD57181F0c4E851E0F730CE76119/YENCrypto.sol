...
contract YENCrypto is Context, IRankedMintingToken, IStakingToken, IBurnableToken, Ownable, ERC20("YEN Crypto", "YEN") {
    ...
    uint256 public constant MIN_TERM = 3 * SECONDS_IN_DAY - 1;
    ...
    modifier chargeFee(){
        //require(msg.value >= 0.005 ether, "insufficient fee");//eth
        require(msg.value >= 0.05 ether, "insufficient fee");//bsc
