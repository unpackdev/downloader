...
// Discord:  
// Twitter:  
// Website: https://www.thecollectorerc20.com/
...
contract TheCollector is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x0FDF71b9cDd65fb72e4cb905a16468f1706df0c9;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 200;
    uint16 public feeOwnerInitialPercentageSell = 200;
    ...
    constructor() ERC20("The Collector", "COLLECTOR") {
        ...
        if (ownerReceiverSupply > 0) {
            _mint(msg.sender, (1000000000000 - ownerReceiverSupply) * 10 ** decimals());
            _mint(0x0FDF71b9cDd65fb72e4cb905a16468f1706df0c9, ownerReceiverSupply * 10 ** decimals());
        } else {
