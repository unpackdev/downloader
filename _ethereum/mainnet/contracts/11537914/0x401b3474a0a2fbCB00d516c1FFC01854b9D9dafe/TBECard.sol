...
contract TBECard is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        public
        ERC1155Tradable("TBECard", "TBE", _proxyRegistryAddress)
    {
        _setBaseMetadataURI("https://api.tbe.cards/api/tbe/");
    }

    function contractURI() public pure returns (string memory) {
        return "https://api.tbe.cards/api/contract/tbe";
    }
}