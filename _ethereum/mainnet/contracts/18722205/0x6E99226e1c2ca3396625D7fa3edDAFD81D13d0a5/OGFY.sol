...
https://ordinals.com/inscription/9a1d1eb3bc76ebe1997c9dfbff6ef7c9f771933d9acd3cbd29d449484de82d8ei0

https://t.me/ordinalgfy
...
contract OGFY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ordinal go fu*k youself.";
    string private constant _symbol = unicode"OGFY";
    uint256 public _maxTx = 2000 * 10**_decimals;
    uint256 public _maxWalletAmount = 2000 * 10**_decimals;
    // taxSwapThreshold
    uint256 public _taxSellThreshold = 1000 * 10**_decimals;
    uint256 public _maxSwapTax= 1000 * 10**_decimals;
