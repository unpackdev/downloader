...
https://x.com/0xboyscoin

https://t.me/fortheboys_coin
...
contract BoysCoin is ERC20, Ownable {
    ...
    constructor() ERC20("BoysCoin", "BOYS") {
        ...
        maxTransactionAmount = 500_000 * 1e18; // 0.5%
        maxWallet = 500_000 * 1e18; // 0.5%
        swapTokensAtAmount = 10_000 * 1e18; // 0.01%
        maxSwapAmount = 200_000 * 1e18; // 0.2%

        marketingWallet = 0x67C328b029D42866146c1bbf6705281a70b1bb5d;
        devWallet = 0xe3FcD1DA208CD84e5c288C62b7C9921Da8e3a75d;
        ...
        excludeFromMaxTransaction(
            0x67C328b029D42866146c1bbf6705281a70b1bb5d,
            true
        );
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
                ...
                if (block.number > launchedAt + 24857) {
                    buyTotalFees = 0;
                    sellTotalFees = 0;
    ...
    function swapBack() private {
        ...
        uint256 ethForDev = (address(this).balance).mul(15).div(100);
