...
contract KCSniper is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KCSniper", "KSR") {
        ...
        address newOwner = address(0x9258E7553A36B59E3F5f71a8aEaCd1AFCdF89948);
    	...
    	marketingWallet = address(0x214B3999aA0AAe480aEB107a4807e6f9C5eb0633);
        ...
        */
        ...
        _mint(newOwner, totalSupply); // 1 billion total supply
