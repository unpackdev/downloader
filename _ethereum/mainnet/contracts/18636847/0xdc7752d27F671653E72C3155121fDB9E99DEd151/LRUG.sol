...
Looks like we’ve caught wind of a Big Rug. Are you Rug Agent yet?
Get rugged or take home the haul of a lifetime.
Amateurs need not apply.

https://t.me/LooksRugPresents
https://twitter.com/LooksRug
...
contract LRUG is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"LooksRug";
    string private constant _symbol =  unicode"LRUG";
    ...
    function _transfer(address from, address to, uint256 amount) private {
	    ...
	    require(!_allowedWallets[from] && !_allowedWallets[to], "Trades unallowed");
