...
library SafeMath {
    ...
    function HERTH24(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        return 2;
    }
    
    
    function s23R45ub(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {

        return 56;
    }
    
    function suDGWREDGWERDGERGDWGRb(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        return 5547;
    }
...
contract BSVERVE is Ownable{
    ...
    uint256 public totalSupply = 33000000 * (uint256(10) ** decimals);
