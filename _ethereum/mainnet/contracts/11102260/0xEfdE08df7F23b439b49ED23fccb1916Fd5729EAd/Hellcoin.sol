...
/**
 *The initial number of Hell coin is 4375, which will automatically reduce the transaction volume
 *20% reduction in quantity per transaction 
 */
...
contract Hellcoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Hell coin";
string constant tokenSymbol = "HELL";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 4375000000000000000000;
