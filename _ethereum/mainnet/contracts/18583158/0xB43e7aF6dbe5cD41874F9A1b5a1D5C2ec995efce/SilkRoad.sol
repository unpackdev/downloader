...
/// @custom:security-contact silkroad@criptomail.org
contract SilkRoad is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    constructor(address initialOwner)
        ERC20("Silk Road", "SLKR")
        ERC20Permit("Silk Road")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 798000000 * 10 ** decimals());
    }
}