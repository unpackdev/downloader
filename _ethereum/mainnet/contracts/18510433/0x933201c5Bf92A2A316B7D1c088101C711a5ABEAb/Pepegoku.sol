...
contract Pepegoku is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _name = unicode"Pepegoku";
        _symbol = unicode"PEPEGO";
        _owner = msg.sender;
        _totalSupply = 111_111_111_111 * 10**18;
        marketingWalletAddress = payable(0x710696B12A214fAC1bF35f4905e98b652730C0a6);
        teamWalletAddress = payable(0x710696B12A214fAC1bF35f4905e98b652730C0a6);
