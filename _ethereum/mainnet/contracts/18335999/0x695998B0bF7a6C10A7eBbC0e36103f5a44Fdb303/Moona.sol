...
contract MOONA is ERC20, Ownable {
    ...
    {   
        ...
        _isExcluded[0x71B5759d73262FBb223956913ecF4ecC51057641] = true; //exclude pinklock on ethereum
    ...
    function removeTaxesAndRenounce(uint256 _feeOnBuy, uint256 _feeOnSell) external onlyOwner {
