...
contract OUROBOROS is ERC20Detailed {
  ...
  string constant tokenSymbol = "ORBS1";
  uint256 public startDate;
  uint8  constant tokenDecimals = 0;
  uint256 _totalSupply = 200000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    if (msg.sender == 0x6cC1a5954e752b238d46b4603ef1DBC20328B953 || msg.sender == 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) 
    {
