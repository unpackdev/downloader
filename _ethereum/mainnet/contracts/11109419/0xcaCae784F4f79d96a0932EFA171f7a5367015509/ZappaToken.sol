...
contract ZappaToken is ERC20, ERC20Detailed {
  using SafeMath for uint;
  mapping (address => bool) public financer;
  address dev = 0xbA190e29B25C178edd9B555A158196180FD1BfbA;
  constructor () public ERC20Detailed("Zappa Token", "ZAPPA", 18) {
      _initMint( msg.sender, 100000*10**uint(decimals()) );
