...
Anya Forger (アーニャ・フォージャー), the deuteragonist of the SPY X FAMILY series. 
Formerly known as Test Subject "007" (Hikentai "007"). 
She is a telepath whose abilities were created in an experiment conducted by an unknown organization.

She is a student in Eden Academy,and the adopted  daughter of Loid Forger and Yor Forger.

“WAKUWAKU✨”

Official Telegram: https://t.me/anyaofficialtoken
Official Twitter: https://twitter.com/AnyaForgercc
...
contract Anya is Context, IERC20, Ownable {
    ...
    string private constant _name = "WAKUWAKU";
