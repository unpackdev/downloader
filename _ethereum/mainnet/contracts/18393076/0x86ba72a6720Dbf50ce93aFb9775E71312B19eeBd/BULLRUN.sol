...
contract BULLRUN is Context, IERC20, Ownable {
    ...
    address marketingWallet = 0xC519d32139b88dD3aa5FC5A424aA68DF0E658353;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(50).div(denominator);     //50%
    uint256 public _walletMax = _totalSupply.mul(50).div(denominator);    //50%
