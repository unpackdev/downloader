...
contract ShootToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Blockshooting Token";
    string private _symbol = "SHOOT";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xB5a83e9AF20fbb2c781308d0D5d1e5cC0a1fF7a0);
    address payable public developmentWallet = payable(0xC7405a74a9Ecc3F99BB3EC829251790041d6200E);
