/**
$🥩 - Proof Of Steak, the first memecoin on POS Ethereum!

t.me/proofofsteaktoken
twitter.com/proofofsteakPOS
...
contract steak is ERC20, Ownable {
    ...
    constructor() ERC20("POS", unicode"🥩") {
        ...
        devWallet = address(0x3aa662514Afc60164feEFC17AE5AE2dA316b9f28); // set as dev wallet
    ...
    // edit fees, cannot exceed 4% buys/sells
    function setFees(uint256 newBuyLiquidityFee, uint256 newBuyDevFee, uint256 newSellLiquidityFee, uint256 newSellDevFee) external onlyOwner {
        ...
        require(buyTotalFees <= 4, "fee too high");
        require(sellTotalFees <= 4, "fee too high");
    }
