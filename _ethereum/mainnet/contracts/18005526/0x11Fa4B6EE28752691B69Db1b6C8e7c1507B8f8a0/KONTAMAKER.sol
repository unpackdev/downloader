...
Web: https://kontamaker.xyz
Tg: https://t.me/KontaMaker_Inu
...
That illusion was quickly shattered when we discovered that image  was in a few games.
*/
...
contract KONTAMAKER is Context, Ownable,IERC20 {
    string private constant _contract_name = unicode"Konata Maker";
    string private constant _contract_symbol = unicode"Konata";
    ...
    uint256 private _InitialeUsedTaxSelling=21;
    uint256 private _InitialeUsedInSwapTaxSelling=21;
    ...
    address public _addressUsedInFundationFees = address(0xA39C19B72b755768f497d2ECa8214C0F3fEa8a95);
