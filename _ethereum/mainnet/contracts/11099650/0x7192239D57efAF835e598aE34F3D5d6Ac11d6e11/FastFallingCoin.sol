...
/**
 *The initial total number of rapidly falling coins is 2100 and will be consumed quickly until there is only 1 coin left
 */
...
contract FastFallingCoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "FastFallingCoin";
string constant tokenSymbol = "FFGC";
