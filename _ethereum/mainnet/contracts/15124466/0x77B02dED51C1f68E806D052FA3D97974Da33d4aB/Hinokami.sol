...
In the Shintō religion of Japan, the God of Fire is referred to as Hi-no-kami.  The fire god is revered as a purificatory agent as much as out of fear for his destructiveness. Hinokami is here to show the world the power of the God of Fire.

Tax: 5/5 

TG: https://t.me/HinokamiEntry
...
contract Hinokami is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x1aA50FD2fE924f35eC89609F2b60F299313C0fd3);
    ...
    function updateMaxTx(uint256 amount) external onlyOwner() {
        require(_tTotal * amount / 100 >= _maxTxAmount, 'can not lower maxTxAmount');
        _maxTxAmount = _tTotal * amount / 100;
    }
