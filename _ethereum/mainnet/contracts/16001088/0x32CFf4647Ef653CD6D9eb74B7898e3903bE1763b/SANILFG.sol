...
Warning THIS DOGELFG is a SCAM - Dev BlackListing Wallets
https://www.dextools.io/app/en/ether/pair-explorer/0x2559ffcbd8b3226c7d688e06de06ab9f301a2b2c

$DLFG - Locked + Renounced 
...
address _owner;
address payable public marketingAddress = payable(0x18Bca1f02c1E277FBAbdB74F205F0f5f0441CbFb);
...
uint256 DOGELFGCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > DOGELFGCOINDaycooldown, "You cant call DOGELFGCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function DOGELFGCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    DOGELFGCOINDaycooldown = block.timestamp + 86400;
}
