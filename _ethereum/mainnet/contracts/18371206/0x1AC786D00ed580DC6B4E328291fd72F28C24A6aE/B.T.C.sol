...
- TG : https://t.me/BTCBullCow
- X : https://x.com/BTCCowBurn?t=0iC63M1g4vLNhlnj4VMK_Q&s=09
- WEB : https://www.burnthecows.com/
...
contract BurnTheCows is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("BurnTheCows", "BTC") {
        ...
        marketingWallet = address(0x743523E22559599c033C7623E8BCf9aC37236a88); // set as marketing wallet
        devWallet = address(0x0247Ec44e3E9b3266A8162bd7ee8e61e93E7e902); // set as dev wallet
