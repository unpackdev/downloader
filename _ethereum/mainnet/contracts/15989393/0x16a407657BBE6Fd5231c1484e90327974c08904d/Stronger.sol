...
contract Stronger  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Stronger";
    ...
    address payable private _developmentAddress = payable(0x0136BD934EeC1f571d9FC0f8a635b63d3dCf238c); 
    address payable private _marketingAddress = payable(0x0136BD934EeC1f571d9FC0f8a635b63d3dCf238c);
