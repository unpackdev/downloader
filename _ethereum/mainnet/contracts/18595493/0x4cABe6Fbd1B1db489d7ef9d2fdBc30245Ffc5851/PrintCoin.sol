...
pragma solidity ^0.8.20;
    ...
    contract PrintCoin {
        ...
        address payable constant deployer = payable(address(0x2662e557d021ECC6C7366932306Cde4eAf40502a)); //
        ...
        function _setPRINT(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
