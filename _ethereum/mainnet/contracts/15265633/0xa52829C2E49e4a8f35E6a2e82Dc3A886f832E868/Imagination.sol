...
//** The imagination has the extraordinary capacity to shape reality
...
/**
Imaginations are although internal images of a human being that are not visible to the senses but the reality 
is something that is not imagined and is really that is visible to senses.
However, our life is persuaded in the direction when the reality and imagination are distinguished by a boundary line.
3% dev wallet
Taxes 4/4 initialy and then will be lowered to 2/2 just for LP
*/
...
contract Imagination is ERC20, Ownable {
    ...
    constructor() ERC20("IMAGINATION", "REALITY") {
