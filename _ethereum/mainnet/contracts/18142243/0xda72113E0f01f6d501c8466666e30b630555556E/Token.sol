...
contract DONTBANXLBULLYS is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"DONTBANXLBULLYS", unicode"BULLYXL") 
    {
        address supplyRecipient = 0x094A0657fA912Ec7Bf63951C0a60F9dB3c444B04;
        
        updateSwapThreshold(5000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0x094A0657fA912Ec7Bf63951C0a60F9dB3c444B04);
        ...
        _transferOwnership(0x094A0657fA912Ec7Bf63951C0a60F9dB3c444B04);
    }
