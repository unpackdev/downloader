...
contract CflatsDapp is ICflatsDapp, CflatsDappRequirements, Harvest
{
    ...
    uint256 public constant DEFAULT_ATTACK_PAYMENT_PLAN_SILVER  = 0.003 ether;
    uint256 public constant DEFAULT_ATTACK_PAYMENT_PLAN_GOLDEN  = 0.0025 ether;
    uint256 public constant DEFAULT_ATTACK_PAYMENT_PLAN_DIAMOND = 0.002 ether;


    // Return payment plan is the same for each nft rarity
    uint256 public constant DEFAULT_RETURN_PAYMENT_PLAN_CHEAP  = 0.0015 ether;
    uint256 public constant DEFAULT_RETURN_PAYMENT_PLAN_MEDIUM = 0.002 ether;
    uint256 public constant DEFAULT_RETURN_PAYMENT_PLAN_BEST   = 0.003 ether;
