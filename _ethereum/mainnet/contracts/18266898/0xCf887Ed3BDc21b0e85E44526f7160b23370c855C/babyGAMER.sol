...
/**
Welcome to Baby Gamer

Baby Gamer just a memes coin folows elon musk.
...
all it's the babyGAMER. It's still growing.

Max bag at launch. 1%.


TG: https://t.me/babygamercommunity
X: https://twitter.com/BabyGamererc20
*/
...
contract babyGAMER is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Gamer", "babyGAMER") {
		...
		charityWallet = address(0xDCA9E5773DBe3a0c6019FD3d1058D535d9ee7f20); // set as charity wallet
        marketingWallet = address(0xDCA9E5773DBe3a0c6019FD3d1058D535d9ee7f20); // set as marketing wallet
        devWallet = address(0xDCA9E5773DBe3a0c6019FD3d1058D535d9ee7f20); // set as dev wallet
