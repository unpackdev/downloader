...
contract CULTISCOMING is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JOIN US. ALL ARE WELCOME";
    string private constant _symbol = unicode"CULT IS COMING";
