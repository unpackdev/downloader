...
Tax reduction triggers at 70 buys:
6/6 + 1% Burn
4/4 + 1% Burn

🔥 20% Burn initially at launch.

The Curse is burning the supply of the token with every buy and sell, so that it can reveal supply shock in the future.

https://t.me/TheCurseERC20
...
contract TheCurseERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Curse";
    string private constant _symbol = unicode"\xF0\x9F\x85\xBE";
