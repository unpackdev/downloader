...
contract Lottery {
    uint256 public constant ticketPrice = 0.025 ether;
    uint256 public constant maxTickets = 250; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.005 ether; // commition per ticket
