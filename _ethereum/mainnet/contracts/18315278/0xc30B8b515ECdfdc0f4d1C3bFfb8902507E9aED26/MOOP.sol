...
contract MOOP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Masturbating Outside On People";
    string private constant _symbol = unicode"$MOOP";
