...
contract BabyBitcoinToken is ERC20, Ownable {
    ...
    address public constant devWallet = payable(0x86AE8456553753B9aCC0f951eC94F942A0ec356e);
    address public constant marketingWallet = payable(0xA889cf2589fA92B0C6300A0c2A3202BCC681B79b);
    ...
    constructor() ERC20("BABYBITCOIN", "BABYB") {
    ...
    function _transfer(
        ...
        // if excluded from fees or reward then no fees
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isHoldReward) {
            takeFee = false;
        }
