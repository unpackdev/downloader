...
Pikachu is the one of the most famous anime characters in the world. Now it has arrived on the ethereum chain with the name $pika. Everyone knows pikachu from the well known Pokemon series. They are renowned for creating anime series as well as games for both the old and the new generation. That’s why we have chosen pikachu to introduce it to the ethereum world because it’s beloved by everyone. Young and old. 

The creator of Pokemon is named satoshi tajiri. This is something that’s quickly recognizable because the creator of bitcoin is named Satoshi Nakamoto.  👫

Check out our website for the $pika roadmap. 🍾

‼️LAUNCHING TUESDAY 9PM UTC ‼️

✉️ Telegram link = https://t.me/PikachuErc
🌐 Website = https://pikachuerc.vip
✖️Twitter = https://twitter.com/Pikacheth
*/
...
contract PIKA is ERC20, Ownable, BaseMath {
