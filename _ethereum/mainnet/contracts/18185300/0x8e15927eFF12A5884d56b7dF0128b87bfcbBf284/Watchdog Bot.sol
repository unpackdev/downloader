...
/*
Your search for a trustworthy companion ends here, thanks to Watchdog Bot 🤖 Receive real-time alerts about newly listed tokens on Uniswap. Gain a competitive edge by uncovering promising projects before the broader public does. Also, Secure Wallet Integration guarantees the protection of your assets against cyber threats, offering you full command over your holdings

Telegram : https://t.me/Watchdogbot_eth
Twitter: https://x.com/watchdogbot_erc
Website: https://watchdogbot.tools
Bot:  @WatchDogOfficial_Bot
*/
...
contract WatchdogBot is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"Watchdog Bot";
    ...
    function openTrading() external onlyOwner() {
        ...
        uint256 initialTokens = initialTotalSupply.per(80); uint256 desiredETHAmount;
