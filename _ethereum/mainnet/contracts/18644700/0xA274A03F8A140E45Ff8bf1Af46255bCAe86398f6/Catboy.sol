...
contract Catboy is ERC20, Auth {
    ...
    event BridgeUpdated(address bridgeCA);
    ...
    uint256 constant private _maxSupply = 200000000* 10**_decimals;
    ...
    address public bridge = 0x000000000000000000000000000000000000dEaD;
    ...
    function _mint(address account, uint256 amount) internal virtual {
            ...
            require(_maxSupply >= _totalSupply + amount, "Mint error! Amount can't be more than the Max Amount!");
    ...
    function updateBridgeContract(address _address) external onlyOwner {
        bridge = _address;

        emit BridgeUpdated(_address);
    }
