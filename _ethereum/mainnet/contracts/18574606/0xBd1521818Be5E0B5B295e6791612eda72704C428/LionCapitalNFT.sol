...
contract LionCapitalNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {

    using Address for address;

    // Token name
    string private constant _name = "Lion Capital";

    // Token symbol
    string private constant _symbol = "LCNC";
    ...
    uint256 private valueToSwitchToRecipient = 11.5 ether;
