...
contract Test is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxBuyAmount = totalSupply() * 5 / 1000; // 0.5% of the total supply initially
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual override {
        if (from != owner() && to != owner()) { // This ensures that the owner can still move tokens without restrictions
            require(amount <= maxBuyAmount, "Transfer amount exceeds maximum buy amount.");
        }
