/*
The marathon brings hope and persistence to human beings, just as you and I are here.
https://twitter.com/marathon_erc20
*/
...
contract MARATHON is Context, IERC20, Ownable {
  ...
  string public _name;
  address public _Marketing = 0x036EFB5673BDb203c66Bb6aA88Dc18C7D971f21A;
  uint256 public _maxTxAmount = 1 * 10**7 * 10**9;
  uint256 public _maxWalletSize = 2 * 10**7 * 10**9;
  
  constructor() {
    _name = "The Persistence";
    _symbol = "MARATHON";
    _decimals = 9;
