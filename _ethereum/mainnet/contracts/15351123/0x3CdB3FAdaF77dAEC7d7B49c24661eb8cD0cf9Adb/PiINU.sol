...
contract PiINU is ERC20, Ownable {
    ...
    constructor() ERC20("Pi-INU", "PINU") {
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);        
        _uniswapV2Pair = address(0);

        // Total supply 3.1415926535897932384
        uint256 totalSupply = 31415926535897932384;

        // Set default fees
        _buyMarketingFee = 10; // 1%
        _buyLiquidityFee = 10; // 1%

        _sellMarketingFee = 10; // 1%
        _sellLiquidityFee = 10; // 1%
