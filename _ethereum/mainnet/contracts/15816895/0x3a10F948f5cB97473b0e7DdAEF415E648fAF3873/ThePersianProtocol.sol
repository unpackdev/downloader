...
The Persian Protocol a community driven crypto currency, with real world use. we seek to maximize the benefits for coin holders.

Twitter: https://twitter.com/thepersianpro

Gitbook: https://thepersianprotocoleth.gitbook.io/

Telegram: https://t.me/ThePersianProtocolERC
...
contract ThePersianProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8dAEcf62C25eEE41FACfF8a6395f203485f50aC2); 
    address payable public Wallet_Utility = payable(0x8dAEcf62C25eEE41FACfF8a6395f203485f50aC2);
    ...
    string private constant _name = "The Persian Protocol"; 
    string private constant _symbol = unicode"TPP"; 
    ...
    constructor () {
        ...
        _owner = 0x8dAEcf62C25eEE41FACfF8a6395f203485f50aC2;
