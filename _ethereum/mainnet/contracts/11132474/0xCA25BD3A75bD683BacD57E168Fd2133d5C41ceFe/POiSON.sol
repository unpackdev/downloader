/*
Hey you! Welsome to GAMiNGPOiSON Collective. You may wonder what this is. We are a crypto contest project in which every day we run a new contest with different rules and rewards. 
That sounds exiciting, righ? Yeah damn exiciting. You wanna know the rules and rewards, well join our telegram group:
https://t.me/gamingpoison

Our twitter account:
https://twitter.com/ga_ngp

Well, play it safe and spend spare eth not more. 

By Pump Guy and Dip Collector
...
contract POiSON is ERC20Detailed {
  ...
  string constant tokenName = "POiSON";
  string constant tokenSymbol = "POiSON";
  uint8  constant tokenDecimals = 18;
  uint256 constant eighteen = 1000000000000000000;
  uint256 _totalSupply = 9000 * eighteen;
