...
A fund raising token for my girlfriends Boob job. She dances well so vibe with her on VC at launch

Website: https://dancinglatina.online/
Twitter/X:  https://x.com/dancinglatinaa
Telegram: https://t.me/dancinglatinaclub
******************************************************************/
...
contract LATINA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dancing Latina";
    string private constant _symbol = "LATINA";
    ...
    constructor() {
        ...
        marketingWallet = payable(0xA30EAedd391988131825AA570798B6b02934d8a0); //Marketing Wallet Address
        DevWallet = payable(0xA30EAedd391988131825AA570798B6b02934d8a0); // Dev Wallet Address
        _balance[marketingWallet] = _totalSupply;
    ...
    uint256 amountETHMarketing = amountReceived.mul(100).div(100); // 50% to marketing wallet
