...
contract FeeClaimer is IFeeClaimer {
    ...
    function registerFee(
        ...
        allocatedFees[_token] = allocatedFees[_token] + _fee;
        fees[_account][_token] = fees[_account][_token] + _fee;
    }
    ...
    function withdrawSomeERC20(
        ...
        fees[msg.sender][_token] = _balance - _tokenAmount;
        allocatedFees[_token] = allocatedFees[_token] - _tokenAmount;
    ...
    function withdrawAllERC20(IERC20 _token, address _recipient) public override returns (bool) {
        ...
        allocatedFees[_token] = allocatedFees[_token] - _balance;
    ...
    function getUnallocatedFees(IERC20 _token) public view override returns (uint256) {
        return Utils.tokenBalance(address(_token), address(this)) - allocatedFees[_token];
    }
