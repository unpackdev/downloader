/**
 ...
 Buckle up, for the tale of $PERFECT is one of bullish optimism and boundless potential.

               $PERFECT is here to take over the memespace!
...
contract Perfect is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 private immutable maxSupply = 1_000_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"Perfect Token";
    string private constant SYMBOL = unicode"PERFECT";
