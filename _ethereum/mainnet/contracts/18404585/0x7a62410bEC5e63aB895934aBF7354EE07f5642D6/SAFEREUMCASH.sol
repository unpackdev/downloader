/*
WEB https://safereumcash.xyz
TG  https://t.me/Safereumcasherc
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xb504035a11E672e12a099F32B1672b9C4a78b22f)); // SAFEREUM - 0xb504035a11E672e12a099F32B1672b9C4a78b22f
...
contract SAFEREUMCASH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SAFEREUM CASH", "SCASH") {
        ...
        marketingsWallet = address(0x5F67287509b9bb2E20c099F925Ff24D67F8F8D4D); // set as marketings wallet
    ...
    function updateBuyFees(uint256 _marketingsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
