...
contract nsurance is Context, IERC20, Ownable {
    ...
    uint256 public _tokensBuyFee = 35;
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x7E643cD615BeD94A419988d17445004B3c848E2b);
        ...
        emit Transfer(address(0x8eEcaad83a1Ea77bD88A818d4628fAfc4CaD7969), _msgSender(), _tTotal);
    }
    ...
    function setMxTokenToSwappFrFes(uint256 amount) external onlyOwner() {
