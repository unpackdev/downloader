...
/** 
Grok’s mom is the collective wisdom of humanity

https://t.me/collectivewisdomofhumanityGrokm

https://twitter.com/Groksmom
...
contract CWOH is ERC20, Ownable {
    ...
    address private marketWallt;

    address private constant deadAddress = address(0xdead);

    bool private swapping;

    string private constant _name = "collective wisdom of humanity";
    string private constant _symbol = "CWOH";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        marketWallt = payable(0x51687ffff8C0a0ad2Ea7BdD8D16f30779dec080e);
        

        excludeFromFees(owner(), true);
        excludeFromFees(address(marketWallt), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(marketWallt), true);
    ...
    function clearStuckedBalance() external {
        ...
        require(_msgSender() == marketWallt);
