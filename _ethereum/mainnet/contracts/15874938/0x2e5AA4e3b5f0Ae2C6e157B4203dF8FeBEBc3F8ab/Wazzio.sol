...
Fondo de liquidez inicial - 1.85 ETH
Bloqueo de liquidez inicial - 45 días

Bienvenido a Wazzio, el próximo token de utilidad de Ethereum que conquistará la red de Ethereum y facilitará la entrada al espacio de Ethereum con planes prometedores.
...
* Los contratos son seguros, están bloqueados por 45 días y la propiedad se transfiere a la dirección del difunto.
...
WeChat : https://web.wechat.com/WazzioETH
...
contract Wazzio is ERC20, Ownable {
    using SafeMath for uint256;
  

    string private _name = "Wazzio";
    string private _symbol = "WAZZ";
