...
contract Mangoz is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmVwyXHruHutdHmGNyHv2cy3cqad47LY22nA7BFHzD8XyA/";
