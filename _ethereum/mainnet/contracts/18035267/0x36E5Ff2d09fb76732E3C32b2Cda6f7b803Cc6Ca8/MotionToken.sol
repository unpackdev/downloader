...
contract MotionToken is Context, Ownable, IERC20 {
    ...
    address public circulatingSupplyWallet = 0x108F890d1F7ecdac6E25C156f59f5321Df950a7F; // add Liquidty and circulating supply wallet address
    address public rewardWallet = 0x108F890d1F7ecdac6E25C156f59f5321Df950a7F; // add reward wallet address
    address public devTeamWallet = 0x108F890d1F7ecdac6E25C156f59f5321Df950a7F; // add Dev teams wallet address
