...
contract RewardCampaign is Adminable {
        ...
        onlyAdmin
    {
        ...
        IERC20(tokenAddress).transfer(getAdmin(), tokenAmount);
        ...
        updateReward(user)
    {
        ...
        rewardsToken.transfer(arcDAO, daoPayable);
        rewardsToken.transfer(user, payableAmount.sub(daoPayable));
