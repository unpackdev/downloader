...
The famous Watermelon game that sold over 3.66M units worldwide is now on the blockchain!

🍉 Website: https://suika.click
🍉 Telegram: https://t.me/SuikaClick
🍉 Twitter: https://twitter.com/SuikaClick
...
contract SUIKA_GAME is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 3_660_000 * 10**_decimals;
    string private constant _name = unicode"Suika Game";
    string private constant _symbol = unicode"SUIKA";
