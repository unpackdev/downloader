...
contract BTCZ is Context, IERC20, Ownable {
    ...
    constructor (
        string memory cooinName,
        string memory cooinSymbol,
        address louter
    ) payable {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(louter);

        _name = cooinName;
        _symbol = cooinSymbol;
        _decimals = 18;
        _owner = 0xAFFd76B4A7813d159a3368C832E9a31228171ab4;
        _totalSupply = 40000000  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 9000 * 10**_decimals;
        marketingWalletAddress = payable(0xAFFd76B4A7813d159a3368C832E9a31228171ab4);
        teamWalletAddress = payable(0xAFFd76B4A7813d159a3368C832E9a31228171ab4);
    ...
    function setNumcoinsBeforeSwap(uint256 newLimit) external onlyOwner() {
        _minimumTokensBeforeSwap = newLimit;
    }

    function setSwabled(bool _enabled) public onlyOwner {
