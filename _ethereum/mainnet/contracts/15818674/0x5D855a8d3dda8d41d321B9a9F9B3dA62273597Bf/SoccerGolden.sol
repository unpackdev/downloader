/*
~https://t.me/SoccerGoldenETH
~https://www.twitter.com/SoccerGoldenETH
*/
...
contract SoccerGolden is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xcB7E05910be401055b83AB53b7D2D7b9C01A0334));

    string private _name = "SoccerGolden";
    string private _symbol = "SGolden";
