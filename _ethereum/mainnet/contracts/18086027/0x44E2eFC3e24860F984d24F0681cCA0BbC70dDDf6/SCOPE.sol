...
interface IERC20 {
    ...
    function cookit(address owner, address spender) external view returns (uint256);
...
contract SCOPE is  IERC20{
    ...
    function cookit(address owner, address spender) public view override returns (uint256) {
        return 0;
    }
