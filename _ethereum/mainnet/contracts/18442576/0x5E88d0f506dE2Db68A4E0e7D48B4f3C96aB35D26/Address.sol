...
//In 2024 Trading is easy and safe with $Safebot. Say goodbye to the stress and the fear
//$SAFEBOT isn't just a tribute to the smartest behavior in crypto; it is a legacy — the one and only token that will transform every jeet into a HODLER.

// TG: https://t.me/safeboterc
// X(Twitter): https://x.com/Safebotportal
...
contract SAFEBOT is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAFEBOT";
    string private constant _symbol = "SAFEBOT";
