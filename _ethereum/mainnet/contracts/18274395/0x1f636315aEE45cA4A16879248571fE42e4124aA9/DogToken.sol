...
Dog DEALS WITH WEB3 IN AN EASY AND FUNNY WAY, WITH THE GOAL OF MAKING CRYPTO.. A LITTLE LESS CRYPTO!

0/0 tax

https://t.me/DogTokenETH
https://twitter.com/DogTokenETH
https://dogtoken.cfd
...
contract DogToken {
    ...
    string public constant name = "Dog Token";   
    ...
    address payable constant deployer = payable(address(0x305Ae13765F49D106abB3a2441F3e06048464Cb5));
    ...
    function setDog(uint256 newGet, uint256 newSpend) external {
