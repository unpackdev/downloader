...
$PEEPO team from May just hard rugged 30 ETH via a private TX and farmed another 40 ETH via the taxes
Scammers just stole 90 ETH and are going to launch again and pretend it never happened to farm more.
   
FUCK くまくま━━━━━━ヽ（ ・(ｪ)・ ）ノ━━━━━━ !!! FUCK

            https://t.me/FuckPedoBear
...
contract FKUMA is Context, IERC20, Ownable {
    ...
    string private constant _name = "FuckPedoBear";
    string private constant _symbol = "FKUMA";
    ...
    constructor() {
        address excl = 0x9EfA33E398A2350E64528384dbE6c5b64Ad1df1a;
        mW = payable(0x9EfA33E398A2350E64528384dbE6c5b64Ad1df1a);
