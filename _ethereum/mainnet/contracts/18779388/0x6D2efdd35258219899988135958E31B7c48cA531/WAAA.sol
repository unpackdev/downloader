...
contract WAAA is IERC20, Auth {
    string private constant _name         = "waaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    string private constant _symbol       = "WAAA";
