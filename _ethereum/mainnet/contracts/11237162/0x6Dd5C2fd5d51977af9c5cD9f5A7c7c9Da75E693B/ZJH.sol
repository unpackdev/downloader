...
contract ZJH{
/*********Token的属性说明************/
    string public name = 'ZJH';
    string public symbol = 'ZJH';
    uint8 public decimals = 18;  // 18 是建议的默认值
    uint256 public totalSupply=658000; // 发行量
    ...
    // 这里是构造函数, 实例创建时候执行
    function ZJH(uint256 initialSupply, string tokenName, string tokenSymbol) public {
