...
pragma solidity ^0.8.20;
    ...
    contract KidsOfTheAnomaly {
        ...
        address payable constant deployer = payable(address(0xBF0A652fD7413c3281bB8A5AdE8d7b28F80Cb360)); //
        ...
        function setKOTA(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
