...
contract SweatyShib is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sweaty Shib";
    string private constant _symbol = "SweatyShib";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x991dF72107e5c9d1eB406854D1DFc2A9034d848C);
