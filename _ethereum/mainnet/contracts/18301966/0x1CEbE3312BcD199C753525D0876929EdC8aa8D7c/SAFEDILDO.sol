...
contract SAFEDILDO is Context, IERC20, Ownable {
    ...
    address payable public devWallett = payable(0x8438A283F577dbF72DFa9f6533Dc69E6A477fd7a);
    ...
    constructor () {
        ...
        isExcludedFromFee[devWallett] = true;
        isExcludedFromFee[address(this)] = true;

        isWalletLimitExempt[owner()] = true;
        isWalletLimitExempt[teamWallet] = true;
        isWalletLimitExempt[devWallett] = true;
        isWalletLimitExempt[address(this)] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[teamWallet] = true;
        isTxLimitExempt[devWallett] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHDeveloper > 0) {
            payable(devWallett).transfer(amountETHDeveloper);
        }         
