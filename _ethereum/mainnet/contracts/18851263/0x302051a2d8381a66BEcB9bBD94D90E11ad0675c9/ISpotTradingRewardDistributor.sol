...
import "./ISpotTradingRewardDistributorStorage.sol";
...
interface ISpotTradingRewardDistributor is ISpotTradingRewardDistributorStorage, IPausable {
     ...
     * @param isFeeInNativeToken A boolean indicating whether fees are in native tokens, true if in native
     */
    function updateTraderActivity(
        address trader,
        address positionAsset,
        uint256 positionAmount,
        bool isFeeInNativeToken
    ) external;
