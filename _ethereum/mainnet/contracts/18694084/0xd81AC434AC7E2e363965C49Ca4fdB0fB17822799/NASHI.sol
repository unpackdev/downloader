...
contract NASHI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NASHI";
    string private constant _symbol = unicode"NASHI";
