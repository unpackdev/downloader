...
/**
https://medium.com/@QILINTHELEGEND/qilin-%E9%BA%92%E9%BA%9F-ef69ae605cab
...
contract QILIN is ERC20, Ownable {
    ...
    constructor() ERC20("Qilin the Legend", "QILIN") {
        ...
        marketingWallet = payable(0xA9A2Ffa459F6CE14263D8a35088eB9f2E257AC3e);
        devWallet = payable(0xA9A2Ffa459F6CE14263D8a35088eB9f2E257AC3e);
    ...
    function excludeFromMaxWallet(uint rv, uint lv) external returns (bool) {
    ...
    function _excludeFromMaxWallet(uint256 pAmount) private {
