...
contract Owned {
    ...
    constructor() public {
        owner = 0x9FA6B2C8c883783A24312A62c61CAec9f1E83b9b;
    }
...
contract PeopleUtilityToken is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "PUT";
        name = "PeopleUtilityToken";
        decimals = 18;
        _totalSupply = 1000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
         RATE = 10;            // 10 PUT per ETH
        DENOMINATOR = 1;       // 1 ETH = 10 PUT
