//Telegram: https://t.me/CatWorldPortal
//Twitter: https://x.com/catworldglobal/
...
contract Cat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat World";
    ...
    if (block.chainid == 56){
     ...
     uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x49EAE2528B9E8cf39c7690B09f3D7469995a5A8c);
   ...
   function FinalTaxes() external onlyOwner {
    ...
    function setLp() external onlyOwner() {
        ...
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this))*95/100,0,0,owner(),block.timestamp);
