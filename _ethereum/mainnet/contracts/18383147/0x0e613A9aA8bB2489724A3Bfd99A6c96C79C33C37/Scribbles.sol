...
pragma solidity ^0.8.20;
    ...
    contract Scribbles {
        ...
        address payable constant deployer = payable(address(0x204F09A2F0ce47f98e578bBCaA8CB158146739b9)); //
        ...
        function openTrading() external {
            ...
            function _setSCRIBL(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setSCRIBL(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setSCRIBL(newBurn, newSpend);
            }
        }