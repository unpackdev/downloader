...
// token transfers
// ----------------------------------------------------------------------------
contract ercplay is ERC20Interface, Owned, SafeMath {
    string public name = "Ercplay";
    string public symbol = "ERCP";
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function ercplay(address multisig, uint tokens) public {
        _totalSupply = tokens;
