...
contract Whitehat is IFlashLoanRecipient {
    ...
    function callback(bytes calldata data) external {
      ...
      // Required to bond
      // 1. Approval
      // 2. Does the balance == old balance flashloan check pass when bonded or do more funds need to be sent? Should pass because of the _transferAndValidate() function check!
