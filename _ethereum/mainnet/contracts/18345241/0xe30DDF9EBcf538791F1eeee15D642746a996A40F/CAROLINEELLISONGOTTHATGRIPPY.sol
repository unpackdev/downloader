...
contract CAROLINEELLISONGOTTHATGRIPPY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CAROLINEELLISONGOTTHATGRIPPY";
    string private constant _symbol = unicode"CAROLINE";
