...
// File contracts/ChangableOwnerVault.sol

// Just contract whose owner can send erc20 tokens and change owner
// Used as recepient of unfreeze so we can hand it over




contract ChangableOwnerVault is Ownable {
    ERC20 public token;
