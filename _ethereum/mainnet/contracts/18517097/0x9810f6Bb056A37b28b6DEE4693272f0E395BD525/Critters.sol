...
contract Critters is ERC721A, Ownable {
    ...
    constructor() ERC721A("The Critters", "CRITTERS") {        
    ...
    function mint(uint256 _amount) external payable 
    {
        ...
        ? 0
        : maxFree - previous;
        uint256 paidNFT = _amount > freeNFT
        ? _amount - freeNFT
        : 0;

        require(price * paidNFT == msg.value, "Invalid funds provided");

        _setAux(_msgSender(), uint64(previous += _amount));
