/**
 BONE PEPE is a decentralized token that 
 is available to anyone, regardless of who you are. 
 It operates in a progressive manner, which means that 
 it is systematically developing. By prioritizing community 
 involvement, ongoing innovation, and security measures, 
 Bone Pepe is playing an important role in making the crypto market more reliable and user-friendly.

https://www.bonepepe.com/

https://twitter.com/bonepepetoken

https://t.me/BonePepeEntry
*/
...
contract BonePEPE is Ownable {
    ...
    string private _cigzyxas = "BonePEPE";
    string private _zvxtgilo = "BonePEPE";
