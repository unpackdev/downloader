...
contract MAKOTO is Context, IERC20, Ownable {
    ...
    string private constant _name = "MAKOTO";
    string private constant _symbol = unicode"マコト";
    ...
    address payable private _developmentAddress = payable(0x80a4cb9eb79B3C6e7341366524Ad9772c1739F53);
    address payable private _marketingAddress = payable(0x80a4cb9eb79B3C6e7341366524Ad9772c1739F53);
