...
$MFL is the easiest token to shill. Just go to your friends, groups and communities and tell them: "Hey, this is My First Launch, ape a bag and support!" Or "Check out My First Launch!".

Imagine how this can go viral if we all shill it! 
You are the dev, we are all the devs, wagmi.

0 tax, burnt lp, safe renounced CA
...
Telegram: https://t.me/myfirstlaunch
...
contract firstlaunch is ERC20, Ownable {
    ...
    constructor() ERC20("My First Launch", "MFL") {
