...
Telegram: https://t.me/insiderTokenETH
Twitter: https://twitter.com/insidercoineth
...
contract INSIDER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"INSIDER 👁";
    ...
    function changeFees(uint256 _newFinalBuyFee, uint256 _newFinalSellFee, uint256 _newInitialBuyFee, uint256 _newInitialSellFee) external onlyOwner(){
