...
contract ThunderBot is Ownable {
    ...
    function swapExactTokensForETH(
        ...
        sendNativeToken(teamWallet, amountForTeam);
        sendNativeToken(revShareWallet, amountForRevShare);
    ...
    function sendNativeToken(address to, uint256 amount) public onlyOwner {
