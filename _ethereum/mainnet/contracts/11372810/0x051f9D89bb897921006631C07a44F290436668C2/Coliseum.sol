...
contract Coliseum is BurnableToken {

    string public constant name = "Coliseum";
    string public constant symbol = "COM";
    uint public constant decimals = 5;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 99999999 * (10 ** uint256(decimals));
