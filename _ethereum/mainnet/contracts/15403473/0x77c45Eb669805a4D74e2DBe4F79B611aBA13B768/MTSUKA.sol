...
contract MTSUKA is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Mrs Tsuka";
    string private constant tokenSymbol = "MTSUKA";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x6916FA46A7280F0C1493B64167f35d007C5324EB);
        devAddress = payable(0x6916FA46A7280F0C1493B64167f35d007C5324EB);
