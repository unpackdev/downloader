...
Donation for soon of Juda

foam achieve guilt obtain used carpet depth change excess comfort perfect R****
0xb8DEfd92A3E6e1C930B85A02af1024f5defE11B1

Smell the $ Follow the Pepe.
Last word push in 24h after launch.
https://t.me/JudaPepe
...
contract JUDAPEPE is ERC20, Ownable {
    string private _name = "Juda Pepe";
    string private _symbol = "JUDAWISH";
    uint256 private _supply        = 10_000_000_000 ether;
    uint256 public maxTxAmount     = 200_000_000 ether;
    uint256 public maxWalletAmount = 200_000_000 ether;
    address public taxAddy = 0xaeA9B1f9A968a09a6201cd0B7e6202b67E920Bae;
    ...
    uint256 private GreedIsGood = 99;
