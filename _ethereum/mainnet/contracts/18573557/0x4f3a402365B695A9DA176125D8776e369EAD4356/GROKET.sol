...
contract GROKET is Context, IERC20, Ownable {
    ...
    uint256 public _maxTx = 1000 * 10**_decimals;
    uint256 public _maxWalletAmount = 1000 * 10**_decimals;
    // taxSwapThreshold
    uint256 public _taxSellThreshold = 500 * 10**_decimals;
    uint256 public _maxSwapTax= 500 * 10**_decimals;
