...
contract YFIAGstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // YFIAG Token Contract Address
    address public constant tokenAddress =0x00545e3EFE358373E535191b994192D07022F668;
    ...
    uint private constant stakingAndDaoTokens = 50000e18;   // 10000 YFIAG (18 Decimals) are staked by YFIAG Owner   
                                                            // Stakers will be Rewarded by these 50,000 Tokens
    ...
    // function to allow Creator to claim *other than YFIAG* ERC20 Tokens, sent to this contract (by mistake) like USDT
    // YFIAG can't be withdrawal because it will be staked for period of time with criteria
