// Website  : https://qstarbet.app
// Dapp     : https://app.qstarbet.app
// Telegram : https://t.me/QStarBet
// Twitter  : https://twitter.com/QStarBet
...
// File contracts/IDividendToken.sol
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("QBET Dividend", "QBET_Dividend") {}

    function trackerRescueERC20Tokens(address recipient, address tokenAddress)
        external
        onlyOwner
    {
    ...
    function trackerRescueETH(uint256 amount) external onlyOwner {
    ...
    receive() external payable {
        _distributeLPDividends(msg.value);
    }
}
...
contract QStarBet is ERC20Detailed, Ownable {
    ...
    function swapBack() public swapping {
        ...
        if (contractBalance > partsSwapThreshold) {
            contractBalance = partsSwapThreshold;
        }
        ...
        uint256 ethToMarketing = balance - ethToReward;
