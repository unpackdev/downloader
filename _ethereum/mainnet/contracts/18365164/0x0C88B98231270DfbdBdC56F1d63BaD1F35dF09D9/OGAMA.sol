...
contract OGAMA is ERC20, Ownable {
    ...
    constructor() ERC20("OGAMA", "OGAMA") {
        ...
        maxTransactionAmount = 10_000 * 1e18; // 100%
        maxWallet = 10_000 * 1e18; // 100% 
        ...
        revShareWallet = address(0xF48B6433f00a0ab715CFdDcF3B45e1c5C23ac270); // set as revShare wallet
