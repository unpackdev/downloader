...
contract HarryPotterShibaDogeElonMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HarryPotterShibaDogeElonMusk";
    string private constant _symbol = unicode"HPSDEM";
