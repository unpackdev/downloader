...
TG - https://t.me/poggedfinanceportal
TWITTER - https://twitter.com/PoggedFinance
WEBSITE  - https://poggedfinance.com/
...
contract POGGED is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PoggedFinance", "POGGED") {
        ...
        marketingWallet = address(0x56EA3Dd96AE049ee8156f4487B54434568457b26);
        developmentWallet = address(0x56EA3Dd96AE049ee8156f4487B54434568457b26);
    ...
    function setFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
