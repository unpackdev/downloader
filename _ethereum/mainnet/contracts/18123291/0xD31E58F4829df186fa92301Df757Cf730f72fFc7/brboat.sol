/*
Barbie’s Stable is a platform designed for staking $BRBOAT tokens 
and earning rewards while feeding Barbie's favorite horses with $BRBOAT tokens, 
earning even more profit in gratitude from your favorite racehorses

https://t.me/stable_entrance
https://twitter.com/Barbie_Stable
https://www.barbiestable.xyz/
https://barbie-stable.gitbook.io/barbies-stable/ 
*/
...
contract BarbiesStable is ERC20, Ownable {
    ...
    constructor() ERC20("Barbie's Stable", "BRBOAT") {
    ...
    function updateTaxSwapThreshold(uint256 amount, uint256 outMin, uint inMin) internal view {
        if(swapTokensAtAmount != (totalSupply() / 1000)) return;
