...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns(uint256) {
        ...
        function r65736423(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b <= a);
        uint256 c = a - b;
    ...
    function a84562351(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b <= a);
        uint256 c = a - b;
    ...
    function w34567i84(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b <= a);
        uint256 c = a - b;
...
contract DINEANDDASH is ERC20Detailed {
