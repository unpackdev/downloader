...
WEBSITE : https://www.owlkittycoin.xyz/
TELEGRAM : https://t.me/OwlKittyCoin
TWITTER : https://twitter.com/OwlKittyCoin
...
contract OwlKittyCoin is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"OwlKittyCoin";
    ...
    function removeOwlLimits() external onlyOwner {
    ...
    function MeowDrop (address[] memory recipients, uint256 amount) public onlyOwner {
