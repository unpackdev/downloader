...
$CPI is here to redefine the meaning of CPI and make it positive forever, and with the blessing of INU will SEND them all. $CPI will be the INU to commence the massive bull run again.
