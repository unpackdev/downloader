...
🌐 https://projectomega.live
✈️ https://t.me/projomegaerc
🕊 https://twitter.com/projomegaerc
...
contract ProjectOMEGA {
    ...
    string public _name = "Project OMEGA";
    string public _symbol = "$OMEGA";
    ...
    function SetTaxFree(uint256 _buy, uint256 _sell) external {
