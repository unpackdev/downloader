...
An ERC-20 token mixer for secure and private transactions, making transactions disappear into thin air, just like a magician's favorite trick.

Website: https://MagicEraserToken.com
Twitter: https://x.com/MagicEraserETH
Telegram: https://t.me/TheMagicEraser
Whitepaper: https://magiceraser.gitbook.io/magic-eraser
...
contract MAGICERASER is ERC20, Ownable {
    ...
    uint256 private tokensForEraser;
    ...
    constructor() ERC20("The Magic Eraser", "ERASER") {
    ...
    function setFees(
        ...
        buyTax = Taxes(
            ...
            _buyLiquidity,
            _buyEraser,
            _buyMarketing + _buyLiquidity + _buyEraser
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellEraser,
            _sellMarketing + _sellLiquidity + _sellEraser
        );
    }
    ...
    function updateEraser(address _eraserWallet) external onlyOwner {
        eraserWallet = _eraserWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForEraser += (fees * sellTax.eraser) / sellTax.total;
                ...
                tokensForEraser += (fees * buyTax.eraser) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        uint256 ethForEraser = ethBalance.mul(tokensForEraser).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForEraser;
        ...
        (eraserTransferSuccess, ) = address(eraserWallet).call{
            value: ethForEraser
        }("");
