...
contract LaidOutZherka is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("LaidOutZherka", "$ZHERKA") {
        ...
        marketingWallet = 0x063B536618a58fEB251eBd89b02ba41C88Ab253A;
        ...
        _mint(_owner, (totalSupply * 48) / 100);
        _mint(owner(), (totalSupply * 47) / 100);
