...
THIS IS THE COIN THAT SENDS $SENDOR THE TICKER IS $SENDOR. WHY BECAUSE IT SENDS.

0 TAX

TG - https://t.me/thecointhatsends
TW - https://twitter.com/cointhatsends
WEB - https://thecointhatsends.fun
...
pragma solidity ^0.8.23;
    ...
    contract TheCoinThatSends {
        string public constant name = "The Coin That Sends";  //
        string public constant symbol = "SENDOR";  //
        ...
        address payable constant deployer = payable(address(0x55D5972d076D837639f96474B2880C23F1aFf7cA)); //
        ...
        function setSENDOR(uint256 newTBurn, uint256 newTConfirm) external {
