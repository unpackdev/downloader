...
Website: https://www.recursiveprotocol.com
Docs:    https://docs.recursiveprotocol.com

Telegram:  https://t.me/recursiveprotocol
Twitter:   https://twitter.com/recursive_prtcl
...
contract RecursiveFi is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private _name = "Recursive Finance";
    string private _symbol = "RCS";
    ...
    uint256 public maxTaxSwap = (_totalSupply * 2) / 1000;
    uint256 private minTokensToSwap = _totalSupply / 100000;

    address payable private taxWallet =
        payable(0xABB4B6A246eE4621c7E08845e9Eb33fE54489518);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountToSwap = min(tAmount, min(contractTokenBalance, maxTaxSwap));
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify || !swapAndLiquifyEnabled) {
            ...
            (uint256 finalAmount, uint256 feeAmount) = takeFees(
                sender,
                recipient,
                amount
            );
