...
contract YFFStoken is MintableToken, BurnableToken, Blacklisted {
  ...
  string public constant name = "kombucha.finance"; // solium-disable-line uppercase
  string public constant symbol = "KOMBUCHA"; // solium-disable-line uppercase
  ...
  uint256 public constant INITIAL_SUPPLY = 60 * 1000000000 * (10 ** uint256(decimals)); 
