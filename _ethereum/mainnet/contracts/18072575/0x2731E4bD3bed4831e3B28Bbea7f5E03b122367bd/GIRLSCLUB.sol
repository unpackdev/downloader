...
contract GIRLSCLUB is Context, IERC20, Ownable {
    ...
    string private constant _name = "GIRLS CLUB";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x06F513ea28D565883b50231587043a21302Ef66f);
        ...
        emit Transfer(address(0x06F513ea28D565883b50231587043a21302Ef66f), _msgSender(), _tTotal);
    }
