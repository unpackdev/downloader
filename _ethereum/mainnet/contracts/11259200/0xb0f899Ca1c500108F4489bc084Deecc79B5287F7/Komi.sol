...
/**
 * telegram: https://t.me/komitoken
 * Komi tokens are reward tokens
 * Every trade will burn 10%
 * The initial total is 2000KOMI
 * When the total remaining amount of KOMI is less than 200, Perfect will buy 1ETH = 5KOMI
*/
...
contract Komi is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Komi Token";
string constant tokenSymbol = "KOMI";
