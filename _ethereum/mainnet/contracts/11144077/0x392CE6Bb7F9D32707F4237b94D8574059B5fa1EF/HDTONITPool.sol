...
contract HDTTokenWrapper {
    ...
    //ONIT
    IERC20 public stakeToken = IERC20(0x410e731c2970Dce3AdD351064AcF5cE9E33FDBf0); 
 ...
 * HDT-ONIT Pool
 */
contract HDTONITPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-ONIT-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-ONIT-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-ONIT-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-ONIT-POOL: Pool is closed");
        _;
    }
