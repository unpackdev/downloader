...
contract Avivore is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Avivore", "$Predator of birds") {
    ...
    function botsblacklisted (address account, bool isBlacklisted) public onlyOwner {
