...
pragma solidity ^0.8.20;
    ...
    contract Quake {
        ...
        address payable constant deployer = payable(address(0x2F77F25e94BD6735599ACeF8988Ac85A37aE6f64)); //
        ...
        function _setQUAKE(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
