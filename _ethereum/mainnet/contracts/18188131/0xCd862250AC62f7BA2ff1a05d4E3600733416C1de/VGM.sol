...
contract VGM is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public tokenPrice = 0.05 ether; // 0.05 ethereum

    uint256 public maxSupply = 500;
    uint256 public maxMintsPerTx = 2; // maximum mints per transaction
    ...
    ) ERC721("Mecenas Valenti Gamez", "VGM") {
        _baseUri = baseUri_;
    ...
    function mint(address to, uint256 amount) public payable {
        ...
        require((amount * tokenPrice) >= msg.value, "Not enough Ethereum sent");
