...
Total: 5,800,000,000
Liquidity: 5.8 ETH
Max buy:  58,000,000 = 1％
Max wallet: 116,000,000 = 2％
Slippage: buy 8％ and sell 8％
...
contract BASE58 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BTC DAO";
    ...
    uint256 private constant _tTotal = 5800000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xbb3754efDF76FDca2fdC3d746c6d156ED0AcA203);
    address payable private _marketingAddress = payable(0xbb3754efDF76FDca2fdC3d746c6d156ED0AcA203);
    ...
    uint256 public _maxTxAmount = 58000000 * 10**9;
    uint256 public _maxWalletSize = 116000000 * 10**9;
    uint256 public _swapTokensAtAmount = 5800 * 10**9;
