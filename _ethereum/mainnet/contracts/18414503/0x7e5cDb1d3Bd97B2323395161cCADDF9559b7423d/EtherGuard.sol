...
contract EtherGuard is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0x3600a76f7faB7c40d4aFe25F0D957f7475ff6a31);
    address payable public immutable marketingWallet = payable(0xd78358Eb781bE7cF3fcf41717eeE400CaC966c5E);
    address payable public immutable devWallet = payable(0x0CfB111F90b42E98DAc0bd37051875b0A4743b23);
    ...
    mapping(address => MakerTaxReduce) private makerTaxData;
    ...
    constructor() ERC20("EtherGuard", "EGUARD") {
        uint256 totalSupply = 100_000_000 * 1e18;

        maxTransaction = 9_000_000 * 1e18; //9% from total supply maxTransactionTxn
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                MakerTaxReduce storage reduceTaxData = makerTaxData[from];
                reduceTaxData.hold = reduceTaxData.buy - _reduceTaxBase;
                reduceTaxData.sell = block.timestamp;
            } else {
                MakerTaxReduce storage reduceTaxData = makerTaxData[to];
