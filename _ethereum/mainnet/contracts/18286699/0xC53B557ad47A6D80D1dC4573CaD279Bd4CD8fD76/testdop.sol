/**
    TestDOP - and it's phenomenal description.
...
contract TestDOP is ERC20, Ownable {
    ...
    constructor() ERC20("TestDOP", "TDOP") {
        uint256 totalSupply = 10_000_000 * 1e2; // two decimals
        ...
        maxTxSize = 10_000 * 1e2;
        maxWalletSize = 10_000 * 1e2;
        addLiquidityThreshold = (totalSupply * 1) / 100000; // 1,000 tokens or 0.001%
