...
//   TELEGRAM LINK: https://t.me/vodkacommunity
...
contract VodkaToken is Context, Ownable, IERC20 {
    using SafeMath for uint256;
    using Address for address;

    string public name = unicode"Ð²Ð¾Ð´ÐºÐ°"; // Updated name
    string public symbol = "VODKA"; // Updated symbol
