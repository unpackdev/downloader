...
contract MYFIRSTMEMECOINbyAutisticDev is ERC20, Ownable, Pausable {
    ...
    address public DEV_WALLET = 0x6a5394E4F4fe826C62A40c16d64265fa41Dc2E41;
    ...
    address public MARKETING_ADDRESS = 
        0x6a5394E4F4fe826C62A40c16d64265fa41Dc2E41;
    ...
    constructor () ERC20 ("MY FIRST MEME COIN (by Autistic Dev)", "MFMC") {
        _mint(DEV_WALLET, 1000000000); // 1000000000 is the total supply
