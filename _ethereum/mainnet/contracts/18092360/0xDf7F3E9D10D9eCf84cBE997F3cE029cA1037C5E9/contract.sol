...
They say everything can be put down to probability. How confident are you?

Website: https://rolldice.tech/
TG: https://t.me/rolldiceportal
X: https://twitter.com/RollDiceErc

Roll Dice Bot - https://t.me/rolldiceerc_bot
...
contract DICE is ERC20, Ownable {
    ...
    constructor () ERC20("RollDice", "DICEBOT") 
   {   
        address newOwner = 0x9F2cE7536E269Eddb92c5d3BFA8baFb22b03D404;
        transferOwnership(newOwner);
        marketingWallet = 0x9F2cE7536E269Eddb92c5d3BFA8baFb22b03D404;
        ...
        maxTransactionAmountBuy    = 20000000000000000000000000;
        maxTransactionAmountSell   = 20000000000000000000000000;
        maxWalletAmount            = 20000000000000000000000000;
    }
    ...
    function changeWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
    ...
    function updateFeeStructure(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
