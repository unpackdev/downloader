...
contract HABIBICOIN is Context, IERC20, Ownable {
  ...
  string private constant _name = unicode"DearHabibiDubaiResort";
  string private constant _symbol = unicode"RESORT";
