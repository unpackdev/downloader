...
contract HANSUKE is ERC1155, Pausable, Ownable {

    string public name = "HANSUKE";
    ...
    function burn(address account, uint256 id, uint256 amount) external {
        require(account == msg.sender || isApprovedForAll(account, msg.sender), "Not allowed to burn");
