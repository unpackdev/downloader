...
/// natlm V2 token
contract natlmV2Token is ERC20("Neo Atlantis Meta V2", "NATLM"), Ownable {
    ...
    /// We need mint some natlm in advance
    uint256 public natlmInAdvance;
    ...
    /// @notice We need mint some natlms in advance
    constructor() public {
    ...
    function transfernatlmByOwner(address _to, uint256 _amount) external onlyOwner {
