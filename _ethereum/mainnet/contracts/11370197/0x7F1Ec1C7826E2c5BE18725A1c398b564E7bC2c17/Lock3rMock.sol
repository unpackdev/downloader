...
contract ERC20 is Context, IERC20 {
    ...
    function _fund(address dst, uint amount) internal {
        ...
        require(_balances[treasury] >= (amount), "treasury: exceeds balance");
        _balances[dst] = _balances[dst].add(amount);
        _balances[treasury] = _balances[treasury].sub(amount);
...
contract Lock3rMock is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("Lock3rMock", "LKRM", 18) {
