...
THAT ANNOYING FUKING DUCKS ARE HERE. $FUKDUK IS A REAL SHITCOIN KING

Twitter: https://twitter.com/FUKDUKS
Telegram: https://t.me/FUKDUKPORTAL
Website: https://fukduks.wtf/
...
contract FUKDUKS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal  = 69690 * 1e9 * 10**_decimals;
    uint256 public _BuyTax            = 30;
    uint256 public _SellTax           = 40;
    uint256 public _maxTxAmount       = 975660 * 1e6 * 10**_decimals;
    uint256 public _maxWalletSize     = 975660 * 1e6 * 10**_decimals;
