...
contract ArtPacksBirthright is ERC721, AccessControl {
    ...
    constructor() public ERC721("ArtPacks Birthright", "APB") {
        _init();
    }
        ...
        onlyRole(MINTER_ROLE) 
    {
        ...
        for (uint256 i; i < quantity; i++) {
            mintedArtWorks[msg.sender].push(tokenIds[i]);
            _mint(to, tokenIds[i]);
        }
