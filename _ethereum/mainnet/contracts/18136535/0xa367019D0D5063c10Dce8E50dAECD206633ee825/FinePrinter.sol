...
Telegram: https://t.me/wearefiner
Website: https://fine-print.vip/
Twitter: https://twitter.com/fine_printer
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable FINE = address(0x75C97384cA209f915381755c582EC0E2cE88c1BA); //fine
...
contract FinePrinter is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Fine Printer";
    string private constant _symbol = "Finer";
    ...
    mapping (address => bool) public humansOnly;
    uint256 deadBlocks;
            
    uint256 private totalFee = 6;
    uint256 private feeDenominator = 100;

    address payable public marketingWallet = payable(0x13a119298bA0D37D401049d821073946ae38442d);
    ...
    uint256 public numTokensSellToAddToLiquidity = 600000000 * 10**9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require (!humansOnly[sender] && !humansOnly[recipient]);
        if (buyLimit) { 
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForFINE(amountToSwap.div(2));

        uint256 dividends = IERC20(FINE).balanceOf(address(this));

        bool success = IERC20(FINE).transfer(address(distributor), dividends);
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 50, "Fee can't exceed 50%");
        totalFee = _fee;
    }
