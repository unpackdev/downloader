...
contract WCBrazilMemes is Context, IERC20, Ownable {
    ...
    string private constant _name = "World Cup Brazil Memes";
    string private constant _symbol = "WCBM";
