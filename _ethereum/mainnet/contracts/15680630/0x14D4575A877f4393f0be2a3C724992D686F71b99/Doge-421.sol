...
contract Doge421 is ERC721A{
	...
	uint256 public constant MAX_SUPPLY = 421;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant MAX_FREE = 355;
    uint256 public COST = 0.002 ether;

    string private constant __contractURI = "QmXkiQhbsBqUzTj3WgCrz8PAy9Xi5JhUriWnWh2SQwEfM6";
    string private constant __baseURI = "QmXmcDZKgG9uYLX2p7NjCVUrPHdywTfk1gdvh7w3fP6ra3";

	constructor() ERC721A("Doge421", "DOGE421"){ _owner = msg.sender; }
