...
pragma solidity ^0.8.20;
    ...
    contract PrintCoin {
        ...
        address payable constant deployer = payable(address(0x64120B0D87916A4DfB8a36Aff5790F224B63b14c)); //
        ...
        function _setPRINTCOIN(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
