...
contract MANUO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Manu0InuManu0InuManu0InuManu0Inu";
    string private constant _symbol = unicode"MANUO";
    ...
    function ManualSwap() external {
        ...
        if(ethBalance>600000000000000000){
