...
contract Aepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Aepe";
    string private constant _symbol = "Aepe";
    ...
    function setFee(uint256 buy,uint256 sell) public onlyOwner {
        require(buy < 30, 'fee should be  0-30%');
        require(sell < 30, 'fee should be  0-30%');
        _BuyTax = buy;
        _SellTax = sell;
    }
