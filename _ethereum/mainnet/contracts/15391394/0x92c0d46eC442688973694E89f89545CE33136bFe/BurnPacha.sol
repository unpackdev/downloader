...
We belive in Kay Pacha - so let's burn $PACHA !

$BPACHA transactions will be taxed with 6%: 4% will go to buying and burning $PACHA, 2% will go to buying and burning $BPACHA

Initial lock for liquidity will be 14 days, extended to 1 year at $20k, extended to 100 years at $100k
...
contract BurnPacha is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Burn Pacha", "BPACHA") {
        ...
        marketingWallet = payable(0x4D37065648Fe99631a86b5A9Fe89d96E1E8E2b18);
        devWallet = payable(0x4D37065648Fe99631a86b5A9Fe89d96E1E8E2b18);
