...
contract TNC is ERC721Enumerable, Pausable, AccessControl, WithdrawalElement, ContextMixin, NativeMetaTransaction {
    using Strings for uint256;
    ...
    function contractURI() public view returns (string memory) {
        return "https://maintest.shazu.io/static/contract.json";
    }
