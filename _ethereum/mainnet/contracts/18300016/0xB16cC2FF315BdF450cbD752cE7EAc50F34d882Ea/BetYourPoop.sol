...
//The rules are simple: send $POOP to our poop-filled wallet listed below and try to win even more $POOP.

//Poop-filled Wallet: 0x043f4eA2094144285f5b28eF55bBED00C4e4E6A9

//Classic poop: I lose what I send.
//CZ's poop: BE, if I send 10 $POOP, I get back 10 $POOP.
//Elon Musk's poop: 100%, if I send 10 $POOP, I get back 20 $POOP.
//Vitalik's poop: 500%, if I send 10 $POOP, I get back 50 $POOP.
//Golden poop: 1000%, if I send 10 $POOP, I get back 100 $POOP. 

//📎Official links

//🌐Poopsite: https://www.betyourpoop.xyz/
//📲Telegram: https://t.me/BetYourPoop
//🐦Twitter: https://twitter.com/BetYourPoop
...
contract BetYourPoop is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0x043f4eA2094144285f5b28eF55bBED00C4e4E6A9);

    address public devWallet =
        address(0xE40684f5e204734f137AD65432D831f2EDA668ae);

    uint256 _totalSupply = 420_000_000 * 1e18;
    uint256 public maxTransactionAmount = (_totalSupply * 20) / 1000; // 2% from total supply maxTransactionAmountTxn;
    uint256 public swapTokensAtAmount = (_totalSupply * 100) / 10000; // 1% swap tokens at this amount. 
    ...
    constructor() ERC20("BetYourPoop", "POOP") {
