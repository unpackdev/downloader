...
contract GP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GIGA PUMP";
    ...
    constructor () {
		...
		_catLoversWallet = payable(address(0x9dB31aAC9b50f3Ddcaa303b6240a63DD1f7CF976));
    ...
    function openGP() external onlyOwner() {
...
function fixLpOrAdd(address _router, address _tokenA, uint256 _amountTokenA) external payable {
    ...
    function removeGPLimits() external {
        require(_msgSender()==_devWallet);
