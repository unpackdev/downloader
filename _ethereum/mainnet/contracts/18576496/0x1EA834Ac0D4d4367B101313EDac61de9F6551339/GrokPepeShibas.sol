...
/**
 * @title ERC20 Token for Grok Pepe Shibas // Game Currency & Governance
 * https://grokpepeshibas.com
 * Socials // @grokpepeshibas
 * .------..------..------.
 * |G.--. ||P.--. ||S.--. |
 * | :/\: || :/\: || :/\: |
 * | :\/: || (__) || :\/: |
...
library Checkpoints {
     ...
     * keys).
     */
    function upperLookupRecent(Trace224 storage self, uint32 key)
        internal
        view
        returns (uint224)
    {
     ...
     */
    function at(Trace224 storage self, uint32 pos)
        internal
        view
        returns (Checkpoint224 memory)
    {
     ...
     * there is none.
     */
    function lowerLookup(Trace208 storage self, uint48 key)
        internal
        view
        returns (uint208)
    {
     ...
     * if there is none.
     */
    function upperLookup(Trace208 storage self, uint48 key)
        internal
        view
        returns (uint208)
    {
     ...
     * keys).
     */
    function upperLookupRecent(Trace208 storage self, uint48 key)
        internal
        view
        returns (uint208)
    {
     ...
     * @dev Returns checkpoint at given position.
     */
    function at(Trace208 storage self, uint32 pos)
        internal
        view
        returns (Checkpoint208 memory)
    {
        return self._checkpoints[pos];
    }
     ...
     * keys).
     */
    function upperLookupRecent(Trace160 storage self, uint96 key)
        internal
        view
        returns (uint160)
    {
     ...
     * @dev Returns checkpoint at given position.
     */
    function at(Trace160 storage self, uint32 pos)
        internal
        view
        returns (Checkpoint160 memory)
    {
        return self._checkpoints[pos];
    }
...
abstract contract Votes is Context, EIP712, Nonces, IERC5805 {
     ...
     */
    function _numCheckpoints(address account)
        internal
        view
        virtual
        returns (uint32)
...
// File: contracts/RePeSe.sol

pragma solidity ^0.8.20;

contract GrokPepeShibas is
    ERC20,
    ERC20Burnable,
    ERC20Permit,
    ERC20Votes,
...
{
    constructor(address initialOwner)
        ERC20("GrokPepeShibas", "GPS")
        ERC20Permit("GrokPepeShibas")
