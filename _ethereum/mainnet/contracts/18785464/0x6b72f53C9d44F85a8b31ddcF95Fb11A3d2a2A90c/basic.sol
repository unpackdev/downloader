...
contract HarryPotterObamaSonicXmas10Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HarryPotterObamaSonicXmas10Inu";
    string private _symbol = "BITCOIN";
    uint8 private _decimals = 9;

    address payable private marketingWallet = payable(0xF4fb763F2f293a91964EDc2355a0a5e6d344373E); 
    ...
    uint256 public _sellLiquidityFees = 15;
    ...
    function setFinalTaxes() public onlyOwner {
        _buyLiquidityFees = 0;
        _buyMarketingFees = 0;
        _totalTaxIfBuying = _buyLiquidityFees.add(_buyMarketingFees);

        _sellLiquidityFees = 0;
        _sellMarketingFees = 0;
        _totalTaxIfSelling = _sellLiquidityFees.add(_sellMarketingFees);
