...
Element Name: Hopium (Hp)

Description: Hopium (Hp) While not naturally occurring, it exists solely within the realm of digital currencies.

Properties:

    Valuable Atomic Weight: The atomic weight of Hopium is directly proportional to its value within the cryptocurrency market.
    As a result, its weight increases as its worth rises against other cryptocurrencies, providing a variable atomic mass.

    Cryptographic Conductivity: Hopium possesses a unique property known as "cryptographic conductivity," allowing for the seamless transfer and encryption of data. 
    When exposed to information, it facilitates secure transmission, safeguarding it from unauthorized access.

    Blockchain Reactivity: Hopium exhibits a remarkable affinity towards blockchain technology. When placed within the framework of a blockchain, 
    it initiates a series of chemical reactions, resulting in the creation of a decentralized ledger capable of recording and validating transactions.

    Decentralized Stability: Contrary to other elements, Hopium remains stable in decentralized environments, embracing the inherent chaos and lack of central authority.
    Its stability brings an element of order to an otherwise anarchic system, ensuring smooth and secure operation.

    Data Transparency: Hopium possesses an exceptional ability to enhance data transparency within the cryptocurrency realm.
    By interacting with other elements in the network, it helps expose and eliminate fraudulent activities, ensuring the integrity of transactions and the protection of users.

    Electrically Charged Excitement: When exposed to electricity, Hopium exhibits an electrifying display of excitement. 
    It sparks with an intense luminosity, symbolizing the excitement and potential of the ever-evolving world of cryptocurrencies.
*/
...
interface IUniswapV2Router02 {
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0xb6af65C00d81c90b24eBf60f32f2Cb39dbb873AB); 
        _feeAddrWallet2 = payable(0xb6af65C00d81c90b24eBf60f32f2Cb39dbb873AB); 
