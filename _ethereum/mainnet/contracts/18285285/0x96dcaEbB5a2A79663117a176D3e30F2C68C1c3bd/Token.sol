...
contract TEST9 is ERC20, Ownable {
    ...
    function changeSellTax(uint48 _mktingTax, uint48 _lpTax, uint48 _devTax, uint48 _divShareTax) external onlyOwner {
        Tax memory taxes;
    ...
    function changeBuyTax(uint48 _mktingTax, uint48 _lpTax, uint48 _devTax, uint48 _divShareTax) external onlyOwner {
        Tax memory taxes;
        taxes.mktingTax = _mktingTax;
        taxes.lpTax = _lpTax;
        taxes.devTax = _devTax;
