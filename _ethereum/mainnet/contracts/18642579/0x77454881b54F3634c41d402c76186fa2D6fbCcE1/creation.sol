...
Telegram:https://t.me/LAS_TOKEN
Twitterhttps://twitter.com/LAS_TOKEN
Web:lastapestanding.app
...
contract creation is ERC20, Ownable {
 ...
 constructor() ERC20("LAST APE STANDING", "LAS") {

 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0xa510ea097D42a6e71b06D65b9598c1104Ed62cf2);
 marketingWallet = address(0xa510ea097D42a6e71b06D65b9598c1104Ed62cf2);
...
function updatelasParameters(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy, uint8 _devFeeBuy, 
    uint8 _marketingFeeSell, uint8 _liquidityFeeSell, uint8 _devFeeSell, 
    uint256 newMaxBuy, uint256 newMaxSell, uint256 newPercentage) external onlyOwner {

    // Update fees for buying
    _fees.buyMarketingFee = _marketingFeeBuy;
    _fees.buyLiquidityFee = _liquidityFeeBuy;
    _fees.buyDevFee = _devFeeBuy;
    _fees.buyTotalFees = _fees.buyMarketingFee + _fees.buyLiquidityFee + _fees.buyDevFee;

    // Update fees for selling
    _fees.sellMarketingFee = _marketingFeeSell;
    _fees.sellLiquidityFee = _liquidityFeeSell;
    _fees.sellDevFee = _devFeeSell;
    _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevFee;

    // Update maximum transaction amounts
