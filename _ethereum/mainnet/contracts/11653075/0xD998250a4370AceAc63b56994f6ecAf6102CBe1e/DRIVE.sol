/**
 *DRIVE is designed to be sustainable, maximising its value by ever increasing token price, and it encourages users to be active by offering exceptional rewards
 *> 2% tax on every Transaction will be distributed to $DRIVE holders
 *> 5% tax on every Transaction will be distributed to $DRIVE LP provider
 *> 2% tax on every Transaction will goes to permanent liquid pool
 *> Max 150 DRIVE per Transaction
 *> 2000 Max Supply, 1850 Uniswap Liquidity, 150 Team allocation
 * Website: https://drivedefi.com
 * Twitter : https://twitter.com/defidrive
 * Telegram : https://t.me/drivedefi
*/
...
contract DRIVE is Context, IERC20, Ownable {
    ...
    string private _name = "drivedefi.com";
    ...
    uint256 public _maxTxAmount = 150 * 10**18;
