...
contract ERC1155 is IERC1155, ERC165 , Allowable{
    ...
    * @param tokenId Token type
    */ 
    function _moveDelegates(address srcRep, address dstRep, uint256 amount, uint256 tokenId) 
        internal 
    {
...
// File: contracts/tokens/ERC1155/DRCX1155.sol
    
pragma solidity ^0.6.8;
    
    
contract DaricoEcosystem is ERC1155Metadata {
