...
contract CoinvipPro {
    ...
    CoinvipPro public oldSC = CoinvipPro(0xE7174076c1C9826d72F30408D7cef9678FEd74b1);
    uint oldSCUserId = 1;
    ...
    constructor() public {
        ...
        LEVEL_PRICE[1] = 0.045 ether;
        LEVEL_PRICE[2] = 0.08 ether;
        LEVEL_PRICE[3] = 0.14 ether;
        LEVEL_PRICE[4] = 0.5 ether;
        LEVEL_PRICE[5] = 3 ether;
        LEVEL_PRICE[6] = 10 ether;
        LEVEL_PRICE[7] = 30 ether;
        LEVEL_PRICE[8] = 60 ether;
        LEVEL_PRICE[9] = 120 ether;
        LEVEL_PRICE[10] = 180 ether;
    ...
    function () external payable {
        ...
        else revert('Please buy first level for 0.045 ETH');
    }
