...
contract RAGE is Context, IERC20, Ownable {
    ...
    string private _name = "RAGE II";
    string private _symbol = "RAGE2";
    ...
    //Total 8% => 6.96% goes to liquidity providers and 1% are added to liquidity pool
    ...
    uint256 public _lpRewardFromLiquidity = 87;
