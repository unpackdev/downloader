...
Like Elon, mission to mars. Moon X is the ultimate mission of chads. Moon X supports Elon’s vision while enriching the life of Hodlers. Moon X main utility is to moon to the top of the meme token sphere and build an incredible community that’s willing to help push the vision of sending chads to the moon again. 

Telegram: https://t.me/MoonXEth
Website: https://www.moonxerc.xyz/
Twitter: https://x.com/moonxeth
...
contract MoonXEth is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Moon X";
