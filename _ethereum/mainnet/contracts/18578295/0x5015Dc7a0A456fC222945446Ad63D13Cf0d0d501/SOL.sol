                                ...
                                @#-.      ........                 .@                               
                                 %@-...                      ...   -@                               
                                   ...
                                   *%.                             .@#                              
                                   ...
                                   %%*+++==--:........:::---====+++**%%                             
                                            @@@@@@@@@@@@@@@                                         
ScreamingOptimisticLlama (SOL)
Website:  https://solcult.xyz
Telegram: https://t.me/officialsolportal
X:        https://x.com/officialsol_erc
...
contract SOL is ERC20, Ownable {
    ...
    uint256 private constant INITIAL_MAX_WALLET_ALLOCATION = TOTAL_SUPPLY * 2 / 100;
    uint256 private constant FINAL_MAX_WALLET_ALLOCATION = type(uint256).max;

    /* Fee swap */
    uint256 private constant DEFAULT_MINIMUM_ACCUMULATED_TEAM_FEE_TO_SWAP = TOTAL_SUPPLY * 5 / 1000;
    address public feeRecipient = address(0x2EC6080bCFae2F41E0c87C3DeEfBD6cC1b497788);
    ...
    constructor() ERC20("ScreamingOptimisticLlama", "SOL") Ownable(msg.sender) {
    ...
    function addInitialLiquidity(uint256 liquiditySupplyAmount) external payable onlyOwner {
    ...
    function swapTeamFees() public {
        ...
        UNISWAP_V2_ROUTER.swapExactTokensForETH(amount, 0, path, feeRecipient, block.timestamp);
    }
    ...
    function _update(address from, address to, uint256 value) internal override {
        ...
        } else if (balanceOf(address(this)) >= _minimumAccumulatedTeamFeeToSwap) {
            // Is not in swap
            swapTeamFees();
        }
