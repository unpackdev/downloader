...
contract PokeTradeFarmV1 is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  address devWallet = 0x6580593410a2f7F5fe4583d405B9C216dD26eF4F;
  address[] degenWallets = [devWallet, devWallet, devWallet];
  string constant tokenName = "PokeTradeFarmV1";
  string constant tokenSymbol = "PTFM";
