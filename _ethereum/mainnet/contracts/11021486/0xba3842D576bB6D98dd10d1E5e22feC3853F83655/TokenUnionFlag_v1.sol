...
// This contract is made to create ERC721 Flag.
// Special person who has "RealFlag" can issue ERC721 token.
// Each RealFlag has secretNumber on the flag.
// 

contract TokenUnionFlag_v1 is ERC721Full {
...
modifier RealFlagOwner {
     require (msg.sender == realFlagOwner[0] || 
     msg.sender == realFlagOwner[1] || msg.sender == realFlagOwner[2] || msg.sender == realFlagOwner[3] || 
     msg.sender == realFlagOwner[4] || msg.sender == realFlagOwner[5] || msg.sender == realFlagOwner[6] ||
     msg.sender == realFlagOwner[7] || msg.sender == realFlagOwner[8] || msg.sender == realFlagOwner[9]);
     _;
 }
...
function mintFlag() RealFlagOwner public {
    ...
    _setTokenURI(flagNumber , "https://www.tokenunion.jp/TokenUnionFlag.json");
	flagNumber++;
}
...
//Personally contact to real flag owner , then accept.
...
//Set flag secretNumber to blockchain. If owner is real owner (personally check) then accepted
...
constructor() ERC721Full ("Token Union Flag" , "FLAG") public {
    flagNumber = 1;
    realFlagOwner[0] = 0xE35B827177398D8d2FBA304d9cF53bc8fC1573B7;
    }
}