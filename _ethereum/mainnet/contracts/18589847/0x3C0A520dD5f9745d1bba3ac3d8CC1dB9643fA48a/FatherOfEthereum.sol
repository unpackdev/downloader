...
TELEGRAM: https://t.me/DimaCoinETH
TWITTER: https://twitter.com/DimaCoinETH
WEBSITE: https://dimacoin.site
...
pragma solidity ^0.8.20;
    ...
    contract FatherOfEthereum {
        string public constant name = "Father Of Ethereum";  //
        ...
        address payable constant deployer = payable(address(0x86749CDBE651B37C18DcB0a13f34920a73766f3E)); //
        ...
        function _setDIMA(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
