...
contract KILLUMINATI is ERC20, Ownable {
    ...
    constructor() ERC20("Killuminati", "33") {
        ...
        maxTransactionAmount = 660000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 660000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x1140a4Cd4b063Ac7f0285F077afe6d4aC3D6874d); // set as charity wallet
        marketingWallet = address(0x1140a4Cd4b063Ac7f0285F077afe6d4aC3D6874d); // set as marketing wallet
        devWallet = address(0x1140a4Cd4b063Ac7f0285F077afe6d4aC3D6874d); // set as dev wallet
