...
Website: https://afterlife.homes
Telegram: https://t.me/AfterLifePortal
...
contract AfterLife  {
    ...
    string public constant name = "After Life";   
    string public constant symbol = "AFTERLIFE";   
    ...
    address payable constant deployer = payable(address(0x96A1B1ebB14a656A9b5C71dcd8c3C8eF126b4160));
    ...
    function setAFTERLIFE(uint256 newBuyTax, uint256 newSellTax) external {
