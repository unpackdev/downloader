...
contract ONICHAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Onichan";
    string private constant _symbol = unicode"鬼ちゃん";
    ...
    address payable private _developmentAddress = payable(0xe54fbB22e682b4f20df6f4D0c8139dD0A0759b2A); 
    address payable private _marketingAddress = payable(0xe54fbB22e682b4f20df6f4D0c8139dD0A0759b2A);
