...
contract GROKENOMICS is Context, IERC20, Ownable {
    ...
    uint256 public maxTxLimit = 500_000_001 * 10**18;
    ...
    address payable public marketingWalletAddress = payable(0x87aCcfbf512545f22bAF67Aa88d02c0699Fbe3d6); // Mkting Address
    address payable public DevWalletAddress = payable(0x11BD8176C2c012533b4C61c599b4454A3be4c0AE); // Developer Address
