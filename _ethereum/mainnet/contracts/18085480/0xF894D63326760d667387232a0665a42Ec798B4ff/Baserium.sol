/**
    Baserium Labs
    Integrate Powerful Platform.
    
    Website: https://baserium.com/
    Twitter: https://twitter.com/BaseriumLabs
    Telegram: https://t.me/Baserium
...
contract Baserium is ERC20, Ownable {
    ...
    constructor() ERC20("Baserium", "BASERIUM") {
        ...
        maxTransactionAmount = 200000000 * 1e18; // 1%
        maxWallet = 200000000 * 1e18; // 1% 
        swapTokensAtAmount = (totalSupply * 5) / 100000000; // 0.05% 
        ...
        revShareWallet = address(0xBDB915B61cF4562e3eA755Cf306d6575f62BE5E2); // set as revShare wallet
