...
contract NFT is INFT, ERC721Royalty, ERC721Enumerable, DefaultOperatorFilterer, Ownable, ReentrancyGuard, Initializable {
    ...
    address public constant serviceFeeAddress = 0xFCf7a957B41B4016bD7fa9403fa3c5faf1c06733;
    uint16 public constant serviceFee = 500; // 5% - default NFTGen service commission, which will be deducted from each sell.
