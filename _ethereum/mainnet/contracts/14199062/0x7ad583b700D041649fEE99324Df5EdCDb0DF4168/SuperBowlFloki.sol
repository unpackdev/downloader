...
contract SuperBowlFloki is Context, IERC20, Ownable {
    ...
    string private  _name = "Super Bowl Floki";
    string private  _symbol = "SBF";
    uint8 private  _decimals = 9;

    uint256 public _burnFee = 4;
    uint256 private _previousburnFee = _burnFee;
    uint256 public _speedbrakeFee = 11;
    ...
    function exclude_lp_FromReward(address account) public onlyOwner() {
        if(_rOwned[account] > 0) {
    ...
    function setMarketingAddress(address _marketingAddress, address _PCS, IUniswapV2Router02 _uniswapV2Router) external onlyOwner() {
        marketingAddress = payable(_marketingAddress); //Where eth will be sent.
