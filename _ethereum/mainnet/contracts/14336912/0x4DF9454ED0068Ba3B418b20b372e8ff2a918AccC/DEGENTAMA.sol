...
contract DEGENTAMA is Context, IERC20, Ownable {
    ...
    string private _name = "Degentama";
    string private _symbol = "DTAMA";
    ...
    uint256 private _developmentFee = 1400;
    ...
    uint256 public _maxWallet = 5000000000 * 10**9;
