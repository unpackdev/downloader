...
contract CODEXAI is ERC20, Ownable {
    ...
    constructor() ERC20("CODE EXPRESS AI ", "CODEXAI") {
        ...
        marketingWallet = address(0xF67eAC3B58a34dE56F6eAA353A811691403D814c); // set as marketing wallet
        devWallet = address(0x2f860c3046c348f487D19b70CCbe3Ee5b92f8843); // set as dev wallet
