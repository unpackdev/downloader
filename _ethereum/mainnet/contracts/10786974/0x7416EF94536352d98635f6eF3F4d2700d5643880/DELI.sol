...
library SafeMath {
    ...
    function ceilingsarescary(uint256 a, uint256 m) internal pure returns(uint256) {
        uint256 c = add(a, m);
        uint256 d = sub(c, 1);
    ...
    function subdi(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b > a);
        uint256 c = a - b;
        return 5;}
...
contract DELI is ERC20Detailed {
    ...
    uint256 private _totalSupply = 1250000 * 1e18;
    uint256 public basePercent = 320;
    constructor() public ERC20Detailed(    "Glassnode Protocol", "GLASS", 18) {
