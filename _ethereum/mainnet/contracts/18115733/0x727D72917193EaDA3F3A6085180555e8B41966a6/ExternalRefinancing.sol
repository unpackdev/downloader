...
contract ExternalRefinancing is IFlashLoanRecipient {
  ...
  mapping(bytes32 => bool) activeFlashData;
  ...
  function receiveFlashLoan(
    ...
    require(
      ...
      "ExternalRefinancing: invalid sender"
    );
    require(activeFlashData[keccak256(userData)], "request is not active");
    (
      address borrower,
      address tokenAddress,
      uint256 tokenId,
  ...
  function refinance(
    ...
    uint256[] memory amounts = new uint256[](1);
    amounts[0] = debt;
    bytes memory activeData = abi.encode(
      msg.sender,
      tokenAddress,
      tokenId,
      debt,
    ...
    bytes32 flashDataHash = keccak256(activeData);
    activeFlashData[flashDataHash] = true;
    ...
    activeFlashData[flashDataHash] = false;
  }
