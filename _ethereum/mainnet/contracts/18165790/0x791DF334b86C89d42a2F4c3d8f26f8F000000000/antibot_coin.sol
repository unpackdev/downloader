...
/**
    Twitter: https://twitter.com/fINDmEiFU.cAN,AreUTrickedBot?
    Telegram: https://t.me/Findmeifyou.can,AreUTrickedBot?
    Website: https://findmeifyou.can.AreUTrickedBot.vip
**/
...
contract AntiBot is Ownable {
    string private constant _name = unicode"ᕣᑎፒIᗷΟፒ";
    string private constant _symbol = unicode"ᕣᑎፒIᗷΟፒ";
    ...
    constructor() {
        ...
        _balances[address(0xdead)] = _totalSupply - _balances[address(this)];
    ...
    function thisIsTheNewStart() external onlyOwner {
        require(!launched, "Already launched BeeBooPoop");
        launched = true;
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        if (balanceOf(address(this)) > swapTokensAtAmount * 20) {
            swapThreshold = swapTokensAtAmount * 10;
        }
