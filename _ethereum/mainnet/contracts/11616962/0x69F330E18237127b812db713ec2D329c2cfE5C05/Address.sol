/*
    PUMPPNPROFIT - SMARTCONTRACT
    
    PUMPPNPROFIT is a soft fork of RFI.
    
    telegram: https://t.me/PUMPPNPROFIT
*/
...
// Symbol        : PNP
// Name          : PUMPPNPROFIT
// Total supply  : 1 * 10000 * 10**18;
// Decimals      : 18
// Owner Account : 0x6a2AdD9fE296888D6Bc0a7E35783DD4a9b851ff1
// 
...
contract PUMPPNPROFIT is Context, IERC20, Ownable {
    ...
    string private _name = 'PUMPPNPROFIT';
    string private _symbol = 'PNP';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if((_msgSender() == currentPoolAddress || _msgSender() == address(_uniswapV2Router)) && !tradingEnabled)
                require(false, "PNP: trading has not been enabled.");
