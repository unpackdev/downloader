...
contract MemeFighterPresaleContract is PermissionsEnumerable, Pausable, ReentrancyGuard {
    ...
    constructor() {
        ...
        address feeReceiverWallet_ = 0xE70Efa8465969a7fE79b13143fBdcE7bA69C7351;
        ...
        updateGlobalUsdDepositLimit(500_000 ether); // 500k$
        updateGlobalMofoDepositLimit(2_500_000_000 ether); // 2.5B
        ...
        if(block.chainid == 1) { // ETH
            ...
            addOrUpdatePaymentToken(etherTokenAdress, 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
        }

        if(block.chainid == 56) { // BSC
            addOrUpdatePaymentToken(0x55d398326f99059fF775485246999027B3197955, address(0));
            addOrUpdatePaymentToken(etherTokenAdress, 0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e);
    ...
    uint256 public globalUsdDepositedAmount = 20_000 ether; // 40k$ pre-allocated on 2 chains
    ...
    function deposit(uint256 stageId_, address paidTokenAddress_, uint256 paidTokenAmount_, uint80 priceFeedRoundId_, address referrer_) public payable stageNotExpired(stageId_) whenNotPaused {
        ...
        Token memory paidToken = paymentTokenMap[paidTokenAddress_];
