...
contract ScourgeApes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ScourgeApes", "SAPE") {
    setHiddenMetadataUri("ipfs://bafybeidhoyijppwlgoq3gia75y2wbd6p2sd3ml7p4konuwp7qec6m3qdgi/hidden.json");
  }
