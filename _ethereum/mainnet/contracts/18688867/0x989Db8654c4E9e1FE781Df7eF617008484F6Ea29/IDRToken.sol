...
/// @custom:security-contact support@ajaib.co.id
contract IDRToken is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("IDR Token", "AIDR")
        Ownable(initialOwner)
        ERC20Permit("IDR Token")
    {
