...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBB4a79cB535f779606cE5Dd5A545338f11d9642F];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie6no34xrstebiuoae7cachrfbeppywjyeac2ctvnozwhyxc34noi/";
...
// File: contracts/ChasingParadiseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChasingParadiseContract is RamppERC721A {
    constructor() RamppERC721A("Chasing Paradise", "PARADISE"){}
}
