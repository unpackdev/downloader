...
contract YufukuNaru is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Yufuku Naru";
    string private constant _symbol = unicode"裕福になる";
    ...
    address payable private _developmentAddress = payable(0x872Ea10D991556beBcfCE693A10215b1044B43Cb);
    address payable private _marketingAddress = payable(0x872Ea10D991556beBcfCE693A10215b1044B43Cb);
