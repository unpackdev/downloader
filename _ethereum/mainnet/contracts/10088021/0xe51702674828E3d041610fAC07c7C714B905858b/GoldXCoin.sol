...
contract Owned {
    ...
    constructor() public {
        owner = 0xBCacE38d6139e18a65E9acEC3027c14DBFB4e3A8;
    }
...
// ----------------------------------------------------------------------------
contract GoldXCoin is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "GoldXCoin";
        decimals = 18;
        _totalSupply = 475000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 6660000; // 1 ETH = 666 GXC // 1 GXC = £0.25
        DENOMINATOR = 10000;
