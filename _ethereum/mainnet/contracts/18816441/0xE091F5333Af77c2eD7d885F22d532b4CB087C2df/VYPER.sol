...
contract VYPER is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xEcb91bd8dD4B4972f1a1Dd259c3963051CCf57C8);
    address payable private _marketingAddress = payable(0xEcb91bd8dD4B4972f1a1Dd259c3963051CCf57C8);
