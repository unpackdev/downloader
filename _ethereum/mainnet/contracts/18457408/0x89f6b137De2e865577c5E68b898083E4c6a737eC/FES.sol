...
contract FES is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(address _fee_wallet) {
        ...
        string memory e_name = "Flat Earth Society";
        string memory e_symbol = "FES";
        ...
        _Fee.push(100); // Buy  fee is  4.00%
        _Fee.push(100); // Sell fee is  4.00%
        _Fee.push(100); // P2P  fee is  4.00%
