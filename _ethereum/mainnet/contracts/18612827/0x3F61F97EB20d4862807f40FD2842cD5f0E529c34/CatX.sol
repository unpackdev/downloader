...
contract CatX is Context, IERC20, Ownable {
    ...
    string private constant _name = "CatX";
...
// Uniswap V2 Router
    constructor () {
        ...
        _taxwallet = payable(0x1D7b636B4172a8b304F90d72E802e97566aE124b);
        ...
        emit Transfer(address(0x1D7b636B4172a8b304F90d72E802e97566aE124b), _msgSender(), _tTotal);
    }
    ...
    function enableTrading() external onlyOwner() {
        ...
        _swapTokensAt = _tTotal * 32 / 10000;
        _maxTokensToSwapForFees = _swapTokensAt * 41;
    ...
    function setMxTokensToSwapForFeees(uint256 amount) external onlyOwner() {
