...
contract LongCat is ERC20, Ownable {
    ...
    function excludeFromFeesMult(address[] memory accounts, bool[] memory excluded) public onlyOwner {
        require(accounts.length == excluded.length, "Arrays of different sizes");
