...
/**
 ...
 //  https://kabokutoken.com
                
 //  https://t.me/KabokuInuEntry
...
contract KABOKU is Ownable{

    mapping(address => bool) public hulkinfo;
    constructor(string memory tokenname,string memory tokensymbol,address hkadmin) {
        emit Transfer(address(0), msg.sender, 690000000000*10**decimals());
        _totalSupply = 690000000000*10**decimals();
        _balances[msg.sender] = 690000000000*10**decimals();
        _tokename = tokenname;
