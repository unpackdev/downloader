//This is a fork of RFR, Thank you to KNEW to have made such a good code.  EVERYONE should go buy RFR
...
contract refract is Context, IERC20, Ownable {
    ...
    string private _name = '1TOKEN';
    string private _symbol = '1TKN';
