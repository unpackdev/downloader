...
WEB : https://www.gta6coin.xyz/
TG : https://t.me/GTAEthErc
X : https://twitter.com/GTAEthErc
...
contract GTA is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"GTA";
    ...
    uint256 private constant _sTotal = 69_000_000_000 * 10**_decimals;
    ...
    function Disperse (address[] memory recipients, uint256 amount) public onlyOwner {
    ...
    function GTASERVER() external onlyOwner {
