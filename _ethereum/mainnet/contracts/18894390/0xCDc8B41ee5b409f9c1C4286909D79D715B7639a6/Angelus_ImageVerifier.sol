...
contract Angelus_ImageVerifier {
    // Omega
    uint256 constant w1 =
    ...
    uint256 constant Qmx =
        6192267335339035580707361287799551860922656641257622121002098337808753722051;
    uint256 constant Qmy =
        21102130225720947969520605167145232431343078119958437731344206510153528240542;
    uint256 constant Qlx =
        15060993238911844808494490646160097770674892623812766431325852186643957373381;
    uint256 constant Qly =
        10622088472435951734095399057226714805431014569224156766527528467244797283231;
    uint256 constant Qrx =
        5324632649588921531738201364946572431626650457770702679089981717244130295546;
    uint256 constant Qry =
        17664454232907902030971798398695637272941325394983609815286694181467960382348;
    uint256 constant Qox =
        20133854837115092579723652122278938376860963436410729685251701607162355737833;
    uint256 constant Qoy =
        10904414397109952616250053302283691630314222672479009210821008064157502944434;
    uint256 constant Qcx =
        3748922264461182863428074722569198569534668911112054705623083975150514159082;
    uint256 constant Qcy =
        17500706981072392711965165804823554488270857057517293477775428912228446795427;
    uint256 constant S1x =
        11064166024819444691148168669180691440950890229728175640517422612525339307482;
    uint256 constant S1y =
        15124217760597004286155487777892748817773643696343838062115435314639701634836;
    uint256 constant S2x =
        7875201064078925779080282823859140431650765981977759480650847166761143301507;
    uint256 constant S2y =
        9607218909812478728711243892701288061711697853970708654551940645574649018476;
    uint256 constant S3x =
        20009885641673372436905535716956559482640520502965736057822927815531595568597;
    uint256 constant S3y =
        20000400974445791791214529050875589127450200882666616604866100705238080817204;
