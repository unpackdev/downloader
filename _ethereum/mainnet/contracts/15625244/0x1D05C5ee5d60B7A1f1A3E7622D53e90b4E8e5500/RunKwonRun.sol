...
contract RunKwonRun is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "RUN KWON RUN";//
    ...
    address payable private _developmentAddress = payable(0xCaA0Ce7904e3Eb815Aa8ef53d1997E3dCC6151fB);
    address payable private _marketingAddress = payable(0xCaA0Ce7904e3Eb815Aa8ef53d1997E3dCC6151fB);
