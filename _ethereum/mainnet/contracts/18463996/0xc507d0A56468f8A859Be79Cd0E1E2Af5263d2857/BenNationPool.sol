...
/**
 * @title Ben Nation Pool
 * @author Ben Coin Collective
 * @notice This contract represents a pool for staking tokens and collecting rewards.
 * @dev This contract is based on the Pancake SmartChefInitializable V2 contract
 * and includes additional logic for having the same staking and reward token.
 */
contract BenNationPool is Ownable, ReentrancyGuard {
