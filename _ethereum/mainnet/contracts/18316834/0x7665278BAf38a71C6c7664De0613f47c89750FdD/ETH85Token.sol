...
/**
 * @dev ERC20Token implementation with Recover, AntiWhale, Tax capabilities
 */
contract ETH85Token is ERC20Base, AntiWhaleToken, Ownable, Recoverable, TaxableToken {
    ...
    constructor(
        ...
        payable
        ERC20Base("HowdyDoodyDegenBoomer85Inu", "ETH85", 18, 0x312f313639363930312f4f2f522f572f54)
