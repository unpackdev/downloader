/**
 * $WITCH - AI-Powered DeFi Forecasting
 *
 * Our project is a pioneering initiative in the realm of decentralized finance,
 * designed to bring predictive power to the fingertips of DeFi participants.
 * At its heart lies an advanced Artificial Intelligence system, meticulously
 * engineered to analyze and predict the price movements of DeFi tokens by delving
 * deep into historical data. The first paragraph of our introduction would highlight
 * the AI's capabilities: Our AI sifts through layers of historical transaction data,
 * liquidity metrics, and tokenomics to unearth patterns that are imperceptible to the human eye.
 * By training on years of market behavior, our model learns to identify the signals that precede
 * significant market events, from surges in token value to unexpected downturns.
 * This historical analysis is not just about understanding past trends; it's about projecting
 * these patterns into the future, giving investors a glimpse of potential market scenarios.
 *
 * Website:     https://witch-coin.com
 * Telegram:    https://t.me/witchCoinETH
 * Twitter:     https://twitter.com/witchcointoken
 * WhitePaper:  https://witch-coin-doc.gitbook.io/documantation/introduction/the-vision
 *
 */
...
contract WitchCoin is Ownable, IERC20 {
    ...
    string private _name = "WitchCoin";
    string private _symbol = "WITCH";
    uint8 constant private _decimals = 9;

    uint256 public treasuryFeeBPS = 1;
    uint256 public liquidityFeeBPS = 1;
    uint256 public dividendFeeBPS = 0;
    uint256 public totalFeeBPS = 2;
    ...
    uint256 public _maxTxAmount = (tokenSupply * maxTxBPS) / 100;
    uint256 public _maxWallet = (tokenSupply * maxWalletBPS) / 100;
    ...
    constructor() {
        marketingWallet = address(0x28bD0796f4BbF0d27220BFE43d009B6339E32B63);
        liquidityWallet = address(0x28bD0796f4BbF0d27220BFE43d009B6339E32B63);
