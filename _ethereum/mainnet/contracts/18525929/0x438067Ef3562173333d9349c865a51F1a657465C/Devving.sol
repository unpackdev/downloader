/**
 ...
 _______   ___________    ____ ____    ____  __  .__   __.   _______ 
|       \ |   ____\   \  /   / \   \  /   / |  | |  \ |  |  /  _____|
|  .--.  ||  |__   \   \/   /   \   \/   /  |  | |   \|  | |  |  __  
|  |  |  ||   __|   \      /     \      /   |  | |  . `  | |  | |_ | 
|  '--'  ||  |____   \    /       \    /    |  | |  |\   | |  |__| | 
...
DEV IS DEVVING HARD $DEVVING

https://t.me/DEVVINGPORTAL

https://twitter.com/DEVISFROMINDIA

https://www.devving.xyz/
...
contract Devving is ERC20, Ownable {

 string _name = "DEV IS DEVVING";
    string _symbol = "DEVVING";
    ...
    constructor() ERC20("Dev Is Devving", "DEVVING") {
        ...
        maxTx = totalSupply * 30 / 1000; // 3% 
        maxWallet = totalSupply * 30 / 1000; // 3% 
        swapTreshold = totalSupply * 30 / 1000; // 3%
        ...
        treasuryWallet = address(0xc524AccdD667298bBc300Af180614e7D045f72e9);
