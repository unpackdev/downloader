...
contract GlamPoodles is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xCAE0C80ABFb43735Ed10C9892e0e2C2f4c170F5A).call{value: address(this).balance * 10 / 100}('');
    require(hs);
    // =============================================================================
