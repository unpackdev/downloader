...
contract PawUniV3LPStake is Ownable, ReentrancyGuard, DividendStakingToken {
    ...
    function onERC721Received(
        ...
        (uint256 amount0, uint256 amount1) = LiquidityAmounts.getAmountsForLiquidity(sqrtPriceX96, sqrtRatioAX96, sqrtRatioBX96, cache.liquidity);

        uint256 estimatingTotalPAW = amount1 + amount0 * price;
