...
contract baboon  is ERC20, Ownable {
 ...
 constructor() ERC20("baboon tools", "baboon tools") {

 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0xb8c1C7544a21Fb7bfA21D1F99A9136E16307ff25);
 marketingWallet = address(0xb8c1C7544a21Fb7bfA21D1F99A9136E16307ff25);
