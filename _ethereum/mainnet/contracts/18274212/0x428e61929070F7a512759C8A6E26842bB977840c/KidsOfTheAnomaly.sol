...
contract KidsOfTheAnomaly {
    ...
    address payable constant deployer = payable(address(0xD0c6842644061505f3f995b799437fc15fd655f7));
    ...
    function setKOTA1(uint256 newGet, uint256 newSpend) external {
