...
contract ZBCT is StandardToken{
string public constant name = "ZBCT"; // solium-disable-line uppercase
string public constant symbol = "ZBCT"; // solium-disable-line uppercase
uint8 public constant decimals = 18; // solium-disable-line uppercase
uint256 public constant INITIAL_SUPPLY = 70000000000000000000000000;
uint256 public constant MAX_SUPPLY = 100 * 10000 * 10000 * (10 **
uint256(decimals));
/**
* @dev Constructor that gives msg.sender all of existing tokens.
*/
constructor() ZBCT() public {
