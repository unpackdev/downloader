...
/*
    ...
    Whitepaper:
    https://awl.gitbook.io/a-world-lost-whitepaper/

    Twitter:
    https://twitter.com/aworldlost
...
contract AWL is ERC20, Ownable {
    ...
    constructor() payable ERC20("A World Lost", "AWL") {
        ...
        treasuryAddress = address(0xFE47540D75E11Bd90EB788D2Df7F4d8775666075);
        ...
        _excludeFromMaxTransaction(
            address(0xFE47540D75E11Bd90EB788D2Df7F4d8775666075),
            true
        ); // Spare
