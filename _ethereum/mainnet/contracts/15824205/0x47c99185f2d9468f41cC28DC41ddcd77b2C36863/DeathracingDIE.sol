...
Crazy sport, although there is only one champion, but every racer deserves to be respe

https://t.me/Deathracing_DIE

https://twitter.com/DRDIE_INU
...
contract DeathracingDIE is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Death racing DIE";
    string private constant _symbol = unicode"DRDIE";
