...
contract AaveL1Gateway is AAVEBase {
    address public constant AAVE_GATEWAY = 0xD322A49006FC828F9B5B37Ab215F99B4E5caB19C;
    address public constant AAVE_POOL_V3 = 0x87870Bca3F3fD6335C3F4ce8392D69350B4fA4E2;
    uint16 public constant REF_CODE = 0;

    receive() external payable {
       IAaveGateway(AAVE_GATEWAY).depositETH{value:msg.value}(AAVE_POOL_V3, msg.sender, REF_CODE);
