...
/**
 * telegram: https://t.me/aiqitoken
 * Every trade will burn 20%
 * The initial total is 3000KOMI
 * When the total remaining amount of AIQI is less than 1000, Perfect will buy 1ETH = 20AIQI
*/

/**
 * When the remaining amount of AIQI is less than 1000, the currency holding ranking will be performed:
...
contract AIQI is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "AIQI token";
string constant tokenSymbol = "AIQI";
