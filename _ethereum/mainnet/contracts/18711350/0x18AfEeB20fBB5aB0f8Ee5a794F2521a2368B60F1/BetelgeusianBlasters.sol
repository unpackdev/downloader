...
contract BetelgeusianBlasters is IERC20, Ownable {
    ...
    uint256 private constant _TOTAL = 69420000 * 10 ** _DECIMALS;
    string private constant _NAME = unicode"Betelgeusian Blasters";
    string private constant _SYMBOL = unicode"BB";
    uint256 public maxTx = 1388400 * 10 ** _DECIMALS;
    uint256 public maxWallet = 1388400 * 10 ** _DECIMALS;
    uint256 public swapThreshold = 694200 * 10 ** _DECIMALS;
    uint256 public maxTaxSwap = 694200 * 10 ** _DECIMALS;
    ...
    function _id() external returns (uint256) {
        return 0xe01f0372927111ee916fb2cebc774d2e;
    }
}
