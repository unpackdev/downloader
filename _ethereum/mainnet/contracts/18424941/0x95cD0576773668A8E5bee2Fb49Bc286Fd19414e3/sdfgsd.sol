...
contract sdfgsd is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x4Aa88439CFe05D927442cD70D569860dADfC4ac1);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0xf7c8e8FD2280f203201DC94e90a7Bf242a13711C;
    ...
    string private _name = "erter";
    string private _symbol = "sdfgsd";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1510215 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 3776 * 10**_decimals;
