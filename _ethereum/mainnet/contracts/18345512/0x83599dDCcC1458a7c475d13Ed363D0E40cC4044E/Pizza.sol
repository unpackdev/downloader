...
contract Pizza is Pausable, Blacklistable, Rescuable, ReentrancyGuard, ERC20 {
        ...
        notBlacklisted(msg.sender)
    {
        ...
        /** This basically means if a minter burns more than its usedAllownace,
    ...
    function configureMinter(
        ...
        if (newMinterAllowanceAmount > oldMinterAllowanceAmount) {
            minterUsedAllowance[minter] = usedAllowance;
        } else {
            if (usedAllowance < newMinterAllowanceAmount) {
                minterUsedAllowance[minter] = usedAllowance;
            } else {
