...
contract YFI2Cstaking is Ownable {
    ...
    uint public constant rewardInterval = 365 days;     // 1.4% per week
    ...
    uint private constant stakingAndDaoTokens = 1450e18;   // 1450 YFI2C will be staked by owner
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out YFY2C!");
