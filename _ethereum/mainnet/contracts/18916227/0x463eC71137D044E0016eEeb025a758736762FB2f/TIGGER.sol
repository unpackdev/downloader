//https://www.cbsnews.com/news/mickey-mouse-tigger-lady-chatterleys-lover-notable-works-enter-public-domain-2024/
...
contract TIGGER is ERC20 {
    constructor() ERC20("TIGGER", "TIGGER") {
        _mint(msg.sender, 2108192 * 10 ** decimals());
    }
}