...
Please read the medium for instructions on how to play!

Website: https://citydefense.space
Telegram: https://t.me/CityDefensePortal
Medium: https://medium.com/@CityDefense
...
contract CityDefense  {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "City Defense";   
    string public constant symbol = "CTDF";   
    ...
    address payable constant deployer = payable(address(0x6af054dC8086754B9C58DbE7a10DD6C68Fa43453));
    ...
    function setCTDF(uint256 newBuyTax, uint256 newSellTax) external {
