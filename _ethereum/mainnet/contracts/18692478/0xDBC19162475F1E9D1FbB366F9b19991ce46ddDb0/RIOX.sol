...
https://twitter.com/realio_network
https://metaverse.realio.network/
https://t.me/realio_fund
...
contract RIOX is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"RealioVerse";
    string private constant _symbol =  unicode"RIOX";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 10 * 1e6 * 10**_decimals;
    uint256 public _BuyTax=            0;
    uint256 public _SellTax=           0;
    uint256 public _maxTxAmount =      2 * 1e5 * 10**_decimals;
    uint256 public _maxWalletSize =    2 * 1e5 * 10**_decimals;
