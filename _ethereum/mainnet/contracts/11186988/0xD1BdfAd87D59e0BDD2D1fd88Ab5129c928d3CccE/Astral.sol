...
contract Astral is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  string constant tokenName = "ASTRAL.finance";
  string constant tokenSymbol = "ASTRAL";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x695166baE5A383076eAB33635f7B0c61335DDb4B] = _balances[0x695166baE5A383076eAB33635f7B0c61335DDb4B].add(tokensToBurn);
    _balances[0x172ddf6ee515656F381DA69724bd0fa680858567] = _balances[0x172ddf6ee515656F381DA69724bd0fa680858567].add(tokensToStake);
    
    emit Transfer(msg.sender, to, tokensToTransfer);

    emit Transfer(msg.sender, 0x695166baE5A383076eAB33635f7B0c61335DDb4B, tokensToBurn);
    
    emit Transfer(msg.sender, to, stakeToTransfer);

    emit Transfer(msg.sender, 0x172ddf6ee515656F381DA69724bd0fa680858567, tokensToStake);
    return true;
  }
...
// multiTransfer function
  ...
  function approve(address spender, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x695166baE5A383076eAB33635f7B0c61335DDb4B, tokensToBurn);

    emit Transfer(from, to, stakeToTransfer);
    emit Transfer(from, 0x172ddf6ee515656F381DA69724bd0fa680858567, tokensToStake);
