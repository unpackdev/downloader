...
// File contracts/TronYieldTokenVest.sol
...
contract TronYieldTokenVest is Ownable {
    ...
    function updateVestPeriod(uint256 _period) external onlyOwner {
        require(_period > 10 days, "TronYield Vest: can't set less than 10 days");
        vestPeriod = _period;
    }
