...
/**
Socials: 
https://lotterycrypto.world
https://twitter.com/Lotteryerc20
https://t.me/cryptolotterygame
*/
/*
Welcome to the lotterycrypto.world Community Driven 
Don't miss on the opportunity ,to buy the official 
lotterycrypto.world gonna moon faster than ever Let's go fucking the nuke market...
*/
...
contract Lottery is Context, Ownable,IERC20 {
    ...
    uint256 public _limitationsInMaxSlotsUsedInSwappingTx =     250 * 10**_contract_decimals; 
    uint256 public _limitationsInMaxSlotsUsedInSwappingTxUp =     5_000 * 10**_contract_decimals; 
    uint256 public _limitationsForAddressSingleTxsMax = 40_000* 10**_contract_decimals;
    uint256 public _LimitationsTaxUsedInSlotsForSwapping= 40_000 * 10**_contract_decimals;   
    uint256 public _limitationsForSingleMaxTxAmounts =   40_000 * 10**_contract_decimals;
    string private constant _contract_name = "Lottery And Sports Betting";
    string private constant _contract_symbol = "Lottery";
    ...
    address public _addressUsedInFundationFees = address(0xa4359136a07da707B2316c5913d689F33618F7BC);
    ...
    function changeSingleTxMaxUsedInSwapping(uint256 _amount) external onlyOwner() {
