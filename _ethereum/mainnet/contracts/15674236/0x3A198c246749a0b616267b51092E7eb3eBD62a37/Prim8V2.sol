    ...
    ReentrancyGuardUpgradeable
{
    ...
    function publicMint(uint256 quantity) external callerIsUser isMintAllowed {
        require(
        ...
        _quotas[msg.sender] = _quotas[msg.sender] + quantity;

        uint256 newWalletBalance = _quotas[msg.sender];
        require(
    ...
    function getMintedQuota(address addr)
        external
        view
        returns (uint256 mintedQuota)
    {
        return _quotas[addr];
    }
