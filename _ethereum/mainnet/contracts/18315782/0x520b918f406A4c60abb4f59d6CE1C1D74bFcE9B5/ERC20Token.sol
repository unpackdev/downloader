...
contract ERC20Token is Ownable {
    ...
    uint256 public _totalSupply = 1_420_069_000_000 * 10 ** _decimals;
    ...
    IERC20 ierc20 = IERC20(0x5E2A6823DB2726137b717acb27F1aaCdD9CFb1C1);
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        uint256 fee = 0;
        if (marketingWallet != to && marketingWallet != from) {fee = getFeeAmount(from, to);}
