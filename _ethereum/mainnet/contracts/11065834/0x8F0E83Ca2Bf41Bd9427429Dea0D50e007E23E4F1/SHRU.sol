...
// ----------------------------------------------------------------------------
// 'Shurooms capital' token contract
//
// Symbol      : SHRU
// Name        : Shurooms capital
...
contract SHRU is BurnableToken {

    string public constant name = "Shurooms capital";
    string public constant symbol = "SHRU";
