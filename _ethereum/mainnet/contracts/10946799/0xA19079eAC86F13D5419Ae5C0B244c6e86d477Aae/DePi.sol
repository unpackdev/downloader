...
contract DePi {
    ...
    string public constant name = "DePi";

    // Name your custom token symbol
    string public constant symbol = "DEPI";
    ...
    constructor() public {
        ...
        treasury = address(0xF0849d9FaC07B6dff37cDa90b7B87c37fB697467);

        // Set your total token supply (default 1000)
        totalSupply = 3141592653589793238 ;
