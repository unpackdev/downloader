// https://www.fox5atlanta.com/video/1373692
...
contract PUSHINP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PUSHING POSITIVITY"; 
    string private constant _symbol = unicode"PUSHINP";
    ...
    function thug() external onlyOwner() {
    ...
    function uahhhh(uint256 _newFee) external{
