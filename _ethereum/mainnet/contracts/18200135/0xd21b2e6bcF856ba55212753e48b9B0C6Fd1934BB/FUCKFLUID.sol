...
contract FUCKFLUID is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fuck Fluid Trade";
    string private constant _symbol = unicode"FUCK FLUID";
