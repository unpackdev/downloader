...
/*
Website: https://www.shibagun.com/
Telegram: https://t.me/shibacumgm
...
contract SHIBACUM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"shibacum";
    string private constant _symbol = unicode"SHIBCUM";
    ...
    function elonmusk() external onlyOwner() {
