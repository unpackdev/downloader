...
import "./ICurve.sol";
import "./MferswapRouter.sol";
import "./ILSSVMPairFactoryLike.sol";
import "./CurveErrorCodes.sol";
    ...
    ERC1155Holder
{
    ...
    /**
        ...
        @param isRouter True if calling from MferswapRouter, false otherwise. Not used for
        ETH pairs.
    ...
    /**
        ...
        @param isRouter Whether or not the caller is MferswapRouter
        @param routerCaller If called from MferswapRouter, store the original caller
        @param _factory The LSSVMPairFactory which stores MferswapRouter allowlist info
    ...
    /**
        ...
        @dev We send ETH back to the caller even when called from MferswapRouter because we do an aggregate slippage check for certain bulk swaps. (Instead of sending directly back to the router caller) 
    ...
    function _takeNFTsFromSender(
    ...
    ) internal virtual {
        {
            ...
            if (isRouter) {
                ...
                MferswapRouter router = MferswapRouter(payable(msg.sender));
