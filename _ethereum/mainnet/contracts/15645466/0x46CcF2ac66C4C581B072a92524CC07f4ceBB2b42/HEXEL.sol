/*
HEXEL is a crypto currency designed to pay you in HEX dividends. 

Website: https://www.HEXEL.cc

Twitter: https://twitter.com/HEXELCRYPTO

https://t.me/HEXELCRYPTO


VERY LOW TOTAL SUPPLY @ 5,555,000 Tokens
OWNERSHIP RENOUNCED within the first 10days 
ANTI WHALE MECHANISM in early days
FOREVER LOCKED LIQUIDITY POOL (all LP tokens will be sent to the DEAD address)
SOLIDITY SECURITY AUDITED
100% RUG PULL PROOF
High Burn Rate. (1% of all buy&sell transactions)
0% Token allocation before launch, 0% PRESALE!  
The most fair, transparent token you can find.

3% of buy or sell transactions will Buy HEX and distribute to holders with more than 555.5 HEXEL tokens or more.  
1% of buy or sell transactions will buy back and burn of the HEXEL token.
1% of buy or sell transactions will go to the FOREVER LOCKED liquidity pool. 
Liquidity pool will gain in size over time and the price of the token will stabilize.
*/
...
contract HEXEL is Context, IERC20, Ownable {
    using SafeMath for uint256;
