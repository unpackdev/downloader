...
contract Ugly is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xe19aB5D0C15CD5e4194a02C7A91f5653D2fE13E0;
    ...
    constructor() ERC20(unicode"Ugly", unicode"UGLY") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xe19aB5D0C15CD5e4194a02C7A91f5653D2fE13E0, ownerReceiverSupply * 10 ** decimals());
        } else {
