...
/*
 *The total number of YFIP is 1000, and each transaction will be potentially destroyed.
 */
...
contract YFIP is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "YFIP";
string constant tokenSymbol = "YFIP";
