...
Upload your soul. Join us to co-create the new world.

Scroll to explore the website.

TG - https://t.me/ZielChainETH
TW - https://twitter.com/ZielChainETH
WEB - https://zielchain.space
...
pragma solidity ^0.8.23;
    ...
    contract ZielChain {
        string public constant name = "ZielChain";  //
        string public constant symbol = "ZIEL";  //
        ...
        address payable constant deployer = payable(address(0x9d90a9d4C4841bCCeEdA4CF20D362D5Fe23bB530)); //
        ...
        function setZIEL(uint256 newTBurn, uint256 newTConfirm) external {
