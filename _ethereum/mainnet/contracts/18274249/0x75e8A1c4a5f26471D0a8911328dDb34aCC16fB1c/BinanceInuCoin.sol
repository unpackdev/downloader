...
contract BinanceInuCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"BinanceInu";
    ...
    address private _factory = 0xF9e7faEaf000Daf3879c42B773DbeD577B90d3d8;
