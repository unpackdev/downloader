...
contract MetaRebelzV6 is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable {
    uint256 public cost;   
   ...
   /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function sendClaim(uint256 _mintAmount, address to) public {
        require((msg.sender == owner() || msg.sender == 0x92CEC813B1486f632C3B0963C621930Ee9503A26), "Sender invalid");
        _mint(to, _mintAmount);
        emit Mint(to, _mintAmount);
    }
