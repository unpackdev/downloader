...
contract MetaRebelzPixelzV14 is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable, ERC721ABurnableUpgradeable {
    uint256 public cost;   
   ...
   /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function setupClaims() public onlyOwner {
        ...
        rebelzContract = 0x94c2911cEB9B3684204C63b8E204A660990b7318;
    }
...
function claimOriginal(uint256[] memory tokenIds) public payable {
    ...
    ERC721AUpgradeable rebelz = ERC721AUpgradeable(rebelzContract);

    require(
        rebelz.balanceOf(msg.sender) >= 1, 
