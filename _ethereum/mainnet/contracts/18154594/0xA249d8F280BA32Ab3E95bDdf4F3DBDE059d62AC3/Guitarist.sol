...
contract Guitarist is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    address public wallet2 = 0x021e4270F4F046beA60B65f0eEb420836bcdB4C9;
    address public wallet3 = 0xeAe45F389F50616A43b2adE2a13A339422535068;
    ...
    constructor(string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Guitarist", "Guitarist") {
     
    baseURI = "https://bafybeibwsk3xshtvcjaohx3jfdbl6oqnfiumy6mv4ocvcpyohlau22vz7e.ipfs.nftstorage.link/";
    setNotRevealedURI(_initNotRevealedUri);   
    setRoyaltyInfo(owner(),500);
    setTreasuryWallet(owner());
    contractURI = _contractURI;  
    mint(250);
    partnerMint(wallet2, 400);
    partnerMint(wallet3, 350);
    }
    ...
    function partnerMint(address partner, uint256 quantity) public payable onlyOwner  {
        require(totalSupply() + quantity <= MAX_SUPPLY,"No More NFTs to Mint");
    ...
    function withdraw() internal {  
        (bool main, ) = payable(treasuryWallet).call{value: address(this).balance}("");
        require(main);
    }
