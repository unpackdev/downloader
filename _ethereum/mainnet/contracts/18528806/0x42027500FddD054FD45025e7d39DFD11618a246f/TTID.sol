...
TG:https://t.me/TTIDportal
Twitter: https://x.com/ttidtoken
Website: https://thistimeisdifferent.com

,---------. .---.  .---..-./`)    .-'''-.         ,---------. .-./`) ,---.    ,---.    .-''-.          .-./`)    .-'''-.          ______     .-./`)  ________  ________     .-''-.  .-------.        .-''-.  ,---.   .--.,---------.  
\          \|   |  |_ _|\ .-.')  / _     \        \          \\ .-.')|    \  /    |  .'_ _   \         \ .-.')  / _     \        |    _ `''. \ .-.')|        ||        |  .'_ _   \ |  _ _   \     .'_ _   \ |    \  |  |\          \ 
 `--.  ,---'|   |  ( ' )/ `-' \ (`' )/`--'         `--.  ,---'/ `-' \|  ,  \/  ,  | / ( ` )   '        / `-' \ (`' )/`--'        | _ | ) _  \/ `-' \|   .----'|   .----' / ( ` )   '| ( ' )  |    / ( ` )   '|  ,  \ |  | `--.  ,---' 
    |   \   |   '-(_{;}_)`-'`"`(_ o _).               |   \    `-'`"`|  |\_   /|  |. (_ o _)  |         `-'`"`(_ o _).           |( ''_'  ) | `-'`"`|  _|____ |  _|____ . (_ o _)  ||(_ o _) /   . (_ o _)  ||  |\_ \|  |    |   \    
    :_ _:   |      (_,_) .---.  (_,_). '.             :_ _:    .---. |  _( )_/ |  ||  (_,_)___|         .---.  (_,_). '.         | . (_) `. | .---. |_( )_   ||_( )_   ||  (_,_)___|| (_,_).' __ |  (_,_)___||  _( )_\  |    :_ _:    
    (_I_)   | _ _--.   | |   | .---.  \  :            (_I_)    |   | | (_ o _) |  |'  \   .---.         |   | .---.  \  :        |(_    ._) ' |   | (_ o._)__|(_ o._)__|'  \   .---.|  |\ \  |  |'  \   .---.| (_ o _)  |    (_I_)    
...
contract ThisTimeIsDifferent is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "This Time Is Different";
    string private _symbol = "TTID";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x5Ef05c45E384E1cB26E420ad1d90aD40BCc47e78);
    address payable public DeveloperWallet = payable(0x5Ef05c45E384E1cB26E420ad1d90aD40BCc47e78);
