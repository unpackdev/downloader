...
PvP Roulette is a Player-versus-Player wagering game on Telegram drawing its inspiration from the classic Russian Roulette 
You can play it in our TG group and it can also be seamlessly integrated into your private groups.

Website:   https://www.pvproulette.io/
Twitter:   https://x.com/PvPRouletteCoin
Telegram:  https://t.me/PvPRouletteCoin
Documents: https://pvp-roulette.gitbook.io/pvp-roulette/
...
/**
 * @title PvP Roulette Token
 * @dev Betting token for PvP Roulette Game
 */
contract PvPRouletteToken is Ownable, ERC20 {
    ...
    constructor() ERC20("PvP Roulette Game Betting Token", "$PVP", 8) {
        if (isGoerli()) {
 ...
 */
contract PvPRouletteBot is Ownable {

    address public revenueWallet;

    PvPRouletteToken public immutable bettingToken;
    ...
    constructor(address payable _bettingToken, uint256 _minimumBet, uint256 _revenueBps, uint256 _burnBps, address _revenueWallet) {
        ...
        burnBps = _burnBps;
        bettingToken = PvPRouletteToken(_bettingToken);
