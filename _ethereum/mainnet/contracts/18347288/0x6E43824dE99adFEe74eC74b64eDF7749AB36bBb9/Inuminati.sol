...
contract Inuminati is ERC20, Ownable {
    ...
    constructor() ERC20("InuminatiCoin", "INU") {
        ...
        uint256 totalSupply = 66 * 1e12 * 1e18;

        maxTransactionAmount =  660 * 1e9 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 1320 * 1e9 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0x028cdd41d7e23bbe9673A078c7eC13e4102cB36B); // set as dev wallet
        MarketingWallet = address(0x028cdd41d7e23bbe9673A078c7eC13e4102cB36B); // set as mkt wallet
