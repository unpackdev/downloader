...
/// @title: PARALLEL UNIVERSES: From Future Frequencies to Gucci Cosmos
/// @author: niftykit.com
    ...
    ReentrancyGuardUpgradeable
{
        ...
        onlyOwnerOrRoles(GucciAuctionStorage.ADMIN_ROLE)
    {
        ...
        require(auction.startedAt == 0, "startedAt must be zero");
    ...
    function placeBid(uint256 auctionId) external payable hasAuction(auctionId) nonReentrant {
        ...
        require(block.timestamp < auction.startedAt + auction.duration, "Auction expired");
        require(
