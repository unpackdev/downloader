 ...
 * The 3rd token in the Gold Retriever Ecosystem
 * The Silver rewards you receive are redeemable for real physical Silver or Gold. 
...
contract SilverRetrieverV1 is ERC20, Ownable {
    ...
    uint256 public constant sellDevFee = 24;
    ...
    constructor () ERC20("Silver Retriever", "SLVR") {
        ...
        marketingWallet = address(0xe73bfa9b5756a848929C977B48f764e195D8cE25); // set as dev wallet
