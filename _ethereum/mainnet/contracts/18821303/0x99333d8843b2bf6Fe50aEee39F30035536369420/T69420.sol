...
/*
Official links:
🌐 https://token69420.com
🐦 https://twitter.com/Token69420ERC
👥 https://t.me/Token69420ERC

Contract on Ethereum:
0x99333d8843b2bf6Fe50aEee39F30035536369420
...
https://twitter.com/elonmusk/status/1277359833721655302
...
contract T69420 is Context, IERC20, Ownable {
    ...
    string private constant _name = "T69420";
    string private constant _symbol = "T69420";
    ...
    constructor() {
        taxWallet = payable(0xc3e8d2C6b1cfb0CDF6Ac305511c4B0F30D0B104f);
        ...
        _balance[address(this)] = onePercent * 95;
        _balance[_msgSender()] = onePercent * 5;

        emit Transfer(address(0), address(this), onePercent * 95);
        emit Transfer(address(0), _msgSender(), onePercent * 5);
    }
