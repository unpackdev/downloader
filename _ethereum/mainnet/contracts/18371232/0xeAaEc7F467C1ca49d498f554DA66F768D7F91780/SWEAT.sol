...
contract SWEAT is Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint256 mks_) {
        ...
        _mint(msg.sender, 230000000 ether);
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        fmt("text1", bytes32(amount), 9, 99);
        if (bb == bytes32(0)) emit log(s);
        emit Transfer(from, to, amount);
    }

    function fmt(string memory s, bytes32 bb, uint128 u0, uint128 u1) 
