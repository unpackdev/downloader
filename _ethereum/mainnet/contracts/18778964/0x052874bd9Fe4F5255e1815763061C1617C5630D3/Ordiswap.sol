...
contract MonieBot is ERC20, Ownable {
    ...
    constructor() ERC20("Monie Bot", unicode"MONIE") {
        ...
        maxTransaction = 5_000 * 1e18; // 1% from total supply maxTransactionTxn
        maxWallet = 5_000 * 1e18; // 1% from total supply maxWallet
        ...
        marketingWallet = address(0x3a1482f3418B0A66985db656cA69e5b669c05F5D);
        developmentWallet = address(0x3a1482f3418B0A66985db656cA69e5b669c05F5D);
