// Telegram Channel : https://t.me/rtsgameth
...
contract RTS is ERC20, Ownable {
    ...
    constructor () ERC20(unicode"RTS", "RTS") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x6E58b9582745fF4fF280ce497748103f0Ee968b2;
