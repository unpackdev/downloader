...
contract HDTTokenWrapper {
    ...
    //MCI
    IERC20 public stakeToken = IERC20(0x3b58c52C03ca5Eb619EBa171091c86C34d603e5f); 
 ...
 * HDT-MCI Pool
 */
contract HDTMCIPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-MCI-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-MCI-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-MCI-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-MCI-POOL: Pool is closed");
        _;
    }
