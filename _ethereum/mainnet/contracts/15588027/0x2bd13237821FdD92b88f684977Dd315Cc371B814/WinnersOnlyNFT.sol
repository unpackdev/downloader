...
contract WinnersOnlyNFT is IERC721, Ownable {
    using Address for address;
    using Strings for uint256;

    string private _name = "Winners Only";
    string private _symbol = "WOYC";

    uint16 public pubsaleSupply = 10000;
    uint16 public limitPerAddress = 100;
    uint public totalSupply;

    uint public lastRevealedId = 0;
    ...
    function mint(uint256 amount) external payable {
        ...
        require(pubsaleOpen, "Sale is not open");
    ...
    function reveal(uint id) external onlyOwner {
        lastRevealedId = id;
    }
