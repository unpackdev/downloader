...
contract Budian is ERC721Enumerable {
    ...
    string public contractURI = "ipfs://bafkreifdbnyuxpnba2dufreyrghuj22ll7pch4cf3swzqirgqbg2gf6cp4/";
    ...
    constructor () ERC721("Budian", "BUDIAN") {
        mintLimits.push(MintLimit(0, 88, 88));
        baseURIRoots.push(BaseURIRoot(0, "ipfs://bafkreih2dmpq5kewwroikz32f7ywj6pzkup64ggagjb43gn2cjnw4iffrq/?"));
    ...
    function setBaseURI(uint256 index, BaseURIRoot calldata baseURIRoot) external onlyOperator {
        // incorrect index will revert
        require(index == 0 || baseURIRoot.start > baseURIRoots[index - 1].start, "Start of base URI root is restrictly increasing");
