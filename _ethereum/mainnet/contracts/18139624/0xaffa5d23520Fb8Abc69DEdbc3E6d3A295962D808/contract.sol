...
contract QUICK is Context, IERC20, Ownable {
    ...
    string private constant _name = "QuickSendBot";
    ...
    function setFeeStructure(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
