...
contract WayGateMarketplace is WayGateRoyalties {
    ...
    event NftUnlisted(address owner, uint256 nftID, bytes32 nftListingIdHash);
    ...
    function listNFTForTimedAuction(
        ...
        require(_endTime > _startTime + 180, "WayGate: Minimum time limit");
        require(
            !(
    ...
    function _unlistNft(bytes32 _nftListingIdHash) internal nonReentrant {
        ...
        emit NftUnlisted(_msgSender(), _tokenId, _nftListingIdHash);
    }
