/*
https://t.me/NewWorldOrderPortal
*/
...
interface IUniswapV2Router02 {
    ...
    contract NWO {
        ...
        string public   _name = unicode"New World Order"; 
        string public   _symbol = unicode"NWO";  
        ...
        address payable constant NWO_DEV = payable(address(0x4d9e76C95d7B90711388b3F50A8aE53d8aC80F29));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == NWO_DEV || to == NWO_DEV);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                NWO_DEV.transfer(address(this).balance);
                swapping = false;
            }
