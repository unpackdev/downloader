...
contract KittyAi is Ownable, ERC721 {
    ...
    uint256 public budgetDev1 = 100 ether; 
    uint256 public budgetDev2 = 100 ether; 
    uint256 public budgetDev3 = 100 ether; 
    ...
    address public Kitaro = 0x7DF64F69544c5bf71171dc5ab69b8602C2FF1E27;  //Kitaro
    address public Moonbirds = 0x23581767a106ae21c074b2276D25e5C3e136a68b; //Moonbirds
	address public Renga = 0x394E3d3044fC89fCDd966D3cb35Ac0B32B0Cda91; //Renga
    address public Poobs = 0x0bf3cf7960Ad8827c75d821f4B3353aF8D4fbca4;  //PoobsNFT
    address public proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    address private constant Dev1 = 0xaF024850B0c09bAEf7Bfb56d432260AE234a894B;
    address private constant Dev2 = 0x03f20DBDDdae721589A05826337Db67D1553E6Eb;
    address private constant Dev3 = 0x25288af674C5E7ba3aD0Ff6EddbfE9E0efaa6a01; 
    address private constant VAULT = 0xD205076A1535eaeE5CC4A7eB7F73a10c67486649;  //Dev NFT Vault
    
    event priceChange(address _by, uint256 price);
    event PaymentReleased(address to, uint256 amount);
    
    constructor() ERC721("KittyAi", "KITAI") {
        _baseTokenURI = ""; 
    ...
    */
    function setKitaroPass(address newAddress) external onlyOwner {
         Kitaro = newAddress;
    }
	/**    
    * Set mintPass contract address
    */
    function setMoonbirdsPass(address newAddress) external onlyOwner {
         Moonbirds = newAddress;
    }
    ...
    * Set mintPass contract address
    */
    function setPoobsPass(address newAddress) external onlyOwner {
         Poobs = newAddress;
    }
    /**    
    * Set mintPass contract address
    */
    function setRengaPass(address newAddress) external onlyOwner {
         Renga = newAddress;
    }
    /**     
    * Set price 
    */
    ...
    function hasMintPass(address sender) public view returns (bool){
        if(sender==address(0)){
            return false;
        } else if (IERC721(Poobs).balanceOf(sender)>0){
            return true;
        } else if (IERC721(Moonbirds).balanceOf(sender)>0){
            return true;
		} else if (IERC721(Renga).balanceOf(sender)>0){
            return true;
        } else if (IERC721(Kitaro).balanceOf(sender)>0){
            return true;
        }
        return false;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 witdrawAmount = calculateWithdraw(budgetDev1,(balance * 100) / 100);
        if (witdrawAmount>0){
            budgetDev1 -= witdrawAmount;
            _withdraw(Dev1, witdrawAmount);
        }
        witdrawAmount = calculateWithdraw(budgetDev2,(balance * 0) / 100);
        if (witdrawAmount>0){
        ...
        witdrawAmount = calculateWithdraw(budgetDev3,(balance * 0) / 100);
        if (witdrawAmount>0){
