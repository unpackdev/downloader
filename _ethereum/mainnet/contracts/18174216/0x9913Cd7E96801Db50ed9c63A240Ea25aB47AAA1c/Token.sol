...
/**
    ...
    Telegram: https://t.me/BabyAlienEntry
    Twitter: https://twitter.com/BABYALIENERC
    Website: https://babyalien.xyz
...
contract BA is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x230BB29387B4fa1d202cf4C320f93A181434a759);
    address payable private _marketingAddress = payable(0x230BB29387B4fa1d202cf4C320f93A181434a759);
    ...
    constructor() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
