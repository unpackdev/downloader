    ...
    UUPSUpgradeable
{
    ...
    uint256 public maxPreMintTypeSupply;
    ...
    function setMaxPreMintTypeSupply(
        uint256 _maxPreMintTypeSupply
    ) public onlyOwner {
        maxPreMintTypeSupply = _maxPreMintTypeSupply;
    }
    ...
    function getTypeIndex(uint256 tokenId) public pure returns (uint256) {
        require(tokenId < MAX_SUPPLY, "Invalid tokenId");
        return tokenId / MAX_PER_TYPE;
    }
        ...
        validateMintable(typeIndex, quantity)
    {
        ...
        require(
            typeSupply[typeIndex] + quantity <= maxPreMintTypeSupply,
            "Exceeds max preMint type supply"
        );
        require(
