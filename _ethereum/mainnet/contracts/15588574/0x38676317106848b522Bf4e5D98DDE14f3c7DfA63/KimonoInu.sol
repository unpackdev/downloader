...
contract KimonoInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KimonoInu";
    string constant _symbol = "KIMONO";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x1A7f7b322Aa0456958A2945f379aDF8e81321416;
        solor = msg.sender;
...
contract StandarToken is KimonoInu {
    constructor() {}
}