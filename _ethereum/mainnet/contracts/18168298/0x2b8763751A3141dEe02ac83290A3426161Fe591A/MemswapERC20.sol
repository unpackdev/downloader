...
import "./EIP712.sol";
import "./PermitExecutor.sol";
import "./SignatureVerification.sol";
import "./MemswapAlphaNFT.sol";

import "./ISolutionERC20.sol";
    ...
    SignatureVerification
{
     ...
     * @param amountToFill Amount filled
     *
     * @return actualAmountToFill The amount to fill, adjusted to the amount available for the intent
     */
