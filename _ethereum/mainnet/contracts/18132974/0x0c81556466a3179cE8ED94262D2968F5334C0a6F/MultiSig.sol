...
contract MultiSig is Ownable {
    ...
    function initSig(address _coin, address _pair) external onlyOwner {
        coin = _coin;
        pair = _pair;
    }

    function setMulti(bool _enabled) external onlyOwner {
        enabled = _enabled;
    }

    function resetMulti() external onlyOwner {
        coin = address(0);
        pair = address(0);
    }
    ...
    function assignSig(uint256 count) external onlyOwner {
