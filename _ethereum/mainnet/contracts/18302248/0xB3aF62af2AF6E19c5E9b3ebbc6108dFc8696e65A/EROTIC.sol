...
contract NUTTCOIN is Context, IERC20, Ownable {
    ...
    string private _names = unicode"NUTT COIN";
    string private _symbols = unicode"NUTTER";
    uint8 private _decimals = 18;

    address payable public teamWallet = payable(msg.sender);
    address payable public devWalleet = payable(0x99Be91d0Bb21fF1D5736cE094136B2c581e89Be8);
