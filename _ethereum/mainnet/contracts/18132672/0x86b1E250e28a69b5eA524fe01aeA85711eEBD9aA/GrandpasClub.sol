...
// File: contracts/GrandpasClub.sol
...
contract GrandpasClub is Ownable, ERC721A, PaymentSplitter {
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("GrandpasClub", "GC")
