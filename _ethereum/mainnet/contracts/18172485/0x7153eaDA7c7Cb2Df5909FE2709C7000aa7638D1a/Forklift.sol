/**
   ...
   Embrace the legacy. Own your ForkLift Certification 
...
contract Forklift is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 private immutable maxSupply = 100_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"Forklift Certified";
    string private constant SYMBOL = unicode"LIFT";
