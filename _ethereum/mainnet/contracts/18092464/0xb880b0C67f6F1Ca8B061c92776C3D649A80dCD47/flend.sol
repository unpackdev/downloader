...
contract flend is ERC20, Ownable {
 ...
 constructor() ERC20("friendlend", "FLEND") {
 
 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0xEDdB63177Fe19Df8b27d85dB0eF3fBB7C743588C);
 marketingWallet = address(0xEDdB63177Fe19Df8b27d85dB0eF3fBB7C743588C);
...
//Limits
 ...
 function updateLendAmount(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
 ...
 function updatelendWalletAmount(uint256 newPercentage) external onlyOwner {
 ...
 function updateAllFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
 ...
 function setFeeWallets(address _marketingWallet,address _devWallet) external onlyOwner{
