...
contract MemeOnCrypto is ERC20, Ownable {
    ...
    constructor() ERC20("Meme On Crypto", "MEMES") {
        ...
        maxTransactionAmount = 8_413_800_000_000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 8_413_800_000_000 * 1e18; // 2% from total supply maxWallet
        ...
        developmentWallet = address(0x9C0475B204553FEEe1c5FDA53378e29A30710314); // set as development wallet
        marketingWallet = address(0xA58D528D8F59A0ED461b5c04162d472506d3BF8e); // set as marketing wallet
        devWallet = address(0xF9694FcB85d4F2AF73797188169053acD8A0132E); // set as dev wallet
