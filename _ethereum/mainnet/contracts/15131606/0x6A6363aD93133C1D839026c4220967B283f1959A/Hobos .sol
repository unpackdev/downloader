...
contract Hobos is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmfHzFEqUG9GjMwDEs2G8byscspGneB4H5yd12rkevuPw5";
  ...
  ) ERC721A("Hobos Awaked", "Hobos Awaked") {
