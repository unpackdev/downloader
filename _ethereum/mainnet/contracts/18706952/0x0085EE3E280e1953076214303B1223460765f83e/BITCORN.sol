/*
https://t.me/BITCORNOFFICIAL




Do not ape unless you like the ''PONZI'' . $BITCORN

1$ Liquidity  =  1$BITCORN

25/25 Starting tax because its $BITCORN and we are poor Corn Collectoprs

If you have a problem with any of this. Go and buy $BTC instead, Only cornheads here.!!!!!!!
*/
...
contract BITCORN is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcorn", "BITCORN") {
        ...
        maxTransactionAmount = 230000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 230000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xa13dC7A85646D84630E4F25df2A2aBb8b96e4d08); // set as charity wallet
        marketingWallet = address(0xa13dC7A85646D84630E4F25df2A2aBb8b96e4d08); // set as marketing wallet
        devWallet = address(0xa13dC7A85646D84630E4F25df2A2aBb8b96e4d08); // set as dev wallet
