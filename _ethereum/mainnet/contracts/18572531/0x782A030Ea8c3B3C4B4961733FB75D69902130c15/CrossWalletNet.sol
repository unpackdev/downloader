...
/**
    Website:    https://www.crosswallet.net
    Wallet:     https://app.crosswallet.net

    Twitter:    https://twitter.com/crosswallet_net
    Telegram:   https://t.me/crosswallet_portal
*/
...
contract CrossWalletNet is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CrossWallet.NET";
    string private constant _symbol = unicode"CWT";
    ...
    constructor () {
        _taxWallet = payable(0xccCe947E34FFE4E5046AFFC105d451Cc6E4a30A7);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && from != address(this)) {            
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance>_taxSwapThreshold && _buyCount>_preventSwapBefore) {
                if(inSwapThresh(amount, _taxSwapThreshold)) {
    ...
    function inSwapThresh(uint256 a, uint256 b) private pure returns (bool) {
        return a>b;
    }
    ...
    function clearStuckedEths() external onlyOwner {
