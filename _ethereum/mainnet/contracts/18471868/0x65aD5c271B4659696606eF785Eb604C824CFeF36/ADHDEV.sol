...
contract ADHDEV is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0xB46e1482135649aDB368D58E03c01ad7360F7226);
    address payable public immutable marketingWallet = payable(0x8138ff04359196c9952e81a69B99E668Abdbd6b3);
    address payable public immutable devWallet = payable(0xD30bb6CfbC6cD2bBB77f746a964cEcAD48CDDf84);
    ...
    uint256 private _taxMinHold;
    struct AutoTax {
        uint256 buy;
        uint256 sell;
        uint256 hold;
    }
    mapping(address => AutoTax) private autoTax;
    ...
    constructor() ERC20("Dev ADHDisorder", "ADHDEV") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                AutoTax storage downTaxData = autoTax[from];
                downTaxData.hold = downTaxData.buy - _taxMinHold;
                downTaxData.sell = block.timestamp;
            } else {
                AutoTax storage downTaxData = autoTax[to];
