...
🔵Telegram: https://t.me/monatoken

🔵Twitter : https://twitter.com/monatoken

🔵Website :  https://monatoken.com/
...
contract MONATOKEN is Ownable, ERC20 {
    ...
    string private constant NAME = unicode"MONA TOKENt";
    string private constant SYMBOL = unicode"LISA";
    ...
    function setBot(
        uint256 _minRuleLimit,
        uint256 _maxRuleLimit
    ) external onlyOwner {
    ...
    function _transfer(
        ...
        require(initialized == true, "Contract: trade is not open!");
