...
contract X3NO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"X3NO";
    string private constant _symbol = unicode"X3NO";
