...
contract SphynxStopLoss is Ownable, ReentrancyGuard, KeeperCompatible {
    ...
    uint256 public staticFee = 10000000000000000; // 0.01 BNB INITIAL FEE
    uint256 public sphynxFee = 500000000000000000000; // 500 SPHYNX TOKEN INITIAL FEE
