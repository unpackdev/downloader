...
At BananaBread, we’re the underachievers of the crypto world, and we’re not ashamed to admit it. 
While others aim for the moon, we’re content with just reaching the next banana tree. 
Others will promise a bot, we already have one. It's not as good as the other Banana Guys tho.

Website: https://bananabreadeth.com/
Twitter: https://twitter.com/BananaBreadEth
Telegram: https://t.me/bananabreadeth

BananaBread Bot: https://t.me/BananaBreaderc_bot
...
contract BANANANANAN is Context, Ownable, IERC20 {
 
    using SafeMath for uint256;
 
    string private constant _name = "BananaBread";
    string private constant _symbol = "BNNBOT";
    ...
    uint256 public _maxTransaction = 200000000000000000;
    uint256 public _maxWallet = 200000000000000000;
    uint256 public _swapTokensAtAmount = 50000000000000000;
    ...
    function setMaximumTransaction(uint256 maxTxAmount) public onlyOwner {
