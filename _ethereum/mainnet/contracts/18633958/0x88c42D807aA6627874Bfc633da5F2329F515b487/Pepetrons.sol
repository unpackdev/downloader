...
contract Pepetrons is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 656;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.0015 ether;

    string private constant _name = "Pepetrons";
    string private constant _symbol = "PEPETRON";
