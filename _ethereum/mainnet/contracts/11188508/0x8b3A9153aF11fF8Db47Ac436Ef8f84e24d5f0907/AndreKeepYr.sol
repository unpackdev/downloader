...
contract AndreKeepYr is StandardToken {

  string public constant name = "Andre KeepYr";
  string public constant symbol = "aKPYR";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 92020 * (10 ** uint256(decimals));
