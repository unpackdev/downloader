...
//TELEGRAM LINK https://t.me/fortniteportal
...
contract FORT is Context, Ownable, IERC20 {
    using SafeMath for uint256;
    using Address for address;

    string public name = "FortniteLamaGoldWinnerStormStandingInu69"; // Updated name
    string public symbol = "FORT"; // Updated symbol
    uint8 public decimals = 18;
    uint256 public totalSupply = 100_000_000 * 10 ** uint256(decimals); // 100 million tokens
