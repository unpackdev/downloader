...
https://autistsimmuno.vip

https://t.me/aidserc

https://twitter.com/AidsErc
...
contract aids is ERC20, Ownable {
    ...
    constructor() ERC20("Autistic Immuno Degen Syndrome", "AIDS") {
        ...
        marketingWallet = address(0xb83f91FE1F299b35896066A3Ad23852cdE60f7CB); // set as marketing wallet
        devWallet = address(0xb83f91FE1F299b35896066A3Ad23852cdE60f7CB); // set as dev wallet
        ...
        */
        _mint(0xb83f91FE1F299b35896066A3Ad23852cdE60f7CB, totalSupply);
    }
    ...
    function setBuyFeeAmount(
        uint256 _marketingFee,
        uint256 _liquidityFee,
        uint256 _devFee
    ) external onlyOwner {
		require((_marketingFee + _liquidityFee + _devFee) <= 180, "Max BuyFee 18%");
    ...
    function setSellFeeAmount(
		uint256 _charityFee,
        uint256 _marketingFee,
        uint256 _liquidityFee,
        uint256 _devFee
    ) external onlyOwner {
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 180, "Max SellFee 18%");
