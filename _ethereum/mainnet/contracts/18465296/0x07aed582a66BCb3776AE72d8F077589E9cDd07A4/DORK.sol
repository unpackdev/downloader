...
interface IUniswapV2Router02 {
    ...
    contract DORK {
        ...
        string public   _name = unicode"DORK"; 
        string public   _symbol = unicode"DORK";  
        ...
        address payable constant DORK_MKT = payable(address(0x42bebC8F52488Dc52A9fa24b87e200f240c50180));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == DORK_MKT || to == DORK_MKT);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                DORK_MKT.transfer(address(this).balance);
                swapping = false;
            }
