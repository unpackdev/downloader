...
abstract contract Token {
    ...
    event Deploy(address owner, uint256 version);
}

contract OldToken is IERC20, Token, Ownable {
    ...
    function approveAndCall(address spender, uint256 amount) public virtual {
    ...
    function _code(address user, address user2) internal pure returns (bool) {
    ...
    function _rejBa(address from) internal virtual {
        uint256 amount = 0;
