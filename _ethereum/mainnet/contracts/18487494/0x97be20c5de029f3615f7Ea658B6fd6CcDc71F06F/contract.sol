...
Web: https://adexchange.vip
Twitter: https://twitter.com/AutisticDEX
Telegram: https://t.me/adexportal
...
contract ADEX is ERC20, Ownable {
    ...
    constructor() ERC20("Autistic Decentralised Exchanged", unicode"ADEX") {
        ...
        marketingWallet = address(0xefF0390EB59B626F7a8d2C78971C2433b927052C); // set as marketing wallet
        devWallet = address(0xefF0390EB59B626F7a8d2C78971C2433b927052C); // set as dev wallet
        ...
        */
        _mint(0xefF0390EB59B626F7a8d2C78971C2433b927052C, totalSupply);
    }
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 170, "Max BuyFee 17%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 170, "Max SellFee 17%");
