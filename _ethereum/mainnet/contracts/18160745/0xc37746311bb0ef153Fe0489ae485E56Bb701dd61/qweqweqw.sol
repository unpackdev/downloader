/**
            POLLY  is here to join the memecoins and takeover.
            
            Launched stealth with no presale, LP Burned and contract renounced, 
            
            $Polly is a coin for the people, forever. Fueled by pure memetic power as it looks, let $Polly show you the way.

            We will bring the community together on the mission to THE MOON.


            https://polly-official.com

            https://twitter.com/PollyTheFrogETH
...
contract POLLY is Ownable {
    ...
    string private _cigzyxas = unicode"Polly The Frog";
    string private _zvxtgilo = unicode"$POLLY";
