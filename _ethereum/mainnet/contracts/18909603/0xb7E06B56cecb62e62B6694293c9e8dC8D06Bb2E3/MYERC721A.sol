 ...
 */
contract MYERC721A is IERC721A,ERC2981, Ownable {
    ...
    uint256 public maxTotalSupply = 200;
    ...
    constructor(string memory name_,
        string memory symbol_)  Ownable(msg.sender) {
        _name = name_;
        _symbol = symbol_;
   ...
   function safeMint(address  to, uint256 quantity) onlyOwner() public  {
            _safeMint(to, quantity, '');
       
    }
    function safeBatchMint(address[] memory tos, uint256 quantity) onlyOwner() public  {
     ...
     */
    function safeMintBy(address to, uint256 quantity, bytes32[] calldata merkleProof) 
    ...
    function contractURI() public pure returns (string memory) {
       return "https://ipfs.io/ipfs/bafkreifqtsujs73mqv6h5khyncaggwuclw2jkrl5edyvflc6yzywrhn32y";
    }
    function tokenURI(uint256 tokenId) public view  override returns (string memory) {
        if (!_exists(tokenId)) _revert(URIQueryForNonexistentToken.selector);
        string memory baseURI = "https://ipfs.io/ipfs/bafybeif7k4m7xdp3rwdr3fdu7xvnywgsu4vld5by6zshnexhxji6z4qubm/";
