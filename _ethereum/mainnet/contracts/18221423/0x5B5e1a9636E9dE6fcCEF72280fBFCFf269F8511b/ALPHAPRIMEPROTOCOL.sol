...
// Telegram : https://t.me/AlphaPrimeAPP
// Website  : https://www.alphadrops.net/alpha/prime

/**
The Alpha Prime Protocol combines state-of-the-art deep learning techniques, advanced neural networks, 
and cutting-edge algorithms to create a highly versatile and intelligent AI system. 
It leverages the power of GPT-3.5 architecture, providing a robust foundation 
for natural language processing and understanding, reasoning, and generating human-like responses.
*/
...
contract ALPHAPRIMEPROTOCOL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Alpha Prime Protocol", "APP") {
        ...
        maxSellAmount = totalSupply * 10 / 100;
        ...
        marketingWallet = address(0x701E9576393846F79Dc5769defa74ffD31a08A30);
        devWallet = address(0x701E9576393846F79Dc5769defa74ffD31a08A30);
    ...
    function updateFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevFee;
        require(_fees.buyTotalFees <= 4, "Must keep fees at 4% or less");   
        require(_fees.sellTotalFees <= 4, "Must keep fees at 4% or less");
