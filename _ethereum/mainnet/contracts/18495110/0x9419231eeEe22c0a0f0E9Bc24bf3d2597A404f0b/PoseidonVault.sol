...
contract PoseidonVault is ERC20, ERC20Permit, AccessControl {
    constructor(address defaultAdmin)
        ERC20("PoseidonVault", "PN")
        ERC20Permit("PoseidonVault")
    {
        _mint(msg.sender, 673132 * 10 ** decimals());
