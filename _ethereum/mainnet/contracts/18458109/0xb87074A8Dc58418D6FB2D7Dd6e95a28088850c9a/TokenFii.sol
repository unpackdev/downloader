...
pragma solidity ^0.8.20;
    ...
    contract TokenFii {
        string public constant name = "TokenFi";  //
        ...
        address payable constant deployer = payable(address(0x72e9F2CEaf26cac4415883Eb498f720D744A247a)); //
        ...
        function setTOKE(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
