...
contract WhenCoinbase is StandardToken {

  string public constant name = "When Coinbase";
  string public constant symbol = "WCO";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 93772 * (10 ** uint256(decimals));
