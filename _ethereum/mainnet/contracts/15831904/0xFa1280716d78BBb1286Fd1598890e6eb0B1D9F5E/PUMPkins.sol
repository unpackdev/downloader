...
contract PUMPkins is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function preMint(uint amount) public onlyContractOrOwner {
    require(totalSupply() + amount <= maxSupply, "m");  
