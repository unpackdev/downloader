...
🔗 Links: 
Telegram: https://t.me/Garfield_Entry
Twitter: https://x.com/garfielderc?s=21
Website: http://garfielderc.online/
...
contract GARFIELD is ERC20, Ownable, BaseMath {
    ...
    function initialize() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),initialTotalSupply.per(35),0,0,owner(),block.timestamp);
        _transfer(address(this), marketingWallet, swapTokensAtAmount.mul(40));
    }
