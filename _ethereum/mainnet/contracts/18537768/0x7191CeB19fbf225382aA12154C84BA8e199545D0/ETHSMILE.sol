...
A simple MEME token, its name is $ETHS. Holding it, you will have the same expression as him. Because it’s up and up and up…

/**
Portal：https://t.me/ETHSMILE_ERC
...
contract ETHSMILE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ETH SMILE";
