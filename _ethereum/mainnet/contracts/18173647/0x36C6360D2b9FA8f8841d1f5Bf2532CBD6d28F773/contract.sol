...
Slavic Cat - $сука блять

Website - https://slaviccat.com/#

TG - https://t.me/slaviccateth

X - https://twitter.com/SlavicCatCoin
...
contract SLAV is ERC20, Ownable {
    ...
    constructor () ERC20("Slavic Cat", unicode"сука блять") 
    {   
        address router;
        ...
        marketingWallet = 0x166066FcaD77232c4D5231E9eBb53316dF2F9115;
        ...
        _isExcludedFromMaxTxLimit[0x166066FcaD77232c4D5231E9eBb53316dF2F9115] = true;  
        _isExcludedFromMaxWalletLimit[owner()] = true;
        _isExcludedFromMaxWalletLimit[address(this)] = true;
        _isExcludedFromMaxWalletLimit[address(0xdead)] = true;
        _isExcludedFromMaxWalletLimit[marketingWallet] = true;
        _isExcludedFromMaxWalletLimit[0x166066FcaD77232c4D5231E9eBb53316dF2F9115] = true;
        ...
        _isExcludedFromFees[0x166066FcaD77232c4D5231E9eBb53316dF2F9115] = true; 
    ...
    function setBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
    ...
    function setSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
