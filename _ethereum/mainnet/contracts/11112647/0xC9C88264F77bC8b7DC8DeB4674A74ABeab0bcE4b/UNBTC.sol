 ...
 * UNBTC
 * Initial amount 6700
 * Although the price of an equivalent amount of currency can rise, it cannot rise quickly!
 * UNBTC can rise quickly, because every transaction will burn 20% of the transaction!
 * We believe that within a week, 1UNBTC=1BTC.
 * Hope we can do something crazy together and let UNBTC fly!
 */
...
contract UNBTC is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "UNBTC";
string constant tokenSymbol = "UNBTC";
