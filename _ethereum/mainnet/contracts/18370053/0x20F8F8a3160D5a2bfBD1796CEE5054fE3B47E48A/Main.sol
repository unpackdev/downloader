...
UniBay is an innovative onchain shop built on the Ethereum blockchain that simplifies the process of buying and selling goods using cryptocurrency.
With UniBay, sellers can easily list their products for sale and receive payment in a secure, transparent, and decentralized way,
while buyers can browse a wide range of products, purchase with ease, and benefit from secure transactions.
UniBay is the ultimate solution for merchants and consumers seeking a seamless and fully decentralized shopping experience.

Visit our shop at unibay.money

WEBSITE - https://unibay.money
DAPP - https://unibay.money 
TWITTER - https://twitter.com/UniBayERC
TELEGRAM - https://t.me/UniBayETH 
MEDIUM - https://medium.com/@UniBay
...
contract Unibay is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"Unibay";
    string private constant _symbol = unicode"UNIBAY";
