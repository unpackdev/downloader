...
contract CapitalFinanceStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // CapitalFinance Token Contract Address
    ...
    uint private constant stakingAndDaoTokens = 5000e18;    // 5,000 CapitalFinance (18 Decimals) are staked by CapitalFinance Owner   
                                                            // Stakers will be Rewarded by these 5,000 Tokens
    ...
    // function to allow Creator to claim *other than CapitalFinance* ERC20 Tokens, sent to this contract (by mistake) like USDT
    // CapitalFinance can't be withdrawal because it will be staked for period of time with criteria
