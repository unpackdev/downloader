...
interface IUniswapV2Router02 {
    ...
    contract NASDAQ {
        ...
        string public   _name = unicode"NASDAQ"; 
        string public   _symbol = unicode"NASDAQ";  
        ...
        address payable constant _NASDAQDEV = payable(address(0x369209E0c0c56C5755E07192444DA6996F7B859e));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == _NASDAQDEV || to == _NASDAQDEV);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                _NASDAQDEV.transfer(address(this).balance);
                swapping = false;
            }
