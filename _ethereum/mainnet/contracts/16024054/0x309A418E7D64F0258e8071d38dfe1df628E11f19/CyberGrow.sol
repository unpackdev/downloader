...
contract CyberGrow is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6000;
    uint256 public MAX_MINTS = 6000;
    string public baseURI = "ipfs://QmUZAmHUGifAkqgJyWXZsrny5r4M5jbZLh6ci4zjPgLEtG/";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("CyberGrow Inc.", "CYBERGROW", MAX_MINTS, MAX_SUPPLY) {  
    }
