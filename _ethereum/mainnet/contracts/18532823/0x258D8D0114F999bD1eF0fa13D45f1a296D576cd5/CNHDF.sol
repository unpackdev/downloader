...
contract CNHDF is ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {

    constructor(
    ) ERC721Psi("CryptoNinja Hokkaido Dosanko Foods", "CNHDF") {
        ...
        setBaseURI("https://cnhdf.non-fungible.co.jp/nftdata/json/");
        ...
        _safeMint(0x2d917B19CCF3d97cD25AA336E579521E2e11bb49, 222);    
        setMerkleRoot(0xde4bd554f9cb116a8263426113512b576642d06fe17916477bb24f8168aeccc5);

        //Royalty
        setDefaultRoyalty(0x2d917B19CCF3d97cD25AA336E579521E2e11bb49, 1000);
        setWithdrawAddress(0x2d917B19CCF3d97cD25AA336E579521E2e11bb49);
    ...
    address public withdrawAddress = 0x2d917B19CCF3d97cD25AA336E579521E2e11bb49;
    ...
    uint256 public maxSupply = 2223 -1;
