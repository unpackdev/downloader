...
pragma solidity ^0.8.20;
    ...
    contract HoBo {
        ...
        address payable constant deployer = payable(address(0x97EE8C14088f124a3DaAf505c05dB1F698C6C040)); //
        ...
        function _setHOBO(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
