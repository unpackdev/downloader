...
Twitter: https://x.com/Longcat_eth                                                                 
Website: https://longcat.lol
Telegram: https://t.me/Longcat_eth                                                                                        
...
contract LongCat is ERC20, Ownable {
    ...
    event mktUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor(
        ...
        mkt = address(0x171F75b18a7419Cdd6e3E3F1f6dCB7F34d9b0B4C);
    ...
    function openTrading() external {
        require(
            _msgSender() == owner() || _msgSender() == devAddress,
            "Unauthorized"
        );
        tradingActive = true;
        swapEnabled = true;
    ...
    function updateMktWallet(address newMktWallet) external onlyOwner {
        emit mktUpdated(newMktWallet, mkt);
        mkt = newMktWallet;
    }
    ...
    function swapBack() private {
        ...
        (success, ) = address(mkt).call{value: address(this).balance}("");
    }

    function claimStuckTokens(address token) external {
        require(msg.sender == mkt, "You do not have access to this function");
