...
contract Escrow {
    ...
    address payable public arbiter =
        payable(0xb5f4bcB46df6284932d71d3c11A2B7eD42e16be1);
    ...
    function createEscrowOrder(
        ...
        require(balanceOf(msg.sender) >= _usdtAmount, "You don't have enough USDT balance");
        require(usdtAllowance(msg.sender) >= _usdtAmount, "You haven't approved enough USDT spending.");
