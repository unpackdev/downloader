/*
https://koalainu.com/
https://t.me/koalainueth
https://twitter.com/Koalainu_erc
*/
...
contract KOALA is ERC20, Ownable {
    ...
    constructor() ERC20("Koala Inu", "KOALA") {
        ...
        marketingWallet = 0x72242c323ad6b7e7b6B0d4D242D59BDc05336F60;
        devWallet = 0x72242c323ad6b7e7b6B0d4D242D59BDc05336F60;
    ...
    function StartKoala() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
 
    // remove limits after token is stable
    function TimeToMoon() external onlyOwner returns (bool){
