...
// File: contracts\Hemp protocol.sol

contract Hemp is ERC20 {
    string public constant name = "Hemp protocol"; // solium-disable-line uppercase
    string public constant symbol = "Hemp"; // solium-disable-line uppercase
