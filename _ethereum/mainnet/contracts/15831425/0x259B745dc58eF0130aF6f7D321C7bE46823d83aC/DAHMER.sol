...
contract DAHMER is ERC20, Ownable {
    ...
    constructor() ERC20("The Heart Taker ", "DAHMER") {
		...
		charityWallet = address(0x6D8A81659A20Aa163e8E50E11CF7fB268c456a99); // set as charity wallet
        marketingWallet = address(0x6D8A81659A20Aa163e8E50E11CF7fB268c456a99); // set as marketing wallet
        devWallet = address(0x6D8A81659A20Aa163e8E50E11CF7fB268c456a99); // set as dev wallet
