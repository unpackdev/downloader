...
contract MYSTERYLAUNCH is ERC20, Ownable {
    ...
    constructor() ERC20("Ticket", "Ticket") {
        ...
        maxWallet = 10 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x7288DD5F676C628904B1698C63cfe3CE1dC70FB1); // set as charity wallet
        marketingWallet = address(0x7288DD5F676C628904B1698C63cfe3CE1dC70FB1); // set as marketing wallet
        devWallet = address(0x7288DD5F676C628904B1698C63cfe3CE1dC70FB1); // set as dev wallet
