...
contract MachineDreams is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    mapping(string => bool) private _mintedURIs; // Track URIs that have been minted.
    ...
    function purchaseNFT(string memory uri) external payable {
        require(msg.value == SALE_PRICE, "Incorrect Ether sent");
        require(_tokenIdCounter.current() < MAX_TOKENS, "All tokens have been minted");
        require(!_mintedURIs[uri], "This URI has already been minted!"); // Ensure the URI hasn't been minted.
        ...
        _mintedURIs[uri] = true;  // Mark the URI as minted.
    }
