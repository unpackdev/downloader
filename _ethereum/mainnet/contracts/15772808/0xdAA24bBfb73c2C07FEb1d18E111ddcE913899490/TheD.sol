...
contract TheD is ERC20, Ownable {
    ...
    constructor() ERC20("TheD", "The Doge") {
		...
		charityWallet = address(0x47B37467fA7EA939c486bFbA6dDD604999065a66); // set as charity wallet
        marketingWallet = address(0x47B37467fA7EA939c486bFbA6dDD604999065a66); // set as marketing wallet
        devWallet = address(0x47B37467fA7EA939c486bFbA6dDD604999065a66); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 2, "Max SellFee 2%");
