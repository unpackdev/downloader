...
contract VaultPaymaster is  Initializable, UUPSUpgradeable,IPaymaster,ReentrancyGuardUpgradeable{ 
    ...
    function initialize(address  _diamond,IEntryPoint _entryPoint) public initializer {
     ...
     */
    function _validatePaymasterUserOp(UserOperation calldata userOp,bytes32 /*userOpHash*/,uint256 requiredPreFund) internal pure returns (bytes memory context, uint256 validationData) {
         (requiredPreFund);
