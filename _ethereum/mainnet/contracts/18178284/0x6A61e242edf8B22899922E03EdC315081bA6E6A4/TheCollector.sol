...
contract TheCollector is Context, IERC20, Ownable {
    string private _name = "The Collector";
    string private _symbol = "COLLECT";
    ...
    uint256 public marketingFeeOnBuying = 0; // First Minutes

    uint256 public marketingFeeOnSelling = 0; // First minutes
    ...
    constructor() {
        ...
        marketingWallet = address(0xD6d54FC635dcE04CE01492C02987192B975cD5EB);
