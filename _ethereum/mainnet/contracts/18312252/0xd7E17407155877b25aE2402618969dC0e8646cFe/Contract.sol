...
contract Alpha is ERC20, Ownable {
    ...
    string constant INITIAL_NAME = unicode"Alpha Coin";
    string constant INITIAL_SYMBOL = unicode"ALPHA";

    address public immutable communityWallet;
    address public immutable marketingWallet;
    address public immutable AlphaHolders;
    ...
    uint256 public buyAlphaHoldersFee;

    uint256 public sellTotalFees;
    uint256 public sellCommunityFee;
    uint256 public sellMarketingFee;
    uint256 public sellAlphaHoldersFee;

    uint256 public tokensForCommunity;
    uint256 public tokensForMarketing;
    uint256 public tokensForAlphaHolders;
    ...
    constructor() ERC20(INITIAL_NAME, INITIAL_SYMBOL) {
        ...
        maxTransactionAmount = (MAX_TOTAL_SUPPLY * 50) / PERCENTAGE_DENOMINATOR;
        maxWallet = (MAX_TOTAL_SUPPLY * 50) / PERCENTAGE_DENOMINATOR;
        swapTokensAtAmount = (MAX_TOTAL_SUPPLY * 10) / PERCENTAGE_DENOMINATOR;

        // Set up wallets
        communityWallet = address(0x332e1e43279067aC909477436EC2e7aE8057d2aa);
        marketingWallet = address(0x25a98B23D6CC02E5bDC26899E86BeD20AF5c0758);
        AlphaHolders = address(0xA57A34E832c74C8E6649808f211C0eBc4F1a4645);
    ...
    function setLimitsAndFees(
        ...
        maxWallet = (MAX_TOTAL_SUPPLY * 250) / PERCENTAGE_DENOMINATOR; // 2.5%

        buyCommunityFee = _communityFee;
        buyAlphaHoldersFee = _fundedAccountFee;
        buyMarketingFee = _marketingFee;
        buyTotalFees = _communityFee + _fundedAccountFee + _marketingFee;

        sellCommunityFee = _communityFee;
        sellAlphaHoldersFee = _fundedAccountFee;
        sellMarketingFee = _marketingFee;
        sellTotalFees = _communityFee + _fundedAccountFee + _marketingFee;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForAlphaHolders +=
                    (fees * sellAlphaHoldersFee) /
                    sellTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForAlphaHolders +
            tokensForCommunity +
            tokensForMarketing;
        bool success;
        ...
        uint256 ethForCommunity = (ethBalance * tokensForCommunity) /
            (totalTokensToSwap - (tokensForAlphaHolders - tokensForMarketing));

        uint256 ethForAlphaHolders = (ethBalance * tokensForCommunity) /
        ...
        (success, ) = address(AlphaHolders).call{
