...
contract The_Pixel_Captainz is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 1069;

    
    uint256 public WHITELIST_SUPPLY = 1048;
    ...
    constructor(
        ...
        _safeMint(0xc858Db9Fd379d21B49B2216e8bFC6588bE3354D7, 20);
    }
