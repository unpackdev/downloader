...
contract Elon is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Good Episode"; 
    string private constant _symbol = unicode"Episode";

    uint8 public buyTax = 25; 
    uint8 public sellTax = 45;

    address public marketingWallet = 0x535d6EE87286f11a7E1b12847a2De8BcDf7CA820; 
