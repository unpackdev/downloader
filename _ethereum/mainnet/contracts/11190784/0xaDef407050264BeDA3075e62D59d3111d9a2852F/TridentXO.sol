...
contract TridentXO is StandardToken {

  string public constant name = "Trident XO";
  string public constant symbol = "TTiX";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 72573 * (10 ** uint256(decimals));
