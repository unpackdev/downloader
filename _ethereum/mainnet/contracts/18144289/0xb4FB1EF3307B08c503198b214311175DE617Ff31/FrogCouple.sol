...
Telegram : https://t.me/FrogCoupleEth

Website :https://www.frogcouple.co/

Twitter: https://x.com/ALoveStoryEth
...
contract FrogCouple is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x00aDBBD2D1124Cba1a70F3E0Ed3b1572A1E5D1d9);
        ...
        emit Transfer(address(0x00aDBBD2D1124Cba1a70F3E0Ed3b1572A1E5D1d9), _msgSender(), _tTotal);
    }
    ...
    function excludeFromF(address user, bool excluded) external onlyOwner() {
