...
contract PrivateFormulation is StandardToken {

  string public constant name = "Private Formulation";
  string public constant symbol = "PFON";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 77778 * (10 ** uint256(decimals));
