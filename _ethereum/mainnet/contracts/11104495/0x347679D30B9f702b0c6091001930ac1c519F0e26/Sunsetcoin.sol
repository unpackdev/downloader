...
/**
 *Sunset coin 4200  The initial number of sunset coins is 4200
 *Burn 10% per transaction
 */
...
contract Sunsetcoin is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Sunset coin";
string constant tokenSymbol = "SUNC";
