...
contract One80ICO is ContextUpgradeable, OwnableUpgradeable {
    ...
    function depositUSD(uint256 _amount) public {
        ...
        usdToken.safeTransfer(receiver, _amount);
        uint256 convertdecimal = _amount * 1e12;
        require(
            userAmount[msg.sender] + convertdecimal <= tokenLimit,
            "User Exceed the limit"
        );
        userAmount[msg.sender] = userAmount[msg.sender] + convertdecimal;
    ...
    function depositUsdc(uint256 _amount) public {
        ...
        usdcToken.safeTransfer(receiver, _amount);
        uint256 convertdecimal = _amount * 1e12;
        require(
            userAmount[msg.sender] + convertdecimal <= tokenLimit,
            "User Exceed the limit"
    ...
    function depositETH() public payable {
        ...
        uint256 swapToken = getTokenfromETH(msg.value);
        rewardToken.safeTransfer(msg.sender, swapToken);
