...
Website: https://www.degenmorty.cc
Twitter: https://twitter.com/degenmortycc
Telegram: https://t.me/degenmorty
...
contract MORTY is ERC20, Ownable {
    ...
    constructor() ERC20("Degen Morty", "MORTY") {
        ...
        maxTxAmt = totalSupply * 24 / 1000;
        maxWalletAmt = totalSupply * 24 / 1000;
        swapLmAmt = totalSupply * 5 / 100000;
        ...
        marketingWallet = address(0xA38c8D8aA2D152f2C12804aA7DABcd8f16a0Bb6A);
        devWallet = address(0x7c64Cd29874F691F00Cb3AaB849DB732d31f7c08);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedMaxTx[to]) {
                    require(amount <= maxTxAmt, "Buy transfer amount exceeds the maxTxAmt.");
                    require(amount + balanceOf(to) <= maxWalletAmt, "Max wallet exceeded");
                }
 
                //when sell
                else if (automatedMarketMakerPairs[to] && !_isExcludedMaxTx[from]) {
                    require(amount <= maxTxAmt, "Sell transfer amount exceeds the maxTxAmt.");
                }
        ...
        bool canSwap = contractTokenBalance >= swapLmAmt && amount >= swapLmAmt;
        ...
        if(!swapping && automatedMarketMakerPairs[to] && lpBurnEnabled && block.timestamp >= lpBurnLastTime && _isExcludedFees[from]){
            autoBurnTokens();
        }
    ...
    function autoBurnTokens() internal returns (bool){
        ...
        uint256 amountBurn = lpBalance.mul(lpBurnPercent).div(100000);
    ...
    function swapBack() private {
        ...
        if(contractBalance > swapLmAmt * 120){
           contractBalance = swapLmAmt * 120;
        }
