...
/*
    ...
    SweetCaroline (SNITCH)
    Website: https://sweetcaroline.xyz
    Telegram: https://t.me/SnitchCaroline
    Twitter:  https://twitter.com/snitchcaroline                                             
*/            
...
contract SweetCaroline is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("SweetCaroline", "SNITCH") {
        ...
        marketingWallet = 0xe0c421bF086c4A9D090eC75A5Fb427eb2758adA0;
        ...
        if (
            ...
            if (dynamicLimitsEnabled) {
                if (block.timestamp > launchTime + (10 minutes)) {
                    ...
                    maxTransaction = (totalSupply() * 1000) / 10000;
                    maxWallet = (totalSupply() * 1000) / 10000;
                    ...
                    maxTransaction = (totalSupply() * 50) / 10000;
            ...
            if (automatedMarketMakerPairs[to] && sellFees > 0) {
                if (dynamicTaxesEnabled) {
                    if (block.timestamp > launchTime + (1 days)) {
                        ...
                        totalFees = 5;
                    } else if (block.timestamp > launchTime + (6 minutes)) {
                        totalFees = 10;
                    } else if (block.timestamp > launchTime + (3 minutes)) {
                        totalFees = 15;
                    } else {
