...
contract BEG is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = _totalSupply / 100 / 5;
    ...
    constructor() {
        ...
        transferOwnership(0x4A2443877aBf999AA421f84d0751cb8dD471F09E);
