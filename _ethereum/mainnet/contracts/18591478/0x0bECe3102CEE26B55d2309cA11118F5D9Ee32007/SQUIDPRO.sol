...
contract SQUIDPRO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SQUID REBORN Game Pro";
    string private constant _symbol = unicode"SQUIDPRO";
