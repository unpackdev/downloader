    ...
    PausableUpgradeable
{
    ...
    function unlockNFTs(address collection, uint256 expiryTs, uint256[] memory nftIds, address receiver)
        public
        whenNotPaused
    {
        mustValidNftIds(nftIds);
    ...
    function tidyExpiredNFTs(address collection, uint256[] memory nftIds) public whenNotPaused {
        mustValidNftIds(nftIds);
