...
import "./ERC721A.sol";
import "./MetaRebelzV5.sol";

contract MetaRebelzPixelzV11 is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable, ERC721ABurnableUpgradeable {
    uint256 public cost;   
...
function claimOriginal(uint256[] memory tokenIds) public payable {
    ...
    MetaRebelzV5(0x94c2911cEB9B3684204C63b8E204A660990b7318).mint(claimGiveAmount, msg.sender);
}
