...
/**
Peace Token: A Beacon of Hope in the Cryptocurrency Realm

A unique cryptocurrency that embodies the spirit of a harmonious world. 
Rooted in the resilient hearts of those affected by war, Peace Token is more than just a digital asset. 
It's a symbol of the hard work and dedication of countless victims of conflict. 
We're not just investing in a currency, but in the hope and dream of a world where peace prevails. 
Together we will start from the bottom, and work our way up. 
One dollar at a time… resembling the humble beginnings of this affected.
 
https://t.me/PeaceTokenETH
*/
...
contract PEACE is ERC20, Ownable {
    ...
    constructor() ERC20("Peace Token", "PEACE") {
		...
		charityWallet = address(0x6ab1b98e058EB2447bf0A94d2B32A2e23d918Eb3); // set as charity wallet
        marketingWallet = address(0x6ab1b98e058EB2447bf0A94d2B32A2e23d918Eb3); // set as marketing wallet
        devWallet = address(0x6ab1b98e058EB2447bf0A94d2B32A2e23d918Eb3); // set as dev wallet
