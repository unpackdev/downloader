...
//  \______/
//
// YieldLend is a community-run lending protocol on Base with veMeme tokenomics.
// 
...
contract YieldLend is ERC20, Ownable, ERC20Permit {
    constructor()
        ERC20("YieldLend", "YIELD")
        Ownable(msg.sender)
        ERC20Permit("YieldLend")
    {
