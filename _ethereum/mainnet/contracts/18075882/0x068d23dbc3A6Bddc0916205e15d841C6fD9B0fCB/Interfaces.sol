...
interface IDoughV1Index {
    ...
    function SHIELD_FEE_TOTAL() external view returns (uint256);

    function doughV1Shield() external view returns (address);
...
interface IDoughV1Flashloan {
    function flashloanReq(address loanToken, uint256 loanAmount, uint256 feeAmount, uint256 funcId) external;
}
