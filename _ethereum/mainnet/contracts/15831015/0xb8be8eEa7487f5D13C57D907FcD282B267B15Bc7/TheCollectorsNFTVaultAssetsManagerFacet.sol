...
contract TheCollectorsNFTVaultAssetsManagerFacet is TheCollectorsNFTVaultBaseFacet {
    ...
    */
    ...
    function isVaultReadyToBuyAsset(uint64 vaultId) public view returns (bool) {
        try this.requireBuyConsensusAndValidatePurchasePrice(vaultId) {
        } catch {
            return false;
        }
        return true;
    ...
    function requireBuyConsensusAndValidatePurchasePrice(uint64 vaultId) public view {
        _requireBuyConsensusAndValidatePurchasePrice(vaultId, 0);
    }
