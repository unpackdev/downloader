...
contract dontape is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"THIS IS A TEST MEME TOKEN DO NOT APE";
    string private constant _symbol = unicode"DONTAPE";
    uint256 public _maxTxAmount =  _tTotal / 100000;
    uint256 public _maxWalletSize =   _tTotal / 100000;
    uint256 public _taxSwapThreshold=  _tTotal / 100000;
    uint256 public _maxTaxSwap=   _tTotal / 100000;
    ...
    constructor () {
        ...
        _teamWallet = payable(0x649Ff99dFCC7d9Eed2637307FCC245D604674C49);
