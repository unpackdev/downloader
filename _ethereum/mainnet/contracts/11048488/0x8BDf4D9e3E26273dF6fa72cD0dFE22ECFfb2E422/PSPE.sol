...
contract PSPE is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Pumping speed";
  string constant tokenSymbol = "PSPE";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 3000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0x419B90526341c6F379fa66511E18EBEABb05F8A8, tokensToBurn);
    return true;
  }
