    ...
    ExponentialNoError
{
    ...
    uint internal constant collateralFactorMaxMantissa = 0.97e18; // 0.97
    ...
    function _setCloseFactor(
        ...
        require(newCloseFactorMantissa >= closeFactorMinMantissa, "newCloseFactorMantissa below min");
        require(newCloseFactorMantissa <= closeFactorMaxMantissa, "newCloseFactorMantissa exceeds max");
    ...
    function updateCompSupplyIndex(address cToken) internal {
        ...
        if (deltaBlocks > 0 && supplySpeed > 0) {
            // console.log(
            //     "updateCompSupplyIndex: deltaBlocks",
            //     deltaBlocks,
            //     "supplySpeed",
            //     supplySpeed
            // );
    ...
    function distributeSupplierComp(address cToken, address supplier) internal {
        ...
        // console.log(
        //     "distributeSupplierComp: supplierIndex",
        //     supplierIndex,
        //     "supplyIndex",
        //     supplyIndex
        // );
        ...
        // console.log("distributeSupplierComp: deltaIndex", deltaIndex.mantissa);
        ...
        // console.log(
        //     "distributeSupplierComp: supplierDelta",
        //     supplierDelta,
        //     "supplierAccrued",
        //     supplierAccrued
        // );
    ...
    function grantCompInternal(
        ...
        River comp = River(getCompAddress());
    ...
    function getCompAddress() public view virtual returns (address) {
        // TODO won't relase governance token at this time
        return address(0);
    }
}
