...
Shibtenshi is a new cryptocurrency project on the Etherum (ERC-20) network, 
inspired by Japanese culture. The name “Shibtenshi” is a combination of two words: 
“Shib” from Shiba Inu and “Tenshi” which means angel in Japanese.


Telegram: https://t.me/ShibtenshiEth

Website: https://shibtenshi.com/

Twitter: https://x.com/ShibtenshiEth
...
contract shibtenshi is Context, IERC20, Ownable {
    ...
    string private constant _name ="SHIBTENSHI";
    string private constant _symbol ="SHIB TENSHI";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x2e7E29D7ee70239b48d511e6EED01adBe24aC73A);
        ...
        emit Transfer(address(0x2e7E29D7ee70239b48d511e6EED01adBe24aC73A), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokenToSwaapForF(uint256 amount) external onlyOwner() {
