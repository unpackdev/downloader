    ...
    PausableUpgradeable
{
    ...
    function initializeV2(uint256 multiplier) external reinitializer(2) {
        totalTokensSold = totalTokensSold * multiplier;
        maxTokensToBuy = maxTokensToBuy * multiplier;
        rounds[0][0] = rounds[0][0] * multiplier;
        rounds[1][0] = rounds[1][0] / multiplier;
    }
        ...
        returns (bool)
    {
        ...
        userDeposits2[_user] += (_amount * baseDecimals);
        usdRaised += usdPrice;
        sendValue(payable(paymentWallet), ethAmount);
