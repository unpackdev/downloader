...
/*  
**   Stealth launch. 4:52am PST. No official social medias whatsoever. Never will be.
*/
...
contract TheAbyss is ERC20, Ownable {
    ...
    constructor() ERC20( "The Abyss", "ABYSU") {
        ...
        operationsAddress = address(0x4F8Ef1B600654746e8a17979514E6f9151119f12); // change this address to wallet u want for operations   
        TaxAddress = address(0x4F8Ef1B600654746e8a17979514E6f9151119f12);  // change this address to the one for tax 
