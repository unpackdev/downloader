...
Telegram: https://t.me/PegasusCoinETH
Website: https://pegasuscoin.vip/
Twitter: https://twitter.com/PegasusCoinETH
...
contract Pegasus is ERC20, Ownable {
    ...
    constructor() ERC20("Pegasus", "PEGASUS") {
    ...
    function openTrading(uint256 _blocks) external onlyOwner {
        blocks = _blocks;
        tradingActive = true;
        swapEnabled = true;
