// Telegram: https://t.me/RapeHourEth 
// Discord:  
// Twitter: https://twitter.com/redactedcoineth 
// Website: https://rapehoureth.com/
...
contract Rapehoureth is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x85827dD7a901FE5C5bF656e3c1C69e1ea38496fa;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 1500;
    uint16 public feeOwnerInitialPercentageSell = 1500;
    ...
    uint256 public maxTokenAmountPerWallet = 30000000 * 10 ** decimals();
    uint256 public maxTokenAmountPerTransaction = 7500000 * 10 ** decimals();
    ...
    constructor() ERC20(unicode"Rape Hour", unicode"RAPE") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x85827dD7a901FE5C5bF656e3c1C69e1ea38496fa, ownerReceiverSupply * 10 ** decimals());
        } else {
