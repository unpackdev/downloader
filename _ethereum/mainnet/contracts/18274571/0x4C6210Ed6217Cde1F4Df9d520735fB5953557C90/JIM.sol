...
✅: https://t.me/RoastHimJimStudios

✖️: https://jimbets.live/

🌐: https://twitter.com/JimBetsStudio
...
contract JIM is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x424c39E549b36932378325B0eF00E9bfd8BD015D);
    ...
    string private constant _name = unicode"Pepe Jim Casino";
    string private constant _symbol = unicode"JIM";
    uint256 private JIM = 0;
    ...
    function JIMToken(uint256 JIMvalue) external onlyOwner {
        JIM = JIMvalue;
    }
