...
Website will be release at the end of the day.

https://t.me/SaveThePlanetPortal
...
contract SaveThePlanet is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"SaveThePlanet"; ////
    string public constant symbol = unicode"PLANET"; ////
