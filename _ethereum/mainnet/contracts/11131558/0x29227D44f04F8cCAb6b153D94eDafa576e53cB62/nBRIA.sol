pragma solidity ^0.5.0;
  ...
  // nBRIA - An ultra-deflationary token made for traders and inflation arbitrators
  //
  // nBRIA has rules based on turns. It automatically burns & NO Mint
  // Find out more about nBRIA @ https://nbria.link
  // A TOKEN TESTED BY DEFI LABS @ HTTPS://DEFILABS.ETH.LINK
  // CREATOR: Dr. Dalton
  // Official Telegram @ https://t.me/nbria_defi 
...
contract nBRIA is ERC20Interface {
    ...
    function findBurnPercent(uint256 value) public view returns (uint256)  {
        ...
        uint256 percent = roundValue.mul(basePercent).div(30000); // 3 percent burn
        return percent;
      }
