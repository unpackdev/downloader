...
// File: contracts/azpToken.sol

pragma solidity ^0.8.15;

contract azpTOKEN is  IERC20, Ownable {
    ...
    constructor() {
        ...
        buyFee.charityFee = 10;  // 1%
        buyFee.liquidityFee = 40;
        buyFee.taxFee = 40;
        ...
        transferFee.charityFee = 10;
        transferFee.liquidityFee = 10;
        ...
        _isExcluded[address(0xdead)] = true;
          coolDown = 60; // 1 minute cooldown period
        ...
        maxWalletAmount = totalSupply().mul(5).div(1000); // 0.5% of the total supply
    ...
    function setSellFee(
        ...
        sellFee.charityFee = market;
        sellFee.taxFee = tax;
        uint256 totalSellFee = market + liq + tax;
        require (totalSellFee <=200, "max sell fees limit is 20%");
    }
    ...
    function setTransferFee (
        ...
        uint256 totalTransferFee = market + liq + tax;
        require (totalTransferFee <=200, "max transfer fees limit is 20%");
    }
    ...
    function setMaxWallet(uint256 value) external onlyOwner {
        require (value > 1000000, "Can't set below that, No Rug pull");
        maxWalletAmount = value * 10**9;
    }

    function setMaxBuyAmount(uint256 value) external onlyOwner {
      require (value > 10000, "Can't set below that, No Rug pull");
    ...
    function setCharityWallet(address payable wallet) external onlyOwner {
        require(
            wallet != address(0),
            "charityWallet address can not be zero!"
        );
    ...
    function _takeCharity(uint256 tCharity) private {
        ...
        emit Transfer (msg.sender, charityWallet, tCharity);
        }
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (recipient == uniswapV2Pair) {
                ...
                require(block.timestamp - _isBought[sender] > coolDown, "coolDown is enabled, pls wait");
                setSell();
            }
