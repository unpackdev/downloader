...
//https://twitter.com/theapeterminal
//https://www.apeterminal.com/
...
contract apeT is ERC20, Ownable {
 ...
 //Wallets
 devWallet = address(0x8725F36C57a763bBDBd236Bd76010AE3D2CcEAB8);
 marketingWallet = address(0x8725F36C57a763bBDBd236Bd76010AE3D2CcEAB8);
...
//Limits
 ...
 function updateMaxAPEAmount(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
 ...
 function updateMaxWalletAPEAmount(uint256 newPercentage) external onlyOwner {
