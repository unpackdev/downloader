...
contract TWOKA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TWOKA", "TWOKA") {
        ...
        swapTokensAtAmount = (totalSupply * 10) / 30000; // 0.1% swapWallet
        ...
        // ~ marketing wallet
        marketingWallet = address(0x18DDA45554E9232421A1Ce10c40543c7D78e7cA1); 
