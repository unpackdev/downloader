...
contract ALPHA is ERC20, Ownable {
    ...
    constructor() ERC20("Alpha Token", "ALPHA") {
		...
		developmentWallet = address(0x9097BFE86c0BF8b74A88c68F99f822e0579C1083); // 
        marketingWallet = address(0x82E16444d96FBBD366A71F274bAdAdD8b2425F1e); // 
        devWallet = address(0xCfbCCf656152c1053Bd08134e005951F294F4563); // 
