...
contract StakingRewards is Ownable, ReentrancyGuard, StakingRewardsAcceleration {
    ...
    constructor() public Ownable() {
        rewardsToken = IERC20(0xAE66bEa480f7a6C91F07C58f2AEe185883558fb8);
        stakingToken = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        y3dToken = Iy3dToken(0xe44aFC0319736759Dbb3222D3DD8259ABb374b0C);
        stakingToken.approve(0xe44aFC0319736759Dbb3222D3DD8259ABb374b0C, uint(-1));
        ref = IRef(0x101C96b59A5d26895BE12b2f13bC354fe01af246);
    }
    ...
    function stake() public payable {
        require(address(stakingToken) == address(0), "Use stake(amount) to stake non-ETH token");
        _stake(msg.value);
    }
    function stake(uint256 amount) public {
        require(address(stakingToken) != address(0), "Use stake() to stake ETH");
        stakingToken.safeTransferFrom(msg.sender, address(this), amount);
