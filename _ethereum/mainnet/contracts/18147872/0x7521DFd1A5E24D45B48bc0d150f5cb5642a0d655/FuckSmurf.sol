/**
https://twitter.com/FuckSmurfEth
*/
...
contract FuckSmurf is ERC20, Pausable {
    address owner;
    address public taxRecipient = 0x883d010a846Ed85ab63987D28004Eae6A9DE0b6A;
    ...
    constructor() ERC20(unicode"НАХУЙ ШАЙЛУШАЙ", "FUCKSMURF") {
        owner = msg.sender;
