...
contract StakingPool is Context, Ownable, ReentrancyGuard {
    ...
    function stake(uint256 _amount) external payable nonReentrant {
        require(msg.value >= getCurrentFeeInETH() * 95/100, 'not enough fees has been sent');
        // Transfer the entire message value to the team wallet
