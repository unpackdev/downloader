...
contract NFT is 
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControlEnumerable, LazyMintAdventureERC721CInitializable, MutableMinterRoyaltiesBase) returns (bool) {
