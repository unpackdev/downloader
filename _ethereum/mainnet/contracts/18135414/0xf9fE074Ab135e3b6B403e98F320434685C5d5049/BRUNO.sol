...
contract BRUNO is ERC20, Ownable {
    ...
    constructor() ERC20("Bruno", "BRUNO") {
        ...
        developmentWallet = address(0xdc07EFdbd3aBB7340f15227D559B165fB087740E); // set as development wallet
        marketingWallet = address(0xE744Eef2ac91fB02A7b766652bc1684a13C5E5F3); // set as marketing wallet
        devWallet = address(0x341C698d54E5420D5A0cCD84BE8cE51Aa82CAc2e); // set as dev wallet
