...
contract HiKing is ERC20, Ownable {
    ...
    constructor() ERC20("HiKing", "hiK") {
        ...
        developmentWallet = address(0xa18D43957314FCa986fC55DEA6BAAC7B4f131d77); // set as development wallet
        marketingWallet = address(0x6117e1debEd39D34a3C3BA45de799611f67562cd); // set as marketing wallet
        devWallet = address(0x161e304ACBEc1045B8Db6E5211c2612D37330d9C); // set as dev wallet
