...
contract UDSCBT is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Up, Down, Strange, Charm, Beauty & Truth", unicode"UDSCBT") {
    ...
    function BoughtUDSCBTEarly(address wallet, bool flag) external onlyOwner {
        bot[wallet] = flag;
    }

    function massUDSCBTBoughtEarly(address[] calldata wallets, bool flag) external onlyOwner {
