...
contract BlackCORE is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  address devWallet = 0x5D23B7DEA677A5e451C51B518117e5AF5e0D5e0d;
  address[] degenWallets = [devWallet, devWallet, devWallet];
  string constant tokenName = "BlackCORE";
  string constant tokenSymbol = "BCORE";
