...
contract PikaDoge is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xDe91ceFeeB1f15a80c4C3BC18B325aE77eFaD290;
    ...
    constructor () ERC20("PikaDoge", "PIKDOG")
    {
        transferOwnership(0xDe91ceFeeB1f15a80c4C3BC18B325aE77eFaD290);
    ...
    function drainErrorBalance() external {
        payable(marketingWalletAddress).transfer(address(this).balance);
    }

    function drainErrorToken(address _token) external {
