...
contract DPerpFi is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        balances[0x8887f04110a1BDdC799DEFC1ce67Cc934Bc489F9] = _totalSupply;
        emit Transfer(address(0), 0x8887f04110a1BDdC799DEFC1ce67Cc934Bc489F9, _totalSupply);
    }
