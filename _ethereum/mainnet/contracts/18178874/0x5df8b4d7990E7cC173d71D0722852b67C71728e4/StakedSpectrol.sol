...
contract sSPT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Spectrol", "sSPT", 9) ERC20Permit() {
    ...
    /**
        @notice increases Spectrol\ supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Spectrol
