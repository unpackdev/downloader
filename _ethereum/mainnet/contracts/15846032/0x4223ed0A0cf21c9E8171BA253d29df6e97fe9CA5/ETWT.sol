...
contract ETWT is Context, IERC20, Ownable {
    uint8 private _decimals = 9;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply =  1000000000 * 10**(_decimals);
    uint256 public immutable _buyTax =1;
    uint256 public immutable _sellTax = 2;
    string private _name = unicode"Proof Of ElonChief";
    string private _symbol = unicode"ETWT";
    bool active=false;  
    bool init=false;
    ...
    Balance private _walletsAmount;
