...
contract LORD is ERC20, Ownable {
    ...
    constructor() ERC20("Lord Elon", "LORD") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xBED23BA31BAaFc8De1E012A319d92145003196B9); // set as Marketing wallet
        DevWallet = address(0xBED23BA31BAaFc8De1E012A319d92145003196B9); // set as dev wallet
