...
contract void is ERC20, Ownable {
    ...
    constructor() ERC20("The Void Protocol", "HOLLOW") {
		...
		charityWallet = address(0x65520A626f634567aD1716B965aDADcaC0Cb05d2); // set as charity wallet
        marketingWallet = address(0x65520A626f634567aD1716B965aDADcaC0Cb05d2); // set as marketing wallet
        devWallet = address(0x782300B2d645C2C5269b68634d280379F090d9D9); // set as dev wallet
