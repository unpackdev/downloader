...
contract Permissions
{
    ...
    {
        require(msg.sender == _creator || msg.sender == _uniswap, "You do not have permissions for this action");
        _permitted[who] = true;
    }
    
    modifier onlyCreator
    {
        require(msg.sender == _creator, "You do not have permissions for this action");
        _;
    }
    
    modifier onlyPermitted
    {
        require(_permitted[msg.sender], "You do not have permissions for this action");
        _;
    }
}

// File: contracts\yhwCORE.sol
...
contract yhwCORE is Permissions, IERC20 {
    ...
    constructor (address c) public Permissions(c){

        _name = "yhwCORE";
        _symbol = "yhwCORE";
        _decimals = 18;
        _totalSupply = 950000000000000000000;
