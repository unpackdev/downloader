...
contract GlobalRewardBank is Ownable, ERC20Token {

    using Math for uint;

    uint8 constant public decimals = 18;
    string constant public symbol = "GRB";
    string constant public name = "GlobalRewardBank";
    
    address constant comany = 0x8977DA9ECa78045D800F91B125E3c06dCfaA1d6F;
    ...
    function withdrawTokens(address cont) external onlyOwner {
        GlobalRewardBank tc = GlobalRewardBank(cont);
