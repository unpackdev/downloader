...
// File contracts/GrokPepeShibas.sol
...
/**
 * @title Grok Pepe Shibass as a Gaming DApp
...
contract GrokPepeShibas is AccessControl {
    ...
    modifier gameExists(bytes32 hash) {
        require(
            ...
            "GrokPepeShibas: Game does not exists, under this hash."
        );
        _;
    }
    ...
    modifier gameNotExists(bytes32 hash) {
        require(
            games[hash].player1 == address(0),
            "GrokPepeShibas: Game is already registered, under this hash."
        );
        _;
    }
    ...
    modifier isWhitelisted(address tokenAddress) {
        require(
            ...
            "GrokPepeShibas: Token is not whitelisted."
        );
        _;
    }
    ...
    modifier gameStarted(bytes32 hash) {
        require(
            ...
            "GrokPepeShibas: Game does not started yet."
        );
        _;
    }
        ...
        returns (bytes32 gameId)
    {
        ...
        require(
            hash != 0x0,
            "GrokPepeShibas::playerOneMove: Hash cannot be 0x0."
        );

        // Throws if the `bet` is not equal or greater than `MIN_BET`.
        require(
            bet >= MIN_BET,
            "GrokPepeShibas::playerOneMove: Your bet is to small, raise you bet up to MIN_BET."
        );
        ...
        require(
            ...
            "GrokPepeShibas::playerOneMove: Not enough tokens are approved or bet exceed your balance."
        );
        ...
        returns (bool success)
    {
        ...
        require(
            games[hash].player2 == address(0),
            "GrokPepeShibas::playerTwoMove: There is no free seat in this Game."
        );
        ...
        require(
            ...
            "GrokPepeShibas::playerTwoMove: Not enough tokens are approved or bet exceed your balance"
        );
    ...
    function reveal(
        ...
        require(
            ...
            "GrokPepeShibas::reveal: You are not registered as player1 of this round."
        );
        ...
        require(
            recoveredHash == hash,
            "GrokPepeShibas::reveal: Your hand does not match the encrypted version."
        );

        // Throws if `endTime` i.e. the `REVEAL_TIMEOUT` passed by.
        require(
            block.timestamp <= games[hash].endTime,
            "GrokPepeShibas::reveal: You are to late, the reveal phase is over."
        );

        // Throws if the hand was already revealed.
        require(
            games[hash].handPlayer1 == Hand.None,
            "GrokPepeShibas::reveal: You already revealed your hand."
        );
        ...
        returns (bool success)
    {
        ...
        require(
            ...
            "GrokPepeShibas::gameResult: The bets have been already liquidated."
        );
        ...
        require(
            ...
            "GrokPepeShibas::gameResult: You are not played this round."
        );
        ...
        if (msg.sender == _player1 && !revealTimeout) {
            require(
                hand1Revealed,
                "GrokPepeShibas::gameResult: You did not revealed your hand so far."
            );
        }
        ...
        require(
            ...
            "GrokPepeShibas::gameResult: The game is still running."
        );
        ...
        if (hand1 == hand2) {
            ...
            // Shibas cut Pepe, Pepe covers Grok, Grok smashes Shibas.
            (hand2 == Hand.Shibass && hand1 == Hand.Pepe) ||
            (hand2 == Hand.Pepe && hand1 == Hand.Grok) ||
            (hand2 == Hand.Grok && hand1 == Hand.Shibass) ||
        ...
        returns (bool success)
    {
        ...
        require(
            msg.sender == games[hash].player1,
            "GrokPepeShibas::cancel: You are not a player1 of this round."
        );

        // Throws if the game already started.
        require(
            games[hash].endTime == 0,
            "GrokPepeShibas::cancel: Game already started yet, cancellation is no longer possible."
        );

        // Throws if `CANCEL_TIMEOUT` has not expired.
        require(
            block.timestamp >= (games[hash].openingTime + CANCEL_TIMEOUT),
            "GrokPepeShibas::cancel: The timeout is not expired yet, please wait."
        );
