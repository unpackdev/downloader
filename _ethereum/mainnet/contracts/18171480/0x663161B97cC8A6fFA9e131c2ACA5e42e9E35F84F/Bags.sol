...
contract Bags  is ERC20, Ownable {
 ...
 //Wallets
 devWallet = address(0xCBa9eED9F2CDBb10802A7d366C8D4Bb7129e03AE);
 marketingWallet = address(0xCBa9eED9F2CDBb10802A7d366C8D4Bb7129e03AE);
...
//Limits
 maxBuyAmount = totalSupply * 1/2 / 100;
 maxSellAmount = totalSupply * 1/2 / 100;
 maxWalletAmount = totalSupply * 1/2 / 100;
