...
contract TheDestroyer is ERC20, Ownable {
    ...
    constructor() ERC20("Gorlock", "GORLOCK") {
        ...
        maxWallet = 20_000_000 * 1e9 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0xE93f169371F3503Eb161E097B3FD8F07ae3ad0c7); // set as dev wallet
        MarketingWallet = address(0xE93f169371F3503Eb161E097B3FD8F07ae3ad0c7); // set as mkt wallet
