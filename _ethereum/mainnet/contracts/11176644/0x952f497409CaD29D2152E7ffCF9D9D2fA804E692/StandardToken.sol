...
contract USDP is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function USDP() {
        ...
        name = "USDP";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "USDP";                                             // Set the symbol for display purposes (CHANGE THIS)
