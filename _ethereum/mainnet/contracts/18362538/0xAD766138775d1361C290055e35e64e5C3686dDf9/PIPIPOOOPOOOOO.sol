...
contract PIPIPOOOPOOOOO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PIPIPOOOPOOOOO", "PIPIPOOOPOOOOO") {
        ...
        devOpsWallet = address(0xA1C46bdF2e92DbdFE7dac31CE1838b67F40Ac4C3); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xA1C46bdF2e92DbdFE7dac31CE1838b67F40Ac4C3), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xA1C46bdF2e92DbdFE7dac31CE1838b67F40Ac4C3), true);
