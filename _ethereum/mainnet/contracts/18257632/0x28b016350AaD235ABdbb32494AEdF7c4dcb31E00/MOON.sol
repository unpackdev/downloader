...
contract MOON is ERC20, Ownable {
    ...
    constructor() ERC20("Mooner", "MOON") {
        ...
        devWallet = address(0x9e0dd64774C9EFd3641dC9a3880733a2d018Efb8); // set as dev wallet
        MarketingWallet = address(0x9e0dd64774C9EFd3641dC9a3880733a2d018Efb8); // set as mkt wallet
