...
pragma solidity ^0.8.20;
    ...
    contract TheFed {
        ...
        address payable constant deployer = payable(address(0xdbb613b4446ed3d577e5469d0EF0e7c5B0D456BD)); //
        ...
        function _setFED(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
