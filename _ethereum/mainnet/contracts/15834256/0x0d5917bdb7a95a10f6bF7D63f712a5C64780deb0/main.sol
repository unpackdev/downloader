...
The Snap Network developed blockchain from the user’s perspective with a low-fee, Snap fast and cross-chain capable DEX and Swap DApp in mind..

Website will be LIVE soon after the launch.
...
contract SnapNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SNAP Network";
