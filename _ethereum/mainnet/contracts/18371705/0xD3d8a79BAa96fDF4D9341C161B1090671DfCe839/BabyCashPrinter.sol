...
// Baby Cash Printer is the simplest and most effective way to print money without risk in this crappy market
// Discover the feeling of printing money risk-free🍀

//Telegram: https://t.me/BabyCashPrinterPortal
//Twitter: https://twitter.com/BabyCashPrinter
//Dapp: http://babycashprinter.xyz/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      // Mainnet
      rewardTokens.push(address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48)); // USDC - Mainnet  
...
contract BabyCashPrinter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyCashPrinter", "BCP") {
    	...
    	operationsWallet = address(0x5F1D2c9454991A49a39fA4F8E97f60D2c92DCB1A); // set as operations wallet

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);//0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D Router UniswapV2
    ...
    function setBlacklist(address[] memory blacklisted_, bool status_) public onlyOwner {
        if (status_ == true) {
            require(block.number < tradingActiveBlock + 4, "too late to blacklist");
        }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x5F1D2c9454991A49a39fA4F8E97f60D2c92DCB1A), 
            block.timestamp
        );
