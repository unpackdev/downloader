...
contract Proxy is ERC721 {
    ...
    constructor(string memory _name/*, address payable owner*/)
        ERC721(
            vCollection(toAddress(_name)).name(),
            vCollection(toAddress(_name)).symbol()
        )
    {
        //_owner = owner;
        collection = vCollection(toAddress(_name));
    }
    ...
    function tokenByIndex(uint256 index) public view returns (address) {
        return collection.tokenByIndex(index);
    }
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index)
        ...
        returns (address)
    {
        return collection.tokenOfOwnerByIndex(owner, index);
    }
    ...
    function safeTransferFrom(
        ...
        collection.safeTransferFrom(from, to, tokenId, _data);
    }
    ...
    function getApproved(uint256 tokenId)
        ...
        returns (address)
    {
        return collection.getApproved(tokenId);
    }

    function setApprovalForAll(address to, bool approved) public override {
        collection.setApprovalForAll(to, approved);
    }
    ...
    function isApprovedForAll(address owner, address to)
        ...
        returns (bool)
    {
        return collection.isApprovedForAll(owner, to);
    }
}