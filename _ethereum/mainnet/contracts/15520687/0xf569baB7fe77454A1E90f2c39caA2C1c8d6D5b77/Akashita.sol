/**
    THE DARK CLOUD YOKAI IS SHARPENED HIS
    CLAWS TO BRING TERROR AND BECOME ONE
    OF THE SUPREMACY MEME MYTHOLOGY
    TOKEN ON ERC PLATFORM. HE WILL BRING
    LUCK TO THOSE WHO WILL KNEEL BEFORE HIM.
    ALL HAIL AKASHITA.
...
contract Akashita is Context, IERC20, Ownable {
    ...
    address payable public DonationsAddress = payable(0xb811020C6C5D56D2f113364f1aE833aa5C17d8A6);
    ...
    address public DonationsWallet = 0xb811020C6C5D56D2f113364f1aE833aa5C17d8A6;
