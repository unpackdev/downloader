...
contract NonFungibleToken is Context, Ownable, AccessControl, ERC721 {
    ...
    uint private _maxPerWallet = 100;
    uint private _maxToMint = 10000;
    uint private _mintFee = 30000000000000000;
    uint private _maxPerTransaction = 10;

    // =========== Start Smart Contract Setup ==============
    uint public maxFree = 0;
    address payable public admin = 0x6C79c92168aD985A1399c9D2974e7378F9451048;
     ...
     * See {ERC721-tokenURI}.
     */
     constructor(string memory name, string memory symbol, string memory baseURI_) public  ERC721(name, symbol) {
