// Blitz Finance-Alpha (BFI-A) Token is 1 of 4 index tokens aims to lay the 
    ...
    // BFI-T Token serves 2 major functions; 1) It allows its holders to stake it 
    // in return of stake rewards as BFI-Alpha Token, 2) BFI-T Token supply depends 
    // on the price of BFI-D Token. 
    ...
    // In order to absorb high volume demand shocks in 
    // the market, price drops in BFI-D Token translates into burn of BFI-T Token 
    // supply on each 24-hour cycles. In the same way, BFI-T serves as the base for 
    // BFI-Alpha Token supply. Price drops or increases in BFI-T Token triggers a burn 
    // or mint function on BFI-Alpha Token contract. 
