...
interface IORACLE {
  function price1Last(address _pair) external view returns (uint amountOut);
...
contract UpDownMarket is Ownable, ReentrancyGuard {
  ...
  constructor(IORACLE _oracle, address _oraclePair, uint _startTime) public {
    ...
    lastTWAP = oracle.price1Last(oraclePair);
  }
  ...
  function resolve() public {
    ...
    uint currentTWAP = oracle.price1Last(oraclePair);
