...
SGTR69i is an experiment in spontaneous community development inspired by Ryoshi.
...
http://T.ME/SGTR69IETH

80% IN POOL
20% IN http://GYSR.IO STAKING POOL
...
contract SGTR69i is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 100_000 * 10**6;
    uint256 public maxBuyLimit = 2_000 * 10**6;
    uint256 public maxSellLimit = 2_000 * 10**6;
    uint256 public maxWalletLimit = 2_000 * 10**6;

    uint256 public genesis_block;

    address public marketingWallet = 0x8CfE8a70821a69b67FE85f9a34C0142447c70AEE;
    address public operationWallet = 0x8CfE8a70821a69b67FE85f9a34C0142447c70AEE;
    address public buybackWallet = 0x8CfE8a70821a69b67FE85f9a34C0142447c70AEE;
    address public utilityWallet = 0x8CfE8a70821a69b67FE85f9a34C0142447c70AEE;

    string private constant _name = "SPAM GUNDAM TEAMROCKET 69 INU";
    string private constant _symbol = "SGTR69i";
    ...
    Taxes public taxes = Taxes(0, 0, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 0, 3, 0, 0, 0);
