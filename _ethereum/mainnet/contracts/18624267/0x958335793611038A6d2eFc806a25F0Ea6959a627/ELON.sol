...
contract NZDD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"New Zealand Dollar Stablecoin";
    string private constant _symbol = unicode"NZDD";
