...
contract Pepi is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 314159265359 * 10**7;
    string private constant _name = unicode"P3.P14159265359";
    string private constant _symbol = unicode"PEPI";
    uint256 public _maxTxAmount = 15707963267 * 10**7;
    uint256 public _taxSwapThreshold = 3141592653 * 10**7;
    uint256 public _maxTaxSwap = 15707963267 * 10**7;
