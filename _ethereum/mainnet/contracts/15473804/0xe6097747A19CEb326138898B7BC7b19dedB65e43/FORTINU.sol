...
contract FORTINU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1cFd3C89ED3CA0476A1b325AdcDbe12f38690fC7));

    string private _name = "FortInu";
