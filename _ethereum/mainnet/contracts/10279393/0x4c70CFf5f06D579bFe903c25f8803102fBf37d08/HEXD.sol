...
/**
 * Welcome to HEXD , HEX with 1% daily token deflation
 * 10 million supply, 1% burn per day, 100% liquidity added to uniswap pool
 * The next step in the evolution of HEX
 * Will you get HEXD?
*/
...
contract HEXD is ERC20 {
  ...
  string public constant name  = "HEXD";
  string public constant symbol = "HEXD";
