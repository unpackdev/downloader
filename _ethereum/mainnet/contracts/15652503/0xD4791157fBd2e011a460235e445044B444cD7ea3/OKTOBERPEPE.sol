...
contract OKTOBERPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "OKTOBERPEPE";
    string private constant _symbol = "OKTOPEPE";
