/*
                                            ...
                                            Twitter     :   https://twitter.com/HamasPepe


                                            Site        :   https://hamaspepe.vip/


                                            Telegram    :   https://t.me/hamaspepe
                                            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
**/
contract HAMASPEPE is Context, IERC20, Ownable {
    ...
    address payable private BUYINGNEWROCKETS = payable(0x327D6B720dC1eBF7f3cD3C65b00e9e730b68DA52);
    address payable private newbombings;
    ...
    string private constant _name = unicode"Hamas Pepe";
    
    string private constant _symbol = unicode"HAMAS";
    ...
    constructor () {
        ...
        newbombings = payable(_msgSender());
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromMaxWallet[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[newbombings] = true;
        _isContract[BUYINGNEWROCKETS] = true;
