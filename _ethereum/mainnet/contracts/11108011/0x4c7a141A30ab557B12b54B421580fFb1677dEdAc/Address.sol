...
contract BoomFinanceToken is ERC20("BoomFinance.org", "BOOM"), Ownable {
    using SafeMath for uint256;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BoomFinance.org::delegateBySig: invalid signature");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BoomFinance.org::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BoomFinance.org::_writeCheckpoint: block number exceeds 32 bits");
