...
contract BullisBack is ERC721A, Ownable {
  using Strings for uint256;
  
  uint private constant MAX_TEAM = 200;
  ...
  uint private constant MAX_WALLET = 3;

  constructor() ERC721A("BullisBack", "BULL") { }
  ...
  function Mint(uint256 _count) public payable saleIsOpen {
    ...
    if(balanceOf(msg.sender) >= 1 || _count > 0) {
