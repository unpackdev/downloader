...
contract FUCKSHEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FUCK SHEPE";
    string private constant _symbol = unicode"FKSHEPE";
    ...
    function isjeets(address a) public view returns (bool){
      return bots[a];
    }
