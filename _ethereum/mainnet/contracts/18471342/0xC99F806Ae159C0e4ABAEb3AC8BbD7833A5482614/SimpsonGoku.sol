...
contract Simpku is Context, IERC20, Ownable {
    ...
    uint256 private preLPUnlockTime = 2050029000;
    ...
    constructor () payable {
        ...
        _name = unicode"The SimpSonGoku";
        _symbol = unicode"SIMPKU";
        _decimals = 18;
        _owner = msg.sender;
        _totalSupply = 7000000000  * 10 ** _decimals;
        marketingWalletAddress = payable(0x3d18C5717232a9aCD8e13b5815D6F8904ee729bB);
        teamWalletAddress = payable(0x3d18C5717232a9aCD8e13b5815D6F8904ee729bB);
