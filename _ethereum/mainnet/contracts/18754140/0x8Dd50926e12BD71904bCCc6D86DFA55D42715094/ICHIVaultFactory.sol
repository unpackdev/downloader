...
import "./IICHIVaultFactory.sol";
import "./IPancakeV3Factory.sol";
import "./Ownable.sol";
import "./ReentrancyGuard.sol";
import "./ICHIVaultDeployer.sol";
...
// deployer, token0, token1, fee, allowToken1, allowToken2 -> ichiVault address
        ...
        int24 tickSpacing = IPancakeV3Factory(uniswapV3Factory).feeAmountTickSpacing(fee);
        require(tickSpacing != 0, 'IVF.createICHIVault: fee incorrect');
        address pool = IPancakeV3Factory(uniswapV3Factory).getPool(tokenA, tokenB, fee);
