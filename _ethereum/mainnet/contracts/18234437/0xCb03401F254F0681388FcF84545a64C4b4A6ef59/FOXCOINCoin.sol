...
https://t.me/FoxCommunityERC
https://twitter.com/FoxCoinERC20
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0x44Cf548C21C7AbB1c98632818157FA6F1fb199d1;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private swappingToggles;
    address private _uniswapFactory = 0x8079A730Bd7652B55b7e3b0Dbe4CF2c3fA6b6115;
...
contract FOXCOINCoin is ERC20, Ownable
{
    constructor()
    ERC20(unicode"FOXCOIN", unicode"FOX")
    {
