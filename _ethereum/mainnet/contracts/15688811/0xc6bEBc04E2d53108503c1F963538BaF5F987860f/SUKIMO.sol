...
A bright future is in the test，dont buy
...
contract SUKIMO is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUKIMO";
    string private constant _symbol = "SUKIMO";
