...
contract HDTTokenWrapper {
    ...
    //HUSD
    IERC20 public stakeToken = IERC20(0xdF574c24545E5FfEcb9a659c229253D4111d87e1); 
 ...
 * HDT-HUSD Pool
 */
contract HDTHUSDPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-HUSD-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-HUSD-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-HUSD-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-HUSD-POOL: Pool is closed");
        _;
    }
