/**
Telegram - https://t.me/captaincuck
Twitter- https://twitter.com/captaincucketh
Website - https://captaincuck.com/home
*/
...
contract CaptainCuck is ERC20, Ownable {
    ...
    constructor() ERC20("Captain Cuck", "SEAGEN") {
        ...
        maxTransactionAmount = 140_000 * 1e18; // 2% max txn at launch
        maxWallet = 140_000 * 1e18; // 2% max wallet at launch
        ...
        mwallet = address(0xB943b1551052D57484B9629F747DA5746BacAc5B); 
        devWallet = address(0xb81F0abd4837c2c01F5CDb9C4a475848C89CF80B); 
        liqWallet = address(0x8Bc54C15dBfEaDf7012F4d6A90f57aa7f3B2d2c4); 
        burnWallet = address(0x07db378891820C6Cb535DBB262E5bD9c648b7189);
