...
contract FairPlay is Context, IERC20, Ownable {
    ...
    string private constant _name = "FairPlay";
    ...
    address payable private _teamAddress = payable(0x78F0BAbD4Fd751A53a150B874e2557ab10a9924A); 
    address payable private _marketingAddress = payable(0x78F0BAbD4Fd751A53a150B874e2557ab10a9924A);
