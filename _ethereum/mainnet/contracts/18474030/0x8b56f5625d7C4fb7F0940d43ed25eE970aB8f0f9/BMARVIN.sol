...
contract BMARVIN is ERC20 {
    ...
    constructor(address router) ERC20("BabyMarvin", "BMARVIN", TOTAL_SUPPLY) {
    ...
    function removeLimitkts() external onlyOwner {
        hasLimit = true;
    }
}