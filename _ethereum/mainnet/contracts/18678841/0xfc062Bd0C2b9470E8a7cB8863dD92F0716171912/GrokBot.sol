...
Elevate Your Engagement: GrokBot — Where Creativity Meets Intelligence on X! 

Telegram: https://t.me/GrokBotERC
X: https://twitter.com/grokBot_ERC
Website: https://grok-bot.xyz/
...
contract GrokBot is ERC20, Ownable {
    ...
    constructor() ERC20("Grok Bot", "GROKB") {
        ...
        maxTransactionAmount = 2000000 * 1e18; // 2% max txn
        ...
        marketingWallet = address(0xdF21c65Ba873dc7314f4ef601e1769c533d86B3d);
        operationsWallet = address(0x0B2B0Ff755BAaE7273EF5DDC04A83C91cEc6E0C2);
