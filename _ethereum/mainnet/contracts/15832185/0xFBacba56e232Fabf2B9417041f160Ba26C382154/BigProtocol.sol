...
contract BigProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Big Protocol";
    ...
    constructor () {
        _feeAddrWallet = payable(0x808AF0158ec476fFEC6eceac17b148DaCA8EE961);
