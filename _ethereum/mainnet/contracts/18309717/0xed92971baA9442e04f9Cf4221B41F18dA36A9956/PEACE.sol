/**
Socials
Telegram: https://t.me/+kg8aylbQO2kzZTIx
Description:PEACE IN THE MIDDLE EAST
*/
...
contract PEACE is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"سلام שלום", unicode"שלום") {
        ...
        marketingWallet = address(0x7efbF46DB07b6f2e6B4964a5dEf1F4BfE7b76f6f); // set as marketing wallet
        devWallet = address(0x7efbF46DB07b6f2e6B4964a5dEf1F4BfE7b76f6f); // set as dev wallet
