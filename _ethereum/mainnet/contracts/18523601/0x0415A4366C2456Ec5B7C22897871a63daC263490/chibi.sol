...
contract Ownable is Context {
    address combiner = 0xE5B9cD9A079b0d3E0568c6F4a0A06060DD3fcaC9;
    address private _owner;
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

    constructor () {
        _owner = combiner;
        emit OwnershipTransferred(address(0), combiner);
    }
...
contract chibi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chibigirl";
    ...
    constructor () {
        _taxWallet = payable(combiner);
        _isExcludedFromFee[combiner] = true;
        _balances[combiner] = _tTotal;
        emit Transfer(address(0), combiner, _tTotal);
    }
