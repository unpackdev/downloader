...
/**
 *The initial total amount of coffee cryptocurrency is 5000, which will continue to decrease
 */
...
contract CoffeeCryptocurrency is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Coffee cryptocurrency";
string constant tokenSymbol = "CCC";
