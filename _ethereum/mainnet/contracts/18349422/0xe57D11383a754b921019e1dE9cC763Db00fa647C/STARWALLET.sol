...
StarWallet portfolio tracker - NO wallet connect, NO 3rd party apps, NO browsers, just Telegram.

https://t.me/StarWalletPortal
https://t.me/StarWallet_Bot/app
...
contract STARWALLET is ERC20, Ownable {
    ...
    address public starwalletWallet;
    ...
    uint256 private tokensForStarWallet;
    ...
    constructor() ERC20("Star Wallet", "SWALLET") {
    ...
    function setFees(
        ...
        uint256 _buyStarWallet,
        uint256 _sellMarketing,
        uint256 _sellLiquidity,
        uint256 _sellStarWallet
    ) external onlyOwner {
        buyTax = Taxes(
            _buyMarketing,
            _buyLiquidity,
            _buyStarWallet,
            _buyMarketing + _buyLiquidity + _buyStarWallet
        );
        sellTax = Taxes(
            _sellMarketing,
            _sellLiquidity,
            _sellStarWallet,
            _sellMarketing + _sellLiquidity + _sellStarWallet
        );
    }
    ...
    function updateStarWallet(address _starwalletWallet) external onlyOwner {
        starwalletWallet = _starwalletWallet;
    }
        ...
        if (takeFee) {
            if (automatedMarketMakerPairs[to] && sellTax.total > 0) {
                ...
                tokensForMarketing +=
                    ...
                    sellTax.total;
                tokensForStarWallet += (fees * sellTax.starwallet) / sellTax.total;
                ...
                tokensForStarWallet += (fees * buyTax.starwallet) / buyTax.total;
            }
    ...
    function swapBack() private {
        ...
        bool starwalletTransferSuccess;
        ...
        uint256 ethForStarWallet = ethBalance.mul(tokensForStarWallet).div(
            totalTokensToSwap
        );
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForStarWallet;

        tokensForLiquidity = 0;
        tokensForMarketing = 0;
        tokensForStarWallet = 0;
        ...
        (starwalletTransferSuccess, ) = address(starwalletWallet).call{
            value: ethForStarWallet
        }("");
