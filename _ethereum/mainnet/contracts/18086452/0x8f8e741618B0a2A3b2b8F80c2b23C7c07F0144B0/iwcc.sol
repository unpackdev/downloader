...
contract IWCC is ERC20, Ownable {
    ...
    constructor() payable ERC20("India World Crypto Coin", "IWCC") {
        newOwner = msg.sender;
        address _dexRouter;
        ...
        communityAddress = address(0xB495C8bEcc1653A2267D3Df92aB1aFD20E8C0B27);
