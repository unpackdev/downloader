...
contract Otter is ERC20, Ownable {
    ...
    OtterDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Otter Protocol", "OTTER") {
        dividendTracker = new OtterDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        OtterDividendTracker newDividendTracker = OtterDividendTracker(
            payable(newAddress)
        );
...
contract OtterDividendTracker is Ownable, DividendPayingToken {
    struct AccountInfo {
        address account;
    ...
    constructor()
        DividendPayingToken("OtterDividentTracker", "OtterDividendTracker")
    {}
    ...
    function _transfer(
        ...
        require(false, "OtterDividendTracker: No transfers allowed");
    }
