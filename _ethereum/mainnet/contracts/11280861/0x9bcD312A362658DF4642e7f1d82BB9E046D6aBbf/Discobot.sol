...
contract Discobot is StandardToken {

  string public constant name = "Discobot";
  string public constant symbol = "Discobot";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 95000 * (10 ** uint256(decimals));
