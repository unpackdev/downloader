    ...
    PausableUpgradeable
{
    ...
    address private _auctionManager; // Auction manager contract address
    ...
    function setAuctionManager(address auctionManager_) external onlyOwner {
        ...
        address prev = _auctionManager;
        _auctionManager = auctionManager_;

        emit AuctionManagerChanged(prev, auctionManager_);
    }
    ...
    function mint(
        address to_,
        uint256 tokenId_
    ) external nonReentrant onlyAuctionManager whenNotPaused {
