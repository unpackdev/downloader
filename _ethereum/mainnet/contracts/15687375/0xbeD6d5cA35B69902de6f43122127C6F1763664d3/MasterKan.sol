...
contract MasterKan is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 3800;

    string private _baseTokenURI;

    constructor(string memory uri) ERC721A("MasterKan", "KAN") {
        _baseTokenURI = uri;
    }
    ...
    // Mint tokens purchased from owner
    function redeemMint(address _to, uint256 _quantity) external onlyOwner {
        require(
