...
// ----------------------------------------------------------------------------
// 'Autonomous.place' token contract
//
// Symbol      : AUT
// Name        : Autonomous.place
// Total supply: 82000
// Decimals    : 18
// ----------------------------------------------------------------------------
...
contract AUT is BurnableToken {
    ...
    string public constant name = "Autonomous.place";
    string public constant symbol = "AUT";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 82000 * (10 ** uint256(decimals));
