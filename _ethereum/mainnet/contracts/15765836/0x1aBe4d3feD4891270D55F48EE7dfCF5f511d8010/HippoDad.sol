...
contract HippoDad is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://Qmdn8ctsH2UziASgov8EbAv9UhxdG3q1CbQRz4iD1VMJvz/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("HippoDad", "HD", MAX_MINTS, MAX_SUPPLY) {  
