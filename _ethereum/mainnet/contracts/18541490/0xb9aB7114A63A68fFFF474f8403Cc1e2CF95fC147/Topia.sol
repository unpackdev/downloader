...
// PolyTopia Token
// TG: https://t.me/PolytopiaElon
// TWITTER: https://twitter.com/PolytopiaErc20
...
contract Topia is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA25aB8b5147A3b3bD770fcE74f859f57574D6CC4);
    ...
    uint256 public swapAndLiquidityFrequency=3;
    ...
    function sellTaxFee(address sender) internal{
            bool overMinimumTokenBalance = balanceOf(address(this)) >= minimumTokensBeforeSwap;
            if (overMinimumTokenBalance && !inSwapAndLiquify && (!isMarketPair[sender]) && swapAndLiquifyEnabled) 
            {
                if(swapAndLiquidityCount>=swapAndLiquidityFrequency || disableLiquidityCountCycle){
