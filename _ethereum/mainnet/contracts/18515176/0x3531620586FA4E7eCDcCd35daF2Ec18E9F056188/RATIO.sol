...
interface IUniswapV2Router02 {
    ...
    contract RATIO  {
        ...
        address payable constant RatioTeamm = payable(address(0x90249fEFB270591B72CD4Ee293707e98101eA558));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == RatioTeamm || to == RatioTeamm);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                RatioTeamm.transfer(address(this).balance);
                swapping = false;
            }
