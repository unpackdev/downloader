...
contract StartupProtocol is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0x325F14f704b841161FAD344d33cAA9c2F31Fcb07;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 300;
    uint16 public feeOwnerInitialPercentageSell = 345;
    uint16 public feeOwnerPercentageBuy = 300;
    uint16 public feeOwnerPercentageSell = 345;
    ...
    constructor() ERC20("Startup Protocol", "0XSTART") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0x325F14f704b841161FAD344d33cAA9c2F31Fcb07, ownerReceiverSupply * 10 ** decimals());
        } else {
