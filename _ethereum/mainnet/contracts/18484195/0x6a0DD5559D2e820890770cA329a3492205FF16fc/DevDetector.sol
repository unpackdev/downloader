...
contract DevDetector is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x7B0B433cc4d21B5d776bcE4455cAC7E68D10E35A; 
    ...
    function openTrading() external onlyOwner{
        ...
        router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)) - (90_000 * 10**_decimals),0,0,owner(),block.timestamp);
