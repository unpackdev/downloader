...
contract Trader{
    ...
    ERC20 constant internal DAI_TOKEN_ADDRESS = ERC20(0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359);
    ...
    function getKyberSellPrice()  constant returns (uint256){
        (uint256 currentPrice,) =  proxy.getExpectedRate(ETH_TOKEN_ADDRESS, DAI_TOKEN_ADDRESS, 1000000000000000000);
        return currentPrice;
    }
    function getKyberBuyPrice()  constant returns (uint256){
        (uint256 currentPrice,) =  proxy.getExpectedRate(DAI_TOKEN_ADDRESS, ETH_TOKEN_ADDRESS, 1000000000000000000);
        return currentPrice;
    }
