...
contract FRUSTRATED is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public maxPerTx = 8;
    uint256 public maxSupply = 1750;
    uint256 public freeMintMax = 750; 
    uint256 public price = 0.002 ether;
    uint256 public maxFreePerWallet = 2; 

    string private baseURI = "ipfs://QmNUJjAr4fCNhKocT7CUiaNBXS9uiTBqdpcaxRnJczVv5y/";
    string public notRevealedUri = "ipfs://QmNUJjAr4fCNhKocT7CUiaNBXS9uiTBqdpcaxRnJczVv5y/";
    ...
    constructor() ERC721A("FRUSTRATED", "FRUSTRATED") {}
