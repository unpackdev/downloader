...
contract DEGENERATEorREGENERATE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYdxBUR9k4e27tK6JPx53xaha2kLF7WudeYxjbkto7Hrk";
    ...
    constructor(
    ) ERC721A("DEGENERATE or REGENERATE", "DR", 100, maxSupply) {
    }
