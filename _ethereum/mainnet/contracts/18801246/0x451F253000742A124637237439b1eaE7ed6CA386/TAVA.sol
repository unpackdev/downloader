// https://x.com/elonmusk/status/1736133485729873924?s=20
...
contract TAVA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tesla Autopilot Vision AI ";
    string private constant _symbol = unicode"TAVA";
