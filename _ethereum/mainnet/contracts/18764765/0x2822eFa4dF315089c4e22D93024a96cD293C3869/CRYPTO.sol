...
contract CRYPTO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Anonimity Enhanced Cryptocurrency";
    ...
    address payable private _marketingAddress = payable(0xbCF56eED6402f0Aa4DE04B46504e9ca6Fae3dD62);
    address payable private _developmentAddress = payable(0xbCF56eED6402f0Aa4DE04B46504e9ca6Fae3dD62);
