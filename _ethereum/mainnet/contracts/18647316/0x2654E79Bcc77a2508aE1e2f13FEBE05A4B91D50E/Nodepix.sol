...
contract Nodepix is IERC721A { 
    ...
    string private constant _name = "Nodepix";
    string private constant _symbol = "NODEPIX";
    string private _baseURI = "NODEPIXNODEPIXNODEPIXNODEPIXNODEPIXNODEPIXNODEPIX";
