...
contract CatsVSDogs is ERC20, Ownable {
    ...
    constructor () ERC20("Cats VS Dogs", "CatsVSDogs") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        transferOwnership(0x00f6f261000C279192C68A9e23B0a0f7d5c9Fdf7);
        ...
        marketingWallet = 0x00f6f261000C279192C68A9e23B0a0f7d5c9Fdf7;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy <= 15, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_totalFeesOnSell <= 15, "Total Fees cannot exceed the maximum");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 15, "Wallet to Wallet Transfer Fee cannot exceed the maximum");
