...
X :  https://twitter.com/DegenopolyERC
...
contract Degenopoly is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 private immutable maxSupply = 1_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"Degenopoly";
    string private constant SYMBOL = unicode"DPOLY";
