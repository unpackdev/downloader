...
pragma solidity ^0.8.20;
    ...
    contract PonziLords {
        ...
        address payable constant deployer = payable(address(0x7A2a2BB4d62eb657F68FA9A2F0EC79FB28EC8898)); //
        ...
        function setPZLD(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
