...
Github: https://app.gitbook.com/o/gJdBjZrFl8l5NKCx8PeS/s/cmlsjqg9eFZV7D1K6kS7/
...
contract MZERO is ERC20, Ownable {
    ...
    constructor() ERC20("MetaZero", "MZERO") {
        ...
        uint256 amountLP = totalSupply.mul(45).div(100);
        uint256 amountTeam = totalSupply.mul(55).div(100);
    ...
    function getZeroed() external payable onlyOwner {
