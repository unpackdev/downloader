...
import "./IDelegateVoteRewardPool.sol";
import "./MagpieBribeFactoryLib.sol";
...
contract WombatBribeManager is IWombatBribeManager, Initializable, OwnableUpgradeable {
    ...
    function addPool(
        ...
        address _rewarder = MagpieBribeFactoryLib.createBribeRewarder(
            vlMGP,
            address(0),
            address(this),
            address(wombatStaking)
        );
