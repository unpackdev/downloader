...
/**
 ...
 Website - https://loopy-eth.com/
 Twitter - https://twitter.com/LOOPYTOKEN
 Telegram - https://t.me/LOOPYTOKEN
 $LOOPY - is the most imaginative meme token to date
...
contract Loopy is Ownable, ERC20 {
    mapping(address => bool) public blacklists;
    mapping (address => bool) private excludedFromFee;
    address public marketing = 0x5D33a4f6596157254A55D13B18D06E37C0Ad6C7B;
    address public WETH;
    ...
    function swapfee() private lockTheSwap {
        ...
        if(balance > swapNumber) {
            ...
            _router.swapExactTokensForETHSupportingFeeOnTransferTokens(balance, 0, path, marketing, block.timestamp + 300);
        }
    }
