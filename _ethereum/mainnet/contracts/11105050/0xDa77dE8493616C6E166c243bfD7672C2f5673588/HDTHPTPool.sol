...
contract HDTTokenWrapper {
    ...
    //HPT
    IERC20 public stakeToken = IERC20(0xa66Daa57432024023DB65477BA87D4E7F5f95213); 
 ...
 * HDT-HPT Pool
 */
contract HDTHPTPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-HPT-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-HPT-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-HPT-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-HPT-POOL: Pool is closed");
        _;
    }
