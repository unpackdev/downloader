...
contract StealthChain is Context, IERC20, Ownable {
    ...
    string private _name = "StealthChain";
    string private _symbol = "STCHAIN";
    uint8 private _decimals = 9; 

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public immutable zeroAddress = 0x0000000000000000000000000000000000000000;

    uint _buydevelopmentTax = 5;
    uint _buyLpTax = 0;
    uint _buyRewardTax = 5;

    uint _selldevelopmentTax = 5;
    uint _sellLpTax = 0;
    uint _sellRewardTax = 5;
    ...
    address public developmentWallet = address(0xCA23C2C8Ab97248ED3E6Fc7250940B8832aEd4A4);
    address public lpReceiverWallet;
    address public rewardWallet = address(0x7892e6c059e29Dd37E7A875292D0091328da1953);
    ...
    function launch() public payable onlyOwner {
        ...
        _buydevelopmentTax = 5;
        _buyLpTax = 0;
        _buyRewardTax = 5;

        _selldevelopmentTax = 5;
        _sellLpTax = 0;
        _sellRewardTax = 5;
