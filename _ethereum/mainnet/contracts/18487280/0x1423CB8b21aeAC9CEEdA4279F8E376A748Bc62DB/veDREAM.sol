...
contract veDREAM is Ownable, ReentrancyGuard {
    ...
    string public constant name = "veDREAM";
    string public constant symbol = "veDREAM";
    ...
    /// @param token_addr `ERC20DREAMWETHLP` token address
