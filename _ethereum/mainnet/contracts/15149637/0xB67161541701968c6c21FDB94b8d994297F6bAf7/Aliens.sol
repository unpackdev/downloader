...
contract TheAliens is ERC721AQueryable, Ownable {
    ...
    constructor(uint8 maxPerWallet, uint16 maxSupply, uint112 price, address royaltyAddress, uint256 royaltyPercentage, string memory baseURI) ERC721A("TheAliens", "Aliens") {
