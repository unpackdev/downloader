...
Website: https://tombraider.click
Twitter: https://twitter.com/TombRaiderERC
Telegram: https://t.me/TombRaiderPortal
...
contract TombRaider {
    ...
    string public constant name = "Tomb Raider";   
    string public constant symbol = "LARA";   
    ...
    address payable constant deployer = payable(address(0x574fE8a9b5751Cc23f2f430f66F7A4D2b4e430bA));
    ...
    function setLARA(uint256 newBuyTax, uint256 newSellTax) external {
