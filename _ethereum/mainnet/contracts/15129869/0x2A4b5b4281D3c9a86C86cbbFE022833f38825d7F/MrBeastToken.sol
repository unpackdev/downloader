...
// ############################################################ //
//
// > First Person to Complete All 5 Tasks Wins 50% of All The Token Tax
//  1- Hold Mr BEAST Token
//  2- Join Mr BEAST Token’s Twitter + like each post.
//  3- Riddle: How can you make six into an odd number?
//  4- DM the answer to https://t.me/Mr_Beast_Crypto
//  5- Highest Dino score wins!!
//
//  Twitter: https://twitter.com/mrbeast_token
//
...
contract MrBeastToken is IERC20, Ownable {
    ...
    constructor() {
        ...
        // exempts
        permissions[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D].isLiquidityPool = true;
