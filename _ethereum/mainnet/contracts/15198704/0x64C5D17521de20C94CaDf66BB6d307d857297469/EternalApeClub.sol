...
contract ArmyApeClub is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmZNoKry8rKbQBoAXGdwJmb1zyErmWiedzMJfsWi19vYNg/";
    string public baseExtension = ".json";
     bool public paused = false;   
    
    constructor() ERC721A("Army Ape Club", "EAC", MAX_MINTS, MAX_SUPPLY) {  
    }
