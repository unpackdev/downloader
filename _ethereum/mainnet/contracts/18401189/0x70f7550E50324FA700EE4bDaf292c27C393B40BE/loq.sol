// https://x.com/VitalikButerin/status/736845668694663168?s=20
...
contract loq is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
  
    string private constant _name = unicode"laughing out quiet";
    string private constant _symbol = unicode"loq";
    ...
    address payable private _developmentAddress = payable(0x2250EAf2927eaD1733518b2a43C3B6e2f00bddfF); 
    address payable private _marketingAddress = payable(0x2250EAf2927eaD1733518b2a43C3B6e2f00bddfF);
