...
// File contracts/GameProducersPrize.sol

pragma solidity ^0.8.4;

contract GameProducersPrize is
    ERC721,
    ERC721URIStorage,
    ERC721Enumerable,
    ERC721Burnable,
    Ownable
{
    ...
    /**
     * @notice Deadline for prize, after this time, you cannot submit form.
     */
    ...
    constructor() ERC721('MIKURU ASAKURA - "GAME PRODUCERS" PRIZE', "MA-GPP") {}
    ...
    function safeMint(
        ...
        tokenDeadlines[tokenId] = deadline;
        _safeMint(to, tokenId);
    ...
    function submitForm(
        ...
        require(
            block.timestamp < tokenDeadlines[tokenId],
            "MA-GPP: The Current Time Is Greater Than The Deadline"
        );
    ...
    /**
     * @notice Update tokenDeadlines
     */
    function updateTokenDeadline(uint256 tokenId, uint256 deadline)
        external
        onlyOwner
    {
        tokenDeadlines[tokenId] = deadline;
