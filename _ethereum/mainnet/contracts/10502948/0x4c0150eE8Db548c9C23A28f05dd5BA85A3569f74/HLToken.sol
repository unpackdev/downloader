 ...
 * @dev HL锁仓解锁合约 Author: Hledger_Zoe@outlook.com, Date:2020/07
...
contract HLToken {
    ...
    string public constant name = "Heterogeneous ledger"; //  token name
    string public constant symbol = "HL"; //  token symbol
  ...
  */
    ...
    address public addr_pool = 0x4DfF08b30635dbcC51c680C00AB8198D76Ad5b36; //矿池挖矿
    address public addr_private = 0xA4F7c762a2C6967500cEded9B09a1c60CA6350f6; //私募
    address public addr_fund = 0x36aEf70cecC3d2e4e30390C74Da5Bde0A5cd560e; //基金会
    address public addr_promotion = 0x70880B8622CE0fBED0c39EcA838733c0Ae9835b0; //推广运营
    address public addr_team = 0x94C153a601e585d41dd54Af19Ab05d9A5bdD1458; //原始团队
