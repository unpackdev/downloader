...
Deep within the arcane recesses of the blockchain, an unsettling secret takes shape - 
20,000 unique mutants, their appearances veiled in enigma, awaiting the shroud of revelation. 
A cryptic order of mutants holds the key.
...
contract MutantCloaks  is ERC721A, Ownable, ReentrancyGuard {
	using Strings for uint256;

	uint256 public maxSupply = 20000;
    uint256 public maxFreeSupply = 20000;
