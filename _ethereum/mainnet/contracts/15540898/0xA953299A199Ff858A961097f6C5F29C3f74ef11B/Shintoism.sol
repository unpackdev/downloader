...
contract Shintoism is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20(unicode"Daruma碧眼胡", "AWAKENING") {
        ...
        uint256 totalSupply = 170_000_000 * 1e18;

        maxTransactionAmount = 1_700_000 * 1e18;
        maxWallet = 5_100_000 * 1e18;
