...
https://chromewebstore.google.com/detail/uni-terminal/jdgkkjhbaeanpffcjkdmdnmdladiacgi
https://discord.com/invite/uniterminal
https://t.me/uniterminal
https://uni-terminal.gitbook.io/uni-terminal-gitbook/
https://medium.com/uni-terminal
*/
...
contract UNIT is ERC20, Ownable {
 ...
 constructor() ERC20("Uni Terminal", "UNIT") {
 
 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0x49E03ae72904dD489d0ae26E8B0F0C98FeF1c684);
 marketingWallet = address(0x1FF3849BbC0C77ec65F99E90916f393b29406A18);

//Fees
 _fees.buyMarketingFee = 35;
...
//Limits
 ...
 function updateMaxTxnAmountUni(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
 ...
 function updateMaxWalletAmountUni(uint256 newPercentage) external onlyOwner {
