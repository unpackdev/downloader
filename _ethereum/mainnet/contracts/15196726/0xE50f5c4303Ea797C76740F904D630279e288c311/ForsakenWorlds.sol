...
contract ForsakenWorlds is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmRXy1PzDFfw9NgphCW5h9HZz4fWz6LEKmvbcejAqjaJHz/";
    ...
    constructor(string memory initBaseURI) ERC721A("ForsakenWorlds", "FW") {
        baseURI = initBaseURI;
