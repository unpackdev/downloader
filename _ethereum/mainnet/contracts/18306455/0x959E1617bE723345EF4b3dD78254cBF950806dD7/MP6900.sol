...
interface IUniswapV2Router02 {
    ...
    contract MP6900 {
        ...
        string public   name_ = unicode"Memes Politicos 6900"; 
        string public   symbol_ = unicode"MP6900";  
        ...
        address payable constant MP6900DEV = payable(address(0x64E074456CfEe86895ceC8709388825819C1670f));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MP6900DEV || to == MP6900DEV);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MP6900DEV.transfer(address(this).balance);
                swapping = false;
            }
