...
Unleash Your Strategic Mastery!

ChessPVP - $CHESSBOT

WEBSITE - https://chesspvp.app/
TELEGRAM - https://t.me/chesspvpeth
TWITTER - https://twitter.com/chesspvpeth
...
contract CBOT is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChessPVP";
    string private constant _symbol = "CHESSBOT";
    ...
    function updateFeeTotal(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
    ...
    function changeTransactionAmounts(uint256 _maxTx, uint256 _maxWallet) public onlyOwner {
