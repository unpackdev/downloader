...
contract stopFollowingMeImCallingThePoliceInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB831da699045f9B68966A8bD2B8526836eD75073); 
    address payable public Wallet_Dev = payable(0x47565d7d7650fd81Ec5778A2A28B0A99861be835);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =1000000000 * 10**_decimals;
    string private constant _name = "stopFollowingMeImCallingThePoliceInu"; 
    string private constant _symbol = unicode"SFMICTP"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 60 / 100;
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal * 60 / 100; 
    ...
    constructor () {
        _owner = 0x47565d7d7650fd81Ec5778A2A28B0A99861be835;
