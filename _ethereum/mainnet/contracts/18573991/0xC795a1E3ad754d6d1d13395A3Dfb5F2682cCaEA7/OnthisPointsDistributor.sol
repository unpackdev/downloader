    ...
    ReentrancyGuardUpgradeable
{
    ...
    mapping(address => EnumerableSetUpgradeable.AddressSet) private creatorsSet;
    ...
    function initialize(
        ...
        decreaseDeltaVolume = 0.05 ether;
    ...
    function registerShortcut(
        ...
        uint256 length = _shortcut.creators.length;

        for (uint256 i = 0; i < length; ) {
            creatorsSet[_shortcutAddr].add(_shortcut.creators[i]);
            unchecked {
                i++;
            }
        }
