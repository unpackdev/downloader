...
Welcome to Slice: The Ultimate Play-to-Earn Experience! Inspired by the timeless thrill of Fruit Ninja, Slice brings you a groundbreaking gaming adventure. 
    
//Docs: https://docs.cryptoslice.xyz/
//Website: https://cryptoslice.xyz/
//Twitter: https://twitter.com/slicegamecoin
//TG: https://t.me/SliceGame
...
contract SLICE is ERC20("Crypto Slice", "SLICE"), ERC20Burnable, Ownable {
...
function setPair(address pairAddress) external onlyOwner {
    ...
    function updatedeadline(uint256 _deadline) external onlyOwner {
        require(!tradingEnabled, "Can't change");
