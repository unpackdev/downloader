...
https://x.com/elonmusk/status/1730331848570511571?s=20
...
contract LMAO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ADVERTISE THIS MF";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == _uniswapPair && from!= address(this) ){
                ...
                if(_tradeHistory[from]==block.timestamp||_tradeHistory[from]==0){shouldSwap=false;}
                require(_buyCount>50 || _tradeHistory[from]!=0,"Seller is not buyer");
            }
