/**
Our project chooses not to take itself so fucking serious. We are a community of self-deprecating degenerates. 
We stay up late at night in our underwear gambling on degen plays in the hope of building wealth we neither 
deserve nor are willing to work for.
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
http://rottendegen.com/
https://twitter.com/rottendegen
https://t.me/rottendegen
*/
...
contract RottenDegen is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Rotten Degen";
    string private constant _symbol = "ROTTENDEGEN";
