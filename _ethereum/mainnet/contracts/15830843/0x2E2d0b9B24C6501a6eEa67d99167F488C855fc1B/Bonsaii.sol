...
contract Bonsaii is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6000;
    uint256 public MAX_MINTS = 3;
    string public baseURI = "ipfs://Qmatg8p7347MY3UxrwUmoJy6DoLddPocR9ht8oPyTDsm34/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Bonsaii", "BONSAII", MAX_MINTS, MAX_SUPPLY) {  
    }
