...
contract Token {
    ...
    string public constant name = "ZDB chain";
    string public constant symbol = "ZDB";
    uint8 public constant decimals = 18;

    uint256 private constant INITIAL_SUPPLY = 3000000000;
    uint256 public constant totalSupply = INITIAL_SUPPLY * 10 ** uint256(decimals);

    address public constant wallet = 0xbC02850308464Ac6D16CD1F8186A48839e468B0A;
