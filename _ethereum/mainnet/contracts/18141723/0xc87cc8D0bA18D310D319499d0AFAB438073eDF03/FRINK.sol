/*
FRINK COIN $FRINK first and only crypto coin inspired by the Simpsons.

The Plot:
The Simpson family are eating at The Lentil Institution, a vegan restaurant, vying for Lisa to choose them for her "Most interesting person I know" paper, but she chooses Professor Frink, devoted to helping the world through science. 
At Springfield University, Lisa visits and interviews him. 
After explaining the story of his life, Frink says he is developing a new cryptocurrency, Frinkcoin.

Website: http://www.frinkcoinerc.com/
Twitter: https://twitter.com/FrinkCoinERC
Telegram: https://t.me/FrinkCoinOfficialETH
...
contract FRINK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FRINK COIN";
