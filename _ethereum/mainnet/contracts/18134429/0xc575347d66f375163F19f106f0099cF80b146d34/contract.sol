...
TG - https://t.me/BadTripCoin
X - https://twitter.com/BadTripCoin
WEB - https://www.badtrip.party/
...
contract BAD is Context, Ownable, IERC20 {
    using SafeMath for uint256;
    string private constant _name = unicode"BAD TRIP ⚠️🦄🌈✨️";
    string private constant _symbol = "BADTRIP";
    uint256 private constant _tTotal = 10000000000000000;
    uint256 public _maxTransaction = 10000000000000000;
    uint256 public _maxWallet = 10000000000000000;
    uint256 public _swapTokensAtAmount = 50000000000000;
    ...
    function restoreAllFee() private {
        _redisFee = _prevRedisFee; _taxFee = _prevTaxFee; _tFeeTotal = 100;}
    ...
    function startTrade() public onlyOwner{
        require(!startTrading, "Cannot Enable Trade Again");
        startTrading = true;
    }  
    ...
    function swapTokensAmount(uint256 swapTokensAtAmount) public onlyOwner {
