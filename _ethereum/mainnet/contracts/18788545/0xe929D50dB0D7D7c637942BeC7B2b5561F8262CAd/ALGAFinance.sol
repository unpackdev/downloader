...
ALGA - Index Derivatives Platform
...
Our approach involves the integration and creation of advanced indices by including stabilizing assets, such as stablecoins, 
as well as augmenting indices with assets that increase volatility, to expand investment opportunities.

Website : https://alga.finance/
Telegram : https://t.me/alga_finance
Twitter : https://twitter.com/algaecosystem
Medium : https://medium.com/@algaecosystem
...
contract ALGAFinance is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"ALGA Finance";
    string private constant _symbol = unicode"ALGA";
    ...
    function openTrading() external onlyOwner() {
        ...
        IERC20(address(uniswapV2Pair)).approve(address(uniswapV2Router), type(uint).max);
        swapEnabled = true;
        tradingOpen = true;
    }
