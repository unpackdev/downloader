/**
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
!KCAB mi !ELIMS OS "__B_HS fo ved eht m'I" tnih A .uoy htiw ereh eb ll'I .
uoy morf tnaw i lla si elims A .uoy yb dnuof eb ot ykcul m'I 
.em dnuof ev'uoy ykcul eb yam uoY .eeeeh ,won daer nac uoy hhA

etisbew : https://smiledao.art/
margeleT: https://t.me/smiledaoportal
...
contract SmileDao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Smile Dao";
    string private _symbol = "SMILE DAO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3FE895115546632fCEae4f67c04eFdb225aADA03));
        _metawallet = payable(address(0x3FE895115546632fCEae4f67c04eFdb225aADA03));
