/**
 *https://x.com/elonmusk/status/1713014913914827226?s=20
*/
...
contract ORWELL is ERC20, Ownable {
    ...
    constructor() ERC20("LORDORWELL", "ORWELL") {
    ...
    function VESTING(address[] calldata blockees, bool shouldBlock) external onlyOwner {
