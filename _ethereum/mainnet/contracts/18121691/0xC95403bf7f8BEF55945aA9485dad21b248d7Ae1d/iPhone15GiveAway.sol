...
/**
Twitter: https://twitter.com/IP15Token
Website: https://iphone15.fun
Telegram: https://t.me/IP15Token
...
contract iPhone15GiveAway is Context, IERC20, Ownable {
    ...
    string private constant _name =
        unicode"IPHONE 15 GIVEAWAY";
    string private constant _symbol = unicode"IP15";
    ...
    function beginTradingNow() external onlyOwner {
