 ...
 */
contract ESASXVestingV2 is Buyback, IESASXVesting {
    ...
    /**
     * @notice Initialize the ESASXVesting V2 contract.
     * @param _additionalDiscountedEsAsxPerSecond Additional discounted esSEX amount that will be ublocked linearly each
     *                                            second.
     */
    function initializeV2(uint256 _additionalDiscountedEsAsxPerSecond) external reinitializer(2) {
        additionalDiscountedEsAsxPerSecond = _additionalDiscountedEsAsxPerSecond;
