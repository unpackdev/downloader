...
// https://t.me/quantumpepeportal
// https://twitter.com/quantumpeperc

/**
 *In a digital cosmos, Pepe the quirky frog had a quantum quirk. Dubbed 'Quantum Pepe', 
 *he memeified quantum wonders on Twitter, sending waves of giggles across parallel universes. 
 *Dive into his Twitter pond to ripple through a realm where every chuckle entangles with a quantum quirk!
*/
...
contract QuantumPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "QuantumPepe";
    string private constant _symbol = "PEPQ";
    ...
    address payable private _marketingAddress = payable(0x430fFeD3105945A1Ac0B22D054520ED0E5122889);
