...
|  `---.  |  |  |  | |  |\   --.|  |      |  |  \   --. /  /.  \   |  |   
`------'  `--'  `--' `--' `----'`--'      `--'   `----''--'  '--'  `--'   
Blockchain Messaging Made Easy.
Send IDM encrypted messages to any Etherscan Contract or address through telegram. 
Communication made easy with minimal fees attached.
...
contract EtherText is ERC20, Ownable{
    ...
    address public pair;
    address public marketingWallet = 0x428626E39b88bc4CeCc329bA947ca6839925F0B8;
    address public marketingWallet2 = 0x44C5ec62acF9267949fc8CCFA877b34912D3a878; // Replace with the second marketing wallet address
    ...
    constructor(address _router) ERC20("EtherText", "ETEXT") {
