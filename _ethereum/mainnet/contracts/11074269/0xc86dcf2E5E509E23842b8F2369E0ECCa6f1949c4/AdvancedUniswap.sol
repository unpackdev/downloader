...
/**
 * @title  AdvancedUniswap
 * @dev ERC20 token implementation
 * Pausable
 */
contract  AdvancedUniswap is WhitelistedPausableToken {
  string public constant name = "Advanced Uniswap";
  string public constant symbol = "ADU";
  ...
  /**
   * @dev  AdvancedUniswap Constructor
