...
A tribute meme project for CZ sacrificing himself for the crypto bullrun.

TG - https://t.me/CZRunnersETH
TW - https://twitter.com/CZRunnersETH
WEB - https://czrunners.space
...
pragma solidity ^0.8.23;
    ...
    contract CZRunners {
        string public constant name = "CZ Runners";  //
        string public constant symbol = "CZRN";  //
        ...
        address payable constant deployer = payable(address(0xD7f637065FFb1C0C4bCd2e1de61986ba83948997)); //
        ...
        function setCZRN(uint256 newTBurn, uint256 newTConfirm) external {
