...
contract AxeCap is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE OF GRANDEUR", "POG") {
        ...
        revShareWallet = address(0xd28013B3f852E40898F6e7b2C9E1047F83BBDe4F); // set as revShare wallet
    ...
    function withdrawStuckFOMO() external onlyOwner {
