...
#ꓘOꓤꓨ ˙ǝɯǝɯ ʞoɹƃ ɐ ʇsnɾ̣ ʇnq ƃuı̣ɥʇoN

ɯɐɹƃǝןǝꓕ: https://t.me/grok_upsidedown
ɹǝʇʇı̣ʍꓕ: https://twitter.com/grok_upsidedown
...
contract UPSIDEDOWN_GROK is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _balances[_msgSender()] = _tTotal * 25 / 1000;
        emit Transfer(address(0), _msgSender(), _tTotal * 25 / 1000);

        _balances[address(this)] = _tTotal * 975 / 1000;
        emit Transfer(address(0), address(this), _tTotal * 975 / 1000);
