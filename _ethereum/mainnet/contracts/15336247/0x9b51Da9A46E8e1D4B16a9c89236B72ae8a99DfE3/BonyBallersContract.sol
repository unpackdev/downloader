...
//
//     ____                       ____        ____              
//    / __ )____  ____  __  __   / __ )____ _/ / /__  __________
//   / __  / __ \/ __ \/ / / /  / __  / __ `/ / / _ \/ ___/ ___/
//  / /_/ / /_/ / / / / /_/ /  / /_/ / /_/ / / /  __/ /  (__  ) 
// /_____/\____/_/ /_/\__, /  /_____/\__,_/_/_/\___/_/  /____/  
//                   /____/                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1660500000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x4fF54698E740A08033510c95806646B3c03EBBd3,0x1Ec68BFBe56F616097DD5Be68237e7795469E3A5];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4fF54698E740A08033510c95806646B3c03EBBd3;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigrihy3pggliapj56il2brolnywb6ieb7l4vkxkaa7fecu5aq36su/";
...
// File: contracts/BonyBallersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BonyBallersContract is RamppERC721A {
    constructor() RamppERC721A("Bony Ballers", "BB"){}
}
