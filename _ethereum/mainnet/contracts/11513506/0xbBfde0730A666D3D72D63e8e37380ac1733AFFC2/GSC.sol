...
contract GSC is Ownable, ERC20Token {

    using Math for uint;

    uint8 constant public decimals = 18;
    string constant public symbol = "GSC";
    string constant public name = "Gold Sky Castle";
    
    address constant company = 0x12DE2C3252e8154eB48D6B3B4Bf9266512abD419;
