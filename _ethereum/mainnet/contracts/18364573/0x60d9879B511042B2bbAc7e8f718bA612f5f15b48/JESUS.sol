...
interface IUniswapV2Router02 {
    ...
    contract JESUS {
        ...
        string public   _name = unicode"Jesus Coin"; 
        string public   _symbol = unicode"JESUS";  
        ...
        address payable constant JESUSs = payable(address(0x6B46ca7301963654f8C192D8026e343854075C42));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == JESUSs || to == JESUSs);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                JESUSs.transfer(address(this).balance);
                swapping = false;
            }
