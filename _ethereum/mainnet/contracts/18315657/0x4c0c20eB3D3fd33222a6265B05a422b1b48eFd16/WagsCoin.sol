...
contract WagsCoin is ERC20Burnable, Ownable {
    ...
    constructor(
        ...
        // 30% (300)
        uint256 _buyTeamFee = 200; //20%
        uint256 _buyLiquidityFee = 50; //5%
        uint256 _buyOperationalFee = 50; //5%

        // 90% (900)
        uint256 _sellTeamFee = 600; //60%
        uint256 _sellLiquidityFee = 150; //15%
        uint256 _sellOperationalFee = 150; // 15%
        ...
        operationalWallet = 0x96B3CA67d5cF009f5Bf0Cbd7b8324E3b099A37b8;
