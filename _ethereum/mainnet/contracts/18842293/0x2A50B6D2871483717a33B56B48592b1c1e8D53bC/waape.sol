/**
    ...
    Website: weareapes.xyz
    Telegram: https://t.me/waapes
...
contract WAAPE is ERC20, Ownable {
    ...
    constructor() ERC20("We Are Apes!", "WAAPE") {
        ...
        swapTokensAtAmount = 5_000_000 * 1e18; // 0.05%
        ...
        revShareWallet = address(0x66798F3b6Bb05976cca927BE3d47Ce3720A77470); // set as revShare wallet
    ...
    function withdrawStuckWAAPE() external onlyOwner {
