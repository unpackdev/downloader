...
contract GRINCHToken is IERC20 {
    string public name = "Grinch Coin";            
    ...
    uint256 public constant usdtToGrinchRate = 1000; 

    uint256 public totalUSDTReceived; 
    uint256 public totalGRINCHIssued; 
    ...
    function receiveUSDTAndSendGRINCH(uint256 usdtAmount) external {
        ...
        uint256 grinAmount = usdtAmount * usdtToGrinchRate*(10**12);

        totalUSDTReceived += usdtAmount;
        totalGRINCHIssued += grinAmount;
