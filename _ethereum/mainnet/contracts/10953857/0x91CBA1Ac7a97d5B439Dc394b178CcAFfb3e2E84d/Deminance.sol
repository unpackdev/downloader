...
contract Owned {
    ...
    constructor() public {
        owner = 0xB6D4c137b60a9FA3D8025A5a276964caB993A107;
        SPYdeployerOwner = 0xB6D4c137b60a9FA3D8025A5a276964caB993A107;
...
// ----------------------------------------------------------------------------
contract Deminance is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        tokenSupply = 100000000 * 10**uint(decimals);
		SPYdeployerSupply = 100000000 * 10**uint(decimals);
