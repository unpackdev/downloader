...
contract Penelopepe is ERC20, Ownable {
    ...
    address constant marketing = 0xa345346B938e19486dd7C6563BfeDbccA98c3C3A;
    uint immutable uniswapSupply = 485_000_000 * 10 ** decimals();
    uint immutable marketingSupply = 15_000_000 * 10 ** decimals();
     ...
     */
    constructor() ERC20("Penelopepe", "PEN") {
