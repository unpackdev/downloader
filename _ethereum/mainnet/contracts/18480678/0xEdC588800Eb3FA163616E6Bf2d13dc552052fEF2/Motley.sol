...
"The Privacy Everyone Deserves"

Trade BTC, ETH, MATIC, and 100+ other cryptocurrencies with seamless security and privacy.
Powered by $MOTLEY Token
 
         
                    Website:    https://motley.finance/  
      
                    Twitter:    https://twitter.com/MotleyCrossERC  

                    Telegram:    https://t.me/MotleyERC
...
contract Motley is ERC20, Ownable {
    ...
    constructor() ERC20("Motley", "MOTLEY") {
    ...
    function removeMotleylimits() external onlyOwner returns (bool){
    ...
    function updatemarketingandoperationsWallet(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function updateMotleyWallet(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
    ...
    function updateMotley_bots(address _address, bool status) external onlyOwner {
