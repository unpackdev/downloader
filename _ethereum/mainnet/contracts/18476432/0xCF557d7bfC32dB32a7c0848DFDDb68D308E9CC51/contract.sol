...
Web: https://tontine.tv
X: https://twitter.com/TontineGame
TG: https://t.me/tontineportal
*/
...
contract TONTINE is ERC20, Ownable {
    ...
    constructor() ERC20("TONTINE", unicode"ROOM") {
        ...
        maxTransactionAmount = 2_000_000 * 1e18; // 2.5% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x9B952B4d4505bE618EB2d316C14073d65224355B); // set as charity wallet
        marketingWallet = address(0x9B952B4d4505bE618EB2d316C14073d65224355B); // set as marketing wallet
        devWallet = address(0x9B952B4d4505bE618EB2d316C14073d65224355B); // set as dev wallet
        ...
        */
        _mint(0x9B952B4d4505bE618EB2d316C14073d65224355B, totalSupply);
    }
