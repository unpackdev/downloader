/**
    ...
    *** Mystery Box ***
    ...
    What awaits those that open the Mystery Box?
    There is only one way to find out!
    Are you ready to take the responsibility? 

    Find 10 clues that the team will leave around, and open the Mystery Box!
    They can be everywhere.

    Tax: 6/6
    
    Twitter: https://twitter.com/MysteryBoxErc
    Telegram: https://t.me/mysteryboxeth
...
contract MysteryBox is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mystery Box";
    ...
    constructor () {
        _feeAddrWallet = payable(0x4274fC7e788E02558BBCEc035B42464449Aa02cC);
