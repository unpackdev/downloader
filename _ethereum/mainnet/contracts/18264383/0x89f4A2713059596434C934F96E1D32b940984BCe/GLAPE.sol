/**
$GLAPE. Helping all the shitcoin, one shitcoin at a time !
Let’s make memecoins great again.

Web - Gladiator-pepe.com
Twitter - X.com/Gladiator_Pepe
TG - t.me/Gladiator_Pepe
...
contract GLAPE is ERC20, Ownable {
    ...
    constructor() ERC20("GLAPE", "GLAPE") {
        ...
        uint256 totalSupply = 1000_0000_000 * 1e18;

        maxTransactionAmount = 5000_00000 * 1e18; // 1%
        maxWallet = 5000_00000 * 1e18; // 1% 
        ...
        revShareWallet = address(0xAbE9a983885741fc942fa082A469A27591453AFb); // set as revShare wallet
