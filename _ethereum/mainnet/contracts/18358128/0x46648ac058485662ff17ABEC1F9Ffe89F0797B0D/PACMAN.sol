/**
PacMan is not just a game; it’s a groundbreaking GameFi (Game Finance) project poised to transform the blockchain gaming landscape on the Ethereum Chain (ERC20). 
PacMan ventures into the world of decentralized finance with a unique focus on gaming, combining the thrill of gameplay with the potential for financial rewards.

https://pacmancoin.site

mail://admin@pacmancoin.site

https://twitter.com/pacmancoinerc
...
contract PACMAN is ERC20, Ownable {
    ...
    constructor() ERC20("Pacman Coin", "PACMAN") {

        address _owner = 0xbD378fb6f4ab7c38c0129CbeB0e2c0dB6Fc90310;
        ...
        marketingWallet = address(0x78e1C46319bE33978e1D3d434cB9Cf7dA917ad52); // set as marketing wallet
