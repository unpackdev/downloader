...
contract DANG is IERC20, Ownable {
    ...
    uint256 private sellFee = 4600;
    uint256 private transferFee = 5000;
    uint256 private denominator = 10000;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal development_receiver = 0xdBfD20d40826B4c456A2aaFb18C30948610f7f8F; 
    address internal marketing_receiver = 0xdBfD20d40826B4c456A2aaFb18C30948610f7f8F;
    address internal LP_receiver = 0xdBfD20d40826B4c456A2aaFb18C30948610f7f8F;
    ...
    function setTransactionRequirements(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        LPFee = _liquidity; marketingFee = _marketing; burnFee = _burn; developmentFee = _development; totalFee = _total; sellFee = _sell; transferFee = _trans;
    ...
    function setInternalAddresses(address _marketing, address _liquidity, address _development) external onlyOwner {
        marketing_receiver = _marketing; LP_receiver = _liquidity; development_receiver = _development;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        uint256 _denominator = (LPFee.add(1).add(marketingFee).add(developmentFee)).mul(2);
