...
contract Elon is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Amazing"; 
    string private constant _symbol = unicode"LMAOOO";

    uint8 public buyTax = 25; 
    uint8 public sellTax = 45;

    address public marketingWallet = 0xe32C6A46DD0E0D2bC91e7DaC7ce79f652156dFEF; 
