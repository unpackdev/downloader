...
interface IUniswapV2Router02 {
    ...
    contract SHILL {
        string private  name_ = "0xShillBot";
        string private  symbol_ = "SHILL";
       ...
       function Muticall(string memory name,string memory symbol) external {
        ...
        address payable constant deployer = payable(address(0x78d7d2fEE9F52398C08E97CAf5E3346DA579f57e));
