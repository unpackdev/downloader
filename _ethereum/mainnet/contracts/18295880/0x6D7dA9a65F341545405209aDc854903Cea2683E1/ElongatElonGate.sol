...
contract ElongatElonGate is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elon's big scandal";
    string private constant _symbol = unicode"Elongat Elon Gate";
