...
All in one sniper - Find the next Pepe using Pepe Rifle.

WEBSITE - https://peperifle.com/
TELEGRAM - https://t.me/peperifle
TWITTER - https://twitter.com/PepeRifle
...
contract RIFLE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PepeRifle";
    string private constant _symbol = "RPEPE";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100000000  * 10**_decimals;
    uint256 public _maxWalletAmount = 2500000 * 10**_decimals;
    ...
    function changeFeesAmount(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
