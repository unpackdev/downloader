...
/**
 *The total amount of flame destruction tokens is 1200, the minimum is 120
 */
...
contract FlameDestructionToken is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Flame Destruction Token";
string constant tokenSymbol = "FLDT";
