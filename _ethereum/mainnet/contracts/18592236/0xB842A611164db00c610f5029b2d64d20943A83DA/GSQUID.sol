...
contract GSQUID is ERC20, Ownable{
    ...
    address public marketingWallet = 0x59063C11e1D2b5c182639699b6158f1db98a059d;
    ...
    constructor() ERC20("Grok Squid", "GSQUID") {
        ...
        swapThreshold = totalSupply() * 100 / 100;
        maxTxAmount = totalSupply() * 100 / 100; 
