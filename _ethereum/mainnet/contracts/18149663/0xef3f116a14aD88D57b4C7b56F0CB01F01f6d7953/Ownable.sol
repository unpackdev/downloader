...
From the creator of Smurf Cats - Nate Hallinan

https://www.natehallinan.com/projects/RWngO

https://cdnb.artstation.com/p/assets/images/images/006/730/601/large/nate-hallinan-sb-web1-1-med.jpg?1500848638
...
contract SharkBunny is Context, IERC20, Ownable {
    ...
    address payable private _SharkBunnyWallet;
    ...
    string private constant _name = unicode"SHARK BUNNY";
    ...
    constructor () {
        ...
        _SharkBunnyWallet = payable(_msgSender());
		_BunnyWallet = payable(address(0x77a3aCc0C78edc831464A27175B00eB18bED2435));
        _isExcludedFromFee[_SharkBunnyWallet] = true;
		_isExcludedFromFee[_BunnyWallet] = true;
	...
	function sendToBunnyWallets(uint256 amount) private {
        _BunnyWallet.transfer(amount);
    }

    function sentToDeployerBunnyWallet(uint256 amount) private {
        _SharkBunnyWallet.transfer(amount);
    }
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to   == uniswapV2Pair && swapEnabled && contractTokenBalance>_taxSwapThreshold && _startingBuyCount>_preventSellToEthTillBuysAre) {
                ...
                if(contractETHBalance > 0) {
					sendToBunnyWallets(address(this).balance);
                }
            }
        }
    ...
    function removeAllTheLimits() external {
        require(_msgSender()==_SharkBunnyWallet);
    ...
    function recoverETH() external {
        require(_msgSender()==_SharkBunnyWallet);
		sentToDeployerBunnyWallet(address(this).balance);
	}
    ...
    function sendContractTokenBalanceToEth() external {
        ...
        if(ethBalance>0){
          sentToDeployerBunnyWallet(ethBalance);
        }
    }
