...
contract PenguinX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 158000000000 * 10**_decimals;
    string private constant _name = unicode"PenguinX";
    string private constant _symbol = unicode"odyssey";
    uint256 public _maxTxAmount = 3160000000 * 10**_decimals;
    uint256 public _maxWalletSize = 3160000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 3160000000 * 10**_decimals;
