...
// File contracts/Grayscale.sol

pragma solidity ^0.8.0;

contract Grayscale is Ownable, ERC20 {
    bool public limited;
    ...
    uint256 public ownerTaxRate = 0; // 0% tax for the owner

    // Assuming 18 decimal places, so 100,000,000,000 tokens will be represented as 100000000000000000000000000
    constructor() ERC20("Grayscale GPT", "GGPT") {
    ...
    function setOwnerTaxRate(uint256 _newTaxRate) external onlyOwner {
        require(_newTaxRate <= 100, "Tax rate must be less than or equal to 100%");
        ownerTaxRate = _newTaxRate;
    }
    ...
    function burn(uint256 value) external {
        uint256 taxAmount = (value * ownerTaxRate) / 100;
        ...
        _burn(msg.sender, amountAfterTax);
    }
}
