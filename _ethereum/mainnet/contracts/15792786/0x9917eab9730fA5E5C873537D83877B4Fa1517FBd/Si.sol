...
contract Si is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Sĭ", unicode"死") {
        ...
        marketingWallet = address(0x937Ed84693CABcfb2E418C3385Abd13F6C997Ed3); // set as marketing wallet
        devWallet = address(0x937Ed84693CABcfb2E418C3385Abd13F6C997Ed3); // set as dev wallet
