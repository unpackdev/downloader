...
contract Kuma is Ownable {
    ...
    uint256 private constant _totalSupply = 69_420_000_000_000 * 1e18;

    uint256 public maxTransactionAmount = 694_200_000_000 * 1e18;
    uint256 public maxWallet = 694_200_000_000 * 1e18;
    uint256 public swapTokensAtAmount = (_totalSupply * 2) / 10000;

    address private revWallet = 0x022602A6769a44a6Be067F352b038583a3Da4FF2;
    address private treasuryWallet = 0x8617FD7bE5847846A0cF69a12342Ce53Cb5492A6;
    address private teamWallet = 0x553Ad690dE52D37a8ee63D113DcC61A7031a1056;
    address private constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    uint8 public buyTotalFees = 0;
    uint8 public sellTotalFees = 0;

    uint8 public revFee = 30;
    ...
    constructor() {
        ...
        address airdropWallet = 0x1F3F3B316aC4457280d72b100De8c2C241EDC30A;
        ...
        _balances[msg.sender] = 6_942_000_000_000 * 1e18;
        emit Transfer(address(0), msg.sender, _balances[msg.sender]);
        _balances[treasuryWallet] = 0 * 1e18; 
        ...
        _balances[address(this)] = 62_478_000_000_000 * 1e18;  
