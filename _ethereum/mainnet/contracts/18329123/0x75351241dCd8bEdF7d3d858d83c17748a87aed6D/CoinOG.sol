/*
    Coin OG (COINOG) - coinog.co	
    https://t.me/CoinOGOfficialPortal	https://twitter.com/Coin_OG_

    In the cyber streets of the decentralized world, where every coin fights for its territory, COIN OG stands tall as the undisputed Original Gangster. Born from the core principles of the OG world – respect, loyalty, and authenticity – COIN OG isn’t just another digital coin; it's the very embodiment of street cred in the crypto universe.
    ...
    Shout out to 2pac, the black god of rap. Chill bro. Name of OG last forever. Respect. 
*/
...
contract CoinOG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Coin OG";
    string private constant _symbol = unicode"COINOG";
