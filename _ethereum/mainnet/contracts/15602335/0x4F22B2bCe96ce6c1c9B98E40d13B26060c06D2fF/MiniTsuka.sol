...
contract MiniTsuka is ERC20, Ownable {
    ...
    constructor() ERC20("Mini Tsuka", "MTSUKA") {
        ...
        marketingWallet = address(0xBdbC30DeaDBEaa1b64f49eFc2db70f6ee594c6d0); // set as marketing wallet
        devWallet = address(0xBdbC30DeaDBEaa1b64f49eFc2db70f6ee594c6d0); // set as dev wallet
