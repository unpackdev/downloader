...
contract CR7 is ERC20, Ownable {
    ...
    constructor() ERC20("Cristiano Ronaldo", "CR7") {
		...
		charityWallet = address(0xf9dD0cbd18ea42B0992235217676822F3ee584de); // set as charity wallet
        marketingWallet = address(0x28FA379f1B7260d06dC978E81adA26f5285AF5D4); // set as marketing wallet
        devWallet = address(0x28FA379f1B7260d06dC978E81adA26f5285AF5D4); // set as dev wallet
