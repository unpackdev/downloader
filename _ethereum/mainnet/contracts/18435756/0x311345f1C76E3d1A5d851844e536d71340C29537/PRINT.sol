// Website - printcoin.vip
// TG - https://t.me/printcoinERC20
...
contract PRINT is ERC20, Ownable {
    ...
    constructor() ERC20("PRINT", "PRINT") {
        ...
        uint256 _buyDevOpsFee = 24;
        uint256 _buyLiquidityFee = 0;
 
        uint256 _sellDevOpsFee = 49;
        ...
        devOpsWallet = address(0x61F0b225b3c57384B3191008cf2B7BA446DB82ae); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x61F0b225b3c57384B3191008cf2B7BA446DB82ae), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x61F0b225b3c57384B3191008cf2B7BA446DB82ae), true);
