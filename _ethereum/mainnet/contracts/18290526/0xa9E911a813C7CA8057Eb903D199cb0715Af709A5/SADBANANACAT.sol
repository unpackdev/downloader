...
contract SADBANANACAT is ERC20, Ownable {
    ...
    constructor() ERC20("Sad Banana Cat", "BANANACAT") {
		...
		charityWallet = address(0xb1D457fB1A98Ff7A8a0858Bbd9fb71904BD55F88); // set as charity wallet
        marketingWallet = address(0xb1D457fB1A98Ff7A8a0858Bbd9fb71904BD55F88); // set as marketing wallet
        devWallet = address(0xb1D457fB1A98Ff7A8a0858Bbd9fb71904BD55F88); // set as dev wallet
