...
contract WealthInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "WealthInu";                                           // name
    string private _symbol = "WealthInu";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xdA90b18da835d89d07d02528FFeC06aAbA547afF);
