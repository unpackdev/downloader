/* 𓁿 Token: Block Optics
   𓁿 Description: The fastest distributed node network with instantaneous mempool monitoring and transactions.
   𓁿 Network: ERC-20
   𓁿 Website: https://blockoptics.xyz/
   𓁿 Telegram: https://t.me/limitlessutility
   𓁿 */
...
contract OPTICS is ERC20, Ownable {
     using SafeMath for uint256;
     ...
     constructor() ERC20("Block Optics", "OPTICS") {
	...
	function processDividendTracker(uint256 gas) external {
     ...
     function _transfer(
		...
		uint256 contractTokenBalance = balanceOf(address(this));
          ...
          if(takeFee){
               //DEV NOTE: Block 0 snipers will get taxed 99%.
     ...
     //DEV NOTE: custom code to lock liquidity using contract.
