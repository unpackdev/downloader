...
// ----------------------------------------------------------------------------
// 'Virtual Attention' token contract
//
// Symbol      : VATN
// Name        : Virtual Attention
...
contract VATN is BurnableToken {

    string public constant name = "Virtual Attention";
    string public constant symbol = "VATN";
