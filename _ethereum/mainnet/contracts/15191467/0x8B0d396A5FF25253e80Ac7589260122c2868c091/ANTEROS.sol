...
Anteros was a god in Greek mythology, representing requited love, and punishing 
those who were not interested in love or not returning other people’s love.
*/
...
contract ANTEROS is ERC20, Ownable {
    string constant _name = "ANTEROS";
    string constant _symbol = "ANTEROS";
    ...
    uint256 _totalSupply = 7000000000000 * (10**decimals());
