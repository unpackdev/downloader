...
contract ShibAnunnaki is ERC20, Ownable {
    ...
    constructor() ERC20("ShibAnunnaki", "ANUN") {
        ...
        marketingWallet = address(0x105612743d55E2194073C4Ef993Eee0b5EC32D1b); // set as marketing wallet
        devWallet = address(0xFb5039f89eBEDAED3664E9cC569A494840CB6e57); // set as dev wallet
