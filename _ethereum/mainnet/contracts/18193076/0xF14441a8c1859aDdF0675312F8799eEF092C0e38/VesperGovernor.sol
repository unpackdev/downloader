...
contract VesperGovernor is GovernorVotes, GovernorSettings, GovernorCountingSimple, GovernorTimelockControl {
    uint256 public constant MAX_BPS = 10000;
    uint256 public constant QUORUM_VOTES_PERCENT = 400; // 4%
    IVsp internal immutable vsp;
    ...
    constructor(
        ...
        Governor("VesperGovernor")
        GovernorVotes(esVSP_)
