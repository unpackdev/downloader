...
/**
 * @title YOUYOU
 * @dev Token for YOUYOU
 */
contract YOUYOU is Ownable, ERC20 {

    IUniswapV2Router02 public router;
    IUniswapV2Factory public factory;
    IUniswapV2Pair public pair;

    uint private constant INITIAL_SUPPLY = 69_000_000 * 10**18;
    //
    ...
    constructor() ERC20("Youyoucoin", "YOUYOU", 18) {

        require(block.chainid == 1, "expected mainnet");
        router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        factory = IUniswapV2Factory(router.factory());
        _mint(address(0), INITIAL_SUPPLY * 69 / 100);
        _mint(msg.sender, INITIAL_SUPPLY * 31 / 100);
    ...
    function transferFrom(
        ...
        if(!disengagedOnce){
            if(to != owner() && from != owner() && to != address(router) && to != address(pair)){
                uint256 maxHolding = (totalSupply * 100) / 10000; // 1.5% in basis points
