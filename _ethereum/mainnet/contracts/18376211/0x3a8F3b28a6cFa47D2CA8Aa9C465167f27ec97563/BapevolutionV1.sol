...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721MetadataUpgradeable.sol@v4.8.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/ERC721Upgradeable.sol@v4.8.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721BurnableUpgradeable.sol@v4.8.3
...
// File contracts/Bapevolution-v1.sol
    ...
    ReentrancyGuardUpgradeable
{
    ...
    address public constant WITHDRAW_ADDRESS =
        0xFC4BF9d0AB489E7684aB0E06D33B8E2257D8fF60;
    ...
    */
    ...
    function airDrop(address[] memory _addresses) public virtual onlyOwner {
        for (uint256 i = 0; i < _addresses.length; i++) {
            require(supply.current() + 1 <= maxSupply, "Max supply exceeded");
            _mintLoop(_addresses[i], 1);
        }
    }
    ...
    function tokenURI(
        ...
        return
            bytes(commonURI).length > 0
                ? string(abi.encodePacked(commonURI, tokenId.toString()))
                : "";
    }
    ...
    */
    ...
    function withdraw() public payable virtual onlyGovernor {
