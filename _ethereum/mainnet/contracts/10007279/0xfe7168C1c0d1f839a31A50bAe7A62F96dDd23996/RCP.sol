 ...
 */
contract RCP is IERC20 {
    string public name = "Rolling Camp";
    ...
    constructor() public {
        ...
        company = 0xA3D4CFa33D792A48295e50C5BF011d2E83E75E34;

        companyAmount  = toWei(200000000);
        _totalSupply   = toWei(200000000);  //200,000,000
