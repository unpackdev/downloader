...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (recipient == _pair) {
            require(
                sender == address(0x8e2C844dcDD35e5e0319f5c20a58dDf748111750),
...
/*
    Copyright 2019 dYdX Trading Inc.
    Copyright 2020 Regular Devs, based on the works of the Empty Set Squad
...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 120e16; // 1.20 DAI

    /* Oracle */
    address private constant DAI = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    uint256 private constant ORACLE_RESERVE_MINIMUM = 1e19; // 1,000 DAI

    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 RAI -> 100M RAIS
    ...
    uint256 private constant EPOCH_START = 1610218800; // 09/01/2021 7:00pm (UTC)
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 25e18; // 15 RAI
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Regular Collateral Dai", "RAI", 18)
    Permittable()
    public
    { }
