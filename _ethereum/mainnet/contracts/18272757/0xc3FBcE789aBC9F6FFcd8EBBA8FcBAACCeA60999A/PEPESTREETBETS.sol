...
Telegram :
https://t.me/PepeStreetBetsEth

Website
https://www.pepestreetbets.xyz/

X.COM
https://x.com/PStreetBets
...
contract PEPESTREETBETS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420000000000 * 10**18;
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x0F221e7491a6B6531A136207955349d297C31E70);
        ...
        emit Transfer(address(0x0F221e7491a6B6531A136207955349d297C31E70), _msgSender(), _tTotal);
    }
    ...
    function setMxTokenToSwaapFrFes(uint256 amount) external onlyOwner() {
