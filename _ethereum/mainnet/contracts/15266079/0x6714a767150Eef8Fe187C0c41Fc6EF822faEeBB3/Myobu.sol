...
https://medium.com/@myobus/my%C5%8Dbu-genesis-d2ccdd09b3f2


変化が必要です、変化は起こります。私たちは、私たちに影響を与えているネズミやネズミを駆除するためにここにいます。
私たちはそれらすべてを暴きます
...
contract Myobu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Myobu";
