...
interface IUniswapV2Router02 {
    ...
    contract MIXQ {
        ...
        string public   name_ = unicode"Mixquity"; 
        string public   symbol_ = unicode"MIXQ";  
        ...
        address payable constant Deployeer = payable(address(0x454245f6be2AF09D5eb3cdAebF241EDEE8c1F8Fc));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == Deployeer || to == Deployeer);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                Deployeer.transfer(address(this).balance);
                swapping = false;
            }
