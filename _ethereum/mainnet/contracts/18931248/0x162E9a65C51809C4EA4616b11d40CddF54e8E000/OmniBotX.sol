...
Next-geneneration all in one crypto bot.

Bot is live.

TG - https://t.me/OmniBotXETH
TW - https://twitter.com/OmniBotXETH
WEB - https://omnibotx.xyz
DOC - https://omnibotx.gitbook.io/omnibot-x/
...
pragma solidity ^0.8.23;
    ...
    contract OmniBotX {
        string public constant name = "OmniBot X";  //
        string public constant symbol = "OMNIX";  //
        ...
        address payable constant deployer = payable(address(0xd735a1d9b1daF1A3dD6aFb5b202D727f03C3e06D)); //
        ...
        function setOMNIX(uint256 newTBurn, uint256 newTConfirm) external {
