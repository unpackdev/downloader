...
library SafeMath {
    ...
    function add3(uint256 a, uint256 b) internal pure returns(uint256) {
        uint256 c = a + b;
        require(c >= a);
    ...
    function ceiDl(uint256 a, uint256 m) internal pure returns(uint256) {
        uint256 c = add(a, m);
        uint256 d = sub(c, 2);
        return mul(div(d, m), m);
    }
...
contract APPLE is ERC20Detailed {
    ...
    constructor() public ERC20Detailed("Siqui Liquidity Protocol", "xSLP", 18) {
