...
interface IERC721 {
    ...
    /**
        @notice Throws unless `msg.sender` is the current owner, an authorized operator,
            ...
            Throws if `_from` is not the current owner. Throws if `_to` is the zero address.
   ...
   */
    ...
    /**
        @notice The caller is responsible to confirm that `_to` is capable of receiving NFTs
            or else they may be permanently lost.
        @dev Throws unless `msg.sender` is the current owner, an authorized operator,
            or the approved address for this NFT. Throws if `_from` is not the current owner.
   ...
   */
    ...
    /**
        ...
        @dev Enables or disables approval for a third party ("operator") to manage all of `msg.sender`'s assets.
            It also emits the ApprovalForAll event.
   ...
   */
    ...
    /**
        @dev Returns the number of NFTs owned by `_owner`.
            NFTs assigned to the zero address are considered invalid, and this function throws for queries about the
            zero address.
   ...
   */
    ...
    /**
        ...
        @dev Returns the address of the owner of the NFT.
            NFTs assigned to the zero address are considered invalid, and queries about them do throw.
   ...
   */
    ...
    /**
        ...
        @param _tokenId The id of the target token.
    */
    ...
    /**
        @dev This emits when the approved address for an NFT is changed or reaffirmed.
            ...
            When a Transfer event emits, this also indicates that the approved address for that NFT (if any)
            is reset to none.
        @param _owner The owner of the target token.
