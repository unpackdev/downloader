...
contract PEPEPOUNDS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3333333 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress = payable(address(0x55526D40C09Da46Fa10721446B97373994A9d9c2));

    string private _name = "PEPEPOUNDS";
    string private _symbol = "PUNDS";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(20); //3%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(20); // 3%
