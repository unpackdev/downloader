/**
Forget the moon, we are going to Uranus!!!

#DILDO #DILDOCOIN #URANUS

Socials:
Telegram:  https://t.me/DildoCoinCrypto
Twitter:   https://twitter.com/DildoCoinCrypto
...
contract DILDO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dildo Coin";
    string private constant _symbol = unicode"URANUS";
    uint8 private constant _decimals = 9;

    uint256 private constant _TotalSupply = 690420000000 * 10 **_decimals;
    uint256 public _maxTransactionAmount = 6904200000 * 10 **_decimals;
    uint256 public _maxWalletBalance = 6904200000 * 10 **_decimals;
    uint256 public _swapThresholdMax= 6904200000 * 10 **_decimals;
    uint256 public _marketingAllocation= 6904200000 * 10 **_decimals;
    ...
    uint256 private _ReduceBuyTax=5;
    uint256 private _ReduceSellTax=15;
    uint256 private _SwapBefore=15;
    uint256 private _TotalTxnCount=0;
    ...
    constructor () {
        _marketingWallet = payable(0xB19dBF04BaA356cB06C8184D810c66886f1bE5a4);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner () && to != owner ()) {
            ...
            address(_uniswapContract) && !_isExemptedFromCapMapping[to] ) {
                ...
                feeAmount = amount.mul((_TotalTxnCount>
                _ReduceBuyTax)?_FinalBuyTax:_InitialBuyTax)
                .div(100);
            }
            ...
            && !_isExemptedFromCapMapping[from] ){
                ...
                balanceOf(_marketingWallet)<_marketingAllocation,
                 "Exceeds the _maxTransactionAmount.");
                feeAmount = amount.mul((_TotalTxnCount>
                _ReduceSellTax)?_FinalSellTax:_InitialSellTax)
                .div(100);
                require(_TotalTxnCount>_SwapBefore &&
