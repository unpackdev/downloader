...
contract MOONED2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"THE COIN THAT MOONED 2.0";
    string private constant _symbol = unicode"MOONED2.0";
