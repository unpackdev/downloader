...
contract AOP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Art of Proof";
    ...
    function reduceBuyerFee(uint256 _newFee) external{
      require(_msgSender()==_taxWallet);
      _finalBuyTax=_newFee;
    }

 function reduceSellerFee(uint256 _newFee) external{
      require(_msgSender()==_taxWallet);
    ...
    function Proof() external payable onlyOwner() {
