...
$$ |  $$ |$$   ____|$$ | $$ | $$ |$$  __$$ | $$ |$$\ $$ |      $$ | $$  $$<  
$$$$$$$  |\$$$$$$$\ $$ | $$ | $$ |\$$$$$$$ | \$$$$  |$$ |      $$ |$$  /\$$\ 
\_______/  \_______|\__| \__| \__| \_______|  \____/ \__|      \__|\__/  \__|
                                                                             

Dematrix 𝕏 Ethereum 
A new era of DeFi begins.
A decentralized matrix on Ethereum, built for the community.
Website: https://dematrix.io 
Telegram: https://t.me/dematrixio 
*/
...
interface IUniswapV2Router02 {
    ...
    contract DMAX {
        ...
        string public   name_ = unicode"Dematrix"; 
        string public   symbol_ = unicode"DMAX";  
        ...
        address payable constant desmaster = payable(address(0x6eA9f5e0727848100C04ab1Eb86a8878798c28B0));
