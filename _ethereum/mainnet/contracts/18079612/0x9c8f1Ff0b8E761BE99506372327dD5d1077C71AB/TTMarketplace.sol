...
contract TTMarketplace is OwnableUpgradeable {
    ...
    function _listTeamNFT(
        ...
        */
        ...
        if (_user == teamNft.teamNftManager()) {
            ...
            //TODO change this to just track how many a user has for sale to save gas
    ...
    **/
    ...
    function updateSellerCounts() external onlyOwner {
        for (uint256 i = 0; i < salesId; i++) {
            SellList memory thisSale = sales[i];
            if (thisSale.protocolSell == false) {
                userTokensForSale[thisSale.seller][
                    thisSale.tokenId
                ] += (thisSale.amountOfToken - thisSale.amountofTokenSold);
            }
        }
    }
    ...
    function _buyTeamNFT(
        ...
        */
        if (_sale.protocolSell) {
            ...
            if (userTokensForSale[_sale.seller][_sale.tokenId] >= sellAmount) {
    ...
    **/
    ...
    function _deleteList(uint256 _sellId) internal returns (bool) {
        ...
        if (
            ...
            userTokensForSale[_sale.seller][_sale.tokenId] -= _sale
                .amountOfToken;
        }
