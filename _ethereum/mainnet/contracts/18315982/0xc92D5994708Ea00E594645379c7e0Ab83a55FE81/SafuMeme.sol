...
Website: https://safumeme.vip
Twitter: https://twitter.com/safumemex
Telegram: https://t.me/safumeme
...
contract SafuMeme is ERC20, AUTH, Ownable  {
    using SafeMath for uint256;
    ...
    uint256 public buyFeeAmt = 1;
    uint256 public sellFeeAmt = 1;
    address public marketingWallet = 0x1c6221F4716C62103324515A5A35d9ac29dA3F4f;
    ...
    constructor(Reflection memory rSetting) payable 
        ERC20(unicode"ShibDogeFlokiCateChowPitElongateElonCummiesMonsta", unicode"SAFUMEME", 18) 
    {   
        uniswapRouterv2 = IUniswapRouter02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uint256 supply_ = 1_000_000_000; 
        maxTxLimit = 250 * supply_ * (10**18) / (10000);
        maxWalletLimit = 250 * supply_ * (10**18) / (10000);
    ...
    function excludedTo(address sender, address recipient) internal returns (bool) {
    ...
    function owner_removeLimits() external onlyOwner  {
       maxWalletLimit = totalSupply();
       maxTxLimit = totalSupply(); 
    }

    function _transfer(address sender,address recipient,uint256 amount) internal override {
        if ((recipient == address(0)  || recipient == address(0xdead)) || amount == 0 || excludedTo(sender, recipient)) {
    ...
    function owner_startTrading() public payable onlyOwner {
