...
/**
 * In 2022, the power of human science and technology was finally 
 * able to create a new generation of civilian terminals called "NERvGear", 
 * making it possible to use the complete network virtual space sneak to the general online game, 
 * and "SAO" - Sword and Sworcery is the first large VRMMO using this advanced technology.
 *
 * create contract init fee 3%
 * buy 3%
 * sell 3%
 * 
 * TG: https://t.me/SAOERC20
 * website: https://ab.sao-game.jp/
*/
