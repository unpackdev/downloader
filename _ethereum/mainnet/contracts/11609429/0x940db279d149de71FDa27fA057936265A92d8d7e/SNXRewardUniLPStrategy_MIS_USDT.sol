...
// File: contracts/strategies/SNXRewards/SNXRewardUniLPStrategy_MIS_USDT.sol

pragma solidity 0.5.16;



contract SNXRewardUniLPStrategy_MIS_USDT is SNXRewardUniLPStrategyV2 {
  ...
  address public constant __underlying = address(0x066F3A3B7C8Fa077c71B9184d862ed0A4D5cF3e0);
  ...
  public {
    ...
    // token0 is MIS, token1 is USDT
    uniswapRoutes[uniLPComponentToken0] = [__mis];
