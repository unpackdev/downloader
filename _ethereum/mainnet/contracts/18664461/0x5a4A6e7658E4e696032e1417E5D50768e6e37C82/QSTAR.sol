// Telegram: https://t.me/QStarAi_Portal
// Twitter:  https://x.com/QStarAi_
...
contract QSTAR is ERC20, Ownable {
    ...
    constructor(
        address _router
    ) ERC20("QSTAR AI BOT", "QSTAR") Ownable(msg.sender) {
        ...
        rewardsWallet = address(0); // set as rewards wallet
        marketingWallet = address(0x7fA00d8655455241680456A8D39697e6CEF5fE77); // set as marketing wallet
        operationsWallet = address(0); // set as operations wallet
