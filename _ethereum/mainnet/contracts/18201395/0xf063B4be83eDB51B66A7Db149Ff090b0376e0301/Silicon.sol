...
contract Silicon is Ownable, ERC20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x4a111e168B81aCeBdA5e8dB2Eb73566dEaCf9f50;
   ...
   function clearERC20Token(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function enableSI() public onlyOwner {
        TradingOpen = true;
        sellpercent = 500;
        buypercent = 400;
