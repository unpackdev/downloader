...
contract AntiSplit is ERC20Detailed {
  ...
  string constant tokenName = "AntiSplit";
  string constant tokenSymbol = "AntiSplit";
  uint8  constant tokenDecimals = 18;
  
  uint256 constant easyDecimals = 1000000000000000000;
  // yes you can use an exponent instead if you want
  uint256 _totalSupply = 2000 * easyDecimals;
