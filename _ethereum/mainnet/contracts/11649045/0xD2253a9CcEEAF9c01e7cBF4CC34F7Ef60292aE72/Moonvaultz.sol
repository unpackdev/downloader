...
contract Moonvaultz is Context, IERC20, Ownable {
    ...
    string private _name = "Moonvaultz.finance";
    string private _symbol = "Moonvaultz";
    ...
    //Total 5% => 1% goes to liquidity providers and 4% are added to liquidity pool
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    //means 10% from total collected liquidity(5% on every Transfer) will be used to rewarded liquidity providers
    uint256 public _lpRewardFromLiquidity = 10;
    ...
    //         10**(uint256(_minTokensBeforeSwapDecimal) + 4)
    //     );
