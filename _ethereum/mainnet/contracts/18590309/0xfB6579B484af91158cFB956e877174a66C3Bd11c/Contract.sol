...
contract DigitalDegen is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (uniswapV2Pair != address(0) && from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
