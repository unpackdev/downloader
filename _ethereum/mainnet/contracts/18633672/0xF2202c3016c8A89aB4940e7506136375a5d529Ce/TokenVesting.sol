...
contract TokenVesting is Ownable, ReentrancyGuard {
    ...
    // @dev Payment phases to the investor (10%, 25%, 40%, 55%, 70%, 85%, and 100%)
    ...
    /**
     * @dev Modifier to ensure that the contract is enabled.
     */
     ...
     * @param _tokenAddress ERC-20 contract address.
    ...
    /**
     * @notice Deposits a fund of 150,000,000 PRT tokens into the contract.
     * @dev Only the owner can call this function.
     */
    function depositTokens() external onlyOwner {
        ...
        require(sent, "Error sending PRT transfer to Contract");
        totalVestingAmount = 150_000_000 ether;
    }

    /**
     * @notice Releases the scheduled tokens.
     * @dev This function is protected against reentrancy.
     * @dev This function can be locked/unlocked by the Owner.
     */
    ...
    /**
     * @notice Changes the contract state, allowing to lock and unlock it.
     * @dev Only the owner can call this function.
     */
    ...
    /**
     * @notice Allows the withdrawal of tokens in case of issues with the contract.
     * @dev The contract must be locked before the initial payment period, and this function should only be called after that period starts.
     * @dev The function can only be called before the initial payment period; after the cliff, calling this function is not possible. This protects the investor.
     * @dev Only the owner can call this function.
     */
    function withdrawEmergency(address _addressTo) public onlyOwner {
        ...
        require(!isEnabled, "Contract must be blocked for the investor");
