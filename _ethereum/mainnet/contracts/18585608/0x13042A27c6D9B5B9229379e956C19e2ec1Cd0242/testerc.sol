/*
Twitter: https://t.me/GrokVerseERC

Website: https://grokverse.io/

Twitter: https://twitter.com/GrokVerseERC
*/
...
contract GrokVerse is Context, IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0x51FD6Eb4967c0D98De676359E1d38D620737Dd1d);
    ...
    string private constant _name = unicode"GrokVerse";
    string private constant _symbol = unicode"GROKVERSE";
    uint256 public _maxTxAmount = 138000000 * 10**_decimals;
    uint256 public _maxWallet = 138000000 * 10**_decimals;
    uint256 public _taxSwap = 13800000 * 10**_decimals;
