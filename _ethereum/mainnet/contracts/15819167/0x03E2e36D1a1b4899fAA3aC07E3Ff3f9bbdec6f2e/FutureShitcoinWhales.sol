...
*Token launch gifted to the "Future Shitcoins 8 Figure Whales" Chat. 

*https://t.me/+ag91uGYwkiYxMTk0

*This token is a soial experiment. Can a degen community pull together and go the distance??? Or dump on eachother???

*we will see.

*If this token survives 12 hours i will lock liquidity for 1 month. 

*Marketing tax will be send to a multi sig wallet created by the comminity. 
...
contract FutureShitcoinWhales is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Future Shitcoin Whales";
    ...
    address payable private _developmentAddress = payable(0xe9A2Cd73bdaD8F808ef8611fcA1CD7145426BbBf);
    address payable private _marketingAddress = payable(0xe9A2Cd73bdaD8F808ef8611fcA1CD7145426BbBf);
