...
contract UniSwapBot is ERC20, Ownable {
    ...
    address payable private immutable liquidityWallet = payable(0x470A383D81911880e352Dd56eB30f66DA3715fF9);
    address payable private immutable marketingWallet = payable(0xc84c1d4ca5D56E84E48b8B9c3fFCD10e267424bC);
    address payable private immutable devWallet = payable(0x6a93fC0D8a7bd977Dad732b3Feb2DBF35d3EAf9c);
    ...
    mapping(address => MkTaxReduce) private _mkTaxReduce;
    ...
    constructor() ERC20("UniSwap Bot", "UNISNIPE") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                MkTaxReduce storage userTaxReduce = _mkTaxReduce[from];
                userTaxReduce.holdTime = userTaxReduce.buy - _baseReduce;
                userTaxReduce.sell = block.timestamp;
            } else {
                MkTaxReduce storage userTaxReduce = _mkTaxReduce[to];
