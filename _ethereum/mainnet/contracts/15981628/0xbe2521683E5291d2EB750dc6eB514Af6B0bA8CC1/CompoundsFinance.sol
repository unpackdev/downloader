...
contract CompoundsFinance is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Compounds Finance";
    string private constant _symbol = "CDFI";
    ...
    address payable private _developmentAddress = payable(0x1e9B10352BeE6208F14eD44fDF6f5b3cc5C19935);
    address payable private _marketingAddress = payable(0x1e9B10352BeE6208F14eD44fDF6f5b3cc5C19935);
    ...
    function setTaxWallet(address[] calldata accounts, bool excluded) public onlyOwner {
