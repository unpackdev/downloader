...
contract LP_LOCK {
    ...
    modifier onlyEmperor() {
        require(msg.sender == emperor, "Only Emperor can call this function");
        _;
    }
    ...
    function lockNFT(uint256 tokenId) external onlyEmperor {
    ...
    function triggerWithdrawal() external onlyEmperor {
    ...
    function cancelWithdrawalTrigger() external onlyEmperor {
        require(isNFTLocked, "NFT is not locked");
    ...
    function withdrawNFT(uint256 tokenId) external onlyEmperor {
        require(isNFTLocked, "NFT is not locked");
        require(lockUpEndTime != 0, "Withdrawal is not triggered");
    ...
    function changeOwner(address newOwner) external onlyEmperor {
