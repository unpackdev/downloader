...
0xUtilities (0xU) |
-------------------
0XUtilities is a web application featuring a suite of utilities. 
Generate vanity wallet addresses, 
seamlessly perform swaps on the Ethereum network, 
view detailed information of a contract, 
plus more!

Private keys generated are stored client side, resulting in a more secure way to generate and store wallets.
Telegram: https://t.me/Zer0xUtilities
Twitter: https://twitter.com/0xUtilities
Website: https://0xutilities.io/
...
contract Zer0xUtilities is Context, IERC20, Ownable {
