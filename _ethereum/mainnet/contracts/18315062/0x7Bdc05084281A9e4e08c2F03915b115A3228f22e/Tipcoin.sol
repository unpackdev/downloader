...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9c07912D9f0A3BCC07c7405d08a0A25CC3346C8e;
...
contract tipcoin is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xE5f3CF5c1646766af714f209896Aba8656aCA79E);
    ...
    string private _name = "Tipcoin2.0"; 
    string private _symbol = "TC 2.0";  
    ...
    uint256 private _TotalFee = 6; // Total fee is 3% (buyFee) + 3% (sellFee)
    uint256 public _buyFee = 3;    // 3% buy fee
    uint256 public _sellFee = 3;   // 3% sell fee
