...
contract PriceFeedsAdapterVenusMainnetXvs is PriceFeedsAdapterWithoutRounds {

  bytes32 constant private XVS_ID = bytes32("XVS");
  ...
  function requireAuthorisedUpdater(address updater) public view override virtual {
    if (updater != 0xE76A94749f1Debb6a8823CDdf44f1e51CC95600e ) {
