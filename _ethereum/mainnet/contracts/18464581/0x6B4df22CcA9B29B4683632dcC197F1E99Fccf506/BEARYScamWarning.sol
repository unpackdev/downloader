...
0x5f4Bc61E05cff305d31876C883cfb81699eA7524 - Likely honeypot, dev still has control of enable/disable trading function and set buy/sell 

FAKE RENOUNCE - dev has set 'second owner' parameter within the contract to control functions after he has 'renounced' control from the first  one.
...
LIKELY SCAM - PROCEED WITH CAUTION
...
contract BEARYScamWarning is IERC20 {

    
    string public constant name = "|SCAMWARNING";
    string public constant symbol = "BEARY PINK GRIL SCAM WARNING - CHECK MY SOURCE CODE !!";
