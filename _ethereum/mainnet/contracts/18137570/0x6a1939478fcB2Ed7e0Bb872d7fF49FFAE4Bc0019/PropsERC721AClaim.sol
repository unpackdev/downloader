    ...
    ERC2981
{
    ...
    address public PROPS_FEE_MANAGER = 0x558B87B2Bf66176328Dfa7966907326604Fb8Ad6; 
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function mintWithSignature(
        ...
        console.log("creator_fee", creator_fee);
        ...
        if(msg.value > _cost) {
            ...
            console.log("tip", tip);
            console.log("tip_split", tip_split);
            uint256 creator_tip = (tip * tip_split) / 10000;
            console.log("creator_tip", creator_tip);
            platform_fee += (tip - creator_tip);
        }

        console.log("msg.value", msg.value);
        console.log("Platform_fee", platform_fee);
        console.log("Creator Fee", (msg.value - platform_fee));
