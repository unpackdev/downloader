...
contract PeterPan is ERC20, Ownable {
    ...
    uint256 private immutable maxSupply = 469_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"Peter Pan V2";
    string private constant SYMBOL = unicode"PAN2.0";
