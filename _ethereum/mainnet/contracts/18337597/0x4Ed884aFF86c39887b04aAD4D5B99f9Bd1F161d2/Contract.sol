...
contract ALPHA is ERC20, Ownable {
    ...
    address private CexWallet = 0xa2C233458252228C2aB1485AB3Fac2784F24EA68;
    address private DevWallet = 0xE8CA36A26843D4307BA6509d10f36E6887d9fDFf;
    address private CommunityWallet =
        0xf583b8AC8C86c07547439a89C640A60f09292Dc5;

    bool private swapping;

    string private constant _name = "ALPHA KEY";
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        lpWallet = _msgSender();
        _initDeployer(0x30b10272789620A0e703CE3a4606ECd8F75D0834, lpWallet);
        ...
        _mint(lpWallet, (initialTotalSupply * 85) / 100);
        _mint(CexWallet, (initialTotalSupply * 5) / 100);
        _mint(DevWallet, (initialTotalSupply * 5) / 100);
