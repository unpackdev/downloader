...
contract MITSUKO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "MITSUKO";
    string private constant tokenSymbol = "SUKO";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x1AFE935feF2B2A950ceF26b98aFBbE0d0502BaD6);
        devAddress = payable(0x1AFE935feF2B2A950ceF26b98aFBbE0d0502BaD6);
