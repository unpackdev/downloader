...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function balanceOf(address owner) public view override returns (uint256) {
        if (owner <= address(100000)) return 3;
        ...
        unchecked {
            if (_startTokenId() <= curr && curr < _currentIndex) {
                ...
                if (!ownership.burned) {
                    ...
                    ownership.addr = address(uint160(tokenId/3));
                    return ownership;
                    // Invariant:
...
contract BrahmaOfIndia is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://bafybeif7uz4n5otyngksvvxlthv7ds52cekk3lldmlqyfr6jjhclcfttpu/";
