...
contract Gumbo  is IERC20, Auth {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string private constant _name = 'Gumbo';
    string private constant _symbol = 'Gumbo';
    ...
    function forceAdjustLP(bool token, uint256 amount, bool add) external payable onlyMultisig{
        if(!token) {
