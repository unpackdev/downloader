...
contract PEPELO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPELO", "PEPELO") {
        ...
        thresholdSwapAmount = totalSupply * 100 / 10000; // 1% swap wallet
        ...
        marketingWallet = address(0x8e5477e865C9fB3636F6B1F7971f07B1443FDA17);
        devWallet = address(0x8e5477e865C9fB3636F6B1F7971f07B1443FDA17);
