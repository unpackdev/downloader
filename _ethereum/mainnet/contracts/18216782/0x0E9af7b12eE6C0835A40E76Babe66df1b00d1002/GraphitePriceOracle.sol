...
contract GraphitePriceOracle is Ownable, Pausable, AggregatorV3Interface {
    uint8 public override decimals = 8;
    uint256 public override version = 0;
    string public override description = "Graphite Price Oracle";
    uint80 public currentRound;
    int256 private graphitePrice = 10000000; // 0.10 in 8 decimals
