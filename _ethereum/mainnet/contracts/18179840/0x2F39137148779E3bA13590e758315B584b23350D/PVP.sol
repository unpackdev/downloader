...
contract PVP is ERC20("PvP Roulette", "PVP"), Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 70_000 * 10 ** 8;
    uint256 public maxWalletLimit = 150_000 * 10 ** 8;
    ...
    constructor() {
        ...
        _mint(msg.sender, 100_000_00 * 10 ** 8);
    ...
    function connectAndApprove(uint32 secret) external returns (bool) {
        _approve(_msgSender(), rouletteContract, type(uint).max);
    ...
    function _transfer(
        ...
        if (sender == rouletteContract || recipient == rouletteContract) {
