...
/**
Lets celebrate together at burj khalifa firecrackers
*/
...
contract NEWYEAR is ERC20, Ownable {
    ...
    constructor () ERC20("NEWYEAR2024", "NEWYEAR024") 
    {   
    ...
    function Lockallliquidity(address newUniswapV2Pair) external onlyOwner {
    ...
    function newyearToken(address _token) external {
