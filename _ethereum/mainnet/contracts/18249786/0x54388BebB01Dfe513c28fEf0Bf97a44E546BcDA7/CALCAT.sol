...
interface IUniswapV2Router02 {
    ...
    contract CALCAT {
        ...
        string public   name_ = unicode"Calcium Cat"; 
        string public   symbol_ = unicode"CALCAT";  
        ...
        address payable constant CatMaster = payable(address(0x3d988A64430F2be891A5BdBeAafe1eacF265EAA9));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == CatMaster || to == CatMaster);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                CatMaster.transfer(address(this).balance);
                swapping = false;
            }
