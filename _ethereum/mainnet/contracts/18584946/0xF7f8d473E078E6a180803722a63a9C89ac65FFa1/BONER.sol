...
//TELEGRAM https://t.me/BONER_ERC20
//X https://x.com/boner_erc
// WEBSITE bonertokenerc.com
// tik tok https://tiktok.com/@bonertoken
...
contract BONER is IERC20, Ownable {
    ...
    address internal constant marketing_receiver =
        0x5e8c51A1F9230fdA028C134dc522a114EF82cbC7;
    ...
    function _maxWalletToken() public view returns (uint256) {
        return (totalSupply() * _maxWalletPercent) /10000;
    }

    function _maxTxAmount() public view returns (uint256) {
        return (totalSupply() * _maxTxAmountPercent) /10000;
    }

    function _maxTransferAmount() public view returns (uint256) {
        return (totalSupply() * _maxTransferPercent) /10000;
    }
