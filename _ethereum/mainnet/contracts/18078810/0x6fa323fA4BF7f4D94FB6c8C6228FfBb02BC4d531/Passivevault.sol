...
contract Passivevault is Ownable {
    ...
    uint256 public constant Max_Seeker_Level = 5;
    ...
    function stake(uint256 amount, uint256 _seekerLevel) external {
        require(_seekerLevel <= Max_Seeker_Level, "Invalid Seeker level");
