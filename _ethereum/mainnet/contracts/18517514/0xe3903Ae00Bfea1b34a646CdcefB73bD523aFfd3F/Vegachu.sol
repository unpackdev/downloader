...
contract Vegachu is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _owner = msg.sender;
        marketingWalletAddress = payable(0x007077d8131b4803527580A581b461b398D9986e);
        teamWalletAddress = payable(0x007077d8131b4803527580A581b461b398D9986e);
    ...
    function updatePair(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
    ...
    function swapAndTransfer(uint256 tAmount) private lockTheSwap {
