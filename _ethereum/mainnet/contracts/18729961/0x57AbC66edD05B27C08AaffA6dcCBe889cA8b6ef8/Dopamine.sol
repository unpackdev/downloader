/**
Need a hit of Dopamine? 
Then you need to embrace Dopamine Token. 
The only token where the dev is always on adderall, so your face will truly melt with how high we'll go.

TG link: t.me/DOPAMINE_ETH 
Twitter: https://twitter.com/Dopamine_ERC20
Website: https://dopamine.support
...
contract DOPAMINE is ERC20, Ownable {
    ...
    constructor() ERC20("DOPAMINE", "DOPE") payable {
        ...
        marketingWallet = address(0xF4B44125D7b8F5637E461666E2590C2c27131218); // set as marketing wallet
        ...
        excludeFromFees(0xdc97133A40543F1aC881EE37BF7Af813B9eeaf69, true); // future owner wallet
        ...
        excludeFromMaxTransaction(0xdc97133A40543F1aC881EE37BF7Af813B9eeaf69, true);
...
_createInitialSupply(0xdc97133A40543F1aC881EE37BF7Af813B9eeaf69, totalSupply*3/100);
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100)/1e18, "Cannot set maxTxnAmount lower than 1%");
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xdc97133A40543F1aC881EE37BF7Af813B9eeaf69,
            block.timestamp
        );
    }
