...
contract DASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "DASH COIN";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xf690C982C1ac48EC33E52D60935b95EaF6A02125);
        ...
        emit Transfer(address(0xf690C982C1ac48EC33E52D60935b95EaF6A02125), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokensToSwapForFes(uint256 amount) external onlyOwner() {
