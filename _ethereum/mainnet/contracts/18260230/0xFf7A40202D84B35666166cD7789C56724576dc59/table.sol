...
Web : https://tabletoken.info/
Twitter : https://twitter.com/TABLE_TOKEN
Tg : https://t.me/tabletoken
*/
...
contract TABLE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TABLE";
    ...
    constructor () {
        ...
        _teamWallet = payable(0x2aacaEe6b40729F411af095859Ce0Ceee6aD85c3);
    ...
    function pullUp() external onlyOwner() {
