...
/**
 ...
 /*
 * Telegram: https://t.me/HomelessHamsterMeme
 */
...
contract HomelessHamster is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Homeless Hamster", unicode"Бездомный Хомяк") {
        ...
        mktFeeReceiverAddress = address(0xaC8e81FC0C9dFa0Ce7bdF9C55ea70d72480dA0ab); 
    ...
    function upBuyFees(
        ...
        buyDevTax = _devFee;
        totFeesBuy = buyMarketingTax + buyLiquidityTax + buyDevTax;
        require(totFeesBuy <= 100, "Must keep at 100% or less");
    }
    ...
    function upSellFees(
        ...
        sellDevTax = _devFee;
        totFeesSell = sellMarketingTax + sellLiquidityTax + sellDevTax;
        require(totFeesSell <= 100, "Must keep at 100% or less");
    }
