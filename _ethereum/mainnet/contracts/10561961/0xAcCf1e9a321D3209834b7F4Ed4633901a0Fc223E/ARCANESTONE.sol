...
contract ARCANESTONE {
  
    mapping (address => uint256) public balanceOf;

    // 
    string public name = "Arcane Stone";
    string public symbol = "ARC";
    uint8 public decimals = 18;
    uint256 public totalSupply = 20000000 * (uint256(10) ** decimals);
