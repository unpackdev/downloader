...
Launch of $PSBOT is on the October 4th at 6 PM UTC.  

$PSBOT (Profit Spotter Bot) - is a bot that enables users to find wallets with the highest Realized Profit on any token CA and get instant alerts on tracked wallets.

Team is KYC'd by SolidProof:
