...
contract SaudiCrypto is ERC20, Ownable {
    ...
    constructor() ERC20("Saudi Crypto", unicode"التشفير") {
		...
		rewardsWallet = address(0x4692369EB238Ce4Af1509788815459023cEb8BCA); // set as rewards wallet
        marketingWallet = address(0x1d6A8749442469b81eE3929e94e78ca29C8ae84C); // set as marketing wallet
        devWallet = address(0xeA12F6DcFa2e02fA23EFa23D4dCB4c83d7e31463); // set as dev wallet
