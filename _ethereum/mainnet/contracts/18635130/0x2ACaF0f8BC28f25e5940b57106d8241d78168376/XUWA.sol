...
contract XUWA is ERC20, Ownable {
    ...
    function XuwaSetLaunch(uint256 _blocks) external payable onlyOwner {
    ...
    function limitsAreXuwa() external onlyOwner {
