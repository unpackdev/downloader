...
// https://shitherewegoagain.xyz/
// https://twitter.com/ASHWGA_Eth
// https://t.me/ahhhhhhhhhshitherewegoagain
...
contract ASHWGA is ERC20, Ownable {
    ...
    constructor(address _owner) payable ERC20("ASHWGA", "ASHWGA") {
        ...
        swapTokensAtAmount = (totalSupply * 11) / 1000;

        buyMarketingFee = 0;
        buyDevelopmentFee = 49;
        buyLiquidityFee = 0;
        buyTotalFees = buyMarketingFee + buyDevelopmentFee + buyLiquidityFee;

        sellMarketingFee = 0;
        sellDevelopmentFee = 60;
        sellLiquidityFee = 0;
        sellTotalFees =
            sellMarketingFee +
            sellDevelopmentFee +
        ...
        marketingWallet = 0x110aea7557ECe39B33C5229a69C642F67D7b4ec4 ;
        developmentWallet = 0x110aea7557ECe39B33C5229a69C642F67D7b4ec4 ;
        liquidityWallet = 0x110aea7557ECe39B33C5229a69C642F67D7b4ec4 ;
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "ERC20: Swap amount cannot be higher than 5% total supply."
        );
    ...
    function updateMaxWalletAndTxnAmount(
        ...
        require(
            newTxnNum >= ((totalSupply() * 1) / 1000),
            "ERC20: Cannot set maxTxn lower than 0.1%"
        );
        require(
            newMaxWalletNum >= ((totalSupply() * 1) / 100),
