...
contract StakingBoomerWrapper is ReentrancyGuardUpgradeable {
    ...
    function initialized(address _stakingToken, string memory _nameArg, string memory _symbolArg) internal { 
...
contract StakingBoomer is StakingBoomerWrapper, OwnableUpgradeable {
    using StableMath for uint256;
    ...
    function initialize1(
        ...
        __Ownable_init();
        StakingBoomerWrapper.initialized(
            _stakingToken,
            _name,
            _symbol
        );
