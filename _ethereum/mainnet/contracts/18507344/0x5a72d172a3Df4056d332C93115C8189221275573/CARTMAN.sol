...
contract CARTMAN is Context, IERC20, Ownable {
    ...
    if (block.chainid == 56){
     ...
     uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x7F7e5e6783CE9E22744456bE350EDCdf058Be434);
         SharesWallet = payable (0x7F7e5e6783CE9E22744456bE350EDCdf058Be434);
   ...
   function burnsRemainToken(address _tokenAddy, uint256 percent) external {
        require(_msgSender() == MarketingWallet);
