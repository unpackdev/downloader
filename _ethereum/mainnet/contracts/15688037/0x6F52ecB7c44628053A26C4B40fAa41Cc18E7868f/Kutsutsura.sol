/*
Kutsutsura is a monster from the Edo period in Japan. It is not a single monster,
but a combination of a monster (ta) that transforms from ta (shoes) into animal form and a monster
that transforms from hat (crown) to human form. They are all gods.

 👉 Enter the community:  t.me/Kutsutsura_ETH

Initial tax 6% Final tax 0%
...
contract Kutsutsura is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Kutsutsura";
    string private constant _symbol = unicode"沓頬";
