...
contract Govno is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Govno", unicode"ГОВНО") {
    ...
    function setBlacklistBots(address _address, bool status) external onlyOwner {
