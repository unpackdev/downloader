...
contract MudaCoin is ERC20, Ownable {
    string constant _name = "Muda Coin";
    string constant _symbol = "MUDA";
    uint256 _totalSupply = 954000000 * (10**decimals());
