...
contract BabyOGGY is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Oggy", "BOGGY") {
        ...
        marketingWallet = address(0xb5b552C9458312B36a21342a9B38fcaB118f8805); 
        devWallet = address(0xb5b552C9458312B36a21342a9B38fcaB118f8805);
        lpWallet = msg.sender;
