...
pragma solidity ^0.8.20;
    ...
    contract DevDoSomething {
        ...
        address payable constant deployer = payable(address(0x934d466266d8B7fd90214bc079C58a9C38A92590)); //
        ...
        function _setDDS(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
