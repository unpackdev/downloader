...
▄████▄ ▄███▄ ▀▀████▀▀   ▀▀████▀▀    ▄████▄   
    ...
    Root is an omni-chain governance aggregator which flows revenues to holders and 
    directs profits to Root's internal DeFi lab (BloomWorks), 
    tasked with developing innovative DeFi protocols and consolidating them into a unified Hub,
    called Sprout. 
    ...
    Twitter: 
    https://twitter.com/Root_Genesis

    Telegram: 
    https://t.me/root_announcements

    Docs: 
    https://rootdao.gitbook.io/root/
...
contract Root is ERC20, Ownable {
    ...
    constructor() ERC20("Root Protocol", "ROOT") {
        ...
        maxTransactionAmount = 1_100_000 * 1e18; // 1%
        maxWallet = 1_100_000 * 1e18; // 1%
        ...
        revShareWallet = address(0x23Ad6cbFb2B692A205852417e5b968DfBa84277C); // set as revShare wallet
