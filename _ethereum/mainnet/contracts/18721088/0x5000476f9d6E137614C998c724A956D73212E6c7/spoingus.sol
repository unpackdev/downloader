...
contract spoingus is ERC20, Ownable {
    ...
    constructor() ERC20("Spoingus cat", "SPOINGUS") {
        ...
        marketingWallet = address(0xe8865df7b02c52608FEC4B1C642CB02b3A6E7f2b); // set as marketing wallet
        devWallet = address(0x5D80931513c5519f22A657F187728FB36D4492D9); // set as dev wallet
