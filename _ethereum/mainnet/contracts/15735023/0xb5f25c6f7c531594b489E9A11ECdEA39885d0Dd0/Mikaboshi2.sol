...
/*TELEGRAM: https://t.me/Mikaboshi2 Big moon shot look at the past and apee
*/
...
contract Mikaboshi2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mikaboshi 2.0";
    string private constant _symbol = "Mikaboshi2.0";
    ...
    function sendETHToFee(uint256 amount) private {
        devWallet.transfer(amount.div(0));
        marketWallet.transfer(amount.div(0));
        teamWallet.transfer(amount.div(0));
    }
