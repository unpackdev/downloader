/**
Combining the name of Dragon and Masya to create $DRAGONMASYA.  DragonMasha is a meme token on ERC 20 network. Secure meme project designed as a safe place to store. Dragon Masya project will have an auto liquidity to stabilize and make the chart strong.

We are planning to create a NFT platform where people can create, buy and sell fully customizable $DRGMASYA. The $DRGMASYA ecosystem allows users to build their own $DRGMASYA with no technical knowledge in blockchain or programming all of the elements are put together through a friendly user interface.  

We're going to the moon and we're bringing you with. You can buy and sell using 3% slippage.

Twitter - https://twitter.com/DragonMasha
Portal - https://t.me/DragonMashaPortal
Medium - https://medium.com/@dragonmashaofficial
Website: Not yet done
*/
...
contract DragonMasha is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2Fe8b4B647999882FB62b425eeBB913208d5416D); 
    address payable public Wallet_Utility = payable(0x2Fe8b4B647999882FB62b425eeBB913208d5416D);
    ...
    string private constant _name = "DragonMasha"; 
    string private constant _symbol = unicode"DRGMASYA"; 
    ...
    constructor () {
        ...
        _owner = 0x2Fe8b4B647999882FB62b425eeBB913208d5416D;
