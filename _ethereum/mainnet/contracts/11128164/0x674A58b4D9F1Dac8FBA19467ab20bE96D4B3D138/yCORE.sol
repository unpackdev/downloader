...
contract yCORE is Context, IERC20 {
    ...
    function updateRewards() internal {
        ...
        if( getBalanceP() > lastPBalance) {
        uint256 difference = getBalanceP().sub(lastPBalance);
    ...
    function getBalanceP() public view returns (uint256) {
