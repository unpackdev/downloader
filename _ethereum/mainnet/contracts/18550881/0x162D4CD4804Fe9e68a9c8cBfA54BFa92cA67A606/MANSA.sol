...
contract MANSA is ERC20, Ownable {
    ...
    constructor () ERC20("Mansa Musa Gold", "MANSA") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + feeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + feeOnSell;

        feeWallet = 0xb0ae44dEC3C4FB8f4bDbd77bf50fb8eF7c8De2Cf;
    ...
    function changeFeeWallet(address _feeWallet) external onlyOwner{
        require(_feeWallet != feeWallet,"Fee wallet is already that address");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            uint256 feeShare = feeOnBuy + feeOnSell;
            ...
            if (feeShare > 0) {
                uint256 feeTokens = contractTokenBalance * feeShare / totalFee;
