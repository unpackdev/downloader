...
/**
 * Total BTCE: 1000
 * 10% of the total number of mainnet tokens
 * The mainnet is expected to go live on December 30, 2020
 */
...
contract BTCE is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "BTCE";
string constant tokenSymbol = "BTCE";
