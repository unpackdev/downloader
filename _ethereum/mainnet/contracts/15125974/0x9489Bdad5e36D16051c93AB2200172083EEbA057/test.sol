 ...
 */
contract MitchellsExtension is AdminControl, CreatorExtension, ICreatorExtensionTokenURI, IManifoldERC721Edition {
    ...
    function tokenHash(address creator, uint256 series, uint256 tokenId) public view returns (bytes32){
        ...
        return bytes32(keccak256(abi.encodePacked(address(creator), _creationDates[creator][series][tokenId], _creators[creator][series][tokenId], tokenId)));
    }
