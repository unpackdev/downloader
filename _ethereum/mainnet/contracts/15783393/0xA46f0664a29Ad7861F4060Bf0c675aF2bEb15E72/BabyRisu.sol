...
contract BabyRisu is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Risu", "Baby Risu") {
		...
		charityWallet = address(0x6c5FeB3a92b448c61bcc2389705c7418c4ee67E1); // set as charity wallet
        marketingWallet = address(0x6c5FeB3a92b448c61bcc2389705c7418c4ee67E1); // set as marketing wallet
        devWallet = address(0x6c5FeB3a92b448c61bcc2389705c7418c4ee67E1); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 12, "Max SellFee 12%");
