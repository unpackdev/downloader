...
/**
 *  Telegram: https://t.me/XChainTG
 *  Twitter: https://twitter.com/XChain_X
 *  Website: https://x-chain.app/
 */
...
contract XCHAIN is IERC20, Auth {
    ...
    string private constant  _name = unicode"𝕏 CHAIN";
    string private constant _symbol = unicode"𝕏CHAIN";
    ...
    address payable public marketingWallet = payable(0x0C735Dd317fd43620F8fa62d361Be40A7F595663);
    ...
    uint256 public numTokensSellToAddToLiquidity = _totalSupply * 10 / 10000; // 0.1% swap wallet
    ...
    function setFee (uint256 _sellFeeRate, uint256 _buyFeeRate) external onlyOwner {
        require (_buyFeeRate <= 3, "Fee can't exceed 3%");
        require (_sellFeeRate <= 3, "Fee can't exceed 3%");
