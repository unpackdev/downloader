// File: THEDIEProtocol.sol


//https://t.me/THEDIEPORTAL
...
contract THEDIEProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THE DIE Protocol", "THEDIE") {
        ...
        devOpsWallet = address(0xBaE5ec63C8d634DE89a01810b500Bfd52a8109FC); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xBaE5ec63C8d634DE89a01810b500Bfd52a8109FC), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xBaE5ec63C8d634DE89a01810b500Bfd52a8109FC), true);
