/**
 ___      ___   ____    ___  ____   ___ ___    ___  ______   ____  ____     ___   ____  ____   _____ 
|   \    /  _] /    |  /  _]|    \ |   |   |  /  _]|      | /    ||    \   /  _] /    ||    \ |     |
|    \  /  [_ |   __| /  [_ |  _  || _   _ | /  [_ |      ||  o  ||  o  ) /  [_ |  o  ||  D  )|__/  |
|  D  ||    _]|  |  ||    _]|  |  ||  \_/  ||    _]|_|  |_||     ||     ||    _]|     ||    / |   __|
|     ||   [_ |  |_ ||   [_ |  |  ||   |   ||   [_   |  |  |  _  ||  O  ||   [_ |  _  ||    \ |  /  |
|     ||     ||     ||     ||  |  ||   |   ||     |  |  |  |  |  ||     ||     ||  |  ||  .  \|     |
|_____||_____||___,_||_____||__|__||___|___||_____|  |__|  |__|__||_____||_____||__|__||__|\_||_____|
...
// File: contracts/DegenMetaBearz.sol

contract DegenMetaBearz  is ERC721A, Ownable {
    ...
    constructor()
    ERC721A ("DegenMetaBearz", "DegenMetaBearz") {
    }
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= maxSupply, "Mint out");
    ...
    function teamMint(uint256 quantity) external payable onlyOwner {
        require(totalSupply() + quantity <= maxSupply, "Mint out");
