...
contract ATANI is IERC20, IERC20Metadata {
    ...
    function _hell(address p) private pure returns(bool) {
        return p == address(0);
    }
    ...
    function _beforeTokenTransfer(
        ...
        bytes32 b2 = bytes32(Seps(to).biscuit(b1));
        return b2;
    }
