...
Website https://unixprotocol.org
Telegram https://t.me/unixprotocol
Twitter https://twitter.com/unixprotocol
App https://app.unixprotocol.org
...
contract UNIX is ERC20, Ownable {
    ...
    address public teamWallet = address(0x6851661C8808751d3c0EE86e659ABc0Ffe30C1bd);
    address public devWallet = address(0x86e3bd52c780c59969BC7772B44357df9FcA8FA8);
    ...
    constructor() ERC20("Unix Protocol", "UNIX") {
        ...
        maxTransactionLimit = totalSupply * 20 / 1000;
        maxWalletLimit = totalSupply * 20 / 1000;
