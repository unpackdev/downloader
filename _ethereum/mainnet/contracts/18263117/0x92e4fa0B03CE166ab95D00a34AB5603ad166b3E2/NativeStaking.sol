...
// File contracts/utils/Utilities.sol
...
// File contracts/NativeStaking.sol

pragma solidity ^0.8.10;

contract NativeStaking is Ownable, ReentrancyGuard, PriceCalculator {
    ...
    constructor(
        ...
        tierStartBlance[uint256(Tier.PLATINUM)] = 800_000_000 * 1e18;
    }
