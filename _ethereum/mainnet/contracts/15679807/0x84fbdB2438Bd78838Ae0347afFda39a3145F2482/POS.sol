...
contract POS is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "https://ipfs.io/ipfs/QmdQD1MWcFqFUy6XVdff49uNNFmCpJhPmhVfrVLr9osaFP";
  ...
  ) ERC721A("The Pets Of Steampunk", "POS") {
