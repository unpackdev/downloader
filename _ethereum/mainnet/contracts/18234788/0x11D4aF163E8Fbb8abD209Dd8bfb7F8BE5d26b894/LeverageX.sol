...
contract LeverageX is ERC20, Ownable {
    ...
    constructor() ERC20("LeverageX", "LRX") payable {
        ...
        uint256 totalSupply = 2000000 * 1e5 * 1e18;
    	...
    	marketingWallet = address(0x4393fa56525298b0ae48a4B8b991B461F00477F5); // set as Marketing wallet
        devWallet = address(0xF3Bbbde49d39C449b582286dB20876d04C8D05D9); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x4393fa56525298b0ae48a4B8b991B461F00477F5, true);
        excludeFromFees(0xF3Bbbde49d39C449b582286dB20876d04C8D05D9, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x4393fa56525298b0ae48a4B8b991B461F00477F5, true);
        excludeFromMaxTransaction(0xF3Bbbde49d39C449b582286dB20876d04C8D05D9, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xF3Bbbde49d39C449b582286dB20876d04C8D05D9,
            block.timestamp
        );
    }
