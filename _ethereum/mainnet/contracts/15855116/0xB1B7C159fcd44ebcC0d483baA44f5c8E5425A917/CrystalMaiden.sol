...
// Main Contract Logic 
// --------------------------------------------------------------
contract CrystalMaiden is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Crystal Maiden";
    string private _symbol = "Maiden";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x5FB3fac6B62da1A009A5b95Ea21faC205cd2FffF);
    address payable public operationsWallet =  payable(0x5FB3fac6B62da1A009A5b95Ea21faC205cd2FffF);
