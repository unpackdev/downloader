...
Im going to make them an offer they can't refuse. I am the X Father of all the shitcoins. Hold your bags and whatever you do dont forget the cannolis.

Links:
🐦 twitter.com/thexfather_erc
👨🏻‍💻 thexfather.xyz
...
contract XFATHER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"THE X FATHER";
    string private constant _symbol = unicode"XFTHR";
