...
contract LockShare is ERC20, Ownable {
    address public treasury;
    uint256 public taxPercentage; // The tax percentage, e.g., 5 for 5% tax

    constructor(uint256 _taxPercentage) ERC20("LockShare", "LST") {
    ...
    function _transfer(
        ...
        if (
            taxPercentage > 0 && sender != address(0) && recipient != address(0)
        ) {
