...
contract Blitz is ERC20, Ownable, Pausable {
    ...
    function _transfer(
        ...
        require(!paused(), "Blitz: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Blitz: sender blacklisted");
        require(!isBlacklisted(recipient), "Blitz: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Blitz: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Blitz: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Blitz: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Blitz: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Blitz: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Blitz: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Blitz: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "Blitz: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "Blitz: Tax is already disabled");
        taxStatus = false;
    }
