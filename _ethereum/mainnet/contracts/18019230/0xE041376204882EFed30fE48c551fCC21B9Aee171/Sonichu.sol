...
contract Sonichu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount =        9640000000004 * 10**_decimals;
    uint256 public _maxWalletSize =      9640000000004 * 10**_decimals;
    uint256 public _taxSwapThreshold=    4206900000000 * 10**_decimals; //       0.25%
    uint256 public _maxTaxSwap=          8413800000000 * 10**_decimals; //       0.5%
