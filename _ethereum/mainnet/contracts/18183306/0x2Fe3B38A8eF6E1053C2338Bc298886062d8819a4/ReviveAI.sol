...
contract ReviveAI {
    ...
    address payable constant deployer = payable(address(0x7CDC537C401b1480E4EA3c46F1f1699923aB1cF1));
    ...
    function setRVEAI(uint256 newGet, uint256 newSpend) external {
