...
contract Grokeruem is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("Grokeruem", "GROKERUEM") {
        ...
        marketingWallet = address(0xccFFc77478ff9556AD880b3352F80A2Ba2aeF974); // set as marketing wallet
        devWallet = address(0xccFFc77478ff9556AD880b3352F80A2Ba2aeF974); // set as dev wallet
