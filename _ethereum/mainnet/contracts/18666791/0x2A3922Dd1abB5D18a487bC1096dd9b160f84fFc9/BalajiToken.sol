...
contract BalajiToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    IBalajiStaking public stakingContract;
    ...
    function setStakingContract(IBalajiStaking stakingContract_) public onlyOwner {
