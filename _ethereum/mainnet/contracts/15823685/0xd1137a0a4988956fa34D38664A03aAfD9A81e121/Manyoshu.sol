...
contract Manyoshu is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Man'yōshū ", unicode"Yōshū") {
		...
		charityWallet = address(0xbd84cD1D9f28C8724C51A7eBF78Da8Cd27D13eB5); // set as charity wallet
        marketingWallet = address(0xbd84cD1D9f28C8724C51A7eBF78Da8Cd27D13eB5); // set as marketing wallet
        devWallet = address(0x5dE313a98f60c5F0B4661164dC1ee897812bbd99); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 100, "Max BuyFee 8%");
