...
/*
Welcome to Mount MEMEmore🗿

Mount MEMEmore is a hilarious internet phenomenon that has taken the meme world by storm. This meme features the iconic Mount Rushmore structure in the United States, but with a hilarious twist - the faces of popular internet and pop culture icons are superimposed over the original sculptures. The result is a completely different take on one of America's most recognizable landmarks. 

The only meme to combine them all into one iconic project representing all of the biggest meme’s we’ve known! 

Mount MEMEmore is an excellent example of the power of memes to bring people together through humor, laughter, and shared experiences.
Website: https://mountmememore.com/
Telegram: https://t.me/MountMememoreETH
...
contract MountMEMEmore is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"PepeBitcoinMountMemeMore999inu";
