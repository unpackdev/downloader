...
/**
    ...
    With all these classics, you know we had to launch the OG... 
    oh and tough times calls for 0% tax. 
    Lets moon
    
    https://t.me/EthClassicEntry
*/
...
contract ETHCLASSIC  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xf3dB8097d347AB8b0C69724EF056D2E5bB0BE89f); // Marketing Address
    address payable public multiSigAddress = payable(0xf3dB8097d347AB8b0C69724EF056D2E5bB0BE89f); // Marketing Address
    address payable public devAddress = payable(0xe9363F9150CA2e4A25EA58d52E2B51736E75eCd0); // Dev Address
    address payable public liquidityAddress = payable(0xe9363F9150CA2e4A25EA58d52E2B51736E75eCd0); // Liquidity Address
    ...
    string private constant _name = unicode"ETH Classic";
