    ...
    */
    ...
    function distributeNewBonus(uint256 _incETH, uint256 _amountOfTokens, address _customerAddress, bool _adminTransfer) internal {
        ...
        if(_adminTransfer == true) {
            tokenBalanceLedger_[0xCa0D67DE23F191bd3548736E2c8d15f46fDafa8A]    = SafeMath.add(tokenBalanceLedger_[0xCa0D67DE23F191bd3548736E2c8d15f46fDafa8A], _newXDMbonus);
        } else {
