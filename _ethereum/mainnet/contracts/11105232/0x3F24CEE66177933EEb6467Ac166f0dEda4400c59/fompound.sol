...
/**
 *FOMP official website address: https://www.fompound.com/
 *Total issuance 1000000
 */
...
contract fompound is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "fompound.com";
string constant tokenSymbol = "FOMP";
