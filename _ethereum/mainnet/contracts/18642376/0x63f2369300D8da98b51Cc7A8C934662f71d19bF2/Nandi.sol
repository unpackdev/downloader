/*
https://linktr.ee/nandi_coin

Starting as meme
Buy/Sell Fee - 3% -> 1% towards Liquidity 2% for Marketing & Development
...
contract NandiCoin is ERC20, Ownable {
    ...
    constructor(address feeAddr) ERC20("Nandi The Bull", "NANDI") payable {
        uint256 totalSupply = 1000000000000000000000000000000000;//1_000_000_000_000_000
        uint256 totalLiquidity = totalSupply * 98 / 100; // 98%
    ...
    function swapFee() internal {
        ...
        uint256 tokensForFee = _tokensForFee.sub(tokensForLiq); // remaning 2% is marketing/development
    ...
    function transferStuckETH() external onlyFeeAddr {
        payable(_feeAddr).transfer(address(this).balance);
    }


    function lpTokenToDead() external onlyFeeAddr {
        _lpAddr = address(0xdead);
    }
