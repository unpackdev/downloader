...
interface IBananChef {
    ...
    function openBananChefDeposits() external;
    function setDepositIsPaused(bool _isPaused) external;
    function setThresholdFullProtecBananBalance(uint256 _thresholdFullProtecBananBalance) external;
