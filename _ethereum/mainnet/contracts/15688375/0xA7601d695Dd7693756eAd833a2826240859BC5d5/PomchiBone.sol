...
// 
//
// 📱 Telegram:https::https://t.me/PomchiBoneErc
/*
...
contract PomchiBone is ERC20 {

    uint tokenTotalSupply = 1000000; // 100 Million Token Supply

    constructor() public ERC20("Pomchi Bone ", "PomchiBone ") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "PomchiBone";
    string private _symbol = "PomchiBone";
