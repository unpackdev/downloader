...
//            `------' \  
//             _/       `--...
//  Let's clean up the mess in DEFI world.  
//  Community-driven. Ethical Team. Huge work.
//  For monkey, made by monkey.

// https://twitter.com/ape_starter
// https://apestarter.site
// https://t.me/apestarter
...
contract APE is ERC20, Ownable {
    ...
    constructor () ERC20("APE starter", "APE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xC92f4BAA47f62abcB99806F036E8d11cd49b012F;
