...
contract Tip2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TIP 2.0";
    string private constant _symbol = unicode"TIP2.0";
