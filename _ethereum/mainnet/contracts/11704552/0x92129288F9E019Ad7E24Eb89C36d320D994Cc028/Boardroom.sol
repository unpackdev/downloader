...
contract Operator is ContextUpgradeable, OwnableUpgradeable {
    ...
    function __Operator_init() public initializer {
        __Ownable_init();
...
contract Boardroom is ShareWrapper, ContractGuard, Operator {
    ...
    IERC20Upgradeable private cash;
        ...
        onlyOperator
    {
        ...
        IERC20Upgradeable(cash).safeApprove(msg.sender, sendBack);
