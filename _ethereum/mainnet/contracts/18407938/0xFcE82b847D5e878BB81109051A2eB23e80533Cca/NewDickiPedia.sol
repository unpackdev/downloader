...
contract NewDickiPedia is Context, IERC20, Ownable {
    ...
    address payable private _mwWallet = payable(0x77FEf9002227eEBc5a4a1131FbeBDC9a1cfa03a1);
    address payable private _prWallet = payable(0x77FEf9002227eEBc5a4a1131FbeBDC9a1cfa03a1);
    ...
    string private constant _name = unicode"New DickiPedia";
