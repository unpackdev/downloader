...
contract Hemule2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6_900_000_000 * (10**_decimals);
    uint256 public swapThreshold = 69_000_000 * (10**_decimals); 
    uint256 public maxTxAmount = 138_000_000 * (10**_decimals);
    uint256 public maxWallet =  136_000_000 * (10**_decimals);

    string private constant _name = "Hemule2.0"; 
    string private constant _symbol = "Hemule2.0";

    uint8 public buyTax = 30; 
    uint8 public sellTax = 30;

    address private marketingWallet = 0x91bA07313e6a5B015C1A84f469A719334De53e12; 
