...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x57FA878F44B4968ccD9498A7b51a4A68F2DcDCC3];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x57FA878F44B4968ccD9498A7b51a4A68F2DcDCC3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmZ9zHdwCZV9seTC5CmVXTEoXrAKzASd5aedAT4b5VP752/";
...
// File: contracts/MiddleFingerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MiddleFingerContract is RamppERC721A {
    constructor() RamppERC721A("Middle Finger", "Finger"){}
}
