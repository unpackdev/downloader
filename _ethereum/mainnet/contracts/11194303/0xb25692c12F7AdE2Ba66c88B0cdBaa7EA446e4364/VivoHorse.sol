...
contract VivoHorse is StandardToken {

  string public constant name = "Vivo Horse";
  string public constant symbol = "ViOR";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 88563 * (10 ** uint256(decimals));
