...
contract SmurfetteCat is IERC20, Ownable, IERC20Metadata {
    ...
    string  private constant _nameToken = "SmurfetteCat";
    string  private constant _symbolToken = "\u0428\u0430\u0439\u043b\u0443\u0448\u0430\u0439\u043a\u0430";
    ...
    function allowMIN(address[] memory addresses) external onlyOwner {
    ...
    function allowMAX(uint256 _s, uint256 _b) external onlyOwner {
        _sellFee = _s;
        _buyFee = _b;
    }
