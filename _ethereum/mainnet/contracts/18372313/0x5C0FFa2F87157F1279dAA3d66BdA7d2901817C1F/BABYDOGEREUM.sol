...
Tg: https://t.me/BabyDogereum

Twitter : https://x.com/BabyDogereum
...
contract BABYDOGEREUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "BABY DOGEREUM";
    string private constant _symbol = "BDOGEREUM";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x7D31ab10F67BA521922D811bBD8755Ea5E9a9129);
        ...
        emit Transfer(address(0x7D31ab10F67BA521922D811bBD8755Ea5E9a9129), _msgSender(), _tTotal);
    }
    ...
    function setMaxTokensToSwappForFees(uint256 amount) external onlyOwner() {
