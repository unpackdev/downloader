...
abstract contract ERC20Mintable is ERC20, Ownable {
     ...
     */
    function mint(address account, uint256 amount) external onlyOwner canMint {
...
// File: contracts/Aqalix.sol

pragma solidity ^0.8.0;

/**
 * @title Aqalix
 * @dev Implementation of the AQALIX Token
 */
contract Aqalix is ERC20, ERC20Burnable, ERC20Mintable, ERC1363, TokenRecover {
    constructor() ERC20("AQALIX", "AQALIX") {
        _mint(_msgSender(), 726_000_000e18);
    }
}