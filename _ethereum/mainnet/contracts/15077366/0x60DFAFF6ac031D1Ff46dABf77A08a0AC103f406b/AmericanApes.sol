...
contract AmericanApes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTcLS9TVyWnQZBL34GtFZbpB7YaaKryhiQiG9giSdc5KB";
    ...
    constructor(
    ) ERC721A("American Apes", "AMERICAN", 100, maxSupply) {
    }
