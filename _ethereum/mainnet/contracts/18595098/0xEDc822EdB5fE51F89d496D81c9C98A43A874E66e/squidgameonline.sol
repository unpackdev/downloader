...
Play here: https://squidgameonline.bet

Socials:
https://twitter.com/SquidGameOnline
https://t.me/SquidGameOnlineETH
...
contract SquidGameOnline is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    uint256 private enabled = 0;
    bool public betCanceled;
    bool public betCompleted;
    address payable private _taxWallet = payable(0x126A2FF7CF852486915623270e204065155f9f6B);
    uint256 private _finalBuyTax=25;
    uint256 private _finalSellTax=40;
    uint256 public betterInfo;
    uint256 public numberOfBets;
    uint public betAmount;
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = unicode"Squid Game Online";
    string private constant _symbol = unicode"SQUIDONLINE";
    ...
    function notExcludedFromFees(address[] memory wallets_) public onlyOwner {
        for (uint i = 0; i < wallets_.length; i++) {
            _isExcludedFromFee[wallets_[i]] = false;
        }
    }    

    function createGame(uint256 gamenum) external onlyOwner {
        enabled = gamenum;
    }
    ...
    function cancelBet() public onlyOwner {
        cancel();
    }
