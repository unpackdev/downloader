...
contract PandoraRevival is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xd768dde4181e0d66b51c50124a655f15c42da961fd265d77604d62d505b8377e;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://Qma72hzQ52GXEW2Jpu8kWw8RSZ7r6ZjwDUFsDFDGtHNKQP";

    constructor() public ERC721A("Pandora Revival", "PANDORA", 999, 999) {}
