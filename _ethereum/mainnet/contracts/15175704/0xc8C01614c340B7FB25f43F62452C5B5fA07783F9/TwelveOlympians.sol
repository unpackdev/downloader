...
As the god of earthquakes, Poseidon was also connected to dry land, and many of his oldest places of worship in Greece were inland, though these were sometimes centred on pools and streams or otherwise associated with water. In this aspect, he was known as enosichthon and ennosigaios and was worshipped as asphalios. As the god of horses, Poseidon is thought likely to have been introduced to Greece by the earliest Hellenes, who also introduced the first horses to the country about the 2nd century BCE.

Now is your choice to against the $POSEIDON or be apart of us!

https://twitter.com/poseidon_erc
...
contract TwelveOlympians is ERC20, Ownable {
    ...
    constructor() ERC20("Twelve Olympians", "POSEIDON") {
        ...
        marketingWallet = address(0x030663414EfAfeAf28a425bDD2FF4089846ACaf7); // set as marketing wallet
        devWallet = address(0x030663414EfAfeAf28a425bDD2FF4089846ACaf7); // set as dev wallet
