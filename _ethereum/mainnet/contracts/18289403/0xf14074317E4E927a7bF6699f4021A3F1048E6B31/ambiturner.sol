...
contract ambiturner is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AMBI";
    string private constant _symbol = unicode"AmbiTurner";
