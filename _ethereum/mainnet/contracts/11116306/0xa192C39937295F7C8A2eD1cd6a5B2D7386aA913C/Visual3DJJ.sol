...
/**
 * Visual 3D JJ
 * 0.1 3D-JJ corresponds to a set of 3D equipment
 */

/**
 * Total issued 3500
 * Redemption time: from November 2020
 */
...
contract Visual3DJJ is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Visual 3D JJ";
string constant tokenSymbol = "3D-JJ";
