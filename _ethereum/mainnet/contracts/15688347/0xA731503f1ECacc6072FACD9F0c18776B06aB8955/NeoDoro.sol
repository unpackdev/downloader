...
contract NeoDoro  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Neodoro Inu";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 taxFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnSell) external onlyOwner {
        ...
        require((_redisFeeOnBuy + _taxFeeOnBuy) <= 12, "Must keep fees at 6% or less");
