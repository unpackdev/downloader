...
Join Our APEgram : https://t.me/theperfectape
...
contract ThePerfectApe is ERC20Detailed{

using SafeMath for uint256;
mapping (address => uint256) public _outputTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "t.me/theperfectape";
string constant tokenSymbol = "PERFECTAPE";
