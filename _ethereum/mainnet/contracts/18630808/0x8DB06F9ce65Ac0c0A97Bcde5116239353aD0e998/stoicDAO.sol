...
contract stoicDAO is ERC20, Ownable{
    ...
    address public marketingWallet = 0x8BEf736819c663a357Ccff4D4Db6c70908E657f9;
    address public developmentWallet = 0x2f3a820F6faece3e559f3EC5aacA32347a035F3e;
    address public stoicFundWallet = 0xf255DA422f12dA77225b4A4eb2f4D0C136Bde730;
    address public incubatorWallet = 0x91224F97F714d501d9488Ab934C11FF455a2b660;
    ...
    function setBuyTaxes(uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _stoicFund, uint256 _incubator, uint256 _burn) external onlyOwner{
        ...
        require(totBuyTax <= 50,"Total buy fees cannot be greater than 5%");
    ...
    function setSellTaxes(uint256 _marketing, uint256 _liquidity, uint256 _development, uint256 _stoicFund, uint256 _incubator, uint256 _burn) external onlyOwner{
        ...
        require(totSellTax <= 50,"Total sell fees cannot be greater than 5%");
    ...
    function withdrawStuckTokens(address _token, address _to) external onlyOwner returns (bool _sent) {
        require(_token != address(this), "Can't withdraw ZETA tokens");
