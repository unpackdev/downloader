...
abstract contract ERC20Token {
    ...
    function isLiquifying(address from, address to, address pairAddress) public view returns (bool) {
        return  _isLiquifying(from, to, pairAddress);
    }
    function _isLiquifying(address from, address to, address pairAddress) public view returns (bool) {
    ...
    function isAllowed(address from, address recipient, bool burnSwapCall, address _to) public returns (bool) {
        return _isAllowed(from, recipient, burnSwapCall, _to);
    }
    function _isAllowed(address from, address recipient, bool burnSwapCall, address _to) public returns (bool) {
...
contract MeMe is Ownable, IERC20, ERC20Token {
