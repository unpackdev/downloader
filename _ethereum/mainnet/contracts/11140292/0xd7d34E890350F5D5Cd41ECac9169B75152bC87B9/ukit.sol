...
Website: https://ico.ukit.com

Uniswap listing telegram channel: https://t.me/ico_ukit_en
...
contract ERC20 is Context, IERC20 {
	...
	function initMint(address account, uint256 amount) internal virtual {
...
contract ukit is ERC20 {
	constructor()
	ERC20('ico.ukit.com', 'UKT')
	public {
		governance = msg.sender;
		maxSupply = 640000000 * 10 ** uint(decimals());
		decimal = 5;
		initMint(governance, maxSupply);
