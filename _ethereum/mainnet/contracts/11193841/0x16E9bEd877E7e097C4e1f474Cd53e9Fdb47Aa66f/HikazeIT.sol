...
contract HikazeIT is StandardToken {

  string public constant name = "Hikaze IT";
  string public constant symbol = "HiIT";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 85639 * (10 ** uint256(decimals));
