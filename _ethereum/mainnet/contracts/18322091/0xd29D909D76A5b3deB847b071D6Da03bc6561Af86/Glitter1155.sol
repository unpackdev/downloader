...
// File: contracts/Glitter1155.sol
...
/**
 * @title Glitter
 * @dev Glitter is a smart contract for managing NFT (Non-Fungible Token) collections, auctions, and minting.
 * It inherits from various OpenZeppelin contracts to leverage their functionalities.
 */

contract Glitter1155 is
    Initializable,
    UUPSUpgradeable,
    OwnableUpgradeable,
    ERC1155Upgradeable
{
    ...
    function initialize() public initializer {
        ...
        baseURI = "ipfs://bafybeibr6cdykqyihyomtbfwt7gn6ioofp5wh2yfxmxndp7u5bioqeqrgu/";
        __ERC1155_init(baseURI);
        name = "All That Glitters";
        symbol = "ATG";

        for (uint256 i = 0; i < 15; i++) {
            _mint(_msgSender(), i, 500, "");
        }
    }

    /**
     * @dev Function to authorize contract upgrades, only callable by the owner
    ...
    /**
     * @dev Function to check if a contract supports a specific interface
