...
contract ChainlinkPriceOracle is BasePriceOracle, IChainlinkPriceOracle {
    ...
    function getPriceOracleResponseFlags() external view override returns (PriceOracleResponse memory) {
        ChainlinkResponse memory chainlinkResponse = _getCurrentChainlinkResponse();
        ChainlinkResponse memory prevChainlinkResponse =
            _getPrevChainlinkResponse(chainlinkResponse.roundId, chainlinkResponse.decimals);
        ...
        return (PriceOracleResponse(false, _chainlinkPriceChangeAboveMax(chainlinkResponse, prevChainlinkResponse), 0));
    }
