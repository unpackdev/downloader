...
contract santalfg is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Santa LFG";
    string private constant _symbol = unicode"SLFG";
