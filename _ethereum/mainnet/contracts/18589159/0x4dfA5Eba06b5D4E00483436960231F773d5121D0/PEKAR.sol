...
contract PEKAR is Context, IERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 699_999_999_999 * 10 ** _decimals;
    ...
    uint256 public maxAmountPerTx = onePercent * 1;
    uint256 public maxAmountPerWallet = onePercent * 5;
    ...
    constructor() {
        taxWallet = payable(0xC824f55F79DC80d84b4552023D919D4444444444);
        ...
        _balance[_msgSender()] = onePercent * 3;   // 3% contract creator wallet 
        _balance[address(this)] = onePercent * 97;  // 97%

        emit Transfer(address(0), _msgSender(), onePercent * 3);
        emit Transfer(address(0), address(this), onePercent * 97);
    }
    ...
    function openTrade(
        ...
        require(!swapEnabled, "PEKAR is already enabled for trading");
