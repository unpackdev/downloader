...
*/
 ...
 // Website: https://duckyeth.net
 // X: https://twitter.com/DuckyaiX
 // TG: https://t.me/duckyai
 //
 // Go Duck Yourself!
 // 
 // Elon love Ducks 
 // https://twitter.com/elonmusk/status/1730643930289459235
 // https://twitter.com/elonmusk/status/1510435828841000960
 // Contract forked from Bitrock Token (https://coinmarketcap.com/currencies/bitrock/) (https://etherscan.io/token/0xde67d97b8770dc98c746a3fc0093c538666eb493)
...
contract Duckyai is Context , IERC20, Ownable {
    ...
    uint256 private _reduceBuyTaxAt=210;
    uint256 private _reduceSellTaxAt=210;
    uint256 private _preventSwapBefore=10;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 6942000000000 * 10**_decimals; // 6,942 trillion max supply
    string private constant _name = "DUCKY" ;
    string private constant _symbol = "DUCKY" ;
    uint256 public _maxTxAmount = 138840000000 * 9**_decimals; // 2% of the supply
    uint256 public _maxWalletSize = 138840000000 * 9**_decimals; // 2% of the supply
    uint256 public _taxSwapThreshold= 6942000000 * 9**_decimals; // 0,1% of the supply
    uint256 public _maxTaxSwap= 69420000000 * 9**_decimals; // 1% of the supply
