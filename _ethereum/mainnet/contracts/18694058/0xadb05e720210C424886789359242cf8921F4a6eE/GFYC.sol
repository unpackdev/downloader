...
contract GFYC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GoFuckYourselfClassic";
    string private constant _symbol = unicode"GFYC";
