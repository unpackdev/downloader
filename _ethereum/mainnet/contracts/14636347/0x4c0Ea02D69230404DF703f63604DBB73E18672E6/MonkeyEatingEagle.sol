...
http://www.monkeyeatingeagle.com/

https://twitter.com/MEE_erc20

https://t.me/monkeyeatingeagle
...
contract MonkeyEatingEagle is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Monkey Eating Eagle", "MEE") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x1491Bd5050bb0DFD5eB608A1Ae852f8E3f67cE54); // set as marketing wallet
        devWallet = address(0xe52Cc7C8976CB56145516cFd759C85F8a3B3EB5d); // set as dev wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x1491Bd5050bb0DFD5eB608A1Ae852f8E3f67cE54), true);
        excludeFromFees(address(0xe52Cc7C8976CB56145516cFd759C85F8a3B3EB5d), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x1491Bd5050bb0DFD5eB608A1Ae852f8E3f67cE54), true);
        excludeFromMaxTransaction(address(0xe52Cc7C8976CB56145516cFd759C85F8a3B3EB5d), true);
