...
Our word is our bond. Broken promises often hurt the people we care about. 
But sometimes when we break our word the damages done to ourselves are far, far worse. And the only bond we’re left with is with death itself.

https://t.me/liccakayama

http://www.liccakayama.monster/

https://medium.com/@licca-chan
...
contract LiccaKayama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Licca Kayama", unicode"リカちゃん") {
