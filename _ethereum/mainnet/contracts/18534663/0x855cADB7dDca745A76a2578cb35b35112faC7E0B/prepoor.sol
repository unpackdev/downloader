...
contract PrePoor is Context, IERC20, Ownable {
    ...
    uint256 private _tax = 50;
    uint256 private constant _preventSwapBefore = 1;
    ...
    uint private secondLowering = 180 + 120;
    uint private thirdLowering = 180 + 120 + 120;
    ...
    function calculateCurrentTax() private view returns (uint256) {
        ...
        uint256 tax = 1;
        if (currentTimestamp > thirdLowering) {
            tax = 1;
