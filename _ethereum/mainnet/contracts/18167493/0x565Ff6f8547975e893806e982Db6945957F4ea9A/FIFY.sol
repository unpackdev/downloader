...
contract FIFY is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"FIFY";
    string private constant _symbol = unicode"FIFY";
    uint8 private constant _decimals = 9;

    uint256 private constant _Totalvy = 1000000000 * 10 **_decimals;
    ...
    constructor () {
        _qfmoburq = payable(0xD378B54194c057359D10d8b455f22504d4fA94E2);
