...
contract JIGGIESbyGETREEL33 is ERC1155PresetMinterPauser, Ownable, ERC2981 {

    string public name = "JIGGIESbyGETREEL33";
    string public symbol = "JIGGY";

    address receiver = 0x46bb5F8B393e3711C083269B3281be5aB2Ec0b6B;
    uint96 feeNumerator = 1000;

    string public contractUri = "https://metadata.getreel33.com/jiggies/contract.json";
