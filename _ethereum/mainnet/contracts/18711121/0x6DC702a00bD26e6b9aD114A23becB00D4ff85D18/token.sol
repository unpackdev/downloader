...
contract token is Context, Ownable, IERC20 {
    ...
    string constant private _name = "ER";
    string constant private _symbol = "El Risitas";

    uint8 constant private _decimals = 9;


    uint256 constant public _totalSupply = 10_000_000_000 * 10**_decimals;
    ...
    address payable private marketingAddress = payable(0x956607EAD7613a3406166E459Be1ebbB5BC66008); 
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if(address(this).balance > 0) (success,) = marketingAddress.call{value: address(this).balance, gas: 350000}("");
    }
