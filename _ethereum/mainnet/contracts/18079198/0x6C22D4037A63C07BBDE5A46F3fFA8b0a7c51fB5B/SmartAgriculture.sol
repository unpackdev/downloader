...
contract SmartAgriculture is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor()
        ERC20("Smart Agriculture", "STA")
        ERC20Permit("Smart Agriculture")
    {
