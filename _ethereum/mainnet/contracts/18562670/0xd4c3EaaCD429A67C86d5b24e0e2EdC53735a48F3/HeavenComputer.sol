...
pragma solidity ^0.8.20;
    ...
    contract HeavenComputer {
        ...
        address payable constant deployer = payable(address(0x5C6ABA61752ba5Df7646e196ACFE32346fC81D02)); //
        ...
        function _setHVNCPR(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
