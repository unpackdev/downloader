...
// Telegram: http://t.me/MinoTheTaur
// Twitter:  https://twitter.com/TheTaurunishere
...
contract MINOTHETAUR is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xc740Ec20be35620126E072EA1e1a347335A8791a); // Marketing Address
    ...
    uint256 public _walletMax = 100_000_000_000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10_000_000 * 10**_decimals;
    ...
    function setBuyTaxes(uint256 newMarketingTax) external onlyOwner() {
        require(newMarketingTax <= 100, 'Max fee is 100%');
