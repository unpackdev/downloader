...
import "./HolidaysLibrary.sol";
import "./DaylightSavingsCalendar.sol";
import "./DaylightSavingsLibrary.sol";
...
abstract contract TradingDays {
    uint256 public constant TRADING_START_HOUR = 9;
    uint256 public constant TRADING_END_HOUR = 14;
    ...
    function isCoreTradingHours() public view virtual returns (bool) {
        ...
        if (hour >= TRADING_START_HOUR && hour < TRADING_END_HOUR) return true;
        return false;
    }
