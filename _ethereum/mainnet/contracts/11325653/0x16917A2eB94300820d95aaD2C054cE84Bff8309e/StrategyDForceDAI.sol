...
contract StrategyDForceDAI {
    ...
    address constant public want = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);     // Dai Stablecoin (DAI) 
    
    address constant public d = address(0x02285AcaafEB533e03A7306C55EC031297df9224);		// dForce USDT (dUSDT)  dForce生息市场  = 收条代币
    address constant public pool = address(0xD2fA07cD6Cd4A5A96aa86BacfA6E50bB3aaDBA8B);      // https://markets.dforce.network/dapp  = (USDT) 挖矿矿池
    
    address constant public df = address(0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0);        // dForce (DF) = 平台代币
    address constant public output = address(0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0);     // dForce (DF) = 平台代币
    ...
    address constant public yfii = address(0xead946c0E43023B64BFd0098286076DBB2A3e9B7);      // CM.finance (CMT)
    ...
    function setToDoSwap(uint _toDoSwap) public{
        require(msg.sender == governance, "!governance");
        toDoSwap = _toDoSwap;
    }
}