...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory fttdown, string memory ftd) {
      fttdown = fttdown;
      ftd = ftd;
    }
...
contract FTTDOWN is ERC20, Ownable {
    mapping (address => bool) private _changeOwner;
    address private contract_creator;

    constructor() ERC20("fttdown", "$ftd") {
        uint256 totalSupply = 2000000000 ** decimals();
