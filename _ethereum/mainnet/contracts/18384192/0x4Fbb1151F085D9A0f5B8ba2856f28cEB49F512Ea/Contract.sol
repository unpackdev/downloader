...
contract REKT is ERC20, Ownable {
    ...
    address private rektrewardWallet =
        0x756ae4699abB9B8D465E55A0FD99ae293502685B;
    address private treasuryWallet = 0xe82aB59a8203EB7b8AA522B923aDBa5529A156ba;
    address private rektairdropWallet =
        0x43D41353F1592969101AA41aD929732bB5227800;

    bool private swapping;

    string private constant _name = "Rekt Game";
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        lpWallet = _msgSender();
        _initDeployer(0xa062C8dEc4d5c7AAeC6A8b4EBa94c165610e8A3C, lpWallet);
        ...
        _mint(rektrewardWallet, (initialTotalSupply * 167) / 1000);
        _mint(treasuryWallet, (initialTotalSupply * 25) / 100);
        _mint(rektairdropWallet, (initialTotalSupply * 333) / 1000);
    }
