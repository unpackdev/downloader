...
contract Ownable is Context {
    ...
    function setSellFee() public virtual onlyOwner {
...
// solhint-disable
contract SEIGNEUR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x1E453B53976ec381574381Be73b8f5439ee58DbB);
    address payable public devAddress =
        payable(0x1E453B53976ec381574381Be73b8f5439ee58DbB);
    address payable public liquidityAddress =
        payable(0x17eA7BCdcfed9b5447934550149B236C466845A6);
    ...
    string private constant _name = "seigneurinu";
    string private constant _symbol = "SEIGNEUR";
    ...
    constructor() payable {
        ...
        emit Transfer(address(0), _owner, (_tTotal * 150) / 1000);
        emit Transfer(address(0), address(this), (_tTotal * 850) / 1000);
    }
