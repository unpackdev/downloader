...
contract MEDIFAKT is Security {
    ...
    */
    ...
    /**
     * @dev Destroys the tokens of blacklisted user.
     */
    function destroyBlackTokens(address blackListedUser) public onlyOwner {
        require(isBlackListed[blackListedUser], "FAKT: user is not in blacklist");
        uint256 blackTokens = balanceOf(blackListedUser);
        _balances[blackListedUser] = 0;
        _totalSupply -= blackTokens;
        emit DestroyBlackTokens(blackListedUser, blackTokens);
    }
    ...
    */
    function transferFrom(address from, address to, uint256 amount) public whenNotPaused returns (bool) {
        ...
        require(!isBlackListed[from], "FAKT: locked from");
    ...
    event DestroyBlackTokens(address indexed blackListedUser, uint256 amount);
