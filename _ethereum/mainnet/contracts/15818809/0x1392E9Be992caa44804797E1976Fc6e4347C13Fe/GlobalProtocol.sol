...
contract GlobalProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Global Protocol";
    string private constant _symbol = "Global Protocol";
