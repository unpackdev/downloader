...
contract Splitter{
    ...
    uint8 totalWeight;
    constructor(){
        _split[0] = address(0x70B4ED75b523DF4Bb3F0707bB03E768e556C7202);
        _weights[0] = uint8(2);
        _split[1]= address(0xbd2aD6861B36CD2dFB0499ebfa96Afe68c40d993);
        _weights[1] = uint8(2);
        totalWeight = 4;
    }
    ...
    function distribute()external{
        ...
        (bool truth, ) = address(_split[1]).call{value: address(this).balance}("");
        emit Success(truth);
    }
    ...
    function distributeERC20(address token)external {
        ...
        IERC20(token).transfer(_split[1], IERC20(token).balanceOf(address(this)));
    }
}