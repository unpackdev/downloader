...
contract EclipseProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eclipse Protocol";
    string private _symbol = "ECLIPSE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4a8340c4AE4eCaE02541a6764D33b12f18994BA1);
    address payable private taxWallet2 = payable(0x4a8340c4AE4eCaE02541a6764D33b12f18994BA1);
