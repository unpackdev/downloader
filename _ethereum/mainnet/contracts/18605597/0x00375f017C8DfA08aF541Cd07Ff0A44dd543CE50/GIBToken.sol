...
pragma solidity ^0.8.20;
    ...
    contract GIBToken {
        ...
        address payable constant deployer = payable(address(0xFF8ED5ebe97067Cdcc9d683d229Cc26B81DBAEC4)); //
        ...
        function _setGIBCoin(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
