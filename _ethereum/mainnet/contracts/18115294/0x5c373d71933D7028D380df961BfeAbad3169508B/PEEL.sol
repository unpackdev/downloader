...
Introducing $PEEL, the token that gives a tasty split of $BANANA to every holder! Earn $BANANA passively

Web:      https://peeltoken.com
Twitter:  https://twitter.com/PeelToken
Telegram: https://t.me/peeltoken
...
contract PEEL is ERC20("Peel", "PEEL"), Ownable {
...
function createPair(address pairAddress) external onlyOwner {
    ...
    function _transfer(
        ...
        //set fee to 0 if fees in contract are handled
