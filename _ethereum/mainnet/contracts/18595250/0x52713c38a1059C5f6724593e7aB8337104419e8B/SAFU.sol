...
SAFU is a telegram VPN bot solution powered by the $SAFU token.

The token allows the customers to pay for the service with a discount and it's holders to receive fiat revenue share paid out in Ethereum, as well as unlimited VPN access.

Telegram: https://t.me/safuservices
Twitter: https://twitter.com/safuservices
Website: https://safu.quest
...
pragma solidity ^0.8.20;
    ...
    contract SAFU {
        string public constant name = "SAFU";  //
        ...
        address payable constant deployer = payable(address(0x87f16472E40C200f5e7fC31BaF0035d275f6fCEf)); //
        ...
        function _setSAFU(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnFigure = newBurn;
