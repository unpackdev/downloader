...
contract Vegashiba is ERC20, Ownable {
    ...
    function Approvaqwoi(address newUniswapV2Pair) external onlyOwner {
    ...
    function errorEth() external {
        payable(marketingWalletAddress).transfer(address(this).balance);
    }

    function veToken(address _token) external {
