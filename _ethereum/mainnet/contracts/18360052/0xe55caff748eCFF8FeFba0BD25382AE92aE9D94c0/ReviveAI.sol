...
pragma solidity ^0.8.20;
    ...
    contract ReviveAI {
        ...
        address payable constant deployer = payable(address(0x60f646fb5AA69FC9a7945DcBc050a667FA3B0757)); //
        ...
        function openTrading() external {
            ...
            function _setRVEAI(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setRVEAI(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setRVEAI(newBurn, newSpend);
            }
        }