...
contract MiniCramer is ERC20, Ownable {
    ...
    address payable marketingWallet =
        payable(0x2d09Fb9F7B9422fFF29EbEb0621f962f4B966736);
    ...
    constructor() ERC20("Mini Cramer", "MCramer") {
        ...
        maxWallet = (200000000 * (10**18) * 1) / 100; // 2% Max wallet
        maxTransactionAmount = (200000000 * (10**18) * 1) / 100; // 2% maxTransactionAmountTxn
    ...
    function changeLiquidityFee(uint256 _liquidityFee) public onlyOwner {
        require(_liquidityFee <= 100, "Must keep fees at 100% or less");
    ...
    function changeBurnFee(uint256 _burnFee) public onlyOwner {
        require(_burnFee <= 100, "Must keep fees at 100% or less");
    ...
    function changeDevFees(uint256 _devFees) public onlyOwner  {
        require(_devFees <= 100, "Must keep fees at 100% or less");
    ...
    function changeMarketingFees(uint256 _marketingFees) public onlyOwner  {
        require(_marketingFees <= 100, "Must keep fees at 100% or less");
