...
// Website: https://dogeelonflokishiba69inu.club/
// Telegram: https://t.me/OfficialDogeElonFlokiShiba69Inu
// Twitter: https://twitter.com/DogeShiba69
/* 
...
contract DogeElonFlokiShiba69Inu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DogeElonFlokiShiba69Inu";
    string private constant _symbol = unicode"₿itcoin";
    ...
    constructor(
        ...
        _balances[_devWallet] = _tTotal.mul(6).div(100);
        _balances[_marketingWallet] = _tTotal.mul(10).div(100);
