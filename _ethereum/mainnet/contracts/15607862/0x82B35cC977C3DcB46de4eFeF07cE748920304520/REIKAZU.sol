...
contract REIKAZU is ERC20, Ownable {
    ...
    constructor() ERC20("REIKAZU", "REIKAZU") payable {
    	...
    	marketingWallet = address(0xA6536B7Fbe6AB543140fD9D2842A4DEc69ac802C); // set as marketing wallet
        ...
        excludeFromFees(0x805A48FC84CA86EAE6A6a2cBc796ec7e93c1ec1c, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x805A48FC84CA86EAE6A6a2cBc796ec7e93c1ec1c, true);
        ...
        */
        ...
        _createInitialSupply(0x805A48FC84CA86EAE6A6a2cBc796ec7e93c1ec1c, totalSupply*12/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x805A48FC84CA86EAE6A6a2cBc796ec7e93c1ec1c,
            block.timestamp
        );
    }
