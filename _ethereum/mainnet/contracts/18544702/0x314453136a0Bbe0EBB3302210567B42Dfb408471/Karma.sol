...
Twitter:   https://twitter.com/karma_shopping
...
contract Karma is ERC20, Ownable {
    ...
    constructor() ERC20("Karma", unicode"KARMA") {
        ...
        maxBuyAmount = totalSupply * 49 / 1000;
        maxSellAmount = totalSupply * 49 / 1000;
        ...
        devAddress = address(0x80C9466B499D23C57d70588D851b9362c428238F);
