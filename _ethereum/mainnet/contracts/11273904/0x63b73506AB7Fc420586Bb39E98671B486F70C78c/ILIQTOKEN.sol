...
contract ILIQTOKEN is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("ILIQToken", "ILIQ") {
        ...
        uint128 _minTokensBeforeSwap = 3500 * 10**18;
        uint256 _maxTokensPerTx = 20000 * 10**18;
    ...
    */
    function _transfer(
        ...
        if(from != owner()) {
            require(amount <= maxTokensPerTx, "ERC20: transfer amount exceeds 20000 limit");
        }
        else{
