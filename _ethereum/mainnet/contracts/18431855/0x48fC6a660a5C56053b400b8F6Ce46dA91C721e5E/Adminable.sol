...
contract T2T2Coin is ERC20,Adminable {
  ...
  /**
   * burns $T2T2 from a holder
   * @param from the holder of the $T2T2
   * @param amount the amount of $T2T2 to burn
   */
  function burn(address from, uint256 amount) external whenNotPaused onlyAdminOrOwner {
    require(admins[msg.sender], "T2T2Coin:Only admins can burn");
    _burn(from, amount);
  }
