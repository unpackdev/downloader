/*
    ...
    based off vitalik's latest tweet!
*/
...
contract Vitalik is IERC20, Ownable {
    ...
    constructor (string memory _nameParam, string memory _symbolParam) payable {
        ...
        liquidityFee = 20;    // to prevent bots at launch
        totalFee = 20;        // to prevent bots at launch
        totalBuyFee = 20;     // to prevent bots at launch
