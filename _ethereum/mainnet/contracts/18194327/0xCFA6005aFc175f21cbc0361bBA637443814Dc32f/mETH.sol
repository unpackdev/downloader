...
contract mETH is ERC20, Ownable {
    ...
    constructor() ERC20("mETHandion", "mETH") {
        ...
        marketingWallet = address(0x58EDe4E48feFB9fb60169E32932F1BB3263E1271); 
        devWallet = address(0x059c69d00380083cc0968816E89c1AE5f4606C49); 
    ...
    function _transfer(
        ...
        if (amount >= 350_000 * 1e18 && block.number <= blockNumber + 20) {
