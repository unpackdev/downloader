...
import "./IMasterRadpieReader.sol";
import "./IRadpieStakingReader.sol";
import "./IRDNTRewardManagerReader.sol";
import "./IRDNTVestManagerReader.sol";
import "./IBaseRewardPoolV3.sol";
...
import "./IIncentivizedERC20.sol";
import "./ReaderDatatype.sol";
...
contract RadpieReader is Initializable, OwnableUpgradeable, ReaderDatatype {
    ...
    function getRadpiePoolInfo(
        ...
        radpiePool.sizeOfPool = IERC20(radpiePoolInfo.receiptToken).totalSupply();
    ...
    function getRadpieRDNTInfo(address account) public view returns (RadpieRDNTInfo memory) {
     ...
     function getRadpieEsRDNTInfo(address account) public view returns (RadpieEsRDNTInfo memory) {
        ...
        if (rdntRewardManager.esRDNT() == address(0)) 
