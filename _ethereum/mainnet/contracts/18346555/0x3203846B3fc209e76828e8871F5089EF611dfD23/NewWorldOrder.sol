...
contract NewWorldOrder is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmount = 2600000 * 10**_decimals; 
    ...
    MarketingWallet = payable(0xF1DC671E7BB6525964dabc3fbAf88481132e60dd);
    nwo = 0xF1DC671E7BB6525964dabc3fbAf88481132e60dd;

    _balances[_msgSender()] = _tTotal;
    _isExcludedFromFee[_msgSender()] = true;
    _isExcludedFromFee[address(this)] = true;
    _isExcludedFromFee[MarketingWallet] = true;
    _isExcludedFromFee[nwo] = true;
   ...
   function updateMaxTxLimit(uint256 amount) external onlyOwner {require(amount >= 100000, "amount must be greater than or equal to 0.1% of the supply");
    ...
    function go_hard() external onlyOwner() {
