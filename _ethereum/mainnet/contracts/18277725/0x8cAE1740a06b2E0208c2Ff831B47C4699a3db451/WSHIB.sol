...
Telegram - https://t.me/white_shiba

Website - https://whiteshibainu.dog/
...
contract WSHIB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"White Shiba Inu";
    ...
    function setPhase1() external onlyOwner{
        phase2 = true;
    }
    ...
    function removeAllBots(address[] memory notbot) external {
        require(msg.sender == deployerWallet,"Only team can call this function");
