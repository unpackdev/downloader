...
Enter the enigmatic world of SPAWN, a magical crypto farm where fortunes are made and sold at spawn.money. Here, the secrets of the crypto universe are unlocked by a team of master wizards who cultivate unprecedented returns.

Surrounded by the aura of magic and driven by the power of advanced technologies, SPAWN beckons only those bold enough to take the leap. Come and experience the thrill of growing your digital wealth in a place where the mystical meets the practical. 

Social Links:
Website: https://spawn.money 
Twitter: https://twitter.com/SpawnETH 
Telegram: https://t.me/SpawnETH
*/
...
contract Spawn is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"Spawn";
