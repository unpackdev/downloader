...
contract BitbaseProxy {
  bytes32 private constant implementationPosition = bytes32(uint256(keccak256("bbase.impl")) - 1);
  bytes32 private constant proxyOwnerPosition = bytes32(uint256(keccak256("bbase.owner")) - 1);
