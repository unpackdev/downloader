...
contract Bridge is Pausable, AccessControl {
    ...
    /**
        ...
        @param initialRelayer Address that should be initially granted the relayer role.
        @param initialRelayerThreshold Number of votes needed for a deposit proposal to be considered passed.
     */
    constructor (uint8 domainID, address initialRelayer, uint256 initialRelayerThreshold, uint256 fee, uint256 expiry) public {
        _domainID = domainID;
        ...
        grantRole(RELAYER_ROLE, initialRelayer);
    }
