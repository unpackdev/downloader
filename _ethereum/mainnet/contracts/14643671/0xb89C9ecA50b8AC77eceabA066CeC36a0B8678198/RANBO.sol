...
Website:  https://ranbo.pro/
Telegram: https://t.me/ranbotoken
...
contract RANBO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ranbo.pro", "RANBO") {
        ...
        InsuranceWallet = address(0xC4EFfe85E5EA5e4b2AAA2E07796714A76cb51b7A);
        TreasuryWallet = address(0xE0A9F4f83624E6Be82A33d8ddd745E60dFba9B58);
