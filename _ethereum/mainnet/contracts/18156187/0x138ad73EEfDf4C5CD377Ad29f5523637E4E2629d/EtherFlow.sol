...
contract EtherFlow is ERC20, Ownable {
    uint256 constant maxWalletStart = 1e17;
    uint256 constant addMaxWalletMinute = 2e16;
    uint256 public constant totalSupplyOnStart = 1e18;
    uint256 tradingStartTime;
    address public pool;

    constructor() ERC20("EtherFlow", "ETF") {
    ...
    function maxPerWallet() public view returns (uint256) {
        ...
        uint256 res = maxWalletStart +
            ((block.timestamp - tradingStartTime) * addMaxWalletMinute) /
            (1 minutes);
    ...
    function tradeBegin(address poolAddress) public onlyOwner {
