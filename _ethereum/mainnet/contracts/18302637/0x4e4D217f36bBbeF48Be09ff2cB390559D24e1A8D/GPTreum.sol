/*
GPTreum - Creating Truly Decentralized AI Models
For More Information - Gptreum.carrd.io
x.com/GPTreum
t.me/GPTreum
github.com/gptreum/OpenSourceLocalModel
*/
...
contract GPTreum is ERC20, Ownable {
    ...
    constructor() ERC20("GPTreum", "GPTREUM") {
        ...
        maxTransactionAmount = totalSupply / 10; // 1% from total supply maxTransactionAmountTxn
        maxWallet = totalSupply / 2; // 1% from total supply maxWallet
        swapTokensAtAmount = totalSupply.div(10000);

        marketingWallet = address(0x13F48521fE54c3805301AfaAcC5f202E8bf1300A); // set as marketing wallet
