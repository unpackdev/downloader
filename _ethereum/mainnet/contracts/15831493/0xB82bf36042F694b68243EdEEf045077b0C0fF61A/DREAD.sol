...
contract DREAD is ERC20, Ownable {
    ...
    constructor() ERC20( "DREAD", "$IT") {
        ...
        operationsAddress = address(0x81317D47911aE76255B25DAC05b50b8f38C909b5); // change this address to wallet u want for operations   
        TaxAddress = address(0x81317D47911aE76255B25DAC05b50b8f38C909b5);  // change this address to the one for tax 
