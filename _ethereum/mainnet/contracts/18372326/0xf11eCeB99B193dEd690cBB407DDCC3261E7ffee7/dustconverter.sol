...
OTC purchases from $DC holders to sustain project growth.
Telegram : https://t.me/dustconverter

Twitter: https://twitter.com/DustConverter

www.dustconverter.org
...
contract DustConverter is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dust Converter";
    string private constant _symbol = unicode"DC";
    uint256 public _maxTxAmount =   1000 * 10**_decimals;
    uint256 public _maxWalletSize = 3250 * 10**_decimals;
