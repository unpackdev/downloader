...
contract LilBullsClub is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmfJSviECRLkRM66U5dkcUunEFGkXuXkuP3CnXp8DmazSn";
  ...
  ) ERC721A("Lil Bulls Club", "Lil Bulls Club") {
