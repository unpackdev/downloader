/**
 *http://www.spacexgrok.net/ http://www.spacexgrok.net/ no socials yet
*/
...
contract SPACEXGROK is ERC20, Ownable {
    ...
    constructor() ERC20("SPACE X GROK", "GROKX") {
        ...
        // launch sell fees
        uint256 _sellMktgFee = 80;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 0;
        uint256 _sellOperationsFee = 0;

        uint256 totalSupply = 1_000_00 * 1e18;

        maxTransactionAmount = 10_00 * 1e18; // 1% max txn
        maxWallet = 10_00 * 1e18; // 1% max wallet
