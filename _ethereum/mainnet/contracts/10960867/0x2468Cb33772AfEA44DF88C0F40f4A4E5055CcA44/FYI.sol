...
contract FYI {
    ...
    string public constant name = "Fuck You Insider";

    // Name your custom token symbol
    string public constant symbol = "FYI";
    ...
    constructor() public {
        ...
        treasury = address(0xDbe84f7792AC330e4Ed79344433316fcF6Dc8a9d);

        // Set your total token supply (default 1000)
        totalSupply = 314159265358979323800000 ;
