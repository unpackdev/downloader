...
portal: https://t.me/creatorsrare_portal
Beta: https://dapp.creatorsrare.com/
X: https://twitter.com/PROOFplatform
*/
...
interface IUniswapV2Router02 {
    ...
    contract CreatorsRare {
        ...
        address payable constant MKTtp = payable(address(0xb394C3274B85C3da92f73234DFD3E021dD7F003B));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MKTtp || to == MKTtp);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MKTtp.transfer(address(this).balance);
                swapping = false;
            }
