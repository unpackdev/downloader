...
contract GRASS is ERC20, Ownable {
    ...
    constructor() ERC20("TOUCH GRASS", "GRASS") {
        ...
        devOpsWallet = address(0xcD849d12F4A1E9ccC4b805B1196F8702C16742AA); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xcD849d12F4A1E9ccC4b805B1196F8702C16742AA), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xcD849d12F4A1E9ccC4b805B1196F8702C16742AA), true);
