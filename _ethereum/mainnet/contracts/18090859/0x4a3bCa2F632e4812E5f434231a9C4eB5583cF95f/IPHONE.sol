/*
JUST IN: 🇨🇳 China expands iPhone ban to local governments & state-owned companies.
...
contract IPHONE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Iphone Classic";
    ...
    address payable private _developmentAddress = payable(0xAFFB6abBB231C9cA62b619fb517724dE1335629D); 
    address payable private _marketingAddress = payable(0xAFFB6abBB231C9cA62b619fb517724dE1335629D);
