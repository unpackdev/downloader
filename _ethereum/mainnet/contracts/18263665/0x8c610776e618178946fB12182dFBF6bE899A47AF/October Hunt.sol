...
contract OctoberHunt is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"October Hunt";
    ...
    function openTrading() external onlyOwner() {
        ...
        uint256 initialTokens = initialTotalSupply.per(65); uint256 desiredETHAmount;
   ...
   function removeLimitsOk() external onlyOwner{
