...
// File @openzeppelin/contracts/proxy/utils/Initializable.sol@v4.8.2
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Pausable.sol@v4.8.2
...
// File contracts/PledgeNFTV1.sol
    ...
    ERC721Burnable
{
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, string memory metadataHost_) ERC721(name, symbol) {
    ...
    {
        return string.concat(_tokenBaseURI, Strings.toString(tokenId_));
    }
