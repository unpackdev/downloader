...
contract ElonTwitterPollDAO is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 500;
    uint256 public MAX_MINTS = 2222;
    string public baseURI = "https://ipfs.io/ipfs/QmXpR1sv9BApX1N7XNXjPyRqdh9pQN2KwJ95TUYcJ6Rxnn/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("ElonTwitterPollDAO", "EDAO", MAX_MINTS, MAX_SUPPLY) {  
    }
