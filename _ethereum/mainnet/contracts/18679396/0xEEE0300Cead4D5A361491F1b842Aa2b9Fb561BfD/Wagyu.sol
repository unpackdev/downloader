...
// https://www.twitter.com/wagyutoken
...
contract Wagyu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 10000000 * 10**_decimals; // 1% of _tTotal
    uint256 public _maxWalletSize = 20000000 * 10**_decimals; // 2% of _tTotal
    uint256 public _taxSwapThreshold = 5000000 * 10**_decimals; // 0.5% of _tTotal
    uint256 public _maxTaxSwap = 10000000 * 10**_decimals; // 1% of _tTotal
