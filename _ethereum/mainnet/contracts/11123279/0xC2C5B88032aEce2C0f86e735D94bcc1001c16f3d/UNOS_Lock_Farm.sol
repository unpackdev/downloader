...
contract UNOS_Lock_Farm is Ownable {
    using SafeMath for uint;
    
    address public constant tokenAddress = 0xd18A8abED9274eDBEace4B12D86A8633283435Da;
    
    uint public constant tokensLocked = 30000e18;         // 30000 UNOS
    uint public constant unlockRate =   30000;            // Unlock Date: 15 November 2020
    uint public constant lockDuration = 20 days;          // Before 20 Days, Its impossible to unlock...
