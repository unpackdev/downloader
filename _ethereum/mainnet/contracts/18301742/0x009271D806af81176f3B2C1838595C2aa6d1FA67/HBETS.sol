...
//TELEGRAM LINK https://t.me/officialheybets
...
contract HBETS is Context, Ownable, IERC20 {
    using SafeMath for uint256;
    using Address for address;

    string public name = "HeyBets"; // Updated name
    string public symbol = "HEYBETS"; // Updated symbol
