...
contract SuperSmashBros is Ownable {
    
    modifier onlyAdmins() {
        require(
            msg.sender == owner() || whitelist[msg.sender] == true,
            "You are not the admin for this contract"
        );
        _;
    }
    ...
    address currencyToken = address(0x0);
    IUniswapV2Router02 public immutable uniswapV2Router;

    constructor(address uniswapRouter, address _currencyToken) {
    ...
    receive() external payable {
        ...
        emit Deposit(currencyToken, msg.value, amountReceived, tx.origin);
    }
    ...
    function WithdrawEth(uint256 amount) public onlyAdmins {
    ...
    function DepositEth() public payable {
        ...
        emit Deposit(currencyToken, msg.value, amountReceived, msg.sender);
    }
    ...
    function convertEthToToken(
        ...
        path[1] = tokenAddress;
        // get balance currently of STABLE TOKEN
    ...
    function changecurrencyToken(address _currencyToken) public onlyAdmins {
        currencyToken = _currencyToken;
    }
}
