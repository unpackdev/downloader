...
contract Goemon is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _name = unicode"Goemon Ninja";
        _symbol = unicode"GOE";
        _decimals = 18;
        _owner = msg.sender;
        _totalSupply = 5_555_555_555  * 10 ** _decimals;
        marketingWalletAddress = payable(0x3d72FDfC5eEF7F33d8A4F7E80D575bd323Eed46e);
        teamWalletAddress = payable(0x3d72FDfC5eEF7F33d8A4F7E80D575bd323Eed46e);
