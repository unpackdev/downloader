...
contract Doppelganger is ERC20, Ownable {
    ...
    constructor() ERC20("Doppelganger", "DOPP") {
        ...
        revShareWallet = address(0x369B7222FEb6d7e7844A86b64e728c055b02D67f); // set as revShare wallet
    ...
    function withdrawStuckDOPP() external onlyOwner {
