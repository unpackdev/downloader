...
contract ENCHANTED is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x183E0728DFB7a1761394b0DA29B947cAA9EB3337); // Marketing Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 20 / 1000; // 2% max txn
