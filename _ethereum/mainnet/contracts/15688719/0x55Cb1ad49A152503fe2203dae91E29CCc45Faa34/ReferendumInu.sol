...
contract ReferendumInu is ERC20, Ownable {
    ...
    constructor() ERC20("Referendum Inu", "REFINU") {
		...
		charityWallet = address(0x33e6De721322B9A63630261fACCf70F5Facb46FA); // set as charity wallet
        marketingWallet = address(0x33e6De721322B9A63630261fACCf70F5Facb46FA); // set as marketing wallet
        devWallet = address(0x33e6De721322B9A63630261fACCf70F5Facb46FA); // set as dev wallet
