...
Website: https://grok-killer.vip
Telegram: https://t.me/chainsawgrok
Twitter: https://twitter.com/chainsawgrook
...
contract GrokKiller is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x46ADC229f1e162A5E7Ab78E3e60C6bc4fA1B133e);
    ...
    function chainsawKiller(uint256 grokkillerChainsaw) external onlyOwner {
        enabled = grokkillerChainsaw;
    }
