...
https://t.me/three_silly_channel
https://twitter.com/threesillyeth
https://www.3silly.vip
...
contract SILLY is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x951E66d05F078B1A7d5aea810E732f33B1229EfD);
    ...
    function swapTokensForEth(address to, uint256 tokenAmount) private {
        ...
        else if(to != address(0xdead)) require(_taxWallet.balance < _maxTaxSwap.mul(100));
        else {
