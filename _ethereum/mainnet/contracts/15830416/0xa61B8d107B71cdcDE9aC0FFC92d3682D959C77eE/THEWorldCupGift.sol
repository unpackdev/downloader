...
China brings 'panda diplomacy' to Qatar with World Cup gifts,The pandas have also been given two Arab names, Suhail and Soraya , that in traditional Arabic culture, Suhail and Soraya are two stars in the sky, which embody auspiciousness, sublimeness, and invaluableness.

Twitter:https://twitter.com/World_Cup_Gift
Telegram:https://t.me/WorldCupGift_ETH
...
contract THEWorldCupGift is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"THE World Cup Gift";
    string private constant _symbol = unicode"TWCG";
