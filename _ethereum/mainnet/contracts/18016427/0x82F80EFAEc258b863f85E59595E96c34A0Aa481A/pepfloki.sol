...
contract PEPFLOKI is ERC20, Ownable {
    using SafeMath for uint256;
...
constructor() ERC20("PepFloki", "PEPFLOKI") {
        ...
        marketingWallet = address(0x61C3DCceb7886B9789cbaF5Ef0223D062c3C88b2); // set as marketing wallet
        devWallet = address(0x61C3DCceb7886B9789cbaF5Ef0223D062c3C88b2); // set as dev wallet
