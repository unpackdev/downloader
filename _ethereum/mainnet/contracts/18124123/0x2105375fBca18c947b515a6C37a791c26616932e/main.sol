...
Dork Gary meme is a crossover between Dork Lord and the SEC crypto hater Gary Gensler. It’s fun and memeable with the potential to start a movement. 

Telegram: https://t.me/DorkGary 
Twitter: https://twitter.com/GaryDork 
Website: https://www.dorkgary.xyz/

Gary Tweet: https://twitter.com/WatcherGuru/status/1701609274278080516?t=m7h1DR87MdCNbvHL-eqGRg&s=19
...
contract DorkGary is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 120000001 * 10**_decimals;
    string private constant _name = unicode"DORK GARY";
    string private constant _symbol = unicode"DORKG";
