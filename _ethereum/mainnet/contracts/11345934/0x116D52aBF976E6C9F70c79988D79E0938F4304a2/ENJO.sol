...
contract ENJO is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "enjo.network";
  string constant tokenSymbol = "ENJO";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 555000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0x085a6E5b151B767C036e9A638830E08e810fE27b, tokensToBurn);
    return true;
  }
