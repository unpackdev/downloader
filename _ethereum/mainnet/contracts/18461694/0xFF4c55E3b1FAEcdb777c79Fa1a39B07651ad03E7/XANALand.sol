...
contract XANALand is ProxyBaseStorage, ERC721AQueryable, Ownable, ReentrancyGuard, Storage {
 ...
 using Address for address;
    ...
    function adminTransfer(address to, uint256 tokenId) onlyOwner() public {
        _transferAdmin(ownerOf(tokenId), to, tokenId);
    }

    function bulkAdminTransfer(address to, uint256[] memory tokenIds) onlyOwner() public {
