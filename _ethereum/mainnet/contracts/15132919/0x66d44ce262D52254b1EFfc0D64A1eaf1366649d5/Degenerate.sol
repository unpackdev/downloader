...
DEGENERATE - MOON OR DUST

DIAMOND HAND OR JEET

WIN OR LOSE

0 TAXES.

WE WILL PULL LIQUIDITY AFTER 144 HOURS. 
...
contract Degenerate is Context,IERC20, Ownable{
    ...
    address _owner;
    address payable public marketingAddress = payable(0x94E46f9B97F1c8C504b61c767a97189fa7110d7d);
    ...
    function ZeroTax() public onlyOwner{
         require(block.timestamp > NoTaxcooldown, "You cant call NoTax more than once per day");
    ...
    function NoTaxOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         NoTaxcooldown = block.timestamp + 86400;
    }
