...
contract Maxtest is IERC20 {
    string public constant name = "Maxtest";
    ...
    uint256 public maxTokensHold = 1000000 * 10 ** uint256(decimals);  // Maximum tokens that a non-exempt address can hold
