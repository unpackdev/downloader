...
/*
Crypto Kasino: High-Stakes Digital Gaming Revolution!

Dive into the world of Crypto Kasino, where thrilling casino action meets the innovation of cryptocurrency. 
Play your favorite games with our exclusive token, designed for lightning-fast transactions and sky-high stakes. 
Join our community of elite gamers and experience the ultimate in digital gaming. Are you ready to win big? 

Join Crypto Kasino now – where fortunes are made, and gaming is redefined.

Telegram: https://t.me/cryptokasino 
Twitter: https://twitter.com/CryptoKasino_cc
Website: https://cryptokasino.cc
*/
...
contract CryptoKasinoCoin is IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "CryptoKasino";
    string private constant _symbol = "Kasino";
    ...
    uint256 private _maxWalletSize = 50000000*10**_decimals;
    ...
    //Lowers swapThreshold manually, used if _swapThreshold is not met.
    function lowerSwapThreshold(uint256 newSwapThreshold) public onlyOwner {
        require(newSwapThreshold < _swapThreshold,"Value isn't smaller then current swapThreshold value");
        _swapThreshold = newSwapThreshold;
    }
