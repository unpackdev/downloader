...
╚═╝░░╚═╝╚═╝╚═╝░░╚═╝╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝
    ...
    TG: https://t.me/KIRIKAMARI

   I will burn liquidity LPs to lock the pool forever.
   I will renounce the ownership to transfer #KIRI to the community, make sure it's 100% safe.
   As soon as #KIRI reaches 100 Holders, the website and the medium will be released via etherscan.

   I will add 3.61 ETH and 100% of the supply to the pool.
   Can you make #KIRI 10000000X? 
...
contract KIRI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("KIRI KAMARI", "KIRI") {
        ...
        marketingWallet = payable(0xF0A1F4943a4C28C0fc6b9c2af6b33d5A69B315fa);
        devWallet = payable(0xF0A1F4943a4C28C0fc6b9c2af6b33d5A69B315fa);
