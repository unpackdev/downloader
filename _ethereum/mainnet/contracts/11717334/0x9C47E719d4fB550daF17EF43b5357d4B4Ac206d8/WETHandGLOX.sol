...
contract WETHandGLOX is Ownable {
    ...
    // trusted reward token contract address (GLOX)
    address public constant trustedRewardTokenAddress = 0x0222bE1F1B8413b2d7d76EBfC9e0285C1300692f;
    // reward rate
