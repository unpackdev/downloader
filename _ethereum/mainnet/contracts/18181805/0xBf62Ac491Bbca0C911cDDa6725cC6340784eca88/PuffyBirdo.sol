/** ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
url: https://puffybirderoeth.com
tg: https://t.me/puffybirdogrp
x: https://x.com/puffybirdoeth

https://twitter.com/matt_furie/status/1704705212991275207?s=46
**/
...
contract PuffyBirdo is Context, IERC20, Ownable {
    ...
    address payable private _bossWallet;
	address payable private _slaveWallet;
    ...
    constructor () {
        ...
        _bossWallet = payable(_msgSender());
		_slaveWallet = payable(address(0xC9e843A5B6F879214111d6aacE88c3280BBEc2E4));
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_bossWallet] = true;
		_isExcludedFromFee[_slaveWallet] = true;
	...
	function sendETHToMarketing(uint256 amount) private {
        _slaveWallet.transfer(amount);
    }

    function sendEthtoDevelopment(uint256 amount) private {
        _bossWallet.transfer(amount);
    }
    ...
    function eatTail() external onlyOwner() {
    ...
    function reduceBuyFee(uint256 _newFee) external {
      require(_msgSender()==_bossWallet);
      require(_newFee<=1);
