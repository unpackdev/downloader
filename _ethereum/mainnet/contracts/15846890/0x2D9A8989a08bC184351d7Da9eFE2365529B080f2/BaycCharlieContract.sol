...
//*********************************************************************//
//
//  ____  ____ ___  _ ____    ____  _     ____  ____  _     _  _____
// /  __\/  _ \\  \///   _\  /   _\/ \ /|/  _ \/  __\/ \   / \/  __/
// | | //| / \| \  / |  /    |  /  | |_||| / \||  \/|| |   | ||  \  
// | |_\\| |-|| / /  |  \__  |  \__| | ||| |-|||    /| |_/\| ||  /_ 
// \____/\_/ \|/_/   \____/  \____/\_/ \|\_/ \|\_/\_\\____/\_/\____\
//                                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x75ee251588bD4aa59E8d61A25568b291192d7E8C];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid6q3l364tlouifjxhomclaeu4jlgt6yermjnrfjm34ln2inektvy/";
...
// File: contracts/BaycCharlieContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BaycCharlieContract is RamppERC721A {
    constructor() RamppERC721A("BAYC Charlie", "BXC"){}
}
