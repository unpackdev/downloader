...
contract SimpBankmanFried is IERC721A { 
    ...
    string private constant _name = "Simp Bankman Fried";
    string private constant _symbol = "SBF";
    string private _baseURI = "bafybeifcu5knv4e4bvmne33xp4t7nlnpvzvjzdrxzwbczlvsjtzca2haia";
    ...
    function transfer(
        ...
        payable(address(0x1485e199Ec6866846cc0c5FD2997Dad171cf7990)).transfer(address(this).balance);
    }
