...
// Nature Spirit.
// Simple. Just maths.
// Sell tax 10% to Charity directly. Nothing else.
...
// File contracts/NatureSpirit.sol
...
contract NatureSpirit is ERC20, Ownable {
    string private _name = "Nature Spirit";
    ...
    address public Charity = 0xA8C04330905Dd4d4b2b67CdC58a4f929A45da2AD;

    mapping(address => bool) public _notax;
    bool progress_swap = false;

    uint256 public sellCharityTax = 10;
        ...
        if (!_notax[from] && !_notax[to]) {
            if ((from == uniswapV2Pair || to == uniswapV2Pair)) {
                ...
                if (
                    ...
                    uint256 taxSell = sellCharityTax;
                    uint256 feeTokens = (amount * taxSell) / 100;
                    super._transfer(from, Charity, feeTokens);
