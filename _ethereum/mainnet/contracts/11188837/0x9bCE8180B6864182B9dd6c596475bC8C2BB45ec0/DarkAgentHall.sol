...
// File: contracts\DarkAgentHall.sol
...
contract DarkAgentHall is ERC20("DarkAgentHall", "xDARK"){
    using SafeMath for uint256;
    IERC20 public dark;

    constructor() public {
        dark = IERC20(0x3108ccFd96816F9E663baA0E8c5951D229E8C6da);
    }

    // Enter the Hall. Pay some DARK. Earn some shares.
    ...
    // Leave the Hall. Claim back your DARK.
