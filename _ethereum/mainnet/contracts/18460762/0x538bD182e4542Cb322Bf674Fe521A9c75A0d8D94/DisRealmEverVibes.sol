...
/// @custom:security-contact drev_token@protonmail.com
contract DisRealmEverVibes is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor(address initialOwner)
        ERC20("DisRealmEverVibes", "DREV")
        Ownable(initialOwner)
        ERC20Permit("DisRealmEverVibes")
    {
        _mint(msg.sender, 3200329198 * 10 ** decimals());
    }
