    ...
    ERC2981
{
    ...
    address public PROPS_FEE_MANAGER = 0xD0CeE8E1EaA690C4c6dCD3e324BAA088130b873f; 
    address public FEE_RECIPIENT = 0xeeeB783c979fEC681e356Dba2Dde9cA3382aF532; 
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function mintWithSignature(
        ...
        uint256 base_fee = _fee - creator_fee;
        
        _cost += _fee;
        if (_cost > msg.value) revert InsufficientFunds();

        (bool fee_sent, bytes memory fee_data) = FEE_RECIPIENT.call{value: base_fee}('');
        (bool sent, bytes memory data) = receivingWallet.call{value: (_cost - base_fee)}('');
