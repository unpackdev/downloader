...
//
// Deployed to : 0x62d2c1680d71B1037b9cF888c425C870baF92aaC
// Symbol      : SPK
// Name        : SPARK
// Total supply: 10000
// Decimals    : 8
// site        : https://sparkcore.online
// ----------------------------------------------------------------------------
...
contract SPARK is ERC20Detailed {
  ...
  function findtwoPercent(uint256 value) public view returns (uint256)  {
    ...
    uint256 twoPercent = roundValue.mul(basePercent).div(3333);
    return twoPercent;
  }
