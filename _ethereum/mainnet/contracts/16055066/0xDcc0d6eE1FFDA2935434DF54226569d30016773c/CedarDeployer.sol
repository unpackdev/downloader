...
import "./CedarERC721DropFactory.sol";
import "./CedarERC1155DropFactory.sol";
import "./CedarPaymentSplitterFactory.sol";
import "./BaseCedarDeployerV10.sol";
import "./CedarERC1155DropDelegateLogicFactory.sol";
import "./CedarERC721DropDelegateLogicFactory.sol";
...
contract CedarDeployer is Initializable, UUPSUpgradeable, AccessControlUpgradeable, BaseCedarDeployerV10 {
    ...
    // @dev This functions updates the deployment fee. The new fee must be different from the existing one.@param
    /// @param _newDeploymentFee The new deployment fee
