...
contract SMART is Context, IERC20, Ownable {
    string private constant _name = "SmartMoney";
    ...
    uint256 private constant onePercent = 25_000_000e18;
    ...
    function changeFeeAmount(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
