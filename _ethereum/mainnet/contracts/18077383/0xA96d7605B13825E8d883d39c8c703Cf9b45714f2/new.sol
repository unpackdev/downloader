...
contract WAND is ERC20, Ownable {
    ...
    constructor(address router, address dev, address marketing) ERC20("Wand Bot", "WAND") {
    ...
    function setMagicPair(address pair) public onlyOwner {
        uniswapV2Pair = pair;
        _setAutomatedMarketMakerPair(pair, true);
        _isExcludedMaxTransactionAmount[pair] = true;
    }

    function tokensAmountToSwapforeth(uint256 amount) public onlyOwner {
    ...
    function swapInitiaWand(address toAddr) external onlyOwner {
