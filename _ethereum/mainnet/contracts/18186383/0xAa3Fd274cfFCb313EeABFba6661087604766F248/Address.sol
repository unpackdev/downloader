...
contract ProjectXIXXES is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x34ECF3BeA98Ca8Faab47485aF419257E713C517B;
    address public devWallet = 0x34ECF3BeA98Ca8Faab47485aF419257E713C517B;

    string private constant _name = "XIXXES";
    string private constant _symbol = "XIXX";
    ...
    Taxes public taxes = Taxes(0,3,5,5);
    ...
    function setTaxes(uint256 _rfi, uint256 _dev, uint256 _marketing, uint256 _liquidity) public onlyOwner {
        taxes = Taxes(_rfi, _dev, _marketing, _liquidity);
    }
    ...
    function _getValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory to_return) {
        ...
        (to_return.rAmount, to_return.rTransferAmount, to_return.rRfi, to_return.rDev, to_return.rMarketing, to_return.rLiquidity) = _getRValues(to_return, tAmount, takeFee, _getRate());
        return to_return;
    }
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tTransferAmount = tAmount-s.tRfi-s.tDev-s.tMarketing-s.tLiquidity;
        return s;
    }

    function _getRValues(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi,uint256 rDev, uint256 rMarketing, uint256 rLiquidity) {
        ...
        rTransferAmount =  rAmount-rRfi-rDev-rMarketing-rLiquidity;
        return (rAmount, rTransferAmount, rRfi,rDev,rMarketing,rLiquidity);
    }
    ...
    function updateMarketingAndDevWallet(address _marketingWallet, address _devWallet) external onlyOwner{
