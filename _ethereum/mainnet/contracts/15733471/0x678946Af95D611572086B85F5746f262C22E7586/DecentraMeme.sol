/*
  ...
  DecentraMeme - MemeD
  Make the TG & Twitter & I will give you something Truly Decentralized!
...
contract DecentraMeme is ERC20, Ownable {
    ...
    uint256 public devFee = 200; // 3%
    uint256 public liquidityFee = 100; // 1%
    uint256 public burnFee = 0; // 0.0%
    uint256 public swapTokensAtAmount = 2250000 * (10**18);
    uint256 public maxWalletToken = 40000000 * (10**18);
    uint256 public maxTransactionAmount = 40000000 * (10**18);
 
    address payable private devWallet = payable(0x5f96e6b1063c0cA9dC7208c275D27a44ce54ef39);
    ...
    constructor() ERC20("DecentraMeme", "MemeD") {
