...
contract POSHIB is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x30d0Ea6f0391f36adDb83F38da57AadeA5614448);
    ...
    constructor() ERC20("Proof of Shiba", "POSHIB") {
        ...
        marketingWallet = address(0xF9aAf5d9685B50ADBCE4F13a3AAf30cDff672015);
        devWallet = address(0xF885f87865a84cb112b7FCD99a1d5BcD4928CD67);
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xF9aAf5d9685B50ADBCE4F13a3AAf30cDff672015), true);
        excludeFromFees(address(0xF885f87865a84cb112b7FCD99a1d5BcD4928CD67), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xF9aAf5d9685B50ADBCE4F13a3AAf30cDff672015), true);
        excludeFromMaxTransaction(address(0xF885f87865a84cb112b7FCD99a1d5BcD4928CD67), true);
