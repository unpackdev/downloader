...
import "./ISpecialSlothItemV2.sol";
import "./ISlothMintV3.sol";
import "./OwnableUpgradeable.sol";
import "./Initializable.sol";

contract SlothMintV11 is Initializable, OwnableUpgradeable, ISlothMintV3 {
    ...
    function publicMintBodyForPiement(address transferAddress, uint8 quantity) payable external {
        ...
        ISloth(_slothAddr).mint(transferAddress, quantity);
    ...
    function publicMintClothesForPiement(address transferAddress, uint8 quantity) payable external {
        ...
        ISlothItemV2(_slothItemAddr).clothesMint(transferAddress, quantity);
        currentClothesCount += quantity;
