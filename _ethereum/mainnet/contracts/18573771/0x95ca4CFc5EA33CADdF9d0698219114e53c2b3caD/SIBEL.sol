...
contract SIBEL is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"Sibel";
    string private constant _symbol =  unicode"SIBEL";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 69 * 1e8 * 10**_decimals;
    uint256 public _BuyTax=            0;
    uint256 public _SellTax=           0;
    uint256 public _maxTxAmount =      1035 * 1e5 * 10**_decimals;
    uint256 public _maxWalletSize =    1035 * 1e5 * 10**_decimals;
