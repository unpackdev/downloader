// https://twitter.com/elonmusk/status/1706586107335311542/photo/1
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private constant _name = "Penguin X";
    string private constant _symbol = "PenguinX";

    IUniswapV2Router02 public _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address public uniswapV2Pair;
    address payable private _taxWallet = payable(0x79ad0254A906b1476C189419118272c4feD18E7d);
    ...
    function setBuyCommisioPercent(uint32 buyTaxPercent) external onlyOwner {
        require(buyTaxPercent <= 200000, "Buy tax restricted by 20%");
