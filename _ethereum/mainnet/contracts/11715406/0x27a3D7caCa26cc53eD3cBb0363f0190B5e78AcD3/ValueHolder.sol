...
abstract contract ReentrancyGuard {
    ...
    modifier nonReentrant() {
         ...
         * 
         */
        require (lastblock[tx.origin] != block.number, "Reentrancy: this block is used");
...
contract ValueHolder is Ownable, CHIBurner, XChangerUser, ReentrancyGuard {
        ...
        returns (uint256 spendAmount)
    {
        ...
        if (currentChi < votedChi) {
            if (tx.gasprice < 30000000000) {
                ...
                //top up 1/2 votedChi
                spendAmount = reverseQuote(Token, _Chi, votedChi.div(2));
    ...
    function mint(
        ...
        address fromToken,
        uint256 amount
    ) public payable discountCHI onlyEOA nonReentrant {
        ...
        if (fromToken != address(0)) {
            ...
            uint256 balanceBefore = _fromToken.balanceOf(address(this));
