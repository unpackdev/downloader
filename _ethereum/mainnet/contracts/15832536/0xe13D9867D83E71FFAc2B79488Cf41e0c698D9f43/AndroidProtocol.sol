...
/*
Unlocking the power of ANDROID
The most used global OS adapting to cryptography and blockchain with the holders generating revenues from the dapps.
Telegram: https://t.me/AndroidProtocol
Twitter: https://twitter.com/androidprotocol
*/
...
contract AndroidProtocol is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0xAc76206550D03dfdc7e392082Be9df29D66B40e8);
    ...
    constructor() ERC20("Android Protocol", "ANDROID") {
        ...
        maxWallet = totalSupply * 30 / 1000; // 3% Max Wallet On Launch
