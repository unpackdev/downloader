...
contract DATO is ERC20{
    uint8 public constant decimals = 18;
    uint256 initialSupply = 1833333333*10**uint256(decimals);

    string public constant name = "DATO TOKEN";
    string public constant symbol = "DATO";

    address payable constant teamAddress = address(0xe2c8083092D6D1fE357AafF08B4394A4441b391A);
