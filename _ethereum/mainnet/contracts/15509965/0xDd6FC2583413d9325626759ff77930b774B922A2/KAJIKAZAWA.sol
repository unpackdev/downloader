...
contract KAJIKAZAWA is ERC20, Ownable {
    ...
    constructor() ERC20( unicode"KAJIKAZAWA", "KAJI") {
        ...
        devWallet = address(0xc963E39cc4Ec1408456B30D3517c6282f07f4a96); // set as dev wallet
