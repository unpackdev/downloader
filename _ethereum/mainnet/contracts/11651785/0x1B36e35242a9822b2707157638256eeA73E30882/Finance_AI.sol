...
Finance AI is a decentralized open-source ecosystem 
that aims to grow and optimize users' monetary value 
...
contract Finance_AI is Context, IERC20, Ownable {
    ...
    string private _name = 'Finance AI';
