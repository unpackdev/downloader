...
/**
 *In the end, the initial number of winners is 5000, which will continue to decrease! In the end, only 100 FLWRs are left, and 3ETH:1FLWR will be recycled.
 *Each transaction will be burned by 20%
 */
...
contract FinalWinner is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Final winner";
string constant tokenSymbol = "FLWR";
