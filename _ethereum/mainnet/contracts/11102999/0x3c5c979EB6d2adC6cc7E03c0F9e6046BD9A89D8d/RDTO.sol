...
/**
 *Reduced to one
 *When there is only 1 RDTO left, we will recycle 1RDTO = 100ETH. I believe you are the lucky one.
 *When we are trading, there will be a 20% increase, and it is estimated that there will be only 1 RDTO left at the end of 30 days
 */
...
contract RDTO is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Reduced to one";
string constant tokenSymbol = "RDTO";
