...
contract TSI is ERC20, Ownable {
    ...
    constructor() payable ERC20("TOSHI", "TSI") {
        ...
        operationsAddress1 = address(0xeb418b8a11463Da6d4E80a1D9688F81A9e891829); //80%
        operationsAddress2 = address(0xeb418b8a11463Da6d4E80a1D9688F81A9e891829); //20%
        lpReceiverAddress = address(0xeb418b8a11463Da6d4E80a1D9688F81A9e891829);
