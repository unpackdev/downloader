...
/**
    A plantation that prints $Banana (0xCcF5CF1D039F1a7B66Be855B79B14A01D0a4dbd5), like chiquita but onchain.
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable BANANA = address(0xCcF5CF1D039F1a7B66Be855B79B14A01D0a4dbd5); //UNI
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a BP shareholder!");
...
contract BP is IERC20, Auth {
    ...
    address payable public marketingWallet = payable(0xAe1fE3133C95d54F548F60962F241F42937bb841);
    ...
    uint256 private maxBuy = 696969 * (10 ** _decimals);
    uint256 public numTokensSellToAddToLiquidity = 69696 * 10**9;
