...
contract CityofMemes {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;
	IERC20 public token;
    // #'s are of 100 so...               200 is 200/100 - 2%, 50 is 0.5%,
	uint256[] public REFERRAL_PERCENTS = [200, 200, 200, 50, 50, 50, 50];
	uint256 constant public TOTAL_REF = 800;           // Total referral fees are 8% 
	uint256 constant public PROJECT_FEE = 300;         // Dev fee is 3%
	uint256 constant public PERCENTS_DIVIDER = 10000;  // 10000 is 100 (percent divider)
	...
	constructor(address tokenAddr, address payable wallet, uint256 start) public {
        ...
        // Rewards are 2.88%, 4.08%, 5.04% and 6%
	...
	function invest(address referrer, uint8 plan) public {
		...
		uint256 rent;
		uint256 total_value;
        // This contract is an ERC20 contract trading in Ethereum USDT therefore ether = USDT.
        if (plan == 0) {
			value = 50 ether;
			rent = 5 ether;
		} else if (plan == 1) {
	...
	function withdraw() public {
        ...
        // You can only withdraw once a day, and the minimum withdrawl is $10 USDT
