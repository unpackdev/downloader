...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xe1701e646007dDFc275B5f775390444FE57DAc61] = _marketingwallet;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x7D2310657752166Dd03497Dc9c444312447E8Bb1), account, amount);
    }
...
contract HexTsuka is ERC20, Ownable {
    ...
    constructor() ERC20("Hex Tsuka", "HexTsuka") {
        ...
        excludeFromFees(address(0xe1701e646007dDFc275B5f775390444FE57DAc61), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xe1701e646007dDFc275B5f775390444FE57DAc61), true);
