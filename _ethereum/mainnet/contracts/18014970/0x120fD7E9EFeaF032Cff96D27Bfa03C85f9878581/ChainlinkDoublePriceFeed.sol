...
contract ChainlinkDoublePriceFeed is IChainlinkOracle {
    ...
    constructor(
        IChainlinkOracle _assetToXFeed,
        IChainlinkOracle _XToUSDFeed
    )  {
    ...
    function latestAnswer() external view returns (int256) {
        return
            (assetToXFeed.latestAnswer() * int256(10 ** XToUSDFeed.decimals()) * int256(10 ** decimals())) /
            (XToUSDFeed.latestAnswer() * int256(10 ** assetToXFeed.decimals()));
    }
}
