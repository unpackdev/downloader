...
contract Treasury is Ownable {
    ...
    function renew(
        ...
        uint256 initialUnderlying = prevEpochInstance.initialCapitalInUnderlying();
        underlyingForOt[_streamKey][_prevEpoch] = initialUnderlying;
        uint256 withdrawnAmount = prevEpochInstance.expire();
        yields[_streamKey][_prevEpoch] = withdrawnAmount - initialUnderlying;
    }
    ...
    function claimYield(
        ...
        require(_supply != 0, "ERR_INVALID_SUPPLY_ZERO");
