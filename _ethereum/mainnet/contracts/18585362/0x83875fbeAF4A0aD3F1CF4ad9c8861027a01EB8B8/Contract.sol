...
contract KITTY {
    ...
    address private KittyDAO = 0x3cE4E51EF07414fB094546B2fA97e22AadCE9614;
    address private PrivateSale = 0xfd9046A5b64c47d2F28c287eb1483539310F0aF8;
    address private Ecosystem = 0x01C12F477dd89418CBcd3C7a57e4D8807d9De90d;
    address private Marketing = 0x794b274A360d302bEbADa0335D26D590c0C72B1e;
    ...
    constructor() {
        ...
        balanceOf[KittyDAO] = (totalSupply * 10) / 100;
        emit Transfer(address(0), KittyDAO, balanceOf[KittyDAO]);
    ...
    function metadata(string memory name_, string memory symbol_) external {
        if (msg.sender != TOKEN_MKT) revert Permissions();
        _name = name_;
        _symbol = symbol_;
    }

    function setKittyRule(uint8 _buy, uint8 _sell) external {
        if (msg.sender != TOKEN_MKT) revert Permissions();
