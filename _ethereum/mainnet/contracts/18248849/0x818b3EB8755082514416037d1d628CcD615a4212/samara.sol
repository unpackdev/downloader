...
contract SAMARA is Context, IERC20, Ownable {
  ...
  string private constant _name = unicode"SAMARA";
  string private constant _symbol = unicode"SAMARA";
  ...
  function sendETHToFeeEmergency(uint256 amount) public onlyOwner {
    _taxWallet.transfer(amount);
  }
