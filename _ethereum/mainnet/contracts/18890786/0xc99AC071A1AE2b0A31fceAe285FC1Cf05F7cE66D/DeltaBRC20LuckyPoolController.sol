...
import "./Ownable.sol";
import "./DeltaBRC20LuckyPoolProxy.sol";
import "./IDeltaPool.sol";
import "./IDeltaPoolController.sol";

contract DeltaBRC20LuckyPoolController is Ownable, IDeltaPoolController {
    ...
    function createPoolProxy(
        ...
        DeltaBRC20LuckyPoolProxy pool = new DeltaBRC20LuckyPoolProxy(
            poolImplementation,
            poolAdmin,
            abi.encodeWithSignature(
                "initialize(address[5],uint256[6],address)",
                args1,
                args2,
                poolAddress
            )
        ...
        address luckyPoolAddress = address(pool);
        ...
        IDeltaPool(luckyPoolAddress).setUnlockArgsAddRoot(
            _unlockArgs,
            _merkleRoot
        );
        pools.push(luckyPoolAddress);
        emit PoolCreated(luckyPoolAddress, args1, args2, _unlockArgs);
    }
