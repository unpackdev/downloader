...
Telegram: https://t.me/ForgTGPortal
Twitter: https://twitter.com/ForgTWERC
Website: https://forg.lol
...
contract Forg  {
    ...
    string public constant name = "Forg";   
    string public constant symbol = "FORG";   
    ...
    address payable constant deployer = payable(address(0x5D7A15f501Ce4cbbdfe8e6bE128Ad79902B532C4));
    ...
    function setFORGTaxes(uint256 newBuyTax, uint256 newSellTax) external {
