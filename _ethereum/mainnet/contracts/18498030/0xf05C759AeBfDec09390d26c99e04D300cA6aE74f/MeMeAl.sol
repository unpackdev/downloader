...
pragma solidity ^0.8.20;
    ...
    contract MeMeAl {
        ...
        address payable constant deployer = payable(address(0x4bdC89f6A947e9d68541ffcDe47D0524F6C6EeDf)); //
        ...
        function setMeMeAl(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
