/**
 * Bitfinexswap
 * Test version tokens, but tokens will be transferred to the official Bitfinexswap proportionally 1:1
 * The tested token is 5000
 * Our feature is to eliminate high gas bills
*/
