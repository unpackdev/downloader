...
Website - https://bipolarbeartoken.com/
X - https://twitter.com/BipolarBearCoin
Telegram - https://t.me/bipolarbearcoin
...
contract BEAR is ERC20, Ownable {
    ...
    constructor () ERC20("Bipolar Bear", "BIBEAR") 
    {   
        address router;
        ...
        _isExcludedFromMaxTxLimit[0x86Db489BbBE153670Aec139b841e447Ba55D0685] = true;  
        marketingWallet = 0x86Db489BbBE153670Aec139b841e447Ba55D0685;
        ...
        _isExcludedFromMaxWalletLimit[0x86Db489BbBE153670Aec139b841e447Ba55D0685] = true;
        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x86Db489BbBE153670Aec139b841e447Ba55D0685] = true; 
    ...
    function excludeAddressFromFees(address account, bool excluded) external onlyOwner{
        require(_isExcludedFromFees[account] != excluded,"Account is already the value of 'excluded'");
        _isExcludedFromFees[account] = excluded;
        emit ExcludeFromFees(account, excluded);
    }

    function setFeeAmount(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
