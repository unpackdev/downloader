...
contract $niretubklativ is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xe1514eB8D203f091C20e99fc35B3a6E9e5Af88c2);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0xe1514eB8D203f091C20e99fc35B3a6E9e5Af88c2;
    ...
    string private _name = "Niretub Klativ";
    string private _symbol = "$niretubklativ";
    uint8 private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 120180000 * 10**_decimals;
    ...
    uint256 private minimumTokensBeforeSwap = 300450 * 10**_decimals;
