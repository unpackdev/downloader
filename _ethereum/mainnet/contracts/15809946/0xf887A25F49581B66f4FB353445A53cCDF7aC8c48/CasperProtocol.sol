...
And we have the logo for it
So shall make a community tg(someone please do)
...
contract CasperProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Casper Protocol";
