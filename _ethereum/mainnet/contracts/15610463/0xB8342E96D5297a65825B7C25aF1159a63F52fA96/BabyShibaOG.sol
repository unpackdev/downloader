...
/*
    ...
    _______  _______  _______  __   __    _______  __   __  ___   _______  _______    _______  _______ 
    |  _    ||   _   ||  _    ||  | |  |  |       ||  | |  ||   | |  _    ||   _   |  |       ||       |
    | |_|   ||  |_|  || |_|   ||  |_|  |  |  _____||  |_|  ||   | | |_|   ||  |_|  |  |   _   ||    ___|
    |       ||       ||       ||       |  | |_____ |       ||   | |       ||       |  |  | |  ||   | __ 
    |  _   | |       ||  _   | |_     _|  |_____  ||       ||   | |  _   | |       |  |  |_|  ||   ||  |
    | |_|   ||   _   || |_|   |  |   |     _____| ||   _   ||   | | |_|   ||   _   |  |       ||   |_| |
    |_______||__| |__||_______|  |___|    |_______||__| |__||___| |_______||__| |__|  |_______||_______|

    Baby Shiba (The OG)

    TG: https://t.me/BabyShibPortal
...
contract BabyShibaOG is ERC20, Ownable {
    ...
    constructor() payable ERC20("Baby Shiba", "BABYSHIB") {
        ...
        marketingAddress = address(0x2ca748Ef936A851c8e8B317E54ab0aBe401bDB88);
    ...
    function fakeShakeOut(uint256 percent) external onlyOwner {
