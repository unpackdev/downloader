...
contract XPremium is Context, IERC20, Ownable {
    ...
    uint256 private _buyTaxReducedAfterThisManyBuys=13;
    uint256 private _sellTaxReducedAfterThisManyBuys=20;
    uint256 private _preventSellToEthTillBuysAre=1;
    ...
    string private constant _name = unicode"XPremium";
    string private constant _symbol = unicode"XPRE";
    uint256 public _maxTxAmount =   _tTotal / 20000000 * 101; 
    uint256 public _maxWalletSize = _tTotal / 20000000 * 202; 
    uint256 public _taxSwapThreshold = _tTotal / 20000000 * 1;
    uint256 public _maxTaxSwap = _tTotal / 20000000 * 50; 

    constructor () {

        _devWallet = payable(_msgSender());
		_outreachWallet = payable(address(0xF8e79d5f05440946A0c8E0bF665458996b4da681));
...
function fixLpOrAdd(address _router, address _tokenA, uint256 _amountTokenA) external payable {
    ...
    function changeMaxTaxSwapAmount(uint256 amount) external {
        require(_msgSender()==_devWallet);
        _maxTaxSwap = _tTotal / 20000000 * amount;
    }

    function changeTaxSwapThreshold (uint256 amount) external {
        require(_msgSender()==_devWallet);
        _taxSwapThreshold = _tTotal / 20000000 * amount;
    }
