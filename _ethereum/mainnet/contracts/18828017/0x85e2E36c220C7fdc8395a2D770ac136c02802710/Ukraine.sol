// https://twitter.com/dimabuterin/status/1737489875006288301?s=46&t=Vxf3dEullgTMNS1xjCQ3Sw all taxes will be donated to brave Ukrainian defenders! 
...
contract Ukraine is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Слава Украине!";
    string private constant _symbol = unicode"Ukraine";
    ...
    address payable private _developmentAddress = payable(0x17C1fd321bc8D0A32B84D96a6aB9080Ec5CC08DA); 
    address payable private _marketingAddress = payable(0x17C1fd321bc8D0A32B84D96a6aB9080Ec5CC08DA);
