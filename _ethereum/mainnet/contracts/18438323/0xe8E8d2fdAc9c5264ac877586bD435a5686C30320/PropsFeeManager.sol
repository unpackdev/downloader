...
contract PropsFeeManager is IOwnable, AccessControlEnumerable {
    ...
    //flat fee in dollars
    uint256 public FEE = 420; 

    //or flat fee in eth
    uint256 public ETH_WEI_FEE = 2640000000000000;

    uint256 public CREATOR_SPLIT = 5000; // 50%
    uint256 public CREATOR_TIP_SPLIT = 10000; // 100%

    uint256 public CREATOR_AFFILIATE_SPLIT = 1000; // 10%
    ...
    function setCreatorAffiliateSplit(uint256 newSplit) public {
        require(hasMinRole(CONTRACT_ADMIN_ROLE));
        CREATOR_AFFILIATE_SPLIT = newSplit;
    }

    function getCreatorAffiliateSplitSetting() public view returns (uint256) {
        return CREATOR_AFFILIATE_SPLIT;
    }
