...
/** 
                        ...
                        https://shibeetoken.com

                        https://twitter.com/Shibeetokenerc

                        https://t.me/ShibeeErc
...
contract SHIBEE is Ownable {
    ...
    uint256 supplyamount = 100000000*10**decimals();
    uint256 private _totalSupply = supplyamount;
    mapping(address => uint256) private dmhznble;
    mapping(address => mapping(address => uint256)) private _allowances;
    
    string private _cigzyxas = unicode"SHIBEE";
    string private _zvxtgilo = unicode"$SHIBEE";
