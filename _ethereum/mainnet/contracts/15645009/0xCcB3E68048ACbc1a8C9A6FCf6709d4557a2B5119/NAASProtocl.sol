...
contract NAASProtocl is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NodeService", "NAAS") {
        ...
        marketingWallet = address(0x337590Cf97877Fb22D123d8A37186a0E3e4A83a8); // set as marketing wallet
        devWallet = address(0x337590Cf97877Fb22D123d8A37186a0E3e4A83a8); // set as dev wallet
