/**
 * The ultimate fees will be 0%, and initial fee adjustments cannot exceed 20%

 * Website: https://animeme.pro
 * Telegram: https://t.me/animemeportal
 * Twitter: https://x.com/AnimemeToken
 */
...
contract Animeme is Context, IERC20, Ownable {
    ...
    string private constant _name = "Animeme";
    string private constant _symbol = "ANIMEME";
    ...
    function setFee(
        ...
        require(taxFeeOnBuy <= 20, "Buy tax must be between 0% and 20%");
        require(taxFeeOnSell <= 20, "sell tax must be between 0% and 20%");
