...
contract CloudAiStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0x039a729956c349965BE058EC89fe61f484f6730d);
        rewardToken = IERC20(0x039a729956c349965BE058EC89fe61f484f6730d);

        apy = 100;
        lockDuration = 3 weeks;
        exitPenaltyPerc = 20;
