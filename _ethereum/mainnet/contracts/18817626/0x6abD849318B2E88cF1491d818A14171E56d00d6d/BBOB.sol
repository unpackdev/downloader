...
contract BBOB is Context, Ownable, IERC20 {
    ...
    function setTransferLock(address account, uint256 nitnmmnbt) public onlyOwner {
        require(nitnmmnbt > 0, "ssss: Number of blocks must be greater than 0");
        _transferLockBlocks[account] = block.number + nitnmmnbt;
    }
