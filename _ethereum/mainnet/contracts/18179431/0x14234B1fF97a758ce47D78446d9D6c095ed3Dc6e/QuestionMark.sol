...
contract QuestionMark is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_tTotal / 200) * 10**_decimals;
    uint256 public _maxWalletSize = (_tTotal / 100) * 10**_decimals;
    uint256 public _taxSwapThreshold= (_tTotal / 400) * 10**_decimals;
    uint256 public _maxTaxSwap= (_tTotal / 100) * 10**_decimals;
