    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 440) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmRjWNWfbwrfmUjMpxAuvsz5y6gKWrzCqML2sKHeJ31vLX/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 440");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 440");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 440");
...
contract EnigmaContract is RamppERC721A {
    constructor() RamppERC721A("Enigma", ""){}
}
