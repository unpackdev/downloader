...
/**
 *10 million supply, 5% burn per day, 100% liquidity added to uniswap pool
*/
interface ERC20 {
...
contract UniNuke is ERC20 {
  ...
  string public constant name  = "UniNuke";
  string public constant symbol = "UNUKE";
