...
MergeChain
The Merge is ongoing of ETHEREUM and It's expected to be completed by Late Sept.
MergeChain is a Low tax Chain Meta that adds upon the Hype of Merge and Chain.

Initial Tax is 6/6
Unicrypt lock for 6 Months.
Renounced at Launch.
...
contract MergeChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "MergeChain";
    string private constant _symbol = "MergeChain";
