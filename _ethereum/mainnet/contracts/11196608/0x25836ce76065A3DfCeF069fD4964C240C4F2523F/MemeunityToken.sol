...
contract Owned {
    ...
    constructor() public {
        owner = 0xD366503FA0A37f2B976e801bB73A36F346EE7BFC;
    }
...
contract MemeunityToken is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "MUU";
        name = "Memeunity Token";
        decimals = 18;
        _totalSupply = 2000000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
         RATE = 2000;            // 2000 MUU per ETH
        DENOMINATOR = 1;         // 1 ETH = 2000 MUU
