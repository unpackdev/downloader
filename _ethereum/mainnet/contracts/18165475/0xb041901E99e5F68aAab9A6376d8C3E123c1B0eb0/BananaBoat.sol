...
Banana Boat the only crypto you need while trading in the sun!

https://t.me/bananaboatETH 
...
contract BananaBoat is Context, IERC20, Ownable {
    string private _name = "Banana Boat";
    string private _symbol = unicode"$Банановая лодка";
    ...
    constructor() {
        ...
        marketingWallet = address(0xDb72D97BB3eAEa43b70A5E2BE202631B4126af43);
