...
contract blky is ERC20, Ownable {
 using SafeMath for uint256;
 ...
 constructor() ERC20("Blockify", "BLKY") {
 
 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0x4dB736030630525712F29e58EEbE9d686ecf4A1B);
 marketingWallet = address(0x4dB736030630525712F29e58EEbE9d686ecf4A1B);
...
//Limits
 ...
 function updateBlockyTxnAmount(uint256 newMaxBuy, uint256 newMaxSell) external onlyOwner {
 ...
 function updateBlockyWalletAmount(uint256 newPercentage) external onlyOwner {
 ...
 function updateBLOCKFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
