    ...
    OnChainPollInterface
{
    ...
    { 
        ...
        for (uint8 index = 0; index < pollsLength; index++) {
           PollClaimReward memory pollClaimRewardDetail = pollsReward[index];
    ...
    { 
        ...
        for (uint8 index = 0; index < endCompetitionsLength; index++) {
            ...
            balanceOfContract = balanceOfContract.sub(endCompetitionDetail.amount);
        } 
