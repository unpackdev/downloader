...
contract BatchTransfer {
    /// @notice Use this function to batch transfer tokens from one address to another.
    ...
    function bTransfer(ERC721Partial tContract, address from, address recipient, uint256[] calldata tokenIds) external {
