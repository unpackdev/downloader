...
contract DESYNC is ERC20, Ownable {
    ...
    constructor() ERC20("Desync", "DESYNC") {
        ...
        devWallet = address(0x8050F0CE29185C41AC0d1654642E60Bc7AfB6311); // set as dev wallet
        MarketingWallet = address(0x8050F0CE29185C41AC0d1654642E60Bc7AfB6311); // set as mkt wallet
