...
contract PepeLama is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Lama";
    string private constant _symbol = unicode"PEPELAMA";
