...
contract HEIMER is ERC20, Ownable {
    ...
    constructor() ERC20("Oppenheimer", "HEIMER") {
        ...
        uint256 totalSupply = 190419451967 * 1e18;

        maxTransactionAmount = 1904194519 * 1e18; // 1%
        maxWallet = 1904194519 * 1e18; // 1% 
        ...
        revShareWallet = address(0x40601EC6699d00A6EE108B59a3A5a18F1831016c); // set as revShare wallet
    ...
    function withdrawStuckHeimer() external onlyOwner {
