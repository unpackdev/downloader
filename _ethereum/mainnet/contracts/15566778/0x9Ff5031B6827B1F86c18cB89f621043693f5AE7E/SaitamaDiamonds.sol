...
contract SaitamaDiamonds is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Saitama Diamonds", unicode"💎💎") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x180fd70641a765bdaae562Cda8556B8821EabEDe); // marketing wallet
        devWallet = address(0x180fd70641a765bdaae562Cda8556B8821EabEDe); // dev wallet
