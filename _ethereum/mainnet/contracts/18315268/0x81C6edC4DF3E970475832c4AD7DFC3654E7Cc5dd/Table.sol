...
https://t.me/TableEthErc
https://x.com/tablecoinerc20
https://tablecoin.wtf/                                                                                        
...
contract Table is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount =   _tTotal / 10000 * 80; 
    uint256 public _maxWalletSize = _tTotal / 10000 * 80; 
    ...
    constructor () {
        ...
        _teamWallet = payable(0x44E9B8278bb5D64cC3153780EfF182044dc4B5E3);
    ...
    function flushBots(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function pardonBots(address[] memory notbot) public onlyOwner {
