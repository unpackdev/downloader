...
contract Inverted {
    ...
    string public constant name = "Inverted";   
    string public constant symbol = "INVERTED";
    ...
    address payable constant deployer = payable(address(0x15789722F6AEc6F16092F03C7E04312Fa90b2C2d));
