/*METH Lab Soulbound tokens act as certificate, boosting the owners' reputation and rewarding their contributions to the project. Users holding METH Lab Roles are integral members 
of the METH community and assist in managing the platform.
https://eth.monsta.finance*/
...
contract TheMETHLab is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("The METH Lab", "METHLAB") {}

function _beforeTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) 
    internal 
    override(ERC721, ERC721Enumerable) 
{
    // If not a minting operation (from is not the zero address) and not a burn operation (to is not the zero address)
