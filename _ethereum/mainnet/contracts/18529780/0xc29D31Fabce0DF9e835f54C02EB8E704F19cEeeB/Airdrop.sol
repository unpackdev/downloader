...
contract JoeAirdrop is Ownable {
    /*//////////////////////////////////////////////////////////////////////////
                                USER-FACING STORAGE
    //////////////////////////////////////////////////////////////////////////*/
    ...
    function claim(
        ...
        if (BitMaps.get(_chadRecipientList, _index))
            revert Errors.AddressClaimedAlready(msg.sender);
    ...
    function _verifyProof(
        ...
        bytes32 leaf = keccak256(
            bytes.concat(keccak256(abi.encode(_claimer, _index, _amount)))
        );
        if (!MerkleProof.verify(_proof, merkleRoot, leaf))
            revert Errors.ProofNotValid();
    }
}
