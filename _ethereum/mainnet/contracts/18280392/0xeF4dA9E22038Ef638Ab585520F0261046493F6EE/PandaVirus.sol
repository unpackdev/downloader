...
Panda Burning Incense Is About to Sweep the Crypto World

https://t.me/PandaVirusETH
https://twitter.com/PandaVirusETH
https://pandavirus.space
...
contract PandaVirus {
    ...
    string public constant name = "Panda Virus";   
    ...
    address payable constant deployer = payable(address(0x011556697846EC6d0ec927f7A95662aE826F7cF1));
    ...
    function setPANDA(uint256 newGet, uint256 newSpend) external {
