...
contract EffectiveAltruism is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Effective Altruism";
    ...
    address payable private _devAddress = payable(0xc936451011ec2c42A148B5e181c5fC7D25A60A82); 
    address payable private _marketingAddress = payable(0xc936451011ec2c42A148B5e181c5fC7D25A60A82);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _devAddress.transfer(amount.mul(2).div(5));
    }
 
    function setLaunch(bool _tradingOpen) public onlyOwner {
