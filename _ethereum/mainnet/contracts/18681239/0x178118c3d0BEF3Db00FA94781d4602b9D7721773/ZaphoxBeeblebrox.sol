...
contract ZaphoxBeeblebrox is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Beeblebrox";
    string private constant _symbol = unicode"BEEB";
