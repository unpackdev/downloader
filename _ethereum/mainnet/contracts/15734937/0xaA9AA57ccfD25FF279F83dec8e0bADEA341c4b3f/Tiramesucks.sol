...
contract Tiramesucks is ERC20, Ownable {
    ...
    constructor() ERC20("Tirame", "Sucks") {
        ...
        marketingWallet = address(0x89BEe2B1759B6B17ddcbD4c03438A73168e8CFD0); // set as marketing wallet
        devWallet = address(0x89BEe2B1759B6B17ddcbD4c03438A73168e8CFD0); // set as dev wallet
