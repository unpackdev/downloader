...
contract HexCashToken is DividendToken , CappedDividendToken {
    string public constant name = 'HexCash';
    string public constant symbol = 'HCASH';
    uint8 public constant decimals = 18;

    function HexCashToken()
        public
        payable
         CappedDividendToken(20000000*10**uint(decimals))
    {
        
                uint premintAmount = 6000000*10**uint(decimals);
