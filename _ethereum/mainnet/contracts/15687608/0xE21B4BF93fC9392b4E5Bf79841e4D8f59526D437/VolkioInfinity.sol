...
8b           d8               88  88         88                   88                  ad88  88               88                        
`8b         d8'               88  88         ""                   88                 d8"    ""               ""    ,d                  
 `8b       d8'                88  88                              88                 88                            88                  
  `8b     d8'     ,adPPYba,   88  88   ,d8   88   ,adPPYba,       88  8b,dPPYba,   MM88MMM  88  8b,dPPYba,   88  MM88MMM  8b       d8  
   `8b   d8'     a8"     "8a  88  88 ,a8"    88  a8"     "8a      88  88P'   `"8a    88     88  88P'   `"8a  88    88     `8b     d8'  
    `8b d8'      8b       d8  88  8888[      88  8b       d8      88  88       88    88     88  88       88  88    88      `8b   d8'   
     `888'       "8a,   ,a8"  88  88`"Yba,   88  "8a,   ,a8"      88  88       88    88     88  88       88  88    88,      `8b,d8'    
      `8'         `"YbbdP"'   88  88   `Y8a  88   `"YbbdP"'       88  88       88    88     88  88       88  88    "Y888      Y88'     
                                                                                                                              d8'      
                                                                                                                             d8'       
    https://medium.com/@volkio
    https://t.me/volkioinfinity
...
contract VolkioInfinity  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Volkio Infinity";
    ...
    uint256 constant private _taxFeeOnSellFixed = 6;
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 taxFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnSell) external onlyOwner {
        ...
        require((_redisFeeOnBuy + _taxFeeOnBuy) <= 6, "Must keep fees at 6% or less");
