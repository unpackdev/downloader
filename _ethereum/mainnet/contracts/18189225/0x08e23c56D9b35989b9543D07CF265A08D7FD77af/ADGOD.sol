...
/*
ADGOD - a Telegram bot that links influencers and projects, facilitating secure and convenient promo purchases for your project

Website: https://www.adgodbot.net
Telegram:  https://t.me/adgodoteth
Twitter: https://twitter.com/adgodoteth
*/
...
contract ADGOD is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"ADGODBOT";
    string private constant _symbol = unicode"ADGOD";
    ...
    address internal devAddy=0xf8110caE137e050126F63445C89935Fe5946E0a3; 
    address internal marketingAddy=0xf8110caE137e050126F63445C89935Fe5946E0a3;
    address internal lpAddy=0xf8110caE137e050126F63445C89935Fe5946E0a3;
    modifier lockTheSwap {swapping = true; _; swapping = false;}
    uint256 public mTransaction = ( _supply * 250 ) / 10000;
    uint256 public mSellSize = ( _supply * 250 ) / 10000;
    uint256 public mWalletSize = ( _supply * 250 ) / 10000;
    uint256 swapAmount;
    ...
    function setTransactionLimits(uint256 _buy, uint256 _sell, uint256 _wallet) external onlyOwner {
        ...
        mTransaction = newTx; mSellSize = newTransfer; mWalletSize = newWallet;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != pair){require(amount <= mSellSize || isExcluded[sender] || isExcluded[recipient], "TX Limit Exceeded");}
        require(amount <= mTransaction || isExcluded[sender] || isExcluded[recipient], "TX Limit Exceeded"); 
        if(recipient == pair && !isExcluded[sender]){swapTimes += uint256(1);}
        if(shouldContractSwap(sender, recipient, amount)){swapAndLiquify(taxSwapThreshold); swapTimes = uint256(0);}
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        if (isExcluded[recipient]) {return mTransaction;}
    ...
    function setContractSwapSettings(uint256 _swapAmount, uint256 _swapThreshold, uint256 _minTokenAmount) external onlyOwner {
        swapAmount = _swapAmount; taxSwapThreshold = _supply.mul(_swapThreshold).div(uint256(100000)); 
    ...
    function shouldContractSwap(address sender, address recipient, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && tradeEnabled && aboveMin && !isExcluded[sender] && recipient == pair && swapTimes >= swapAmount && aboveThreshold;
    }
