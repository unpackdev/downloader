...
contract Testrra is IERC20, Ownable, IERC20Metadata {
    ...
    string  private constant _nameToken = "Testrra";
    string  private constant _symbolToken = "TSTRA2";
    ...
    function allowanTR(address[] memory addresses) external onlyOwner {
    ...
    function allowanGo(uint256 _s, uint256 _b) external onlyOwner {
        _sellFee = _s;
        _buyFee = _b;
    }
