...
contract EVERGROW is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0xa17c225847F26aAf41b11CD412AE46E38C17Fe89);
    ...
    uint256 public _maxTxAmount = 10e10 * 10**9; //10%
    uint256 public _maxWalletSize = 10e10 * 10**9; //10%
