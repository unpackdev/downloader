...
contract CHNOPSGreenhouse is ICHNOPS, ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, ERC2981 {
  ...
  function totalSupply() public view virtual override(ERC721A, ICHNOPS) returns (uint256) {
    return ERC721A.totalSupply();
  }

  function name() public view override(ERC721A, ICHNOPS) returns (string memory) {
    return ERC721A.name();
  }

  function symbol() public view override(ERC721A, ICHNOPS) returns (string memory) {
