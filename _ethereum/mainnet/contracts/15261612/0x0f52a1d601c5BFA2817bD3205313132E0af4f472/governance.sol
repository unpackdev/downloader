...
contract BerserkerGovernance is GovernorInterface, GovernorEvents {
    ...
    uint256 public constant MIN_VOTING_DELAY = 24 hours;

    /// @notice The max setable voting delay
    uint256 public constant MAX_VOTING_DELAY = 1 weeks;

    /// @notice The interval time between proposals of one member
    uint256 public constant INTERVAL_TIME = 1 weeks;
