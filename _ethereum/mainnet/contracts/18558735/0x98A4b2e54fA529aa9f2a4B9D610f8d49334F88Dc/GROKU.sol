...
contract GROKU is Ownable, ERC20 {
    ...
    string constant _name = "GROK inU";
    string constant _symbol = "GROKU";
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(3);
    uint256 public _maxWalletToken = _totalSupply.mul(1).div(3);
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x97020238fe844205B9EA95eea131E9735f9f04Ce;
