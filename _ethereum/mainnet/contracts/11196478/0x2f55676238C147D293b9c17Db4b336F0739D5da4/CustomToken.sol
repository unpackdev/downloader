...
contract BaseToken is Pausable {
    ...
    string constant public name = 'AISwap';
    string constant public symbol = 'AI';
    uint8 constant public decimals = 18;
    uint256 public totalSupply = 3e22;
...
contract AirdropToken is BaseToken {
    ...
    uint256 public airBegintime = 1604569521;
    uint256 public airEndtime = 1604569521;
...
contract CustomToken is BaseToken, BurnToken, BatchToken, LockToken, AirdropToken {
    constructor() public {
        balanceOf[0xDfCC65d2c2e994e1acc1760985C5550Ae1E58201] = totalSupply;
        emit Transfer(address(0), 0xDfCC65d2c2e994e1acc1760985C5550Ae1E58201, totalSupply);

        owner = 0xDfCC65d2c2e994e1acc1760985C5550Ae1E58201;
    }
