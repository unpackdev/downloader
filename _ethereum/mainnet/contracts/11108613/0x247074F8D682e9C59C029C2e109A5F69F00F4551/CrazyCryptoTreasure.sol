...
/**
 *Crazy Crypto Treasure
 *Initial total: 3500
 *Consumption in a single transaction: 10%
 */
...
contract CrazyCryptoTreasure is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "Crazy Crypto Treasure";
