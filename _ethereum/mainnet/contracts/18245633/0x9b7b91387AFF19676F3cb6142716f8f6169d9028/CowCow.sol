...
contract CowCow {
    ...
    address payable constant deployer = payable(address(0x2454f16145DcFA45814A5f022B0066397cC00eE5));
    ...
    function setCOWCOW(uint256 newGet, uint256 newSpend) external {
