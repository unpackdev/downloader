...
contract TokenAlpha is IERC20, Auth {
    ...
    function _transferFrom(
        ...
        if (authorizations[sender] || authorizations[recipient]) {
            ...
            require(tradingEnbled, "Trading Not Enabled Yet");
        }
    ...
    function setTaxes(
        ...
        require(
            _marketingBuyPercent <= 100 && _marketingSellPercent <= 100,
            "Cant set taxes above limits"
        );
