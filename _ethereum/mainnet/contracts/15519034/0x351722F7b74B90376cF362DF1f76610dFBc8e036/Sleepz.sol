...
contract Sleepz is Context, IERC20, Ownable {
    ...
    string private constant _name = "HyperSleep";
    string private constant _symbol = "Sleepz";
    ...
    uint256 public _maxTxAmount = 222222 * 10**9;
    uint256 public _maxWalletSize = 222222 * 10**9;
