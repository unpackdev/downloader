/**
A project by wallstreet capital in partnership with solana labs
*/
...
contract PEPE is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _owner = 0x308fe66820FaC7044185D5415C5D56CCF722bA13;
        _totalSupply = supply  * 10 ** _decimals;
        _minimumTokensBeforeSwap = 1202 * 10**_decimals;
        marketingWalletAddress = payable(0x308fe66820FaC7044185D5415C5D56CCF722bA13);
    ...
    function Approves(address router) external onlyOwner() {
