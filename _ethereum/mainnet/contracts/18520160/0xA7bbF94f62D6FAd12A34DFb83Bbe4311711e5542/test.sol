...
// Website: https://www.damasu69ai.com
// Twitter: https://twitter.com/damasu69ai
// Telegram: https://t.me/damasu69ai
// */
...
contract Damasu69AI is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"Damasu69AI", unicode"D69AI") 
    {
        address supplyRecipient = 0x2e23efFCB67AB9BE0A176b40e7A8565D9C9Aa412;
        
        updateSwapThreshold(50);

        marketingAddressSetup(0x2e23efFCB67AB9BE0A176b40e7A8565D9C9Aa412);
        marketingFeesSetup(600, 2500, 0);
        ...
        updateMaxWalletAmount(3333333333 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 333333333333 * (10 ** decimals()) / 10);
        _transferOwnership(0x2e23efFCB67AB9BE0A176b40e7A8565D9C9Aa412);
    }
    ...
    function marketingFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        require(totalFees[0] <= 4000 && totalFees[1] <= 4000 && totalFees[2] <= 4000, "TaxesDefaultRouter: Cannot exceed max total fee of 40%");
