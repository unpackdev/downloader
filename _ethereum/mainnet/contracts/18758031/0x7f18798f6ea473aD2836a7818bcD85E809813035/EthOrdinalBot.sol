// Twitter: https://twitter.com/EthOrdiBot
// Telegram: https://t.me/ordeth
...
contract EthOrdinalBot is ERC20, Owned {
    mapping (address => bool) isFeeExempt;

    // Fee decrementation schedule
    uint256 private constant startingFee = 200;
    uint256 private constant intermediateFee = 150;
    uint256 private constant finalFee = 50;
    ...
    uint256 private constant whalePercent = 3;
    ...
    constructor (address _marketing) Owned(msg.sender) ERC20("Eth Ordinal Bot", "ORDETH", 18) {
        marketing = _marketing;
        address factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;

        startingBlock = block.number;
        taxLowerBlockIntermediate = startingBlock + 25;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        if (fee == intermediateFee && block.number > taxLowerBlockFinal) {
            fee = finalFee;
        }
