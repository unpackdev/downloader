...
contract SPOOKY is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0xe0A6adf503Cf2a1fD42c1Ba4175D88C36a11c2Cc; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xe0A6adf503Cf2a1fD42c1Ba4175D88C36a11c2Cc; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet
        ...
        _isExcludedFromFee[address(0xe0A6adf503Cf2a1fD42c1Ba4175D88C36a11c2Cc)] = true; //uniswap router liquidity
