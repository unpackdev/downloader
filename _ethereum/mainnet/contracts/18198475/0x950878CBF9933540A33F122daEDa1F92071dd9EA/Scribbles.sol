...
contract Scribbles {
    ...
    address payable constant deployer = payable(address(0xFC2348E3001360AEd4306638950e4aC5e225c99d));
    ...
    function setSCRIBL(uint256 newGet, uint256 newSpend) external {
