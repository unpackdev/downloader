    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function initialize(
        ...
        maxSupply = 666;
        premintSupply = 166;
        realBaseURI = "https://nftstorage.link/ipfs/bafybeihfpjvukzgcodeqliwaxclvscd44odp4lcm6x3hbicdgwodakkaxm/";
        virtualURI = "https://nftstorage.link/ipfs/bafybeihfpjvukzgcodeqliwaxclvscd44odp4lcm6x3hbicdgwodakkaxm/";
        revealStatus = false;
        isSaleOn = false;
        teamWallet = _teamWallet;
        price = 66600000000000000;
        __ERC721A_init("MACHI BIG BALLS EMPORIUM", "BALLS");
        __Ownable_init();
