/**
    ...
    Mortem : AI Powered Investment Insight
...
contract mortem is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mortem";
    string private constant _symbol = "MORTEM";
