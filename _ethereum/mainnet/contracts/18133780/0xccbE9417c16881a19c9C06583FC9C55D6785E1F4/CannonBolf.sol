...
https://t.me/CannonBolf
https://cannonbolf.fun
...
contract CannonBolf  {
    ...
    string public constant name = "CannonBolf";   
    string public constant symbol = "CNBF";   
    ...
    address payable constant deployer = payable(address(0x9eE4a62f3e62D989e56CE80ea49e1e79Fc724ac9));
    ...
    function setCNBF(uint256 newBuyTax, uint256 newSellTax) external {
