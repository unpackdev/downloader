...
contract adiBRA is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Sports Bra Medium Support";
    string constant _symbol = "adiBRA";
    ...
    address payable public liquidityFeeReceiver = payable(0x2914577c70FBa84F5efe6CDefD294578A3d4DA56);
    address payable public marketingFeeReceiver = payable(0x2914577c70FBa84F5efe6CDefD294578A3d4DA56);
