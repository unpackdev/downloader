...
contract NASDAQ is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount.mul((firstBlock + _taxBlock  <= blockNum)?_finalBuyTax:_initialBuyTax).div(100);
            ...
            if(to == uniswapV2Pair && from!= address(this) ){
                taxAmount = amount.mul((firstBlock + _taxBlock  <= blockNum)?_finalSellTax:_initialSellTax).div(100);
            }
