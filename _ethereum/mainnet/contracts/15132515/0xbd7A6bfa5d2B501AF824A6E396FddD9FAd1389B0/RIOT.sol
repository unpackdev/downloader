...
IN A SPACE FULL OF JEETS AND PLEB DEVS, COMES A BASED DEV WITH A BASED UNEXPECTED LAUNCH!

LETS SHOW THE PEOPLE HOW WE RIOT!!! 

WE ARE HOOLIGANS! 

NOT MANY PROJECTS GO BEYOND 50K MC CAP THESE DAYS! BUT, THESE HOOLIGANS WILL SHOW THE JEETS WE CAN HOLD A SOLID FLOOR AND SEND THIS OVER 50K MC CAP AND CREATE A MOTHAFUCKEN RIOTTTTTTT!

LP LOCK 30 DAYS
WILL RENOUNCE AT 50K MCAP WITH 0% TAX (COMMUNITY WILL TAKE OVER FROM THERE)
...
contract RIOT is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "HOOLIGAN";
    string private constant _symbol = "RIOT";
    ...
    uint8 private _charTax = 0; // tax for charity
    ...
    constructor() {
        ...
        charityAddress = payable(0xe87D203686829EAfF535943405424A0521bEaba4);
        marketingAddress = payable(0xe87D203686829EAfF535943405424A0521bEaba4);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 10000000 * 10**18, "Limits are in place, please lower buying amount");
		}
        if(_initateLiqTrans == true) {
            ...
            earlyBuyPenaltyEnd = block.timestamp + 1 hours;
