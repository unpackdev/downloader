/* TWITTER: https://twitter.com/youranonnews
/ WEBSITE: https://youranon.news/
/ TELEGRAM: https://t.me/ANONYMOUSTOKENERC20
*/
...
contract ANONYMOUSTOKEN is ERC20, Ownable {
    uint256 _startTime;
    address pool;
    uint256 public constant startTotalSupply = 1e30;
    uint256 constant _maxWalletPerSecond =
        (startTotalSupply / 100 - _startMaxBuy) / 900;
    uint256 constant _startMaxBuy = startTotalSupply / 100000;

    constructor() ERC20("ANONYMOUS TOKEN", "ANON") {
