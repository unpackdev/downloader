...
contract ZK_Email is Context, IERC20, Ownable {
    ...
    uint256 private _midBuyTax=19;
    uint256 private _initialSellTax=26;
    uint256 private _midSellTax=19;
    ...
    uint256 private constant _tTotal = 2121212121212121212000 * 10**_decimals;
    string private constant _name = unicode"ZK Email";
    string private constant _symbol = unicode"ZK-E";
    uint256 public _maxTxAmount =   21212121212121212120 * 10**_decimals;
    uint256 public _maxWalletSize = 21212121212121212120 * 10**_decimals;
    uint256 public _taxSwapThreshold= 21212121212121212120 * 10**_decimals;
    uint256 public _maxTaxSwap= 21212121212121212120 * 10**_decimals;
