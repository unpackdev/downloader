/**
 *   Telegram : https://t.me/ShibaAndPepe
 *   Website  : https://www.shibaandpepe.com/
...
contract ShibaAndPepe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba And Pepe","SHIPE")  {
        
        address newOwner = address(0xc022661E52DEd85B85176f586e79c83Bb22ad0Fa);
    	...
    	marketingWallet = address(0xc022661E52DEd85B85176f586e79c83Bb22ad0Fa); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xc022661E52DEd85B85176f586e79c83Bb22ad0Fa),
            block.timestamp
        );
