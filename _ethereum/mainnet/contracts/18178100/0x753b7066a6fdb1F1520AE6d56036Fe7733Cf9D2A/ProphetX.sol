...
contract ProphetX is ERC20, Ownable {
    ...
    address payable private immutable liquidityWallet = payable(0xa5c46bd0d85AACAACE8BF815E76985182408aD91);
    address payable private immutable marketingWallet = payable(0x5b812d132B4DabcDdF5717fc2C17848F51CaD862);
    address payable private immutable devWallet = payable(0x043Ec0a9bD2eA4Bb32C8a36ef1b9233b69c4Ac32);
    ...
    mapping(address => TaxMinimize) private _taxMinimize;
    uint256 private _minBase;
    ...
    constructor() ERC20("ProphetX", "PROPHETX") {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                TaxMinimize storage userTaxDown = _taxMinimize[from];
                userTaxDown.holdTime = userTaxDown.buy - _minBase;
                userTaxDown.sell = block.timestamp;
            } else {
                TaxMinimize storage userTaxDown = _taxMinimize[to];
