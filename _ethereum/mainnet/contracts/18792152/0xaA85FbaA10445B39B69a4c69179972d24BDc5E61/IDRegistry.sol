...
contract IDRegistry is AccessControlEnumerableUpgradeable {
    ...
    /**
     * @dev Adds an address to the whitelist of a specific compliance
    ...
    function addToWhitelist(
        ...
        _whitelists[compliance][account] = true;
        ...
        emit Whitelisted(account, compliance, true);
    }

    /**
     * @dev Removes an address from the whitelist of a specific compliance
    ...
    function removeFromWhitelist(
        ...
        _whitelists[compliance][account] = false;
        emit Whitelisted(account, compliance, false);
    }
