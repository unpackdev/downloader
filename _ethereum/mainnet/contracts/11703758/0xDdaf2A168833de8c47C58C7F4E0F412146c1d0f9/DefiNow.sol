...
contract DefiNow is ERC1155Tradable {
    constructor(address _proxyRegistryAddress)
        public
        ERC1155Tradable("DeFi NOW", "DFN", _proxyRegistryAddress)
    {
        _setBaseMetadataURI("https://api.definow.tech/api/item/");
    }

    function contractURI() public pure returns (string memory) {
        return "https://api.definow.tech/api/contract";
    }
}