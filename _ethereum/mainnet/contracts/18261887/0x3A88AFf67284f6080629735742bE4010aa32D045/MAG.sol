...
/*
* @title MAG - Metashima by Dimension Studio
* @author lileddie.eth (@lileddie_eth) / Enefte Studio
*/

contract MAG is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString(),"/mag")) : "";
    }
    ...
    constructor() ERC721("Metashima", "MAG") {
        _owner = msg.sender;
    }
