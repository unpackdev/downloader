...
/*
Ready Player One revolves around a dystopian future where society heavily relies on a vast virtual reality universe to escape the challenges of the real world. 

Within this digital realm, users can be anyone or do anything they desire, leading to a high-stakes quest that holds the key to immense power and wealth. 

This coin explores themes of escapism, nostalgia, and the impact of technology on human lives.

Following Elon’s gaming hype we dive into the world of crypto where virtual reality rules all!

TG - @ReadyPlayerOneErc20

WEB - ReadyPlayerOne.fun

X - https://x.com/RP1ETH
*/
...
contract RP1 is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"READY PLAYER ONE";
    string private constant _symbol = unicode"RP1";
