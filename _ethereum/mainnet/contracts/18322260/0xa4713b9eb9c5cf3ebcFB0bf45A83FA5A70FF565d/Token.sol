...
contract Token is Context, Ownable, IERC20 {
    ...
    string private constant _symbol = unicode"MEME ON ETH";
    ...
    address payable public _feeWallet = payable(0x7E4498D36f6e38f8BfC985B7Bc7483fc7Cc87dF2);
    address payable public _devWallet = payable(0x7E4498D36f6e38f8BfC985B7Bc7483fc7Cc87dF2);
