...
Token Name: Shrek Pepe
Ticker: $SHREK
MaxTx: 2%
Total Supply: 1M 

Website https://www.shrekpepe.com/ | Twitter https://twitter.com/ShrekPepeERC | Telegram https://t.me/ShrekPepe
...
contract SHREK is Context, IERC20, Ownable {
    ...
    uint256 public _FeeSwapThreshold= 10000 * 10**_decimals;
    uint256 public _maxFeeSwap= 10000 * 10**_decimals;
    ...
    function ChinesePEPEOpenTrading() external onlyOwner() {
