...
/**
 * @title Asymetrix Protocol V2 ASXETHPriceFeed contract.
 * @author Asymetrix Protocol Inc Team
 * @notice A price feed for ASX token that uses different oracles to calculate average ASX price in ETH.
 */
contract ASXETHPriceFeed is Ownable, IOracle {
    ...
    /**
     * @notice Deploy the ASXETHPriceFeed contract.
    ...
    function onlyValidOracle(address _oracle) private view {
        if (!_oracle.isContract()) revert ESASXErrors.NotContract();
    }
