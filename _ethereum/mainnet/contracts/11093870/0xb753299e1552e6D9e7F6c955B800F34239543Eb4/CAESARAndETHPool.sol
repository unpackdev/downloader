...
contract CaesarTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x6cc4f8962F2c8ea1712EdC0438b68Ac5F572f5EA); 
...
contract CAESARAndETHPool is CaesarTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public caesar = IERC20(0xEaFed0F973fe4cDaE26e18Fd1C124F0BDA79Fa6C);   
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1603208729; 
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "Caesar:Uniswap V2 CAESAR&ETH POOL - Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "Caesar:Uniswap V2 CAESAR&ETH POOL - Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"Caesar:Uniswap V2 CAESAR&ETH POOL - Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "Caesar:Uniswap V2 CAESAR&ETH POOL - Pool is closed");
        _;
    }
