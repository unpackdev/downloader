 ...
 * 
 ...
 Telegram:https://t.me/Eloncoinerc
Twitter:https://x.com/eloncoin?s=21&t=hag3hfwfZ9VCAFR2Wvo87A
Website:WWW.ElonCoin.xyz
 */
...
contract ELON is ERC20, Ownable {
    ...
    uint256 public _maxWalletLimit = 21000000000 * 9 ** decimals();
    ...
    constructor() ERC20("ELON", "$ELON") {
        ...
        // MINT INITIAL SUPPLY
        _mint(msg.sender, 420000000000 * 9 ** decimals());
