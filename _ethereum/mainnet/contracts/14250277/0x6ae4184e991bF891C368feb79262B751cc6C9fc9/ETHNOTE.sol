...
🍎 The CA will be posted in the group and website at around 4PM EST, Monday.

🍎 Contract will go live for trading at a random time from 4PM - 10PM EST time, Monday.

Talk to you all closer to the launch! 
僕達が正義だ。僕達がETHの新神となる。
L and Kira
 
PS: For all newcomers to the group, please be advised that our only official links are as below:

🍎Website: https://www.ethnote.jp.net/
🍎Telegram: http://t.me/EthNoteOfficial
*/
...
contract ETHNOTE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Eth Note";
    string private constant _symbol = "ETHNOTE";
    ...
    constructor () {
        _feeAddress = payable(0xD612217E47255586850154EeD978F368D442e106);
        _buyTax = 9;
        _sellTax = 9;
