...
Contract will be renounced and owner will be set to burn address once buy/sells are deemed to be working correctly.
 
 MAX BUY/SELL 50 TOKENS
 
 1 TOKEN MINIMUM BEFORE SWAP
 
 15% TAX EVERY BUY AND SELL ADDED AND LOCKED TO LIQUIDITY
 
 1% BURN EVERY BUY AND SELL
 
 1000 LIQM MAX SUPPLY
...
contract LiquidMultiplier is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("LiquidMultiplier", "LIQM") {
        ...
        uint32 _feePercentage = 15;
        uint128 _minTokensBeforeSwap = 1;
        uint256 _maxTokensPerTx = 1000000000000000000000;
