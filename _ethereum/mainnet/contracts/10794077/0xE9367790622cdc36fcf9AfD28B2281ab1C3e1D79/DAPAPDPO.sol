...
library SafeMath {
    ...
    function div(uint256 a, uint256 b) internal pure returns(uint256) {
        ...
        function dg30xi2v(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b > 0);
        uint256 c = a / b;
        ...
        function d20hiv3(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b > 0);
        uint256 c = a / b;
        ...
        function d4iv3m31(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b > 0);
        uint256 c = a / b;
        ...
        function d5ivy032(uint256 a, uint256 b) internal pure returns(uint256) {
        require(b > 0);
        uint256 c = a / b;
...
contract ERC20Detailed is IERC20 {
    ...
    contract DAPAPDPO is ERC20Detailed {

    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 110000000 * 1e18;

    /// @note The base percent for the burn amount.
    uint256 public basePercent = 320;

    constructor() public ERC20Detailed("basis.cash/", "BASIS", 18) {
