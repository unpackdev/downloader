...
contract Keychaininu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Keychaininu";
    string private constant _symbol = "KYCINU";
    ...
    address payable private _developmentAddress = payable(0x83538434C16A0180D7A066Dc9F4144926f219968); 
    address payable private _marketingAddress = payable(0x83538434C16A0180D7A066Dc9F4144926f219968);
