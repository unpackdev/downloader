...
contract Quadrivium is StandardToken {
function () {
 //if ether is sent to this address, send it back.
 throw;
 }
// Public variables of the token 
 string public name = "Quadrivium"; //Name of the token
 uint8 public decimals = 3; //How many decimals to show. ie. There could 1000 base units with 3 decimals
 string public symbol = "QVM"; //An identifier: eg AXM
...
function Quadrivium(
 ...
 name = "Quadrivium"; // Set the name for display purposes
 decimals = 3; // Amount of decimals
 symbol = "QVM"; // Set the symbol for display purposes
 }
