...
contract WheeliesOnchain is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Wheelies OnChain", "WELSOC") {
