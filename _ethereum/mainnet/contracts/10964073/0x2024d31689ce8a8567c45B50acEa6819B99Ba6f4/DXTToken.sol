...
contract DXTToken is StandardToken {
    ...
    */
    ...
    constructor () public {
        // 发币总量 10000w
        uint _total = 100000000 * (10 ** 18);
        balances[msg.sender] = _total;               // Give the creator all initial tokens
        totalSupply = _total;                        // Update total supply
        name = "DXT1";                                   // Set the name for display purposes
        decimals = 18;                            // Amount of decimals for display purposes
        symbol = "DXT";                               // Set the symbol for display purposes
    }
