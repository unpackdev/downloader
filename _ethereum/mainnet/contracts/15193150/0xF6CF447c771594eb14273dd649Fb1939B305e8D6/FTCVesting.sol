...
contract FTCVesting {
    ...
    constructor(
        ...
        vestingCliff = block.timestamp + 180 days;
        vestingEnd = block.timestamp + 720 days;

        lastUpdate = vestingBegin;

        require(vestingCliff >= vestingBegin, "FTCVester.constructor: cliff is too early");
        require(vestingEnd > vestingCliff, "FTCVester.constructor: end is too early");
    }
