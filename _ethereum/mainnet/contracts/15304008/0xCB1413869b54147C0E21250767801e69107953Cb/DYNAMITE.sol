...
Get on board the most hyped token tonight.
Dynamite is a straightforward bullish and hyped name for an ERC20 token.  
We are actually going to explode tonight. Locked for 14 days, no team tokens, 
no prepumps, no bullshit. Everyone apes at launch.

Your task is to get on board your friends, lads, chads, moms,dads and so on. 
Pumping all fucking night long. Dynamite is in the house and the fuse is already on fire.

https://t.me/dynamitecave
...
contract DYNAMITE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dynamite";
    string private constant _symbol = "DYNAMITE";
