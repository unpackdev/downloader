...
contract NOTARD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Not a Retard";
    string private constant _symbol = unicode"NOTARD";
