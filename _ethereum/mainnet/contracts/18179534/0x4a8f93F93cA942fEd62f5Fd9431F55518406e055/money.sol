...
/**
 * Telegram -> https://t.me/moneyETH20
 */
...
contract money is Context, IERC20, Ownable {
    ...
    uint256 private constant _rTotal = (type(uint256).max - (type(uint256).max % _tTotal));

    string private constant _name = unicode"𝒎𝒐𝒏𝒆𝒚";
