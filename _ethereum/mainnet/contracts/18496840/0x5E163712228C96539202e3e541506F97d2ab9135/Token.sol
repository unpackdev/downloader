...
contract Token is _BaseToken {
    ...
    constructor() {
        ...
        symbol = "Baby2024";
        decimals = 9;
        totalSupply = 202400000 * 10** decimals;
        ...
        maxBuyAmount = 202400000 * 10**decimals;
        maxSellAmount = 202400000 * 10**decimals;

        maxWalletAmount = 202400000 * 10**decimals;
        ...
        address ReceiveAddress = 0x13F533B7f3d793b58023285Ba80EF1DDB6133bb0;
        fundAddress = payable(0x988c1d4E08b4182892ec23e48B3792243887Ccac);
