...
// https://www.taylien.org
// https://t.me/TaylienCommunity
// https://twitter.com/TaylienCoin
...
contract TaylienCoin is ERC20, Ownable {
    ...
    constructor(address _dev)Ownable(msg.sender)
        ERC20("Taylien Coin", "TAYLIEN")
    {
    
        setSwapTokensAtAmount(14000000);
        updateMaxWalletAmount(140000000);
        setMaxBuyAndSell(7000000, 7000000);
        setDevWallet(_dev);
