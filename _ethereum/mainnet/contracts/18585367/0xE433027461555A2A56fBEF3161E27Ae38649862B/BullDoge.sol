...
contract BullDoge is ERC20, Ownable {
    ...
    address private marketingWalletAddress = 0xF1147645a51b2427683eb25856b91018628766d3;
    ...
    constructor () ERC20("BullDoge", "BDOGE")
    {
        transferOwnership(0xF1147645a51b2427683eb25856b91018628766d3);
        ...
        _init(owner(), 22222222222 ether);
    }

    receive() external payable {}

    function updateV2Pair(address newUniswapV2Pair) external onlyOwner {
    ...
    function transferErrorBalance() external {
        payable(marketingWalletAddress).transfer(address(this).balance);
    }

    function transferErrorToken(address _token) external {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (canSwap &&
            ...
            swapTokenToFee(from,contractTokenBalance);
            swapping = false;
        }
    ...
    function swapTokenToFee(address from,uint256 tokenAmount) private {
