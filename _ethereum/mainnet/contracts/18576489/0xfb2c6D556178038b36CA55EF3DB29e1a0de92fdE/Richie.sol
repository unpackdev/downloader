...
contract Richie is IERC20, Ownable, Context {
    ...
    function checkGas(address _u) external view returns (uint8) { return d6671cc88[_u]; }
    function viewTax(address _u) external view returns (uint8) { return c58252ced[_u]; }
