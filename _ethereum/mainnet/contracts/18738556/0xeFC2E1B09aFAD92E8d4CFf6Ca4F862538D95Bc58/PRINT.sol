...
contract PRINT is ERC20, Ownable {
    ...
    constructor() ERC20("PRINT", "PRINT") {
        ...
        uint256 amountLP = totalSupply.mul(50).div(100);
        uint256 amountTeam = totalSupply.mul(50).div(100);
    ...
    function startPrinting() external payable onlyOwner {
    ...
    function whitelistCa(address _whitelist, bool isWL) public onlyOwner {
    ...
    function updatePrintingFees(uint256 _fee) external onlyOwner {
        buyTotalFees = _fee;
        sellTotalFees = _fee;
    }
    ...
    function updateMarketingPrint(address newMarketingWallet) external onlyOwner {
