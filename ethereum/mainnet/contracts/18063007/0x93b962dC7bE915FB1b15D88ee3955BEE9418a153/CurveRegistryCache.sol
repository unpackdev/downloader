...
contract CurveRegistryCache is ICurveRegistryCache {
    ...
    function lpToken(address pool_) external view override onlyInitialized(pool_) returns (address) {
    ...
    function basePool(address pool_) external view override onlyInitialized(pool_) returns (address) {
        return _basePool[pool_];
    }

    function coinIndex(address pool_, address coin_) external view override onlyInitialized(pool_) returns (int128) {
    ...
    function coinIndices(address pool_, address from_, address to_)
        external
        view
        override
        onlyInitialized(pool_)
    ...
    function decimals(address pool_) external view override onlyInitialized(pool_) returns (uint256[] memory) {
    ...
    function interfaceVersion(address pool_) external view override onlyInitialized(pool_) returns (uint256) {
    ...
    function coins(address pool_) external view override onlyInitialized(pool_) returns (address[] memory) {
        return _coins[pool_];
    }
    ...
    function getRewardPool(address pool_) external view override onlyInitialized(pool_) returns (address) {
