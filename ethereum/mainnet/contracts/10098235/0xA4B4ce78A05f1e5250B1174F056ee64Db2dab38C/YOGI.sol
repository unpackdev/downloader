...
contract Owned {
    ...
    constructor() public {
        owner = 0xdfB9636367bcBdA7E9e9e58a7e7E428c7FB36f77;
    }
...
// ----------------------------------------------------------------------------
contract YOGI is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "YOGI";
        decimals = 18;
        _totalSupply = 155904279285 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 2164940000; // 1 ETH = 216494 YGI // 1 YGI = 0.0000001 BTC
        DENOMINATOR = 10000;
