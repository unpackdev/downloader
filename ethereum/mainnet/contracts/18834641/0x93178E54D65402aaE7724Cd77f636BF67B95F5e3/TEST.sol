...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 private maxSwap = _totalSupply / 1000;
    ...
    function changeTax(uint256 newBuyTax, uint256 newSellTax, uint256 newSplitPercentF) external onlyOwner {
        buyTax = newBuyTax;
        sellTax = newSellTax;
