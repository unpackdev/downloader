...
contract turkeysGameFarmers is ERC721Enumerable, Ownable, Pausable {
    ...
    TestularInterface public grainContract = TestularInterface(0xfb6b23ade938eD16F769833B2FF92CA26303390b);
    ...
    uint256 public REWARD_RATE = 10000;
    uint256 public REWARD_RATE_PER_SECOND = REWARD_RATE * 10**9 / 86400;
    ...
    function claim() public whenNotPaused {
        ...
        grainContract.rewardTokens(msg.sender, LOST_REWARDS_ADDRESS, finalReward, lostReward);
    }
    ...
    function setGrainContract(address _grainContractAddress) external onlyOwner {
        grainContract = TestularInterface(_grainContractAddress);
    }
}