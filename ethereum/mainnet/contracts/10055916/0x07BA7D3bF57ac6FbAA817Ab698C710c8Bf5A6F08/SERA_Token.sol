...
contract Owned {
    ...
    constructor() public {
        owner = 0x3fd0388C25920818A16f93FEA5EbB8350f14fb3E;
    }
...
// ----------------------------------------------------------------------------
contract SERA_Token is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "SERA Token";
        decimals = 18;
        _totalSupply = 700000000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 1900000; // 1 ETH = 190 SRA // 1 SRA = 1 USD
        DENOMINATOR = 10000;
