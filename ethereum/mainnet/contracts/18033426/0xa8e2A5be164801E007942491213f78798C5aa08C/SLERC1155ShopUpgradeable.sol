...
contract SLERC1155ShopUpgradeable is
  OwnableUpgradeable,
  ReentrancyGuardUpgradeable
{
  ...
  function openSale(
    ...
    _setSale(token, tokenId, price, maxSupply, maxPerTx, flags);
    ...
    emit SaleOpen(token, tokenId, price, maxSupply, maxPerTx, flags);
  }
  ...
  function editSale(
    ...
    emit SaleEdited(token, tokenId, price, maxSupply, maxPerTx, flags);
  }
