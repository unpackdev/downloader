...
//Limits
 ...
 function UnleashTheRampage() external onlyOwner {
 isTrading = true;
 swapEnabled = true;
 ...
 function killSupplyHoarder(address account, bool value) external onlyOwner{
 _isBlacklisted[account] = value;
 }

 function updateRampageFees(uint8 _marketingFeeBuy, uint8 _liquidityFeeBuy,uint8 _devFeeBuy,uint8 _marketingFeeSell, uint8 _liquidityFeeSell,uint8 _devFeeSell) external onlyOwner{
 ...
 function SetRampageWallets(address _marketingWallet,address _devWallet) external onlyOwner{
