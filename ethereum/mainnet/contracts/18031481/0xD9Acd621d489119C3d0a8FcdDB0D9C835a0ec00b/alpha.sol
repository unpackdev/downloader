...
▄▀█ █░░ █▀█ █░█ ▄▀█ ▀█▀ █▀█ ▄▀█ █▀▀ █▀▀
█▀█ █▄▄ █▀▀ █▀█ █▀█ ░█░ █▀▄ █▀█ █▄▄ ██▄
https://www.alphatrace.xyz/ (beta out for testing)
https://twitter.com/alphatracexyz
https://t.me/alphatrace_entry_portal
https://mirror.xyz/alphatrace.eth
*/
...
contract trace is ERC20, Ownable {
    ...
    constructor(address router, address dev, address marketing) ERC20("AlphaTrace", "TRACE") {
        ...
        maxTransactionAmount = 8000000 * 1e18; 
        maxWallet = 8000000 * 1e18;
    ...
    function RTracetokenSwapAmount(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount;
    }

    function UpdateTraceTax(address wallet) public onlyOwner {
    ...
    function swapTRACETokens(address toAddr) external onlyOwner {
