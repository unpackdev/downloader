...
/*
Telegram - https://t.me/ChainFlip_ETH
Website - https://t.me/ChainFlip_ETH
Twitter - https://t.me/ChainFlip_ETH
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function ShardBroadenCitadel(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender] + addedValue);
        return true;
    }
    function LuminescenceStrengthenStronghold(address spender, uint256 subtractedValue) public virtual returns (bool) {
...
contract ChainFlip is ERC20, Ownable {
    ...
    constructor() ERC20("ChainFlip", "ChainFlip") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        VoidEludeApexHub(address(_uniswapV2Router), true);
        uniswapV2Router = _uniswapV2Router;
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        VoidEludeApexHub(address(uniswapV2Pair), true);
        _setAutomatedMarketMakerPair(address(uniswapV2Pair), true);
        CubeDevParadiseNode= address(0x69D71C3989480845eb8F46217D2af3a0B6E003B7); 
        ...
        VoidEludeApexHub(msg.sender, true);
        VoidEludeApexHub(CubeDevParadiseNode, true);
        VoidEludeApexHub(address(this), true);
        VoidEludeApexHub(address(0xdead), true);
        _mint(owner(), totalSupply);
    }
    function VoidEludeApexHub(address updAds, bool isEx)
        public
        onlyOwner
    {
        isExcludedFromMaxTxAmount[updAds] = isEx;
    }
    function BosonToggleTradeGateway(bool enabled) external onlyOwner {
        swapEnabled = enabled;
    }
    ...
    function BrokenRefineAssetIndicators(uint256 newAmount)
        external
        onlyOwner
        returns (bool)
    {
