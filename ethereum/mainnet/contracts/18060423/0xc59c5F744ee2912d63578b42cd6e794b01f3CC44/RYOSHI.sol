...
contract RYOSHI is ERC20, Ownable {
    ...
    constructor() ERC20("Ryoshi's Coin", "RYOSHI", DECIMALS) {
        ...
        sniperDevelopment = address(0x904519C04Ca9c3311B2FDfd1d557E7881392409e); 
        sniperOwner = address(0x904519C04Ca9c3311B2FDfd1d557E7881392409e);
    ...
    function ryoshi() external onlyOwner {
        tradingActive = true;
        swapBack = true;
