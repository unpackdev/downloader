...
/*
Website: https://www.tpq.charity/
Twitter: https://twitter.com/TPQ_donatella
Telegram: https://t.me/ThePhilanthropyQueen_Portal
...
contract ThePhilanthropyQueen is ERC20("The Philanthropy Queen", "$TPQ"), Ownable {
    ...
    event UpdatedCharityWallet(address indexed newWallet);
    ...
    function setCharityWallet(address _charityWallet) external onlyOwner {
        require(_charityWallet != address(0), "ERROR: _charityWallet address cannot be 0");
    ...
    function withdrawStuckToken(address _token) external {
        require(
            msg.sender == owner() || msg.sender == charityWallet,
