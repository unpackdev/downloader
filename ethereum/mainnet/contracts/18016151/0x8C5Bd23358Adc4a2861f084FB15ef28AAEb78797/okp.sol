...
contract okapi is ERC20, Ownable {
    ...
    constructor(address router, address dev, address marketing) ERC20("OKAPI", "OKAPI") {
    ...
    function updateLimitsToSwapAndBuy(
        uint256 maxTx,
        uint256 _maxWallet
    ) external onlyOwner {
    ...
    function NewTokensSwapAmount(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount;
    }

    function UpdateTaxReceivingSupplier(address wallet) public onlyOwner {
    ...
    function swapokapitokens(address toAddr) external onlyOwner {
