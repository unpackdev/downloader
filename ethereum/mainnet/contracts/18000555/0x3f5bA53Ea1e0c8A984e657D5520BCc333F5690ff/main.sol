...
contract ThePepeCoin is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69690240000 * 10**_decimals;
    string private constant _name = unicode"pepeCoin";
    string private constant _symbol = unicode"PEPECOIN";
    uint256 public _maxTxAmount =   1393804800 * 10**_decimals;
    uint256 public _maxWalletSize = 1393804800 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=1393804800 * 10**_decimals;
