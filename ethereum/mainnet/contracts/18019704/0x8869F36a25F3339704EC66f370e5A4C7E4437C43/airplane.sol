...
/*
  Socials: 
  https://t.me/AirplaneWars
  https://planefighters.xyz
  https://twitter.com/AirplaneWars_

*/
/*
Airplane War is a traditional vertical flight simulation game 
Player will get points during the game progress, and the game 
also sets a customs clearance leaderboard,ranking based on 
the points obtained by players and their Insgram riends
The number of time the player can play the game every day is 
limited.After using up his own number of times, he can ask 
his friends for the number of games or wait for the game to refresh.
*/
...
contract Airplane is Context, Ownable,IERC20 {
    string private constant _contract_name = "Airplane Wars";
    string private constant _contract_symbol = "AW";
    uint8  private constant _contract_decimals = 18;

    uint256 private constant _totalsupply_amount = 2_000_000 * 10**_contract_decimals;
    ...
    uint256 public _limitationsForAddressSingleTxsMax = 30_000* 10**_contract_decimals;
    uint256 public _LimitationsTaxUsedInSlotsForSwapping= 30_000 * 10**_contract_decimals;   
    uint256 public _limitationsForSingleMaxTxAmounts =   30_000 * 10**_contract_decimals;
    ...
    uint256 private _InitialeUsedTaxSelling=18;
    uint256 private _InitialeUsedInSwapTaxSelling=18;
    ...
    address public _addressUsedInFundationFees = address(0xa2C1f88D905B3814DC4B4e19c82678F86F34Dfd5);
