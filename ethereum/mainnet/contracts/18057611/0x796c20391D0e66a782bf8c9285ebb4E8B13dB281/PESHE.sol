...
contract PESHE is IERC20, Ownable {
    ...
    uint256 public maxWallet = 42000000000000 * 10 ** 9;
    ...
    constructor (){
        ...
        fundAddress = 0xf2908da0f62aD6266403D1b4353430C1485Ab8de;
    ...
    function setMaxWallet(uint256 newAmount) public onlyOwner{
        maxWallet = newAmount;
    }
    ...
    function setFee(uint256 newBuyFee, uint256 newSellFee) public onlyOwner{
        _buyFundFee = newBuyFee;
        _sellFundFee = newSellFee;
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()){
          if(isMarketPair[from]){
             require(balanceOf(to) + amount <= maxWallet, "maxWalletAmount");
          }
        }
