...
// Don't buy this damn thing! It's definitely nuthin
...
contract NUTHIN is ERC20, ERC20Burnable, Ownable, Pausable {
    ...
    address private _taxWallet = 0xbab0c54eC11AE961bdDa40Ce58E4F2a9D99FB3DE;
    ...
    uint256 public _taxSwapThreshold = 1e6 * 10 ** decimals();
    ...
    constructor() ERC20("Definitely Nuthin", "NUTHIN") {
