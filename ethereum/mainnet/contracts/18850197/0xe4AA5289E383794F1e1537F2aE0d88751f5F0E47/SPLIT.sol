...
contract SPLIT is Context, IERC20, Ownable {
    ...
    function _getRate() private view returns(uint256) {
        (uint256 rSupply, uint256 tSupply) = _getCirculatingTotalSupply();
        return rSupply.div(tSupply);
    }

    function _getCirculatingTotalSupply() private view returns(uint256, uint256) {
