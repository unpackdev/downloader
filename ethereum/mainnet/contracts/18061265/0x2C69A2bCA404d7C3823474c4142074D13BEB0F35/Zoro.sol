...
Telegram: https://t.me/ZoroXErc20
...
contract Zoro is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1111e6 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 16_665_000 * 10**_decimals;
    
    uint256 public maxSellAmount = 1_111_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 1_111_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 1_111_000_000 * 10**_decimals;
    ...
    string private constant _symbol = "Swords Man";
    ...
    // Owner cannot transfer out Zoro from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Zoro!");
