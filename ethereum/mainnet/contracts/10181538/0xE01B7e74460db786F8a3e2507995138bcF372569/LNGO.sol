...
// ----------------------------------------------------------------------------
// 'Love Never Grows Old' token contract
//
// Symbol      : LNGO
// Name        : Love Never Grows Old
...
contract LNGO is BurnableToken {

    string public constant name = "Love Never Grows Old";
    string public constant symbol = "LNGO";
