...
contract KRX is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KRX() {
        ...
        totalSupply = 9999999999;                        // Update total supply (1000 for example) (CHANGE THIS)
        name = "KRX";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 1;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KRX";                                             // Set the symbol for display purposes (CHANGE THIS)
