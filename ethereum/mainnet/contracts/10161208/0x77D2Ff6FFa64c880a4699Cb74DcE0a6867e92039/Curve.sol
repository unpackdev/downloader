...
contract Curve is IExchange, TokenFetcher {
    ...
    constructor(address _compoundPool) public {
    ...
    function swap(
        ...
        if( exchange == compoundPool) {
            if (curveData.underlyingSwap) {
                ...
                ICompoundPool(exchange).exchange_underlying(curveData.i, curveData.j, fromAmount, toAmount, curveData.deadline);
            }
            else {
                ...
                ICompoundPool(exchange).exchange(curveData.i, curveData.j, fromAmount, toAmount, curveData.deadline);
            }
        }
        else {
            if (curveData.underlyingSwap) {
