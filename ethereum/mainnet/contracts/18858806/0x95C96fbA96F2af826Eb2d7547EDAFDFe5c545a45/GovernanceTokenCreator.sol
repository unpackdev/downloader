...
import "./JubiERC20GovernanceImpl.sol";
import "./Types.sol";
 ...
 */
contract GovernanceTokenCreator is OwnableUpgradeable, UUPSUpgradeable {
    ...
    function createToken(Types.TokenConfig memory _config) public {
        ...
        JubiERC20GovernanceImpl newToken = new JubiERC20GovernanceImpl(
            _config.name,
            _config.symbol
        );
        ...
        emit NewTokenCreated(
            address(newToken),
            Types.ImplementationType.ERC20_GOVERNANCE_TOKEN,
            _config
        );
    }
