...
contract PEP3 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420630000000 * 10**_decimals;
    string private constant _name = unicode"PEP3";
    string private constant _symbol = unicode"PEP3";
    uint256 public _maxTxAmount =   4206300000 * 10**_decimals;
    uint256 public _maxWalletSize = 8412600000 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=4206300000 * 10**_decimals;
