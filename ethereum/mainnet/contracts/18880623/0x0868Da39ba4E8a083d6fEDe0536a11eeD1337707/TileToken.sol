...
contract TileToken is ERC20 {
    ...
    EtheriaWrapper ew = EtheriaWrapper(0x629A493A94B611138d4Bee231f94f5C08aB6570A);

    uint8 constant COL = 18;
    uint8 constant ROW = 18;
    uint constant ID = 612;
    ...
    function canTileBeNamed() public view returns (bool) {
        return doesContractOwnTile() && block.timestamp > lastNameChange + SECS_PER_MONTH;
    }
