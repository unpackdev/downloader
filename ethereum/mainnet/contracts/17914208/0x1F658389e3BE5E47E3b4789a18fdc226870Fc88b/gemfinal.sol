...
/*
*  Comics by MANDOX - Special Edition
...
contract MandoxComicSE is ERC721Psi, Ownable{
     ...
     * contract deployment.
     */
    constructor(string memory _baseUri) ERC721Psi("MANDOXcomics GEM", "MCGse") {
        baseURI = _baseUri;
    }
    ...
    */
    function exclusiveMint(uint256 quantity, address _to) external onlyOwner {
