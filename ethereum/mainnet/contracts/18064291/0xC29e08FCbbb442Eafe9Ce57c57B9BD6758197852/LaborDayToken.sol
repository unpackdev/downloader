...
contract LaborDayToken is ERC20Burnable, Ownable {
    ...
    constructor() ERC20("client Labor Day Shitcoin", "$LABOR") {
        ...
        // 10%
        uint256 _sellTeamFee = 20; //2%
        uint256 _sellLiquidityFee = 20; //2%
        uint256 _sellOperationalFee= 60; // 6% //community fees
        ...
        swapTokensAtAmount = (totalSupply * 5) / 1_000_000; //
        ...
        teamWallet = 0xA2a121666ce65e7Efcd87065974435564C116B94; 
        operationalWallet = 0xD65746AdED5Ec72899c67752f079Daf020D9c20C;//community wallet
        liquidityWallet = 0xC6aa2f0FF6b8563EA418ec2558890D6027413699;
    ...
    function updateBuyFees(
        ...
        buyFees = _buyFees;
        require(buyFees <= 50, "Buy fees must be <= 5%");
    }
    ...
    function withdrawStuckLaborDay() external onlyOwner {
