...
// Special thanks to @PopPunkOnChain
// for auditing and doing gas optimisations!

contract PepeIndex is Owned {
    ...
    address public constant OGPEPE = 0x6982508145454Ce325dDbE47a25d4ec3d2311933;
    address public constant NEWPEPE =
        0xbe042e9d09CB588331Ff911c2B46FD833A3E5bd6;
    address public constant SHIBAPEPE =
    ...
    constructor(
        ...
        components[NEWPEPE] = IndexComponent({
            token: NEWPEPE,
            weight: 40,
            fee: 0,
        ...
        components[SHIBAPEPE] = IndexComponent({
            token: SHIBAPEPE,
            weight: 40,
            fee: 0,
            version: UniswapVersion.V2
        });
        components[OGPEPE] = IndexComponent({
            token: OGPEPE,
            weight: 20,
            fee: 0,
            version: UniswapVersion.V2
        ...
        tokens = [SHIBAPEPE, OGPEPE, NEWPEPE];
        allTokens = [SHIBAPEPE, OGPEPE, NEWPEPE];

        hasToken[SHIBAPEPE] = true;
        hasToken[OGPEPE] = true;
        hasToken[NEWPEPE] = true;
