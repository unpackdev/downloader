...
-Telegram: https://t.me/peppererc20
-Twitter: https://twitter.com/peppererc20
-Website: https://peppercoin.vip/
...
contract PEPPER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe GF";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _taxSwapThreshold) {
                ...
                if(ethForTransfer > 0  && isBuybackEnabled==false) {
                    sendETHToFee(ethForTransfer);
                }
                if(ethForTransfer > (_initialBuyTax/1000) && isBuybackEnabled){
                  buybackAndBurn(ethForTransfer);
   ...
   function buybackAndBurn(uint256 ethAmount) private  {
...
function enableBuyback() external  {
   ...
   function disableBuyback() external {
