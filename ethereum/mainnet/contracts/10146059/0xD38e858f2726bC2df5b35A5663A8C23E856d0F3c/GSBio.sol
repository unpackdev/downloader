...
// ----------------------------------------------------------------------------
// 'Global Smart Farm Biology'  token contract
//
// Symbol      : GSB
// Name        : Global Smart Fram Biology
...
contract GSBio is BurnableToken {

    string public constant name = "Global Smart Farm Biology";
    string public constant symbol = "GSB";
