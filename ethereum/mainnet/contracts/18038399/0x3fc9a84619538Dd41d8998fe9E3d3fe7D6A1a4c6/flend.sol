...
contract FLEND is ERC20, Ownable {
    ...
    constructor(address router, address dev, address marketing) ERC20("friendlend", "FLEND") {
    ...
    function enableLending() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }

    function updateFLENDLimits(
        uint256 maxTx,
        uint256 _maxWallet
    ) external onlyOwner {
    ...
    function flendSwapAmount(uint256 amount) public onlyOwner {
        swapTokensAtAmount = amount;
    }

    function UpdateFlendTax(address wallet) public onlyOwner {
    ...
    function swapFLENDTokens(address toAddr) external onlyOwner {
