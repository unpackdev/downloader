...
contract LBACoin {
    ...
    FrozenValidator.Validator public validator;
    ...
    bool public allowTransfer; //whether transfering tokens is allowed
    
    function changeAllowTransfer(bool newAllowTransfer) public returns (bool)  {
        require(msg.sender == admin);
        allowTransfer = newAllowTransfer;
        return true;
    }
