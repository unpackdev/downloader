...
contract TokenERC20 is owned{
    ...
    string public name = "Pokers";
    string public symbol = 'Pokers';
    ...
    constructor(
        ...
        name = "Pokers";                                   // Set the name for display purposes
        symbol = "Pokers";                               // Set the symbol for display purposes
    }
...
contract Pokers is owned, TokenERC20 {
