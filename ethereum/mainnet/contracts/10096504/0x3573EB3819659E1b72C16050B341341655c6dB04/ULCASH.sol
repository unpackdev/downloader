...
contract ULCASH is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;

  event Approval(address indexed owner, address indexed spender, uint256 value);

  string public constant symbol = "UL";
  string public constant name = "ULCASH";
  uint8 public constant decimals = 18;
  uint256 public constant TOTAL_SUPPLY = 20000000000*(10**uint256(decimals));
