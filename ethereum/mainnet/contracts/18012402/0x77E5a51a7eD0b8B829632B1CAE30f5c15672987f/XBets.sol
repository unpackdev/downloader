/**
Telegram: https://t.me/XBetsETH
Website: https://www.xbets.vip/
Twitter: https://twitter.com/XBetsETH
Medium: https://medium.com/@XBets
*/
...
contract XBets is ERC20, Ownable {
    ...
    constructor() ERC20("XBets", "XBETS") {
        ...
        maxTransactionAmount = 15555555 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 15555555 * 1e18; // 2% from total supply maxWallet
        ...
        developmentWallet = address(0xD066f21F358F4B752f216Af855d6030D5B23Df80); // set as development wallet
        marketingWallet = address(0x41A8A506b77c4Ee4659c1EB4d028Db402A2aaF80); // set as marketing wallet
        devWallet = address(0x3334636348346bb2c28947dF3c369eaAb111F72c); // set as dev wallet
