...
contract Astrofolio is ERC20, Ownable {
    ...
    function addLiquidity() external onlyOwner {
        ...
        _approve(address(this), address(uniswapV2Router), balanceContract);
        uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceContract,0,0,owner(),block.timestamp);
