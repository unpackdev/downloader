/*
    Twitter:    https://x.com/IDBotERC
    TG:         http://t.me/IDBotERC
    Website:    https://idbot.tech
*/
...
contract IDBOT is ERC20, Ownable {
    ...
    constructor() ERC20("IDBot AI", "IDBot") {
        ...
        marketingWallet = address(0x04e7598Fd0b9388657Fc7952E2a11EBfA0bf29a9); 
        devWallet = address(0x026Ce127a27eD96Da1D376f5cC150eBe7061eBc2);
        lpWallet = msg.sender;
    ...
    function updateBuyFees(
        ...
        uint256 _devFee
         ...
         require((_marketingFee + _liquidityFee + _devFee) <= 25 ,"Buy fee cant be sent more than 50%");
    ...
    function updateSellFees(
        ...
        require((_marketingFee + _liquidityFee + _devFee) <= 40 ,"Sell fee cant be sent more than 50% ");
