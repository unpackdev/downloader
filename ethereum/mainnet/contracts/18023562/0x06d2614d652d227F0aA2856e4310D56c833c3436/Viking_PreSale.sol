...
contract Viking_PreSale is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor() {
        ...
        baseDecimals = (10**18);
        salePrice = 10 * (10**11); //0.0000010 USD
    ...
    function startStep(uint256 stepIndex) internal {
        ...
        if (stepIndex == 1) {
            ...
            nextPrice = 20 * (10**11); //0.0000020 USD
    ...
    uint256 public bonusPercentage = 10; // Default bonus percentage
        ...
        returns (uint256 totalValue)
    {
        uint256 totalSoldUSD = (totalUsdValueForPresale * (10**18)) -
            inSaleUSDvalue;
            uint256 basePrice = _amount * salePrice;
            uint256 bonusAmount = (basePrice * bonusPercentage) / 100;
    ...
    function setBonusPercentage(uint256 _bonusPercentage) external onlyOwner {
