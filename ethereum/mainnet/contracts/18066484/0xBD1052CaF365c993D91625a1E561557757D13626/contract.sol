...
Taking Dice off the streets and into TG

TELEGRAM - https://t.me/dicebeteth
WEBSITE - https://dicebettg.com/
TWITTER - https://twitter.com/DiceBetTg

DiceBet Bot - https://t.me/dicebeterc_bot
...
contract DICE is ERC20, Ownable {
    ...
    constructor() ERC20("DiceBet", "DICE") {
        ...
        marketingWallet = address(0xEa3923149c358343bb378370bA36F724803C4b1b);
        developmentWallet = address(0xEa3923149c358343bb378370bA36F724803C4b1b);
    ...
    function updateMaxTxnAmount(uint256 newMaxBuy, uint256 newMaxSell, uint256 newPercentage) public onlyOwner {
    ...
    function setFeesAmount(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
    ...
    function removeLimits() external onlyOwner {
        updateMaxTxnAmount(1000,1000,1000);
    }
