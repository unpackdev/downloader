...
contract BRC20 is ERC20, ERC20Burnable, Ownable, ERC20Permit, ReentrancyGuard {
    ...
    function burnWithPayment(uint256 value) public payable nonReentrant(){
        if(burnFee != 0){
