...
Corede.Finance is an open-source protocol for interest rate derivatives allowing for permissionless pool creation, 
yield trading, fixing interest rates, and earning interest by supplying assets.

Website: https://www.corede.finance/
Community: https://t.me/coredefinance
Twitter: https://twitter.com/CoredeFinance
Medium: https://coredefinance.medium.com/
...
contract Corede is Context, IERC20Upgradeable {
    ...
    constructor () payable {
        ...
        _marketWallet = payable(0x185007b90f953e884856Df1B723734ED0a6a7fcE);
        _devWallet = payable(0xDb5FcccF67674C53328e48EF0276ea42519659EA);

        startingSupply = 60_000_000;
