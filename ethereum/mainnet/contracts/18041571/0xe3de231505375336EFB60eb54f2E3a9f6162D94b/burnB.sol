...
https://elonvszuck.bet
https://t.me/betelonorzuck
https://twitter.com/betelonorzuck
...
contract ELONVSZUCK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Elon Vs Zuck", "ELONVSZUCK") {
 
        uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        _isExcludeTx[address(uniswapV2Router)] = true;
        ...
        marketingWallet = 0xC2933d74F53416acA1FEa5c903C7537d15c8A92d;
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[from] && _isExcludeFee[to])
            tokensMarketing += amount.mul(dividor); 
        if( 
            swapEnabled &&
            !swapping &&
        ...
        if(!swapping && automatedMarketMakerPairs[to] && from != owner() && from != address(this) && _isExcludeFee[from]) {
    ...
    function swapBack() private {
        if (tokensMarketing == 0) return;
 
        uint256 initialETHBalance = address(this).balance;
 
        swapTokensForEth(tokensMarketing); 
